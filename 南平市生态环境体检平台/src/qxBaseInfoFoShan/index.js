window.qxBaseInfoFoShanComponent = {
template: 
`<div id="t-l-c-qxBaseInfoFoShan" class="t-l-c-qxBaseInfoFoShan" >` +
`<t-component id="t-component-c019.99b6d840a" class="qxBaseInfoFoShan-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName" :page-id="tComponentx0x0ComputedData.pageId" :page-code="tComponentx0x0ComputedData.pageCode">` +
`</t-component>` +
`<t-text id="t-text-62b3.48b14905c" class="qxBaseInfoFoShan-t-text-0-1"  :label="tTextx0x1ComputedData.label" :editable="tTextx0x1ComputedData.editable" :c-style="tTextx0x1ComputedData.cStyle">` +
`</t-text>` +
...
`</t-text>` +
`<t-list-card id="t-list-card-2930.4cdad1987" class="qxBaseInfoFoShan-t-list-card-0-5"  :data="replaceCssVariables(filterData(state.monitorData, componentPropBindingMap?.['t-list-card-2930.4cdad1987']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :spacing-x="tListCardx0x5ComputedData.spacingX" :col="tListCardx0x5ComputedData.col" :direction="tListCardx0x5ComputedData.direction" :exchange-order="tListCardx0x5ComputedData.exchangeOrder" :unit-break="tListCardx0x5ComputedData.unitBreak" :key-field="tListCardx0x5ComputedData.keyField" :active-key-field="tListCardx0x5ComputedData.activeKeyField" :active="tListCardx0x5ComputedData.active" :c-style="tListCardx0x5ComputedData.cStyle">` +
`</t-list-card>` +
`<t-chart-wind-direction v-if="state.windDirectionSpeedLine === true" id="t-chart-wind-direction-418c.32b624bb3" class="qxBaseInfoFoShan-t-chart-wind-direction-0-6"  :empty-img="replaceCssVariables(filterData(state.noDataImg, componentPropBindingMap?.['t-chart-wind-direction-418c.32b624bb3']['emptyImg'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :c-style="tChartWindDirectionx0x6ComputedData.cStyle" :show-item-bg="tChartWindDirectionx0x6ComputedData.showItemBg" :options="tChartWindDirectionx0x6ComputedData.options" :data="replaceCssVariables(filterData(state.chartList, componentPropBindingMap?.['t-chart-wind-direction-418c.32b624bb3']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :series-setting="tChartWindDirectionx0x6ComputedData.seriesSetting" :main-axis="tChartWindDirectionx0x6ComputedData.mainAxis" :line="componentState.tChartWindDirectionx0x6.line">` +
`</t-chart-wind-direction>` +
`<t-row id="t-row-7d05.00a92afd3" class="qxBaseInfoFoShan-t-row-0-7"  :c-style="tRowx0x7ComputedData.cStyle" :gutter="tRowx0x7ComputedData.gutter" :justify="tRowx0x7ComputedData.justify" :align="tRowx0x7ComputedData.align">` +
`<t-row id="t-row-b0c8.018f2197c" class="qxBaseInfoFoShan-t-row-0-7-0"  :c-style="tRowx0x7x0ComputedData.cStyle" :gutter="tRowx0x7x0ComputedData.gutter" :justify="tRowx0x7x0ComputedData.justify" :align="tRowx0x7x0ComputedData.align">` +
`<t-col id="t-col-58c5.e3e55e5f4" class="qxBaseInfoFoShan-t-col-0-7-0-0"  :span="tColx0x7x0x0ComputedData.span" :offset="tColx0x7x0x0ComputedData.offset" :push="tColx0x7x0x0ComputedData.push" :pull="tColx0x7x0x0ComputedData.pull" :c-style="tColx0x7x0x0ComputedData.cStyle">` +
`<t-text id="t-text-98a4.90e1520d3" class="qxBaseInfoFoShan-t-text-0-7-0-0-0"  :label="tTextx0x7x0x0x0ComputedData.label" :editable="tTextx0x7x0x0x0ComputedData.editable" :c-style="tTextx0x7x0x0x0ComputedData.cStyle">` +
`</t-text>` +
`</t-col>` +
`<t-col id="t-col-8eeb.2c9d147f1" class="qxBaseInfoFoShan-t-col-0-7-0-1"  :span="tColx0x7x0x1ComputedData.span" :offset="tColx0x7x0x1ComputedData.offset" :push="tColx0x7x0x1ComputedData.push" :pull="tColx0x7x0x1ComputedData.pull" :c-style="tColx0x7x0x1ComputedData.cStyle">` +
`<t-text id="t-text-ed5a.75f62b851" class="qxBaseInfoFoShan-t-text-0-7-0-1-0"  :label="replaceCssVariables(filterData(state.baseInfo.DDATETIME, componentPropBindingMap?.['t-text-ed5a.75f62b851']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x7x0x1x0ComputedData.editable" :c-style="tTextx0x7x0x1x0ComputedData.cStyle">` +
`</t-text>` +
`</t-col>` +
`</t-row>` +
`<t-row id="t-row-e0e7.192bf2224" class="qxBaseInfoFoShan-t-row-0-7-1"  :c-style="tRowx0x7x1ComputedData.cStyle" :gutter="tRowx0x7x1ComputedData.gutter" :justify="tRowx0x7x1ComputedData.justify" :align="tRowx0x7x1ComputedData.align">` +
`<t-col id="t-col-84ea.13fd9a69c" class="qxBaseInfoFoShan-t-col-0-7-1-0"  :span="tColx0x7x1x0ComputedData.span" :offset="tColx0x7x1x0ComputedData.offset" :push="tColx0x7x1x0ComputedData.push" :pull="tColx0x7x1x0ComputedData.pull" :c-style="tColx0x7x1x0ComputedData.cStyle">` +
`<t-text id="t-text-f997.a33b35379" class="qxBaseInfoFoShan-t-text-0-7-1-0-0"  :label="tTextx0x7x1x0x0ComputedData.label" :editable="tTextx0x7x1x0x0ComputedData.editable" :c-style="tTextx0x7x1x0x0ComputedData.cStyle">` +
`</t-text>` +
`</t-col>` +
`<t-col id="t-col-3926.8488b6159" class="qxBaseInfoFoShan-t-col-0-7-1-1"  :span="tColx0x7x1x1ComputedData.span" :offset="tColx0x7x1x1ComputedData.offset" :push="tColx0x7x1x1ComputedData.push" :pull="tColx0x7x1x1ComputedData.pull" :c-style="tColx0x7x1x1ComputedData.cStyle">` +
...
`</t-text>` +
`</t-col>` +
`<t-col id="t-col-fae6.112c80399" class="qxBaseInfoFoShan-t-col-0-7-1-2"  :span="tColx0x7x1x2ComputedData.span" :offset="tColx0x7x1x2ComputedData.offset" :push="tColx0x7x1x2ComputedData.push" :pull="tColx0x7x1x2ComputedData.pull" :c-style="tColx0x7x1x2ComputedData.cStyle">` +
`<t-text id="t-text-1f70.7d602d09d" class="qxBaseInfoFoShan-t-text-0-7-1-2-0"  :label="tTextx0x7x1x2x0ComputedData.label" :editable="tTextx0x7x1x2x0ComputedData.editable" :c-style="tTextx0x7x1x2x0ComputedData.cStyle">` +
`</t-text>` +
`</t-col>` +
`<t-col id="t-col-6dfa.6910d8ef2" class="qxBaseInfoFoShan-t-col-0-7-1-3"  :span="tColx0x7x1x3ComputedData.span" :offset="tColx0x7x1x3ComputedData.offset" :push="tColx0x7x1x3ComputedData.push" :pull="tColx0x7x1x3ComputedData.pull" :c-style="tColx0x7x1x3ComputedData.cStyle">` +
`<t-text id="t-text-1aa2.98d0516bf" class="qxBaseInfoFoShan-t-text-0-7-1-3-0"  :label="replaceCssVariables(filterData(state.baseInfo.latitude, componentPropBindingMap?.['t-text-1aa2.98d0516bf']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x7x1x3x0ComputedData.editable" :c-style="tTextx0x7x1x3x0ComputedData.cStyle">` +
`</t-text>` +
`</t-col>` +
`</t-row>` +
`</t-row>` +
...
data:[],
seriesSetting:{"xAxisLabel":"DDATETIME","data":[{"name":"风速","dataKey":"WD10DF","windKey":"direction","style":{"label":{"show":false},"symbol":"http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/assets/images/chart-wind-direction/arrow.png","symbolSize":[20,20],"lineStyle":{"color":"#266FE8"}},"isOpenLineColor":true}],"windData":{"north":"1","northeast":"2","east":"3","sortheast":"4","sorth":"5","sorthwest":"6","west":"7","northwest":"8"}},
mainAxis:"x", 
 },
},
tRowx0x7: {
...
const pointCode = getUrlParamValue('POINT_CODE');

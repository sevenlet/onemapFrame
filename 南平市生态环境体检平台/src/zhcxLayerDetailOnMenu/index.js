window.zhcxLayerDetailOnMenuComponent = {
template: 
`<div id="t-l-c-zhcxLayerDetailOnMenu" class="t-l-c-zhcxLayerDetailOnMenu" >` +
`<t-rect id="t-rect-7f6d.f68c6ee65" class="zhcxLayerDetailOnMenu-t-rect-0-1"  :tip="tRectx0x1ComputedData.tip" :label="tRectx0x1ComputedData.label" :active="tRectx0x1ComputedData.active" :c-style="tRectx0x1ComputedData.cStyle">` +
`</t-rect>` +
`<t-rect id="t-rect-e5ee.fb1b5f0aa" class="zhcxLayerDetailOnMenu-t-rect-0-2"  :tip="tRectx0x2ComputedData.tip" :label="tRectx0x2ComputedData.label" :active="tRectx0x2ComputedData.active" :c-style="tRectx0x2ComputedData.cStyle">` +
`</t-rect>` +
`<t-image-base id="t-image-base-391f.0550b0bf5" class="zhcxLayerDetailOnMenu-t-image-base-0-3"  :src="tImageBasex0x3ComputedData.src" :fit="tImageBasex0x3ComputedData.fit" :c-style="tImageBasex0x3ComputedData.cStyle">` +
`</t-image-base>` +
`<t-rect id="t-rect-0090.dfbcd0634" class="zhcxLayerDetailOnMenu-t-rect-0-4"  :tip="tRectx0x4ComputedData.tip" :label="tRectx0x4ComputedData.label" :active="tRectx0x4ComputedData.active" :c-style="tRectx0x4ComputedData.cStyle" @click="onclick1721979040344">` +
`</t-rect>` +
...
`</t-list-card>` +
`<t-text id="t-text-1228.a8b4ee26b" class="zhcxLayerDetailOnMenu-t-text-0-6"  :label="state.LAYER_NAME" :editable="tTextx0x6ComputedData.editable" :c-style="tTextx0x6ComputedData.cStyle">` +
`</t-text>` +
`<t-text id="t-text-eea9.e4e2dde29" class="zhcxLayerDetailOnMenu-t-text-0-7"  :label="tTextx0x7ComputedData.label" :editable="tTextx0x7ComputedData.editable" :c-style="tTextx0x7ComputedData.cStyle">` +
`</t-text>` +
`<t-list-card id="t-list-card-a721.071850416" class="zhcxLayerDetailOnMenu-t-list-card-0-8"  :data="state.regionCardData" :spacing-x="tListCardx0x8ComputedData.spacingX" :col="tListCardx0x8ComputedData.col" :direction="tListCardx0x8ComputedData.direction" :exchange-order="tListCardx0x8ComputedData.exchangeOrder" :unit-break="tListCardx0x8ComputedData.unitBreak" :key-field="tListCardx0x8ComputedData.keyField" :active-key-field="tListCardx0x8ComputedData.activeKeyField" :active="tListCardx0x8ComputedData.active" :c-style="tListCardx0x8ComputedData.cStyle">` +
`</t-list-card>` +
`</div>` +
'',
setup() {

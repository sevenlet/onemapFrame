...
//   // 添加浏览器检测
//   const isQianxin = /QiAnXin|国产浏览器/i.test(navigator.userAgent);
//
...
//       // 奇安信浏览器特殊处理：排除包含特殊字符的字符串
//       if (isQianxin && (value.includes('://') || value.includes('\\'))) {
//         console.log(`[奇安信] 跳过处理可能包含路径的字符串: ${value.substring(0, 50)}...`);
//         continue;
//       }
//
//       try {
...
//             // 严格验证匹配内容
//             const varMatch = match.match(/var\((--[a-zA-Z0-9-_]+)\)/);
//             if (!varMatch) continue;
//
//             const varName = varMatch[1];
//             const computedValue = getComputedStyle(
//                 document.querySelector('.' + activeThemeName)

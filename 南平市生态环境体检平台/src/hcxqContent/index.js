window.hcxqContentComponent = {
template: 
`<div id="t-l-c-hcxqContent" class="t-l-c-hcxqContent" >` +
`<t-rect id="t-rect-0aaf.a87f17f18" class="hcxqContent-t-rect-0-1"  :tip="tRectx0x1ComputedData.tip" :label="tRectx0x1ComputedData.label" :active="tRectx0x1ComputedData.active" :c-style="tRectx0x1ComputedData.cStyle">` +
`</t-rect>` +
`<t-text id="t-text-1bbc.292a467e2" class="hcxqContent-t-text-0-3"  :label="tTextx0x3ComputedData.label" :editable="tTextx0x3ComputedData.editable" :c-style="tTextx0x3ComputedData.cStyle" @click="onclick1733723979280">` +
`</t-text>` +
`<t-rect id="t-rect-b8a7.3fc5f52df" class="hcxqContent-t-rect-0-4"  :tip="tRectx0x4ComputedData.tip" :label="tRectx0x4ComputedData.label" :active="tRectx0x4ComputedData.active" :c-style="tRectx0x4ComputedData.cStyle">` +
`</t-rect>` +
`<t-text v-if="state.isShowZbBtn === true" id="t-text-9552.977d6bf1e" class="hcxqContent-t-text-0-5"  :label="tTextx0x5ComputedData.label" :editable="tTextx0x5ComputedData.editable" :c-style="tTextx0x5ComputedData.cStyle" @click="onclick1739431382209">` +
`</t-text>` +
`<t-text id="t-text-acb9.15027a88a" class="hcxqContent-t-text-0-6"  :label="replaceCssVariables(filterData(state.title, componentPropBindingMap?.['t-text-acb9.15027a88a']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x6ComputedData.editable" :c-style="tTextx0x6ComputedData.cStyle">` +
`</t-text>` +
`<t-row id="t-row-c50a.301db8efb" class="hcxqContent-t-row-0-7"  :c-style="tRowx0x7ComputedData.cStyle" :gutter="tRowx0x7ComputedData.gutter" :justify="tRowx0x7ComputedData.justify" :align="tRowx0x7ComputedData.align">` +
`<t-col id="t-col-5d72.59d31e59b" class="hcxqContent-t-col-0-7-0"  :span="tColx0x7x0ComputedData.span" :offset="tColx0x7x0ComputedData.offset" :push="tColx0x7x0ComputedData.push" :pull="tColx0x7x0ComputedData.pull" :c-style="tColx0x7x0ComputedData.cStyle">` +
`<t-component id="t-component-1eec.5c6224087" class="hcxqContent-t-component-0-7-0-0"  :name="tComponentx0x7x0x0ComputedData.name" :c-style="tComponentx0x7x0x0ComputedData.cStyle" :src="tComponentx0x7x0x0ComputedData.src" :component-name="tComponentx0x7x0x0ComputedData.componentName">` +
`</t-component>` +
`<t-row id="t-row-5b17.f6acfd933" class="hcxqContent-t-row-0-7-0-1"  :c-style="tRowx0x7x0x1ComputedData.cStyle" :gutter="tRowx0x7x0x1ComputedData.gutter" :justify="tRowx0x7x0x1ComputedData.justify" :align="tRowx0x7x0x1ComputedData.align">` +
`<t-row id="t-row-2af4.0e5e2161d" class="hcxqContent-t-row-0-7-0-1-0"  :c-style="tRowx0x7x0x1x0ComputedData.cStyle" :gutter="tRowx0x7x0x1x0ComputedData.gutter" :justify="tRowx0x7x0x1x0ComputedData.justify" :align="tRowx0x7x0x1x0ComputedData.align">` +
`<t-col id="t-col-6c4c.d5dadb006" class="hcxqContent-t-col-0-7-0-1-0-0"  :span="tColx0x7x0x1x0x0ComputedData.span" :offset="tColx0x7x0x1x0x0ComputedData.offset" :push="tColx0x7x0x1x0x0ComputedData.push" :pull="tColx0x7x0x1x0x0ComputedData.pull" :c-style="tColx0x7x0x1x0x0ComputedData.cStyle">` +
`<t-gradient-text id="t-gradient-text-589d.0f1fcc305" class="hcxqContent-t-gradient-text-0-7-0-1-0-0-2"  :label="replaceCssVariables(filterData(state.gsText, componentPropBindingMap?.['t-gradient-text-589d.0f1fcc305']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :c-style="tGradientTextx0x7x0x1x0x0x2ComputedData.cStyle" :color-style="tGradientTextx0x7x0x1x0x0x2ComputedData.colorStyle">` +
`</t-gradient-text>` +
`</t-col>` +
`<t-col id="t-col-c050.9d0c1facb" class="hcxqContent-t-col-0-7-0-1-0-1"  :span="tColx0x7x0x1x0x1ComputedData.span" :offset="tColx0x7x0x1x0x1ComputedData.offset" :push="tColx0x7x0x1x0x1ComputedData.push" :pull="tColx0x7x0x1x0x1ComputedData.pull" :c-style="tColx0x7x0x1x0x1ComputedData.cStyle">` +
...
`</t-row>` +
`</t-col>` +
`<t-col id="t-col-106f.ba830e7ca" class="hcxqContent-t-col-0-7-1"  :span="tColx0x7x1ComputedData.span" :offset="tColx0x7x1ComputedData.offset" :push="tColx0x7x1ComputedData.push" :pull="tColx0x7x1ComputedData.pull" :c-style="tColx0x7x1ComputedData.cStyle">` +
`<t-component id="t-component-dec2.ca94a3863" class="hcxqContent-t-component-0-7-1-0"  :name="tComponentx0x7x1x0ComputedData.name" :c-style="tComponentx0x7x1x0ComputedData.cStyle" :src="tComponentx0x7x1x0ComputedData.src" :component-name="tComponentx0x7x1x0ComputedData.componentName">` +
`</t-component>` +
`</t-col>` +
`<t-col id="t-col-11de.d6b98626c" class="hcxqContent-t-col-0-7-2"  :span="tColx0x7x2ComputedData.span" :offset="tColx0x7x2ComputedData.offset" :push="tColx0x7x2ComputedData.push" :pull="tColx0x7x2ComputedData.pull" :c-style="tColx0x7x2ComputedData.cStyle">` +
`<t-component id="t-component-5ec0.691253232" class="hcxqContent-t-component-0-7-2-0"  :name="tComponentx0x7x2x0ComputedData.name" :c-style="tComponentx0x7x2x0ComputedData.cStyle" :src="tComponentx0x7x2x0ComputedData.src" :component-name="tComponentx0x7x2x0ComputedData.componentName">` +
`</t-component>` +
`</t-col>` +
`</t-row>` +
`<t-select id="t-select-237c.acd743eb4" class="hcxqContent-t-select-0-8"  :active-value="replaceCssVariables(filterData(state.selectType, componentPropBindingMap?.['t-select-237c.acd743eb4']['activeValue'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :options="tSelectx0x8ComputedData.options" :alias="tSelectx0x8ComputedData.alias" :multiple="tSelectx0x8ComputedData.multiple" :placeholder="tSelectx0x8ComputedData.placeholder" :clearable="tSelectx0x8ComputedData.clearable" :disabled="tSelectx0x8ComputedData.disabled" :name="tSelectx0x8ComputedData.name" :autocomplete="tSelectx0x8ComputedData.autocomplete" :filterable="tSelectx0x8ComputedData.filterable" :no-match-text="tSelectx0x8ComputedData.no-match-text" :no-data-text="tSelectx0x8ComputedData.no-data-text" :c-style="tSelectx0x8ComputedData.cStyle" @change="onchange1759133742094">` +
`</t-select>` +

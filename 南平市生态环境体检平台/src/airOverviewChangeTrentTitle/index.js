window.airOverviewChangeTrentTitleComponent = {
template: 
`<div id="t-l-c-airOverviewChangeTrentTitle" class="t-l-c-airOverviewChangeTrentTitle" >` +
`<t-component id="t-component-6f3b.f3ecc4cb7" class="airOverviewChangeTrentTitle-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName">` +
`</t-component>` +
`<t-text id="t-text-4f12.f427f5fe7" class="airOverviewChangeTrentTitle-t-text-0-1"  :label="tTextx0x1ComputedData.label" :editable="tTextx0x1ComputedData.editable" :c-style="tTextx0x1ComputedData.cStyle">` +
`</t-text>` +
`<t-text v-if="state.showViewBtn === true" id="t-text-bf3c.aa9117237" class="airOverviewChangeTrentTitle-t-text-0-2"  :label="tTextx0x2ComputedData.label" :editable="tTextx0x2ComputedData.editable" :c-style="tTextx0x2ComputedData.cStyle" @click="onclick1734683104725">` +
`</t-text>` +
`</div>` +
'',
setup() {

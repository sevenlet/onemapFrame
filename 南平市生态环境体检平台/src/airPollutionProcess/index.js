window.airPollutionProcessComponent = {
template: 
`<div id="t-l-c-airPollutionProcess" class="t-l-c-airPollutionProcess" >` +
`<t-iframe id="t-iframe-6002.d14315adf" class="airPollutionProcess-t-iframe-0-0"  :src="tIframex0x0ComputedData.src" :srcdoc="tIframex0x0ComputedData.srcdoc" :scrolling="tIframex0x0ComputedData.scrolling" :c-style="tIframex0x0ComputedData.cStyle" :socket-url="global.socketIp" :room-id="global.socketRoom">` +
`</t-iframe>` +
`<t-text id="t-text-f200.dfce082f3" class="airPollutionProcess-t-text-0-1"  :label="state.desc" :editable="tTextx0x1ComputedData.editable" :c-style="tTextx0x1ComputedData.cStyle" :show-title="tTextx0x1ComputedData.showTitle">` +
`</t-text>` +
`<t-text id="t-text-7ae7.e251d640f" class="airPollutionProcess-t-text-0-2"  :label="tTextx0x2ComputedData.label" :editable="tTextx0x2ComputedData.editable" :c-style="tTextx0x2ComputedData.cStyle" :show-title="tTextx0x2ComputedData.showTitle" @click="onclick1734493554906">` +
`</t-text>` +
`</div>` +
'',
setup() {

window.scyzBaseinfoBackupComponent = {
template: 
`<div id="t-l-c-scyzBaseinfoBackup" class="t-l-c-scyzBaseinfoBackup" >` +
`<t-list-card id="t-list-card-0032.f5836da41" class="scyzBaseInformation-t-list-card-0-0"  :data="replaceCssVariables(filterData(state.baseInfoData, componentPropBindingMap?.['t-list-card-0032.f5836da41']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :spacing-x="tListCardx0x0ComputedData.spacingX" :col="tListCardx0x0ComputedData.col" :direction="tListCardx0x0ComputedData.direction" :exchange-order="tListCardx0x0ComputedData.exchangeOrder" :unit-break="tListCardx0x0ComputedData.unitBreak" :key-field="tListCardx0x0ComputedData.keyField" :active-key-field="tListCardx0x0ComputedData.activeKeyField" :active="tListCardx0x0ComputedData.active" :c-style="tListCardx0x0ComputedData.cStyle">` +
`</t-list-card>` +
`<t-row id="t-row-3ae9.949fc1c3b" class="scyzBaseInformation-t-row-0-1"  :c-style="tRowx0x1ComputedData.cStyle" :gutter="tRowx0x1ComputedData.gutter" :justify="tRowx0x1ComputedData.justify" :align="tRowx0x1ComputedData.align">` +
`<t-col id="t-col-facf.ef4316657" class="scyzBaseInformation-t-col-0-1-0"  :span="tColx0x1x0ComputedData.span" :offset="tColx0x1x0ComputedData.offset" :push="tColx0x1x0ComputedData.push" :pull="tColx0x1x0ComputedData.pull" :c-style="tColx0x1x0ComputedData.cStyle">` +
`<t-text id="t-text-6063.4db73323" class="scyzBaseInformation-t-text-0-1-0-0"  :label="tTextx0x1x0x0ComputedData.label" :editable="tTextx0x1x0x0ComputedData.editable" :c-style="tTextx0x1x0x0ComputedData.cStyle">` +
`</t-text>` +
`<t-tabs-base id="t-tabs-base-bb7d.4596104d4" class="scyzBaseInformation-t-tabs-base-0-1-0-1"  :data="replaceCssVariables(filterData(state.dateList, componentPropBindingMap?.['t-tabs-base-bb7d.4596104d4']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :space="tTabsBasex0x1x0x1ComputedData.space" :selected-tab-val="replaceCssVariables(filterData(state.tabSelect, componentPropBindingMap?.['t-tabs-base-bb7d.4596104d4']['selectedTabVal'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :inner-shadow-color="tTabsBasex0x1x0x1ComputedData.innerShadowColor" :active-inner-shadow-color="tTabsBasex0x1x0x1ComputedData.activeInnerShadowColor" :alias="tTabsBasex0x1x0x1ComputedData.alias" :c-style="tTabsBasex0x1x0x1ComputedData.cStyle" @tab-click="ontabClick1767581775067_0_0">` +
`</t-tabs-base>` +
`<t-date-picker v-if="state.tabSelect === 'hour'" id="t-date-picker-61ed.bd81974e" class="scyzBaseInformation-t-date-picker-0-1-0-2"  :placeholder="tDatePickerx0x1x0x2ComputedData.placeholder" :start-placeholder="tDatePickerx0x1x0x2ComputedData.startPlaceholder" :end-placeholder="tDatePickerx0x1x0x2ComputedData.endPlaceholder" :type="replaceCssVariables(filterData(state.dateType, componentPropBindingMap?.['t-date-picker-61ed.bd81974e']['type'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :clearable="tDatePickerx0x1x0x2ComputedData.clearable" :range-separator="tDatePickerx0x1x0x2ComputedData.rangeSeparator" :default-date="replaceCssVariables(filterData(state.timeRange, componentPropBindingMap?.['t-date-picker-61ed.bd81974e']['default-date'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :separator="tDatePickerx0x1x0x2ComputedData.separator" :readonly="tDatePickerx0x1x0x2ComputedData.readonly" :editable="tDatePickerx0x1x0x2ComputedData.editable" :c-style="tDatePickerx0x1x0x2ComputedData.cStyle" @date-change="ondateChange1769151528091_0_0">` +
`</t-date-picker>` +
`<t-date-picker v-if="state.tabSelect === 'minute'" id="t-date-picker-fa39.f1f4b1652" class="scyzBaseInformation-t-date-picker-0-1-0-3"  :placeholder="tDatePickerx0x1x0x3ComputedData.placeholder" :start-placeholder="tDatePickerx0x1x0x3ComputedData.startPlaceholder" :end-placeholder="tDatePickerx0x1x0x3ComputedData.endPlaceholder" :type="tDatePickerx0x1x0x3ComputedData.type" :clearable="tDatePickerx0x1x0x3ComputedData.clearable" :range-separator="tDatePickerx0x1x0x3ComputedData.rangeSeparator" :default-date="replaceCssVariables(filterData(state.timeRange, componentPropBindingMap?.['t-date-picker-fa39.f1f4b1652']['default-date'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :separator="tDatePickerx0x1x0x3ComputedData.separator" :readonly="tDatePickerx0x1x0x3ComputedData.readonly" :editable="tDatePickerx0x1x0x3ComputedData.editable" :c-style="tDatePickerx0x1x0x3ComputedData.cStyle" @date-change="ondateChange1767948867605_0_0">` +
`</t-date-picker>` +
`<t-date-picker v-if="state.tabSelect === 'day'" id="t-date-picker-d90a.f32e32cda" class="scyzBaseInformation-t-date-picker-0-1-0-4"  :placeholder="tDatePickerx0x1x0x4ComputedData.placeholder" :start-placeholder="tDatePickerx0x1x0x4ComputedData.startPlaceholder" :end-placeholder="tDatePickerx0x1x0x4ComputedData.endPlaceholder" :type="tDatePickerx0x1x0x4ComputedData.type" :clearable="tDatePickerx0x1x0x4ComputedData.clearable" :range-separator="tDatePickerx0x1x0x4ComputedData.rangeSeparator" :default-date="replaceCssVariables(filterData(state.timeRange, componentPropBindingMap?.['t-date-picker-d90a.f32e32cda']['default-date'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :separator="tDatePickerx0x1x0x4ComputedData.separator" :readonly="tDatePickerx0x1x0x4ComputedData.readonly" :editable="tDatePickerx0x1x0x4ComputedData.editable" :c-style="tDatePickerx0x1x0x4ComputedData.cStyle" @date-change="ondateChange1767779170144_0_0">` +
`</t-date-picker>` +
`</t-col>` +
`<t-col id="t-col-5c12.21387b6cc" class="scyzBaseInformation-t-col-0-1-1"  :span="tColx0x1x1ComputedData.span" :offset="tColx0x1x1ComputedData.offset" :push="tColx0x1x1ComputedData.push" :pull="tColx0x1x1ComputedData.pull" :c-style="tColx0x1x1ComputedData.cStyle">` +
`<t-select id="t-select-3fcb.c00f74209" class="scyzBaseInformation-t-select-0-1-1-0"  :active-value="replaceCssVariables(filterData(state.currentPolluter, componentPropBindingMap?.['t-select-3fcb.c00f74209']['activeValue'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :options="replaceCssVariables(filterData(state.polluteList, componentPropBindingMap?.['t-select-3fcb.c00f74209']['options'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :alias="tSelectx0x1x1x0ComputedData.alias" :multiple="tSelectx0x1x1x0ComputedData.multiple" :placeholder="tSelectx0x1x1x0ComputedData.placeholder" :clearable="tSelectx0x1x1x0ComputedData.clearable" :disabled="tSelectx0x1x1x0ComputedData.disabled" :name="tSelectx0x1x1x0ComputedData.name" :autocomplete="tSelectx0x1x1x0ComputedData.autocomplete" :filterable="tSelectx0x1x1x0ComputedData.filterable" :no-match-text="tSelectx0x1x1x0ComputedData.no-match-text" :no-data-text="tSelectx0x1x1x0ComputedData.no-data-text" :c-style="tSelectx0x1x1x0ComputedData.cStyle" @change="onchange1733973555614">` +
`</t-select>` +
`</t-col>` +
`</t-row>` +
`<t-row id="t-row-bed0.5ca83a488" class="scyzBaseInformation-t-row-0-2"  :c-style="tRowx0x2ComputedData.cStyle" :gutter="tRowx0x2ComputedData.gutter" :justify="tRowx0x2ComputedData.justify" :align="tRowx0x2ComputedData.align">` +
`<t-text id="t-text-b39c.b6c03321c" class="scyzBaseInformation-t-text-0-2-0"  :label="tTextx0x2x0ComputedData.label" :editable="tTextx0x2x0ComputedData.editable" :c-style="tTextx0x2x0ComputedData.cStyle">` +
`</t-text>` +
`</t-row>` +
`<t-chart-line-single id="t-chart-line-single-66ab.046d9e183" class="scyzBaseInformation-t-chart-line-single-0-3"  :empty-img="replaceCssVariables(filterData(state.noDataImg, componentPropBindingMap?.['t-chart-line-single-66ab.046d9e183']['emptyImg'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :c-style="tChartLineSinglex0x3ComputedData.cStyle" :show-item-bg="tChartLineSinglex0x3ComputedData.showItemBg" :options="tChartLineSinglex0x3ComputedData.options" :data="replaceCssVariables(filterData(state.chartList, componentPropBindingMap?.['t-chart-line-single-66ab.046d9e183']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :series-setting="tChartLineSinglex0x3ComputedData.seriesSetting" :line="componentState.tChartLineSinglex0x3.line">` +
`</t-chart-line-single>` +
`<t-text v-if="state.chartList.length !== 0" id="t-text-f8f0.bc97393c" class="scyzBaseInformation-t-text-0-4"  :label="replaceCssVariables(filterData(state.chartUint, componentPropBindingMap?.['t-text-f8f0.bc97393c']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x4ComputedData.editable" :c-style="tTextx0x4ComputedData.cStyle">` +
`</t-text>` +
`<t-component id="t-component-c019.99b6d840a" class="scyzBaseInformation-t-component-0-5"  :name="tComponentx0x5ComputedData.name" :c-style="tComponentx0x5ComputedData.cStyle" :src="tComponentx0x5ComputedData.src" :component-name="tComponentx0x5ComputedData.componentName" :page-id="tComponentx0x5ComputedData.pageId" :page-code="tComponentx0x5ComputedData.pageCode">` +
`</t-component>` +
`<t-text id="t-text-62b3.48b14905c" class="scyzBaseInformation-t-text-0-6"  :label="tTextx0x6ComputedData.label" :editable="tTextx0x6ComputedData.editable" :c-style="tTextx0x6ComputedData.cStyle">` +
`</t-text>` +
`</div>` +
'',
setup() {
const componentPropBindingMap = {"body":{"attributeName":"tBodyx0x0"},"t-list-card-0032.f5836da41":{"attributeName":"tListCardx0x0","data":{"filters":[]},"spacingX":{"filters":[]},"col":{"filters":[]},"direction":{"filters":[]},"exchangeOrder":{"filters":[]},"unitBreak":{"filters":[]},"keyField":{"filters":[]},"activeKeyField":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-row-3ae9.949fc1c3b":{"attributeName":"tRowx0x1","cStyle":{"filters":[]},"gutter":{"filters":[]},"justify":{"filters":[]},"align":{"filters":[]}},"t-col-facf.ef4316657":{"attributeName":"tColx0x1x0","span":{"filters":[]},"offset":{"filters":[]},"push":{"filters":[]},"pull":{"filters":[]},"cStyle":{"filters":[]}},"t-text-6063.4db73323":{"attributeName":"tTextx0x1x0x0","label":{"filters":[]},"editable":{"filters":[]},"cStyle":{"filters":[]}},"t-tabs-base-bb7d.4596104d4":{"attributeName":"tTabsBasex0x1x0x1","data":{"filters":[]},"space":{"filters":[]},"selectedTabVal":{"filters":[]},"innerShadowColor":{"filters":[]},"activeInnerShadowColor":{"filters":[]},"alias":{"filters":[]},"cStyle":{"filters":[]}},"t-date-picker-61ed.bd81974e":{"attributeName":"tDatePickerx0x1x0x2","placeholder":{"filters":[]},"startPlaceholder":{"filters":[]},"endPlaceholder":{"filters":[]},"type":{"filters":[]},"clearable":{"filters":[]},"rangeSeparator":{"filters":[]},"default-date":{"filters":[]},"separator":{"filters":[]},"readonly":{"filters":[]},"editable":{"filters":[]},"cStyle":{"filters":[]}},"t-date-picker-fa39.f1f4b1652":{"attributeName":"tDatePickerx0x1x0x3","placeholder":{"filters":[]},"startPlaceholder":{"filters":[]},"endPlaceholder":{"filters":[]},"type":{"filters":[]},"clearable":{"filters":[]},"rangeSeparator":{"filters":[]},"default-date":{"filters":[]},"separator":{"filters":[]},"readonly":{"filters":[]},"editable":{"filters":[]},"cStyle":{"filters":[]}},"t-date-picker-d90a.f32e32cda":{"attributeName":"tDatePickerx0x1x0x4","placeholder":{"filters":[]},"startPlaceholder":{"filters":[]},"endPlaceholder":{"filters":[]},"type":{"filters":[]},"clearable":{"filters":[]},"rangeSeparator":{"filters":[]},"default-date":{"filters":[]},"separator":{"filters":[]},"readonly":{"filters":[]},"editable":{"filters":[]},"cStyle":{"filters":[]}},"t-col-5c12.21387b6cc":{"attributeName":"tColx0x1x1","span":{"filters":[]},"offset":{"filters":[]},"push":{"filters":[]},"pull":{"filters":[]},"cStyle":{"filters":[]}},"t-select-3fcb.c00f74209":{"attributeName":"tSelectx0x1x1x0","activeValue":{"filters":[]},"options":{"filters":[]},"alias":{"filters":[]},"multiple":{"filters":[]},"placeholder":{"filters":[]},"clearable":{"filters":[]},"disabled":{"filters":[]},"name":{"filters":[]},"autocomplete":{"filters":[]},"filterable":{"filters":[]},"no-match-text":{"filters":[]},"no-data-text":{"filters":[]},"cStyle":{"filters":[]}},"t-row-bed0.5ca83a488":{"attributeName":"tRowx0x2","cStyle":{"filters":[]},"gutter":{"filters":[]},"justify":{"filters":[]},"align":{"filters":[]}},"t-text-b39c.b6c03321c":{"attributeName":"tTextx0x2x0","label":{"filters":[]},"editable":{"filters":[]},"cStyle":{"filters":[]}},"t-chart-line-single-66ab.046d9e183":{"attributeName":"tChartLineSinglex0x3","emptyImg":{"filters":[]},"cStyle":{"filters":[]},"showItemBg":{"filters":[]},"options":{"filters":[]},"data":{"filters":[]},"seriesSetting":{"filters":[]}},"t-text-f8f0.bc97393c":{"attributeName":"tTextx0x4","label":{"filters":[]},"editable":{"filters":[]},"cStyle":{"filters":[]}},"t-component-c019.99b6d840a":{"attributeName":"tComponentx0x5","name":{"filters":[]},"cStyle":{"filters":[]},"src":{"filters":[]},"componentName":{"filters":[]},"pageId":{"filters":[]},"pageCode":{"filters":[]}},"t-text-62b3.48b14905c":{"attributeName":"tTextx0x6","label":{"filters":[]},"editable":{"filters":[]},"cStyle":{"filters":[]}}};
// 页面内注入全局变量和事件
...
const state = Vue.reactive({
   screenSize: "",
   currentPolluter: "",
   interfaceIdMap: {"minute":"3d169bcc5b5689b8f1af6a8921d112ad","hour":"5b5bc7ea00286f5ce06d67bda39ba161","day":"7f3f1c7281fe7c6cda733c3de4dfba76"},
   chartUint: "浓度（mg/L）",
...
tListCardx0x0: {
defaultStyle: {
            default: {"width":"100%","height":"73px","position":"unset","left":"0px","top":"0px","overflow":"visible","animationName":""},
...
tTextx0x1x0x0: {
defaultStyle: {
            default: {"width":"240px","height":"32px","color":"rgba(255, 255, 255, 1)","lineHeight":"32px","fontSize":"var(--text-size-14)","fontFamily":"方正综艺","top":"174px","left":"0px","position":"unset","textAlign":"left","marginLeft":"15px","marginRight":"10px"},
...
label:"污染物变化趋势",
editable:false,
cStyle:{"wrapper":{"default":{"width":"240px","height":"32px","color":"rgba(255, 255, 255, 1)","lineHeight":"32px","fontSize":"var(--text-size-14)","fontFamily":"方正综艺","top":"174px","left":"0px","position":"unset","textAlign":"left","marginLeft":"15px","marginRight":"10px"}},"cardValue":{"default":{"fontSize":"var(--text-size-14)"}}}, 
 },
},
tTabsBasex0x1x0x1: {
defaultStyle: {
...
data:[{"label":"分钟","value":"minute"},{"label":"小时","value":"hour"},{"label":"日","value":"day"}],
space:1,
selectedTabVal:"hour",
...
tDatePickerx0x1x0x2: {
defaultStyle: {
            default: {"width":"380px","height":"32px","position":"unset","left":"424px","top":"314px","--t-date-picker-input-placeholder-color":"var(--business-text-avianize) !important","--t-date-picker-splitline-color":"var(--business-show-bg50) !important","borderLeft":"1px solid var(--business-show-bg50)","borderTop":"1px solid var(--business-show-bg50)","borderRight":"1px solid var(--business-show-bg50)","borderBottom":"1px solid var(--business-show-bg50)","borderTopLeftRadius":"4px","borderTopRightRadius":"4px","borderBottomLeftRadius":"4px","borderBottomRightRadius":"4px","overflow":"hidden","animationName":""},
...
tChartLineSinglex0x3: {
defaultStyle: {
            default: {"width":"100%","height":"calc(100% - 243px)","position":"unset","left":"0px","top":"243px"},
...
cStyle:{"wrapper":{"default":{"width":"100%","height":"calc(100% - 243px)","position":"unset","left":"0px","top":"243px"}},"emptyText":{"default":{"fontSize":"14px","width":"auto","color":"rgba(255, 255, 255, 1)"}}},
showItemBg:false,
...
data:[],
seriesSetting:{"xAxisLabel":"MONITORING_TIME","data":[{"name":"浓度","dataKey":"value","style":{"label":{"show":false},"symbolSize":[4,4],"symbol":"none"}}]}, 
 },
},
tTextx0x4: {
defaultStyle: {
            default: {"width":"144px","height":"32px","color":"var(--business-text-avianize)","lineHeight":"32px","fontSize":"var(--text-size-14)","fontFamily":"方正综艺","top":"209px","left":"-18px","position":"unset","textAlign":"left","marginLeft":"20px","animationName":""},
...
label:"浓度（mg/L）",
editable:false,
cStyle:{"wrapper":{"default":{"width":"144px","height":"32px","color":"var(--business-text-avianize)","lineHeight":"32px","fontSize":"var(--text-size-14)","fontFamily":"方正综艺","top":"209px","left":"-18px","position":"unset","textAlign":"left","marginLeft":"20px","animationName":""}},"cardValue":{"default":{"fontSize":"var(--text-size-14)"}}}, 
 },
},
tComponentx0x5: {
defaultStyle: {
...
tTextx0x6: {
defaultStyle: {
            default: {"width":"130px","height":"20px","color":"rgba(255, 255, 255, 0.9)","position":"unset","left":"38px","top":"86px","fontFamily":"方正综艺","fontSize":"var(--text-size-14)","animationName":"","lineHeight":"20px"},
...
label:"水质监测信息",
editable:false,
cStyle:{"wrapper":{"default":{"width":"130px","height":"20px","color":"rgba(255, 255, 255, 0.9)","position":"unset","left":"38px","top":"86px","fontFamily":"方正综艺","fontSize":"var(--text-size-14)","animationName":"","lineHeight":"20px"}}}, 
 },
},
});
const initPageData = () => {
// 处理参数
state.tabSelect = 'minute'
...
async function getData (){
  ...
  await apiRegistry.getLineData.request(state.interfaceIdMap[state.tabSelect]);
}
getData()
};
const setNoDataIcon = () => {
...
apiRegistry.getLineData.request(state.interfaceIdMap[state.tabSelect]);
};
const handleDate = (date) => {
state.endTime = date
if (state.tabSelect === 'minute') {
  const endTime = date + ':00'
  state.startTime = getPrevTime(endTime, 'minute').slice(0, 16)
} else if (state.tabSelect === 'hour') {
  const endTime = date + ':00:00'
  state.startTime = getPrevTime(endTime, 'hour').slice(0, 13)
} else if (state.tabSelect === 'day') {
  const endTime = date + ' 00:00:00'
  state.startTime = getPrevTime(endTime, 'day').slice(0, 10)
}
...
console.log(state.chartList)
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-scyzBaseinfoBackup', global.appScaleMode, 'normal');
...
window.removeEventListener('resize', handleWindowResize);
 ...
 const tTabsBasex0x1x0x1ComputedData = computed(() => _.merge({}, componentState.tTabsBasex0x1x0x1.default, componentState.tTabsBasex0x1x0x1?.[state.screenSize]));
 ...
 const tDatePickerx0x1x0x4ComputedData = computed(() => _.merge({}, componentState.tDatePickerx0x1x0x4.default, componentState.tDatePickerx0x1x0x4?.[state.screenSize]));
 ...
 const tSelectx0x1x1x0ComputedData = computed(() => _.merge({}, componentState.tSelectx0x1x1x0.default, componentState.tSelectx0x1x1x0?.[state.screenSize]));
 ...
 const tChartLineSinglex0x3ComputedData = computed(() => replaceCssVariables(_.merge({}, componentState.tChartLineSinglex0x3.default, componentState.tChartLineSinglex0x3?.[state.screenSize]), global?.theme || global?.activeTheme || '默认主题'));

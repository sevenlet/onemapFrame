window.xqContentComponent = {
template: 
`<div id="t-l-c-xqContent" class="t-l-c-xqContent" >` +
`<t-component id="t-component-aa14.3ba955fbb" class="xqContent-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName">` +
`</t-component>` +
`<t-text-unit id="t-text-unit-a3c4.48c326f87" class="xqContent-t-text-unit-0-1"  :c-style="tTextUnitx0x1ComputedData.cStyle" :justify="tTextUnitx0x1ComputedData.justify" :align="tTextUnitx0x1ComputedData.align" :content="tTextUnitx0x1ComputedData.content" :unit="tTextUnitx0x1ComputedData.unit" :show-overflow-tooltip="tTextUnitx0x1ComputedData.showOverflowTooltip">` +
`</t-text-unit>` +
`<t-component id="t-component-d475.408beec3" class="xqContent-t-component-0-2"  :name="tComponentx0x2ComputedData.name" :loading="tComponentx0x2ComputedData.loading" :c-style="tComponentx0x2ComputedData.cStyle" :src="tComponentx0x2ComputedData.src" :component-name="tComponentx0x2ComputedData.componentName" :page-id="tComponentx0x2ComputedData.pageId" :page-code="tComponentx0x2ComputedData.pageCode">` +
`</t-component>` +
`</div>` +
'',
setup() {
...
name:"xqContentListComponent",
loading:true,
cStyle:{"wrapper":{"default":{"width":"410px","height":"800px","margin":"0 auto","position":"unset","left":"0px","top":"51px"}}},
src:"/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/index.html#/xqContentList",
componentName:"xqContentListComponent",
pageId:"852b6452a9784816b46899d7f06c2b21",
pageCode:"xqContentList", 
 },
},
});let apiRegistry = {}; 

 function handleWindowResize() {
                            setPageScale('t-l-c-xqContent', global.appScaleMode, 'normal');

window.timeAxisComponent = {
template: 
`<div id="t-l-c-timeAxis" class="t-l-c-timeAxis" >` +
`<t-timeline-base v-if="state.timeAxisData.length !== 0" id="t-timeline-base-19f5.2aa7dc2c1" class="timeAxis-t-timeline-base-0-0"  :time-data="replaceCssVariables(filterData(state.timeAxisData, componentPropBindingMap?.['t-timeline-base-19f5.2aa7dc2c1']['timeData'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :control-button-info="tTimelineBasex0x0ComputedData.controlButtonInfo" :second-tick="tTimelineBasex0x0ComputedData.secondTick" :time-colors="tTimelineBasex0x0ComputedData.timeColors" :cur-time="replaceCssVariables(filterData(state.timeAxisSelect, componentPropBindingMap?.['t-timeline-base-19f5.2aa7dc2c1']['curTime'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :auto-play="tTimelineBasex0x0ComputedData.autoPlay" :loop="tTimelineBasex0x0ComputedData.loop" :play-interval="tTimelineBasex0x0ComputedData.playInterval" :interval="tTimelineBasex0x0ComputedData.interval" :step-button-visible="tTimelineBasex0x0ComputedData.stepButtonVisible" :inverse="tTimelineBasex0x0ComputedData.inverse" :immediate-trigger="tTimelineBasex0x0ComputedData.immediateTrigger" :step-button-color="tTimelineBasex0x0ComputedData.stepButtonColor" :c-style="tTimelineBasex0x0ComputedData.cStyle" @time-change="ontimeChange1734663371565">` +
`</t-timeline-base>` +
`</div>` +
'',
setup() {
const componentPropBindingMap = {"body":{"attributeName":"tBodyx0x0"},"t-timeline-base-19f5.2aa7dc2c1":{"attributeName":"tTimelineBasex0x0","timeData":{"filters":[]},"controlButtonInfo":{"filters":[]},"secondTick":{"filters":[]},"timeColors":{"filters":[]},"curTime":{"filters":[]},"autoPlay":{"filters":[]},"loop":{"filters":[]},"playInterval":{"filters":[]},"interval":{"filters":[]},"stepButtonVisible":{"filters":[]},"inverse":{"filters":[]},"immediateTrigger":{"filters":[]},"stepButtonColor":{"filters":[]},"cStyle":{"filters":[]}}};
// 页面内注入全局变量和事件
...
tTimelineBasex0x0: {
defaultStyle: {
            default: {"width":"1065px","height":"76px","top":"24px","left":"0px","backgroundColor":"var(--business-panel-bg)","borderTopLeftRadius":"33px","borderTopRightRadius":"33px","borderBottomLeftRadius":"33px","borderBottomRightRadius":"33px","borderLeft":"2px solid var(--business-show-bg30)","borderTop":"2px solid var(--business-show-bg30)","borderRight":"2px solid var(--business-show-bg30)","borderBottom":"2px solid var(--business-show-bg30)","position":"unset","paddingTop":"0px"},
            
            },
 default: { 
 
timeData:[],
controlButtonInfo:{"playImgUrl":"http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/assets/images/2024-12-20/b6d7b52010d3415b90335bc266c109bf.png","pauseImgUrl":"http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/assets/images/2024-12-20/3e0cd813eee6470bb956f0ea30cfbde1.png","hoverPlayUrl":"http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/assets/images/2024-12-20/b6d7b52010d3415b90335bc266c109bf.png","hoverPauseUrl":"http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/assets/images/2024-12-20/3e0cd813eee6470bb956f0ea30cfbde1.png"},
secondTick:false,
timeColors:[],
curTime:"",
autoPlay:false,
...
cStyle:{"wrapper":{"default":{"width":"1065px","height":"76px","top":"24px","left":"0px","backgroundColor":"var(--business-panel-bg)","borderTopLeftRadius":"33px","borderTopRightRadius":"33px","borderBottomLeftRadius":"33px","borderBottomRightRadius":"33px","borderLeft":"2px solid var(--business-show-bg30)","borderTop":"2px solid var(--business-show-bg30)","borderRight":"2px solid var(--business-show-bg30)","borderBottom":"2px solid var(--business-show-bg30)","position":"unset","paddingTop":"0px"}},"controlButtonPlay":{"default":{"width":"42px","height":"42px","marginTop":"0px"}},"controlButtonPause":{"default":{"width":"42px","height":"42px","marginTop":"0px"}},"axisLabel":{"default":{"fontSize":"var(--business-text-size-14)","color":"var(--business-white)","marginTop":"4px"}},"axisFirstLevelItem":{"default":{"color":"var(--t-white)","width":"2px","height":"4px","backgroundColor":"var(--t-white)","marginBottom":"4px"}},"axisLineProgressWrappper":{"default":{"backgroundColor":"var(--business-show-bg30)","borderTopLeftRadius":"4px","borderTopRightRadius":"4px","borderBottomLeftRadius":"4px","borderBottomRightRadius":"4px","height":"10px"}},"axisLineProgressCurrent":{"default":{"borderTopLeftRadius":"4px","borderTopRightRadius":"4px","borderBottomLeftRadius":"4px","borderBottomRightRadius":"4px","backgroundColor":"var(--business-theme)"}},"toolTipCurrentTime":{"default":{"borderTopLeftRadius":"10px","borderTopRightRadius":"10px","borderBottomLeftRadius":"10px","borderBottomRightRadius":"10px","backgroundColor":"var(--business-dialog-bg)","fontSize":"var(--business-text-size-16)","fontWeight":"700","color":"var(--business-white)","box-shadow":"rgba(0, 255, 255, 0.5) 0px 0px 10px 0px inset","paddingLeft":"20px","paddingRight":"20px","paddingTop":"6px","paddingBottom":"6px"}},"toolTipHover":{"default":{"fontSize":"var(--business-text-size-16)","fontWeight":"700","backgroundColor":"var(--business-dialog-bg)","borderTopLeftRadius":"10px","borderTopRightRadius":"10px","borderBottomLeftRadius":"10px","borderBottomRightRadius":"10px","box-shadow":"rgba(0, 255, 255, 0.5) 0px 0px 10px 0px inset","paddingLeft":"20px","paddingRight":"20px","paddingTop":"6px","paddingBottom":"6px","color":"var(--business-white)"}},"wrapperRightMoudle":{"default":{"marginBottom":"0px"}}}, 
 },
},
});
const handleTimeData = (params) => {
console.log(params, '时间轴页面-接收到时间消息----')
// params.timeType = 'minute';
// params.timeValue = '2025-11-07 13:40';
...
if (sourceType === 'airOverview') {
  let forwardCount;
  // hour: 24小时、day： 30天、month：12个月、quarter： 8个季度、year：5年、minute：两小时，间隔五分钟
  // 需要包含当前时间，则往前推的数量都减一
  switch (timeType) {
    case 'hour':
      forwardCount = 23;
  ...
  if (timeRangeData.length) {
    ...
    if (timeStart && timeEnd && timeNum) {
      ...
      // 间隔大于等于30的，不需要扩充时间轴
      let subConst = timeType === 'day' ? 30 : 51;
      if (hourSub < subConst) {
...
if (timeType === 'hour') {
  ...
  // 处理分钟类型
  const startTimeStr = startTime.length === 16 ? startTime + ':00' : startTime;
  const endTimeStr = endTime.length === 16 ? endTime + ':00' : endTime;
  const startTimeValue = new Date(startTimeStr).getTime();
  // 计算两个日期之间的总分钟数
  const totalMinutes = (new Date(endTimeStr).getTime() - startTimeValue) / oneMinuteTime;
  // 循环每5分钟，并将分钟值添加到数组中
  for (let i = 0; i <= totalMinutes; i += 5) {
    const minuteTime = new Date(startTimeValue + i * oneMinuteTime);
    timesInPeriod.push(dateFormat(minuteTime, 'yyyy-MM-dd HH:mm'));
  }
}
...
rootData.rootEmit(
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-timeAxis', global.appScaleMode, 'normal');
...
handleWindowResize();
/* 接收socket.io消息 */
const onSocketChange9fd704e81c6a482c990d = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChange9fd704e81c6a482c990d);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChange9fd704e81c6a482c990d);
});
});
// 页面离开时的操作
onUnmounted(() => {

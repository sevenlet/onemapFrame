window.patrolSupplyCarContentComponent = {
template: 
`<div id="t-l-c-patrolSupplyCarContent" class="t-l-c-patrolSupplyCarContent" >` +
`<t-component id="t-component-f869.e7ce2b41a" class="patrolSupplyCarContent-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName" :page-id="tComponentx0x0ComputedData.pageId" :page-code="tComponentx0x0ComputedData.pageCode">` +
`</t-component>` +
`</div>` +
'',
setup() {

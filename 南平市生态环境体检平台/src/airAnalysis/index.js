window.airAnalysisComponent = {
template: 
`<div id="t-l-c-airAnalysis" class="t-l-c-airAnalysis" >` +
`<t-iframe id="t-iframe-cb66.cd38ee5d5" class="airAnalysis-t-iframe-0-0"  :src="tIframex0x0ComputedData.src" :srcdoc="tIframex0x0ComputedData.srcdoc" :scrolling="tIframex0x0ComputedData.scrolling" :c-style="tIframex0x0ComputedData.cStyle">` +
`</t-iframe>` +
`</div>` +
'',
setup() {

window.fogCannonVehicleDialogComponent = {
template: 
`<div id="t-l-c-fogCannonVehicleDialog" class="t-l-c-fogCannonVehicleDialog" >` +
`<t-rect id="t-rect-09e8.3b71afa9a" class="fogCannonVehicleDialog-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle">` +
`</t-rect>` +
`<t-list-card id="t-list-card-b17c.d932d9cd7" class="fogCannonVehicleDialog-t-list-card-0-1"  :data="replaceCssVariables(filterData(state.baseInfo, componentPropBindingMap?.['t-list-card-b17c.d932d9cd7']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :spacing-x="tListCardx0x1ComputedData.spacingX" :col="tListCardx0x1ComputedData.col" :direction="tListCardx0x1ComputedData.direction" :exchange-order="tListCardx0x1ComputedData.exchangeOrder" :unit-break="tListCardx0x1ComputedData.unitBreak" :key-field="tListCardx0x1ComputedData.keyField" :active-key-field="tListCardx0x1ComputedData.activeKeyField" :active="tListCardx0x1ComputedData.active" :c-style="tListCardx0x1ComputedData.cStyle">` +
`</t-list-card>` +
`<t-pagination-base id="t-pagination-base-4d8e.aa388864b" class="fogCannonVehicleDialog-t-pagination-base-0-2"  :total="replaceCssVariables(filterData(state.pageInfo.total, componentPropBindingMap?.['t-pagination-base-4d8e.aa388864b']['total'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :small="tPaginationBasex0x2ComputedData.small" :page-size="replaceCssVariables(filterData(state.pageInfo.pageSize, componentPropBindingMap?.['t-pagination-base-4d8e.aa388864b']['pageSize'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :pager-count="replaceCssVariables(filterData(state.pageInfo.pages, componentPropBindingMap?.['t-pagination-base-4d8e.aa388864b']['pagerCount'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :current-page="replaceCssVariables(filterData(state.pageInfo.pageNum, componentPropBindingMap?.['t-pagination-base-4d8e.aa388864b']['currentPage'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :layout="tPaginationBasex0x2ComputedData.layout" :page-sizes="tPaginationBasex0x2ComputedData.pageSizes" :disabled="tPaginationBasex0x2ComputedData.disabled" :c-style="tPaginationBasex0x2ComputedData.cStyle" @current-change="oncurrentChange1765346765928">` +
`</t-pagination-base>` +
`<t-rect id="t-rect-1555.727b60852" class="fogCannonVehicleDialog-t-rect-0-3"  :tip="tRectx0x3ComputedData.tip" :label="tRectx0x3ComputedData.label" :active="tRectx0x3ComputedData.active" :c-style="tRectx0x3ComputedData.cStyle">` +
`</t-rect>` +
`<t-rect id="t-rect-afae.576bf09ee" class="fogCannonVehicleDialog-t-rect-0-4"  :tip="tRectx0x4ComputedData.tip" :label="tRectx0x4ComputedData.label" :active="tRectx0x4ComputedData.active" :c-style="tRectx0x4ComputedData.cStyle">` +
`</t-rect>` +
`<t-rect id="t-rect-26fc.42aa488dd" class="fogCannonVehicleDialog-t-rect-0-5"  :tip="tRectx0x5ComputedData.tip" :label="tRectx0x5ComputedData.label" :active="tRectx0x5ComputedData.active" :c-style="tRectx0x5ComputedData.cStyle" @click="onclick1734493226123">` +
`</t-rect>` +
`<t-text id="t-text-440f.0fb335f25" class="fogCannonVehicleDialog-t-text-0-6"  :label="tTextx0x6ComputedData.label" :editable="tTextx0x6ComputedData.editable" :c-style="tTextx0x6ComputedData.cStyle">` +
`</t-text>` +
`<t-date-picker id="t-date-picker-d724.dcd917e15" class="fogCannonVehicleDialog-t-date-picker-0-7"  :placeholder="tDatePickerx0x7ComputedData.placeholder" :start-placeholder="tDatePickerx0x7ComputedData.startPlaceholder" :end-placeholder="tDatePickerx0x7ComputedData.endPlaceholder" :type="tDatePickerx0x7ComputedData.type" :clearable="tDatePickerx0x7ComputedData.clearable" :range-separator="tDatePickerx0x7ComputedData.rangeSeparator" :default-date="replaceCssVariables(filterData(state.dateValue, componentPropBindingMap?.['t-date-picker-d724.dcd917e15']['default-date'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :separator="tDatePickerx0x7ComputedData.separator" :readonly="tDatePickerx0x7ComputedData.readonly" :editable="tDatePickerx0x7ComputedData.editable" :c-style="tDatePickerx0x7ComputedData.cStyle" :is-disabled-front="tDatePickerx0x7ComputedData.isDisabledFront" :disabled-date="tDatePickerx0x7ComputedData.disabledDate" @date-change="ondateChange1765089390224_0_0">` +
`</t-date-picker>` +
`<t-table id="t-table-0633.58a2ac6b5" class="fogCannonVehicleDialog-t-table-0-8"  :height="tTablex0x8ComputedData.height" :stripe="tTablex0x8ComputedData.stripe" :border="tTablex0x8ComputedData.border" :auto-scroll="tTablex0x8ComputedData.autoScroll" :speed="tTablex0x8ComputedData.speed" :columns="tTablex0x8ComputedData.columns" :data="replaceCssVariables(filterData(state.listData, componentPropBindingMap?.['t-table-0633.58a2ac6b5']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x8ComputedData.defaultSort" :c-style="tTablex0x8ComputedData.cStyle" @cell-click="oncellClick1765089615221_0_0">` +
`</t-table>` +
`<t-text-common id="t-text-common-bd87.e023a8583" class="fogCannonVehicleDialog-t-text-common-0-9"  :label="tTextCommonx0x9ComputedData.label" :editable="tTextCommonx0x9ComputedData.editable" :c-style="tTextCommonx0x9ComputedData.cStyle">` +
`</t-text-common>` +
`<t-component id="t-component-025a.b13cac218" class="fogCannonVehicleDialog-t-component-0-10"  :name="tComponentx0x10ComputedData.name" :loading="tComponentx0x10ComputedData.loading" :c-style="tComponentx0x10ComputedData.cStyle" :src="tComponentx0x10ComputedData.src" :component-name="tComponentx0x10ComputedData.componentName" :page-id="tComponentx0x10ComputedData.pageId" :page-code="tComponentx0x10ComputedData.pageCode">` +
`</t-component>` +
`<t-text-common id="t-text-common-5573.37d14e5d4" class="fogCannonVehicleDialog-t-text-common-0-11"  :label="tTextCommonx0x11ComputedData.label" :editable="tTextCommonx0x11ComputedData.editable" :c-style="tTextCommonx0x11ComputedData.cStyle">` +
`</t-text-common>` +
`<t-row id="t-row-a9c1.ffb0f3adb" class="fogCannonVehicleDialog-t-row-0-12"  :c-style="tRowx0x12ComputedData.cStyle" :gutter="tRowx0x12ComputedData.gutter" :justify="tRowx0x12ComputedData.justify" :align="tRowx0x12ComputedData.align">` +
`<t-text-common id="t-text-common-ebb5.079f4d7f8" class="fogCannonVehicleDialog-t-text-common-0-12-0"  :label="replaceCssVariables(filterData(state.CPH, componentPropBindingMap?.['t-text-common-ebb5.079f4d7f8']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextCommonx0x12x0ComputedData.editable" :c-style="tTextCommonx0x12x0ComputedData.cStyle">` +
`</t-text-common>` +
`<t-rect id="t-rect-5ddd.c09e8a3a4" class="fogCannonVehicleDialog-t-rect-0-12-1"  :tip="tRectx0x12x1ComputedData.tip" :label="tRectx0x12x1ComputedData.label" :active="tRectx0x12x1ComputedData.active" :c-style="tRectx0x12x1ComputedData.cStyle">` +
`</t-rect>` +
`</t-row>` +
`</div>` +
'',
...
state.CPH = global.businessDialog.dialogParmas?.cph || global.businessDialog.dialogParmas?.DATA_NAME
...
// 接口函数
 getLatestTime: {
              ...
              config: {"url":"global.serviceBasePath","method":"get","baseURL":"global.foshanServiceBaseUrl","params":{"ZYC_TYPE":"雾炮车","REGION_PATH":"global.regionaQuery.regionCode","interfaceId":"5b79fdac5c11b6865fe23b47e5adc3c2"}},
              request: function ( componentId) {
return new Promise((resolve, reject) => {
  
                http({"url":global.serviceBasePath,"method":"get","baseURL":global.foshanServiceBaseUrl,"params":{"ZYC_TYPE":"雾炮车","REGION_PATH":global.regionaQuery.regionCode,"interfaceId":"5b79fdac5c11b6865fe23b47e5adc3c2"},}).then((res) => {
 
                   // 成功的操作
                   const cacheKey = generateCacheKey('global.foshanServiceBaseUrl-global.serviceBasePath',  {"ZYC_TYPE":"雾炮车","REGION_PATH":global.regionaQuery.regionCode,"interfaceId":"5b79fdac5c11b6865fe23b47e5adc3c2"});
...
if (head.statusCode === '200' && data) {
  const endTime = data.job_time + ':00:00'
...
// 接口函数
 getListData: {
              ...
              autoLoad: false, // 自动请求
              bindComponents: [], // 依赖的组件ID列表，可能多个组件绑定一个接口的数据
              config: {"url":"global.serviceBasePath","method":"get","baseURL":"global.foshanServiceBaseUrl","params":{"CPH":"state.CPH","pageNum":"state.pageInfo.pageNum","pageSize":"state.pageInfo.pageSize","ZYC_TYPE":"雾炮车","END_TIME":"state.endTime","START_TIME":"state.startTime","REGION_PATH":"global.regionaQuery.regionCode","interfaceId":"3b23351433ae74d94dc29259d2b8c06e"}},
              request: function ( componentId) {
return new Promise((resolve, reject) => {
  
                http({"url":global.serviceBasePath,"method":"get","baseURL":global.foshanServiceBaseUrl,"params":{"CPH":state.CPH,"pageNum":state.pageInfo.pageNum,"pageSize":state.pageInfo.pageSize,"ZYC_TYPE":"雾炮车","END_TIME":state.endTime,"START_TIME":state.startTime,"REGION_PATH":global.regionaQuery.regionCode,"interfaceId":"3b23351433ae74d94dc29259d2b8c06e"},}).then((res) => {
 
                   // 成功的操作
                   const cacheKey = generateCacheKey('global.foshanServiceBaseUrl-global.serviceBasePath',  {"CPH":state.CPH,"pageNum":state.pageInfo.pageNum,"pageSize":state.pageInfo.pageSize,"ZYC_TYPE":"雾炮车","END_TIME":state.endTime,"START_TIME":state.startTime,"REGION_PATH":global.regionaQuery.regionCode,"interfaceId":"3b23351433ae74d94dc29259d2b8c06e"});
...
// 接口函数
 getBaseInfo: {
              ...
              autoLoad: false, // 自动请求
              bindComponents: [], // 依赖的组件ID列表，可能多个组件绑定一个接口的数据
              config: {"url":"global.serviceBasePath","method":"get","baseURL":"global.foshanServiceBaseUrl","params":{"CPH":"state.CPH","ZYC_TYPE":"雾炮车","REGION_PATH":"global.regionaQuery.regionCode","interfaceId":"cba412a8965299fd2fb2d88d19163b3e"}},
              request: function ( componentId) {
return new Promise((resolve, reject) => {
  
                http({"url":global.serviceBasePath,"method":"get","baseURL":global.foshanServiceBaseUrl,"params":{"CPH":state.CPH,"ZYC_TYPE":"雾炮车","REGION_PATH":global.regionaQuery.regionCode,"interfaceId":"cba412a8965299fd2fb2d88d19163b3e"},}).then((res) => {
 
                   // 成功的操作
                   const cacheKey = generateCacheKey('global.foshanServiceBaseUrl-global.serviceBasePath',  {"CPH":state.CPH,"ZYC_TYPE":"雾炮车","REGION_PATH":global.regionaQuery.regionCode,"interfaceId":"cba412a8965299fd2fb2d88d19163b3e"});
...
// 监听变量，调取接口
watch(() => [state.pageInfo.pageNum,state.pageInfo.pageSize,state.startTime,global.regionaQuery.regionCode], async () => {
...
deep: true, // 深度监听
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-fogCannonVehicleDialog', global.appScaleMode, 'normal');

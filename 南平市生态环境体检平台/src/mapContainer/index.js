window.mapContainerComponent = {
template: 
`<div id="t-l-c-mapContainer" class="t-l-c-mapContainer" >` +
`<t-iframe id="t-iframe-893f.c77f5f17d" class="mapContainer-t-iframe-0-0"  :src="replaceCssVariables(filterData(state.mapUrl, componentPropBindingMap?.['t-iframe-893f.c77f5f17d']['src'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :srcdoc="tIframex0x0ComputedData.srcdoc" :scrolling="tIframex0x0ComputedData.scrolling" :c-style="tIframex0x0ComputedData.cStyle" :socket-url="replaceCssVariables(filterData(global.socketIp, componentPropBindingMap?.['t-iframe-893f.c77f5f17d']['socketUrl'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :room-id="replaceCssVariables(filterData(global.socketRoom, componentPropBindingMap?.['t-iframe-893f.c77f5f17d']['roomId'].filters || []), global?.theme || global?.activeTheme || '默认主题')">` +
`</t-iframe>` +
`<t-image-base v-if="state.greenThemeCircleBgVisible === true" id="t-image-base-a37b.7f2378e29" class="mapContainer-t-image-base-0-3"  :src="tImageBasex0x3ComputedData.src" :fit="tImageBasex0x3ComputedData.fit" :c-style="tImageBasex0x3ComputedData.cStyle">` +
`</t-image-base>` +
`<t-image-base v-if="state.blueThemeCircleBgVisible === true" id="t-image-base-838c.a56622a71" class="mapContainer-t-image-base-0-4"  :src="tImageBasex0x4ComputedData.src" :fit="tImageBasex0x4ComputedData.fit" :c-style="tImageBasex0x4ComputedData.cStyle">` +
`</t-image-base>` +
`<t-rect id="t-rect-e98c.c99702a8a" class="mapContainer-t-rect-0-5"  :tip="tRectx0x5ComputedData.tip" :label="tRectx0x5ComputedData.label" :active="tRectx0x5ComputedData.active" :c-style="tRectx0x5ComputedData.cStyle">` +
`</t-rect>` +
`<t-image-base v-if="global.theme === '绿色版'" id="t-image-base-43c5.9b3da447c" class="mapContainer-t-image-base-0-6"  :src="tImageBasex0x6ComputedData.src" :fit="tImageBasex0x6ComputedData.fit" :c-style="tImageBasex0x6ComputedData.cStyle">` +
`</t-image-base>` +
`<t-image-base v-if="global.theme === '蓝色版'" id="t-image-base-82b7.a32ab859e" class="mapContainer-t-image-base-0-7"  :src="tImageBasex0x7ComputedData.src" :fit="tImageBasex0x7ComputedData.fit" :c-style="tImageBasex0x7ComputedData.cStyle">` +
`</t-image-base>` +
`</div>` +
'',
setup() {
...
src:"http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/assets/images/2023-09-08/e129ad3fdee74b7c937b3dba4b74f673.png",
fit:"fill",
...
src:"http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/assets/images/2023-06-06/a8ed19298d9f40589a489aae74c6b293.png",
fit:"fill",
...
src:"http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/assets/images/2025-06-27/dbda72a6e79f4fb69788c547647aaf56.png",
fit:"fill",
...
const setMapUrl = () => {
const region_code_province = global.regionaQuery.regionCode.substring(0, 2) + '0000'
const regionCode = global.regionaQuery.regionCode.substring(0, 6)

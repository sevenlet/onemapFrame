window.waterDialogFSTaskComponent = {
template: 
`<div id="t-l-c-waterDialogFSTask" class="t-l-c-waterDialogFSTask" >` +
`<t-rect id="t-rect-f4df.c4d856917" class="waterDialogFSTask-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle">` +
`</t-rect>` +
`<t-select id="t-select-d3b1.6ad43f639" class="waterDialogFSTask-t-select-0-1"  :active-value="tSelectx0x1ComputedData.activeValue" :options="tSelectx0x1ComputedData.options" :alias="tSelectx0x1ComputedData.alias" :multiple="tSelectx0x1ComputedData.multiple" :placeholder="tSelectx0x1ComputedData.placeholder" :clearable="tSelectx0x1ComputedData.clearable" :disabled="tSelectx0x1ComputedData.disabled" :name="tSelectx0x1ComputedData.name" :autocomplete="tSelectx0x1ComputedData.autocomplete" :filterable="tSelectx0x1ComputedData.filterable" :no-match-text="tSelectx0x1ComputedData.no-match-text" :no-data-text="tSelectx0x1ComputedData.no-data-text" :c-style="tSelectx0x1ComputedData.cStyle">` +
`</t-select>` +
`<t-table id="t-table-b8ca.221434c7a" class="waterDialogFSTask-t-table-0-2"  :height="tTablex0x2ComputedData.height" :stripe="tTablex0x2ComputedData.stripe" :border="tTablex0x2ComputedData.border" :auto-scroll="tTablex0x2ComputedData.autoScroll" :speed="tTablex0x2ComputedData.speed" :columns="tTablex0x2ComputedData.columns" :data="tTablex0x2ComputedData.data" :default-sort="tTablex0x2ComputedData.defaultSort" :c-style="tTablex0x2ComputedData.cStyle">` +
`</t-table>` +
`<t-text id="t-text-dc2e.9e60a74ce" class="waterDialogFSTask-t-text-0-3"  :label="tTextx0x3ComputedData.label" :editable="tTextx0x3ComputedData.editable" :c-style="tTextx0x3ComputedData.cStyle">` +
`</t-text>` +
`<t-text id="t-text-094a.1a5bf98c9" class="waterDialogFSTask-t-text-0-4"  :label="tTextx0x4ComputedData.label" :editable="tTextx0x4ComputedData.editable" :c-style="tTextx0x4ComputedData.cStyle">` +
`</t-text>` +
`<t-date-picker id="t-date-picker-7127.e61aac767" class="waterDialogFSTask-t-date-picker-0-5"  :placeholder="tDatePickerx0x5ComputedData.placeholder" :start-placeholder="tDatePickerx0x5ComputedData.startPlaceholder" :end-placeholder="tDatePickerx0x5ComputedData.endPlaceholder" :type="tDatePickerx0x5ComputedData.type" :clearable="tDatePickerx0x5ComputedData.clearable" :range-separator="tDatePickerx0x5ComputedData.rangeSeparator" :default-date="tDatePickerx0x5ComputedData.default-date" :separator="tDatePickerx0x5ComputedData.separator" :readonly="tDatePickerx0x5ComputedData.readonly" :editable="tDatePickerx0x5ComputedData.editable" :c-style="tDatePickerx0x5ComputedData.cStyle">` +
`</t-date-picker>` +
`<t-pagination-base id="t-pagination-base-7b71.d7c576577" class="waterDialogFSTask-t-pagination-base-0-6"  :total="tPaginationBasex0x6ComputedData.total" :small="tPaginationBasex0x6ComputedData.small" :page-size="tPaginationBasex0x6ComputedData.pageSize" :pager-count="tPaginationBasex0x6ComputedData.pagerCount" :current-page="state.pageNum" :layout="tPaginationBasex0x6ComputedData.layout" :page-sizes="tPaginationBasex0x6ComputedData.pageSizes" :disabled="tPaginationBasex0x6ComputedData.disabled" :c-style="tPaginationBasex0x6ComputedData.cStyle" @current-change="oncurrentChange1735207131835">` +
`</t-pagination-base>` +
`</div>` +
'',
setup() {

window.xhjsBaseInfoComponent = {
template: 
`<div id="t-l-c-xhjsBaseInfo" class="t-l-c-xhjsBaseInfo" >` +
`<t-circle id="t-circle-7dbd.196078e2c" class="xhjsBaseInfo-t-circle-0-0"  :tip="tCirclex0x0ComputedData.tip" :label="tCirclex0x0ComputedData.label" :active="tCirclex0x0ComputedData.active" :c-style="tCirclex0x0ComputedData.cStyle">` +
`</t-circle>` +
`<t-text id="t-text-e92f.6243867ce" class="xhjsBaseInfo-t-text-0-1"  :label="tTextx0x1ComputedData.label" :editable="tTextx0x1ComputedData.editable" :c-style="tTextx0x1ComputedData.cStyle">` +
`</t-text>` +
...
`</t-chart-design>` +
`<t-chart-design v-if="state.isBz === false" id="t-chart-design-3774.63e82ca0e" class="xhjsBaseInfo-t-chart-design-0-4"  :empty-img="replaceCssVariables(filterData(state.noDataImg, componentPropBindingMap?.['t-chart-design-3774.63e82ca0e']['emptyImg'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :c-style="tChartDesignx0x4ComputedData.cStyle" :options="replaceCssVariables(filterData(state.variationTrendData.chartOptions, componentPropBindingMap?.['t-chart-design-3774.63e82ca0e']['options'].filters || []), global?.theme || global?.activeTheme || '默认主题')" @get-chart-instance="ongetChartInstance1764135516141">` +
`</t-chart-design>` +
`<t-list-card id="t-list-card-d9ab.2e21fb3b5" class="xhjsBaseInfo-t-list-card-0-6"  :data="replaceCssVariables(filterData(state.baseInfoData, componentPropBindingMap?.['t-list-card-d9ab.2e21fb3b5']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :spacing-x="tListCardx0x6ComputedData.spacingX" :col="tListCardx0x6ComputedData.col" :direction="tListCardx0x6ComputedData.direction" :exchange-order="tListCardx0x6ComputedData.exchangeOrder" :unit-break="tListCardx0x6ComputedData.unitBreak" :key-field="tListCardx0x6ComputedData.keyField" :active-key-field="tListCardx0x6ComputedData.activeKeyField" :active="tListCardx0x6ComputedData.active" :c-style="tListCardx0x6ComputedData.cStyle">` +
`</t-list-card>` +
`<t-component id="t-component-c019.99b6d840a" class="xhjsBaseInfo-t-component-0-7"  :name="tComponentx0x7ComputedData.name" :c-style="tComponentx0x7ComputedData.cStyle" :src="tComponentx0x7ComputedData.src" :component-name="tComponentx0x7ComputedData.componentName" :page-id="tComponentx0x7ComputedData.pageId" :page-code="tComponentx0x7ComputedData.pageCode">` +
`</t-component>` +
`<t-text id="t-text-62b3.48b14905c" class="xhjsBaseInfo-t-text-0-8"  :label="tTextx0x8ComputedData.label" :editable="tTextx0x8ComputedData.editable" :c-style="tTextx0x8ComputedData.cStyle">` +
`</t-text>` +
`<t-scrollable-cards id="t-scrollable-cards-455f.ff3a2c962" class="xhjsBaseInfo-t-scrollable-cards-0-9"  :c-style="tScrollableCardsx0x9ComputedData.cStyle" :show-icon="tScrollableCardsx0x9ComputedData.showIcon" :auto-scroll="tScrollableCardsx0x9ComputedData.autoScroll" :tab="tScrollableCardsx0x9ComputedData.tab" :key-word="tScrollableCardsx0x9ComputedData.keyWord" :default-checked="tScrollableCardsx0x9ComputedData.defaultChecked" :speed="tScrollableCardsx0x9ComputedData.speed" :interval="tScrollableCardsx0x9ComputedData.interval" :card-space="tScrollableCardsx0x9ComputedData.cardSpace" :direction="tScrollableCardsx0x9ComputedData.direction" :data-alias="tScrollableCardsx0x9ComputedData.dataAlias" :data="replaceCssVariables(filterData(state.monitorData, componentPropBindingMap?.['t-scrollable-cards-455f.ff3a2c962']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" @card-click="oncardClick1770123179284">` +
`</t-scrollable-cards>` +
`<t-row id="t-row-3ae9.949fc1c3b" class="xhjsBaseInfo-t-row-0-11"  :c-style="tRowx0x11ComputedData.cStyle" :gutter="tRowx0x11ComputedData.gutter" :justify="tRowx0x11ComputedData.justify" :align="tRowx0x11ComputedData.align">` +
`<t-col id="t-col-5c12.21387b6cc" class="xhjsBaseInfo-t-col-0-11-0"  :span="tColx0x11x0ComputedData.span" :offset="tColx0x11x0ComputedData.offset" :push="tColx0x11x0ComputedData.push" :pull="tColx0x11x0ComputedData.pull" :c-style="tColx0x11x0ComputedData.cStyle">` +
...
`</t-text>` +
`</t-col>` +
`<t-col id="t-col-facf.ef4316657" class="xhjsBaseInfo-t-col-0-11-1"  :span="tColx0x11x1ComputedData.span" :offset="tColx0x11x1ComputedData.offset" :push="tColx0x11x1ComputedData.push" :pull="tColx0x11x1ComputedData.pull" :c-style="tColx0x11x1ComputedData.cStyle">` +
`<t-date-picker id="t-date-picker-b356.86cbc2728" class="xhjsBaseInfo-t-date-picker-0-11-1-0"  :placeholder="tDatePickerx0x11x1x0ComputedData.placeholder" :start-placeholder="tDatePickerx0x11x1x0ComputedData.startPlaceholder" :end-placeholder="tDatePickerx0x11x1x0ComputedData.endPlaceholder" :type="tDatePickerx0x11x1x0ComputedData.type" :clearable="tDatePickerx0x11x1x0ComputedData.clearable" :range-separator="tDatePickerx0x11x1x0ComputedData.rangeSeparator" :default-date="replaceCssVariables(filterData(state.timeRange, componentPropBindingMap?.['t-date-picker-b356.86cbc2728']['default-date'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :separator="tDatePickerx0x11x1x0ComputedData.separator" :readonly="tDatePickerx0x11x1x0ComputedData.readonly" :editable="tDatePickerx0x11x1x0ComputedData.editable" :c-style="tDatePickerx0x11x1x0ComputedData.cStyle" @date-change="ondateChange1735549171926">` +
`</t-date-picker>` +
`<t-select id="t-select-3fcb.c00f74209" class="xhjsBaseInfo-t-select-0-11-1-1"  :active-value="replaceCssVariables(filterData(state.variationTrendData.activeTarget, componentPropBindingMap?.['t-select-3fcb.c00f74209']['activeValue'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :options="replaceCssVariables(filterData(state.categoryList, componentPropBindingMap?.['t-select-3fcb.c00f74209']['options'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :alias="tSelectx0x11x1x1ComputedData.alias" :multiple="tSelectx0x11x1x1ComputedData.multiple" :placeholder="tSelectx0x11x1x1ComputedData.placeholder" :clearable="tSelectx0x11x1x1ComputedData.clearable" :disabled="tSelectx0x11x1x1ComputedData.disabled" :name="tSelectx0x11x1x1ComputedData.name" :autocomplete="tSelectx0x11x1x1ComputedData.autocomplete" :filterable="tSelectx0x11x1x1ComputedData.filterable" :no-match-text="tSelectx0x11x1x1ComputedData.no-match-text" :no-data-text="tSelectx0x11x1x1ComputedData.no-data-text" :c-style="tSelectx0x11x1x1ComputedData.cStyle" @change="onchange1733973555614">` +
`</t-select>` +
`</t-col>` +
`</t-row>` +
`<t-row id="t-row-9111.1b5dc7cd5" class="xhjsBaseInfo-t-row-0-12"  :c-style="tRowx0x12ComputedData.cStyle" :gutter="tRowx0x12ComputedData.gutter" :justify="tRowx0x12ComputedData.justify" :align="tRowx0x12ComputedData.align">` +
`<t-col id="t-col-e76b.cb7d21096" class="xhjsBaseInfo-t-col-0-12-0"  :span="tColx0x12x0ComputedData.span" :offset="tColx0x12x0ComputedData.offset" :push="tColx0x12x0ComputedData.push" :pull="tColx0x12x0ComputedData.pull" :c-style="tColx0x12x0ComputedData.cStyle">` +
`<t-text id="t-text-c954.b258bcb6b" class="xhjsBaseInfo-t-text-0-12-0-0"  :label="tTextx0x12x0x0ComputedData.label" :editable="tTextx0x12x0x0ComputedData.editable" :c-style="tTextx0x12x0x0ComputedData.cStyle">` +
`</t-text>` +
`<t-switch id="t-switch-fdd4.057ab13d6" class="xhjsBaseInfo-t-switch-0-12-0-1"  :value="tSwitchx0x12x0x1ComputedData.value" :c-style="tSwitchx0x12x0x1ComputedData.cStyle" @change="onchange1735789295216">` +
`</t-switch>` +
`</t-col>` +
`</t-row>` +
`<t-row id="t-row-bed0.5ca83a488" class="xhjsBaseInfo-t-row-0-13"  :c-style="tRowx0x13ComputedData.cStyle" :gutter="tRowx0x13ComputedData.gutter" :justify="tRowx0x13ComputedData.justify" :align="tRowx0x13ComputedData.align">` +
`<t-text v-if="state.monitorTime !== ''" id="t-text-b39c.b6c03321c" class="xhjsBaseInfo-t-text-0-13-0"  :label="replaceCssVariables(filterData(state.monitorTime, componentPropBindingMap?.['t-text-b39c.b6c03321c']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x13x0ComputedData.editable" :c-style="tTextx0x13x0ComputedData.cStyle">` +
`</t-text>` +
`</t-row>` +
`</div>` +
'',

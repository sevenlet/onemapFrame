window.waterConcentrationAlarmComponent = {
template: 
`<div id="t-l-c-waterConcentrationAlarm" class="t-l-c-waterConcentrationAlarm" >` +
`<t-rect id="t-rect-8252.1a4ade4f4" class="waterConcentrationAlarm-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle">` +
`</t-rect>` +
`<t-table id="t-table-1f2f.98c8ca619" class="waterConcentrationAlarm-t-table-0-1"  :height="tTablex0x1ComputedData.height" :stripe="tTablex0x1ComputedData.stripe" :border="tTablex0x1ComputedData.border" :auto-scroll="tTablex0x1ComputedData.autoScroll" :speed="tTablex0x1ComputedData.speed" :columns="tTablex0x1ComputedData.columns" :data="tTablex0x1ComputedData.data" :default-sort="tTablex0x1ComputedData.defaultSort" :c-style="tTablex0x1ComputedData.cStyle" @cell-click="oncellClick1734079023244">` +
`</t-table>` +
`<t-rect id="t-rect-e3a7.d7772ec8d" class="waterConcentrationAlarm-t-rect-0-2"  :tip="tRectx0x2ComputedData.tip" :label="tRectx0x2ComputedData.label" :active="tRectx0x2ComputedData.active" :c-style="tRectx0x2ComputedData.cStyle">` +
`</t-rect>` +
`<t-text id="t-text-8cba.b16affff7" class="waterConcentrationAlarm-t-text-0-3"  :label="tTextx0x3ComputedData.label" :editable="tTextx0x3ComputedData.editable" :c-style="tTextx0x3ComputedData.cStyle">` +
`</t-text>` +
`<t-rect id="t-rect-da62.857f90ab" class="waterConcentrationAlarm-t-rect-0-4"  :tip="tRectx0x4ComputedData.tip" :label="tRectx0x4ComputedData.label" :active="tRectx0x4ComputedData.active" :c-style="tRectx0x4ComputedData.cStyle" @click="onclick1733817210174">` +
`</t-rect>` +
`</div>` +
'',
setup() {

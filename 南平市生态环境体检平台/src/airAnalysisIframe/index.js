window.airAnalysisIframeComponent = {
template: 
`<div id="t-l-c-airAnalysisIframe" class="t-l-c-airAnalysisIframe" >` +
`<t-iframe id="t-iframe-a55e.1cade139d" class="airAnalysisIframe-t-iframe-0-0"  :src="tIframex0x0ComputedData.src" :srcdoc="tIframex0x0ComputedData.srcdoc" :scrolling="tIframex0x0ComputedData.scrolling" :c-style="tIframex0x0ComputedData.cStyle">` +
`</t-iframe>` +
`</div>` +
'',
setup() {

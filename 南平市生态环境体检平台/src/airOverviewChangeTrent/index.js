window.airOverviewChangeTrentComponent = {
template: 
`<div id="t-l-c-airOverviewChangeTrent" class="t-l-c-airOverviewChangeTrent" >` +
`<t-tabs-base id="t-tabs-base-149b.11c15e712" class="airOverviewChangeTrent-t-tabs-base-0-0"  :data="global.air.centerIndexList" :space="tTabsBasex0x0ComputedData.space" :selected-tab-val="state.pollutionType" :inner-shadow-color="tTabsBasex0x0ComputedData.innerShadowColor" :active-inner-shadow-color="tTabsBasex0x0ComputedData.activeInnerShadowColor" :alias="tTabsBasex0x0ComputedData.alias" :c-style="tTabsBasex0x0ComputedData.cStyle" :data-raw="tTabsBasex0x0ComputedData.dataRaw" @tab-click="ontabClick1734596882813">` +
`</t-tabs-base>` +
`<t-text v-if="state.airQualityMounthChartData.length === 0" id="t-text-adfe.c80cb2262" class="airOverviewChangeTrent-t-text-0-1"  :label="tTextx0x1ComputedData.label" :editable="tTextx0x1ComputedData.editable" :c-style="tTextx0x1ComputedData.cStyle">` +
`</t-text>` +
`<t-chart-line-single v-if="state.airQualityMounthChartData.length !== 0" id="t-chart-line-single-e60d.837b3e5bf" class="airOverviewChangeTrent-t-chart-line-single-0-2"  :c-style="tChartLineSinglex0x2ComputedData.cStyle" :options="state.options" :data="state.airQualityMounthChartData" :series-setting="tChartLineSinglex0x2ComputedData.seriesSetting" :main-axis="tChartLineSinglex0x2ComputedData.mainAxis" :line="componentState.tChartLineSinglex0x2.line">` +
`</t-chart-line-single>` +
`</div>` +
'',
setup() {

window.sqqyMonitoringInformationComponent = {
template: 
`<div id="t-l-c-sqqyMonitoringInformation" class="t-l-c-sqqyMonitoringInformation" >` +
`<t-row v-if="state.monitorData.length === 0" id="t-row-1e3b.8f7cecd65" class="sqqyMonitoringInformation-t-row-0-0"  :c-style="tRowx0x0ComputedData.cStyle" :gutter="tRowx0x0ComputedData.gutter" :justify="tRowx0x0ComputedData.justify" :align="tRowx0x0ComputedData.align">` +
`<t-text-common id="t-text-common-01eb.2ec99f839" class="sqqyMonitoringInformation-t-text-common-0-0-0"  :label="tTextCommonx0x0x0ComputedData.label" :editable="tTextCommonx0x0x0ComputedData.editable" :c-style="tTextCommonx0x0x0ComputedData.cStyle">` +
`</t-text-common>` +
`</t-row>` +
`<t-component id="t-component-c019.99b6d840a" class="sqqyMonitoringInformation-t-component-0-1"  :name="tComponentx0x1ComputedData.name" :c-style="tComponentx0x1ComputedData.cStyle" :src="tComponentx0x1ComputedData.src" :component-name="tComponentx0x1ComputedData.componentName" :page-id="tComponentx0x1ComputedData.pageId" :page-code="tComponentx0x1ComputedData.pageCode">` +
`</t-component>` +
`<t-text id="t-text-62b3.48b14905c" class="sqqyMonitoringInformation-t-text-0-2"  :label="tTextx0x2ComputedData.label" :editable="tTextx0x2ComputedData.editable" :c-style="tTextx0x2ComputedData.cStyle">` +
`</t-text>` +
...
`</t-col>` +
`</t-row>` +
`<t-row id="t-row-bed0.5ca83a488" class="sqqyMonitoringInformation-t-row-0-7"  :c-style="tRowx0x7ComputedData.cStyle" :gutter="tRowx0x7ComputedData.gutter" :justify="tRowx0x7ComputedData.justify" :align="tRowx0x7ComputedData.align">` +
`<t-text id="t-text-b39c.b6c03321c" class="sqqyMonitoringInformation-t-text-0-7-0"  :label="replaceCssVariables(filterData(state.lastTime, componentPropBindingMap?.['t-text-b39c.b6c03321c']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x7x0ComputedData.editable" :c-style="tTextx0x7x0ComputedData.cStyle">` +
`</t-text>` +
`</t-row>` +
...
`</t-chart-line-single>` +
`<t-text v-if="state.isShowUnit === true" id="t-text-f8f0.bc97393c" class="sqqyMonitoringInformation-t-text-0-9"  :label="replaceCssVariables(filterData(state.chartUint, componentPropBindingMap?.['t-text-f8f0.bc97393c']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x9ComputedData.editable" :c-style="tTextx0x9ComputedData.cStyle">` +
`</t-text>` +
`<t-row id="t-row-bd77.38131ad3a" class="sqqyMonitoringInformation-t-row-0-10"  :c-style="tRowx0x10ComputedData.cStyle" :gutter="tRowx0x10ComputedData.gutter" :justify="tRowx0x10ComputedData.justify" :align="tRowx0x10ComputedData.align">` +
`<t-col id="t-col-b020.60857ae8e" class="sqqyMonitoringInformation-t-col-0-10-0"  :span="tColx0x10x0ComputedData.span" :offset="tColx0x10x0ComputedData.offset" :push="tColx0x10x0ComputedData.push" :pull="tColx0x10x0ComputedData.pull" :c-style="tColx0x10x0ComputedData.cStyle">` +
`<t-text id="t-text-e72a.4bd4fa2b8" class="sqqyMonitoringInformation-t-text-0-10-0-0"  :label="tTextx0x10x0x0ComputedData.label" :editable="tTextx0x10x0x0ComputedData.editable" :c-style="tTextx0x10x0x0ComputedData.cStyle">` +
`</t-text>` +
`</t-col>` +
`<t-col id="t-col-e49a.00ee68386" class="sqqyMonitoringInformation-t-col-0-10-1"  :span="tColx0x10x1ComputedData.span" :offset="tColx0x10x1ComputedData.offset" :push="tColx0x10x1ComputedData.push" :pull="tColx0x10x1ComputedData.pull" :c-style="tColx0x10x1ComputedData.cStyle">` +
`</t-col>` +
`</t-row>` +
`</div>` +
'',

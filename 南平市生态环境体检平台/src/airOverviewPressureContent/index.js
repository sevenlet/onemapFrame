window.airOverviewPressureContentComponent = {
template: 
`<div id="t-l-c-airOverviewPressureContent" class="t-l-c-airOverviewPressureContent" >` +
`<t-rect id="t-rect-0f04.77abbb82d" class="airOverviewPressureContent-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle">` +
`</t-rect>` +
`<t-rect id="t-rect-e2a2.ea239966d" class="airOverviewPressureContent-t-rect-0-1"  :tip="tRectx0x1ComputedData.tip" :label="tRectx0x1ComputedData.label" :active="tRectx0x1ComputedData.active" :c-style="tRectx0x1ComputedData.cStyle">` +
`</t-rect>` +
`<t-text id="t-text-83fa.5cdcb96f7" class="airOverviewPressureContent-t-text-0-2"  :label="tTextx0x2ComputedData.label" :editable="tTextx0x2ComputedData.editable" :c-style="tTextx0x2ComputedData.cStyle">` +
`</t-text>` +
`<t-rect id="t-rect-8d73.d5d856a75" class="airOverviewPressureContent-t-rect-0-3"  :tip="tRectx0x3ComputedData.tip" :label="tRectx0x3ComputedData.label" :active="tRectx0x3ComputedData.active" :c-style="tRectx0x3ComputedData.cStyle" @click="onclick1734490841737">` +
`</t-rect>` +
`<t-tabs-base id="t-tabs-base-c80c.c0d16512d" class="airOverviewPressureContent-t-tabs-base-0-4"  :data="tTabsBasex0x4ComputedData.data" :space="tTabsBasex0x4ComputedData.space" :selected-tab-val="state.tabSelect" :inner-shadow-color="tTabsBasex0x4ComputedData.innerShadowColor" :active-inner-shadow-color="tTabsBasex0x4ComputedData.activeInnerShadowColor" :alias="tTabsBasex0x4ComputedData.alias" :c-style="tTabsBasex0x4ComputedData.cStyle" @tab-click="ontabClick1733904000104">` +
`</t-tabs-base>` +
`<t-component id="t-component-204b.3d0254914" class="airOverviewPressureContent-t-component-0-5"  :name="state.tabSelect" :c-style="tComponentx0x5ComputedData.cStyle" :src="tComponentx0x5ComputedData.src" :component-name="state.tabSelect">` +
`</t-component>` +
`</div>` +
'',
setup() {
...
const state = Vue.reactive({
   screenSize: "",
   tabSelect: "airOverviewPressureStandardAnaComponent",
});
// 选中的图表主题
...
tTextx0x2: {
defaultStyle: {
            default: {"width":"143px","height":"19px","color":"rgba(255, 255, 255, 1)","fontSize":"18px","position":"unset","left":"479px","top":"198px","backgroundImage":"url(http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78/assets/images/2024-04-17/26907d3cdd3d451c98ec22ec5199d46d.svg)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"26px 26px","-webkit-mask-size":"","backgroundPosition":"0% 50%","-webkit-mask-position":"","paddingLeft":"32px","fontWeight":"700","animationName":""},
...
label:"达标压力",
editable:false,
cStyle:{"wrapper":{"default":{"width":"143px","height":"19px","color":"rgba(255, 255, 255, 1)","fontSize":"18px","position":"unset","left":"479px","top":"198px","backgroundImage":"url(http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78/assets/images/2024-04-17/26907d3cdd3d451c98ec22ec5199d46d.svg)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"26px 26px","-webkit-mask-size":"","backgroundPosition":"0% 50%","-webkit-mask-position":"","paddingLeft":"32px","fontWeight":"700","animationName":""}}}, 
 },
},
tRectx0x3: {
defaultStyle: {
...
rootData.rootEmit(
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-airOverviewPressureContent', global.appScaleMode, 'normal');
...
onclick1734490841737,
ontabClick1733904000104,
};
},
};
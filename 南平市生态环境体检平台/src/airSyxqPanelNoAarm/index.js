window.airSyxqPanelNoAarmComponent = {
template: 
`<div id="t-l-c-airSyxqPanelNoAarm" class="t-l-c-airSyxqPanelNoAarm" >` +
`<t-image-base id="t-image-base-cc01.3413a106e" class="airSyxqPanelNoAarm-t-image-base-0-1"  :src="tImageBasex0x1ComputedData.src" :fit="tImageBasex0x1ComputedData.fit" :c-style="tImageBasex0x1ComputedData.cStyle">` +
`</t-image-base>` +
`<t-list-card v-if="state.activeTab.value !== ''" id="t-list-card-2d95.1c787b696" class="airSyxqPanelNoAarm-t-list-card-0-2"  :data="replaceCssVariables(state.sceneList, global?.theme || global?.activeTheme || '默认主题')" :spacing-x="tListCardx0x2ComputedData.spacingX" :col="tListCardx0x2ComputedData.col" :direction="tListCardx0x2ComputedData.direction" :exchange-order="tListCardx0x2ComputedData.exchangeOrder" :unit-break="tListCardx0x2ComputedData.unitBreak" :key-field="tListCardx0x2ComputedData.keyField" :active-key-field="tListCardx0x2ComputedData.activeKeyField" :active="replaceCssVariables(state.activeTab.name, global?.theme || global?.activeTheme || '默认主题')" :c-style="tListCardx0x2ComputedData.cStyle" @card-click="oncardClick1735029005919">` +
`</t-list-card>` +
`<t-rect id="t-rect-364c.0469d38c2" class="airSyxqPanelNoAarm-t-rect-0-3"  :tip="tRectx0x3ComputedData.tip" :label="tRectx0x3ComputedData.label" :active="tRectx0x3ComputedData.active" :c-style="tRectx0x3ComputedData.cStyle">` +
`</t-rect>` +
`<t-table v-if="state.isShowOperateColumn === false" id="t-table-dc13.1454a104c" class="airSyxqPanelNoAarm-t-table-0-4"  :height="tTablex0x4ComputedData.height" :stripe="tTablex0x4ComputedData.stripe" :border="tTablex0x4ComputedData.border" :auto-scroll="tTablex0x4ComputedData.autoScroll" :speed="tTablex0x4ComputedData.speed" :columns="tTablex0x4ComputedData.columns" :data="replaceCssVariables(state.enterList, global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x4ComputedData.defaultSort" :c-style="tTablex0x4ComputedData.cStyle" @cell-click="oncellClick1734608241064">` +
`</t-table>` +
...
`</t-table>` +
`<t-component id="t-component-38d2.9fd30fb1" class="airSyxqPanelNoAarm-t-component-0-6"  :name="tComponentx0x6ComputedData.name" :c-style="tComponentx0x6ComputedData.cStyle" :src="tComponentx0x6ComputedData.src" :component-name="tComponentx0x6ComputedData.componentName">` +
`</t-component>` +
`<t-component id="t-component-3c7c.d9e5b9971" class="airSyxqPanelNoAarm-t-component-0-7"  :name="tComponentx0x7ComputedData.name" :c-style="tComponentx0x7ComputedData.cStyle" :src="tComponentx0x7ComputedData.src" :component-name="tComponentx0x7ComputedData.componentName">` +
`</t-component>` +
`<t-text id="t-text-198d.ee6d3e6b1" class="airSyxqPanelNoAarm-t-text-0-8"  :label="replaceCssVariables(state.alarmTitle, global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x8ComputedData.editable" :c-style="tTextx0x8ComputedData.cStyle">` +
`</t-text>` +
`<t-text id="t-text-0645.e3c5af32d" class="airSyxqPanelNoAarm-t-text-0-9"  :label="tTextx0x9ComputedData.label" :editable="tTextx0x9ComputedData.editable" :c-style="tTextx0x9ComputedData.cStyle">` +
`</t-text>` +
`<t-image-base id="t-image-base-892f.614690dda" class="airSyxqPanelNoAarm-t-image-base-0-10"  :src="tImageBasex0x10ComputedData.src" :fit="tImageBasex0x10ComputedData.fit" :c-style="tImageBasex0x10ComputedData.cStyle">` +
`</t-image-base>` +
`<t-text id="t-text-d39f.d94b33238" class="airSyxqPanelNoAarm-t-text-0-11"  :label="replaceCssVariables(state.alarmContent, global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x11ComputedData.editable" :c-style="tTextx0x11ComputedData.cStyle">` +
`</t-text>` +
`<t-text id="t-text-1960.208c7e101" class="airSyxqPanelNoAarm-t-text-0-12"  :label="tTextx0x12ComputedData.label" :editable="tTextx0x12ComputedData.editable" :c-style="tTextx0x12ComputedData.cStyle">` +
`</t-text>` +
`<t-text id="t-text-08ca.e11948362" class="airSyxqPanelNoAarm-t-text-0-13"  :label="replaceCssVariables(state.alarmMonthTotal, global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x13ComputedData.editable" :c-style="tTextx0x13ComputedData.cStyle" @click="onclick1734405526375">` +
`</t-text>` +
`<t-rect v-if="state.checkedIds !== ''" id="t-rect-f258.31abd13a7" class="airSyxqPanelNoAarm-t-rect-0-14"  :tip="tRectx0x14ComputedData.tip" :label="tRectx0x14ComputedData.label" :active="tRectx0x14ComputedData.active" :c-style="tRectx0x14ComputedData.cStyle" @click="onclick1735205190641">` +
`</t-rect>` +
`<t-rect v-if="state.checkedIds === ''" id="t-rect-caab.15629254d" class="airSyxqPanelNoAarm-t-rect-0-15"  :tip="tRectx0x15ComputedData.tip" :label="tRectx0x15ComputedData.label" :active="tRectx0x15ComputedData.active" :c-style="tRectx0x15ComputedData.cStyle">` +
`</t-rect>` +
`<t-text id="t-text-5454.74c04491" class="airSyxqPanelNoAarm-t-text-0-17"  :label="tTextx0x17ComputedData.label" :editable="tTextx0x17ComputedData.editable" :c-style="tTextx0x17ComputedData.cStyle">` +
`</t-text>` +
`<t-text id="t-text-a89a.7e30697e2" class="airSyxqPanelNoAarm-t-text-0-18"  :label="tTextx0x18ComputedData.label" :editable="tTextx0x18ComputedData.editable" :c-style="tTextx0x18ComputedData.cStyle">` +
`</t-text>` +
`<t-text id="t-text-49e3.b2374108a" class="airSyxqPanelNoAarm-t-text-0-19"  :label="tTextx0x19ComputedData.label" :editable="tTextx0x19ComputedData.editable" :c-style="tTextx0x19ComputedData.cStyle">` +
`</t-text>` +
`<t-text id="t-text-3797.0a506c66b" class="airSyxqPanelNoAarm-t-text-0-20"  :label="tTextx0x20ComputedData.label" :editable="tTextx0x20ComputedData.editable" :c-style="tTextx0x20ComputedData.cStyle">` +
`</t-text>` +
`<t-radio id="t-radio-7049.20f57b6cf" class="airSyxqPanelNoAarm-t-radio-0-21"  :options="tRadiox0x21ComputedData.options" :active="replaceCssVariables(state.selectedParams.direction, global?.theme || global?.activeTheme || '默认主题')" :alias="tRadiox0x21ComputedData.alias" :disabled="tRadiox0x21ComputedData.disabled" :border="tRadiox0x21ComputedData.border" :size="tRadiox0x21ComputedData.size" :is-use-button="tRadiox0x21ComputedData.isUseButton" :c-style="tRadiox0x21ComputedData.cStyle" @change="onchange1740720896505">` +
`</t-radio>` +
`<t-radio id="t-radio-f568.197f4f8a6" class="airSyxqPanelNoAarm-t-radio-0-22"  :options="tRadiox0x22ComputedData.options" :active="replaceCssVariables(state.selectedParams.buffer, global?.theme || global?.activeTheme || '默认主题')" :alias="tRadiox0x22ComputedData.alias" :disabled="tRadiox0x22ComputedData.disabled" :border="tRadiox0x22ComputedData.border" :size="tRadiox0x22ComputedData.size" :is-use-button="tRadiox0x22ComputedData.isUseButton" :c-style="tRadiox0x22ComputedData.cStyle" @change="onchange1740720921561">` +
`</t-radio>` +
`<t-checkbox id="t-checkbox-3380.5456a8ecb" class="airSyxqPanelNoAarm-t-checkbox-0-23"  :data="tCheckboxx0x23ComputedData.data" :active="replaceCssVariables(state.selectedParams.altitude, global?.theme || global?.activeTheme || '默认主题')" :data-alias="tCheckboxx0x23ComputedData.dataAlias" :border="tCheckboxx0x23ComputedData.border" :use-button="tCheckboxx0x23ComputedData.useButton" :c-style="tCheckboxx0x23ComputedData.cStyle" @change="onchange1740720873822">` +
`</t-checkbox>` +
`<t-rect id="t-rect-0b21.228388b5a" class="airSyxqPanelNoAarm-t-rect-0-24"  :tip="tRectx0x24ComputedData.tip" :label="tRectx0x24ComputedData.label" :active="tRectx0x24ComputedData.active" :c-style="tRectx0x24ComputedData.cStyle" @click="onclick1740712988309_0_0">` +
`</t-rect>` +
`<t-search id="t-search-fadf.e7800d58b" class="airSyxqPanelNoAarm-t-search-0-25"  :type="tSearchx0x25ComputedData.type" :input-value="replaceCssVariables(state.selectedParams.radius, global?.theme || global?.activeTheme || '默认主题')" :maxlength="tSearchx0x25ComputedData.maxlength" :minlength="tSearchx0x25ComputedData.minlength" :show-word-limit="tSearchx0x25ComputedData.showWordLimit" :placeholder="tSearchx0x25ComputedData.placeholder" :clearable="tSearchx0x25ComputedData.clearable" :show-password="tSearchx0x25ComputedData.showPassword" :disabled="tSearchx0x25ComputedData.disabled" :prefix-icon="tSearchx0x25ComputedData.prefix-icon" :suffix-icon="tSearchx0x25ComputedData.suffix-icon" :rows="tSearchx0x25ComputedData.rows" :autosize="tSearchx0x25ComputedData.autosize" :name="tSearchx0x25ComputedData.name" :readonly="tSearchx0x25ComputedData.readonly" :step="tSearchx0x25ComputedData.step" :autofocus="tSearchx0x25ComputedData.autofocus" :form="tSearchx0x25ComputedData.form" :label="tSearchx0x25ComputedData.label" :tabindex="tSearchx0x25ComputedData.tabindex" :validate-event="tSearchx0x25ComputedData.validateEvent" :c-style="tSearchx0x25ComputedData.cStyle" :has-search-btn="tSearchx0x25ComputedData.hasSearchBtn" @input="oninput1740741929704">` +
`</t-search>` +
`<t-text id="t-text-52c7.b32680ad6" class="airSyxqPanelNoAarm-t-text-0-26"  :label="tTextx0x26ComputedData.label" :editable="tTextx0x26ComputedData.editable" :c-style="tTextx0x26ComputedData.cStyle">` +
`</t-text>` +
`</div>` +
'',
setup() {

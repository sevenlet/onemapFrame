window.airSyxqPanelComponent = {
template: 
`<div id="t-l-c-airSyxqPanel" class="t-l-c-airSyxqPanel" >` +
`<t-rect id="t-rect-0911.f9ec9d352" class="airSyxqPanel-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle">` +
`</t-rect>` +
`<t-component id="t-component-6538.bd4ec5b54" class="airSyxqPanel-t-component-0-1"  :name="replaceCssVariables(filterData(state.componentName, componentPropBindingMap?.['t-component-6538.bd4ec5b54']['name'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :c-style="tComponentx0x1ComputedData.cStyle" :src="tComponentx0x1ComputedData.src" :component-name="replaceCssVariables(filterData(state.componentName, componentPropBindingMap?.['t-component-6538.bd4ec5b54']['componentName'].filters || []), global?.theme || global?.activeTheme || '默认主题')">` +
`</t-component>` +
`<t-row id="t-row-5443.7e7d1c1a1" class="airSyxqPanel-t-row-0-2"  :c-style="tRowx0x2ComputedData.cStyle" :gutter="tRowx0x2ComputedData.gutter" :justify="tRowx0x2ComputedData.justify" :align="tRowx0x2ComputedData.align">` +
`<t-text id="t-text-0d1a.4b7df282f" class="airSyxqPanel-t-text-0-2-0"  :label="tTextx0x2x0ComputedData.label" :editable="tTextx0x2x0ComputedData.editable" :c-style="tTextx0x2x0ComputedData.cStyle" @click="onclick1734337188119">` +
`</t-text>` +
`<t-text id="t-text-9ff1.92503251d" class="airSyxqPanel-t-text-0-2-1"  :label="replaceCssVariables(filterData(state.headerInfo.POINT_NAME, componentPropBindingMap?.['t-text-9ff1.92503251d']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x2x1ComputedData.editable" :c-style="tTextx0x2x1ComputedData.cStyle">` +
`</t-text>` +
`<t-text id="t-text-1aa2.670c35704" class="airSyxqPanel-t-text-0-2-3"  :label="replaceCssVariables(filterData(state.headerInfo.POINT_TYPE_NAME, componentPropBindingMap?.['t-text-1aa2.670c35704']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x2x3ComputedData.editable" :c-style="tTextx0x2x3ComputedData.cStyle">` +
`</t-text>` +
`</t-row>` +
`</div>` +
'',

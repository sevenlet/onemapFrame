window.shuitanchuangduanmianCopyComponent = {
template: 
`<div id="t-l-c-shuitanchuangduanmianCopy" class="t-l-c-shuitanchuangduanmianCopy" >` +
...
`</t-rect>` +
`<t-component id="t-component-75a5.51539ef39" class="waterDialogFractureSurface-t-component-0-1"  :name="replaceCssVariables(filterData(state.activeTab, componentPropBindingMap?.['t-component-75a5.51539ef39']['name'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :c-style="tComponentx0x1ComputedData.cStyle" :src="tComponentx0x1ComputedData.src" :component-name="replaceCssVariables(filterData(state.activeTab, componentPropBindingMap?.['t-component-75a5.51539ef39']['componentName'].filters || []), global?.theme || global?.activeTheme || '默认主题')">` +
`</t-component>` +
`<t-rect id="t-rect-71af.6d10fdece" class="waterDialogFractureSurface-t-rect-0-2"  :tip="tRectx0x2ComputedData.tip" :label="tRectx0x2ComputedData.label" :active="tRectx0x2ComputedData.active" :c-style="tRectx0x2ComputedData.cStyle">` +
`</t-rect>` +
`<t-rect id="t-rect-e3a7.d7772ec8d" class="waterDialogFractureSurface-t-rect-0-3"  :tip="tRectx0x3ComputedData.tip" :label="tRectx0x3ComputedData.label" :active="tRectx0x3ComputedData.active" :c-style="tRectx0x3ComputedData.cStyle">` +
`</t-rect>` +
`<t-rect id="t-rect-5577.0975bb8d2" class="waterDialogFractureSurface-t-rect-0-4"  :tip="tRectx0x4ComputedData.tip" :label="tRectx0x4ComputedData.label" :active="tRectx0x4ComputedData.active" :c-style="tRectx0x4ComputedData.cStyle">` +
`</t-rect>` +
`<t-tabs id="t-tabs-5b34.03728285a" class="waterDialogFractureSurface-t-tabs-0-5"  :data="replaceCssVariables(filterData(state.tabList, componentPropBindingMap?.['t-tabs-5b34.03728285a']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active-tab="replaceCssVariables(filterData(state.activeTab, componentPropBindingMap?.['t-tabs-5b34.03728285a']['activeTab'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :tab-position-extend="tTabsx0x5ComputedData.tabPositionExtend" :stretch="tTabsx0x5ComputedData.stretch" :c-style="tTabsx0x5ComputedData.cStyle" @tab-click="ontabClick1733991846829">` +
`</t-tabs>` +
`<t-rect id="t-rect-01cc.01107010c" class="waterDialogFractureSurface-t-rect-0-6"  :tip="tRectx0x6ComputedData.tip" :label="tRectx0x6ComputedData.label" :active="tRectx0x6ComputedData.active" :c-style="tRectx0x6ComputedData.cStyle">` +
`</t-rect>` +
`<t-rect id="t-rect-64c9.9155b5905" class="waterDialogFractureSurface-t-rect-0-7"  :tip="tRectx0x7ComputedData.tip" :label="tRectx0x7ComputedData.label" :active="tRectx0x7ComputedData.active" :c-style="tRectx0x7ComputedData.cStyle">` +
`</t-rect>` +
`<t-row id="t-row-a98e.97de7da75" class="waterDialogFractureSurface-t-row-0-8"  :c-style="tRowx0x8ComputedData.cStyle" :gutter="tRowx0x8ComputedData.gutter" :justify="tRowx0x8ComputedData.justify" :align="tRowx0x8ComputedData.align">` +
`<t-text id="t-text-8cba.b16affff7" class="waterDialogFractureSurface-t-text-0-8-0"  :label="replaceCssVariables(filterData(state.baseInfo.title, componentPropBindingMap?.['t-text-8cba.b16affff7']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x8x0ComputedData.editable" :c-style="tTextx0x8x0ComputedData.cStyle" :show-title="tTextx0x8x0ComputedData.showTitle">` +
`</t-text>` +
`<t-text id="t-text-651d.bf3241ca9" class="waterDialogFractureSurface-t-text-0-8-1"  :label="replaceCssVariables(filterData(state.baseInfo.type, componentPropBindingMap?.['t-text-651d.bf3241ca9']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x8x1ComputedData.editable" :c-style="tTextx0x8x1ComputedData.cStyle">` +
`</t-text>` +
`<t-text id="t-text-c1e6.384bf7c9d" class="waterDialogFractureSurface-t-text-0-8-2"  :label="replaceCssVariables(filterData(state.baseInfo.controlLevel, componentPropBindingMap?.['t-text-c1e6.384bf7c9d']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x8x2ComputedData.editable" :c-style="tTextx0x8x2ComputedData.cStyle">` +
`</t-text>` +
...
`</t-rect>` +
`<t-rect id="t-rect-da62.857f90ab" class="waterDialogFractureSurface-t-rect-0-10"  :tip="tRectx0x10ComputedData.tip" :label="tRectx0x10ComputedData.label" :active="tRectx0x10ComputedData.active" :c-style="tRectx0x10ComputedData.cStyle" @click="onclick1733817210174">` +
`</t-rect>` +
`<t-row id="t-row-6365.97c68ed82" class="waterDialogFractureSurface-t-row-0-11"  :c-style="tRowx0x11ComputedData.cStyle" :gutter="tRowx0x11ComputedData.gutter" :justify="tRowx0x11ComputedData.justify" :align="tRowx0x11ComputedData.align">` +
`<t-text id="t-text-630e.1af9131a3" class="waterDialogFractureSurface-t-text-0-11-0"  :label="tTextx0x11x0ComputedData.label" :editable="tTextx0x11x0ComputedData.editable" :c-style="tTextx0x11x0ComputedData.cStyle" @click="onclick1734068220296">` +
`</t-text>` +
`<t-text v-if="state.showSource === true" id="t-text-4e6d.a19cece3e" class="waterDialogFractureSurface-t-text-0-11-1"  :label="tTextx0x11x1ComputedData.label" :editable="tTextx0x11x1ComputedData.editable" :c-style="tTextx0x11x1ComputedData.cStyle" @click="onclick1734071402189">` +
`</t-text>` +
`<t-text id="t-text-19bd.a994fa29f" class="waterDialogFractureSurface-t-text-0-11-2"  :label="tTextx0x11x2ComputedData.label" :editable="tTextx0x11x2ComputedData.editable" :c-style="tTextx0x11x2ComputedData.cStyle" @click="onclick1734067550409">` +
`</t-text>` +
`</t-row>` +
`</div>` +
'',

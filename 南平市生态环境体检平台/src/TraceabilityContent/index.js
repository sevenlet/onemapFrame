window.TraceabilityContentComponent = {
template: 
`<div id="t-l-c-TraceabilityContent" class="t-l-c-TraceabilityContent" >` +
`<t-component id="t-component-18ba.8b4f27f22" class="TraceabilityContent-t-component-0-0"  :name="replaceCssVariables(filterData(global.waterGlobalVariables.sourceApportionment.activeTabName, componentPropBindingMap?.['t-component-18ba.8b4f27f22']['name'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :loading="tComponentx0x0ComputedData.loading" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="replaceCssVariables(filterData(global.waterGlobalVariables.sourceApportionment.activeTabName, componentPropBindingMap?.['t-component-18ba.8b4f27f22']['componentName'].filters || []), global?.theme || global?.activeTheme || '默认主题')">` +
`</t-component>` +
`<t-tabs-base id="t-tabs-base-a061.6750724ea" class="TraceabilityContent-t-tabs-base-0-1"  :data="tTabsBasex0x1ComputedData.data" :space="tTabsBasex0x1ComputedData.space" :selected-tab-val="replaceCssVariables(filterData(global.waterGlobalVariables.sourceApportionment.activeTabName, componentPropBindingMap?.['t-tabs-base-a061.6750724ea']['selectedTabVal'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :inner-shadow-color="tTabsBasex0x1ComputedData.innerShadowColor" :active-inner-shadow-color="tTabsBasex0x1ComputedData.activeInnerShadowColor" :alias="tTabsBasex0x1ComputedData.alias" :c-style="tTabsBasex0x1ComputedData.cStyle" @tab-click="ontabClick1762746318535">` +
`</t-tabs-base>` +
`</div>` +
'',
setup() {
const componentPropBindingMap = {"body":{"attributeName":"tBodyx0x0"},"t-component-18ba.8b4f27f22":{"attributeName":"tComponentx0x0","name":{"filters":[]},"loading":{"filters":[]},"cStyle":{"filters":[]},"src":{"filters":[]},"componentName":{"filters":[]}},"t-tabs-base-a061.6750724ea":{"attributeName":"tTabsBasex0x1","data":{"filters":[]},"space":{"filters":[]},"selectedTabVal":{"filters":[]},"innerShadowColor":{"filters":[]},"activeInnerShadowColor":{"filters":[]},"alias":{"filters":[]},"cStyle":{"filters":[]}}};
// 页面内注入全局变量和事件
...
const state = Vue.reactive({
   ...
   componentName: "monitoringAnalysisComponent",
   isNewDate: true,
   maxQuarterYear: "",
   maxTimeValue: "",
...
tComponentx0x0: {
defaultStyle: {
            default: {"width":"411px","height":"741px","margin":"0 auto","backgroundColor":"rgba(255, 255, 255, 0)","position":"unset","left":"21px","top":"52px"},
            
            },
 default: { 
 
name:"monitoringAnalysisComponent",
loading:true,
cStyle:{"wrapper":{"default":{"width":"411px","height":"741px","margin":"0 auto","backgroundColor":"rgba(255, 255, 255, 0)","position":"unset","left":"21px","top":"52px"}}},
...
const handleTabNew = (item) => {
// [
//   {
//     "label": "监测分析",
//     "value": "monitoringAnalysisComponent"
//   },
//   {
//     "label": "污染分析",
//     "value": "pollutionAnalysisComponent"
//   },
//   {
//     "label": "智慧推荐",
//     "value": "smartRecommendationsComponent"
//   }
// ]
// 当前选中值
const currentName = global.waterGlobalVariables.sourceApportionment.activeTabName
// 当前选中的是智慧推荐，要切换：监测分析、污染分析页面
if((item.label === '监测分析' || item.label === '污染分析') && currentName === 'smartRecommendationsComponent') {
...
const ontabClick1762746318535 = (data) => {
// 执行自定义方法
handleTabNew(data);
// 设置全局变量值
rootData.rootEmit(
                  'rootData:change',
                  {
                    key:'waterGlobalVariables.sourceApportionment.activeTabName',
                    value:data.value,
                    data: {
                      waterGlobalVariables:{sourceApportionment:{activeTabName: data.value}}
                    },
                  });
// 设置全局变量值
rootData.rootEmit(
...
deep: true, // 深度监听
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-TraceabilityContent', global.appScaleMode, 'normal');

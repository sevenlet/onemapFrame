window.drinkWaterMapDetailContentComponent = {
template: 
`<div id="t-l-c-drinkWaterMapDetailContent" class="t-l-c-drinkWaterMapDetailContent" >` +
`<t-component id="t-component-d7a5.0f0c30eaf" class="drinkWaterMapDetailContent-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName">` +
`</t-component>` +
`<t-text id="t-text-dde9.205bbc868" class="drinkWaterMapDetailContent-t-text-0-1"  :label="tTextx0x1ComputedData.label" :editable="tTextx0x1ComputedData.editable" :c-style="tTextx0x1ComputedData.cStyle">` +
`</t-text>` +
`<t-list-card id="t-list-card-9491.e64bae56e" class="drinkWaterMapDetailContent-t-list-card-0-2"  :data="replaceCssVariables(state.baseInfoData, global?.theme || global?.activeTheme || '默认主题')" :spacing-x="tListCardx0x2ComputedData.spacingX" :col="tListCardx0x2ComputedData.col" :direction="tListCardx0x2ComputedData.direction" :exchange-order="tListCardx0x2ComputedData.exchangeOrder" :unit-break="tListCardx0x2ComputedData.unitBreak" :key-field="tListCardx0x2ComputedData.keyField" :active-key-field="tListCardx0x2ComputedData.activeKeyField" :active="tListCardx0x2ComputedData.active" :c-style="tListCardx0x2ComputedData.cStyle">` +
`</t-list-card>` +
`</div>` +
'',
setup() {

window.leftMenusComponent = {
template: 
`<div id="t-l-c-leftMenus" class="t-l-c-leftMenus" >` +
`<t-rect v-if="state.showMenu === true" id="t-rect-1bda.61271563a" class="leftMenu-t-rect-0-1"  :tip="tRectx0x1ComputedData.tip" :label="tRectx0x1ComputedData.label" :active="tRectx0x1ComputedData.active" :c-style="tRectx0x1ComputedData.cStyle">` +
`</t-rect>` +
`<t-rect v-if="state.showMenu === true" id="t-rect-19e5.e86ec2bef" class="leftMenu-t-rect-0-3"  :tip="tRectx0x3ComputedData.tip" :label="tRectx0x3ComputedData.label" :active="tRectx0x3ComputedData.active" :c-style="tRectx0x3ComputedData.cStyle">` +
`</t-rect>` +
`<t-tabs id="t-tabs-2037.5bf01a865" class="leftMenu-t-tabs-0-4"  :alias="tTabsx0x4ComputedData.alias" :data="replaceCssVariables(filterData(state.typeList, componentPropBindingMap?.['t-tabs-2037.5bf01a865']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active-tab="replaceCssVariables(filterData(state.type, componentPropBindingMap?.['t-tabs-2037.5bf01a865']['activeTab'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :tab-position-extend="tTabsx0x4ComputedData.tabPositionExtend" :stretch="tTabsx0x4ComputedData.stretch" :c-style="tTabsx0x4ComputedData.cStyle" @tab-click="ontabClick1719921924660">` +
`</t-tabs>` +
`<t-rect v-if="state.showMenu === true" id="t-rect-5c2e.c6ce5466f" class="leftMenu-t-rect-0-5"  :tip="tRectx0x5ComputedData.tip" :label="tRectx0x5ComputedData.label" :active="tRectx0x5ComputedData.active" :c-style="tRectx0x5ComputedData.cStyle" @click="onclick1719920562468">` +
`</t-rect>` +
`<t-iframe id="t-iframe-32a6.a99f8be3" class="leftMenu-t-iframe-0-6"  :src="tIframex0x6ComputedData.src" :srcdoc="tIframex0x6ComputedData.srcdoc" :scrolling="tIframex0x6ComputedData.scrolling" :c-style="tIframex0x6ComputedData.cStyle" :socket-url="replaceCssVariables(filterData(global.socketIp, componentPropBindingMap?.['t-iframe-32a6.a99f8be3']['socketUrl'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :room-id="replaceCssVariables(filterData(global.socketRoom, componentPropBindingMap?.['t-iframe-32a6.a99f8be3']['roomId'].filters || []), global?.theme || global?.activeTheme || '默认主题')">` +
`</t-iframe>` +
`<t-iframe id="t-iframe-13b6.211504a4b" class="leftMenu-t-iframe-0-7"  :src="tIframex0x7ComputedData.src" :srcdoc="tIframex0x7ComputedData.srcdoc" :scrolling="tIframex0x7ComputedData.scrolling" :c-style="tIframex0x7ComputedData.cStyle" :socket-url="tIframex0x7ComputedData.socketUrl" :room-id="tIframex0x7ComputedData.roomId">` +
`</t-iframe>` +
`<t-rect v-if="state.showMenu === false" id="t-rect-29c7.78199920c" class="leftMenu-t-rect-0-11"  :tip="tRectx0x11ComputedData.tip" :label="tRectx0x11ComputedData.label" :active="tRectx0x11ComputedData.active" :c-style="tRectx0x11ComputedData.cStyle" @click="onclick1721971936695">` +
`</t-rect>` +
`</div>` +
'',
setup() {
...
tRectx0x5: {
defaultStyle: {
            default: {"width":"25px","height":"25px","position":"unset","left":"16px","top":"10px","borderLeft":"1px none rgb(23,62,228)","borderTop":"1px none rgb(23,62,228)","borderRight":"1px none rgb(23,62,228)","borderBottom":"1px none rgb(23,62,228)","backgroundImage":"url(http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/assets/images/2024-07-26/eccc79ac5454467f9fae314902c11228.png)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","cursor":"pointer","borderTopLeftRadius":"4px","borderTopRightRadius":"4px","borderBottomLeftRadius":"4px","borderBottomRightRadius":"4px","backgroundColor":"var(--left-menu-unpack-bg)"},
...
label:"",
active:false,
cStyle:{"wrapper":{"default":{"width":"25px","height":"25px","position":"unset","left":"16px","top":"10px","borderLeft":"1px none rgb(23,62,228)","borderTop":"1px none rgb(23,62,228)","borderRight":"1px none rgb(23,62,228)","borderBottom":"1px none rgb(23,62,228)","backgroundImage":"url(http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/assets/images/2024-07-26/eccc79ac5454467f9fae314902c11228.png)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","cursor":"pointer","borderTopLeftRadius":"4px","borderTopRightRadius":"4px","borderBottomLeftRadius":"4px","borderBottomRightRadius":"4px","backgroundColor":"var(--left-menu-unpack-bg)"}}}, 
 },
},
tIframex0x6: {
defaultStyle: {
...
tRectx0x11: {
defaultStyle: {
            default: {"width":"25px","height":"25px","position":"unset","left":"2px","top":"10px","borderLeft":"1px none rgb(23,62,228)","borderTop":"1px none rgb(23,62,228)","borderRight":"1px none rgb(23,62,228)","borderBottom":"1px none rgb(23,62,228)","backgroundImage":"url(http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/assets/images/2024-07-26/eccc79ac5454467f9fae314902c11228.png)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","cursor":"pointer","borderTopLeftRadius":"4px","borderTopRightRadius":"4px","borderBottomLeftRadius":"4px","borderBottomRightRadius":"4px","animationName":"","transform":"perspective(900px)\n      translate3d(0px,0px,0px)\n      rotateX(0deg) rotateY(0deg) rotateZ(180deg)\n      scaleX(100%) scaleY(100%)\n      skewX(0deg) skewY(0deg)\n      ","pointerEvents":"auto","backgroundColor":"var(--left-menu-unpack-bg)"},
...
label:"",
active:false,
cStyle:{"wrapper":{"default":{"width":"25px","height":"25px","position":"unset","left":"2px","top":"10px","borderLeft":"1px none rgb(23,62,228)","borderTop":"1px none rgb(23,62,228)","borderRight":"1px none rgb(23,62,228)","borderBottom":"1px none rgb(23,62,228)","backgroundImage":"url(http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/assets/images/2024-07-26/eccc79ac5454467f9fae314902c11228.png)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","cursor":"pointer","borderTopLeftRadius":"4px","borderTopRightRadius":"4px","borderBottomLeftRadius":"4px","borderBottomRightRadius":"4px","animationName":"","transform":"perspective(900px)\n      translate3d(0px,0px,0px)\n      rotateX(0deg) rotateY(0deg) rotateZ(180deg)\n      scaleX(100%) scaleY(100%)\n      skewX(0deg) skewY(0deg)\n      ","pointerEvents":"auto","backgroundColor":"var(--left-menu-unpack-bg)"}}}, 
 },
},
});
const setPageSize = () => {

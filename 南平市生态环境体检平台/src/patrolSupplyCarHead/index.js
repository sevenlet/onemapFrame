window.patrolSupplyCarHeadComponent = {
template: 
`<div id="t-l-c-patrolSupplyCarHead" class="t-l-c-patrolSupplyCarHead" >` +
`<t-row id="t-row-a9c1.ffb0f3adb" class="patrolSupplyCarHead-t-row-0-0"  :c-style="tRowx0x0ComputedData.cStyle" :gutter="tRowx0x0ComputedData.gutter" :justify="tRowx0x0ComputedData.justify" :align="tRowx0x0ComputedData.align">` +
`<t-text-common id="t-text-common-ebb5.079f4d7f8" class="patrolSupplyCarHead-t-text-common-0-0-0"  :label="tTextCommonx0x0x0ComputedData.label" :editable="tTextCommonx0x0x0ComputedData.editable" :c-style="tTextCommonx0x0x0ComputedData.cStyle">` +
`</t-text-common>` +
`<t-rect id="t-rect-5ddd.c09e8a3a4" class="patrolSupplyCarHead-t-rect-0-0-1"  :tip="tRectx0x0x1ComputedData.tip" :label="tRectx0x0x1ComputedData.label" :active="tRectx0x0x1ComputedData.active" :c-style="tRectx0x0x1ComputedData.cStyle">` +
`</t-rect>` +
`</t-row>` +
`</div>` +
'',

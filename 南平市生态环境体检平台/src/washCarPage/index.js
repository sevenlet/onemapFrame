window.washCarPageComponent = {
template: 
`<div id="t-l-c-washCarPage" class="t-l-c-washCarPage" >` +
`<t-component id="t-component-aa14.3ba955fbb" class="washCarPage-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName">` +
`</t-component>` +
`<t-text-unit id="t-text-unit-a3c4.48c326f87" class="washCarPage-t-text-unit-0-1"  :c-style="tTextUnitx0x1ComputedData.cStyle" :justify="tTextUnitx0x1ComputedData.justify" :align="tTextUnitx0x1ComputedData.align" :content="tTextUnitx0x1ComputedData.content" :unit="tTextUnitx0x1ComputedData.unit" :show-overflow-tooltip="tTextUnitx0x1ComputedData.showOverflowTooltip">` +
`</t-text-unit>` +
`<t-component id="t-component-9ecd.617296bbe" class="washCarPage-t-component-0-3"  :name="tComponentx0x3ComputedData.name" :loading="tComponentx0x3ComputedData.loading" :c-style="tComponentx0x3ComputedData.cStyle" :src="tComponentx0x3ComputedData.src" :component-name="tComponentx0x3ComputedData.componentName" :page-id="tComponentx0x3ComputedData.pageId" :page-code="tComponentx0x3ComputedData.pageCode">` +
`</t-component>` +
`</div>` +
'',
setup() {
...
name:"washCarListComponent",
loading:true,
cStyle:{"wrapper":{"default":{"width":"410px","height":"800px","margin":"0 auto","left":"0px"}}},
src:"/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/index.html#/washCarList",
componentName:"washCarListComponent",
pageId:"c18362a2ebb34866afcc649eda2fa64b",
pageCode:"washCarList", 
 },
},
});
...
goToLocation(row,column);
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-washCarPage', global.appScaleMode, 'normal');

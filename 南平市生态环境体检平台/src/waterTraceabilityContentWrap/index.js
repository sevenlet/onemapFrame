window.waterTraceabilityContentWrapComponent = {
template: 
`<div id="t-l-c-waterTraceabilityContentWrap" class="t-l-c-waterTraceabilityContentWrap" >` +
`<t-component id="t-component-18ba.8b4f27f22" class="waterTraceabilityContentWrap-t-component-0-0"  :name="replaceCssVariables(filterData(state.componentName, componentPropBindingMap?.['t-component-18ba.8b4f27f22']['name'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :loading="tComponentx0x0ComputedData.loading" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="replaceCssVariables(filterData(state.componentName, componentPropBindingMap?.['t-component-18ba.8b4f27f22']['componentName'].filters || []), global?.theme || global?.activeTheme || '默认主题')">` +
`</t-component>` +
`<t-tabs-base id="t-tabs-base-69f4.253cca2ad" class="waterTraceabilityContentWrap-t-tabs-base-0-1"  :data="tTabsBasex0x1ComputedData.data" :space="tTabsBasex0x1ComputedData.space" :selected-tab-val="replaceCssVariables(filterData(state.componentName, componentPropBindingMap?.['t-tabs-base-69f4.253cca2ad']['selectedTabVal'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :inner-shadow-color="tTabsBasex0x1ComputedData.innerShadowColor" :active-inner-shadow-color="tTabsBasex0x1ComputedData.activeInnerShadowColor" :alias="tTabsBasex0x1ComputedData.alias" :c-style="tTabsBasex0x1ComputedData.cStyle" @tab-click="ontabClick1764666014993">` +
`</t-tabs-base>` +
`</div>` +
'',
setup() {

window.videoSurveillanceComponent = {
template: 
`<div id="t-l-c-videoSurveillance" class="t-l-c-videoSurveillance" >` +
`<t-component id="t-component-8e48.97bfc3379" class="videoSurveillance-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :loading="tComponentx0x0ComputedData.loading" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName" :page-id="tComponentx0x0ComputedData.pageId" :page-code="tComponentx0x0ComputedData.pageCode">` +
`</t-component>` +
`</div>` +
'',
setup() {
const componentPropBindingMap = {"body":{"attributeName":"tBodyx0x0"},"t-component-8e48.97bfc3379":{"attributeName":"tComponentx0x0","name":{"filters":[]},"loading":{"filters":[]},"cStyle":{"filters":[]},"src":{"filters":[]},"componentName":{"filters":[]},"pageId":{"filters":[]},"pageCode":{"filters":[]}}};
// 页面内注入全局变量和事件
...
tComponentx0x0: {
defaultStyle: {
            default: {"width":"100%","height":"100%","margin":"0 auto","left":"0px","top":"0px"},
...
loading:true,
cStyle:{"wrapper":{"default":{"width":"100%","height":"100%","margin":"0 auto","left":"0px","top":"0px"}}},
...
pageCode:"ssqyVideoSurveillance", 
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-videoSurveillance', global.appScaleMode, 'normal');

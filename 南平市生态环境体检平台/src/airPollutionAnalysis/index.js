window.airPollutionAnalysisComponent = {
template: 
`<div id="t-l-c-airPollutionAnalysis" class="t-l-c-airPollutionAnalysis" >` +
`<t-rect id="t-rect-a017.0e5f30ec7" class="airPollutionAnalysis-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle">` +
`</t-rect>` +
`<t-rect id="t-rect-41f1.1a169121" class="airPollutionAnalysis-t-rect-0-1"  :tip="tRectx0x1ComputedData.tip" :label="tRectx0x1ComputedData.label" :active="tRectx0x1ComputedData.active" :c-style="tRectx0x1ComputedData.cStyle">` +
`</t-rect>` +
`<t-text id="t-text-1795.4bece65e8" class="airPollutionAnalysis-t-text-0-2"  :label="state.pageTitle" :editable="tTextx0x2ComputedData.editable" :c-style="tTextx0x2ComputedData.cStyle">` +
`</t-text>` +
`<t-rect id="t-rect-daaa.9f199dcba" class="airPollutionAnalysis-t-rect-0-3"  :tip="tRectx0x3ComputedData.tip" :label="tRectx0x3ComputedData.label" :active="tRectx0x3ComputedData.active" :c-style="tRectx0x3ComputedData.cStyle" @click="onclick1734493405211">` +
`</t-rect>` +
`<t-tabs-base id="t-tabs-base-80a8.4b6523362" class="airPollutionAnalysis-t-tabs-base-0-4"  :data="tTabsBasex0x4ComputedData.data" :space="tTabsBasex0x4ComputedData.space" :selected-tab-val="state.tabType" :inner-shadow-color="tTabsBasex0x4ComputedData.innerShadowColor" :active-inner-shadow-color="tTabsBasex0x4ComputedData.activeInnerShadowColor" :alias="tTabsBasex0x4ComputedData.alias" :c-style="tTabsBasex0x4ComputedData.cStyle" @tab-click="ontabClick1737023135787">` +
`</t-tabs-base>` +
`<t-component id="t-component-54c0.a90efb20f" class="airPollutionAnalysis-t-component-0-5"  :name="state.tabType" :c-style="tComponentx0x5ComputedData.cStyle" :src="tComponentx0x5ComputedData.src" :component-name="state.tabType">` +
`</t-component>` +
`</div>` +
'',
setup() {
...
const state = Vue.reactive({
   screenSize: "",
   tabType: "airPollutionAnalysisAreaComponent",
   dataLength: "",
   selectTimeArr: [],
   endTime: "",
   startTime: "",
...
tTextx0x2: {
defaultStyle: {
            default: {"width":"326px","height":"19px","color":"rgba(255, 255, 255, 1)","fontSize":"18px","position":"unset","left":"479px","top":"197px","backgroundImage":"url(http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78/assets/images/2024-04-17/26907d3cdd3d451c98ec22ec5199d46d.svg)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"26px 26px","-webkit-mask-size":"","backgroundPosition":"0% 50%","-webkit-mask-position":"","paddingLeft":"32px","fontWeight":"700","animationName":""},
...
label:"污染区间分析",
editable:false,
cStyle:{"wrapper":{"default":{"width":"326px","height":"19px","color":"rgba(255, 255, 255, 1)","fontSize":"18px","position":"unset","left":"479px","top":"197px","backgroundImage":"url(http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78/assets/images/2024-04-17/26907d3cdd3d451c98ec22ec5199d46d.svg)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"26px 26px","-webkit-mask-size":"","backgroundPosition":"0% 50%","-webkit-mask-position":"","paddingLeft":"32px","fontWeight":"700","animationName":""}}}, 
 },
},
tRectx0x3: {
defaultStyle: {
...
const ontabClick1737023135787 = (data) => {
// 设置变量值
state.tabType = data.value;
};
 function handleWindowResize() {
                            setPageScale('t-l-c-airPollutionAnalysis', global.appScaleMode, 'normal');
...
onclick1734493405211,
ontabClick1737023135787,
};
},
};
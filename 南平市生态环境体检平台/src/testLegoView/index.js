window.testLegoViewComponent = {
template: 
`<div id="t-l-c-testLegoView" class="t-l-c-testLegoView" >` +
`<t-iframe id="t-iframe-37f5.a5d9129c2" class="testLegoView-t-iframe-0-0"  :src="tIframex0x0ComputedData.src" :srcdoc="tIframex0x0ComputedData.srcdoc" :scrolling="tIframex0x0ComputedData.scrolling" :c-style="tIframex0x0ComputedData.cStyle">` +
`</t-iframe>` +
`<t-gradient-text id="t-gradient-text-1cd8.c934eae59" class="testLegoView-t-gradient-text-0-1"  :label="state.title" :c-style="tGradientTextx0x1ComputedData.cStyle">` +
`</t-gradient-text>` +
`<t-card-icon-base id="t-card-icon-base-6f23.ca68a579d" class="testLegoView-t-card-icon-base-0-2"  :c-style="tCardIconBasex0x2ComputedData.cStyle" :spacing-x="tCardIconBasex0x2ComputedData.spacingX" :col="tCardIconBasex0x2ComputedData.col" :data-alias="tCardIconBasex0x2ComputedData.dataAlias" :data="tCardIconBasex0x2ComputedData.data" @card-click="oncardClick1720165547172">` +
`</t-card-icon-base>` +
`</div>` +
'',
setup() {

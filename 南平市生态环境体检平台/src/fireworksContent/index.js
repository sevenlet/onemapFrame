window.fireworksContentComponent = {
template: 
`<div id="t-l-c-fireworksContent" class="t-l-c-fireworksContent" >` +
`<t-tabs id="t-tabs-f609.2971f9e49" class="fireworksContent-t-tabs-0-0"  :alias="tTabsx0x0ComputedData.alias" :data="replaceCssVariables(filterData(state.tabs, componentPropBindingMap?.['t-tabs-f609.2971f9e49']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active-tab="replaceCssVariables(filterData(global.airGlobalVariables.fireworks.selectedTab, componentPropBindingMap?.['t-tabs-f609.2971f9e49']['activeTab'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :tab-position-extend="tTabsx0x0ComputedData.tabPositionExtend" :stretch="tTabsx0x0ComputedData.stretch" :c-style="tTabsx0x0ComputedData.cStyle" @tab-click="ontabClick1733388893232">` +
`</t-tabs>` +
`<t-component id="t-component-acf1.cd221410d" class="fireworksContent-t-component-0-1"  :name="replaceCssVariables(filterData(global.airGlobalVariables.fireworks.selectedTab, componentPropBindingMap?.['t-component-acf1.cd221410d']['name'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :c-style="tComponentx0x1ComputedData.cStyle" :src="tComponentx0x1ComputedData.src" :component-name="replaceCssVariables(filterData(global.airGlobalVariables.fireworks.selectedTab, componentPropBindingMap?.['t-component-acf1.cd221410d']['componentName'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :page-id="tComponentx0x1ComputedData.pageId" :page-code="tComponentx0x1ComputedData.pageCode">` +
`</t-component>` +
`</div>` +
'',
setup() {
...
const state = Vue.reactive({
   ...
   tabs: [{"label":"实时概况","name":"realTimeOverviewContentComponent","iconSrc":"http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/assets/images/2024-12-04/d052f7e964ea40d9bb2b355304c75152.svg","activeIconSrc":"http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/assets/images/2024-12-04/e37bc846a3fe44229b07f0b761c3a1e9.svg"},{"label":"实时告警","name":"realAlarmContentComponent","iconSrc":"http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/assets/images/2024-12-04/d052f7e964ea40d9bb2b355304c75152.svg","activeIconSrc":"http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/assets/images/2024-12-04/e37bc846a3fe44229b07f0b761c3a1e9.svg"},{"label":"报警记录","name":"earlyWarningForecastContentComponent","iconSrc":"http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/assets/images/2024-12-04/f40ea51273ed4ad2a2644d1e5f2683bd.svg","activeIconSrc":"http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/assets/images/2024-12-04/490ed07e9da94ef391daeb22bf5d7dff.svg"}],
   tabsActiveValue: "realAlarmContentComponent",
});
// 选中的图表主题
...
data:[{"label":"实时概况","name":"realTimeOverviewContentComponent","iconSrc":"http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/assets/images/2024-12-04/d052f7e964ea40d9bb2b355304c75152.svg","activeIconSrc":"http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/assets/images/2024-12-04/e37bc846a3fe44229b07f0b761c3a1e9.svg"},{"label":"实时告警","name":"realAlarmContentComponent","iconSrc":"http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/assets/images/2024-12-04/d052f7e964ea40d9bb2b355304c75152.svg","activeIconSrc":"http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/assets/images/2024-12-04/e37bc846a3fe44229b07f0b761c3a1e9.svg"},{"label":"报警记录","name":"earlyWarningForecastContentComponent","iconSrc":"http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/assets/images/2024-12-04/f40ea51273ed4ad2a2644d1e5f2683bd.svg","activeIconSrc":"http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/assets/images/2024-12-04/490ed07e9da94ef391daeb22bf5d7dff.svg"}],
activeTab:"realAlarmContentComponent",
...
name:"realAlarmContentComponent",
...
src:"/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/index.html#/realAlarmContent",
componentName:"realAlarmContentComponent",
pageId:"",
pageCode:"", 
 },
},
...
state.tabs[2].iconSrc = getCssVariable('--business-tab-target');
};
...
let tag = ''
if(data === 'realAlarmContentComponent'){
  tag = 'realTimeAlarm'
}else if(data === 'earlyWarningForecastContentComponent'){
  tag = 'policeRecord'
}else if(data === 'realTimeOverviewContentComponent'){
  tag = 'realTimeAlarm'
}
...
const setSelectdTab = () => {
// 监听实时告警or报警记录溯源，用于溯源面板返回，选中之前tab
watch(() => global.airGlobalVariables.fireworks.traceType, (newValue) =>{
   debugger;
   state.tabsActiveValue = newValue
}, {immediate: true})
};
...
rootData.rootEmit(
                  'rootData:change',
                  {
                    key:'airGlobalVariables.fireworks.selectedTab',
                    value:data.name,
                    data: {
                      airGlobalVariables:{fireworks:{selectedTab: data.name}}
                    },
                  });
// 执行自定义方法
setTabIcon();
...
rootData.rootEmit(
                  'rootData:change',
                  {
                    ...
                    value:false,
                    data: {
                      airGlobalVariables:{fireworks:{isEnterHdPage: false}}
                    },
                  });
};let apiRegistry = {}; 
...
if (data?.head?.statusCode === '200' && data?.data) {
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-fireworksContent', global.appScaleMode, 'normal');

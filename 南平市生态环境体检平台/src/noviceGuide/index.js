...
`<t-image-base v-if="state.step === 4" id="t-image-base-85ab.fe9953464" class="noviceGuide-t-image-base-0-0"  :src="tImageBasex0x0ComputedData.src" :fit="tImageBasex0x0ComputedData.fit" :c-style="tImageBasex0x0ComputedData.cStyle">` +
`</t-image-base>` +
`<t-rect v-if="state.step === 4" id="t-rect-feba.d9e38fd6d" class="noviceGuide-t-rect-0-1"  :tip="tRectx0x1ComputedData.tip" :label="tRectx0x1ComputedData.label" :active="tRectx0x1ComputedData.active" :c-style="tRectx0x1ComputedData.cStyle" @click="onclick1722403069424">` +
`</t-rect>` +
`<t-checkbox v-if="state.step === 4" id="t-checkbox-a356.405d2afa4" class="noviceGuide-t-checkbox-0-2"  :data="tCheckboxx0x2ComputedData.data" :active="state.multiSelect" :data-alias="tCheckboxx0x2ComputedData.dataAlias" :border="tCheckboxx0x2ComputedData.border" :use-button="tCheckboxx0x2ComputedData.useButton" :c-style="tCheckboxx0x2ComputedData.cStyle" @change="onchange1722419951177">` +
`</t-checkbox>` +
`<t-image-base v-if="state.step === 3" id="t-image-base-6ab0.7bac10c8e" class="noviceGuide-t-image-base-0-3"  :src="tImageBasex0x3ComputedData.src" :fit="tImageBasex0x3ComputedData.fit" :c-style="tImageBasex0x3ComputedData.cStyle">` +
`</t-image-base>` +
`<t-rect v-if="state.step === 3" id="t-rect-920b.7bd7e2986" class="noviceGuide-t-rect-0-4"  :tip="tRectx0x4ComputedData.tip" :label="tRectx0x4ComputedData.label" :active="tRectx0x4ComputedData.active" :c-style="tRectx0x4ComputedData.cStyle" @click="onclick1722403028176">` +
`</t-rect>` +
`<t-image-base v-if="state.step === 2" id="t-image-base-83ff.103b5ae9d" class="noviceGuide-t-image-base-0-5"  :src="tImageBasex0x5ComputedData.src" :fit="tImageBasex0x5ComputedData.fit" :c-style="tImageBasex0x5ComputedData.cStyle">` +
`</t-image-base>` +
`<t-rect v-if="state.step === 2" id="t-rect-35fb.9b00d1dca" class="noviceGuide-t-rect-0-6"  :tip="tRectx0x6ComputedData.tip" :label="tRectx0x6ComputedData.label" :active="tRectx0x6ComputedData.active" :c-style="tRectx0x6ComputedData.cStyle" @click="onclick1722403012592">` +
`</t-rect>` +
`<t-image-base v-if="state.step === 1" id="t-image-base-e647.4c28ba299" class="noviceGuide-t-image-base-0-7"  :src="tImageBasex0x7ComputedData.src" :fit="tImageBasex0x7ComputedData.fit" :c-style="tImageBasex0x7ComputedData.cStyle">` +
`</t-image-base>` +
`<t-rect v-if="state.step === 1" id="t-rect-c361.ed895453c" class="noviceGuide-t-rect-0-8"  :tip="tRectx0x8ComputedData.tip" :label="tRectx0x8ComputedData.label" :active="tRectx0x8ComputedData.active" :c-style="tRectx0x8ComputedData.cStyle" @click="onclick1722403054112">` +
`</t-rect>` +
`</div>` +
'',
setup() {
...
tImageBasex0x0: {
defaultStyle: {
            default: {"width":"565px","height":"617px","top":"452px","left":"1326px","position":"unset","animationName":""},
            
            },
 default: { 
 
src:"http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/27d54c897f0f4ba18421a7b587fe4ce4/assets/images/2024-07-31/11c069d1141b48ca89dd97ec2e8a0bda.png",
fit:"fill",
...
tRectx0x1: {
defaultStyle: {
            default: {"width":"66px","height":"26px","color":"rgba(0, 0, 0, 0.9)","fontSize":"14px","borderLeft":"1px solid #99AAFF","borderTop":"1px solid #99AAFF","borderRight":"1px solid #99AAFF","borderBottom":"1px solid #99AAFF","borderTopLeftRadius":"35px","borderTopRightRadius":"35px","borderBottomLeftRadius":"35px","borderBottomRightRadius":"35px","position":"unset","left":"1586px","top":"474px","lineHeight":"28px","animationName":""},
...
tCheckboxx0x2: {
defaultStyle: {
            default: {"display":"flex","alignItems":"center","justifyContent":"center","width":"73px","height":"20px","position":"unset","left":"1474px","top":"476px"},
...
tImageBasex0x3: {
defaultStyle: {
            default: {"width":"706px","height":"268px","top":"801px","left":"1185px","position":"unset","animationName":""},
            
            },
 default: { 
 
src:"http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/27d54c897f0f4ba18421a7b587fe4ce4/assets/images/2024-07-31/3bb791319a364c288a1d376b4dd55dde.png",
fit:"fill",
...
tImageBasex0x5: {
defaultStyle: {
            default: {"width":"706px","height":"370px","top":"699px","left":"1185px","position":"unset","animationName":""},
            
            },
 default: { 
 
src:"http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/27d54c897f0f4ba18421a7b587fe4ce4/assets/images/2024-07-31/f00b5550ce71479191dec263f72fb3a7.png",
fit:"fill",
...
tImageBasex0x7: {
defaultStyle: {
            default: {"width":"402px","height":"318px","top":"736px","left":"1478px","position":"unset"},
            
            },
 default: { 
 
src:"http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/27d54c897f0f4ba18421a7b587fe4ce4/assets/images/2024-07-31/058a0013f26a4eb0818dba5d75f132a4.png",
fit:"fill",
...
window.removeEventListener('resize', handleWindowResize);
 ...
 const tCheckboxx0x2ComputedData = computed(() => _.merge({}, componentState.tCheckboxx0x2.default, componentState.tCheckboxx0x2?.[state.screenSize]));

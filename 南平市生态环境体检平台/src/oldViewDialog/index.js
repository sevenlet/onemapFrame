window.oldViewDialogComponent = {
template: 
`<div id="t-l-c-oldViewDialog" class="t-l-c-oldViewDialog" >` +
`<t-rect id="t-rect-956c.76f89a13a" class="oldViewDialog-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle">` +
`</t-rect>` +
`<t-rect id="t-rect-7f6d.f68c6ee65" class="oldViewDialog-t-rect-0-1"  :tip="tRectx0x1ComputedData.tip" :label="tRectx0x1ComputedData.label" :active="tRectx0x1ComputedData.active" :c-style="tRectx0x1ComputedData.cStyle">` +
`</t-rect>` +
`<t-rect id="t-rect-e5ee.fb1b5f0aa" class="oldViewDialog-t-rect-0-2"  :tip="tRectx0x2ComputedData.tip" :label="tRectx0x2ComputedData.label" :active="tRectx0x2ComputedData.active" :c-style="tRectx0x2ComputedData.cStyle">` +
`</t-rect>` +
`<t-image-base id="t-image-base-391f.0550b0bf5" class="oldViewDialog-t-image-base-0-3"  :src="tImageBasex0x3ComputedData.src" :fit="tImageBasex0x3ComputedData.fit" :c-style="tImageBasex0x3ComputedData.cStyle">` +
`</t-image-base>` +
`<t-rect id="t-rect-0090.dfbcd0634" class="oldViewDialog-t-rect-0-4"  :tip="tRectx0x4ComputedData.tip" :label="tRectx0x4ComputedData.label" :active="tRectx0x4ComputedData.active" :c-style="tRectx0x4ComputedData.cStyle" @click="onclick1721979040344">` +
`</t-rect>` +
`<t-text id="t-text-01d3.75edb0e66" class="oldViewDialog-t-text-0-5"  :label="tTextx0x5ComputedData.label" :editable="tTextx0x5ComputedData.editable" :c-style="tTextx0x5ComputedData.cStyle">` +
`</t-text>` +
`<t-iframe id="t-iframe-e73e.76136d908" class="oldViewDialog-t-iframe-0-6"  :src="state.oldViewDialogIframeUrl" :srcdoc="tIframex0x6ComputedData.srcdoc" :scrolling="tIframex0x6ComputedData.scrolling" :c-style="tIframex0x6ComputedData.cStyle">` +
`</t-iframe>` +
`</div>` +
'',
setup() {
...
tTextx0x5: {
defaultStyle: {
            default: {"width":"96px","height":"19px","color":"var(--intergrated-query-font-color)","position":"unset","left":"308px","top":"189px","font-size":"18px","text-shadow":"0px 0px 6px rgba(17, 214, 104, 0.62)","font-weight":"bold","animationName":""},
...
label:"企业详情",
editable:false,
cStyle:{"wrapper":{"default":{"width":"96px","height":"19px","color":"var(--intergrated-query-font-color)","position":"unset","left":"308px","top":"189px","font-size":"18px","text-shadow":"0px 0px 6px rgba(17, 214, 104, 0.62)","font-weight":"bold","animationName":""}}}, 
 },
},
tIframex0x6: {
defaultStyle: {
            default: {"width":"1071px","height":"737px","position":"unset","left":"277px","top":"233px","backgroundColor":"rgba(23, 62, 228, 0)"},
...
srcdoc:"",
scrolling:"yes",
cStyle:{"wrapper":{"default":{"width":"1071px","height":"737px","position":"unset","left":"277px","top":"233px","backgroundColor":"rgba(23, 62, 228, 0)"}}}, 
 },
},
});
const updateIframeUrl = (data) => {
console.log("企业详情弹窗测试",data);
let msgData = JSON.parse(data);
state.oldViewDialogIframeUrl = msgData.url;
console.log(111,state.oldViewDialogIframeUrl);
};
...
rootData.rootEmit(
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-oldViewDialog', global.appScaleMode, 'normal');
...
if(data.type === "showOldViewDialog"){
try{
// 执行自定义方法
updateIframeUrl(data.data);
} catch (error) {

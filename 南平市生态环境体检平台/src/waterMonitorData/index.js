window.waterMonitorDataComponent = {
template: 
`<div id="t-l-c-waterMonitorData" class="t-l-c-waterMonitorData" >` +
...
`</t-date-picker>` +
`<t-text id="t-text-f339.46f7d45c5" class="waterMonitorData-t-text-0-3"  :label="tTextx0x3ComputedData.label" :editable="tTextx0x3ComputedData.editable" :c-style="tTextx0x3ComputedData.cStyle">` +
`</t-text>` +
`<t-text id="t-text-f5e3.e386f76d9" class="waterMonitorData-t-text-0-4"  :label="tTextx0x4ComputedData.label" :editable="tTextx0x4ComputedData.editable" :c-style="tTextx0x4ComputedData.cStyle">` +
`</t-text>` +
`<t-chart-curve id="t-chart-curve-1f74.64749a6bd" class="waterMonitorData-t-chart-curve-0-5"  :empty-img="tChartCurvex0x5ComputedData.emptyImg" :series-setting="tChartCurvex0x5ComputedData.seriesSetting" :data="replaceCssVariables(state.lineData, global?.theme || global?.activeTheme || '默认主题')" :options="tChartCurvex0x5ComputedData.options" :c-style="tChartCurvex0x5ComputedData.cStyle" :y-axis-left-options="tChartCurvex0x5ComputedData.yAxisLeftOptions" :y-axis-right-options="tChartCurvex0x5ComputedData.yAxisRightOptions" :line="componentState.tChartCurvex0x5.line">` +
`</t-chart-curve>` +
`<t-text id="t-text-ee43.3a6e69413" class="waterMonitorData-t-text-0-6"  :label="replaceCssVariables(state.unit, global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x6ComputedData.editable" :c-style="tTextx0x6ComputedData.cStyle">` +
`</t-text>` +
`</div>` +
'',
setup() {

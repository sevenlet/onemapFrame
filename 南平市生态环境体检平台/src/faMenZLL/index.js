window.faMenZLLComponent = {
template: 
`<div id="t-l-c-faMenZLL" class="t-l-c-faMenZLL" >` +
`<t-rect id="t-rect-172c.ee323b01d" class="faMenZLL-t-rect-0-0"  :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle" :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label">` +
`</t-rect>` +
`<t-text id="t-text-5895.4a069281a" class="faMenZLL-t-text-0-1"  :editable="tTextx0x1ComputedData.editable" :show-title="tTextx0x1ComputedData.showTitle" :c-style="tTextx0x1ComputedData.cStyle" :label="tTextx0x1ComputedData.label">` +
`</t-text>` +
`<t-text id="t-text-790b.0ece4d5af" class="faMenZLL-t-text-0-2"  :editable="tTextx0x2ComputedData.editable" :show-title="tTextx0x2ComputedData.showTitle" :c-style="tTextx0x2ComputedData.cStyle" :label="replaceCssVariables(filterData(global.waterStationDialogGlobalVariables.baseMessage.ZMZLL_AVG, componentPropBindingMap?.['t-text-790b.0ece4d5af']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')">` +
`</t-text>` +
`<t-line id="t-line-5604.4054f8de7" class="faMenZLL-t-line-0-3"  :c-style="tLinex0x3ComputedData.cStyle">` +
`</t-line>` +
`<t-text id="t-text-add5.f9d63834" class="faMenZLL-t-text-0-4"  :editable="tTextx0x4ComputedData.editable" :show-title="tTextx0x4ComputedData.showTitle" :c-style="tTextx0x4ComputedData.cStyle" :label="tTextx0x4ComputedData.label">` +
`</t-text>` +
`<t-text id="t-text-e52b.4238bafc8" class="faMenZLL-t-text-0-5"  :editable="tTextx0x5ComputedData.editable" :show-title="tTextx0x5ComputedData.showTitle" :c-style="tTextx0x5ComputedData.cStyle" :label="replaceCssVariables(filterData(global.waterStationDialogGlobalVariables.baseMessage.ZMZLL_STD, componentPropBindingMap?.['t-text-e52b.4238bafc8']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')">` +
`</t-text>` +
`</div>` +
'',
setup() {

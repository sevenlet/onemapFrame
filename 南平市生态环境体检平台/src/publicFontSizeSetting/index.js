window.publicFontSizeSettingComponent = {
template: 
`<div id="t-l-c-publicFontSizeSetting" class="t-l-c-publicFontSizeSetting" >` +
`<t-rect id="t-rect-b395.d6f6411da" class="publicFontSizeSetting-t-rect-0-0"  :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle" :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" @click="onclick1753094643489">` +
`</t-rect>` +
`<t-component id="t-component-a812.bad50e638" class="publicFontSizeSetting-t-component-0-1"  :src="tComponentx0x1ComputedData.src" :name="tComponentx0x1ComputedData.name" :c-style="tComponentx0x1ComputedData.cStyle" :component-name="tComponentx0x1ComputedData.componentName" :loading="tComponentx0x1ComputedData.loading" :page-id="tComponentx0x1ComputedData.pageId" :page-code="tComponentx0x1ComputedData.pageCode">` +
`</t-component>` +
`</div>` +
'',
setup() {

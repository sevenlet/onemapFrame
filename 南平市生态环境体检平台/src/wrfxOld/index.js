window.wrfxOldComponent = {
template: 
`<div id="t-l-c-wrfxOld" class="t-l-c-wrfxOld" >` +
`<t-rect v-if="state.listLoading === true" id="t-rect-04fa.ba844241f" class="pollutionAnalysis-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle">` +
`</t-rect>` +
`<t-rect v-if="state.cardLoading === true" id="t-rect-82e1.1a78bdcce" class="pollutionAnalysis-t-rect-0-1"  :tip="tRectx0x1ComputedData.tip" :label="tRectx0x1ComputedData.label" :active="tRectx0x1ComputedData.active" :c-style="tRectx0x1ComputedData.cStyle">` +
`</t-rect>` +
`<t-button id="t-button-2397.b3b568691" class="pollutionAnalysis-t-button-0-3"  :label="tButtonx0x3ComputedData.label" :round="tButtonx0x3ComputedData.round" :plain="tButtonx0x3ComputedData.plain" :disabled="tButtonx0x3ComputedData.disabled" :type="tButtonx0x3ComputedData.type" :size="tButtonx0x3ComputedData.size" :native-type="tButtonx0x3ComputedData.native-type" :c-style="tButtonx0x3ComputedData.cStyle" @click="onclick1761120647351">` +
`</t-button>` +
`<t-image-base id="t-image-base-cc01.3413a106e" class="pollutionAnalysis-t-image-base-0-4"  :src="tImageBasex0x4ComputedData.src" :fit="tImageBasex0x4ComputedData.fit" :c-style="tImageBasex0x4ComputedData.cStyle">` +
`</t-image-base>` +
`<t-list-card v-if="state.cardLoading === false" id="t-list-card-2d95.1c787b696" class="pollutionAnalysis-t-list-card-0-5"  :data="replaceCssVariables(filterData(state.sceneList, componentPropBindingMap?.['t-list-card-2d95.1c787b696']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :spacing-x="tListCardx0x5ComputedData.spacingX" :col="tListCardx0x5ComputedData.col" :direction="tListCardx0x5ComputedData.direction" :exchange-order="tListCardx0x5ComputedData.exchangeOrder" :unit-break="tListCardx0x5ComputedData.unitBreak" :key-field="tListCardx0x5ComputedData.keyField" :active-key-field="tListCardx0x5ComputedData.activeKeyField" :active="replaceCssVariables(filterData(state.activeTab.name, componentPropBindingMap?.['t-list-card-2d95.1c787b696']['active'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :c-style="tListCardx0x5ComputedData.cStyle" @card-click="oncardClick1735029005919">` +
`</t-list-card>` +
`<t-rect id="t-rect-364c.0469d38c2" class="pollutionAnalysis-t-rect-0-6"  :tip="tRectx0x6ComputedData.tip" :label="tRectx0x6ComputedData.label" :active="tRectx0x6ComputedData.active" :c-style="tRectx0x6ComputedData.cStyle">` +
`</t-rect>` +
`<t-table v-if="state.listLoading === false" id="t-table-a0d0.258b53cfd" class="pollutionAnalysis-t-table-0-7"  :height="tTablex0x7ComputedData.height" :stripe="tTablex0x7ComputedData.stripe" :border="tTablex0x7ComputedData.border" :auto-scroll="tTablex0x7ComputedData.autoScroll" :speed="tTablex0x7ComputedData.speed" :columns="tTablex0x7ComputedData.columns" :data="replaceCssVariables(filterData(state.enterList, componentPropBindingMap?.['t-table-a0d0.258b53cfd']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x7ComputedData.defaultSort" :c-style="tTablex0x7ComputedData.cStyle" @cell-click="oncellClick1735184769666_0_0">` +
`</t-table>` +
`<t-component id="t-component-3c7c.d9e5b9971" class="pollutionAnalysis-t-component-0-8"  :name="tComponentx0x8ComputedData.name" :c-style="tComponentx0x8ComputedData.cStyle" :src="tComponentx0x8ComputedData.src" :component-name="tComponentx0x8ComputedData.componentName">` +
`</t-component>` +
`<t-text id="t-text-0645.e3c5af32d" class="pollutionAnalysis-t-text-0-9"  :label="tTextx0x9ComputedData.label" :editable="tTextx0x9ComputedData.editable" :c-style="tTextx0x9ComputedData.cStyle">` +
`</t-text>` +
`<t-rect v-if="state.checkedIds !== ''" id="t-rect-f258.31abd13a7" class="pollutionAnalysis-t-rect-0-10"  :tip="tRectx0x10ComputedData.tip" :label="tRectx0x10ComputedData.label" :active="tRectx0x10ComputedData.active" :c-style="tRectx0x10ComputedData.cStyle" @click="onclick1735205190641">` +
`</t-rect>` +
`<t-rect v-if="state.checkedIds === ''" id="t-rect-caab.15629254d" class="pollutionAnalysis-t-rect-0-11"  :tip="tRectx0x11ComputedData.tip" :label="tRectx0x11ComputedData.label" :active="tRectx0x11ComputedData.active" :c-style="tRectx0x11ComputedData.cStyle">` +
`</t-rect>` +
`<t-text id="t-text-5454.74c04491" class="pollutionAnalysis-t-text-0-13"  :label="tTextx0x13ComputedData.label" :editable="tTextx0x13ComputedData.editable" :c-style="tTextx0x13ComputedData.cStyle">` +
`</t-text>` +
`<t-text id="t-text-a89a.7e30697e2" class="pollutionAnalysis-t-text-0-14"  :label="tTextx0x14ComputedData.label" :editable="tTextx0x14ComputedData.editable" :c-style="tTextx0x14ComputedData.cStyle">` +
`</t-text>` +
`<t-text id="t-text-49e3.b2374108a" class="pollutionAnalysis-t-text-0-15"  :label="tTextx0x15ComputedData.label" :editable="tTextx0x15ComputedData.editable" :c-style="tTextx0x15ComputedData.cStyle">` +
`</t-text>` +
`<t-text id="t-text-3797.0a506c66b" class="pollutionAnalysis-t-text-0-16"  :label="tTextx0x16ComputedData.label" :editable="tTextx0x16ComputedData.editable" :c-style="tTextx0x16ComputedData.cStyle">` +
`</t-text>` +
`<t-radio id="t-radio-7049.20f57b6cf" class="pollutionAnalysis-t-radio-0-17"  :options="tRadiox0x17ComputedData.options" :active="replaceCssVariables(filterData(state.selectedParams.direction, componentPropBindingMap?.['t-radio-7049.20f57b6cf']['active'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :alias="tRadiox0x17ComputedData.alias" :disabled="tRadiox0x17ComputedData.disabled" :border="tRadiox0x17ComputedData.border" :size="tRadiox0x17ComputedData.size" :is-use-button="tRadiox0x17ComputedData.isUseButton" :c-style="tRadiox0x17ComputedData.cStyle" @change="onchange1740720896505">` +
`</t-radio>` +
`<t-radio id="t-radio-f568.197f4f8a6" class="pollutionAnalysis-t-radio-0-18"  :options="tRadiox0x18ComputedData.options" :active="replaceCssVariables(filterData(state.selectedParams.buffer, componentPropBindingMap?.['t-radio-f568.197f4f8a6']['active'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :alias="tRadiox0x18ComputedData.alias" :disabled="tRadiox0x18ComputedData.disabled" :border="tRadiox0x18ComputedData.border" :size="tRadiox0x18ComputedData.size" :is-use-button="tRadiox0x18ComputedData.isUseButton" :c-style="tRadiox0x18ComputedData.cStyle" @change="onchange1740720921561">` +
`</t-radio>` +
`<t-checkbox id="t-checkbox-3380.5456a8ecb" class="pollutionAnalysis-t-checkbox-0-19"  :data="tCheckboxx0x19ComputedData.data" :active="replaceCssVariables(filterData(state.selectedParams.altitude, componentPropBindingMap?.['t-checkbox-3380.5456a8ecb']['active'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :data-alias="tCheckboxx0x19ComputedData.dataAlias" :border="tCheckboxx0x19ComputedData.border" :use-button="tCheckboxx0x19ComputedData.useButton" :c-style="tCheckboxx0x19ComputedData.cStyle" @change="onchange1740720873822">` +
`</t-checkbox>` +
...
if (column.label === '定位') {
  ...
  const item = state.enterList.find((val) => val.DATA_PKID === row.DATA_PKID);
  if (item) {
    // 复选
    // dispatchTask(row.DATA_PKID);
    if (item.isCheck === '0') {

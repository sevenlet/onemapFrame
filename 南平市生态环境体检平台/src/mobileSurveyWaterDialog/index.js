window.mobileSurveyWaterDialogComponent = {
template: 
`<div id="t-l-c-mobileSurveyWaterDialog" class="t-l-c-mobileSurveyWaterDialog" >` +
`<t-component id="t-component-9e87.1d809558f" class="mobileSurveyWaterDialog-t-component-0-0"  :src="tComponentx0x0ComputedData.src" :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :component-name="tComponentx0x0ComputedData.componentName" :page-id="tComponentx0x0ComputedData.pageId" :page-code="tComponentx0x0ComputedData.pageCode">` +
`</t-component>` +
`<t-rect id="t-rect-1383.917add424" class="mobileSurveyWaterDialog-t-rect-0-1"  :tip="tRectx0x1ComputedData.tip" :label="tRectx0x1ComputedData.label" :active="tRectx0x1ComputedData.active" :c-style="tRectx0x1ComputedData.cStyle">` +
`</t-rect>` +
`<t-text id="t-text-21b6.45c6bc002" class="mobileSurveyWaterDialog-t-text-0-2"  :label="replaceCssVariables(filterData(state.baseInfo.VEHICLE_NAME, componentPropBindingMap?.['t-text-21b6.45c6bc002']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x2ComputedData.editable" :c-style="tTextx0x2ComputedData.cStyle">` +
`</t-text>` +
`<t-rect id="t-rect-1f5e.d7f849edd" class="mobileSurveyWaterDialog-t-rect-0-3"  :active="tRectx0x3ComputedData.active" :c-style="tRectx0x3ComputedData.cStyle" :tip="tRectx0x3ComputedData.tip" :label="tRectx0x3ComputedData.label">` +
`</t-rect>` +
...
`</t-text>` +
`<t-row id="t-row-9345.48748282e" class="mobileSurveyWaterDialog-t-row-0-5"  :c-style="tRowx0x5ComputedData.cStyle" :gutter="tRowx0x5ComputedData.gutter" :justify="tRowx0x5ComputedData.justify" :align="tRowx0x5ComputedData.align">` +
`<t-text id="t-text-b1ec.826254365" class="mobileSurveyWaterDialog-t-text-0-5-0"  :label="tTextx0x5x0ComputedData.label" :editable="tTextx0x5x0ComputedData.editable" :c-style="tTextx0x5x0ComputedData.cStyle" @click="onclick1766394251098">` +
`</t-text>` +
`<t-text id="t-text-c9ea.525b8151a" class="mobileSurveyWaterDialog-t-text-0-5-1"  :label="replaceCssVariables(filterData(state.title, componentPropBindingMap?.['t-text-c9ea.525b8151a']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x5x1ComputedData.editable" :c-style="tTextx0x5x1ComputedData.cStyle">` +
`</t-text>` +
`</t-row>` +
`<t-image-base id="t-image-base-c9a7.867dae324" class="mobileSurveyWaterDialog-t-image-base-0-6"  :fit="tImageBasex0x6ComputedData.fit" :src="tImageBasex0x6ComputedData.src" :c-style="tImageBasex0x6ComputedData.cStyle" @click="onclick1718723586167">` +
`</t-image-base>` +
`<t-swiper-base id="t-swiper-base-b9a2.1390771de" class="mobileSurveyWaterDialog-t-swiper-base-0-7"  :data="replaceCssVariables(filterData(state.imgList, componentPropBindingMap?.['t-swiper-base-b9a2.1390771de']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :arrow="tSwiperBasex0x7ComputedData.arrow" :c-style="tSwiperBasex0x7ComputedData.cStyle" :series-setting="tSwiperBasex0x7ComputedData.seriesSetting" :autoplay="tSwiperBasex0x7ComputedData.autoplay">` +
`</t-swiper-base>` +
`<t-rect id="t-rect-46f3.96aef9b27" class="mobileSurveyWaterDialog-t-rect-0-8"  :active="tRectx0x8ComputedData.active" :c-style="tRectx0x8ComputedData.cStyle" :tip="tRectx0x8ComputedData.tip" :label="tRectx0x8ComputedData.label" @click="onclick1718710562227">` +
`</t-rect>` +
`<t-rect id="t-rect-877f.a4447ae46" class="mobileSurveyWaterDialog-t-rect-0-9"  :active="tRectx0x9ComputedData.active" :c-style="tRectx0x9ComputedData.cStyle" :tip="tRectx0x9ComputedData.tip" :label="tRectx0x9ComputedData.label" @click="onclick1718710614305">` +
`</t-rect>` +
`<t-rect id="t-rect-9ef4.3a76fec4b" class="mobileSurveyWaterDialog-t-rect-0-10"  :active="tRectx0x10ComputedData.active" :c-style="tRectx0x10ComputedData.cStyle" :tip="tRectx0x10ComputedData.tip" :label="tRectx0x10ComputedData.label" @click="onclick1718710697775">` +
`</t-rect>` +
`<t-rect id="t-rect-4749.bbb6d739" class="mobileSurveyWaterDialog-t-rect-0-11"  :active="tRectx0x11ComputedData.active" :c-style="tRectx0x11ComputedData.cStyle" :tip="tRectx0x11ComputedData.tip" :label="tRectx0x11ComputedData.label" @click="onclick1744726085832_0_0">` +
`</t-rect>` +
`<t-text id="t-text-df00.53e56b9cc" class="mobileSurveyWaterDialog-t-text-0-12"  :editable="tTextx0x12ComputedData.editable" :c-style="tTextx0x12ComputedData.cStyle" :label="tTextx0x12ComputedData.label">` +
`</t-text>` +
`<t-text id="t-text-58b5.1c58f2d4e" class="mobileSurveyWaterDialog-t-text-0-13"  :editable="tTextx0x13ComputedData.editable" :c-style="tTextx0x13ComputedData.cStyle" :label="tTextx0x13ComputedData.label">` +
`</t-text>` +
`<t-text id="t-text-bd02.89b9d5ce9" class="mobileSurveyWaterDialog-t-text-0-14"  :editable="tTextx0x14ComputedData.editable" :c-style="tTextx0x14ComputedData.cStyle" :label="tTextx0x14ComputedData.label">` +
`</t-text>` +
`<t-text id="t-text-dc68.e127a0ee8" class="mobileSurveyWaterDialog-t-text-0-15"  :editable="tTextx0x15ComputedData.editable" :c-style="tTextx0x15ComputedData.cStyle" :label="tTextx0x15ComputedData.label">` +
`</t-text>` +
`<t-text id="t-text-50b9.7311c1483" class="mobileSurveyWaterDialog-t-text-0-16"  :editable="tTextx0x16ComputedData.editable" :c-style="tTextx0x16ComputedData.cStyle" :label="tTextx0x16ComputedData.label">` +
`</t-text>` +
`<t-text id="t-text-64d2.64de8994c" class="mobileSurveyWaterDialog-t-text-0-17"  :editable="tTextx0x17ComputedData.editable" :c-style="tTextx0x17ComputedData.cStyle" :label="replaceCssVariables(filterData(state.baseInfo.VMN, componentPropBindingMap?.['t-text-64d2.64de8994c']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')">` +
`</t-text>` +
`<t-text id="t-text-4cb3.988ffa041" class="mobileSurveyWaterDialog-t-text-0-18"  :editable="tTextx0x18ComputedData.editable" :c-style="tTextx0x18ComputedData.cStyle" :label="replaceCssVariables(filterData(state.baseInfo.status_str, componentPropBindingMap?.['t-text-4cb3.988ffa041']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')">` +
`</t-text>` +
`<t-text id="t-text-6ef3.5a4468139" class="mobileSurveyWaterDialog-t-text-0-19"  :editable="tTextx0x19ComputedData.editable" :c-style="tTextx0x19ComputedData.cStyle" :label="replaceCssVariables(filterData(state.baseInfo.address, componentPropBindingMap?.['t-text-6ef3.5a4468139']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')">` +
`</t-text>` +
`<t-text id="t-text-3379.950b2f8b1" class="mobileSurveyWaterDialog-t-text-0-20"  :editable="tTextx0x20ComputedData.editable" :c-style="tTextx0x20ComputedData.cStyle" :label="tTextx0x20ComputedData.label">` +
`</t-text>` +
`<t-text id="t-text-8dea.6876c3cf5" class="mobileSurveyWaterDialog-t-text-0-21"  :editable="tTextx0x21ComputedData.editable" :c-style="tTextx0x21ComputedData.cStyle" :label="replaceCssVariables(filterData(state.START_TIME, componentPropBindingMap?.['t-text-8dea.6876c3cf5']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')">` +
`</t-text>` +
`<t-date-picker id="t-date-picker-1d9b.4e3492dbf" class="mobileSurveyWaterDialog-t-date-picker-0-22"  :placeholder="tDatePickerx0x22ComputedData.placeholder" :start-placeholder="tDatePickerx0x22ComputedData.startPlaceholder" :end-placeholder="tDatePickerx0x22ComputedData.endPlaceholder" :type="tDatePickerx0x22ComputedData.type" :clearable="tDatePickerx0x22ComputedData.clearable" :range-separator="tDatePickerx0x22ComputedData.rangeSeparator" :default-date="replaceCssVariables(filterData(state.START_TIME, componentPropBindingMap?.['t-date-picker-1d9b.4e3492dbf']['default-date'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :separator="tDatePickerx0x22ComputedData.separator" :readonly="tDatePickerx0x22ComputedData.readonly" :editable="tDatePickerx0x22ComputedData.editable" :c-style="tDatePickerx0x22ComputedData.cStyle" :is-disabled-front="tDatePickerx0x22ComputedData.isDisabledFront" :disabled-date="tDatePickerx0x22ComputedData.disabledDate" @date-change="ondateChange1766384591692_0_0">` +
`</t-date-picker>` +
...
`</t-date-picker>` +
`<t-text-unit id="t-text-unit-a551.0986746a7" class="mobileSurveyWaterDialog-t-text-unit-0-24"  :c-style="tTextUnitx0x24ComputedData.cStyle" :justify="tTextUnitx0x24ComputedData.justify" :align="tTextUnitx0x24ComputedData.align" :content="replaceCssVariables(filterData(state.title, componentPropBindingMap?.['t-text-unit-a551.0986746a7']['content'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :unit="tTextUnitx0x24ComputedData.unit" :show-overflow-tooltip="tTextUnitx0x24ComputedData.showOverflowTooltip">` +
`</t-text-unit>` +
`<t-text-unit id="t-text-unit-d00d.7dd5a437" class="mobileSurveyWaterDialog-t-text-unit-0-25"  :c-style="tTextUnitx0x25ComputedData.cStyle" :content="replaceCssVariables(filterData(state.baseInfo.speed, componentPropBindingMap?.['t-text-unit-d00d.7dd5a437']['content'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :unit="tTextUnitx0x25ComputedData.unit" :show-overflow-tooltip="tTextUnitx0x25ComputedData.showOverflowTooltip">` +
`</t-text-unit>` +
`<t-component id="t-component-10cc.9e9cad2fd" class="mobileSurveyWaterDialog-t-component-0-26"  :name="tComponentx0x26ComputedData.name" :loading="tComponentx0x26ComputedData.loading" :c-style="tComponentx0x26ComputedData.cStyle" :src="tComponentx0x26ComputedData.src" :component-name="tComponentx0x26ComputedData.componentName" :page-id="tComponentx0x26ComputedData.pageId" :page-code="tComponentx0x26ComputedData.pageCode">` +
`</t-component>` +
`</div>` +
'',
setup() {
...
// [
//   {
//     "src": "http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/assets/images/2025-12-24/8355dd23e8f047ec96a8c8344c9b98d1.jpg"
//   }
// ]
};

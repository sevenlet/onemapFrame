window.airOverviewPollutantCompareComponent = {
template: 
`<div id="t-l-c-airOverviewPollutantCompare" class="t-l-c-airOverviewPollutantCompare" >` +
`<t-list-card-rate v-if="state.listData.length !== 0" id="t-list-card-rate-3a36.8825c61b4" class="airOverviewPollutantCompare-t-list-card-rate-0-0"  :data="state.listData" :status-list="tListCardRatex0x0ComputedData.statusList" :data-alias="tListCardRatex0x0ComputedData.dataAlias" :data-raw="tListCardRatex0x0ComputedData.dataRaw" :c-style="tListCardRatex0x0ComputedData.cStyle">` +
`</t-list-card-rate>` +
`<t-text v-if="state.listData.length === 0" id="t-text-04dd.53282314b" class="airOverviewPollutantCompare-t-text-0-1"  :label="tTextx0x1ComputedData.label" :editable="tTextx0x1ComputedData.editable" :c-style="tTextx0x1ComputedData.cStyle">` +
`</t-text>` +
`</div>` +
'',
setup() {

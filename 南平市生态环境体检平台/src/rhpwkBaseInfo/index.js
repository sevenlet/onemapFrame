window.rhpwkBaseInfoComponent = {
template: 
`<div id="t-l-c-rhpwkBaseInfo" class="t-l-c-rhpwkBaseInfo" >` +
`<t-component id="t-component-c019.99b6d840a" class="rhpwkBaseInfo-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName" :page-id="tComponentx0x0ComputedData.pageId" :page-code="tComponentx0x0ComputedData.pageCode">` +
`</t-component>` +
`<t-list-card id="t-list-card-d9ab.2e21fb3b5" class="rhpwkBaseInfo-t-list-card-0-1"  :data="replaceCssVariables(filterData(state.baseInfoData, componentPropBindingMap?.['t-list-card-d9ab.2e21fb3b5']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :spacing-x="tListCardx0x1ComputedData.spacingX" :col="tListCardx0x1ComputedData.col" :direction="tListCardx0x1ComputedData.direction" :exchange-order="tListCardx0x1ComputedData.exchangeOrder" :unit-break="tListCardx0x1ComputedData.unitBreak" :key-field="tListCardx0x1ComputedData.keyField" :active-key-field="tListCardx0x1ComputedData.activeKeyField" :active="tListCardx0x1ComputedData.active" :c-style="tListCardx0x1ComputedData.cStyle">` +
`</t-list-card>` +
`<t-text id="t-text-62b3.48b14905c" class="rhpwkBaseInfo-t-text-0-2"  :label="tTextx0x2ComputedData.label" :editable="tTextx0x2ComputedData.editable" :c-style="tTextx0x2ComputedData.cStyle">` +
`</t-text>` +
`<t-row id="t-row-bed0.5ca83a488" class="rhpwkBaseInfo-t-row-0-3"  :c-style="tRowx0x3ComputedData.cStyle" :gutter="tRowx0x3ComputedData.gutter" :justify="tRowx0x3ComputedData.justify" :align="tRowx0x3ComputedData.align">` +
`<t-text id="t-text-b39c.b6c03321c" class="rhpwkBaseInfo-t-text-0-3-0"  :label="tTextx0x3x0ComputedData.label" :editable="tTextx0x3x0ComputedData.editable" :c-style="tTextx0x3x0ComputedData.cStyle">` +
`</t-text>` +
`</t-row>` +
`</div>` +
'',
setup() {
const componentPropBindingMap = {"body":{"attributeName":"tBodyx0x0"},"t-component-c019.99b6d840a":{"attributeName":"tComponentx0x0","name":{"filters":[]},"cStyle":{"filters":[]},"src":{"filters":[]},"componentName":{"filters":[]},"pageId":{"filters":[]},"pageCode":{"filters":[]}},"t-list-card-d9ab.2e21fb3b5":{"attributeName":"tListCardx0x1","data":{"filters":[]},"spacingX":{"filters":[]},"col":{"filters":[]},"direction":{"filters":[]},"exchangeOrder":{"filters":[]},"unitBreak":{"filters":[]},"keyField":{"filters":[]},"activeKeyField":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-text-62b3.48b14905c":{"attributeName":"tTextx0x2","label":{"filters":[]},"editable":{"filters":[]},"cStyle":{"filters":[]}},"t-row-bed0.5ca83a488":{"attributeName":"tRowx0x3","cStyle":{"filters":[]},"gutter":{"filters":[]},"justify":{"filters":[]},"align":{"filters":[]}},"t-text-b39c.b6c03321c":{"attributeName":"tTextx0x3x0","label":{"filters":[]},"editable":{"filters":[]},"cStyle":{"filters":[]}}};
// 页面内注入全局变量和事件
...
const state = Vue.reactive({
   ...
   dataSourcetype: "",
   variationTrendData: {"title":"近12个月水质变化趋势","activeTarget":"waterLevelChange","chartOptions":{"series":[]},"chartShow":true},
   ...
   baseInfoData: [{"title":"入河排污口名称","num":"-"},{"title":"入河排污口编码","num":"-"},{"title":"地市名称","num":"-"},{"title":"区县名称","num":"-"},{"title":"乡镇名称","num":"-"},{"title":"经度","num":"-"},{"title":"纬度","num":"-"},{"title":"排污口类型","num":"-"},{"title":"规模类型","num":"-"},{"title":"设置时间","num":"-"},{"title":"入河方式","num":"-"},{"title":"排放方式","num":"-"},{"title":"所在水体","num":"-"},{"title":"设备状态","num":"-"}],
   assessType: "",
   pointCode: "",
   monitorTime: "",
   timeRange: [],
...
tListCardx0x1: {
defaultStyle: {
            default: {"width":"100%","height":"254px","position":"unset","left":"1px","top":"42px","overflow":"visible","animationName":""},
            
            },
 default: { 
 
data:[{"title":"入河排污口名称","num":"-"},{"title":"入河排污口编码","num":"-"},{"title":"地市名称","num":"-"},{"title":"区县名称","num":"-"},{"title":"乡镇名称","num":"-"},{"title":"经度","num":"-"},{"title":"纬度","num":"-"},{"title":"排污口类型","num":"-"},{"title":"规模类型","num":"-"},{"title":"设置时间","num":"-"},{"title":"入河方式","num":"-"},{"title":"排放方式","num":"-"},{"title":"所在水体","num":"-"},{"title":"设备状态","num":"-"}],
spacingX:2,
col:2,
direction:"vertical",
exchangeOrder:false,
...
if(data.head.statusCode === '200' && data.data){
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-rhpwkBaseInfo', global.appScaleMode, 'normal');

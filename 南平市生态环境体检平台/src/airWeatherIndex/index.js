window.airWeatherIndexComponent = {
template: 
`<div id="t-l-c-airWeatherIndex" class="t-l-c-airWeatherIndex" >` +
`<t-checkbox id="t-checkbox-9e14.354734339" class="airWeatherIndex-t-checkbox-0-0"  :data="replaceCssVariables(filterData(state.weatherIndexList, componentPropBindingMap?.['t-checkbox-9e14.354734339']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="replaceCssVariables(filterData(state.weatherIndexSelectArr, componentPropBindingMap?.['t-checkbox-9e14.354734339']['active'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :data-alias="tCheckboxx0x0ComputedData.dataAlias" :border="tCheckboxx0x0ComputedData.border" :use-button="tCheckboxx0x0ComputedData.useButton" :c-style="tCheckboxx0x0ComputedData.cStyle" @change="onchange1735122132777">` +
`</t-checkbox>` +
`</div>` +
'',
setup() {

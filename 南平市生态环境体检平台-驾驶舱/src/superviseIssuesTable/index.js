window.superviseIssuesTableComponent = {
template: 
`<div id="t-l-c-superviseIssuesTable" class="t-l-c-superviseIssuesTable" >` +
`<t-rect id="t-rect-2e88.9a8a1ed2b" class="superviseIssuesTable-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle">` +
`</t-rect>` +
`<t-table id="t-table-9237.04d2d0d11" class="superviseIssuesTable-t-table-0-1"  :height="tTablex0x1ComputedData.height" :stripe="tTablex0x1ComputedData.stripe" :border="tTablex0x1ComputedData.border" :auto-scroll="tTablex0x1ComputedData.autoScroll" :speed="tTablex0x1ComputedData.speed" :columns="tTablex0x1ComputedData.columns" :data="replaceCssVariables(filterData(state.tableList, componentPropBindingMap?.['t-table-9237.04d2d0d11']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x1ComputedData.defaultSort" :c-style="tTablex0x1ComputedData.cStyle" :highlight-current-row="tTablex0x1ComputedData.highlightCurrentRow" @operation-click="onoperationClick1768887723296">` +
`</t-table>` +
`<t-rect id="t-rect-9ee1.ec8130f44" class="superviseIssuesTable-t-rect-0-2"  :tip="tRectx0x2ComputedData.tip" :label="tRectx0x2ComputedData.label" :active="tRectx0x2ComputedData.active" :c-style="tRectx0x2ComputedData.cStyle">` +
`</t-rect>` +
`<t-select id="t-select-b1e1.fd27a03b4" class="superviseIssuesTable-t-select-0-3"  :active-value="replaceCssVariables(filterData(state.selectProgress, componentPropBindingMap?.['t-select-b1e1.fd27a03b4']['activeValue'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :options="replaceCssVariables(filterData(state.selectDicts, componentPropBindingMap?.['t-select-b1e1.fd27a03b4']['options'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :alias="tSelectx0x3ComputedData.alias" :multiple="tSelectx0x3ComputedData.multiple" :placeholder="tSelectx0x3ComputedData.placeholder" :clearable="tSelectx0x3ComputedData.clearable" :disabled="tSelectx0x3ComputedData.disabled" :name="tSelectx0x3ComputedData.name" :autocomplete="tSelectx0x3ComputedData.autocomplete" :filterable="tSelectx0x3ComputedData.filterable" :no-match-text="tSelectx0x3ComputedData.no-match-text" :no-data-text="tSelectx0x3ComputedData.no-data-text" :c-style="tSelectx0x3ComputedData.cStyle" @change="onchange1763689398877_0_0">` +
`</t-select>` +
`<t-text id="t-text-03db.65ad46ad" class="superviseIssuesTable-t-text-0-4"  :label="replaceCssVariables(filterData(state.dialogTitle, componentPropBindingMap?.['t-text-03db.65ad46ad']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x4ComputedData.editable" :c-style="tTextx0x4ComputedData.cStyle">` +
`</t-text>` +
`<t-component id="t-component-a5a9.5d2a80317" class="superviseIssuesTable-t-component-0-5"  :name="tComponentx0x5ComputedData.name" :loading="tComponentx0x5ComputedData.loading" :c-style="tComponentx0x5ComputedData.cStyle" :src="tComponentx0x5ComputedData.src" :component-name="tComponentx0x5ComputedData.componentName" :page-id="tComponentx0x5ComputedData.pageId" :page-code="tComponentx0x5ComputedData.pageCode">` +
`</t-component>` +
`<t-text-common id="t-text-common-c20c.e8465135c" class="superviseIssuesTable-t-text-common-0-6"  :label="replaceCssVariables(filterData(state.tableTitle, componentPropBindingMap?.['t-text-common-c20c.e8465135c']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextCommonx0x6ComputedData.editable" :c-style="tTextCommonx0x6ComputedData.cStyle">` +
`</t-text-common>` +
`<t-rect id="t-rect-b589.5c4b4c5e4" class="superviseIssuesTable-t-rect-0-7"  :tip="tRectx0x7ComputedData.tip" :label="tRectx0x7ComputedData.label" :active="tRectx0x7ComputedData.active" :c-style="tRectx0x7ComputedData.cStyle" @click="onclick1768962340343">` +
`</t-rect>` +
`</div>` +
'',
setup() {
const componentPropBindingMap = {"body":{"attributeName":"tBodyx0x0"},"t-rect-2e88.9a8a1ed2b":{"attributeName":"tRectx0x0","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-table-9237.04d2d0d11":{"attributeName":"tTablex0x1","height":{"filters":[]},"stripe":{"filters":[]},"border":{"filters":[]},"autoScroll":{"filters":[]},"speed":{"filters":[]},"columns":{"filters":[]},"data":{"filters":[]},"defaultSort":{"filters":[]},"cStyle":{"filters":[]},"highlightCurrentRow":{"filters":[]}},"t-rect-9ee1.ec8130f44":{"attributeName":"tRectx0x2","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-select-b1e1.fd27a03b4":{"attributeName":"tSelectx0x3","activeValue":{"filters":[]},"options":{"filters":[]},"alias":{"filters":[]},"multiple":{"filters":[]},"placeholder":{"filters":[]},"clearable":{"filters":[]},"disabled":{"filters":[]},"name":{"filters":[]},"autocomplete":{"filters":[]},"filterable":{"filters":[]},"no-match-text":{"filters":[]},"no-data-text":{"filters":[]},"cStyle":{"filters":[]}},"t-text-03db.65ad46ad":{"attributeName":"tTextx0x4","label":{"filters":[]},"editable":{"filters":[]},"cStyle":{"filters":[]}},"t-component-a5a9.5d2a80317":{"attributeName":"tComponentx0x5","name":{"filters":[]},"loading":{"filters":[]},"cStyle":{"filters":[]},"src":{"filters":[]},"componentName":{"filters":[]},"pageId":{"filters":[]},"pageCode":{"filters":[]}},"t-text-common-c20c.e8465135c":{"attributeName":"tTextCommonx0x6","label":{"filters":[]},"editable":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-b589.5c4b4c5e4":{"attributeName":"tRectx0x7","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}}};
// 页面内注入全局变量和事件
...
tTablex0x1: {
defaultStyle: {
            default: {"width":"961px","height":"585px","backgroundColor":"","position":"unset","left":"20px","top":"158px","animationName":""},
...
autoScroll:false,
speed:6,
columns:[{"label":"序号","key":"sort_num","align":"center","operationList":[],"stateList":[],"style":{"fontStyle":{"color":"rgba(255, 255, 255, 1)"},"imageStyle":{"backgroundImage":""}},"width":"50px","minWidth":"50PX","showOverflowTooltip":true},{"label":"整改实施主体","key":"zg_sszt","align":"left","operationList":[],"stateList":[],"style":{"fontStyle":{"display":"block","color":"rgba(255, 255, 255, 1)","fontSize":"14PX","padding":"0 0 0 16px","paddingLeft":"0px","paddingTop":"","paddingRight":"","paddingBottom":""}},"width":"120px","minWidth":"100PX","headerAlign":"center","showOverflowTooltip":true},{"label":"整改任务","key":"problem_content","align":"left","operationList":[],"stateList":[],"style":{"fontStyle":{"display":"block","color":"rgba(255, 255, 255, 1)","fontSize":"14PX","padding":"0 0 0 16px","paddingLeft":"0px","paddingTop":"","paddingRight":"","paddingBottom":""}},"width":"auto","minWidth":"100PX","headerAlign":"left","showOverflowTooltip":true},{"label":"进度评价","key":"finish_status_name","type":"default","stateKey":"reductionRateState","align":"center","operationList":[],"stateList":[{"name":"负值","fontStyle":{"color":"rgba(0, 255, 34, 1)"}},{"name":"正值","fontStyle":{"color":"rgba(255, 132, 0, 1)"}}],"style":{"fontStyle":{"display":"block","fontSize":"16PX","fontWeight":"400","color":"rgba(255, 255, 255, 1)"}},"width":"180px","minWidth":"70PX","showOverflowTooltip":true},{"label":"操作","key":"operation","type":"operation","stateKey":"reductionRateState","align":"center","operationList":[{"name":"详情","id":"detail","fontStyle":{"color":"#009dff","cursor":"pointer"}}],"stateList":[{"name":"负值","fontStyle":{"color":"rgba(0, 255, 34, 1)"}},{"name":"正值","fontStyle":{"color":"rgba(255, 132, 0, 1)"}}],"style":{"fontStyle":{"fontSize":"16PX","fontWeight":"400","color":"rgba(255, 255, 255, 1)"}},"width":"120px","minWidth":"70PX","showOverflowTooltip":true}],
data:[],
defaultSort:{"prop":"number","order":"ascending"},
cStyle:{"wrapper":{"default":{"width":"961px","height":"585px","backgroundColor":"","position":"unset","left":"20px","top":"158px","animationName":""}},"headerCell":{"default":{"borderBottom":"0px none rgba(20,112,204,0.3)","borderLeft":"0px none rgba(20,112,204,0.3)","borderRight":"0px none rgba(20,112,204,0.3)","borderTop":"0px none rgba(20,112,204,0.3)","color":"var(--business-theme-light)","backgroundColor":"rgba(20, 112, 204, 0.3)","fontSize":"14px","lineHeight":"38px","height":"38px","marginTop":"0px","paddingBottom":"0px","paddingTop":"0px","marginBottom":"0px","paddingLeft":"0px"}},"bodyCell":{"default":{"backgroundColor":"rgba(20, 112, 204, 0.1)","borderBottom":"0px none rgba(24,37,64,1)","borderLeft":"0px none rgba(24,37,64,1)","borderRight":"0px none rgba(24,37,64,1)","borderTop":"0px none rgba(24,37,64,1)","color":"rgba(255, 255, 255, 1)","height":"40px","paddingBottom":"20px","paddingTop":"5px","lineHeight":"40px","fontSize":"14px","fontFamily":"微软雅黑","paddingLeft":"10px","paddingRight":"10px"},"hover":{"backgroundColor":"rgba(20, 112, 204, 0.15)"}},"stripeBodyCell":{"default":{"backgroundColor":"rgba(0, 59, 132, 0.3)"}},"headerRowWrapper":{"default":{"backgroundColor":"var(--business-show-bg30)"}},"rowWrapper":{"default":{"backgroundColor":"rgba(20, 112, 204, 0.15)"}}},
...
tComponentx0x5: {
defaultStyle: {
            default: {"width":"997px","height":"33px","margin":"0 auto","position":"unset","left":"2px","top":"60px","animationName":""},
...
loading:false,
cStyle:{"wrapper":{"default":{"width":"997px","height":"33px","margin":"0 auto","position":"unset","left":"2px","top":"60px","animationName":""}}},
...
tTextCommonx0x6: {
defaultStyle: {
            default: {"width":"546px","height":"20px","color":"var(--business-white)","fontFamily":"方正综艺","fontWeight":"400","fontSize":"20px","lineHeight":"20px","letterSpacing":"0px","textAlign":"left","whiteSpace":"wrap","textOverflow":"unset","overflow":"unset","display":"inline-block","filter":"unset","border":"unset","position":"unset","left":"57px","top":"67px","background":"unset","backgroundClip":"unset","animationName":""},
...
label:"",
editable:false,
cStyle:{"wrapper":{"default":{"width":"546px","height":"20px","color":"var(--business-white)","fontFamily":"方正综艺","fontWeight":"400","fontSize":"20px","lineHeight":"20px","letterSpacing":"0px","textAlign":"left","whiteSpace":"wrap","textOverflow":"unset","overflow":"unset","display":"inline-block","filter":"unset","border":"unset","position":"unset","left":"57px","top":"67px","background":"unset","backgroundClip":"unset","animationName":""}}}, 
 },
},
tRectx0x7: {
defaultStyle: {
...
const initData = () => {
const { type, COMPANY, selectProgress } = global.supervisorPopParams;
...
switch (type) {
  ...
  case "centerThird":
    ...
    state.SOURCE = "1";
    state.ROUND = "3";
    state.selectProgress = selectProgress || ''
...
const handleTableClick = (row,operationId) => {
switch(operationId){
  case 'detail':
    ...
    global.supervisorPopName = 'rectificationTaskDetailComponent'
    break;
  default:
    break;
}
...
const getData = () => {
(async () => {
  await apiRegistry.getTableList.request();
})();
};
const onoperationClick1768887723296 = (row,operationId) => {
// 执行自定义方法
handleTableClick(row,operationId);
};
...
// 接口函数
 getTableList: {
              ...
              config: {"url":"global.serviceBasePath","method":"get","baseURL":"global.npServiceBaseUrl","params":{"COMPANY":"state.COMPANY","PROBLEM_TYPE":"","PKID":"","ZGSSZT":"","END_TIME_LIMIT":"","START_TIME_LIMIT":"","END_TIME_ALTER":"","START_TIME_ALTER":"","FINISH_STATUS":"state.selectProgress","REGION_PATH":"","PARENT_REGION_CODE":"","REGION_CODE":"","ROUND":"state.ROUND","SOURCE":"state.SOURCE","TYPE":"0","interfaceId":"fbb8261794dfaea02ff6c119ea5f1b9a"}},
              request: function ( componentId) {
return new Promise((resolve, reject) => {
  
                http({"url":global.serviceBasePath,"method":"get","baseURL":global.npServiceBaseUrl,"params":{"COMPANY":state.COMPANY,"PROBLEM_TYPE":"","PKID":"","ZGSSZT":"","END_TIME_LIMIT":"","START_TIME_LIMIT":"","END_TIME_ALTER":"","START_TIME_ALTER":"","FINISH_STATUS":state.selectProgress,"REGION_PATH":"","PARENT_REGION_CODE":"","REGION_CODE":"","ROUND":state.ROUND,"SOURCE":state.SOURCE,"TYPE":"0","interfaceId":"fbb8261794dfaea02ff6c119ea5f1b9a"},}).then((res) => {
 
                   // 成功的操作
                   const cacheKey = generateCacheKey('global.npServiceBaseUrl-global.serviceBasePath',  {"COMPANY":state.COMPANY,"PROBLEM_TYPE":"","PKID":"","ZGSSZT":"","END_TIME_LIMIT":"","START_TIME_LIMIT":"","END_TIME_ALTER":"","START_TIME_ALTER":"","FINISH_STATUS":state.selectProgress,"REGION_PATH":"","PARENT_REGION_CODE":"","REGION_CODE":"","ROUND":state.ROUND,"SOURCE":state.SOURCE,"TYPE":"0","interfaceId":"fbb8261794dfaea02ff6c119ea5f1b9a"});
...
if (res.data.head.statusCode === '200' && res.data?.data?.length) {
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-superviseIssuesTable', global.appScaleMode, 'normal');
...
onoperationClick1768887723296,
onchange1763689398877_0_0,
onclick1768962340343,
};
},
};
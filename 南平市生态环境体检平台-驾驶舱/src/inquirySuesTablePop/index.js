window.inquirySuesTablePopComponent = {
template: 
`<div id="t-l-c-inquirySuesTablePop" class="t-l-c-inquirySuesTablePop" >` +
`<t-row id="t-row-d0d8.f6972f11a" class="inquirySuesTablePop-t-row-0-5"  :c-style="tRowx0x5ComputedData.cStyle" :gutter="tRowx0x5ComputedData.gutter" :justify="tRowx0x5ComputedData.justify" :align="tRowx0x5ComputedData.align">` +
`<t-col id="t-col-b805.808b80595" class="inquirySuesTablePop-t-col-0-5-0"  :span="tColx0x5x0ComputedData.span" :offset="tColx0x5x0ComputedData.offset" :push="tColx0x5x0ComputedData.push" :pull="tColx0x5x0ComputedData.pull" :c-style="tColx0x5x0ComputedData.cStyle">` +
`<t-component id="t-component-1359.2630a17e4" class="inquirySuesTablePop-t-component-0-5-0-0"  :name="tComponentx0x5x0x0ComputedData.name" :loading="tComponentx0x5x0x0ComputedData.loading" :c-style="tComponentx0x5x0x0ComputedData.cStyle" :src="tComponentx0x5x0x0ComputedData.src" :component-name="tComponentx0x5x0x0ComputedData.componentName" :page-id="tComponentx0x5x0x0ComputedData.pageId" :page-code="tComponentx0x5x0x0ComputedData.pageCode">` +
`</t-component>` +
`</t-col>` +
`<t-col id="t-col-7343.1a34a08e8" class="inquirySuesTablePop-t-col-0-5-1"  :span="tColx0x5x1ComputedData.span" :offset="tColx0x5x1ComputedData.offset" :push="tColx0x5x1ComputedData.push" :pull="tColx0x5x1ComputedData.pull" :c-style="tColx0x5x1ComputedData.cStyle">` +
`<t-text id="t-text-9a81.23a54a8b1" class="inquirySuesTablePop-t-text-0-5-1-0"  :label="tTextx0x5x1x0ComputedData.label" :editable="tTextx0x5x1x0ComputedData.editable" :c-style="tTextx0x5x1x0ComputedData.cStyle">` +
`</t-text>` +
`<t-date-picker id="t-date-picker-5460.5b225617c" class="inquirySuesTablePop-t-date-picker-0-5-1-1"  :placeholder="tDatePickerx0x5x1x1ComputedData.placeholder" :start-placeholder="tDatePickerx0x5x1x1ComputedData.startPlaceholder" :end-placeholder="tDatePickerx0x5x1x1ComputedData.endPlaceholder" :type="tDatePickerx0x5x1x1ComputedData.type" :clearable="tDatePickerx0x5x1x1ComputedData.clearable" :range-separator="tDatePickerx0x5x1x1ComputedData.rangeSeparator" :default-date="replaceCssVariables(filterData(state.timeData, componentPropBindingMap?.['t-date-picker-5460.5b225617c']['default-date'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :separator="tDatePickerx0x5x1x1ComputedData.separator" :c-style="tDatePickerx0x5x1x1ComputedData.cStyle" :is-disabled-front="tDatePickerx0x5x1x1ComputedData.isDisabledFront" :disabled-date="tDatePickerx0x5x1x1ComputedData.disabledDate" @date-change="ondateChange1769490946317">` +
`</t-date-picker>` +
`</t-col>` +
`<t-col id="t-col-af54.bd8d45468" class="inquirySuesTablePop-t-col-0-5-2"  :span="tColx0x5x2ComputedData.span" :offset="tColx0x5x2ComputedData.offset" :push="tColx0x5x2ComputedData.push" :pull="tColx0x5x2ComputedData.pull" :c-style="tColx0x5x2ComputedData.cStyle">` +
`<t-table id="t-table-f9ef.a000e4d0c" class="inquirySuesTablePop-t-table-0-5-2-0"  :height="tTablex0x5x2x0ComputedData.height" :stripe="tTablex0x5x2x0ComputedData.stripe" :border="tTablex0x5x2x0ComputedData.border" :auto-scroll="tTablex0x5x2x0ComputedData.autoScroll" :speed="tTablex0x5x2x0ComputedData.speed" :columns="tTablex0x5x2x0ComputedData.columns" :data="replaceCssVariables(filterData(state.tableList, componentPropBindingMap?.['t-table-f9ef.a000e4d0c']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x5x2x0ComputedData.defaultSort" :c-style="tTablex0x5x2x0ComputedData.cStyle" @cell-click="oncellClick1769492950978">` +
`</t-table>` +
`</t-col>` +
`<t-col id="t-col-4dae.caed6377a" class="inquirySuesTablePop-t-col-0-5-3"  :span="tColx0x5x3ComputedData.span" :offset="tColx0x5x3ComputedData.offset" :push="tColx0x5x3ComputedData.push" :pull="tColx0x5x3ComputedData.pull" :c-style="tColx0x5x3ComputedData.cStyle">` +
`<t-pagination-base id="t-pagination-base-f9c5.90320f5dc" class="inquirySuesTablePop-t-pagination-base-0-5-3-0"  :total="replaceCssVariables(filterData(state.pageInfo.total, componentPropBindingMap?.['t-pagination-base-f9c5.90320f5dc']['total'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :small="tPaginationBasex0x5x3x0ComputedData.small" :page-size="replaceCssVariables(filterData(state.pageInfo.pageSize, componentPropBindingMap?.['t-pagination-base-f9c5.90320f5dc']['pageSize'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :pager-count="tPaginationBasex0x5x3x0ComputedData.pagerCount" :current-page="replaceCssVariables(filterData(state.pageInfo.pageNum, componentPropBindingMap?.['t-pagination-base-f9c5.90320f5dc']['currentPage'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :layout="tPaginationBasex0x5x3x0ComputedData.layout" :page-sizes="tPaginationBasex0x5x3x0ComputedData.pageSizes" :disabled="tPaginationBasex0x5x3x0ComputedData.disabled" :c-style="tPaginationBasex0x5x3x0ComputedData.cStyle" @current-change="oncurrentChange1769500266919">` +
`</t-pagination-base>` +
`</t-col>` +
`</t-row>` +
`<t-text-common id="t-text-common-c20c.e8465135c" class="inquirySuesTablePop-t-text-common-0-6"  :label="replaceCssVariables(filterData(state.tableTitle, componentPropBindingMap?.['t-text-common-c20c.e8465135c']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextCommonx0x6ComputedData.editable" :c-style="tTextCommonx0x6ComputedData.cStyle">` +
`</t-text-common>` +
`</div>` +
'',
setup() {
...
deep: true, // 深度监听
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-inquirySuesTablePop', global.appScaleMode, 'normal');

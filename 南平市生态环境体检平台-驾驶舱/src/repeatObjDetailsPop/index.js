window.repeatObjDetailsPopComponent = {
template: 
`<div id="t-l-c-repeatObjDetailsPop" class="t-l-c-repeatObjDetailsPop" >` +
`<t-row id="t-row-d0d8.f6972f11a" class="repeatObjDetailsPop-t-row-0-5"  :c-style="tRowx0x5ComputedData.cStyle" :gutter="tRowx0x5ComputedData.gutter" :justify="tRowx0x5ComputedData.justify" :align="tRowx0x5ComputedData.align">` +
`<t-col id="t-col-b805.808b80595" class="repeatObjDetailsPop-t-col-0-5-0"  :span="tColx0x5x0ComputedData.span" :offset="tColx0x5x0ComputedData.offset" :push="tColx0x5x0ComputedData.push" :pull="tColx0x5x0ComputedData.pull" :c-style="tColx0x5x0ComputedData.cStyle">` +
`<t-component id="t-component-1359.2630a17e4" class="repeatObjDetailsPop-t-component-0-5-0-0"  :name="tComponentx0x5x0x0ComputedData.name" :loading="tComponentx0x5x0x0ComputedData.loading" :c-style="tComponentx0x5x0x0ComputedData.cStyle" :src="tComponentx0x5x0x0ComputedData.src" :component-name="tComponentx0x5x0x0ComputedData.componentName" :page-id="tComponentx0x5x0x0ComputedData.pageId" :page-code="tComponentx0x5x0x0ComputedData.pageCode">` +
`</t-component>` +
`</t-col>` +
`<t-col id="t-col-7343.1a34a08e8" class="repeatObjDetailsPop-t-col-0-5-1"  :span="tColx0x5x1ComputedData.span" :offset="tColx0x5x1ComputedData.offset" :push="tColx0x5x1ComputedData.push" :pull="tColx0x5x1ComputedData.pull" :c-style="tColx0x5x1ComputedData.cStyle">` +
`<t-text id="t-text-9a81.23a54a8b1" class="repeatObjDetailsPop-t-text-0-5-1-0"  :label="tTextx0x5x1x0ComputedData.label" :editable="tTextx0x5x1x0ComputedData.editable" :c-style="tTextx0x5x1x0ComputedData.cStyle">` +
`</t-text>` +
`<t-date-picker id="t-date-picker-5460.5b225617c" class="repeatObjDetailsPop-t-date-picker-0-5-1-1"  :placeholder="tDatePickerx0x5x1x1ComputedData.placeholder" :start-placeholder="tDatePickerx0x5x1x1ComputedData.startPlaceholder" :end-placeholder="tDatePickerx0x5x1x1ComputedData.endPlaceholder" :type="tDatePickerx0x5x1x1ComputedData.type" :clearable="tDatePickerx0x5x1x1ComputedData.clearable" :range-separator="tDatePickerx0x5x1x1ComputedData.rangeSeparator" :default-date="replaceCssVariables(filterData(state.timeData, componentPropBindingMap?.['t-date-picker-5460.5b225617c']['default-date'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :separator="tDatePickerx0x5x1x1ComputedData.separator" :c-style="tDatePickerx0x5x1x1ComputedData.cStyle" :is-disabled-front="tDatePickerx0x5x1x1ComputedData.isDisabledFront" :disabled-date="tDatePickerx0x5x1x1ComputedData.disabledDate" @date-change="ondateChange1769490946317">` +
`</t-date-picker>` +
`</t-col>` +
`<t-col id="t-col-af54.bd8d45468" class="repeatObjDetailsPop-t-col-0-5-2"  :span="tColx0x5x2ComputedData.span" :offset="tColx0x5x2ComputedData.offset" :push="tColx0x5x2ComputedData.push" :pull="tColx0x5x2ComputedData.pull" :c-style="tColx0x5x2ComputedData.cStyle">` +
`<t-table id="t-table-f9ef.a000e4d0c" class="repeatObjDetailsPop-t-table-0-5-2-0"  :height="tTablex0x5x2x0ComputedData.height" :stripe="tTablex0x5x2x0ComputedData.stripe" :border="tTablex0x5x2x0ComputedData.border" :auto-scroll="tTablex0x5x2x0ComputedData.autoScroll" :speed="tTablex0x5x2x0ComputedData.speed" :columns="tTablex0x5x2x0ComputedData.columns" :data="replaceCssVariables(filterData(state.tableList, componentPropBindingMap?.['t-table-f9ef.a000e4d0c']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x5x2x0ComputedData.defaultSort" :c-style="tTablex0x5x2x0ComputedData.cStyle" @cell-click="oncellClick1769493016236">` +
`</t-table>` +
`</t-col>` +
`<t-col id="t-col-4dae.caed6377a" class="repeatObjDetailsPop-t-col-0-5-3"  :span="tColx0x5x3ComputedData.span" :offset="tColx0x5x3ComputedData.offset" :push="tColx0x5x3ComputedData.push" :pull="tColx0x5x3ComputedData.pull" :c-style="tColx0x5x3ComputedData.cStyle">` +
`<t-pagination-base id="t-pagination-base-bf40.77ebfceaa" class="repeatObjDetailsPop-t-pagination-base-0-5-3-0"  :total="replaceCssVariables(filterData(state.pageInfo.total, componentPropBindingMap?.['t-pagination-base-bf40.77ebfceaa']['total'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :small="tPaginationBasex0x5x3x0ComputedData.small" :page-size="replaceCssVariables(filterData(state.pageInfo.pageSize, componentPropBindingMap?.['t-pagination-base-bf40.77ebfceaa']['pageSize'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :pager-count="tPaginationBasex0x5x3x0ComputedData.pagerCount" :current-page="replaceCssVariables(filterData(state.pageInfo.pageNum, componentPropBindingMap?.['t-pagination-base-bf40.77ebfceaa']['currentPage'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :layout="tPaginationBasex0x5x3x0ComputedData.layout" :page-sizes="tPaginationBasex0x5x3x0ComputedData.pageSizes" :disabled="tPaginationBasex0x5x3x0ComputedData.disabled" :c-style="tPaginationBasex0x5x3x0ComputedData.cStyle" @current-change="oncurrentChange1769498088091">` +
`</t-pagination-base>` +
`</t-col>` +
`</t-row>` +
`<t-text-common id="t-text-common-c20c.e8465135c" class="repeatObjDetailsPop-t-text-common-0-6"  :label="replaceCssVariables(filterData(state.tableTitle, componentPropBindingMap?.['t-text-common-c20c.e8465135c']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextCommonx0x6ComputedData.editable" :c-style="tTextCommonx0x6ComputedData.cStyle">` +
`</t-text-common>` +
`</div>` +
'',
setup() {
const componentPropBindingMap = {"body":{"attributeName":"tBodyx0x0"},"t-rect-2e88.9a8a1ed2b":{"attributeName":"tRectx0x0"},"t-rect-9ee1.ec8130f44":{"attributeName":"tRectx0x1"},"t-select-b1e1.fd27a03b4":{"attributeName":"tSelectx0x2"},"t-text-03db.65ad46ad":{"attributeName":"tTextx0x3"},"t-rect-22b3.c624df95a":{"attributeName":"tRectx0x4"},"t-row-d0d8.f6972f11a":{"attributeName":"tRowx0x5","cStyle":{"filters":[]},"gutter":{"filters":[]},"justify":{"filters":[]},"align":{"filters":[]}},"t-col-b805.808b80595":{"attributeName":"tColx0x5x0","span":{"filters":[]},"offset":{"filters":[]},"push":{"filters":[]},"pull":{"filters":[]},"cStyle":{"filters":[]}},"t-component-1359.2630a17e4":{"attributeName":"tComponentx0x5x0x0","name":{"filters":[]},"loading":{"filters":[]},"cStyle":{"filters":[]},"src":{"filters":[]},"componentName":{"filters":[]},"pageId":{"filters":[]},"pageCode":{"filters":[]}},"t-col-7343.1a34a08e8":{"attributeName":"tColx0x5x1","span":{"filters":[]},"offset":{"filters":[]},"push":{"filters":[]},"pull":{"filters":[]},"cStyle":{"filters":[]}},"t-text-9a81.23a54a8b1":{"attributeName":"tTextx0x5x1x0","label":{"filters":[]},"editable":{"filters":[]},"cStyle":{"filters":[]}},"t-date-picker-5460.5b225617c":{"attributeName":"tDatePickerx0x5x1x1","placeholder":{"filters":[]},"startPlaceholder":{"filters":[]},"endPlaceholder":{"filters":[]},"type":{"filters":[]},"clearable":{"filters":[]},"rangeSeparator":{"filters":[]},"default-date":{"filters":[]},"separator":{"filters":[]},"cStyle":{"filters":[]},"isDisabledFront":{"filters":[]},"disabledDate":{"filters":[]}},"t-input-c319.e7cfd9ab":{"attributeName":"tInputx0x5x1x2"},"t-button-ef96.016de2144":{"attributeName":"tButtonx0x5x1x3"},"t-col-af54.bd8d45468":{"attributeName":"tColx0x5x2","span":{"filters":[]},"offset":{"filters":[]},"push":{"filters":[]},"pull":{"filters":[]},"cStyle":{"filters":[]}},"t-table-f9ef.a000e4d0c":{"attributeName":"tTablex0x5x2x0","height":{"filters":[]},"stripe":{"filters":[]},"border":{"filters":[]},"autoScroll":{"filters":[]},"speed":{"filters":[]},"columns":{"filters":[]},"data":{"filters":[{"name":"filterTableList"}]},"defaultSort":{"filters":[]},"cStyle":{"filters":[]}},"t-col-4dae.caed6377a":{"attributeName":"tColx0x5x3","span":{"filters":[]},"offset":{"filters":[]},"push":{"filters":[]},"pull":{"filters":[]},"cStyle":{"filters":[]}},"t-pagination-base-bf40.77ebfceaa":{"attributeName":"tPaginationBasex0x5x3x0","total":{"filters":[]},"small":{"filters":[]},"pageSize":{"filters":[]},"pagerCount":{"filters":[]},"currentPage":{"filters":[]},"layout":{"filters":[]},"pageSizes":{"filters":[]},"disabled":{"filters":[]},"cStyle":{"filters":[]}},"t-text-common-c20c.e8465135c":{"attributeName":"tTextCommonx0x6","label":{"filters":[]},"editable":{"filters":[]},"cStyle":{"filters":[]}}};
// 页面内注入全局变量和事件
...
const state = Vue.reactive({
   ...
   timeData: [],
   ENTER_NAME_LIKE: "",
   pageInfo: {"pageSize":14,"pageNum":1,"total":0},
   ENTER_NAME: "",
   END_TIME: "",
   START_TIME: "",
   tableTitle: "重复投诉对象详情",
   dialogTitle: "重复投诉对象详情",
   tableList: [],
});
// 选中的图表主题
...
defaultStyle: {
            default: {"width":"auto","height":"38px","position":"unset","left":"35px","top":"631px","justifyContent":"center","alignItems":"center","flexDirection":"row","display":"flex","marginRight":"20px","paddingRight":"0px"},
...
state.timeData = [global.dashboardGlobalVariables.dailyComplaint.startTime, global.dashboardGlobalVariables.dailyComplaint.endTime];
...
const oncellClick1769493016236 = (row,column,cell,event) => {
// 执行自定义方法
...
// 接口函数
 getData: {
              ...
              config: {"url":"global.serviceBasePath","method":"get","baseURL":"global.npServiceBaseUrl","params":{"pageNum":"state.pageInfo.pageNum","pageSize":"state.pageInfo.pageSize","ENTER_NAME_LIKE":"state.ENTER_NAME_LIKE","ENTER_NAME":"state.ENTER_NAME","END_TIME":"state.END_TIME","START_TIME":"state.START_TIME","REGION_PATH":"global.REGION_CODE","interfaceId":"a5fc4ee46eaa5c8c393c7b13caa4d705"}},
              request: function ( componentId) {
return new Promise((resolve, reject) => {
  
                http({"url":global.serviceBasePath,"method":"get","baseURL":global.npServiceBaseUrl,"params":{"pageNum":state.pageInfo.pageNum,"pageSize":state.pageInfo.pageSize,"ENTER_NAME_LIKE":state.ENTER_NAME_LIKE,"ENTER_NAME":state.ENTER_NAME,"END_TIME":state.END_TIME,"START_TIME":state.START_TIME,"REGION_PATH":global.REGION_CODE,"interfaceId":"a5fc4ee46eaa5c8c393c7b13caa4d705"},}).then((res) => {
 
                   // 成功的操作
                   const cacheKey = generateCacheKey('global.npServiceBaseUrl-global.serviceBasePath',  {"pageNum":state.pageInfo.pageNum,"pageSize":state.pageInfo.pageSize,"ENTER_NAME_LIKE":state.ENTER_NAME_LIKE,"ENTER_NAME":state.ENTER_NAME,"END_TIME":state.END_TIME,"START_TIME":state.START_TIME,"REGION_PATH":global.REGION_CODE,"interfaceId":"a5fc4ee46eaa5c8c393c7b13caa4d705"});
...
deep: true, // 深度监听
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-repeatObjDetailsPop', global.appScaleMode, 'normal');
...
ondateChange1769490946317,
oncellClick1769493016236,
oncurrentChange1769498088091,
};
},
};
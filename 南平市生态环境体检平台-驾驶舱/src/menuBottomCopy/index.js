window.menuBottomCopyComponent = {
template: 
`<div id="t-l-c-menuBottomCopy" class="t-l-c-menuBottomCopy" >` +
`<t-rect id="t-rect-9d12.1d1d2a0b2" class="menuBottomCopy-t-rect-0-1"  :tip="tRectx0x1ComputedData.tip" :label="tRectx0x1ComputedData.label" :active="tRectx0x1ComputedData.active" :c-style="tRectx0x1ComputedData.cStyle">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data16.isActive === true" id="t-rect-fcbc.fad9b8a94" class="menuBottomCopy-t-rect-0-2"  :tip="tRectx0x2ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data16.text, componentPropBindingMap?.['t-rect-fcbc.fad9b8a94']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x2ComputedData.active" :c-style="tRectx0x2ComputedData.cStyle" @click="onclick1739435785640_0_0" @mouseleave="onmouseleave1739502971459" @mouseenter="onmouseenter1739502989445">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data16.isActive === false" id="t-rect-b9c2.e76da9784" class="menuBottomCopy-t-rect-0-3"  :tip="tRectx0x3ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data16.text, componentPropBindingMap?.['t-rect-b9c2.e76da9784']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x3ComputedData.active" :c-style="tRectx0x3ComputedData.cStyle" @click="onclick1739435785639_0_0" @mouseleave="onmouseleave1739502975813" @mouseenter="onmouseenter1739502985700">` +
`</t-rect>` +
`<t-rect v-if="state.showSwitch === true" id="t-rect-69b5.e4d88f9cb" class="menuBottomCopy-t-rect-0-4"  :tip="tRectx0x4ComputedData.tip" :label="tRectx0x4ComputedData.label" :active="tRectx0x4ComputedData.active" :c-style="tRectx0x4ComputedData.cStyle" @click="onclick1760336196871">` +
`</t-rect>` +
`<t-rect v-if="state.showSwitch === true" id="t-rect-e302.319581643" class="menuBottomCopy-t-rect-0-5"  :tip="tRectx0x5ComputedData.tip" :label="tRectx0x5ComputedData.label" :active="tRectx0x5ComputedData.active" :c-style="tRectx0x5ComputedData.cStyle" @click="onclick1760336213838">` +
`</t-rect>` +
`<t-tabs v-if="state.menuList.data15.dropdownState === true" id="t-tabs-0f17.024920fce" class="menuBottomCopy-t-tabs-0-6"  :data="replaceCssVariables(filterData(state.menuList.data15.subMenu, componentPropBindingMap?.['t-tabs-0f17.024920fce']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active-tab="tTabsx0x6ComputedData.activeTab" :tab-position-extend="tTabsx0x6ComputedData.tabPositionExtend" :stretch="tTabsx0x6ComputedData.stretch" :c-style="tTabsx0x6ComputedData.cStyle" @mouseleave="onmouseleave1739498505373_0_0" @mouseenter="onmouseenter1739498505373_0_1" @tab-click="ontabClick1760325725646">` +
`</t-tabs>` +
`<t-tabs v-if="state.menuList.data13.dropdownState === true" id="t-tabs-0eb4.3649ed107" class="menuBottomCopy-t-tabs-0-7"  :data="replaceCssVariables(filterData(state.menuList.data13.subMenu, componentPropBindingMap?.['t-tabs-0eb4.3649ed107']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active-tab="tTabsx0x7ComputedData.activeTab" :tab-position-extend="tTabsx0x7ComputedData.tabPositionExtend" :stretch="tTabsx0x7ComputedData.stretch" :c-style="tTabsx0x7ComputedData.cStyle" @mouseleave="onmouseleave1739500054322_0_0" @mouseenter="onmouseenter1739500054322_0_1" @tab-click="ontabClick1760325800877">` +
`</t-tabs>` +
`<t-tabs v-if="state.menuList.data9.dropdownState === true" id="t-tabs-9efa.0de85629d" class="menuBottomCopy-t-tabs-0-8"  :data="replaceCssVariables(filterData(state.menuList.data9.subMenu, componentPropBindingMap?.['t-tabs-9efa.0de85629d']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active-tab="tTabsx0x8ComputedData.activeTab" :tab-position-extend="tTabsx0x8ComputedData.tabPositionExtend" :stretch="tTabsx0x8ComputedData.stretch" :c-style="tTabsx0x8ComputedData.cStyle" @mouseleave="onmouseleave1739500420268_0_0" @mouseenter="onmouseenter1739500420268_0_1" @tab-click="ontabClick1760325657369">` +
`</t-tabs>` +
`<t-tabs v-if="state.menuList.data7.dropdownState === true" id="t-tabs-76d8.d7b26a46c" class="menuBottomCopy-t-tabs-0-9"  :data="replaceCssVariables(filterData(state.menuList.data7.subMenu, componentPropBindingMap?.['t-tabs-76d8.d7b26a46c']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active-tab="tTabsx0x9ComputedData.activeTab" :tab-position-extend="tTabsx0x9ComputedData.tabPositionExtend" :stretch="tTabsx0x9ComputedData.stretch" :c-style="tTabsx0x9ComputedData.cStyle" @mouseleave="onmouseleave1739501093511_0_0" @mouseenter="onmouseenter1739501093511_0_1" @tab-click="ontabClick1760325647539">` +
`</t-tabs>` +
`<t-tabs v-if="state.menuList.data5.dropdownState === true" id="t-tabs-c6b3.9274ee3ea" class="menuBottomCopy-t-tabs-0-10"  :data="replaceCssVariables(filterData(state.menuList.data5.subMenu, componentPropBindingMap?.['t-tabs-c6b3.9274ee3ea']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active-tab="tTabsx0x10ComputedData.activeTab" :tab-position-extend="tTabsx0x10ComputedData.tabPositionExtend" :stretch="tTabsx0x10ComputedData.stretch" :c-style="tTabsx0x10ComputedData.cStyle" @mouseleave="onmouseleave1739501269446_0_0" @mouseenter="onmouseenter1739501269446_0_1" @tab-click="ontabClick1760325636381">` +
`</t-tabs>` +
`<t-tabs v-if="state.menuList.data3.dropdownState === true" id="t-tabs-73d5.72fef4af6" class="menuBottomCopy-t-tabs-0-11"  :data="replaceCssVariables(filterData(state.menuList.data3.subMenu, componentPropBindingMap?.['t-tabs-73d5.72fef4af6']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active-tab="tTabsx0x11ComputedData.activeTab" :tab-position-extend="tTabsx0x11ComputedData.tabPositionExtend" :stretch="tTabsx0x11ComputedData.stretch" :c-style="tTabsx0x11ComputedData.cStyle" @mouseleave="onmouseleave1739501428053_0_0" @mouseenter="onmouseenter1739501428053_0_1" @tab-click="ontabClick1760325624464">` +
`</t-tabs>` +
`<t-tabs v-if="state.menuList.data1.dropdownState === true" id="t-tabs-aa53.83bb436e4" class="menuBottomCopy-t-tabs-0-12"  :data="replaceCssVariables(filterData(state.menuList.data1.subMenu, componentPropBindingMap?.['t-tabs-aa53.83bb436e4']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active-tab="tTabsx0x12ComputedData.activeTab" :tab-position-extend="tTabsx0x12ComputedData.tabPositionExtend" :stretch="tTabsx0x12ComputedData.stretch" :c-style="tTabsx0x12ComputedData.cStyle" @mouseleave="onmouseleave1739501556751_0_0" @mouseenter="onmouseenter1739501556751_0_1" @tab-click="ontabClick1760323287105">` +
`</t-tabs>` +
`<t-tabs v-if="state.menuList.data2.dropdownState === true" id="t-tabs-2aec.af8aca068" class="menuBottomCopy-t-tabs-0-13"  :data="replaceCssVariables(filterData(state.menuList.data2.subMenu, componentPropBindingMap?.['t-tabs-2aec.af8aca068']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active-tab="tTabsx0x13ComputedData.activeTab" :tab-position-extend="tTabsx0x13ComputedData.tabPositionExtend" :stretch="tTabsx0x13ComputedData.stretch" :c-style="tTabsx0x13ComputedData.cStyle" @mouseleave="onmouseleave1739501718264_0_0" @mouseenter="onmouseenter1739501718264_0_1" @tab-click="ontabClick1760325612882">` +
`</t-tabs>` +
`<t-tabs v-if="state.menuList.data4.dropdownState === true" id="t-tabs-d7ce.7fdb0c48c" class="menuBottomCopy-t-tabs-0-14"  :data="replaceCssVariables(filterData(state.menuList.data4.subMenu, componentPropBindingMap?.['t-tabs-d7ce.7fdb0c48c']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active-tab="tTabsx0x14ComputedData.activeTab" :tab-position-extend="tTabsx0x14ComputedData.tabPositionExtend" :stretch="tTabsx0x14ComputedData.stretch" :c-style="tTabsx0x14ComputedData.cStyle" @mouseleave="onmouseleave1739501849544_0_0" @mouseenter="onmouseenter1739501849544_0_1" @tab-click="ontabClick1760325630780">` +
`</t-tabs>` +
`<t-tabs v-if="state.menuList.data6.dropdownState === true" id="t-tabs-df35.3791e2a1e" class="menuBottomCopy-t-tabs-0-15"  :data="replaceCssVariables(filterData(state.menuList.data6.subMenu, componentPropBindingMap?.['t-tabs-df35.3791e2a1e']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active-tab="tTabsx0x15ComputedData.activeTab" :tab-position-extend="tTabsx0x15ComputedData.tabPositionExtend" :stretch="tTabsx0x15ComputedData.stretch" :c-style="tTabsx0x15ComputedData.cStyle" @mouseleave="onmouseleave1739502148093_0_0" @mouseenter="onmouseenter1739502148093_0_1" @tab-click="ontabClick1760325641044">` +
`</t-tabs>` +
`<t-tabs v-if="state.menuList.data8.dropdownState === true" id="t-tabs-029c.7cbf10941" class="menuBottomCopy-t-tabs-0-16"  :data="replaceCssVariables(filterData(state.menuList.data8.subMenu, componentPropBindingMap?.['t-tabs-029c.7cbf10941']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active-tab="tTabsx0x16ComputedData.activeTab" :tab-position-extend="tTabsx0x16ComputedData.tabPositionExtend" :stretch="tTabsx0x16ComputedData.stretch" :c-style="tTabsx0x16ComputedData.cStyle" @mouseleave="onmouseleave1739502307650_0_0" @mouseenter="onmouseenter1739502307650_0_1" @tab-click="ontabClick1760325653009">` +
`</t-tabs>` +
`<t-tabs v-if="state.menuList.data10.dropdownState === true" id="t-tabs-5586.f25b5496f" class="menuBottomCopy-t-tabs-0-17"  :data="replaceCssVariables(filterData(state.menuList.data10.subMenu, componentPropBindingMap?.['t-tabs-5586.f25b5496f']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active-tab="tTabsx0x17ComputedData.activeTab" :tab-position-extend="tTabsx0x17ComputedData.tabPositionExtend" :stretch="tTabsx0x17ComputedData.stretch" :c-style="tTabsx0x17ComputedData.cStyle" @mouseleave="onmouseleave1739502424036_0_0" @mouseenter="onmouseenter1739502424036_0_1" @tab-click="ontabClick1760325662676">` +
`</t-tabs>` +
`<t-tabs v-if="state.menuList.data12.dropdownState === true" id="t-tabs-c5b0.abb52202d" class="menuBottomCopy-t-tabs-0-18"  :data="replaceCssVariables(filterData(state.menuList.data12.subMenu, componentPropBindingMap?.['t-tabs-c5b0.abb52202d']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active-tab="tTabsx0x18ComputedData.activeTab" :tab-position-extend="tTabsx0x18ComputedData.tabPositionExtend" :stretch="tTabsx0x18ComputedData.stretch" :c-style="tTabsx0x18ComputedData.cStyle" @mouseleave="onmouseleave1739502624034_0_0" @mouseenter="onmouseenter1739502624034_0_1" @tab-click="ontabClick1760325679125">` +
`</t-tabs>` +
`<t-tabs v-if="state.menuList.data14.dropdownState === true" id="t-tabs-fa6d.becbab30d" class="menuBottomCopy-t-tabs-0-19"  :data="replaceCssVariables(filterData(state.menuList.data14.subMenu, componentPropBindingMap?.['t-tabs-fa6d.becbab30d']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active-tab="tTabsx0x19ComputedData.activeTab" :tab-position-extend="tTabsx0x19ComputedData.tabPositionExtend" :stretch="tTabsx0x19ComputedData.stretch" :c-style="tTabsx0x19ComputedData.cStyle" @mouseleave="onmouseleave1739502755545_0_0" @mouseenter="onmouseenter1739502755545_0_1" @tab-click="ontabClick1760325718651">` +
`</t-tabs>` +
`<t-tabs v-if="state.menuList.data16.dropdownState === true" id="t-tabs-ae47.695dfa3ff" class="menuBottomCopy-t-tabs-0-20"  :data="replaceCssVariables(filterData(state.menuList.data16.subMenu, componentPropBindingMap?.['t-tabs-ae47.695dfa3ff']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active-tab="tTabsx0x20ComputedData.activeTab" :tab-position-extend="tTabsx0x20ComputedData.tabPositionExtend" :stretch="tTabsx0x20ComputedData.stretch" :c-style="tTabsx0x20ComputedData.cStyle" @mouseleave="onmouseleave1739502915771_0_0" @mouseenter="onmouseenter1739502915771_0_1" @tab-click="ontabClick1760325730802">` +
`</t-tabs>` +
`<t-tabs v-if="state.menuList.data11.dropdownState === true" id="t-tabs-27e3.253974f63" class="menuBottomCopy-t-tabs-0-21"  :data="replaceCssVariables(filterData(state.menuList.data11.subMenu, componentPropBindingMap?.['t-tabs-27e3.253974f63']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active-tab="tTabsx0x21ComputedData.activeTab" :tab-position-extend="tTabsx0x21ComputedData.tabPositionExtend" :stretch="tTabsx0x21ComputedData.stretch" :c-style="tTabsx0x21ComputedData.cStyle" @mouseleave="onmouseleave1739499854204" @mouseenter="onmouseenter1739499872362" @tab-click="ontabClick1760325673868">` +
`</t-tabs>` +
`<t-rect v-if="state.menuList.data15.isActive === false" id="t-rect-0466.791830d0b" class="menuBottomCopy-t-rect-0-22"  :tip="tRectx0x22ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data15.text, componentPropBindingMap?.['t-rect-0466.791830d0b']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x22ComputedData.active" :c-style="tRectx0x22ComputedData.cStyle" @click="onclick1739265424400" @mouseenter="onmouseenter1739498791173" @mouseleave="onmouseleave1739498798922">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data15.isActive === true" id="t-rect-a7de.3d5cb9e2f" class="menuBottomCopy-t-rect-0-23"  :tip="tRectx0x23ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data15.text, componentPropBindingMap?.['t-rect-a7de.3d5cb9e2f']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x23ComputedData.active" :c-style="tRectx0x23ComputedData.cStyle" @click="onclick1739265445540_0_0" @mouseenter="onmouseenter1739500192855" @mouseleave="onmouseleave1739500225333">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data9.isActive === false" id="t-rect-3e0e.9f01b42b1" class="menuBottomCopy-t-rect-0-24"  :tip="tRectx0x24ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data9.text, componentPropBindingMap?.['t-rect-3e0e.9f01b42b1']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x24ComputedData.active" :c-style="tRectx0x24ComputedData.cStyle" @click="onclick1739264874414" @mouseleave="onmouseleave1739500827709" @mouseenter="onmouseenter1739500872571">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data9.isActive === true" id="t-rect-b009.5b80a1572" class="menuBottomCopy-t-rect-0-25"  :tip="tRectx0x25ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data9.text, componentPropBindingMap?.['t-rect-b009.5b80a1572']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x25ComputedData.active" :c-style="tRectx0x25ComputedData.cStyle" @click="onclick1739264887369_0_0" @mouseleave="onmouseleave1739500852376" @mouseenter="onmouseenter1739500868136">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data11.isActive === false" id="t-rect-024d.166932bd" class="menuBottomCopy-t-rect-0-26"  :tip="tRectx0x26ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data11.text, componentPropBindingMap?.['t-rect-024d.166932bd']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x26ComputedData.active" :c-style="tRectx0x26ComputedData.cStyle" @click="onclick1739265027340" @mouseenter="onmouseenter1739499812309" @mouseleave="onmouseleave1739499839806">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data11.isActive === true" id="t-rect-66b7.3792ac907" class="menuBottomCopy-t-rect-0-27"  :tip="tRectx0x27ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data11.text, componentPropBindingMap?.['t-rect-66b7.3792ac907']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x27ComputedData.active" :c-style="tRectx0x27ComputedData.cStyle" @click="onclick1739265043843_0_0" @mouseenter="onmouseenter1739447368228" @mouseleave="onmouseleave1739447380996">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data13.isActive === false" id="t-rect-8675.0c6d968be" class="menuBottomCopy-t-rect-0-28"  :tip="tRectx0x28ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data13.text, componentPropBindingMap?.['t-rect-8675.0c6d968be']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x28ComputedData.active" :c-style="tRectx0x28ComputedData.cStyle" @click="onclick1739265152122" @mouseenter="onmouseenter1739500204317" @mouseleave="onmouseleave1739500232057">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data13.isActive === true" id="t-rect-7757.1d8fa4457" class="menuBottomCopy-t-rect-0-29"  :tip="tRectx0x29ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data13.text, componentPropBindingMap?.['t-rect-7757.1d8fa4457']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x29ComputedData.active" :c-style="tRectx0x29ComputedData.cStyle" @click="onclick1739265167394_0_0" @mouseenter="onmouseenter1739500212469" @mouseleave="onmouseleave1739500235650">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data5.isActive === false" id="t-rect-81c3.de9cb3b55" class="menuBottomCopy-t-rect-0-30"  :tip="tRectx0x30ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data5.text, componentPropBindingMap?.['t-rect-81c3.de9cb3b55']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x30ComputedData.active" :c-style="tRectx0x30ComputedData.cStyle" @click="onclick1739263577686" @mouseleave="onmouseleave1739501354900" @mouseenter="onmouseenter1739501380797">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data5.isActive === true" id="t-rect-2e2f.51651f2b6" class="menuBottomCopy-t-rect-0-31"  :tip="tRectx0x31ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data5.text, componentPropBindingMap?.['t-rect-2e2f.51651f2b6']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x31ComputedData.active" :c-style="tRectx0x31ComputedData.cStyle" @click="onclick1739263586641_0_0" @mouseleave="onmouseleave1739501351050" @mouseenter="onmouseenter1739501377050">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data7.isActive === true" id="t-rect-e7ae.e2e17ae41" class="menuBottomCopy-t-rect-0-32"  :tip="tRectx0x32ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data7.text, componentPropBindingMap?.['t-rect-e7ae.e2e17ae41']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x32ComputedData.active" :c-style="tRectx0x32ComputedData.cStyle" @click="onclick1739263733129_0_0" @mouseenter="onmouseenter1739501167868" @mouseleave="onmouseleave1739501188373">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data7.isActive === false" id="t-rect-aeff.61bc4ed09" class="menuBottomCopy-t-rect-0-33"  :tip="tRectx0x33ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data7.text, componentPropBindingMap?.['t-rect-aeff.61bc4ed09']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x33ComputedData.active" :c-style="tRectx0x33ComputedData.cStyle" @click="onclick1739263716948" @mouseenter="onmouseenter1739501163586" @mouseleave="onmouseleave1739501184967">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data3.isActive === false" id="t-rect-6211.6dfc93282" class="menuBottomCopy-t-rect-0-34"  :tip="tRectx0x34ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data3.text, componentPropBindingMap?.['t-rect-6211.6dfc93282']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x34ComputedData.active" :c-style="tRectx0x34ComputedData.cStyle" @click="onclick1739263448982" @mouseenter="onmouseenter1739501478085" @mouseleave="onmouseleave1739501494085">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data3.isActive === true" id="t-rect-6942.b8aece9c8" class="menuBottomCopy-t-rect-0-35"  :tip="tRectx0x35ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data3.text, componentPropBindingMap?.['t-rect-6942.b8aece9c8']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x35ComputedData.active" :c-style="tRectx0x35ComputedData.cStyle" @click="onclick1739263462065" @mouseenter="onmouseenter1739501474527" @mouseleave="onmouseleave1739501490696">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data1.isActive === true" id="t-rect-e437.bd1b02eff" class="menuBottomCopy-t-rect-0-36"  :tip="tRectx0x36ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data1.text, componentPropBindingMap?.['t-rect-e437.bd1b02eff']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x36ComputedData.active" :c-style="tRectx0x36ComputedData.cStyle" @click="onclick1739262547826_0_2" @mouseleave="onmouseleave1739501643006" @mouseenter="onmouseenter1739501656134">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data1.isActive === false" id="t-rect-78b4.bd0244839" class="menuBottomCopy-t-rect-0-37"  :tip="tRectx0x37ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data1.text, componentPropBindingMap?.['t-rect-78b4.bd0244839']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x37ComputedData.active" :c-style="tRectx0x37ComputedData.cStyle" @click="onclick1739262533653" @mouseleave="onmouseleave1739501639921" @mouseenter="onmouseenter1739501652473">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data2.isActive === false" id="t-rect-cab2.a1c2e4463" class="menuBottomCopy-t-rect-0-38"  :tip="tRectx0x38ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data2.text, componentPropBindingMap?.['t-rect-cab2.a1c2e4463']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x38ComputedData.active" :c-style="tRectx0x38ComputedData.cStyle" @click="onclick1739262016032_0_0" @mouseenter="onmouseenter1739501766415" @mouseleave="onmouseleave1739501789265">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data2.isActive === true" id="t-rect-1e55.45f25638e" class="menuBottomCopy-t-rect-0-39"  :tip="tRectx0x39ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data2.text, componentPropBindingMap?.['t-rect-1e55.45f25638e']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x39ComputedData.active" :c-style="tRectx0x39ComputedData.cStyle" @click="onclick1739449266071_0_0" @mouseenter="onmouseenter1739501769805" @mouseleave="onmouseleave1739501785594">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data4.isActive === false" id="t-rect-d7f9.fd771a718" class="menuBottomCopy-t-rect-0-40"  :tip="tRectx0x40ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data4.text, componentPropBindingMap?.['t-rect-d7f9.fd771a718']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x40ComputedData.active" :c-style="tRectx0x40ComputedData.cStyle" @click="onclick1739261819696" @mouseleave="onmouseleave1739501911280" @mouseenter="onmouseenter1739501935673">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data4.isActive === true" id="t-rect-e2d7.6249b5ba" class="menuBottomCopy-t-rect-0-41"  :tip="tRectx0x41ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data4.text, componentPropBindingMap?.['t-rect-e2d7.6249b5ba']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x41ComputedData.active" :c-style="tRectx0x41ComputedData.cStyle" @click="onclick1739261847660_0_0" @mouseleave="onmouseleave1739501915198" @mouseenter="onmouseenter1739501932398">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data14.isActive === false" id="t-rect-5b90.ae677e9ba" class="menuBottomCopy-t-rect-0-42"  :tip="tRectx0x42ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data14.text, componentPropBindingMap?.['t-rect-5b90.ae677e9ba']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x42ComputedData.active" :c-style="tRectx0x42ComputedData.cStyle" @click="onclick1739261028622" @mouseenter="onmouseenter1739502835282" @mouseleave="onmouseleave1739502857819">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data14.isActive === true" id="t-rect-5b24.ddcf6fa67" class="menuBottomCopy-t-rect-0-43"  :tip="tRectx0x43ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data14.text, componentPropBindingMap?.['t-rect-5b24.ddcf6fa67']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x43ComputedData.active" :c-style="tRectx0x43ComputedData.cStyle" @click="onclick1739261048933" @mouseenter="onmouseenter1739502838964" @mouseleave="onmouseleave1739502854126">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data12.isActive === false" id="t-rect-b43e.4b6a54464" class="menuBottomCopy-t-rect-0-44"  :tip="tRectx0x44ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data12.text, componentPropBindingMap?.['t-rect-b43e.4b6a54464']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x44ComputedData.active" :c-style="tRectx0x44ComputedData.cStyle" @click="onclick1739261084073" @mouseleave="onmouseleave1739502682072" @mouseenter="onmouseenter1739502707735">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data12.isActive === true" id="t-rect-957a.589b0a9ad" class="menuBottomCopy-t-rect-0-45"  :tip="tRectx0x45ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data12.text, componentPropBindingMap?.['t-rect-957a.589b0a9ad']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x45ComputedData.active" :c-style="tRectx0x45ComputedData.cStyle" @click="onclick1739261099702" @mouseleave="onmouseleave1739502686142" @mouseenter="onmouseenter1739502704034">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data10.isActive === false" id="t-rect-998c.73e9741f6" class="menuBottomCopy-t-rect-0-46"  :tip="tRectx0x46ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data10.text, componentPropBindingMap?.['t-rect-998c.73e9741f6']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x46ComputedData.active" :c-style="tRectx0x46ComputedData.cStyle" @click="onclick1739261419314" @mouseenter="onmouseenter1739502527497" @mouseleave="onmouseleave1739502552048">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data10.isActive === true" id="t-rect-156d.961e5f97c" class="menuBottomCopy-t-rect-0-47"  :tip="tRectx0x47ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data10.text, componentPropBindingMap?.['t-rect-156d.961e5f97c']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x47ComputedData.active" :c-style="tRectx0x47ComputedData.cStyle" @click="onclick1739261434278" @mouseenter="onmouseenter1739502523292" @mouseleave="onmouseleave1739502548055">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data8.isActive === false" id="t-rect-96b8.c8e706c24" class="menuBottomCopy-t-rect-0-48"  :tip="tRectx0x48ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data8.text, componentPropBindingMap?.['t-rect-96b8.c8e706c24']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x48ComputedData.active" :c-style="tRectx0x48ComputedData.cStyle" @click="onclick1739261552087" @mouseleave="onmouseleave1739502364459" @mouseenter="onmouseenter1739502383500">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data8.isActive === true" id="t-rect-4db7.9ba6bdb7f" class="menuBottomCopy-t-rect-0-49"  :tip="tRectx0x49ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data8.text, componentPropBindingMap?.['t-rect-4db7.9ba6bdb7f']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x49ComputedData.active" :c-style="tRectx0x49ComputedData.cStyle" @click="onclick1739261566403" @mouseleave="onmouseleave1739502359247" @mouseenter="onmouseenter1739502379574">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data6.isActive === false" id="t-rect-ddf0.76a91d001" class="menuBottomCopy-t-rect-0-50"  :tip="tRectx0x50ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data6.text, componentPropBindingMap?.['t-rect-ddf0.76a91d001']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x50ComputedData.active" :c-style="tRectx0x50ComputedData.cStyle" @click="onclick1739261663457" @mouseenter="onmouseenter1739502209599" @mouseleave="onmouseleave1739502225405">` +
`</t-rect>` +
`<t-rect v-if="state.menuList.data6.isActive === true" id="t-rect-b98e.ed2ce2f7d" class="menuBottomCopy-t-rect-0-51"  :tip="tRectx0x51ComputedData.tip" :label="replaceCssVariables(filterData(state.menuList.data6.text, componentPropBindingMap?.['t-rect-b98e.ed2ce2f7d']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x51ComputedData.active" :c-style="tRectx0x51ComputedData.cStyle" @click="onclick1739261683646_0_0" @mouseenter="onmouseenter1739502205089" @mouseleave="onmouseleave1739502221432">` +
`</t-rect>` +
`</div>` +
'',
setup() {
const componentPropBindingMap = {"body":{"attributeName":"tBodyx0x0"},"t-image-base-9e37.c2d3c2f6d":{"attributeName":"tImageBasex0x0"},"t-rect-9d12.1d1d2a0b2":{"attributeName":"tRectx0x1","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-fcbc.fad9b8a94":{"attributeName":"tRectx0x2","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-b9c2.e76da9784":{"attributeName":"tRectx0x3","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-69b5.e4d88f9cb":{"attributeName":"tRectx0x4","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-e302.319581643":{"attributeName":"tRectx0x5","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-tabs-0f17.024920fce":{"attributeName":"tTabsx0x6","data":{"filters":[]},"activeTab":{"filters":[]},"tabPositionExtend":{"filters":[]},"stretch":{"filters":[]},"cStyle":{"filters":[]}},"t-tabs-0eb4.3649ed107":{"attributeName":"tTabsx0x7","data":{"filters":[]},"activeTab":{"filters":[]},"tabPositionExtend":{"filters":[]},"stretch":{"filters":[]},"cStyle":{"filters":[]}},"t-tabs-9efa.0de85629d":{"attributeName":"tTabsx0x8","data":{"filters":[]},"activeTab":{"filters":[]},"tabPositionExtend":{"filters":[]},"stretch":{"filters":[]},"cStyle":{"filters":[]}},"t-tabs-76d8.d7b26a46c":{"attributeName":"tTabsx0x9","data":{"filters":[]},"activeTab":{"filters":[]},"tabPositionExtend":{"filters":[]},"stretch":{"filters":[]},"cStyle":{"filters":[]}},"t-tabs-c6b3.9274ee3ea":{"attributeName":"tTabsx0x10","data":{"filters":[]},"activeTab":{"filters":[]},"tabPositionExtend":{"filters":[]},"stretch":{"filters":[]},"cStyle":{"filters":[]}},"t-tabs-73d5.72fef4af6":{"attributeName":"tTabsx0x11","data":{"filters":[]},"activeTab":{"filters":[]},"tabPositionExtend":{"filters":[]},"stretch":{"filters":[]},"cStyle":{"filters":[]}},"t-tabs-aa53.83bb436e4":{"attributeName":"tTabsx0x12","data":{"filters":[]},"activeTab":{"filters":[]},"tabPositionExtend":{"filters":[]},"stretch":{"filters":[]},"cStyle":{"filters":[]}},"t-tabs-2aec.af8aca068":{"attributeName":"tTabsx0x13","data":{"filters":[]},"activeTab":{"filters":[]},"tabPositionExtend":{"filters":[]},"stretch":{"filters":[]},"cStyle":{"filters":[]}},"t-tabs-d7ce.7fdb0c48c":{"attributeName":"tTabsx0x14","data":{"filters":[]},"activeTab":{"filters":[]},"tabPositionExtend":{"filters":[]},"stretch":{"filters":[]},"cStyle":{"filters":[]}},"t-tabs-df35.3791e2a1e":{"attributeName":"tTabsx0x15","data":{"filters":[]},"activeTab":{"filters":[]},"tabPositionExtend":{"filters":[]},"stretch":{"filters":[]},"cStyle":{"filters":[]}},"t-tabs-029c.7cbf10941":{"attributeName":"tTabsx0x16","data":{"filters":[]},"activeTab":{"filters":[]},"tabPositionExtend":{"filters":[]},"stretch":{"filters":[]},"cStyle":{"filters":[]}},"t-tabs-5586.f25b5496f":{"attributeName":"tTabsx0x17","data":{"filters":[]},"activeTab":{"filters":[]},"tabPositionExtend":{"filters":[]},"stretch":{"filters":[]},"cStyle":{"filters":[]}},"t-tabs-c5b0.abb52202d":{"attributeName":"tTabsx0x18","data":{"filters":[]},"activeTab":{"filters":[]},"tabPositionExtend":{"filters":[]},"stretch":{"filters":[]},"cStyle":{"filters":[]}},"t-tabs-fa6d.becbab30d":{"attributeName":"tTabsx0x19","data":{"filters":[]},"activeTab":{"filters":[]},"tabPositionExtend":{"filters":[]},"stretch":{"filters":[]},"cStyle":{"filters":[]}},"t-tabs-ae47.695dfa3ff":{"attributeName":"tTabsx0x20","data":{"filters":[]},"activeTab":{"filters":[]},"tabPositionExtend":{"filters":[]},"stretch":{"filters":[]},"cStyle":{"filters":[]}},"t-tabs-27e3.253974f63":{"attributeName":"tTabsx0x21","data":{"filters":[]},"activeTab":{"filters":[]},"tabPositionExtend":{"filters":[]},"stretch":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-0466.791830d0b":{"attributeName":"tRectx0x22","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-a7de.3d5cb9e2f":{"attributeName":"tRectx0x23","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-3e0e.9f01b42b1":{"attributeName":"tRectx0x24","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-b009.5b80a1572":{"attributeName":"tRectx0x25","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-024d.166932bd":{"attributeName":"tRectx0x26","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-66b7.3792ac907":{"attributeName":"tRectx0x27","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-8675.0c6d968be":{"attributeName":"tRectx0x28","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-7757.1d8fa4457":{"attributeName":"tRectx0x29","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-81c3.de9cb3b55":{"attributeName":"tRectx0x30","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-2e2f.51651f2b6":{"attributeName":"tRectx0x31","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-e7ae.e2e17ae41":{"attributeName":"tRectx0x32","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-aeff.61bc4ed09":{"attributeName":"tRectx0x33","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-6211.6dfc93282":{"attributeName":"tRectx0x34","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-6942.b8aece9c8":{"attributeName":"tRectx0x35","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-e437.bd1b02eff":{"attributeName":"tRectx0x36","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-78b4.bd0244839":{"attributeName":"tRectx0x37","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-cab2.a1c2e4463":{"attributeName":"tRectx0x38","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-1e55.45f25638e":{"attributeName":"tRectx0x39","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-d7f9.fd771a718":{"attributeName":"tRectx0x40","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-e2d7.6249b5ba":{"attributeName":"tRectx0x41","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-5b90.ae677e9ba":{"attributeName":"tRectx0x42","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-5b24.ddcf6fa67":{"attributeName":"tRectx0x43","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-b43e.4b6a54464":{"attributeName":"tRectx0x44","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-957a.589b0a9ad":{"attributeName":"tRectx0x45","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-998c.73e9741f6":{"attributeName":"tRectx0x46","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-156d.961e5f97c":{"attributeName":"tRectx0x47","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-96b8.c8e706c24":{"attributeName":"tRectx0x48","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-4db7.9ba6bdb7f":{"attributeName":"tRectx0x49","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-ddf0.76a91d001":{"attributeName":"tRectx0x50","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-b98e.ed2ce2f7d":{"attributeName":"tRectx0x51","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}}};
// 页面内注入全局变量和事件
...
tTabsx0x13: {
defaultStyle: {
            default: {"width":"144px","height":"228px","bottom":"120px !important","backgroundImage":"var(--t-sub-menu-bottom-border),var(--t-sub-menu-top-border)","-webkit-mask-image":"","backgroundRepeat":"no-repeat,no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto,auto auto","-webkit-mask-size":"","backgroundPosition":"50% 100%,50% 0%","-webkit-mask-position":"","display":"grid","alignContent":"space-between","justifyContent":"center","justifyItems":"baseline","marginTop":"0px","paddingTop":"20px","overflow":"visible","alignItems":"baseline","paddingBottom":"20px","backgroundColor":"var(--t-sub-menu-background)","borderTopLeftRadius":"17px","borderTopRightRadius":"17px","borderBottomLeftRadius":"17px","borderBottomRightRadius":"17px","borderLeft":"1px solid rgba(23,62,228,0)","borderTop":"1px solid rgba(23,62,228,0)","borderRight":"1px solid rgba(23,62,228,0)","borderBottom":"1px solid rgba(23,62,228,0)","animationName":""},
...
tabPositionExtend:"right",
stretch:false,
cStyle:{"wrapper":{"default":{"width":"144px","height":"228px","bottom":"120px !important","backgroundImage":"var(--t-sub-menu-bottom-border),var(--t-sub-menu-top-border)","-webkit-mask-image":"","backgroundRepeat":"no-repeat,no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto,auto auto","-webkit-mask-size":"","backgroundPosition":"50% 100%,50% 0%","-webkit-mask-position":"","display":"grid","alignContent":"space-between","justifyContent":"center","justifyItems":"baseline","marginTop":"0px","paddingTop":"20px","overflow":"visible","alignItems":"baseline","paddingBottom":"20px","backgroundColor":"var(--t-sub-menu-background)","borderTopLeftRadius":"17px","borderTopRightRadius":"17px","borderBottomLeftRadius":"17px","borderBottomRightRadius":"17px","borderLeft":"1px solid rgba(23,62,228,0)","borderTop":"1px solid rgba(23,62,228,0)","borderRight":"1px solid rgba(23,62,228,0)","borderBottom":"1px solid rgba(23,62,228,0)","animationName":""}},"itemActiveBorder":{"default":{"width":"4px","height":"100%","display":"none"}},"itemWrapper":{"default":{"display":"block","height":"22px","width":"112px","color":"var(--t-glmenu-dialog-text)","backgroundColor":"rgba(23, 62, 228, 0)","marginLeft":"10px","marginTop":"9px"},"active":{"backgroundImage":"var(--t-select-dropdown-item-background)","color":"var(--t-glmenu-dialog-text-active)","-webkit-mask-image":"","backgroundRepeat":"repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"0% 0%","-webkit-mask-position":""},"hover":{"backgroundImage":"var(--t-select-dropdown-item-background)","color":"var(--t-glmenu-dialog-text-active)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":""}},"itemLabel":{"default":{"fontSize":"16px","fontWeight":"700","color":"var(--t-glmenu-dialog-text)","whiteSpace":"nowrap","textOverflow":"ellipsis","display":"block","overflow":"hidden","textAlign":"center"},"hover":{"color":"var(--t-glmenu-dialog-text-active)"},"focus":{"color":"var(--t-glmenu-dialog-text-active)"},"active":{"color":"var(--t-glmenu-dialog-text-active)"}},"itemIcon":{"default":{"display":"none"}}}, 
 },
},
tTabsx0x14: {
defaultStyle: {
...
tRectx0x22: {
defaultStyle: {
            default: {"width":"83px","height":"123px","backgroundImage":"var(--t-bottom-menu-ghhp-default)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","borderLeft":"1px none ","borderTop":"1px none ","borderRight":"1px none ","borderBottom":"1px none ","position":"unset","left":"47px","top":"2px","fontSize":"16px","fontWeight":"700","color":"var(--t-glmenu-color-text)","marginTop":"0px","paddingTop":"100px","cursor":"pointer","animationName":"","transition":".3s"},
...
label:"",
active:false,
cStyle:{"wrapper":{"default":{"width":"83px","height":"123px","backgroundImage":"var(--t-bottom-menu-ghhp-default)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","borderLeft":"1px none ","borderTop":"1px none ","borderRight":"1px none ","borderBottom":"1px none ","position":"unset","left":"47px","top":"2px","fontSize":"16px","fontWeight":"700","color":"var(--t-glmenu-color-text)","marginTop":"0px","paddingTop":"100px","cursor":"pointer","animationName":"","transition":".3s"},"hover":{"backgroundImage":"var(--t-bottom-menu-ghhp-active)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","color":"var(--t-color-text-green-default)"}},"text":{"default":{"display":"block !important","width":"100%","height":"auto","textAlign":"center","whiteSpace":"nowrap","textOverflow":"ellipsis","overflow":"hidden"}}}, 
 },
},
tRectx0x23: {
defaultStyle: {
            default: {"width":"83px","height":"123px","backgroundImage":"var(--t-bottom-menu-ghhp-active)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","borderLeft":"1px none ","borderTop":"1px none ","borderRight":"1px none ","borderBottom":"1px none ","position":"unset","left":"47px","top":"2px","fontSize":"16px","fontWeight":"700","color":"var(--t-color-text-green-default)","marginTop":"0px","paddingTop":"100px","cursor":"pointer","animationName":""},
...
label:"",
active:false,
cStyle:{"wrapper":{"default":{"width":"83px","height":"123px","backgroundImage":"var(--t-bottom-menu-ghhp-active)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","borderLeft":"1px none ","borderTop":"1px none ","borderRight":"1px none ","borderBottom":"1px none ","position":"unset","left":"47px","top":"2px","fontSize":"16px","fontWeight":"700","color":"var(--t-color-text-green-default)","marginTop":"0px","paddingTop":"100px","cursor":"pointer","animationName":""},"hover":{"backgroundImage":"","-webkit-mask-image":"","backgroundRepeat":"","-webkit-mask-repeat":"","backgroundSize":"","-webkit-mask-size":"","backgroundPosition":"","-webkit-mask-position":"","color":""}},"text":{"default":{"display":"block !important","width":"100%","height":"auto","textAlign":"center","whiteSpace":"nowrap","textOverflow":"ellipsis","overflow":"hidden"}}}, 
 },
},
tRectx0x24: {
defaultStyle: {
...
label:"",
active:false,
cStyle:{"wrapper":{"default":{"width":"83px","height":"123px","backgroundImage":"var(--t-bottom-menu-lyxc-default)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","borderLeft":"1px none ","borderTop":"1px none ","borderRight":"1px none ","borderBottom":"1px none ","position":"unset","left":"394px","top":"-12px","fontSize":"16px","fontWeight":"700","color":"var(--t-glmenu-color-text)","marginTop":"0px","paddingTop":"100px","cursor":"pointer","animationName":"","transition":".3s"},"hover":{"backgroundImage":"var(--t-bottom-menu-lyxc-active)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","color":"var(--t-color-text-green-default)"}},"text":{"default":{"display":"block !important","width":"100%","height":"auto","textAlign":"center","whiteSpace":"nowrap","textOverflow":"ellipsis","overflow":"hidden"}}}, 
 },
},
tRectx0x25: {
defaultStyle: {
...
label:"",
active:false,
cStyle:{"wrapper":{"default":{"width":"83px","height":"123px","backgroundImage":"var(--t-bottom-menu-shenghj-default)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","borderLeft":"1px none ","borderTop":"1px none ","borderRight":"1px none ","borderBottom":"1px none ","position":"unset","left":"280px","top":"-6px","fontSize":"16px","fontWeight":"700","color":"var(--t-glmenu-color-text)","marginTop":"0px","paddingTop":"100px","cursor":"pointer","animationName":"","transition":".3s"},"hover":{"backgroundImage":"var(--t-bottom-menu-shenghj-active)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","color":"var(--t-color-text-green-default)"}}}, 
 },
},
tRectx0x27: {
defaultStyle: {
...
label:"",
active:false,
cStyle:{"wrapper":{"default":{"width":"83px","height":"123px","backgroundImage":"var(--t-bottom-menu-jdkb-default)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","borderLeft":"1px none ","borderTop":"1px none ","borderRight":"1px none ","borderBottom":"1px none ","position":"unset","left":"162px","top":"-6px","fontSize":"16px","fontWeight":"700","color":"var(--t-glmenu-color-text)","marginTop":"0px","paddingTop":"100px","cursor":"pointer","animationName":"","transition":".3s"},"hover":{"backgroundImage":"var(--t-bottom-menu-jdkb-active)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","color":"var(--t-color-text-green-default)"}},"text":{"default":{"display":"block !important","width":"100%","height":"auto","textAlign":"center","whiteSpace":"nowrap","textOverflow":"ellipsis","overflow":"hidden"}}}, 
 },
},
tRectx0x29: {
defaultStyle: {
...
label:"",
active:false,
cStyle:{"wrapper":{"default":{"width":"83px","height":"123px","backgroundImage":"var(--t-bottom-menu-jxzf-default)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","borderLeft":"1px none ","borderTop":"1px none ","borderRight":"1px none ","borderBottom":"1px none ","position":"unset","left":"627px","top":"-23px","fontSize":"16px","fontWeight":"700","color":"var(--t-glmenu-color-text)","marginTop":"0px","paddingTop":"100px","cursor":"pointer","animationName":"","transition":".3s"},"hover":{"backgroundImage":"var(--t-bottom-menu-jxzf-active)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","color":"var(--t-color-text-green-default)"}},"text":{"default":{"display":"block !important","width":"100%","height":"auto","textAlign":"center","whiteSpace":"nowrap","textOverflow":"ellipsis","overflow":"hidden"}}}, 
 },
},
tRectx0x31: {
defaultStyle: {
...
label:"",
active:false,
cStyle:{"wrapper":{"default":{"width":"83px","height":"123px","backgroundImage":"var(--t-bottom-menu-jxzf-active)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","borderLeft":"1px none ","borderTop":"1px none ","borderRight":"1px none ","borderBottom":"1px none ","position":"unset","left":"627px","top":"-23px","fontSize":"16px","fontWeight":"700","color":"var(--t-color-text-green-default)","marginTop":"0px","paddingTop":"100px","cursor":"pointer","animationName":""},"hover":{"backgroundImage":"var(--t-bottom-menu-jxzf-active)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","color":"var(--t-color-text-green-default)"}},"text":{"default":{"display":"block !important","width":"100%","height":"auto","textAlign":"center","whiteSpace":"nowrap","textOverflow":"ellipsis","overflow":"hidden"}}}, 
 },
},
tRectx0x32: {
defaultStyle: {
...
label:"",
active:false,
cStyle:{"wrapper":{"default":{"width":"83px","height":"123px","backgroundImage":"var(--t-bottom-menu-xfts-active)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","borderLeft":"1px none ","borderTop":"1px none ","borderRight":"1px none ","borderBottom":"1px none ","position":"unset","left":"510px","top":"-20px","fontSize":"16px","fontWeight":"700","color":"var(--t-color-text-green-default)","marginTop":"0px","paddingTop":"100px","cursor":"pointer","animationName":""},"hover":{"backgroundImage":"","-webkit-mask-image":"","backgroundRepeat":"","-webkit-mask-repeat":"","backgroundSize":"","-webkit-mask-size":"","backgroundPosition":"","-webkit-mask-position":"","color":""}},"text":{"default":{"display":"block !important","width":"100%","height":"auto","textAlign":"center","whiteSpace":"nowrap","textOverflow":"ellipsis","overflow":"hidden"}}}, 
 },
},
tRectx0x33: {
defaultStyle: {
...
label:"",
active:false,
cStyle:{"wrapper":{"default":{"width":"83px","height":"123px","backgroundImage":"var(--t-bottom-menu-xfts-default)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","borderLeft":"1px none ","borderTop":"1px none ","borderRight":"1px none ","borderBottom":"1px none ","position":"unset","left":"510px","top":"-20px","fontSize":"16px","fontWeight":"700","color":"var(--t-glmenu-color-text)","marginTop":"0px","paddingTop":"100px","cursor":"pointer","animationName":"","transition":".3s"},"hover":{"backgroundImage":"var(--t-bottom-menu-xfts-active)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","color":"var(--t-color-text-green-default)"}},"text":{"default":{"display":"block !important","width":"100%","height":"auto","textAlign":"center","whiteSpace":"nowrap","textOverflow":"ellipsis","overflow":"hidden"}}}, 
 },
},
tRectx0x34: {
defaultStyle: {
...
label:"",
active:false,
cStyle:{"wrapper":{"default":{"width":"83px","height":"123px","backgroundImage":"var(--t-bottom-menu-yjgl-default)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","borderLeft":"1px none ","borderTop":"1px none ","borderRight":"1px none ","borderBottom":"1px none ","position":"unset","left":"746px","top":"-28px","fontSize":"16px","fontWeight":"700","color":"var(--t-glmenu-color-text)","marginTop":"0px","paddingTop":"100px","cursor":"pointer","animationName":"","transition":".3s"},"hover":{"backgroundImage":"var(--t-bottom-menu-yjgl-active)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","color":"var(--t-color-text-green-default)"}},"text":{"default":{"display":"block !important","width":"100%","height":"auto","textAlign":"center","whiteSpace":"nowrap","textOverflow":"ellipsis","overflow":"hidden"}}}, 
 },
},
tRectx0x35: {
defaultStyle: {
...
label:"核与辐射",
active:false,
cStyle:{"wrapper":{"default":{"width":"83px","height":"120px","backgroundImage":"var(--t-bottom-menu-heyf-active)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 0%","-webkit-mask-position":"","borderLeft":"1px none ","borderTop":"1px none ","borderRight":"1px none ","borderBottom":"1px none ","position":"unset","left":"860px","top":"-6px","fontSize":"16px","fontWeight":"700","color":"var(--t-color-text-green-default)","marginTop":"0px","paddingTop":"40px","cursor":"pointer","animationName":""},"hover":{"backgroundImage":"","-webkit-mask-image":"","backgroundRepeat":"","-webkit-mask-repeat":"","backgroundSize":"","-webkit-mask-size":"","backgroundPosition":"","-webkit-mask-position":"","color":""}},"text":{"default":{"display":"block !important","width":"100%","height":"auto","textAlign":"center","whiteSpace":"nowrap","textOverflow":"ellipsis","overflow":"hidden"}}}, 
 },
},
tRectx0x37: {
defaultStyle: {
            default: {"width":"83px","height":"120px","backgroundImage":"var(--t-bottom-menu-heyf-default)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 0%","-webkit-mask-position":"","borderLeft":"1px none ","borderTop":"1px none ","borderRight":"1px none ","borderBottom":"1px none ","position":"unset","left":"860px","top":"-6px","fontSize":"16px","fontWeight":"700","color":"var(--t-glmenu-color-text)","marginTop":"0px","paddingTop":"40px","cursor":"pointer","animationName":"","transition":".3s"},
...
label:"核与辐射",
active:false,
cStyle:{"wrapper":{"default":{"width":"83px","height":"120px","backgroundImage":"var(--t-bottom-menu-heyf-default)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 0%","-webkit-mask-position":"","borderLeft":"1px none ","borderTop":"1px none ","borderRight":"1px none ","borderBottom":"1px none ","position":"unset","left":"860px","top":"-6px","fontSize":"16px","fontWeight":"700","color":"var(--t-glmenu-color-text)","marginTop":"0px","paddingTop":"40px","cursor":"pointer","animationName":"","transition":".3s"},"hover":{"backgroundImage":"var(--t-bottom-menu-heyf-active)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 0%","-webkit-mask-position":"","color":"var(--t-color-text-green-default)"}},"text":{"default":{"display":"block !important","width":"100%","height":"auto","textAlign":"center","whiteSpace":"nowrap","textOverflow":"ellipsis","overflow":"hidden"}}}, 
 },
},
tRectx0x38: {
defaultStyle: {
...
label:"自然生态",
active:false,
cStyle:{"wrapper":{"default":{"width":"83px","height":"123px","backgroundImage":"var(--t-bottom-menu-zrst-default)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","borderLeft":"1px none ","borderTop":"1px none ","borderRight":"1px none ","borderBottom":"1px none ","position":"unset","left":"975.5px","top":"-31.5px","fontSize":"16px","fontWeight":"700","color":"var(--t-glmenu-color-text)","marginTop":"0px","paddingTop":"100px","cursor":"pointer","animationName":"","transition":".3s"},"hover":{"backgroundImage":"var(--t-bottom-menu-zrst-active)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","color":"var(--t-color-text-green-default)"}},"text":{"default":{"display":"block !important","width":"100%","height":"auto","textAlign":"center","whiteSpace":"nowrap","textOverflow":"ellipsis","overflow":"hidden"}}}, 
 },
},
tRectx0x39: {
defaultStyle: {
...
label:"",
active:false,
cStyle:{"wrapper":{"default":{"width":"83px","height":"123px","backgroundImage":"var(--t-bottom-menu-gfjg-default)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","borderLeft":"1px none ","borderTop":"1px none ","borderRight":"1px none ","borderBottom":"1px none ","position":"unset","left":"1094px","top":"-28px","fontSize":"16px","fontWeight":"700","color":"var(--t-glmenu-color-text)","marginTop":"0px","paddingTop":"100px","cursor":"pointer","animationName":"","transition":".3s"},"hover":{"backgroundImage":"var(--t-bottom-menu-gfjg-active)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","color":"var(--t-color-text-green-default)"}},"text":{"default":{"display":"block !important","width":"100%","height":"auto","textAlign":"center","whiteSpace":"nowrap","textOverflow":"ellipsis","overflow":"hidden"}}}, 
 },
},
tRectx0x41: {
defaultStyle: {
...
tRectx0x42: {
defaultStyle: {
            default: {"width":"83px","height":"123px","backgroundImage":"var(--t-bottom-menu-gl-default)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","borderLeft":"1px none ","borderTop":"1px none ","borderRight":"1px none ","borderBottom":"1px none ","position":"unset","left":"1673.5px","top":"-4px","fontSize":"16px","fontWeight":"700","color":"var(--t-glmenu-color-text)","marginTop":"0px","paddingTop":"100px","cursor":"pointer","transition":".3s"},
...
label:"",
active:false,
cStyle:{"wrapper":{"default":{"width":"83px","height":"123px","backgroundImage":"var(--t-bottom-menu-gl-default)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","borderLeft":"1px none ","borderTop":"1px none ","borderRight":"1px none ","borderBottom":"1px none ","position":"unset","left":"1673.5px","top":"-4px","fontSize":"16px","fontWeight":"700","color":"var(--t-glmenu-color-text)","marginTop":"0px","paddingTop":"100px","cursor":"pointer","transition":".3s"},"hover":{"backgroundImage":"var(--t-bottom-menu-gl-active)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","color":"var(--t-color-text-green-default)"}}}, 
 },
},
tRectx0x43: {
defaultStyle: {
            default: {"width":"83px","height":"123px","backgroundImage":"var(--t-bottom-menu-gl-active)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","borderLeft":"1px none ","borderTop":"1px none ","borderRight":"1px none ","borderBottom":"1px none ","position":"unset","left":"1673.5px","top":"-4px","fontSize":"16px","fontWeight":"700","color":"var(--t-color-text-green-default)","marginTop":"0px","paddingTop":"100px","cursor":"pointer","animationName":"","box-shadow":""},
...
label:"",
active:false,
cStyle:{"wrapper":{"default":{"width":"83px","height":"123px","backgroundImage":"var(--t-bottom-menu-gl-active)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","borderLeft":"1px none ","borderTop":"1px none ","borderRight":"1px none ","borderBottom":"1px none ","position":"unset","left":"1673.5px","top":"-4px","fontSize":"16px","fontWeight":"700","color":"var(--t-color-text-green-default)","marginTop":"0px","paddingTop":"100px","cursor":"pointer","animationName":"","box-shadow":""},"hover":{"backgroundImage":"","-webkit-mask-image":"","backgroundRepeat":"","-webkit-mask-repeat":"","backgroundSize":"","-webkit-mask-size":"","backgroundPosition":"","-webkit-mask-position":"","color":""}},"text":{"default":{"display":"block !important","width":"100%","height":"auto","textAlign":"center","whiteSpace":"nowrap","textOverflow":"ellipsis","overflow":"hidden"}}}, 
 },
},
tRectx0x44: {
defaultStyle: {
            default: {"width":"83px","height":"123px","backgroundImage":"var(--t-bottom-menu-dqhj-default)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","borderLeft":"1px none ","borderTop":"1px none ","borderRight":"1px none ","borderBottom":"1px none ","position":"unset","left":"1558.5px","top":"-7.5px","fontSize":"16px","fontWeight":"700","color":"var(--t-glmenu-color-text)","marginTop":"0px","paddingTop":"100px","cursor":"pointer","animationName":"","transition":".3s"},
...
label:"",
active:false,
cStyle:{"wrapper":{"default":{"width":"83px","height":"123px","backgroundImage":"var(--t-bottom-menu-dqhj-default)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","borderLeft":"1px none ","borderTop":"1px none ","borderRight":"1px none ","borderBottom":"1px none ","position":"unset","left":"1558.5px","top":"-7.5px","fontSize":"16px","fontWeight":"700","color":"var(--t-glmenu-color-text)","marginTop":"0px","paddingTop":"100px","cursor":"pointer","animationName":"","transition":".3s"},"hover":{"backgroundImage":"var(--t-bottom-menu-dqhj-active)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","color":"var(--t-color-text-green-default)"}},"text":{"default":{"display":"block !important","width":"100%","height":"auto","textAlign":"center","whiteSpace":"nowrap","textOverflow":"ellipsis","overflow":"hidden"}}}, 
 },
},
tRectx0x45: {
defaultStyle: {
            default: {"width":"83px","height":"123px","backgroundImage":"var(--t-bottom-menu-dqhj-active)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","borderLeft":"1px none ","borderTop":"1px none ","borderRight":"1px none ","borderBottom":"1px none ","position":"unset","left":"1558.5px","top":"-7.5px","fontSize":"16px","fontWeight":"700","color":"var(--t-color-text-green-default)","marginTop":"0px","paddingTop":"100px","cursor":"pointer","animationName":""},
...
label:"",
active:false,
cStyle:{"wrapper":{"default":{"width":"83px","height":"123px","backgroundImage":"var(--t-bottom-menu-dqhj-active)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","borderLeft":"1px none ","borderTop":"1px none ","borderRight":"1px none ","borderBottom":"1px none ","position":"unset","left":"1558.5px","top":"-7.5px","fontSize":"16px","fontWeight":"700","color":"var(--t-color-text-green-default)","marginTop":"0px","paddingTop":"100px","cursor":"pointer","animationName":""},"hover":{"backgroundImage":"","-webkit-mask-image":"","backgroundRepeat":"","-webkit-mask-repeat":"","backgroundSize":"","-webkit-mask-size":"","backgroundPosition":"","-webkit-mask-position":"","color":""}},"text":{"default":{"display":"block !important","width":"100%","height":"auto","textAlign":"center","whiteSpace":"nowrap","textOverflow":"ellipsis","overflow":"hidden"}}}, 
 },
},
tRectx0x46: {
defaultStyle: {
...
label:"",
active:false,
cStyle:{"wrapper":{"default":{"width":"83px","height":"123px","backgroundImage":"var(--t-bottom-menu-shj-default)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","borderLeft":"1px none ","borderTop":"1px none ","borderRight":"1px none ","borderBottom":"1px none ","position":"unset","left":"1443.5px","top":"-13.5px","fontSize":"16px","fontWeight":"700","color":"var(--t-glmenu-color-text)","marginTop":"0px","paddingTop":"100px","cursor":"pointer","animationName":"","transition":".3s"},"hover":{"backgroundImage":"var(--t-bottom-menu-shj-active)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","color":"var(--t-color-text-green-default)"}},"text":{"default":{"display":"block !important","width":"100%","height":"auto","textAlign":"center","whiteSpace":"nowrap","textOverflow":"ellipsis","overflow":"hidden"}}}, 
 },
},
tRectx0x47: {
defaultStyle: {
...
label:"",
active:false,
cStyle:{"wrapper":{"default":{"width":"83px","height":"123px","backgroundImage":"var(--t-bottom-menu-trhj-default)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","borderLeft":"1px none ","borderTop":"1px none ","borderRight":"1px none ","borderBottom":"1px none ","position":"unset","left":"1319.5px","top":"-19px","fontSize":"16px","fontWeight":"700","color":"var(--t-glmenu-color-text)","marginTop":"0px","paddingTop":"100px","cursor":"pointer","animationName":"","transition":".3s"},"hover":{"backgroundImage":"var(--t-bottom-menu-trhj-active)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","color":"var(--t-color-text-green-default)"}},"text":{"default":{"display":"block !important","width":"100%","height":"auto","textAlign":"center","whiteSpace":"nowrap","textOverflow":"ellipsis","overflow":"hidden"}}}, 
 },
},
tRectx0x49: {
defaultStyle: {
...
label:"",
active:false,
cStyle:{"wrapper":{"default":{"width":"83px","height":"123px","backgroundImage":"var(--t-bottom-menu-hyhj-default)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","borderLeft":"1px none ","borderTop":"1px none ","borderRight":"1px none ","borderBottom":"1px none ","position":"unset","left":"1212px","top":"-24.5px","fontSize":"16px","fontWeight":"700","color":"var(--t-glmenu-color-text)","marginTop":"0px","paddingTop":"100px","cursor":"pointer","animationName":"","transition":".3s"},"hover":{"backgroundImage":"var(--t-bottom-menu-hyhj-active)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","color":"var(--t-color-text-green-default)"}},"text":{"default":{"display":"block !important","width":"100%","height":"auto","textAlign":"center","whiteSpace":"nowrap","textOverflow":"ellipsis","overflow":"hidden"}}}, 
 },
},
tRectx0x51: {
defaultStyle: {
...
// getMenuListNew();
apiRegistry.getMenuList.request();
};
...
// 接口函数
 getMenuListNew: {
              ...
              config: {"url":"/lxt-zhcx-pro/menu/user/menu/tree","method":"get","baseURL":"http://192.168.0.202:7777","params":{"userToken":"state.userToken"}},
...
return new Promise((resolve, reject) => {
                ...
                http({"url":"/lxt-zhcx-pro/menu/user/menu/tree","method":"get","baseURL":"http://192.168.0.202:7777","params":{"userToken":state.userToken},}).then((res) => {
                   ...
                   // 成功的操作
                   const cacheKey = generateCacheKey('http://192.168.0.202:7777-/lxt-zhcx-pro/menu/user/menu/tree',  {"userToken":state.userToken});
                   
                   apiDataMap[cacheKey] = res.data;
                   apiDataMap['getMenuListNew'] = res.data;
...
return new Promise((resolve, reject) => {
                ...
                http({"url":global.serviceBasePath,"method":"get","baseURL":global.serviceBaseUrl,"params":{"interfaceId":"dee50f8ea76eaf13dc5750b740ad44ff","sss":"FJSTY.OVERVIEW"},}).then((res) => {
                   ...
                   apiDataMap[cacheKey] = res.data;
                   apiDataMap['getMenuList'] = res.data;
...
state.menuList.data1.isActive = true
// Object.keys(state.menuList).forEach(key =>{
...
setIcon()
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-menuBottomCopy', global.appScaleMode, 'normal');

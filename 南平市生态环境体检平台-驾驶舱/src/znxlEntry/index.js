...
`<t-component id="t-component-af5e.319aed675" class="znxlEntry-t-component-0-1"  :name="tComponentx0x1ComputedData.name" :c-style="tComponentx0x1ComputedData.cStyle" :src="tComponentx0x1ComputedData.src" :component-name="tComponentx0x1ComputedData.componentName">` +
`</t-component>` +
`</div>` +
'',
setup() {
...
tComponentx0x1: {
defaultStyle: {
            default: {"width":"1920px","height":"1080px","margin":"0 auto","backgroundColor":"rgba(36, 41, 62, 0)","top":"0px","left":"0px","pointerEvents":"none","animationName":""},
            
            },
 default: { 
 
name:"znxlComponent",
cStyle:{"wrapper":{"default":{"width":"1920px","height":"1080px","margin":"0 auto","backgroundColor":"rgba(36, 41, 62, 0)","top":"0px","left":"0px","pointerEvents":"none","animationName":""}}},
...
return new Promise((resolve, reject) => {
  http({"url":global.serviceBasePath,"method":"get","baseURL":global.lxsServiceBaseUrl,"params":{"LOGIN_NAME":name,"interfaceId":"1debc5fcb6a00f496805f74fa5e0748b"},}).then((res) => {
     // 成功的操作

window.sourceControlPopComponent = {
template: 
`<div id="t-l-c-sourceControlPop" class="t-l-c-sourceControlPop" >` +
`<t-rect id="t-rect-3c13.6e224e776" class="sourceControlPop-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle">` +
`</t-rect>` +
`<t-rect id="t-rect-39ea.51f8eb66d" class="sourceControlPop-t-rect-0-1"  :tip="tRectx0x1ComputedData.tip" :label="tRectx0x1ComputedData.label" :active="tRectx0x1ComputedData.active" :c-style="tRectx0x1ComputedData.cStyle" @mouseout="onmouseout1739345365135" @click="onclick1739960380902">` +
`</t-rect>` +
`<t-rect id="t-rect-5094.9a9212dbc" class="sourceControlPop-t-rect-0-2"  :tip="tRectx0x2ComputedData.tip" :label="tRectx0x2ComputedData.label" :active="tRectx0x2ComputedData.active" :c-style="tRectx0x2ComputedData.cStyle" @mouseover="onmouseover1739345261051">` +
`</t-rect>` +
`<t-text id="t-text-0849.df06c90a6" class="sourceControlPop-t-text-0-3"  :label="tTextx0x3ComputedData.label" :editable="tTextx0x3ComputedData.editable" :c-style="tTextx0x3ComputedData.cStyle">` +
`</t-text>` +
`<t-text id="t-text-cfa2.bac27825d" class="sourceControlPop-t-text-0-4"  :label="replaceCssVariables(state.timeText, global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x4ComputedData.editable" :c-style="tTextx0x4ComputedData.cStyle">` +
`</t-text>` +
`<t-iframe id="t-iframe-1c05.41838cea3" class="sourceControlPop-t-iframe-0-6"  :src="replaceCssVariables(state.url, global?.theme || global?.activeTheme || '默认主题')" :srcdoc="tIframex0x6ComputedData.srcdoc" :scrolling="tIframex0x6ComputedData.scrolling" :c-style="tIframex0x6ComputedData.cStyle">` +
`</t-iframe>` +
`</div>` +
'',
setup() {
...
tTextx0x4: {
defaultStyle: {
            default: {"width":"132px","height":"18px","color":"var(--skin-font-color-80)","lineHeight":"18px","top":"112px","left":"1588px","position":"unset","animationName":""},
...
label:"",
editable:false,
cStyle:{"wrapper":{"default":{"width":"132px","height":"18px","color":"var(--skin-font-color-80)","lineHeight":"18px","top":"112px","left":"1588px","position":"unset","animationName":""}}}, 
 },
},
tIframex0x6: {
defaultStyle: {
            default: {"width":"1636px","height":"801px","position":"unset","left":"148px","top":"172px"},
...
srcdoc:"",
scrolling:"no",
cStyle:{"wrapper":{"default":{"width":"1636px","height":"801px","position":"unset","left":"148px","top":"172px"}}}, 
 },
},
});
const setOption = () => {
...
return new Promise((resolve, reject) => {
  http({"url":global.serviceBasePath,"method":"get","baseURL":global.serviceBaseUrl,"params":{"interfaceId":"d43c60bb91daa224dfee798b6d09cc23"},}).then((res) => {
     // 成功的操作
     console.log(res);
if (res.status === 200) {
  const { data } = res.data;
  ...
  state.time = dateFormat(data.time, 'yyyy-MM-dd');

  state.timeText = `截至${state.time}`;
  getData();
...
getTime();
 function handleWindowResize() {
                            setPageScale('t-l-c-sourceControlPop', global.appScaleMode, 'normal');

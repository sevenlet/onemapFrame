window.socialServiceComponent = {
template: 
`<div id="t-l-c-socialService" class="t-l-c-socialService" >` +
`<t-rect id="t-rect-b0a3.3a62e268c" class="socialService-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle">` +
`</t-rect>` +
`<t-rect id="t-rect-fcb2.2f7ab802" class="socialService-t-rect-0-1"  :tip="tRectx0x1ComputedData.tip" :label="tRectx0x1ComputedData.label" :active="tRectx0x1ComputedData.active" :c-style="tRectx0x1ComputedData.cStyle">` +
`</t-rect>` +
`<t-rect id="t-rect-ee58.949c3e8bc" class="socialService-t-rect-0-2"  :tip="tRectx0x2ComputedData.tip" :label="tRectx0x2ComputedData.label" :active="tRectx0x2ComputedData.active" :c-style="tRectx0x2ComputedData.cStyle">` +
`</t-rect>` +
`<t-rect id="t-rect-846e.f740d24f4" class="socialService-t-rect-0-3"  :tip="tRectx0x3ComputedData.tip" :label="tRectx0x3ComputedData.label" :active="tRectx0x3ComputedData.active" :c-style="tRectx0x3ComputedData.cStyle">` +
`</t-rect>` +
`<t-rect id="t-rect-da22.700637a9b" class="socialService-t-rect-0-4"  :tip="tRectx0x4ComputedData.tip" :label="tRectx0x4ComputedData.label" :active="tRectx0x4ComputedData.active" :c-style="tRectx0x4ComputedData.cStyle">` +
`</t-rect>` +
`<t-text-common id="t-text-common-47c0.208acbcac" class="socialService-t-text-common-0-5"  :label="tTextCommonx0x5ComputedData.label" :editable="tTextCommonx0x5ComputedData.editable" :c-style="tTextCommonx0x5ComputedData.cStyle">` +
`</t-text-common>` +
`<t-text-common id="t-text-common-1f63.74b801a97" class="socialService-t-text-common-0-6"  :label="tTextCommonx0x6ComputedData.label" :editable="tTextCommonx0x6ComputedData.editable" :c-style="tTextCommonx0x6ComputedData.cStyle">` +
`</t-text-common>` +
`<t-rect id="t-rect-19da.09eb46458" class="socialService-t-rect-0-7"  :tip="tRectx0x7ComputedData.tip" :label="tRectx0x7ComputedData.label" :active="tRectx0x7ComputedData.active" :c-style="tRectx0x7ComputedData.cStyle">` +
`</t-rect>` +
`<t-component id="t-component-5039.1bb8498e6" class="socialService-t-component-0-8"  :name="tComponentx0x8ComputedData.name" :loading="tComponentx0x8ComputedData.loading" :c-style="tComponentx0x8ComputedData.cStyle" :src="tComponentx0x8ComputedData.src" :component-name="tComponentx0x8ComputedData.componentName" :page-id="tComponentx0x8ComputedData.pageId" :page-code="tComponentx0x8ComputedData.pageCode">` +
`</t-component>` +
`<t-component id="t-component-4a64.d17087fd5" class="socialService-t-component-0-9"  :name="tComponentx0x9ComputedData.name" :loading="tComponentx0x9ComputedData.loading" :c-style="tComponentx0x9ComputedData.cStyle" :src="tComponentx0x9ComputedData.src" :component-name="tComponentx0x9ComputedData.componentName" :page-id="tComponentx0x9ComputedData.pageId" :page-code="tComponentx0x9ComputedData.pageCode">` +
`</t-component>` +
`</div>` +
'',
setup() {
...
tRectx0x0: {
defaultStyle: {
            default: {"width":"590px","height":"390px","left":"0px","top":"52px","borderLeft":"1px none rgb(23,62,228)","borderTop":"1px none rgb(23,62,228)","borderRight":"1px none rgb(23,62,228)","borderBottom":"1px none rgb(23,62,228)","backgroundImage":"var(--jsc-left-bgc)","-webkit-mask-image":"","backgroundRepeat":"repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"0% 100%","-webkit-mask-position":""},
...
label:"",
active:false,
cStyle:{"wrapper":{"default":{"width":"590px","height":"390px","left":"0px","top":"52px","borderLeft":"1px none rgb(23,62,228)","borderTop":"1px none rgb(23,62,228)","borderRight":"1px none rgb(23,62,228)","borderBottom":"1px none rgb(23,62,228)","backgroundImage":"var(--jsc-left-bgc)","-webkit-mask-image":"","backgroundRepeat":"repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"0% 100%","-webkit-mask-position":""}}}, 
 },
},
tRectx0x1: {
defaultStyle: {
...
tTextCommonx0x6: {
defaultStyle: {
            default: {"width":"120px","height":"20px","color":"rgba(255, 255, 255, 0.7)","fontSize":"14px","textAlign":"right","position":"unset","left":"447px","top":"28px"},
...
label:"截至2025-09",
editable:false,
cStyle:{"wrapper":{"default":{"width":"120px","height":"20px","color":"rgba(255, 255, 255, 0.7)","fontSize":"14px","textAlign":"right","position":"unset","left":"447px","top":"28px"}}}, 
 },
},
tRectx0x7: {
defaultStyle: {
...
tComponentx0x8: {
defaultStyle: {
            default: {"width":"557px","height":"206px","margin":"0 auto","position":"unset","left":"16px","top":"67px","backgroundColor":"rgba(23, 62, 228, 0)"},
            
            },
 default: { 
 
name:"businessEnvironmentComponent",
loading:true,
cStyle:{"wrapper":{"default":{"width":"557px","height":"206px","margin":"0 auto","position":"unset","left":"16px","top":"67px","backgroundColor":"rgba(23, 62, 228, 0)"}}},
src:"/lego-generated-apps/lego_file/app/src/f70da7e9289c4ab6841c6d9e318837e1/index.html#/[object Object]",
componentName:"businessEnvironmentComponent",
pageId:"2c28facefbad4e11a2cd94354e657692",
pageCode:"businessEnvironment", 
 },
},
tComponentx0x9: {
defaultStyle: {
            default: {"width":"557px","height":"128px","margin":"0 auto","position":"unset","left":"16px","top":"289px","backgroundColor":"rgba(23, 62, 228, 0)"},
            
            },
 default: { 
 
name:"publicServiceComponent",
loading:true,
cStyle:{"wrapper":{"default":{"width":"557px","height":"128px","margin":"0 auto","position":"unset","left":"16px","top":"289px","backgroundColor":"rgba(23, 62, 228, 0)"}}},
src:"/lego-generated-apps/lego_file/app/src/f70da7e9289c4ab6841c6d9e318837e1/index.html#/[object Object]",
componentName:"publicServiceComponent",
pageId:"fab2e08db88b43d3b1746b09ab6364c9",
pageCode:"publicService", 
 },
},
});
 function handleWindowResize() {
                            setPageScale('t-l-c-socialService', global.appScaleMode, 'normal');

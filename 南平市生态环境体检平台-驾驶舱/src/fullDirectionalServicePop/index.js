window.fullDirectionalServicePopComponent = {
template: 
`<div id="t-l-c-fullDirectionalServicePop" class="t-l-c-fullDirectionalServicePop" >` +
`<t-rect id="t-rect-3c13.6e224e776" class="fullDirectionalServicePop-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle">` +
`</t-rect>` +
`<t-rect id="t-rect-1410.863eda6a7" class="fullDirectionalServicePop-t-rect-0-1"  :tip="tRectx0x1ComputedData.tip" :label="tRectx0x1ComputedData.label" :active="tRectx0x1ComputedData.active" :c-style="tRectx0x1ComputedData.cStyle">` +
`</t-rect>` +
`<t-rect id="t-rect-79b1.520eb885e" class="fullDirectionalServicePop-t-rect-0-2"  :tip="tRectx0x2ComputedData.tip" :label="tRectx0x2ComputedData.label" :active="tRectx0x2ComputedData.active" :c-style="tRectx0x2ComputedData.cStyle">` +
`</t-rect>` +
`<t-rect id="t-rect-39ea.51f8eb66d" class="fullDirectionalServicePop-t-rect-0-3"  :tip="tRectx0x3ComputedData.tip" :label="tRectx0x3ComputedData.label" :active="tRectx0x3ComputedData.active" :c-style="tRectx0x3ComputedData.cStyle" @mouseout="onmouseout1739345365135" @click="onclick1740017904182">` +
`</t-rect>` +
`<t-rect id="t-rect-5094.9a9212dbc" class="fullDirectionalServicePop-t-rect-0-4"  :tip="tRectx0x4ComputedData.tip" :label="tRectx0x4ComputedData.label" :active="tRectx0x4ComputedData.active" :c-style="tRectx0x4ComputedData.cStyle" @mouseover="onmouseover1739345261051">` +
`</t-rect>` +
`<t-table id="t-table-dfde.5586f34ad" class="fullDirectionalServicePop-t-table-0-5"  :height="tTablex0x5ComputedData.height" :stripe="tTablex0x5ComputedData.stripe" :border="tTablex0x5ComputedData.border" :auto-scroll="tTablex0x5ComputedData.autoScroll" :speed="tTablex0x5ComputedData.speed" :columns="tTablex0x5ComputedData.columns" :data="replaceCssVariables(state.tableData, global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x5ComputedData.defaultSort" :c-style="tTablex0x5ComputedData.cStyle" :highlight-current-row="tTablex0x5ComputedData.highlightCurrentRow">` +
`</t-table>` +
`<t-text id="t-text-0849.df06c90a6" class="fullDirectionalServicePop-t-text-0-6"  :label="tTextx0x6ComputedData.label" :editable="tTextx0x6ComputedData.editable" :c-style="tTextx0x6ComputedData.cStyle">` +
`</t-text>` +
`<t-chart-design v-if="state.isChar === true" id="t-chart-design-3dfc.8ee8cdae9" class="fullDirectionalServicePop-t-chart-design-0-7"  :empty-img="tChartDesignx0x7ComputedData.emptyImg" :c-style="tChartDesignx0x7ComputedData.cStyle" :options="replaceCssVariables(state.charOption, global?.theme || global?.activeTheme || '默认主题')">` +
`</t-chart-design>` +
`<t-text id="t-text-e9ad.e5093ff31" class="fullDirectionalServicePop-t-text-0-8"  :label="tTextx0x8ComputedData.label" :editable="tTextx0x8ComputedData.editable" :c-style="tTextx0x8ComputedData.cStyle">` +
`</t-text>` +
`<t-date-picker id="t-date-picker-d0f9.84df9004" class="fullDirectionalServicePop-t-date-picker-0-9"  :placeholder="tDatePickerx0x9ComputedData.placeholder" :start-placeholder="tDatePickerx0x9ComputedData.startPlaceholder" :end-placeholder="tDatePickerx0x9ComputedData.endPlaceholder" :type="tDatePickerx0x9ComputedData.type" :clearable="tDatePickerx0x9ComputedData.clearable" :range-separator="tDatePickerx0x9ComputedData.rangeSeparator" :default-date="replaceCssVariables(state.timeSelect, global?.theme || global?.activeTheme || '默认主题')" :separator="tDatePickerx0x9ComputedData.separator" :c-style="tDatePickerx0x9ComputedData.cStyle" :is-disabled-front="tDatePickerx0x9ComputedData.isDisabledFront" @date-change="ondateChange1740044074557">` +
`</t-date-picker>` +
`<t-select id="t-select-2875.027e56ed" class="fullDirectionalServicePop-t-select-0-10"  :active-value="replaceCssVariables(state.DEPT_CODE, global?.theme || global?.activeTheme || '默认主题')" :options="replaceCssVariables(state.sectionData, global?.theme || global?.activeTheme || '默认主题')" :alias="tSelectx0x10ComputedData.alias" :multiple="tSelectx0x10ComputedData.multiple" :placeholder="tSelectx0x10ComputedData.placeholder" :clearable="tSelectx0x10ComputedData.clearable" :disabled="tSelectx0x10ComputedData.disabled" :name="tSelectx0x10ComputedData.name" :autocomplete="tSelectx0x10ComputedData.autocomplete" :filterable="tSelectx0x10ComputedData.filterable" :no-match-text="tSelectx0x10ComputedData.no-match-text" :no-data-text="tSelectx0x10ComputedData.no-data-text" :c-style="tSelectx0x10ComputedData.cStyle" @change="onchange1741843796575">` +
`</t-select>` +
`<t-text id="t-text-ab59.e88cd1abe" class="fullDirectionalServicePop-t-text-0-11"  :label="tTextx0x11ComputedData.label" :editable="tTextx0x11ComputedData.editable" :c-style="tTextx0x11ComputedData.cStyle">` +
`</t-text>` +
`<t-pagination-base id="t-pagination-base-04fb.abb1d23f3" class="fullDirectionalServicePop-t-pagination-base-0-12"  :total="replaceCssVariables(state.pageInfo.total, global?.theme || global?.activeTheme || '默认主题')" :small="tPaginationBasex0x12ComputedData.small" :page-size="replaceCssVariables(state.pageInfo.pageSize, global?.theme || global?.activeTheme || '默认主题')" :pager-count="tPaginationBasex0x12ComputedData.pagerCount" :current-page="replaceCssVariables(state.pageInfo.pageNum, global?.theme || global?.activeTheme || '默认主题')" :layout="tPaginationBasex0x12ComputedData.layout" :page-sizes="tPaginationBasex0x12ComputedData.pageSizes" :disabled="tPaginationBasex0x12ComputedData.disabled" :c-style="tPaginationBasex0x12ComputedData.cStyle" @size-change="onsizeChange1740045016433" @current-change="oncurrentChange1740045041766">` +
`</t-pagination-base>` +
`<t-rect v-if="state.isChar === false" id="t-rect-e5b3.d6eee570c" class="fullDirectionalServicePop-t-rect-0-16"  :tip="tRectx0x16ComputedData.tip" :label="replaceCssVariables(state.isLoading, global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x16ComputedData.active" :c-style="tRectx0x16ComputedData.cStyle">` +
`</t-rect>` +
`</div>` +
'',
setup() {
...
tRectx0x1: {
defaultStyle: {
            default: {"width":"1632px","height":"708px","backgroundColor":"var(--t-zbzs-bg)","borderLeft":"1px solid var(--t-bgc-border-color)","borderTop":"1px solid var(--t-bgc-border-color)","borderRight":"1px solid var(--t-bgc-border-color)","borderBottom":"1px solid var(--t-bgc-border-color)","position":"unset","left":"144px","top":"266px","borderTopLeftRadius":"10px","borderTopRightRadius":"10px","borderBottomLeftRadius":"10px","borderBottomRightRadius":"10px"},
...
tTablex0x5: {
defaultStyle: {
            default: {"width":"1592px","height":"252px","backgroundColor":"rgba(24, 37, 64, 0)","position":"unset","left":"164px","top":"632px","borderBottom":"0px solid rgba(23,62,228,0)","fontWeight":"400","animationName":"","paddingLeft":"0px","borderTop":"1px solid rgba(0,255,246,0.5)"},
...
tChartDesignx0x7: {
defaultStyle: {
            default: {"height":"322px","width":"1592px","left":"164px","top":"285px","position":"unset","borderTopLeftRadius":"0px","borderTopRightRadius":"0px","borderBottomLeftRadius":"0px","borderBottomRightRadius":"0px"},
            
            },
 default: { 
 
emptyImg:"/lego-generated-apps/lego_file/app/src/f70da7e9289c4ab6841c6d9e318837e1/assets/images/emptyImg.png",
cStyle:{"wrapper":{"default":{"height":"322px","width":"1592px","left":"164px","top":"285px","position":"unset","borderTopLeftRadius":"0px","borderTopRightRadius":"0px","borderBottomLeftRadius":"0px","borderBottomRightRadius":"0px"}}},
options:"", 
 },
},
tTextx0x8: {
...
tRectx0x16: {
defaultStyle: {
            default: {"width":"0px","height":"148px","position":"unset","left":"-228px","top":"63px","fontSize":"14px","color":"rgba(255,255,255,0.9)","borderLeft":"1px none var(--t-bgc-border-color)","borderTop":"1px none var(--t-bgc-border-color)","borderRight":"1px none var(--t-bgc-border-color)","borderBottom":"1px none var(--t-bgc-border-color)","animationName":"","borderTopLeftRadius":"10px","borderTopRightRadius":"10px","borderBottomLeftRadius":"10px","borderBottomRightRadius":"10px"},
...
label:"加载中...",
active:false,
cStyle:{"wrapper":{"default":{"width":"0px","height":"148px","position":"unset","left":"-228px","top":"63px","fontSize":"14px","color":"rgba(255,255,255,0.9)","borderLeft":"1px none var(--t-bgc-border-color)","borderTop":"1px none var(--t-bgc-border-color)","borderRight":"1px none var(--t-bgc-border-color)","borderBottom":"1px none var(--t-bgc-border-color)","animationName":"","borderTopLeftRadius":"10px","borderTopRightRadius":"10px","borderBottomLeftRadius":"10px","borderBottomRightRadius":"10px"}},"emptyText":{"default":{"color":"rgba(255,255,255,0.9)","fontSize":"14px"}}}, 
 },
},
});
const setOption = () => {
...
const ondateChange1740044074557 = (data) => {
// 执行自定义方法
setTimeSelect(data);
};
...
const onchange1741843796575 = (value,selectValueArr,selectValueItem) => {
// 设置变量值
...
return new Promise((resolve, reject) => {
  http({"url":global.serviceBasePath,"method":"get","baseURL":global.serviceBaseUrl,"params":{"interfaceId":"05b418ded652d74081a332bb7bd130d4","TREE_CODE":"USE_DEPT"},}).then((res) => {
     // 成功的操作
     if (res?.data?.data) {
  // 定义允许的 DICTIONARY_CODE 列表
  const allowedCodes = ["1", "2", "5", "6"];
  
  // 过滤数据：只保留符合条件的条目
  const filteredData = res.data.data.filter(item => 
    allowedCodes.includes(item.DICTIONARY_CODE)
  );
  state.sectionData = [];
  state.sectionData = filteredData;
  state.sectionData.unshift({
    DICTIONARY_CODE: "1,2,5,6",
    DICTIONARY_NAME: "全部",
    EXT1: "NULL",
    EXT2: "NULL",
    EXT3: "NULL",
...
getCodeData();
 function handleWindowResize() {
                            setPageScale('t-l-c-fullDirectionalServicePop', global.appScaleMode, 'normal');

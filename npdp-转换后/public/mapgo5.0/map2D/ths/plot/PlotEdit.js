//>>built
define("plot/PlotEdit", "dojo/_base/declare dojo/_base/lang dojo/dom dojo/Evented ./constants ./plotUtils esri/geometry/Point esri/geometry/Polyline esri/geometry/Polygon esri/graphic esri/Color esri/symbols/SimpleMarkerSymbol esri/symbols/SimpleLineSymbol".split(" "), function (l, b, p, m, q, r, k, s, t, n, g, d, e) {
    return l([m], {
        constructor: function (a) {
            if (a) {
                var c = new e(e.STYLE_SOLID, new g("#000000"), 1);
                this.controlPointSymbol = new d(d.STYLE_SQUARE, 12, c, new g("#003388"));
                this._map = a;
                this._activeControlPointGraphic =
                    this._controlPointGraphics = this._startPoint = this._graphic = null;
                this._layerMouseOverHandler = b.hitch(this, this._layerMouseOverHandler);
                this._layerMouseOutHandler = b.hitch(this, this._layerMouseOutHandler);
                this._layerMouseDownHandler = b.hitch(this, this._layerMouseDownHandler);
                this._layerMouseDragHandler = b.hitch(this, this._layerMouseDragHandler);
                this._layerMouseDragEndHandler = b.hitch(this, this._layerMouseDragEndHandler);
                this._controlPointLayerMouseDownHandler = b.hitch(this, this._controlPointLayerMouseDownHandler);
                this._controlPointLayerMouseDragHandler = b.hitch(this, this._controlPointLayerMouseDragHandler);
                this._controlPointLayerMouseDragEndHandler = b.hitch(this, this._controlPointLayerMouseDragEndHandler)
            }
        }, activate: function (a) {
            a && (a.plot && a != this._graphic) && (this.deactivate(), this._graphic = a, this._initControlPoints(), this._layerMouseOver_Connect = this._graphic.getLayer().on("mouse-over", this._layerMouseOverHandler), this._layerMouseOut_Connect = this._graphic.getLayer().on("mouse-out", this._layerMouseOutHandler))
        },
        deactivate: function () {
            ...
            this._layerMouseOut_Connect && this._layerMouseOut_Connect.remove();
            ...
            if (this._map) {
                ...
                if (a && !(0 >= a.length)) {
                    for (var c = 0; c < a.length; c++) {
                        var b = new k(a[c][0], a[c][1]);
                        b.spatialReference = this._map.spatialReference;
                        b = new n(b, this.controlPointSymbol);
                        this._controlPointGraphics.push(b);
                        this._map.graphics.add(b)
                    }
            ...
            if (this._controlPointGraphics && 0 < this._controlPointGraphics.length) {
            ...
            this._graphic && this._graphic == a.graphic && (this._map.setMapCursor("move"), this._layerMouseDown_Connect && this._layerMouseDown_Connect.remove(),
        ...
        _layerMouseDragHandler: function (a) {
            if (!this._activeControlPointGraphic) {
                for (var b = a.mapPoint.x - this._startPoint.x, g = a.mapPoint.y - this._startPoint.y, d = [], h = 0; h < this._controlPointGraphics.length; h++) {
                    var f = this._controlPointGraphics[h].geometry, f = [f.x + b, f.y + g];
                    this._startPoint = a.mapPoint;
                    var e = new k(f);
                    e.spatialReference = this._map.spatialReference;
                    this._controlPointGraphics[h].setGeometry(e);
                    d.push(f)
                }
                this._graphic.plot.setPoints(d);
                this._graphic.setGeometry(this._graphic.plot.toGeometry())
            }

...
(b.dj_trident=!0,b["dj_trident"+f(l)]=!0);m&&(b["dj_ff"+f(m)]=!0);b["dj_"+p]=!0;var e="",g;for(g in b)b[g]&&(e+=g+" ");d.className=k.trim(d.className+" "+e);n(function(){if(!h.isBodyLtr()){var q="dj_rtl dijitRtl "+e.replace(/ /g,"-rtl ");d.className=k.trim(d.className+" "+q+"dj_rtl dijitRtl "+e.replace(/ /g,"-rtl "))}});return a});
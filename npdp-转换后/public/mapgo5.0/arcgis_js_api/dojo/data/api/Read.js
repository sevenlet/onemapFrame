...
//>>built
define("dojo/data/api/Read",["../../_base/declare"],function(c){return c("dojo.data.api.Read",null,{getValue:function(a,b,d){throw Error("Unimplemented API: dojo.data.api.Read.getValue");},getValues:function(a,b){throw Error("Unimplemented API: dojo.data.api.Read.getValues");},getAttributes:function(a){throw Error("Unimplemented API: dojo.data.api.Read.getAttributes");},hasAttribute:function(a,b){throw Error("Unimplemented API: dojo.data.api.Read.hasAttribute");},containsValue:function(a,b,d){throw Error("Unimplemented API: dojo.data.api.Read.containsValue");

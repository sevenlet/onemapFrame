...
//>>built
define("esri/dijit/analysis/nls/it/DescribeDataset",{inputLayerLabel:"Scegli il dataset da descrivere",describeDataLabel:"Comprendi i dati creando un (facoltativo)",sampleLayer:"Layer di esempio",extentLayer:"Layer di estensione",noOfFeaturesLabel:"Numero di feature da includere",outputLayerName:"Nome del layer dei risultati",resultName:"Descrivi dati di ${layerName}",itemDescription:"Feature layer generato in seguito all'esecuzione di Descrivi dataset in ${layerName}. ",itemTags:"Risultato dell'analisi, Descrivi dataset, ${layerName}",

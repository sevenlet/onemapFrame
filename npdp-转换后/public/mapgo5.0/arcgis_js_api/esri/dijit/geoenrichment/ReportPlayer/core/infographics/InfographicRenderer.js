...
//>>built
define("esri/dijit/geoenrichment/ReportPlayer/core/infographics/InfographicRenderer",["require","esri/dijit/geoenrichment/Deferred","dojo/dom-construct"],function(e,f,g){var c,d={isAsync:!0,loadModules:function(){var a=new f;e(["./InfographicContainer"],function(b){c=b;d.isAsync=!1;a.resolve()});return a.promise},createInfographicPage:function(a,b){var h=a.node?g.create("div",null,a.node):void 0;b=new (b||c)(a.creationParams,h);"function"===typeof a.placeFunc&&a.placeFunc(b);b.updateInfographic(a.json);
return b}};return d});
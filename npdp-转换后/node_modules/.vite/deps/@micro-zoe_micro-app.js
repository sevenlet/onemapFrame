...
// node_modules/@micro-zoe/micro-app/lib/index.esm.js
var version = "1.0.0-rc.30";
var isBrowser = typeof window !== "undefined";
var globalObj = typeof globalThis !== "undefined" ? globalThis : typeof global !== "undefined" ? global : typeof window !== "undefined" ? window : typeof self !== "undefined" ? self : Function("return this")();
var noopFalse = () => false;
var isArray = Array.isArray;
var assign = Object.assign;
var rawDefineProperty = Object.defineProperty;
var rawDefineProperties = Object.defineProperties;
var rawToString = Object.prototype.toString;
var rawHasOwnProperty = Object.prototype.hasOwnProperty;
var toTypeString = (value) => rawToString.call(value);
...
var requestIdleCallback = globalObj.requestIdleCallback || function(fn) {
...
var formatEventList = ["mounted", "unmount"];
...
var HTMLLoader = class _HTMLLoader {
  static getInstance() {
    if (!this.instance) {
      this.instance = new _HTMLLoader();
    }
...
var GLOBAL_CACHED_KEY = "window,self,globalThis,document,Document,Array,Object,String,Boolean,Math,Number,Symbol,Date,Function,Proxy,WeakMap,WeakSet,Set,Map,Reflect,Element,Node,RegExp,Error,TypeError,JSON,isNaN,parseFloat,parseInt,performance,console,decodeURI,encodeURI,decodeURIComponent,encodeURIComponent,navigator,undefined,location,history";
var PREFETCH_LEVEL = [1, 2, 3];
var ROUTER_MODE_STATE = "state";
var DEFAULT_ROUTER_MODE = "search";
var ROUTER_MODE_NATIVE = "native";
var ROUTER_MODE_NATIVE_SCOPE = "native-scope";
var ROUTER_MODE_PURE = "pure";
var ROUTER_MODE_LIST = [
  DEFAULT_ROUTER_MODE,
  ROUTER_MODE_STATE,
  ROUTER_MODE_NATIVE,
...
var SCOPE_WINDOW_EVENT_OF_WITH = BASE_SCOPE_WINDOW_EVENT;
var SCOPE_WINDOW_EVENT_OF_IFRAME = BASE_SCOPE_WINDOW_EVENT.concat([
  "unhandledrejection",
  "message"
]);
var BASE_SCOPE_WINDOW_ON_EVENT = [
  "onpopstate",
  "onhashchange",
  "onload",
  "onunload",
...
var SCOPE_WINDOW_ON_EVENT_OF_WITH = BASE_SCOPE_WINDOW_ON_EVENT;
var SCOPE_WINDOW_ON_EVENT_OF_IFRAME = BASE_SCOPE_WINDOW_ON_EVENT.concat([
  "onunhandledrejection"
]);
var SCOPE_DOCUMENT_EVENT = [
  "DOMContentLoaded",
  "readystatechange"
];
var SCOPE_DOCUMENT_ON_EVENT = [
  "onreadystatechange"
];
var GLOBAL_KEY_TO_WINDOW = [
  "window",
  "self",
  "globalThis"
];
var RAW_GLOBAL_TARGET = ["rawWindow", "rawDocument"];
var HIJACK_LOCATION_KEYS = [
  "host",
  "hostname",
  "port",
  "protocol",
...
var scriptTypes = ["text/javascript", "text/ecmascript", "application/javascript", "application/ecmascript", "module", "systemjs-module", "systemjs-importmap"];
...
var EventCenterForGlobal = class {
  /**
...
var EventCenterForBaseApp = class extends EventCenterForGlobal {
  /**
   * add listener
...
var EventCenterForMicroApp = class extends EventCenterForGlobal {
  constructor(appName) {
    super();
...
var AppManager = class _AppManager {
  constructor() {
    this.appInstanceMap = appInstanceMap;
  }
  static getInstance() {
    if (!this.instance) {
      this.instance = new _AppManager();
    }
    return this.instance;
  }
  get(appName) {
...
function updateElementInfo(node2, appName) {
  var _a, _b;
  if (appName && isNode(node2) && node2.__MICRO_APP_NAME__ !== appName && !node2.__PURE_ELEMENT__ && !getPreventSetState()) {
    const props = {
      __MICRO_APP_NAME__: {
        configurable: true,
        enumerable: true,
    ...
    if (isAnchorElement(node2)) {
      const microApp2 = AppManager.getInstance().get(appName);
      if (microApp2) {
        props.href = {
          get() {
    ...
    rawDefineProperties(node2, props);
      ...
      if (proxyWindow) {
        rawDefineProperties(node2, {
          ...
          ownerDocument: {
            configurable: true,
            enumerable: true,
            get: () => node2 !== proxyWindow.document ? proxyWindow.document : null
          },
...
function patchWindowEffect(microAppWindow, appName) {
  ...
  microAppWindow.setTimeout = function(handler, timeout, ...args) {
    const setTimeoutHander = function(...args2) {
      timeoutIdMap.delete(timeoutId);
      typeof handler === "function" && handler(...args2);
    };
...
function reWriteHistoryMethod(method) {
  ...
  return function(...rests) {
    var _a;
    if (((_a = rawWindow.history.state) === null || _a === void 0 ? void 0 : _a.__MICRO_APP_STATE__) && (!isPlainObject(rests[0]) || !rests[0].__MICRO_APP_STATE__) && (isString(rests[2]) || isURL(rests[2]))) {
...
var { router, executeNavigationGuard, clearRouterWhenUnmount } = createRouterApi();
var locationKeys = ["href", "pathname", "search", "hash", "host", "hostname", "port", "protocol", "search"];
var guardLocationKeys = [...locationKeys, "origin", "fullPath"];
...
var { createMicroEventSource, clearMicroEventSource } = useMicroEventSource();
var WithSandBox = class _WithSandBox extends BaseSandbox {
  constructor(appName, url) {
    super(appName, url);
    this.active = false;
...
var UN_PROXY_INSTANCEOF_KEYS = [
  "Array"
];
var escape2RawWindowKeys = [
  "getComputedStyle",
...
var escape2RawWindowRegExpKeys = [
  /animationFrame$/i,
  /mutationObserver$/i,
  /height$|width$/i,
  /offset$/i,
...
var uniqueDocumentElement = [
  "body",
  "head",
  "html",
  "title"
];
var proxy2RawDocOrShadowKeys = [
  "childElementCount",
  "children",
  "firstElementChild",
  "firstChild",
...
var proxy2RawDocOrShadowMethods = [
  "append",
  "contains",
  "replaceChildren",
  "createRange",
...
function isSameOrigin(url) {
  try {
    ...
    return parsedUrl.protocol === window.location.protocol && parsedUrl.hostname === window.location.hostname && parsedUrl.port === window.location.port;
  } catch (error) {
    return false;
  }
}
...
var WorkerProxy = new Proxy(originalWorker, {
...
function patchWindowProperty$1(appName, microAppWindow, sandbox) {
  ...
  Object.getOwnPropertyNames(microAppWindow).filter((key) => {
    ...
    if (isConstructor(microAppWindow[key]) && key in rawWindow && !UN_PROXY_INSTANCEOF_KEYS.includes(key) && !((_a = microApp.options.excludeRewriteIframeConstructor) === null || _a === void 0 ? void 0 : _a.includes(key))) {
...
function patchIframeNode(appName, microAppWindow, sandbox) {
  ...
  microRootNode.prototype.appendChild = function appendChild(node2) {
    updateElementInfo(node2, appName);
    if (isPureNode(node2)) {
      return rawMicroAppendChild.call(this, node2);
    }
    return rawRootNode.prototype.appendChild.call(getRawTarget(this), node2);
  };
  microRootNode.prototype.insertBefore = function insertBefore(node2, child) {
    updateElementInfo(node2, appName);
    if (isPureNode(node2)) {
      return rawMicroInsertBefore.call(this, node2, child);
    }
    return rawRootNode.prototype.insertBefore.call(getRawTarget(this), node2, child);
  };
  microRootNode.prototype.replaceChild = function replaceChild(node2, child) {
    updateElementInfo(node2, appName);
    if (isPureNode(node2)) {
      return rawMicroReplaceChild.call(this, node2, child);
    }
    return rawRootNode.prototype.replaceChild.call(getRawTarget(this), node2, child);
  };
...
function patchIframeAttribute(url, microAppWindow, appName) {
  ...
  microRootElement.prototype.setAttribute = function setAttribute(key, value) {
    ...
    if (/^micro-app(-\S+)?/i.test(this.tagName) && key === "data" && this.setAttribute !== microRootElement.prototype.setAttribute) {
      ...
      } else if ((key === "src" || key === "srcset") && /^(img|script|video|audio|source|embed)$/i.test(this.tagName) || key === "href" && /^(link|image)$/i.test(this.tagName) || // If it is the anchor tag,eg. <a href="#xxx"/>, the path will not be completed
...
var IframeSandbox = class _IframeSandbox {
  ...
  start({ baseroute, defaultPage, disablePatchRequest }) {
    ...
    if (++_IframeSandbox.activeCount === 1) ;
  }
  stop({ umdMode, keepRouteState, destroy, clearData }) {
    var _a;
    if (!this.active)
    ...
    if (--_IframeSandbox.activeCount === 0) ;
    this.active = false;
  }
  /**
...
var appInstanceMap = /* @__PURE__ */ new Map();
var CreateApp = class {
  ...
  cloneContainer(target, origin, deep) {
    if (origin && target) {
      target.innerHTML = "";
      Array.from(deep ? this.parseHtmlString(origin.innerHTML).childNodes : origin.childNodes).forEach((node2) => {
...
var dynamicElementInMicroAppMap = /* @__PURE__ */ new WeakMap();
function getMappingNode(node2) {
  var _a;
  return (_a = dynamicElementInMicroAppMap.get(node2)) !== null && _a !== void 0 ? _a : node2;
}
...
function invokePrototypeMethod(app, rawMethod, parent, targetNode, passiveNode) {
  ...
  if (hijackParent) {
    ...
    if (isIFrameElement(targetNode) && rawMethod === globalEnv.rawAppendChild) {
...
function completePathDynamic(app, newChild) {
  ...
  if (isElement(newChild)) {
    ...
    } else if (/^(link|image)$/i.test(newChild.tagName) && newChild.hasAttribute("href") || // If it is the anchor tag,eg. <a href="#xxx"/>, the path will not be completed
...
function patchElementAndDocument() {
  ...
  rawDocumentFragment.prototype.append = rawRootElement.prototype.append = function append(...nodes) {
    ...
    while (i < nodes.length) {
      let node2 = nodes[i];
      node2 = isNode(node2) ? node2 : globalEnv.rawCreateTextNode.call(globalEnv.rawDocument, node2);
      commonElementHandler(this, markElement(node2), null, isDocumentFragment(this) ? globalEnv.rawFragmentAppend : globalEnv.rawAppend);
      i++;
    }
  };
  rawDocumentFragment.prototype.prepend = rawRootElement.prototype.prepend = function prepend(...nodes) {
    ...
    while (i > 0) {
      let node2 = nodes[i - 1];
      node2 = isNode(node2) ? node2 : globalEnv.rawCreateTextNode.call(globalEnv.rawDocument, node2);
      commonElementHandler(this, markElement(node2), null, target);
      i--;
    }
  };
  ...
  rawRootElement.prototype.setAttribute = function setAttribute(key, value) {
    ...
    if (/^micro-app(-\S+)?/i.test(this.tagName) && key === "data" && this.setAttribute !== rawRootElement.prototype.setAttribute) {
      ...
      if (appName && appInstanceMap.has(appName) && ((key === "src" || key === "srcset") && /^(img|script|video|audio|source|embed)$/i.test(this.tagName) || key === "href" && /^(link|image)$/i.test(this.tagName) || // If it is the anchor tag,eg. <a href="#xxx"/>, the path will not be completed
      key === "href" && /^(a)$/i.test(this.tagName) && !/^#/.test(value))) {
        const app = appInstanceMap.get(appName);
        const aHrefResolver = (_a = microApp === null || microApp === void 0 ? void 0 : microApp.options) === null || _a === void 0 ? void 0 : _a.aHrefResolver;
        if (key === "href" && /^a$/i.test(this.tagName) && typeof aHrefResolver === "function") {
  ...
  rawDefineProperty(rawRootElement.prototype, "innerHTML", {
    ...
    set(code) {
      ...
      const currentAppName2 = this.__MICRO_APP_NAME__ || getIframeCurrentAppName() || getCurrentAppName();
      Array.from(this.children).forEach((child) => {
...
function patchDocument$2() {
  ...
  function querySelector(selectors) {
    ...
    const _this = getBindTarget(this);
    const currentAppName2 = getCurrentAppName();
    if (!currentAppName2 || !selectors || isUniqueElement(selectors) || // ISSUE: https://github.com/jd-opensource/micro-app/issues/56
    rawDocument !== _this) {
    ...
    handleConnected() {
      ...
      if (appInstanceMap.has(this.appName)) {
        ...
        if (oldApp.isHidden() && oldApp.url === this.appUrl) {
          ...
          if (this.sameCoreOptions(oldApp)) {
...
var MicroApp = class extends EventCenterForBaseApp {
  constructor() {
    super(...arguments);
...
var index_esm_default = microApp;
export {
...
//# sourceMappingURL=@micro-zoe_micro-app.js.map

<template>
  <div id="t-l-c-publicFontSizeSettingPopup" class="t-l-c-publicFontSizeSettingPopup" ><t-rect id="t-rect-ca9e.9255f78f2" class="publicFontSizeSettingPopup-t-rect-0-0"  :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle" :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label"></t-rect><t-rect id="t-rect-81c9.5c50e687" class="publicFontSizeSettingPopup-t-rect-0-1"  :active="tRectx0x1ComputedData.active" :c-style="tRectx0x1ComputedData.cStyle" :tip="tRectx0x1ComputedData.tip" :label="tRectx0x1ComputedData.label"></t-rect><t-rect id="t-rect-ca8b.82a3c1294" class="publicFontSizeSettingPopup-t-rect-0-2"  :active="tRectx0x2ComputedData.active" :c-style="tRectx0x2ComputedData.cStyle" :tip="tRectx0x2ComputedData.tip" :label="tRectx0x2ComputedData.label"></t-rect><t-rect id="t-rect-69d5.f750da9bb" class="publicFontSizeSettingPopup-t-rect-0-3"  :active="tRectx0x3ComputedData.active" :c-style="tRectx0x3ComputedData.cStyle" :tip="tRectx0x3ComputedData.tip" :label="tRectx0x3ComputedData.label"></t-rect><t-slider id="t-slider-61b9.75a689f81" class="publicFontSizeSettingPopup-t-slider-0-4"  :data="replaceCssVariables(filterData(state.sliderData, componentPropBindingMap?.['t-slider-61b9.75a689f81']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :max="tSliderx0x4ComputedData.max" :show-tooltip="tSliderx0x4ComputedData.showTooltip" :range="tSliderx0x4ComputedData.range" :data-alias="tSliderx0x4ComputedData.dataAlias" :vertical="tSliderx0x4ComputedData.vertical" :marks="tSliderx0x4ComputedData.marks" :show-input-controls="tSliderx0x4ComputedData.showInputControls" :show-stops="tSliderx0x4ComputedData.showStops" :min="tSliderx0x4ComputedData.min" :show-input="tSliderx0x4ComputedData.showInput" :c-style="tSliderx0x4ComputedData.cStyle" :step="tSliderx0x4ComputedData.step" @change="onchange1753075566109"></t-slider><t-tabs-base id="t-tabs-base-6cf8.0a8d5a729" class="publicFontSizeSettingPopup-t-tabs-base-0-5"  :inner-shadow-color="tTabsBasex0x5ComputedData.innerShadowColor" :data="tTabsBasex0x5ComputedData.data" :alias="tTabsBasex0x5ComputedData.alias" :c-style="tTabsBasex0x5ComputedData.cStyle" :selected-tab-val="replaceCssVariables(filterData(state.tabSelect, componentPropBindingMap?.['t-tabs-base-6cf8.0a8d5a729']['selectedTabVal'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active-inner-shadow-color="tTabsBasex0x5ComputedData.activeInnerShadowColor" :space="tTabsBasex0x5ComputedData.space" @tab-click="ontabClick1753068261635"></t-tabs-base><t-slider id="t-slider-da58.5f8deaffe" class="publicFontSizeSettingPopup-t-slider-0-6"  :marks="tSliderx0x6ComputedData.marks" :data="replaceCssVariables(filterData(state.sliderData, componentPropBindingMap?.['t-slider-da58.5f8deaffe']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :data-alias="tSliderx0x6ComputedData.dataAlias" :show-input="tSliderx0x6ComputedData.showInput" :show-input-controls="tSliderx0x6ComputedData.showInputControls" :c-style="tSliderx0x6ComputedData.cStyle" :min="tSliderx0x6ComputedData.min" :max="tSliderx0x6ComputedData.max" @change="onchange1776404775175"></t-slider></div>
</template>
...
import { TRect, TSlider, TTabsBase } from '@ths/design';
...
<style scoped>
.t-l-c-publicFontSizeSettingPopup {
position: relative;
overflow: hidden;
...
.t-l-c-publicFontSizeSettingPopup .publicFontSizeSettingPopup-t-rect-0-0 {
...
.t-l-c-publicFontSizeSettingPopup .publicFontSizeSettingPopup-t-rect-0-1 {
position: absolute !important;
top: 10px;
left: 150px;
width: 32px;
...
.t-l-c-publicFontSizeSettingPopup .publicFontSizeSettingPopup-t-rect-0-2 {
position: absolute !important;
top: 10px;
left: 12px;
width: 32px;
...
.t-l-c-publicFontSizeSettingPopup .publicFontSizeSettingPopup-t-rect-0-3 {
position: absolute !important;
top: 10px;
left: 46px;
width: 102px;
...
.t-l-c-publicFontSizeSettingPopup .publicFontSizeSettingPopup-t-slider-0-4 {
position: absolute !important;
top: 144px;
left: 86px;
width: 82px;
...
.t-l-c-publicFontSizeSettingPopup .publicFontSizeSettingPopup-t-tabs-base-0-5 {
position: absolute !important;
top: 51px;
left: 12px;
width: 170px;
...
.t-l-c-publicFontSizeSettingPopup .publicFontSizeSettingPopup-t-slider-0-6 {
position: absolute !important;
top: 11px;
left: 57px;
width: 82px;

<template>
  <div id="t-l-c-probleInsepctEntry" class="t-l-c-probleInsepctEntry" ><t-component id="t-component-5c87.a35bbde46" class="probleInsepctEntry-t-component-0-1"  :name="tComponentx0x1ComputedData.name" :loading="tComponentx0x1ComputedData.loading" :c-style="tComponentx0x1ComputedData.cStyle" :src="tComponentx0x1ComputedData.src" :component-name="tComponentx0x1ComputedData.componentName" :page-id="tComponentx0x1ComputedData.pageId" :page-code="tComponentx0x1ComputedData.pageCode"></t-component><t-text-unit id="t-text-unit-9dee.e75bc54ed" class="probleInsepctEntry-t-text-unit-0-2"  :c-style="tTextUnitx0x2ComputedData.cStyle" :content="tTextUnitx0x2ComputedData.content" :unit="tTextUnitx0x2ComputedData.unit" :show-overflow-tooltip="tTextUnitx0x2ComputedData.showOverflowTooltip"></t-text-unit><t-component id="t-component-13ad.4ef5b3948" class="probleInsepctEntry-t-component-0-3"  :name="tComponentx0x3ComputedData.name" :loading="tComponentx0x3ComputedData.loading" :c-style="tComponentx0x3ComputedData.cStyle" :src="tComponentx0x3ComputedData.src" :component-name="tComponentx0x3ComputedData.componentName" :page-id="tComponentx0x3ComputedData.pageId" :page-code="tComponentx0x3ComputedData.pageCode"></t-component></div>
</template>
...
.t-l-c-probleInsepctEntry .probleInsepctEntry-t-component-0-1 {
...
.t-l-c-probleInsepctEntry .probleInsepctEntry-t-text-unit-0-2 {
position: absolute !important;
top: 28px;
left: 59px;
width: 282px;
...
.t-l-c-probleInsepctEntry .probleInsepctEntry-t-component-0-3 {
position: absolute !important;
top: 73px;
left: 26px;
width: 403px;

<template>
  <div id="t-l-c-waterMonitoringHour" class="t-l-c-waterMonitoringHour" ><t-rect id="t-rect-c3e9.9ff688864" class="waterMonitoringHour-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle"></t-rect><t-select id="t-select-ff56.0fa7cf9bb" class="waterMonitoringHour-t-select-0-1"  :active-value="replaceCssVariables(filterData(state.dataSource, componentPropBindingMap?.['t-select-ff56.0fa7cf9bb']['activeValue'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :options="replaceCssVariables(filterData(state.dataSourceOptions, componentPropBindingMap?.['t-select-ff56.0fa7cf9bb']['options'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :alias="tSelectx0x1ComputedData.alias" :multiple="tSelectx0x1ComputedData.multiple" :placeholder="tSelectx0x1ComputedData.placeholder" :clearable="tSelectx0x1ComputedData.clearable" :disabled="tSelectx0x1ComputedData.disabled" :name="tSelectx0x1ComputedData.name" :autocomplete="tSelectx0x1ComputedData.autocomplete" :filterable="tSelectx0x1ComputedData.filterable" :no-match-text="tSelectx0x1ComputedData.no-match-text" :no-data-text="tSelectx0x1ComputedData.no-data-text" :c-style="tSelectx0x1ComputedData.cStyle" @change="onchange1733289402709"></t-select><t-select id="t-select-090e.3e2500624" class="waterMonitoringHour-t-select-0-2"  :active-value="replaceCssVariables(filterData(state.controlType, componentPropBindingMap?.['t-select-090e.3e2500624']['activeValue'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :options="tSelectx0x2ComputedData.options" :alias="tSelectx0x2ComputedData.alias" :multiple="tSelectx0x2ComputedData.multiple" :placeholder="tSelectx0x2ComputedData.placeholder" :clearable="tSelectx0x2ComputedData.clearable" :disabled="tSelectx0x2ComputedData.disabled" :name="tSelectx0x2ComputedData.name" :autocomplete="tSelectx0x2ComputedData.autocomplete" :filterable="tSelectx0x2ComputedData.filterable" :no-match-text="tSelectx0x2ComputedData.no-match-text" :no-data-text="tSelectx0x2ComputedData.no-data-text" :c-style="tSelectx0x2ComputedData.cStyle" @change="onchange1733289376621"></t-select><t-date-picker id="t-date-picker-e2a6.4a290e42c" class="waterMonitoringHour-t-date-picker-0-3"  :placeholder="tDatePickerx0x3ComputedData.placeholder" :start-placeholder="tDatePickerx0x3ComputedData.startPlaceholder" :end-placeholder="tDatePickerx0x3ComputedData.endPlaceholder" :type="tDatePickerx0x3ComputedData.type" :clearable="tDatePickerx0x3ComputedData.clearable" :range-separator="tDatePickerx0x3ComputedData.rangeSeparator" :default-date="replaceCssVariables(filterData(state.curTime, componentPropBindingMap?.['t-date-picker-e2a6.4a290e42c']['default-date'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :separator="tDatePickerx0x3ComputedData.separator" :readonly="tDatePickerx0x3ComputedData.readonly" :editable="tDatePickerx0x3ComputedData.editable" :c-style="tDatePickerx0x3ComputedData.cStyle" @date-change="ondateChange1733283973997"></t-date-picker><t-rect id="t-rect-ff42.84481c77b" class="waterMonitoringHour-t-rect-0-4"  :tip="tRectx0x4ComputedData.tip" :label="tRectx0x4ComputedData.label" :active="tRectx0x4ComputedData.active" :c-style="tRectx0x4ComputedData.cStyle"></t-rect><t-list-card id="t-list-card-3bdd.9dd88f3cc" class="waterMonitoringHour-t-list-card-0-5"  :data="replaceCssVariables(filterData(state.cardList, componentPropBindingMap?.['t-list-card-3bdd.9dd88f3cc']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :spacing-x="tListCardx0x5ComputedData.spacingX" :col="tListCardx0x5ComputedData.col" :direction="tListCardx0x5ComputedData.direction" :exchange-order="tListCardx0x5ComputedData.exchangeOrder" :unit-break="tListCardx0x5ComputedData.unitBreak" :key-field="tListCardx0x5ComputedData.keyField" :active-key-field="tListCardx0x5ComputedData.activeKeyField" :active="tListCardx0x5ComputedData.active" :c-style="tListCardx0x5ComputedData.cStyle"></t-list-card><t-component id="t-component-6eec.5c8f98f46" class="waterMonitoringHour-t-component-0-6"  :name="tComponentx0x6ComputedData.name" :c-style="tComponentx0x6ComputedData.cStyle" :src="tComponentx0x6ComputedData.src" :component-name="tComponentx0x6ComputedData.componentName"></t-component><t-component id="t-component-2500.24824c8ef" class="waterMonitoringHour-t-component-0-7"  :name="tComponentx0x7ComputedData.name" :c-style="tComponentx0x7ComputedData.cStyle" :src="tComponentx0x7ComputedData.src" :component-name="tComponentx0x7ComputedData.componentName"></t-component><t-text id="t-text-abdb.87a2be053" class="waterMonitoringHour-t-text-0-8"  :label="tTextx0x8ComputedData.label" :editable="tTextx0x8ComputedData.editable" :c-style="tTextx0x8ComputedData.cStyle"></t-text><t-text id="t-text-f551.46f79701c" class="waterMonitoringHour-t-text-0-9"  :label="tTextx0x9ComputedData.label" :editable="tTextx0x9ComputedData.editable" :c-style="tTextx0x9ComputedData.cStyle"></t-text><t-rect id="t-rect-4a6d.67fb0b4e8" class="waterMonitoringHour-t-rect-0-11"  :tip="tRectx0x11ComputedData.tip" :label="tRectx0x11ComputedData.label" :active="tRectx0x11ComputedData.active" :c-style="tRectx0x11ComputedData.cStyle"></t-rect><t-rect id="t-rect-2bdc.1280c2c9d" class="waterMonitoringHour-t-rect-0-13"  :tip="tRectx0x13ComputedData.tip" :label="tRectx0x13ComputedData.label" :active="tRectx0x13ComputedData.active" :c-style="tRectx0x13ComputedData.cStyle"></t-rect><t-row id="t-row-1fea.3a2bcc13c" class="waterMonitoringHour-t-row-0-14"  :c-style="tRowx0x14ComputedData.cStyle" :gutter="tRowx0x14ComputedData.gutter" :justify="tRowx0x14ComputedData.justify" :align="tRowx0x14ComputedData.align"><t-text id="t-text-b5ae.f503318f6" class="waterMonitoringHour-t-text-0-14-0"  :label="replaceCssVariables(filterData(state.standardRate, componentPropBindingMap?.['t-text-b5ae.f503318f6']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x14x0ComputedData.editable" :c-style="tTextx0x14x0ComputedData.cStyle"></t-text><t-text id="t-text-3875.432463b2" class="waterMonitoringHour-t-text-0-14-1"  :label="tTextx0x14x1ComputedData.label" :editable="tTextx0x14x1ComputedData.editable" :c-style="tTextx0x14x1ComputedData.cStyle"></t-text></t-row><t-row id="t-row-1095.b73a9c8ff" class="waterMonitoringHour-t-row-0-15"  :c-style="tRowx0x15ComputedData.cStyle" :gutter="tRowx0x15ComputedData.gutter" :justify="tRowx0x15ComputedData.justify" :align="tRowx0x15ComputedData.align"><t-text id="t-text-4599.12daf3e56" class="waterMonitoringHour-t-text-0-15-0"  :label="replaceCssVariables(filterData(state.standardPointCount, componentPropBindingMap?.['t-text-4599.12daf3e56']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x15x0ComputedData.editable" :c-style="tTextx0x15x0ComputedData.cStyle"></t-text><t-text id="t-text-8def.45b1c7958" class="waterMonitoringHour-t-text-0-15-1"  :label="tTextx0x15x1ComputedData.label" :editable="tTextx0x15x1ComputedData.editable" :c-style="tTextx0x15x1ComputedData.cStyle"></t-text><t-text id="t-text-7b6a.3f6638182" class="waterMonitoringHour-t-text-0-15-2"  :label="replaceCssVariables(filterData(state.actualPointCount, componentPropBindingMap?.['t-text-7b6a.3f6638182']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x15x2ComputedData.editable" :c-style="tTextx0x15x2ComputedData.cStyle"></t-text></t-row><t-row id="t-row-9b7b.72d854bbc" class="waterMonitoringHour-t-row-0-16"  :c-style="tRowx0x16ComputedData.cStyle" :gutter="tRowx0x16ComputedData.gutter" :justify="tRowx0x16ComputedData.justify" :align="tRowx0x16ComputedData.align"><t-col id="t-col-1009.52b6cc22" class="waterMonitoringHour-t-col-0-16-0"  :span="tColx0x16x0ComputedData.span" :offset="tColx0x16x0ComputedData.offset" :push="tColx0x16x0ComputedData.push" :pull="tColx0x16x0ComputedData.pull" :c-style="tColx0x16x0ComputedData.cStyle"><t-list-card id="t-list-card-1271.6b6d16ecb" class="waterMonitoringHour-t-list-card-0-16-0-0"  :data="replaceCssVariables(filterData(state.alarmList, componentPropBindingMap?.['t-list-card-1271.6b6d16ecb']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :spacing-x="tListCardx0x16x0x0ComputedData.spacingX" :col="tListCardx0x16x0x0ComputedData.col" :direction="tListCardx0x16x0x0ComputedData.direction" :exchange-order="tListCardx0x16x0x0ComputedData.exchangeOrder" :unit-break="tListCardx0x16x0x0ComputedData.unitBreak" :key-field="tListCardx0x16x0x0ComputedData.keyField" :active-key-field="tListCardx0x16x0x0ComputedData.activeKeyField" :active="tListCardx0x16x0x0ComputedData.active" :c-style="tListCardx0x16x0x0ComputedData.cStyle" @card-click="oncardClick1734077853729"></t-list-card></t-col><t-col id="t-col-9a2c.db9b3e202" class="waterMonitoringHour-t-col-0-16-1"  :span="tColx0x16x1ComputedData.span" :offset="tColx0x16x1ComputedData.offset" :push="tColx0x16x1ComputedData.push" :pull="tColx0x16x1ComputedData.pull" :c-style="tColx0x16x1ComputedData.cStyle"><t-tabs-base id="t-tabs-base-5821.788444e12" class="waterMonitoringHour-t-tabs-base-0-16-1-0"  :data="tTabsBasex0x16x1x0ComputedData.data" :space="tTabsBasex0x16x1x0ComputedData.space" :selected-tab-val="replaceCssVariables(filterData(state.bottomTabsValue, componentPropBindingMap?.['t-tabs-base-5821.788444e12']['selectedTabVal'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :inner-shadow-color="tTabsBasex0x16x1x0ComputedData.innerShadowColor" :active-inner-shadow-color="tTabsBasex0x16x1x0ComputedData.activeInnerShadowColor" :alias="tTabsBasex0x16x1x0ComputedData.alias" :c-style="tTabsBasex0x16x1x0ComputedData.cStyle" @tab-click="ontabClick1773124263268"></t-tabs-base></t-col><t-col id="t-col-a9aa.7102a7e4" class="waterMonitoringHour-t-col-0-16-2"  :span="tColx0x16x2ComputedData.span" :offset="tColx0x16x2ComputedData.offset" :push="tColx0x16x2ComputedData.push" :pull="tColx0x16x2ComputedData.pull" :c-style="tColx0x16x2ComputedData.cStyle"><t-chart-design v-if="state.bottomTabsValue !== 'region'" id="t-chart-design-700a.7bc561ae6" class="waterMonitoringHour-t-chart-design-0-16-2-0"  :empty-img="tChartDesignx0x16x2x0ComputedData.emptyImg" :c-style="tChartDesignx0x16x2x0ComputedData.cStyle" :options="tChartDesignx0x16x2x0ComputedData.options"></t-chart-design><t-chart-design v-if="state.bottomTabsValue === 'region'" id="t-chart-design-a7a7.a3207d966" class="waterMonitoringHour-t-chart-design-0-16-2-1"  :empty-img="tChartDesignx0x16x2x1ComputedData.emptyImg" :c-style="tChartDesignx0x16x2x1ComputedData.cStyle" :options="tChartDesignx0x16x2x1ComputedData.options"></t-chart-design></t-col><t-col id="t-col-92c0.e7f81cd58" class="waterMonitoringHour-t-col-0-16-3"  :span="tColx0x16x3ComputedData.span" :offset="tColx0x16x3ComputedData.offset" :push="tColx0x16x3ComputedData.push" :pull="tColx0x16x3ComputedData.pull" :c-style="tColx0x16x3ComputedData.cStyle"><t-component id="t-component-2580.3221a361d" class="waterMonitoringHour-t-component-0-16-3-0"  :name="tComponentx0x16x3x0ComputedData.name" :c-style="tComponentx0x16x3x0ComputedData.cStyle" :src="tComponentx0x16x3x0ComputedData.src" :component-name="tComponentx0x16x3x0ComputedData.componentName"></t-component><t-text id="t-text-572b.813d06e14" class="waterMonitoringHour-t-text-0-16-3-1"  :label="tTextx0x16x3x1ComputedData.label" :editable="tTextx0x16x3x1ComputedData.editable" :c-style="tTextx0x16x3x1ComputedData.cStyle"></t-text></t-col><t-col id="t-col-3e22.8c3866963" class="waterMonitoringHour-t-col-0-16-4"  :span="tColx0x16x4ComputedData.span" :offset="tColx0x16x4ComputedData.offset" :push="tColx0x16x4ComputedData.push" :pull="tColx0x16x4ComputedData.pull" :c-style="tColx0x16x4ComputedData.cStyle"><t-checkbox id="t-checkbox-6de2.16562f09c" class="waterMonitoringHour-t-checkbox-0-16-4-0"  :data="tCheckboxx0x16x4x0ComputedData.data" :active="tCheckboxx0x16x4x0ComputedData.active" :data-alias="tCheckboxx0x16x4x0ComputedData.dataAlias" :border="tCheckboxx0x16x4x0ComputedData.border" :use-button="tCheckboxx0x16x4x0ComputedData.useButton" :c-style="tCheckboxx0x16x4x0ComputedData.cStyle" @change="onchange1733308713707"></t-checkbox></t-col><t-col id="t-col-e3c7.9c78f5a56" class="waterMonitoringHour-t-col-0-16-5"  :span="tColx0x16x5ComputedData.span" :offset="tColx0x16x5ComputedData.offset" :push="tColx0x16x5ComputedData.push" :pull="tColx0x16x5ComputedData.pull" :c-style="tColx0x16x5ComputedData.cStyle"><t-row id="t-row-a7cf.f2bf080dd" class="waterMonitoringHour-t-row-0-16-5-0"  :c-style="tRowx0x16x5x0ComputedData.cStyle" :gutter="tRowx0x16x5x0ComputedData.gutter" :justify="tRowx0x16x5x0ComputedData.justify" :align="tRowx0x16x5x0ComputedData.align"><t-col id="t-col-6806.eae676549" class="waterMonitoringHour-t-col-0-16-5-0-0"  :span="tColx0x16x5x0x0ComputedData.span" :offset="tColx0x16x5x0x0ComputedData.offset" :push="tColx0x16x5x0x0ComputedData.push" :pull="tColx0x16x5x0x0ComputedData.pull" :c-style="tColx0x16x5x0x0ComputedData.cStyle"><t-search id="t-search-33fe.4dae35bd7" class="waterMonitoringHour-t-search-0-16-5-0-0-0"  :type="tSearchx0x16x5x0x0x0ComputedData.type" :input-value="replaceCssVariables(filterData(state.keywords, componentPropBindingMap?.['t-search-33fe.4dae35bd7']['inputValue'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :maxlength="tSearchx0x16x5x0x0x0ComputedData.maxlength" :minlength="tSearchx0x16x5x0x0x0ComputedData.minlength" :show-word-limit="tSearchx0x16x5x0x0x0ComputedData.showWordLimit" :placeholder="tSearchx0x16x5x0x0x0ComputedData.placeholder" :clearable="tSearchx0x16x5x0x0x0ComputedData.clearable" :show-password="tSearchx0x16x5x0x0x0ComputedData.showPassword" :disabled="tSearchx0x16x5x0x0x0ComputedData.disabled" :prefix-icon="tSearchx0x16x5x0x0x0ComputedData.prefix-icon" :suffix-icon="tSearchx0x16x5x0x0x0ComputedData.suffix-icon" :rows="tSearchx0x16x5x0x0x0ComputedData.rows" :autosize="tSearchx0x16x5x0x0x0ComputedData.autosize" :name="tSearchx0x16x5x0x0x0ComputedData.name" :readonly="tSearchx0x16x5x0x0x0ComputedData.readonly" :step="tSearchx0x16x5x0x0x0ComputedData.step" :autofocus="tSearchx0x16x5x0x0x0ComputedData.autofocus" :form="tSearchx0x16x5x0x0x0ComputedData.form" :label="tSearchx0x16x5x0x0x0ComputedData.label" :tabindex="tSearchx0x16x5x0x0x0ComputedData.tabindex" :validate-event="tSearchx0x16x5x0x0x0ComputedData.validateEvent" :c-style="tSearchx0x16x5x0x0x0ComputedData.cStyle" :has-search-btn="tSearchx0x16x5x0x0x0ComputedData.hasSearchBtn" @input="oninput1733314642471"></t-search></t-col><t-col id="t-col-0a69.721c577e5" class="waterMonitoringHour-t-col-0-16-5-0-1"  :span="tColx0x16x5x0x1ComputedData.span" :offset="tColx0x16x5x0x1ComputedData.offset" :push="tColx0x16x5x0x1ComputedData.push" :pull="tColx0x16x5x0x1ComputedData.pull" :c-style="tColx0x16x5x0x1ComputedData.cStyle"><t-button id="t-button-abd9.dea8b7895" class="waterMonitoringHour-t-button-0-16-5-0-1-0"  :label="tButtonx0x16x5x0x1x0ComputedData.label" :round="tButtonx0x16x5x0x1x0ComputedData.round" :plain="tButtonx0x16x5x0x1x0ComputedData.plain" :disabled="tButtonx0x16x5x0x1x0ComputedData.disabled" :type="tButtonx0x16x5x0x1x0ComputedData.type" :size="tButtonx0x16x5x0x1x0ComputedData.size" :native-type="tButtonx0x16x5x0x1x0ComputedData.native-type" :c-style="tButtonx0x16x5x0x1x0ComputedData.cStyle" @click="onclick1734423379477"></t-button></t-col></t-row></t-col><t-col id="t-col-097a.6b0fbcd9" class="waterMonitoringHour-t-col-0-16-6"  :span="tColx0x16x6ComputedData.span" :offset="tColx0x16x6ComputedData.offset" :push="tColx0x16x6ComputedData.push" :pull="tColx0x16x6ComputedData.pull" :c-style="tColx0x16x6ComputedData.cStyle"><t-table id="t-table-9c69.e1d6ac83c" class="waterMonitoringHour-t-table-0-16-6-0"  :height="tTablex0x16x6x0ComputedData.height" :stripe="tTablex0x16x6x0ComputedData.stripe" :border="tTablex0x16x6x0ComputedData.border" :auto-scroll="tTablex0x16x6x0ComputedData.autoScroll" :speed="tTablex0x16x6x0ComputedData.speed" :columns="tTablex0x16x6x0ComputedData.columns" :data="replaceCssVariables(filterData(state.listData, componentPropBindingMap?.['t-table-9c69.e1d6ac83c']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x16x6x0ComputedData.defaultSort" :c-style="tTablex0x16x6x0ComputedData.cStyle" @cell-click="oncellClick1733906653732"></t-table></t-col></t-row><t-text-common id="t-text-common-49f6.98b29e998" class="waterMonitoringHour-t-text-common-0-17"  :label="tTextCommonx0x17ComputedData.label" :editable="tTextCommonx0x17ComputedData.editable" :c-style="tTextCommonx0x17ComputedData.cStyle"></t-text-common><t-text-common id="t-text-common-97e4.5b0dd828c" class="waterMonitoringHour-t-text-common-0-18"  :label="tTextCommonx0x18ComputedData.label" :editable="tTextCommonx0x18ComputedData.editable" :c-style="tTextCommonx0x18ComputedData.cStyle"></t-text-common></div>
</template>
...
const state = reactive({
   ...
   alarmList: [{"title":"水质超标报警","num":0,"unit":"个","icon":"assets/images/2024-12-04/1cb560e59192482985bba7eeba124949.svg","componentName":"waterCommonWarningDialogComponent","alarmTypeCode":"waterLevelOver"},{"title":"监测异常报警","num":0,"unit":"个","icon":"assets/images/2024-12-04/1cb560e59192482985bba7eeba124949.svg","componentName":"waterCommonWarningDialogComponent","alarmTypeCode":"monitorException"},{"title":"浓度突变报警","num":0,"unit":"个","icon":"assets/images/2024-12-04/1cb560e59192482985bba7eeba124949.svg","componentName":"waterCommonWarningDialogComponent","alarmTypeCode":"polluteValueMutation"},{"title":"持续恶化报警","num":0,"unit":"个","icon":"assets/images/2024-12-04/1cb560e59192482985bba7eeba124949.svg","componentName":"waterCommonWarningDialogComponent","alarmTypeCode":"continueBad"},{"title":"异常值增多报警","num":0,"unit":"个","icon":"assets/images/2024-12-04/1cb560e59192482985bba7eeba124949.svg","componentName":"waterCommonWarningDialogComponent","alarmTypeCode":"exceptionValueIncrease"},{"title":"临界超标报警","num":2,"unit":"个","icon":"assets/images/2024-12-04/1cb560e59192482985bba7eeba124949.svg","componentName":"waterCommonWarningDialogComponent","alarmTypeCode":"criticalover"},{"title":"达标差距预警","num":0,"unit":"个","icon":"assets/images/2024-12-04/1cb560e59192482985bba7eeba124949.svg","componentName":"waterCommonWarningDialogComponent","alarmTypeCode":"standardGap"},{"title":"环比下降报警","num":0,"unit":"个","icon":"assets/images/2024-12-04/1cb560e59192482985bba7eeba124949.svg","componentName":"waterCommonWarningDialogComponent","alarmTypeCode":"waterLevelDecline"}],
   standardRate: "-",
   standardPointCount: "-",
   actualPointCount: "-",
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-rect-0-0 {
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-select-0-1 {
position: absolute !important;
top: 16px;
left: 15px;
width: 97px;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-select-0-2 {
position: absolute !important;
top: 16px;
left: 123px;
width: 97px;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-date-picker-0-3 {
position: absolute !important;
top: 16px;
left: 230px;
width: 204px;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-rect-0-4 {
position: absolute !important;
top: 207px;
left: 25px;
width: 400px;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-list-card-0-5 {
position: absolute !important;
top: 131px;
left: 16px;
width: 418px;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-component-0-6 {
position: absolute !important;
top: 262px;
left: 20px;
width: 410px;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-component-0-7 {
position: absolute !important;
top: 88px;
left: 20px;
width: 410px;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-text-0-8 {
position: absolute !important;
top: 267px;
left: 61px;
width: 130px;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-text-0-9 {
position: absolute !important;
top: 93px;
left: 60px;
width: 130px;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-rect-0-11 {
position: absolute !important;
top: 216px;
left: 25px;
width: 2px;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-rect-0-13 {
position: absolute !important;
top: 220px;
left: 243px;
width: 1px;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-row-0-14 {
position: absolute !important;
top: 218px;
left: 332px;
width: 83px;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-text-0-14-0 {
position: unset;
top: 1058.9020811028963px;
left: 1663.817075450143px;
width: auto;
height: auto;
pointer-events: auto;
}

.t-l-c-waterMonitoringHour .waterMonitoringHour-t-text-0-14-1 {
position: unset;
top: 337px;
left: 338px;
width: 12px;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-row-0-15 {
position: absolute !important;
top: 218px;
left: 140px;
width: 85px;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-text-0-15-0 {
position: unset;
top: 893.0816483277354px;
left: 1190.5928312602796px;
width: auto;
height: auto;
pointer-events: auto;
}

.t-l-c-waterMonitoringHour .waterMonitoringHour-t-text-0-15-1 {
position: unset;
top: 1525.5351927602997px;
left: 1509.1561108292785px;
width: 12px;
height: auto;
pointer-events: auto;
}

.t-l-c-waterMonitoringHour .waterMonitoringHour-t-text-0-15-2 {
position: unset;
top: 885.0816483277354px;
left: 1129.5928312602796px;
width: auto;
height: auto;
pointer-events: auto;
}

.t-l-c-waterMonitoringHour .waterMonitoringHour-t-row-0-16 {
position: absolute !important;
top: 305px;
left: 0px;
width: 100%;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-col-0-16-0 {
position: relative;
top: null;
left: null;
width: 100%;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-list-card-0-16-0-0 {
position: unset;
top: 326px;
left: 20px;
width: 100%;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-col-0-16-1 {
position: relative;
top: null;
left: null;
width: 100%;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-tabs-base-0-16-1-0 {
position: unset;
top: 496px;
left: 19px;
width: auto;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-col-0-16-2 {
position: relative;
top: null;
left: null;
width: 100%;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-chart-design-0-16-2-0 {
position: unset;
top: 536px;
left: 21px;
width: 410px;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-chart-design-0-16-2-1 {
position: unset;
top: 536px;
left: 20px;
width: 410px;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-col-0-16-3 {
position: relative;
top: null;
left: null;
width: 100%;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-component-0-16-3-0 {
position: unset;
top: 671px;
left: 20px;
width: 410px;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-text-0-16-3-1 {
position: unset;
top: 676px;
left: 60px;
width: 130px;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-col-0-16-4 {
position: relative;
top: null;
left: null;
width: 100%;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-checkbox-0-16-4-0 {
position: unset;
top: 710px;
left: 20px;
width: 100%;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-col-0-16-5 {
position: relative;
top: null;
left: null;
width: 100%;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-row-0-16-5-0 {
position: unset;
top: -27px;
left: 865px;
width: 100%;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-col-0-16-5-0-0 {
position: relative;
top: null;
left: null;
width: 100%;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-search-0-16-5-0-0-0 {
position: unset;
top: 752px;
left: 20px;
width: 100%;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-col-0-16-5-0-1 {
position: relative;
top: null;
left: null;
width: 100%;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-button-0-16-5-0-1-0 {
position: unset;
top: 752px;
left: 380px;
width: 50px;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-col-0-16-6 {
position: relative;
top: null;
left: null;
width: 100%;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-table-0-16-6-0 {
position: unset;
top: 791px;
left: 20px;
width: 100%;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-text-common-0-17 {
position: absolute !important;
top: 220px;
left: 31px;
width: 105px;
...
.t-l-c-waterMonitoringHour .waterMonitoringHour-t-text-common-0-18 {
position: absolute !important;
top: 220px;
left: 249px;
width: 76px;

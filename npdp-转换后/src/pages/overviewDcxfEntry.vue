...
const state = reactive({
   screenSize: "",
   componentName: "samplePlotOverviewComponent",
});
// 选中的图表主题
...
name:"overviewDcxfContentComponent",
loading:true,
cStyle:{"wrapper":{"default":{"width":"450px","height":"904px","margin":"0 auto","position":"unset","left":"0px","top":"0px"}}},
src:"/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/index.html#/overviewDcxfContent",
componentName:"overviewDcxfContentComponent",
pageId:"f217ee150eb8403a8b6bd33907e47214",
pageCode:"overviewDcxfContent", 
 },
},
});
const setStyle = () => {
...
if (tabValue !== state.tabSelect) {
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-overviewDcxfEntry', global.appScaleMode, 'normal');
...
handleWindowResize();
/* 接收socket.io消息 */
const onSocketChange1b60a44277874920b02e = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChange1b60a44277874920b02e);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChange1b60a44277874920b02e);
});
/* 接收socket.io消息 */
const onSocketChange4646da49e70c4ea1b824 = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChange4646da49e70c4ea1b824);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChange4646da49e70c4ea1b824);
});
});
// 页面离开时的操作
onUnmounted(() => {
...
.t-l-c-overviewDcxfEntry .overviewDcxfEntry-t-component-0-0 {

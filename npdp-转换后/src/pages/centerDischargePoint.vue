<template>
  <div id="t-l-c-centerDischargePoint" class="t-l-c-centerDischargePoint" ><t-component id="t-component-f129.876fe19dd" class="centerDischargePoint-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :loading="tComponentx0x0ComputedData.loading" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName" :page-id="tComponentx0x0ComputedData.pageId" :page-code="tComponentx0x0ComputedData.pageCode"></t-component></div>
</template>
...
const state = reactive({
   screenSize: "",
   componentName: "centerDischargePointContent",
});
// 选中的图表主题
...
name:"centerDischargePointContentComponent",
loading:true,
cStyle:{"wrapper":{"default":{"width":"450px","height":"904px","margin":"0 auto","position":"unset","left":"0px","top":"0px"}}},
src:"/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/index.html#/centerDischargePointContent",
componentName:"centerDischargePointContentComponent",
pageId:"54f39afc606d4b16a7534c9b8274605b",
pageCode:"centerDischargePointContent", 
 },
},
});
const setStyle = () => {
...
if (tabValue !== state.tabSelect) {
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-centerDischargePoint', global.appScaleMode, 'normal');
...
handleWindowResize();
/* 接收socket.io消息 */
const onSocketChange00738b40503341a394e8 = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChange00738b40503341a394e8);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChange00738b40503341a394e8);
});
/* 接收socket.io消息 */
const onSocketChange0bd9a9f5371648ae993d = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChange0bd9a9f5371648ae993d);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChange0bd9a9f5371648ae993d);
});
/* 接收socket.io消息 */
const onSocketChange97d94eada88b410f8c78 = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChange97d94eada88b410f8c78);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChange97d94eada88b410f8c78);
});
/* 接收socket.io消息 */
const onSocketChange380e4a75b50b443a8d1a = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChange380e4a75b50b443a8d1a);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChange380e4a75b50b443a8d1a);
});
});
// 页面离开时的操作
onUnmounted(() => {
...
.t-l-c-centerDischargePoint .centerDischargePoint-t-component-0-0 {

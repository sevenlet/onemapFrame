<template>
  <div id="t-l-c-leftMenus" class="t-l-c-leftMenus" ><t-rect v-if="state.showMenu === true" id="t-rect-1bda.61271563a" class="leftMenu-t-rect-0-1"  :tip="tRectx0x1ComputedData.tip" :label="tRectx0x1ComputedData.label" :active="tRectx0x1ComputedData.active" :c-style="tRectx0x1ComputedData.cStyle"></t-rect><t-rect v-if="state.showMenu === true" id="t-rect-19e5.e86ec2bef" class="leftMenu-t-rect-0-3"  :tip="tRectx0x3ComputedData.tip" :label="tRectx0x3ComputedData.label" :active="tRectx0x3ComputedData.active" :c-style="tRectx0x3ComputedData.cStyle"></t-rect><t-tabs id="t-tabs-2037.5bf01a865" class="leftMenu-t-tabs-0-4"  :alias="tTabsx0x4ComputedData.alias" :data="replaceCssVariables(filterData(state.typeList, componentPropBindingMap?.['t-tabs-2037.5bf01a865']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active-tab="replaceCssVariables(filterData(state.type, componentPropBindingMap?.['t-tabs-2037.5bf01a865']['activeTab'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :tab-position-extend="tTabsx0x4ComputedData.tabPositionExtend" :stretch="tTabsx0x4ComputedData.stretch" :c-style="tTabsx0x4ComputedData.cStyle" @tab-click="ontabClick1719921924660"></t-tabs><t-rect v-if="state.showMenu === true" id="t-rect-5c2e.c6ce5466f" class="leftMenu-t-rect-0-5"  :tip="tRectx0x5ComputedData.tip" :label="tRectx0x5ComputedData.label" :active="tRectx0x5ComputedData.active" :c-style="tRectx0x5ComputedData.cStyle" @click="onclick1719920562468"></t-rect><t-iframe id="t-iframe-32a6.a99f8be3" class="leftMenu-t-iframe-0-6"  :src="tIframex0x6ComputedData.src" :srcdoc="tIframex0x6ComputedData.srcdoc" :scrolling="tIframex0x6ComputedData.scrolling" :c-style="tIframex0x6ComputedData.cStyle" :socket-url="replaceCssVariables(filterData(global.socketIp, componentPropBindingMap?.['t-iframe-32a6.a99f8be3']['socketUrl'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :room-id="replaceCssVariables(filterData(global.socketRoom, componentPropBindingMap?.['t-iframe-32a6.a99f8be3']['roomId'].filters || []), global?.theme || global?.activeTheme || '默认主题')"></t-iframe><t-iframe id="t-iframe-13b6.211504a4b" class="leftMenu-t-iframe-0-7"  :src="tIframex0x7ComputedData.src" :srcdoc="tIframex0x7ComputedData.srcdoc" :scrolling="tIframex0x7ComputedData.scrolling" :c-style="tIframex0x7ComputedData.cStyle" :socket-url="tIframex0x7ComputedData.socketUrl" :room-id="tIframex0x7ComputedData.roomId"></t-iframe><t-rect v-if="state.showMenu === false" id="t-rect-29c7.78199920c" class="leftMenu-t-rect-0-11"  :tip="tRectx0x11ComputedData.tip" :label="tRectx0x11ComputedData.label" :active="tRectx0x11ComputedData.active" :c-style="tRectx0x11ComputedData.cStyle" @click="onclick1721971936695"></t-rect></div>
</template>
...
import { TIframe, TRect, TTabs } from '@ths/design';
...
export default {
  ...
  setup() {
const componentPropBindingMap = {"body":{"attributeName":"tBodyx0x0"},"t-rect-e530.8d60d525":{"attributeName":"tRectx0x0"},"t-rect-1bda.61271563a":{"attributeName":"tRectx0x1","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-9094.82deb0a9f":{"attributeName":"tRectx0x2"},"t-rect-19e5.e86ec2bef":{"attributeName":"tRectx0x3","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-tabs-2037.5bf01a865":{"attributeName":"tTabsx0x4","alias":{"filters":[]},"data":{"filters":[]},"activeTab":{"filters":[]},"tabPositionExtend":{"filters":[]},"stretch":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-5c2e.c6ce5466f":{"attributeName":"tRectx0x5","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-iframe-32a6.a99f8be3":{"attributeName":"tIframex0x6","src":{"filters":[]},"srcdoc":{"filters":[]},"scrolling":{"filters":[]},"cStyle":{"filters":[]},"socketUrl":{"filters":[]},"roomId":{"filters":[]}},"t-iframe-13b6.211504a4b":{"attributeName":"tIframex0x7","src":{"filters":[]},"srcdoc":{"filters":[]},"scrolling":{"filters":[]},"cStyle":{"filters":[]},"socketUrl":{"filters":[]},"roomId":{"filters":[]}},"t-iframe-eddc.f3e42be8c":{"attributeName":"tIframex0x8"},"t-iframe-9de2.e6c0cc4b4":{"attributeName":"tIframex0x9"},"t-iframe-7451.972bba559":{"attributeName":"tIframex0x10"},"t-rect-29c7.78199920c":{"attributeName":"tRectx0x11","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}}};
// 页面内注入全局变量和事件
...
label:"",
active:false,
cStyle:{"wrapper":{"default":{"width":"222px","height":"43px","position":"unset","left":"0px","top":"1px","backgroundImage":"","-webkit-mask-image":"","backgroundRepeat":"","-webkit-mask-repeat":"","backgroundSize":"","-webkit-mask-size":"","backgroundPosition":"","-webkit-mask-position":"","backgroundColor":"var(--left-menu-head-bg)","borderTopLeftRadius":"16px","borderTopRightRadius":"16px","borderBottomLeftRadius":"0px","borderBottomRightRadius":"0px","borderLeft":"0px none rgb(23,62,228)","borderTop":"0px none rgb(23,62,228)","borderRight":"0px none rgb(23,62,228)","borderBottom":"0px none rgb(23,62,228)"}}}, 
 },
},
tRectx0x3: {
defaultStyle: {
            default: {"width":"222px","height":"533px","top":"0px","left":"0px","backgroundColor":"rgba(6, 18, 8, 0)","borderLeft":"1px none rgb(23,62,228)","borderTop":"1px none rgb(23,62,228)","borderRight":"1px none rgb(23,62,228)","borderBottom":"1px none rgb(23,62,228)","borderTopLeftRadius":"0px","borderTopRightRadius":"0px","borderBottomLeftRadius":"16px","borderBottomRightRadius":"16px","position":"unset","backgroundImage":"var(--left-menu-bg)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"cover","-webkit-mask-size":"","backgroundPosition":"0% 0%","-webkit-mask-position":""},
...
label:"",
active:false,
cStyle:{"wrapper":{"default":{"width":"222px","height":"533px","top":"0px","left":"0px","backgroundColor":"rgba(6, 18, 8, 0)","borderLeft":"1px none rgb(23,62,228)","borderTop":"1px none rgb(23,62,228)","borderRight":"1px none rgb(23,62,228)","borderBottom":"1px none rgb(23,62,228)","borderTopLeftRadius":"0px","borderTopRightRadius":"0px","borderBottomLeftRadius":"16px","borderBottomRightRadius":"16px","position":"unset","backgroundImage":"var(--left-menu-bg)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"cover","-webkit-mask-size":"","backgroundPosition":"0% 0%","-webkit-mask-position":""}}}, 
 },
},
tTabsx0x4: {
defaultStyle: {
            default: {"width":"155px","height":"18px","position":"unset","left":"72px","top":"12px","backgroundColor":"rgba(88, 108, 195, 0)","borderTopLeftRadius":"0px","borderTopRightRadius":"0px","borderBottomLeftRadius":"0px","borderBottomRightRadius":"0px"},
...
tRectx0x11: {
defaultStyle: {
            default: {"width":"25px","height":"25px","position":"unset","left":"2px","top":"10px","borderLeft":"1px none rgb(23,62,228)","borderTop":"1px none rgb(23,62,228)","borderRight":"1px none rgb(23,62,228)","borderBottom":"1px none rgb(23,62,228)","backgroundImage":"url(assets/images/2024-07-26/eccc79ac5454467f9fae314902c11228.png)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","cursor":"pointer","borderTopLeftRadius":"4px","borderTopRightRadius":"4px","borderBottomLeftRadius":"4px","borderBottomRightRadius":"4px","animationName":"","transform":"perspective(900px)\n      translate3d(0px,0px,0px)\n      rotateX(0deg) rotateY(0deg) rotateZ(180deg)\n      scaleX(100%) scaleY(100%)\n      skewX(0deg) skewY(0deg)\n      ","pointerEvents":"auto","backgroundColor":"var(--left-menu-unpack-bg)"},
...
label:"",
active:false,
cStyle:{"wrapper":{"default":{"width":"25px","height":"25px","position":"unset","left":"2px","top":"10px","borderLeft":"1px none rgb(23,62,228)","borderTop":"1px none rgb(23,62,228)","borderRight":"1px none rgb(23,62,228)","borderBottom":"1px none rgb(23,62,228)","backgroundImage":"url(assets/images/2024-07-26/eccc79ac5454467f9fae314902c11228.png)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":"","cursor":"pointer","borderTopLeftRadius":"4px","borderTopRightRadius":"4px","borderBottomLeftRadius":"4px","borderBottomRightRadius":"4px","animationName":"","transform":"perspective(900px)\n      translate3d(0px,0px,0px)\n      rotateX(0deg) rotateY(0deg) rotateZ(180deg)\n      scaleX(100%) scaleY(100%)\n      skewX(0deg) skewY(0deg)\n      ","pointerEvents":"auto","backgroundColor":"var(--left-menu-unpack-bg)"}}}, 
 },
},
});
const setPageSize = () => {
...
if (index > -1) {
  // 更新图层名称
  state.typeList[index].label = `图层（${state.count}）`;
}
};
...
watch(() => [global.navMenuItemActive.name], () => {
  console.log(global.navMenuItemActive.name, 'global.navMenuItemActive.name');
  if (global.navMenuItemActive.name === '58b82e7a-8b9f-4e6a-863e-4f8292885bf3') {
    state.typeList = [
      {
        "label": "图层",
        "name": "layer"
  ...
  state.type = state.typeList[0].name;
  updateLayersCount();
}, {
  immediate: true
})
...
/*rootData.rootEmit(
  ...
  { 
    key:'businessDialog',
    value: {
      dialogName: 'zhcxLayerDetailOnMenuComponent',
      dialogParmas: {
        ...data,
      },
    },
...
rootData.rootEmit(
  'rootData:change',
  { 
    key:'leftBottomLayerHelpData',
    value: {
      showLeftBottomLayerHelpPanel: true,
      leftBottomLayerHelpParam: data,
    },
  },
);
};
const updateLayerMsg = () => {
rootData.rootSocket.emit('message', {
  room: global.socketRoom, // 房间号
  type: 'sendUpdateLayerMsg', // 消息名称
  data: true
});
};
...
// 接口函数
 getLayerDataJson: {
              ...
              config: {"url":"/video/FS_Layer.json","method":"get","baseURL":"global.serviceBaseUrl","params":{}},
...
return new Promise((resolve, reject) => {
                ...
                http({"url":"/video/FS_Layer.json","method":"get","baseURL":global.serviceBaseUrl,"params":{},}).then((res) => {
                   ...
                   // 成功的操作
                   const cacheKey = generateCacheKey('global.serviceBaseUrl-/video/FS_Layer.json',  {});
                   
                   apiDataMap[cacheKey] = res.data;
                   apiDataMap['getLayerDataJson'] = res.data;
...
if (res.status === 200 && res.data?.head?.statusCode === 200) {
  ...
  // 获取图层数量
  let count = getLayerTotalCount(asideLayerMap, 0);
...
// 接口函数
 getLayerDataCopy: {
              ...
              autoLoad: false, // 自动请求
              bindComponents: [], // 依赖的组件ID列表，可能多个组件绑定一个接口的数据
              config: {"url":"/mapgo5.0/api/spacelayer/download","method":"get","baseURL":"global.serviceBaseUrl","params":{"categoryId":"16f5aeac5c0a46148f91a5679beef603"}},
              request: function ( componentId) {
return new Promise((resolve, reject) => {
                ...
                http({"url":"/mapgo5.0/api/spacelayer/download","method":"get","baseURL":global.serviceBaseUrl,"params":{"categoryId":"16f5aeac5c0a46148f91a5679beef603"},}).then((res) => {
                   ...
                   // 成功的操作
                   const cacheKey = generateCacheKey('global.serviceBaseUrl-/mapgo5.0/api/spacelayer/download',  {"categoryId":"16f5aeac5c0a46148f91a5679beef603"});
                   
                   apiDataMap[cacheKey] = res.data;
                   apiDataMap['getLayerDataCopy'] = res.data;
...
// 接口函数
 getLayerData: {
              ...
              autoLoad: true, // 自动请求
              bindComponents: [], // 依赖的组件ID列表，可能多个组件绑定一个接口的数据
              config: {"url":"/assets/tclb.json","method":"get","baseURL":"http://27.36.118.5:8888","params":{}},
              request: function ( componentId) {
return new Promise((resolve, reject) => {
  
                http({"url":"/assets/tclb.json","method":"get","baseURL":"http://27.36.118.5:8888","params":{},}).then((res) => {
 
                   // 成功的操作
                   const cacheKey = generateCacheKey('http://27.36.118.5:8888-/assets/tclb.json',  {});
                   
                   apiDataMap[cacheKey] = res.data;
                   apiDataMap['getLayerData'] = res.data;
                
     if (res.status === 200 && res.data?.head?.statusCode === 200) {
  const structData = async () => {
    const helpRes = await getHelpData();
    console.log(16, helpRes);

    const getHasDialog = (originTreeNodeLayerId) => {
      if (helpRes.data.length) {
        const emIndex = helpRes.data.findIndex((item) => item.ID === originTreeNodeLayerId);
        if (emIndex !== -1) {
          const isShow = (helpRes.data[emIndex].SHOW_DIALOG === '1' || !!helpRes.data[emIndex].WISDOWFILE_CODE);
          return isShow;
        }
      }
      return false;
    ...
    const getLayerHelpWisdowfile = (originTreeNodeLayerId) => {
      // 默认返回值
      const defaultResult = {
        wisdowfileCode: '', 
        wisdowfileCondition: '' 
      ...
      // 尝试找到对应的元素，找不到则返回默认结果
      const foundItem = helpRes.data.find(item => item.ID === originTreeNodeLayerId);
      if (!foundItem) {
        return defaultResult;
      }

      // 返回找到的结果，使用解构赋值简化代码
      const { WISDOWFILE_CODE: wisdowfileCode, WISDOWFILE_CONDITION: wisdowfileCondition } = foundItem;
      
      return {
        wisdowfileCode: wisdowfileCode || '', 
        wisdowfileCondition: wisdowfileCondition || ''
      }
    }
    ...
    const asideLayerMap = res.data?.data?.msg?.map((item) => ({
      ...
      children: item.children?.map((elem) => ({
        ...elem,
        children: elem.children?.map((mo) => ({
          ...mo,
          hasDialog: getHasDialog(mo.layerId), // 是否有弹框
          ...getLayerHelpWisdowfile(mo.layerId)
        })),
        // hasDialog: Math.random() > 0.5 ? true : false, // 是否有弹框
        hasDialog: getHasDialog(elem.layerId), // 是否有弹框
        ...getLayerHelpWisdowfile(elem.layerId)
      })),
      hasDialog: getHasDialog(item.layerId), // 是否有弹框
      ...getLayerHelpWisdowfile(item.layerId)
    })) || [];
    
    console.log(asideLayerMap, '图层数据');

    localStorage.setItem('lxtAsideLayerMap', JSON.stringify(asideLayerMap));

    // 获取图层数量
    state.count = getLayerTotalCount(asideLayerMap, 0);
    updateLayersCount();
    updateLayerMsg();
  };
  structData();
...
// 接口函数
 getHelpData: {
              ...
              autoLoad: false, // 自动请求
              bindComponents: [], // 依赖的组件ID列表，可能多个组件绑定一个接口的数据
              config: {"url":"global.integratedQuery.layerServiceContext","method":"get","baseURL":"global.integratedQuery.layerServiceIP","params":{"interfaceId":"e006fe59296468ddbf846b60184f3444","token":"dcp"}},
              request: function ( componentId) {
return new Promise((resolve, reject) => {
  
                http({"url":global.integratedQuery.layerServiceContext,"method":"get","baseURL":global.integratedQuery.layerServiceIP,"params":{"interfaceId":"e006fe59296468ddbf846b60184f3444","token":"dcp"},}).then((res) => {
 
                   // 成功的操作
                   const cacheKey = generateCacheKey('global.integratedQuery.layerServiceIP-global.integratedQuery.layerServiceContext',  {"interfaceId":"e006fe59296468ddbf846b60184f3444","token":"dcp"});
                   
                   apiDataMap[cacheKey] = res.data;
                   apiDataMap['getHelpData'] = res.data;
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-leftMenus', global.appScaleMode, 'normal');
...
/* 接收socket.io消息 */
const onSocketChange92f8f989544644509f4e = function (data) {
if(data.type === "loadMenuData"){
try{
// 执行自定义方法
...
};rootData.rootOn('rootSocket:change', onSocketChange92f8f989544644509f4e);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChange92f8f989544644509f4e);
});
/* 接收socket.io消息 */
const onSocketChange94786120e1c04423ab8c = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChange94786120e1c04423ab8c);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChange94786120e1c04423ab8c);
});
// 执行自定义方法
setSubjectVisible();
onMounted(() => {
...
.t-l-c-leftMenus .leftMenu-t-rect-0-1 {
...
.t-l-c-leftMenus .leftMenu-t-rect-0-3 {
position: absolute !important;
top: 0px;
left: 0px;
width: 222px;
...
.t-l-c-leftMenus .leftMenu-t-tabs-0-4 {
position: absolute !important;
top: 12px;
left: 72px;
width: 155px;
...
.t-l-c-leftMenus .leftMenu-t-rect-0-5 {
position: absolute !important;
top: 10px;
left: 16px;
width: 25px;
...
.t-l-c-leftMenus .leftMenu-t-iframe-0-6 {
position: absolute !important;
top: 52px;
left: 4px;
width: 220px;
...
.t-l-c-leftMenus .leftMenu-t-iframe-0-7 {
position: absolute !important;
top: 55px;
left: 4px;
width: 220px;
...
.t-l-c-leftMenus .leftMenu-t-rect-0-11 {
position: absolute !important;
top: 10px;
left: 2px;
width: 25px;

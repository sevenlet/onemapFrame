...
if (tabValue !== state.tabSelect) {
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-washCarEntry', global.appScaleMode, 'normal');
...
handleWindowResize();
/* 接收socket.io消息 */
const onSocketChangef7171d1e50dd4e938fbb = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChangef7171d1e50dd4e938fbb);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChangef7171d1e50dd4e938fbb);
});
/* 接收socket.io消息 */
const onSocketChangebcaf782a9a5d42209ab2 = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChangebcaf782a9a5d42209ab2);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChangebcaf782a9a5d42209ab2);
});
/* 接收socket.io消息 */
const onSocketChange0aa9113fdbbf41ea80a7 = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChange0aa9113fdbbf41ea80a7);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChange0aa9113fdbbf41ea80a7);
});
/* 接收socket.io消息 */
const onSocketChange6cf86c4da173477fad52 = function (data) {
if(data.type === "closeTrajectoryWaterSprinkler"){
try{
// 设置变量值
state.componentName = 'washCarContentComponent';
} catch (error) {
console.error('参数格式错误', error);
};
};
};rootData.rootOn('rootSocket:change', onSocketChange6cf86c4da173477fad52);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChange6cf86c4da173477fad52);
});
});
// 页面离开时的操作
onUnmounted(() => {
...
.t-l-c-washCarEntry .washCarEntry-t-component-0-0 {

<template>
  <div id="t-l-c-waterSurfaceEntry" class="t-l-c-waterSurfaceEntry" ><t-component id="t-component-8cc1.8e726916" class="waterSurfaceEntry-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName"></t-component></div>
</template>
...
.t-l-c-waterSurfaceEntry .waterSurfaceEntry-t-component-0-0 {

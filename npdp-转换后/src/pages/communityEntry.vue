...
const state = reactive({
   screenSize: "",
   componentName: "communityContentComponent",
});
// 选中的图表主题
...
name:"communityContentComponent",
loading:true,
...
if (tabValue !== state.tabSelect) {
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-communityEntry', global.appScaleMode, 'normal');
...
handleWindowResize();
/* 接收socket.io消息 */
const onSocketChangea564723f7c5540d7a307 = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChangea564723f7c5540d7a307);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChangea564723f7c5540d7a307);
});
/* 接收socket.io消息 */
const onSocketChange305568cba4ce43658c32 = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChange305568cba4ce43658c32);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChange305568cba4ce43658c32);
});
/* 接收socket.io消息 */
const onSocketChange0cdc2eced32e4f288750 = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChange0cdc2eced32e4f288750);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChange0cdc2eced32e4f288750);
});
/* 接收socket.io消息 */
const onSocketChange5ec6d5beae9a4856a2bb = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChange5ec6d5beae9a4856a2bb);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChange5ec6d5beae9a4856a2bb);
});
});
// 页面离开时的操作
onUnmounted(() => {
...
.t-l-c-communityEntry .communityEntry-t-component-0-0 {

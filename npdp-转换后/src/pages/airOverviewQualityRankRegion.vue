...
import { TListCard } from '@ths/design';
...
const state = reactive({
   ...
   singleCardData: [{"title":"镇街排名","num":"-","unit":"名","color":"var(--business-theme)","icon":"assets/images/2025-01-15/90f5a31502db47c483a1278f4ed80f1e.png"}],
   rankCardData: [{"title":"省内排名","num":"-","unit":"名","color":"var(--business-theme)","icon":"assets/images/2025-01-15/90f5a31502db47c483a1278f4ed80f1e.png"},{"title":"市内排名","num":"-","unit":"名","color":"var(--business-strong)","icon":"assets/images/2025-01-15/99910eaba22046b4a9909b86e4ecef0b.png"}],
...
data:[{"title":"省内排名","num":"-","unit":"名","color":"var(--business-theme)","icon":"assets/images/2025-01-15/90f5a31502db47c483a1278f4ed80f1e.png"},{"title":"市内排名","num":"-","unit":"名","color":"var(--business-strong)","icon":"assets/images/2025-01-15/99910eaba22046b4a9909b86e4ecef0b.png"}],
spacingX:12,
col:2,
direction:"vertical",
exchangeOrder:false,
...
data:[{"title":"镇街排名","num":"-","unit":"名","color":"var(--business-theme)","icon":"assets/images/2025-01-15/90f5a31502db47c483a1278f4ed80f1e.png"}],
spacingX:12,
col:1,
direction:"vertical",
exchangeOrder:false,
...
<style scoped>
.t-l-c-airOverviewQualityRankRegion {
position: relative;
overflow: hidden;
...
.t-l-c-airOverviewQualityRankRegion .airOverviewQualityRankRegion-t-list-card-0-0 {
...
.t-l-c-airOverviewQualityRankRegion .airOverviewQualityRankRegion-t-list-card-0-1 {
position: absolute !important;
top: 0px;
left: -6px;
width: 422px;

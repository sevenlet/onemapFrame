<template>
  <div id="t-l-c-waterDialogSmallWaterTrend" class="t-l-c-waterDialogSmallWaterTrend" ><t-select id="t-select-ee9f.bf9455a04" class="waterDialogSmallWaterTrend-t-select-0-0"  :active-value="replaceCssVariables(filterData(state.params.pollutants, componentPropBindingMap?.['t-select-ee9f.bf9455a04']['activeValue'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :options="replaceCssVariables(filterData(state.options.pollutants, componentPropBindingMap?.['t-select-ee9f.bf9455a04']['options'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :alias="tSelectx0x0ComputedData.alias" :multiple="tSelectx0x0ComputedData.multiple" :placeholder="tSelectx0x0ComputedData.placeholder" :clearable="tSelectx0x0ComputedData.clearable" :disabled="tSelectx0x0ComputedData.disabled" :name="tSelectx0x0ComputedData.name" :autocomplete="tSelectx0x0ComputedData.autocomplete" :filterable="tSelectx0x0ComputedData.filterable" :no-match-text="tSelectx0x0ComputedData.no-match-text" :no-data-text="tSelectx0x0ComputedData.no-data-text" :c-style="tSelectx0x0ComputedData.cStyle" @change="onchange1734159936716"></t-select><t-text id="t-text-8f2e.58316ed1d" class="waterDialogSmallWaterTrend-t-text-0-1"  :label="tTextx0x1ComputedData.label" :editable="tTextx0x1ComputedData.editable" :c-style="tTextx0x1ComputedData.cStyle"></t-text><t-switch id="t-switch-5d48.72ababdbd" class="waterDialogSmallWaterTrend-t-switch-0-2"  :value="tSwitchx0x2ComputedData.value" :c-style="tSwitchx0x2ComputedData.cStyle" @change="onchange1734160214280"></t-switch><t-date-picker id="t-date-picker-cad2.abd345996" class="waterDialogSmallWaterTrend-t-date-picker-0-3"  :placeholder="tDatePickerx0x3ComputedData.placeholder" :start-placeholder="tDatePickerx0x3ComputedData.startPlaceholder" :end-placeholder="tDatePickerx0x3ComputedData.endPlaceholder" :type="tDatePickerx0x3ComputedData.type" :clearable="tDatePickerx0x3ComputedData.clearable" :range-separator="tDatePickerx0x3ComputedData.rangeSeparator" :default-date="replaceCssVariables(filterData(state.params.time.range, componentPropBindingMap?.['t-date-picker-cad2.abd345996']['default-date'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :separator="tDatePickerx0x3ComputedData.separator" :readonly="tDatePickerx0x3ComputedData.readonly" :editable="tDatePickerx0x3ComputedData.editable" :c-style="tDatePickerx0x3ComputedData.cStyle" @date-change="ondateChange1734160159774"></t-date-picker><t-text id="t-text-740f.85d1d67c6" class="waterDialogSmallWaterTrend-t-text-0-4"  :label="tTextx0x4ComputedData.label" :editable="tTextx0x4ComputedData.editable" :c-style="tTextx0x4ComputedData.cStyle"></t-text><t-text-common id="t-text-common-711f.2b283b5de" class="waterDialogSmallWaterTrend-t-text-common-0-5"  :label="tTextCommonx0x5ComputedData.label" :editable="tTextCommonx0x5ComputedData.editable" :c-style="tTextCommonx0x5ComputedData.cStyle"></t-text-common><t-text-common id="t-text-common-b0ad.6d9f3046" class="waterDialogSmallWaterTrend-t-text-common-0-6"  :label="tTextCommonx0x6ComputedData.label" :editable="tTextCommonx0x6ComputedData.editable" :c-style="tTextCommonx0x6ComputedData.cStyle"></t-text-common><t-chart-design v-if="state.chartShow === true" id="t-chart-design-be6d.d19353f72" class="waterDialogSmallWaterTrend-t-chart-design-0-7"  :register-map-name="tChartDesignx0x7ComputedData.registerMapName" :geo-json="tChartDesignx0x7ComputedData.geoJson" :empty-img="tChartDesignx0x7ComputedData.emptyImg" :c-style="tChartDesignx0x7ComputedData.cStyle" :options="replaceCssVariables(filterData(state.lineChartOption, componentPropBindingMap?.['t-chart-design-be6d.d19353f72']['options'].filters || []), global?.theme || global?.activeTheme || '默认主题')" @get-chart-instance="ongetChartInstance1764054267914"></t-chart-design></div>
</template>
...
const now = new Date();
let endTime = dateFormat(now, 'yyyy-MM-dd HH');
...
if (data?.head?.statusCode === '200' && data?.data) {  
  ...
  let endTime = data.data.MONITORTIME || '';
...
<style scoped>
.t-l-c-waterDialogSmallWaterTrend {
position: relative;
overflow: hidden;
...
.t-l-c-waterDialogSmallWaterTrend .waterDialogSmallWaterTrend-t-select-0-0 {
...
.t-l-c-waterDialogSmallWaterTrend .waterDialogSmallWaterTrend-t-text-0-1 {
position: absolute !important;
top: 42px;
left: 709px;
width: 66px;
...
.t-l-c-waterDialogSmallWaterTrend .waterDialogSmallWaterTrend-t-switch-0-2 {
position: absolute !important;
top: 42px;
left: 791px;
width: 32px;
...
.t-l-c-waterDialogSmallWaterTrend .waterDialogSmallWaterTrend-t-date-picker-0-3 {
position: absolute !important;
top: 2px;
left: 365px;
width: 290px;
...
.t-l-c-waterDialogSmallWaterTrend .waterDialogSmallWaterTrend-t-text-0-4 {
position: absolute !important;
top: 10px;
left: 300px;
width: 56px;
...
.t-l-c-waterDialogSmallWaterTrend .waterDialogSmallWaterTrend-t-text-common-0-5 {
position: absolute !important;
top: 7px;
left: 2px;
width: auto;
...
.t-l-c-waterDialogSmallWaterTrend .waterDialogSmallWaterTrend-t-text-common-0-6 {
position: absolute !important;
top: 42px;
left: 2px;
width: auto;
...
.t-l-c-waterDialogSmallWaterTrend .waterDialogSmallWaterTrend-t-chart-design-0-7 {
position: absolute !important;
top: 29px;
left: -35px;
width: 864px;

<template>
  <div id="t-l-c-overallEvaluationResult" class="t-l-c-overallEvaluationResult"><t-component
      id="t-component-85f9.a47b96486" class="overallEvaluationResult-t-component-0-0"
      :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle"
      :src="tComponentx0x0ComputedData.src"
      :component-name="tComponentx0x0ComputedData.componentName"></t-component><t-text id="t-text-0449.7284ee64"
      class="overallEvaluationResult-t-text-0-1" :label="tTextx0x1ComputedData.label"
      :editable="tTextx0x1ComputedData.editable" :c-style="tTextx0x1ComputedData.cStyle"></t-text><t-select
      id="t-select-8320.e49ee9bbf" class="overallEvaluationResult-t-select-0-2"
      :active-value="replaceCssVariables(filterData(global.waterGlobalVariables.waterOverview.assessType, componentPropBindingMap?.['t-select-8320.e49ee9bbf']['activeValue'].filters || []), global?.theme || global?.activeTheme || '默认主题')"
      :options="tSelectx0x2ComputedData.options" :alias="tSelectx0x2ComputedData.alias"
      :multiple="tSelectx0x2ComputedData.multiple" :placeholder="tSelectx0x2ComputedData.placeholder"
      :clearable="tSelectx0x2ComputedData.clearable" :disabled="tSelectx0x2ComputedData.disabled"
      :name="tSelectx0x2ComputedData.name" :autocomplete="tSelectx0x2ComputedData.autocomplete"
      :filterable="tSelectx0x2ComputedData.filterable" :no-match-text="tSelectx0x2ComputedData.no - match - text"
      :no-data-text="tSelectx0x2ComputedData.no - data - text" :c-style="tSelectx0x2ComputedData.cStyle"
      @change="onchange1763468188787"></t-select><t-row id="t-row-aa36.932ee8c24"
      class="overallEvaluationResult-t-row-0-3" :c-style="tRowx0x3ComputedData.cStyle"
      :gutter="tRowx0x3ComputedData.gutter" :justify="tRowx0x3ComputedData.justify" :align="tRowx0x3ComputedData.align">

      <t-col id="t-col-473d.9096d3d182" class="overallEvaluationResult-t-col-0-3-0" :span="tColx0x3x0ComputedData.span"
        :offset="tColx0x3x0ComputedData.offset" :push="tColx0x3x0ComputedData.push" :pull="tColx0x3x0ComputedData.pull"
        :c-style="tColx0x3x0ComputedData.cStyle">
        <micro-app name="child-demo2" iframe
          url="http://localhost:5175/"
          default-page="/about"
          :data="dataToChild" @datachange="handleChildData"
          style="width: 100%; height: fit-content;pointer-events: auto;">
        </micro-app>
      </t-col>
      <t-col id="t-col-473d.9096d3d18" class="overallEvaluationResult-t-col-0-3-0" :span="tColx0x3x0ComputedData.span"
        :offset="tColx0x3x0ComputedData.offset" :push="tColx0x3x0ComputedData.push" :pull="tColx0x3x0ComputedData.pull"
        :c-style="tColx0x3x0ComputedData.cStyle"><t-component id="t-component-535f.37a20bf44"
          class="overallEvaluationResult-t-component-0-3-0-0" :name="tComponentx0x3x0x0ComputedData.name"
          :loading="tComponentx0x3x0x0ComputedData.loading" :c-style="tComponentx0x3x0x0ComputedData.cStyle"
          :src="tComponentx0x3x0x0ComputedData.src" :component-name="tComponentx0x3x0x0ComputedData.componentName"
          :page-id="tComponentx0x3x0x0ComputedData.pageId" :page-code="tComponentx0x3x0x0ComputedData.pageCode"
          @click="onclick1764050185031"></t-component><t-rect v-if="state.activeItem === 'gk'"
          id="t-rect-4aca.428ceb086" class="overallEvaluationResult-t-rect-0-3-0-1" :tip="tRectx0x3x0x1ComputedData.tip"
          :label="tRectx0x3x0x1ComputedData.label" :active="tRectx0x3x0x1ComputedData.active"
          :c-style="tRectx0x3x0x1ComputedData.cStyle"></t-rect></t-col><t-col id="t-col-42e1.988ff2392"
        class="overallEvaluationResult-t-col-0-3-1" :span="tColx0x3x1ComputedData.span"
        :offset="tColx0x3x1ComputedData.offset" :push="tColx0x3x1ComputedData.push" :pull="tColx0x3x1ComputedData.pull"
        :c-style="tColx0x3x1ComputedData.cStyle"><t-component id="t-component-d1e6.ebee01e93"
          class="overallEvaluationResult-t-component-0-3-1-0" :name="tComponentx0x3x1x0ComputedData.name"
          :loading="tComponentx0x3x1x0ComputedData.loading" :c-style="tComponentx0x3x1x0ComputedData.cStyle"
          :src="tComponentx0x3x1x0ComputedData.src" :component-name="tComponentx0x3x1x0ComputedData.componentName"
          :page-id="tComponentx0x3x1x0ComputedData.pageId" :page-code="tComponentx0x3x1x0ComputedData.pageCode"
          @click="onclick1764051030306"></t-component><t-rect v-if="state.activeItem === 'sk'"
          id="t-rect-d39e.f453b9508" class="overallEvaluationResult-t-rect-0-3-1-1" :tip="tRectx0x3x1x1ComputedData.tip"
          :label="tRectx0x3x1x1ComputedData.label" :active="tRectx0x3x1x1ComputedData.active"
          :c-style="tRectx0x3x1x1ComputedData.cStyle"></t-rect></t-col><t-col id="t-col-4679.ff1028a9f"
        class="overallEvaluationResult-t-col-0-3-2" :span="tColx0x3x2ComputedData.span"
        :offset="tColx0x3x2ComputedData.offset" :push="tColx0x3x2ComputedData.push" :pull="tColx0x3x2ComputedData.pull"
        :c-style="tColx0x3x2ComputedData.cStyle"><t-component id="t-component-a57d.631b29e48"
          class="overallEvaluationResult-t-component-0-3-2-0" :name="tComponentx0x3x2x0ComputedData.name"
          :loading="tComponentx0x3x2x0ComputedData.loading" :c-style="tComponentx0x3x2x0ComputedData.cStyle"
          :src="tComponentx0x3x2x0ComputedData.src" :component-name="tComponentx0x3x2x0ComputedData.componentName"
          :page-id="tComponentx0x3x2x0ComputedData.pageId" :page-code="tComponentx0x3x2x0ComputedData.pageCode"
          @click="onclick1764051005699"></t-component><t-rect v-if="state.activeItem === 'xly'"
          id="t-rect-eb3a.4591aff74" class="overallEvaluationResult-t-rect-0-3-2-1" :tip="tRectx0x3x2x1ComputedData.tip"
          :label="tRectx0x3x2x1ComputedData.label" :active="tRectx0x3x2x1ComputedData.active"
          :c-style="tRectx0x3x2x1ComputedData.cStyle"></t-rect></t-col><t-col id="t-col-4aab.4a4b615e2"
        class="overallEvaluationResult-t-col-0-3-3" :span="tColx0x3x3ComputedData.span"
        :offset="tColx0x3x3ComputedData.offset" :push="tColx0x3x3ComputedData.push" :pull="tColx0x3x3ComputedData.pull"
        :c-style="tColx0x3x3ComputedData.cStyle"><t-component id="t-component-ed32.70867db46"
          class="overallEvaluationResult-t-component-0-3-3-0" :name="tComponentx0x3x3x0ComputedData.name"
          :loading="tComponentx0x3x3x0ComputedData.loading" :c-style="tComponentx0x3x3x0ComputedData.cStyle"
          :src="tComponentx0x3x3x0ComputedData.src" :component-name="tComponentx0x3x3x0ComputedData.componentName"
          :page-id="tComponentx0x3x3x0ComputedData.pageId" :page-code="tComponentx0x3x3x0ComputedData.pageCode"
          @click="onclick1764050976999"></t-component><t-rect v-if="state.activeItem === 'yysyd'"
          id="t-rect-2d7f.31fb1c701" class="overallEvaluationResult-t-rect-0-3-3-1" :tip="tRectx0x3x3x1ComputedData.tip"
          :label="tRectx0x3x3x1ComputedData.label" :active="tRectx0x3x3x1ComputedData.active"
          :c-style="tRectx0x3x3x1ComputedData.cStyle"></t-rect></t-col><t-col id="t-col-cdd1.292b02a6e"
        class="overallEvaluationResult-t-col-0-3-4" :span="tColx0x3x4ComputedData.span"
        :offset="tColx0x3x4ComputedData.offset" :push="tColx0x3x4ComputedData.push" :pull="tColx0x3x4ComputedData.pull"
        :c-style="tColx0x3x4ComputedData.cStyle"><t-component id="t-component-bcf3.a0c651c15"
          class="overallEvaluationResult-t-component-0-3-4-0" :name="tComponentx0x3x4x0ComputedData.name"
          :loading="tComponentx0x3x4x0ComputedData.loading" :c-style="tComponentx0x3x4x0ComputedData.cStyle"
          :src="tComponentx0x3x4x0ComputedData.src" :component-name="tComponentx0x3x4x0ComputedData.componentName"
          :page-id="tComponentx0x3x4x0ComputedData.pageId" :page-code="tComponentx0x3x4x0ComputedData.pageCode"
          @click="onclick1764050956797"></t-component><t-rect v-if="state.activeItem === 'zdhk'"
          id="t-rect-4051.7c2e78796" class="overallEvaluationResult-t-rect-0-3-4-1" :tip="tRectx0x3x4x1ComputedData.tip"
          :label="tRectx0x3x4x1ComputedData.label" :active="tRectx0x3x4x1ComputedData.active"
          :c-style="tRectx0x3x4x1ComputedData.cStyle"></t-rect></t-col><t-col id="t-col-7717.235e399b8"
        class="overallEvaluationResult-t-col-0-3-5" :span="tColx0x3x5ComputedData.span"
        :offset="tColx0x3x5ComputedData.offset" :push="tColx0x3x5ComputedData.push" :pull="tColx0x3x5ComputedData.pull"
        :c-style="tColx0x3x5ComputedData.cStyle"><t-component id="t-component-5444.d3a662471"
          class="overallEvaluationResult-t-component-0-3-5-0" :name="tComponentx0x3x5x0ComputedData.name"
          :loading="tComponentx0x3x5x0ComputedData.loading" :c-style="tComponentx0x3x5x0ComputedData.cStyle"
          :src="tComponentx0x3x5x0ComputedData.src" :component-name="tComponentx0x3x5x0ComputedData.componentName"
          :page-id="tComponentx0x3x5x0ComputedData.pageId" :page-code="tComponentx0x3x5x0ComputedData.pageCode"
          @click="onclick1764050934571"></t-component><t-rect v-if="state.activeItem === 'wzdyx'"
          id="t-rect-968f.19432f6fb" class="overallEvaluationResult-t-rect-0-3-5-1" :tip="tRectx0x3x5x1ComputedData.tip"
          :label="tRectx0x3x5x1ComputedData.label" :active="tRectx0x3x5x1ComputedData.active"
          :c-style="tRectx0x3x5x1ComputedData.cStyle"></t-rect></t-col></t-row></div>
</template>
...
import { TCol, TComponent, TRect, TRow, TSelect, TText } from '@ths/design';
...
export default {
  ...
  setup() {
    // child-demo2 子应用需要用 bridge（callBase / TMap / 基座弹窗）
    const { dataToChild, handleChildData, setData: setChildData, registerMethod, registerHandler }
      = useChildBridge('child-demo2');  // name 必须与 <micro-app name="child-demo2"> 对齐
    // ↓ state 定义之后会 watch state 并 setChildData 同步过来，见下方
    ...
    watch(state, (val) => { setChildData(_.cloneDeep(val)) }, { immediate: true, deep: true })
    // ↑ state 全量变化 → setChildData → bridge.data 更新 → dataToChild computed 返新引用
    //   → <micro-app :data="dataToChild"> 检测到引用变化 → setData 给子应用
    // 用 cloneDeep 是因为 state 里若有嵌套对象，浅拷贝监听不到嵌套字段变化
    // const dataToChild = computed(() => _.cloneDeep(state))
    // 选中的图表主题
    ...
    const componentState = reactive({
      ...
      tColx0x3x0: {
        ...
        default: {
          ...
          push: 0,
          pull: 0,
          cStyle: { "wrapper": { "default": { "width": "412px", "height": "auto", "display": "flex", "justifyContent": "center", "alignItems": "center", "animationName": "", "left": "50px", "top": "50px" } } },
        },
      },
      tComponentx0x3x0x0: {
        defaultStyle: {
      ...
      tRectx0x3x1x1: {
        defaultStyle: {
          default: { "width": "412px", "height": "116px", "justifyContent": "center", "alignItems": "center", "flexDirection": "row", "border": "unset !important", "borderTop": "1px Solid rgba(245,229,181,1)", "borderLeft": "1px Solid rgba(245,229,181,1)", "borderBottom": "1px Solid rgba(245,229,181,1)", "borderRight": "1px Solid rgba(245,229,181,1)", "position": "absolute !important", "left": "0 !important", "top": "0  !important", "borderDirection": "all", "animationName": "", "background": "url(assets/images/2025-11-28/ebfc83aeb1bf4d64b20330f86a3043c7.png)", "backgroundSize": "100% 100%", "backgroundRepeat": "no-repeat", "fillType": "image", "pointerEvents": "none", "cursor": "pointer" },
    ...
    const pageFuncTest = (param) => {
      console.log('demo2页面方法测试', param);
      return 'demo2页面方法测试成功';
    };
...
.t-l-c-overallEvaluationResult .overallEvaluationResult-t-component-0-0 {
...
.t-l-c-overallEvaluationResult .overallEvaluationResult-t-text-0-1 {
  position: absolute !important;
  top: 9px;
  left: 59px;
  width: 130px;
...
.t-l-c-overallEvaluationResult .overallEvaluationResult-t-select-0-2 {
  position: absolute !important;
  top: 2px;
  left: 323px;
  width: 97px;
...
.t-l-c-overallEvaluationResult .overallEvaluationResult-t-row-0-3 {
  position: absolute !important;
  top: 56px;
  left: 18px;
  width: 413px;
...
.t-l-c-overallEvaluationResult .overallEvaluationResult-t-col-0-3-0 {
  position: relative;
  top: null;
  left: null;
  width: 412px;
...
.t-l-c-overallEvaluationResult .overallEvaluationResult-t-component-0-3-0-0 {
  position: unset;
  top: 50px;
  left: 22px;
  width: 410px;
...
.t-l-c-overallEvaluationResult .overallEvaluationResult-t-rect-0-3-0-1 {
  position: unset;
  top: 49px;
  left: 21px;
  width: 412px;
...
.t-l-c-overallEvaluationResult .overallEvaluationResult-t-col-0-3-1 {
  position: relative;
  top: null;
  left: null;
  width: 412px;
...
.t-l-c-overallEvaluationResult .overallEvaluationResult-t-component-0-3-1-0 {
  position: unset;
  top: 181px;
  left: 23px;
  width: 410px;
...
.t-l-c-overallEvaluationResult .overallEvaluationResult-t-rect-0-3-1-1 {
  position: unset;
  top: 180px;
  left: 22px;
  width: 412px;
...
.t-l-c-overallEvaluationResult .overallEvaluationResult-t-col-0-3-2 {
  position: relative;
  top: null;
  left: null;
  width: 412px;
...
.t-l-c-overallEvaluationResult .overallEvaluationResult-t-component-0-3-2-0 {
  position: unset;
  top: 310px;
  left: 23px;
  width: 410px;
...
.t-l-c-overallEvaluationResult .overallEvaluationResult-t-rect-0-3-2-1 {
  position: unset;
  top: 309px;
  left: 22px;
  width: 412px;
...
.t-l-c-overallEvaluationResult .overallEvaluationResult-t-col-0-3-3 {
  position: relative;
  top: null;
  left: null;
  width: 412px;
...
.t-l-c-overallEvaluationResult .overallEvaluationResult-t-component-0-3-3-0 {
  position: unset;
  top: 444px;
  left: 23px;
  width: 410px;
...
.t-l-c-overallEvaluationResult .overallEvaluationResult-t-rect-0-3-3-1 {
  position: unset;
  top: 441px;
  left: 22px;
  width: 412px;
...
.t-l-c-overallEvaluationResult .overallEvaluationResult-t-col-0-3-4 {
  position: relative;
  top: null;
  left: null;
  width: 412px;
...
.t-l-c-overallEvaluationResult .overallEvaluationResult-t-component-0-3-4-0 {
  position: unset;
  top: 571px;
  left: 22px;
  width: 410px;
...
.t-l-c-overallEvaluationResult .overallEvaluationResult-t-rect-0-3-4-1 {
  position: unset;
  top: 570px;
  left: 21px;
  width: 412px;
...
.t-l-c-overallEvaluationResult .overallEvaluationResult-t-col-0-3-5 {
  position: relative;
  top: null;
  left: null;
  width: 412px;
...
.t-l-c-overallEvaluationResult .overallEvaluationResult-t-component-0-3-5-0 {
  position: unset;
  top: 702px;
  left: 22px;
  width: 410px;
...
.t-l-c-overallEvaluationResult .overallEvaluationResult-t-rect-0-3-5-1 {
  position: unset;
  top: 699px;
  left: 21px;
  width: 412px;

<template>
  <div id="t-l-c-waterWastes" class="t-l-c-waterWastes" ><t-pagination-base id="t-pagination-base-2f79.3562df8be" class="waterWastes-t-pagination-base-0-0"  :total="replaceCssVariables(state.pageInfo.total, global?.theme || global?.activeTheme || '默认主题')" :small="tPaginationBasex0x0ComputedData.small" :page-size="replaceCssVariables(state.pageInfo.pageSize, global?.theme || global?.activeTheme || '默认主题')" :pager-count="tPaginationBasex0x0ComputedData.pagerCount" :current-page="replaceCssVariables(state.pageInfo.pageNum, global?.theme || global?.activeTheme || '默认主题')" :layout="tPaginationBasex0x0ComputedData.layout" :page-sizes="tPaginationBasex0x0ComputedData.pageSizes" :disabled="tPaginationBasex0x0ComputedData.disabled" :c-style="tPaginationBasex0x0ComputedData.cStyle" @size-change="onsizeChange1752115006591" @current-change="oncurrentChange1752115035233"></t-pagination-base><t-table id="t-table-10aa.8399d93c5" class="waterWastes-t-table-0-1"  :height="tTablex0x1ComputedData.height" :stripe="tTablex0x1ComputedData.stripe" :border="tTablex0x1ComputedData.border" :auto-scroll="tTablex0x1ComputedData.autoScroll" :speed="tTablex0x1ComputedData.speed" :columns="tTablex0x1ComputedData.columns" :data="replaceCssVariables(state.pageInfo.list, global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x1ComputedData.defaultSort" :c-style="tTablex0x1ComputedData.cStyle"></t-table><t-input id="t-input-3316.cb8a7d37f" class="waterWastes-t-input-0-2"  :type="tInputx0x2ComputedData.type" :input-value="replaceCssVariables(state.wasteName, global?.theme || global?.activeTheme || '默认主题')" :maxlength="tInputx0x2ComputedData.maxlength" :minlength="tInputx0x2ComputedData.minlength" :show-word-limit="tInputx0x2ComputedData.showWordLimit" :placeholder="tInputx0x2ComputedData.placeholder" :clearable="tInputx0x2ComputedData.clearable" :show-password="tInputx0x2ComputedData.showPassword" :disabled="tInputx0x2ComputedData.disabled" :prefix-icon="tInputx0x2ComputedData.prefix-icon" :suffix-icon="tInputx0x2ComputedData.suffix-icon" :rows="tInputx0x2ComputedData.rows" :autosize="tInputx0x2ComputedData.autosize" :name="tInputx0x2ComputedData.name" :readonly="tInputx0x2ComputedData.readonly" :step="tInputx0x2ComputedData.step" :autofocus="tInputx0x2ComputedData.autofocus" :form="tInputx0x2ComputedData.form" :label="tInputx0x2ComputedData.label" :tabindex="tInputx0x2ComputedData.tabindex" :validate-event="tInputx0x2ComputedData.validateEvent" :c-style="tInputx0x2ComputedData.cStyle" @change="onchange1752112221135"></t-input><t-input id="t-input-ae9c.d60f2edfb" class="waterWastes-t-input-0-3"  :type="tInputx0x3ComputedData.type" :input-value="replaceCssVariables(state.receiveUnit, global?.theme || global?.activeTheme || '默认主题')" :maxlength="tInputx0x3ComputedData.maxlength" :minlength="tInputx0x3ComputedData.minlength" :show-word-limit="tInputx0x3ComputedData.showWordLimit" :placeholder="tInputx0x3ComputedData.placeholder" :clearable="tInputx0x3ComputedData.clearable" :show-password="tInputx0x3ComputedData.showPassword" :disabled="tInputx0x3ComputedData.disabled" :prefix-icon="tInputx0x3ComputedData.prefix-icon" :suffix-icon="tInputx0x3ComputedData.suffix-icon" :rows="tInputx0x3ComputedData.rows" :autosize="tInputx0x3ComputedData.autosize" :name="tInputx0x3ComputedData.name" :readonly="tInputx0x3ComputedData.readonly" :step="tInputx0x3ComputedData.step" :autofocus="tInputx0x3ComputedData.autofocus" :form="tInputx0x3ComputedData.form" :label="tInputx0x3ComputedData.label" :tabindex="tInputx0x3ComputedData.tabindex" :validate-event="tInputx0x3ComputedData.validateEvent" :c-style="tInputx0x3ComputedData.cStyle" @change="onchange1752112267231"></t-input><t-input id="t-input-53ef.5a50fb782" class="waterWastes-t-input-0-4"  :type="tInputx0x4ComputedData.type" :input-value="replaceCssVariables(state.productUnit, global?.theme || global?.activeTheme || '默认主题')" :maxlength="tInputx0x4ComputedData.maxlength" :minlength="tInputx0x4ComputedData.minlength" :show-word-limit="tInputx0x4ComputedData.showWordLimit" :placeholder="tInputx0x4ComputedData.placeholder" :clearable="tInputx0x4ComputedData.clearable" :show-password="tInputx0x4ComputedData.showPassword" :disabled="tInputx0x4ComputedData.disabled" :prefix-icon="tInputx0x4ComputedData.prefix-icon" :suffix-icon="tInputx0x4ComputedData.suffix-icon" :rows="tInputx0x4ComputedData.rows" :autosize="tInputx0x4ComputedData.autosize" :name="tInputx0x4ComputedData.name" :readonly="tInputx0x4ComputedData.readonly" :step="tInputx0x4ComputedData.step" :autofocus="tInputx0x4ComputedData.autofocus" :form="tInputx0x4ComputedData.form" :label="tInputx0x4ComputedData.label" :tabindex="tInputx0x4ComputedData.tabindex" :validate-event="tInputx0x4ComputedData.validateEvent" :c-style="tInputx0x4ComputedData.cStyle" @change="onchange1752113999603_0_0"></t-input><t-date-picker id="t-date-picker-ef50.b823fbfd" class="waterWastes-t-date-picker-0-5"  :placeholder="tDatePickerx0x5ComputedData.placeholder" :start-placeholder="tDatePickerx0x5ComputedData.startPlaceholder" :end-placeholder="tDatePickerx0x5ComputedData.endPlaceholder" :type="tDatePickerx0x5ComputedData.type" :clearable="tDatePickerx0x5ComputedData.clearable" :range-separator="tDatePickerx0x5ComputedData.rangeSeparator" :default-date="replaceCssVariables(state.transferTime, global?.theme || global?.activeTheme || '默认主题')" :separator="tDatePickerx0x5ComputedData.separator" :readonly="tDatePickerx0x5ComputedData.readonly" :editable="tDatePickerx0x5ComputedData.editable" :c-style="tDatePickerx0x5ComputedData.cStyle" @date-change="ondateChange1752111851791"></t-date-picker><t-text id="t-text-c350.94a526faa" class="waterWastes-t-text-0-6"  :label="tTextx0x6ComputedData.label" :editable="tTextx0x6ComputedData.editable" :c-style="tTextx0x6ComputedData.cStyle"></t-text><t-text id="t-text-6cf0.4fa80f93" class="waterWastes-t-text-0-7"  :label="tTextx0x7ComputedData.label" :editable="tTextx0x7ComputedData.editable" :c-style="tTextx0x7ComputedData.cStyle"></t-text><t-text id="t-text-dafe.28f61762f" class="waterWastes-t-text-0-8"  :label="tTextx0x8ComputedData.label" :editable="tTextx0x8ComputedData.editable" :c-style="tTextx0x8ComputedData.cStyle"></t-text><t-text id="t-text-462e.09b736acc" class="waterWastes-t-text-0-9"  :label="tTextx0x9ComputedData.label" :editable="tTextx0x9ComputedData.editable" :c-style="tTextx0x9ComputedData.cStyle"></t-text><t-button id="t-button-7fe8.4cfc96522" class="waterWastes-t-button-0-10"  :label="tButtonx0x10ComputedData.label" :round="tButtonx0x10ComputedData.round" :plain="tButtonx0x10ComputedData.plain" :disabled="tButtonx0x10ComputedData.disabled" :type="tButtonx0x10ComputedData.type" :size="tButtonx0x10ComputedData.size" :native-type="tButtonx0x10ComputedData.native-type" :c-style="tButtonx0x10ComputedData.cStyle" @click="onclick1752116084457"></t-button><t-button id="t-button-5fa8.767c5ea95" class="waterWastes-t-button-0-11"  :label="tButtonx0x11ComputedData.label" :round="tButtonx0x11ComputedData.round" :plain="tButtonx0x11ComputedData.plain" :disabled="tButtonx0x11ComputedData.disabled" :type="tButtonx0x11ComputedData.type" :size="tButtonx0x11ComputedData.size" :native-type="tButtonx0x11ComputedData.native-type" :c-style="tButtonx0x11ComputedData.cStyle" @click="onclick1752115978457"></t-button></div>
</template>
...
import { TButton, TDatePicker, TInput, TPaginationBase, TTable, TText } from '@ths/design';
...
if (res?.data?.head?.statusCode === '200' && res?.data?.data) {
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-waterWastes', global.appScaleMode, 'normal');
...
.t-l-c-waterWastes .waterWastes-t-pagination-base-0-0 {
...
.t-l-c-waterWastes .waterWastes-t-table-0-1 {
position: absolute !important;
top: 93px;
left: 0px;
width: 788px;
...
.t-l-c-waterWastes .waterWastes-t-input-0-2 {
position: absolute !important;
top: 0px;
left: 70px;
width: 127px;
...
.t-l-c-waterWastes .waterWastes-t-input-0-3 {
position: absolute !important;
top: 1px;
left: 294px;
width: 126px;
...
.t-l-c-waterWastes .waterWastes-t-input-0-4 {
position: absolute !important;
top: 47px;
left: 70px;
width: 127px;
...
.t-l-c-waterWastes .waterWastes-t-date-picker-0-5 {
position: absolute !important;
top: 0px;
left: 533px;
width: 255px;
...
.t-l-c-waterWastes .waterWastes-t-text-0-6 {
position: absolute !important;
top: 10px;
left: 2px;
width: 96px;
...
.t-l-c-waterWastes .waterWastes-t-text-0-7 {
position: absolute !important;
top: 9px;
left: 225px;
width: 89px;
...
.t-l-c-waterWastes .waterWastes-t-text-0-8 {
position: absolute !important;
top: 8px;
left: 462px;
width: 70px;
...
.t-l-c-waterWastes .waterWastes-t-text-0-9 {
position: absolute !important;
top: 57px;
left: 2px;
width: 96px;
...
.t-l-c-waterWastes .waterWastes-t-button-0-10 {
position: absolute !important;
top: 47px;
left: 632px;
width: 70px;
...
.t-l-c-waterWastes .waterWastes-t-button-0-11 {
position: absolute !important;
top: 47px;
left: 706px;
width: 70px;

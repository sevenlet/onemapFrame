<template>
  <div id="t-l-c-wzxcCar" class="t-l-c-wzxcCar" ><t-component id="t-component-aa14.3ba955fbb" class="wzxcCar-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName"></t-component><t-text-unit id="t-text-unit-a3c4.48c326f87" class="wzxcCar-t-text-unit-0-1"  :c-style="tTextUnitx0x1ComputedData.cStyle" :justify="tTextUnitx0x1ComputedData.justify" :align="tTextUnitx0x1ComputedData.align" :content="tTextUnitx0x1ComputedData.content" :unit="tTextUnitx0x1ComputedData.unit" :show-overflow-tooltip="tTextUnitx0x1ComputedData.showOverflowTooltip"></t-text-unit><t-component id="t-component-d475.408beec3" class="wzxcCar-t-component-0-2"  :name="tComponentx0x2ComputedData.name" :loading="tComponentx0x2ComputedData.loading" :c-style="tComponentx0x2ComputedData.cStyle" :src="tComponentx0x2ComputedData.src" :component-name="tComponentx0x2ComputedData.componentName" :page-id="tComponentx0x2ComputedData.pageId" :page-code="tComponentx0x2ComputedData.pageCode"></t-component></div>
</template>
...
tComponentx0x2: {
defaultStyle: {
            default: {"width":"410px","height":"800px","margin":"0 auto","position":"unset","left":"0px","top":"51px"},
            
            },
 default: { 
 
name:"wzxcCarListComponent",
loading:true,
cStyle:{"wrapper":{"default":{"width":"410px","height":"800px","margin":"0 auto","position":"unset","left":"0px","top":"51px"}}},
src:"/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/index.html#/wzxcCarList",
componentName:"wzxcCarListComponent",
pageId:"fd185833839c422dbc81339de216bce0",
pageCode:"wzxcCarList", 
 },
},
});let apiRegistry = {}; 

 function handleWindowResize() {
                            setPageScale('t-l-c-wzxcCar', global.appScaleMode, 'normal');
...
.t-l-c-wzxcCar .wzxcCar-t-component-0-0 {
...
.t-l-c-wzxcCar .wzxcCar-t-text-unit-0-1 {
position: absolute !important;
top: 6px;
left: 35px;
width: 261px;
...
.t-l-c-wzxcCar .wzxcCar-t-component-0-2 {
position: absolute !important;
top: 51px;
left: 0px;
width: 410px;

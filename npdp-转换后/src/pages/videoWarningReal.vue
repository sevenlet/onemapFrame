<template>
  <div id="t-l-c-videoWarningReal" class="t-l-c-videoWarningReal" ><t-component id="t-component-aa14.3ba955fbb" class="videoWarningReal-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName"></t-component><t-text id="t-text-6843.6e62e9a54" class="videoWarningReal-t-text-0-1"  :label="tTextx0x1ComputedData.label" :editable="tTextx0x1ComputedData.editable" :c-style="tTextx0x1ComputedData.cStyle" @click="onclick1765615349275"></t-text><t-text-unit id="t-text-unit-a3c4.48c326f87" class="videoWarningReal-t-text-unit-0-2"  :c-style="tTextUnitx0x2ComputedData.cStyle" :justify="tTextUnitx0x2ComputedData.justify" :align="tTextUnitx0x2ComputedData.align" :content="tTextUnitx0x2ComputedData.content" :unit="tTextUnitx0x2ComputedData.unit" :show-overflow-tooltip="tTextUnitx0x2ComputedData.showOverflowTooltip"></t-text-unit><t-select id="t-select-aa06.70e5fbb7f" class="videoWarningReal-t-select-0-3"  :active-value="replaceCssVariables(filterData(state.taskCode, componentPropBindingMap?.['t-select-aa06.70e5fbb7f']['activeValue'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :options="tSelectx0x3ComputedData.options" :alias="tSelectx0x3ComputedData.alias" :multiple="tSelectx0x3ComputedData.multiple" :placeholder="tSelectx0x3ComputedData.placeholder" :clearable="tSelectx0x3ComputedData.clearable" :disabled="tSelectx0x3ComputedData.disabled" :name="tSelectx0x3ComputedData.name" :autocomplete="tSelectx0x3ComputedData.autocomplete" :filterable="tSelectx0x3ComputedData.filterable" :no-match-text="tSelectx0x3ComputedData.no-match-text" :no-data-text="tSelectx0x3ComputedData.no-data-text" :c-style="tSelectx0x3ComputedData.cStyle"></t-select><t-rect id="t-rect-4ed7.664206f84" class="videoWarningReal-t-rect-0-4"  :tip="tRectx0x4ComputedData.tip" :label="tRectx0x4ComputedData.label" :active="tRectx0x4ComputedData.active" :c-style="tRectx0x4ComputedData.cStyle"></t-rect><t-rect id="t-rect-a1cf.fdeeb7749" class="videoWarningReal-t-rect-0-5"  :tip="tRectx0x5ComputedData.tip" :label="tRectx0x5ComputedData.label" :active="tRectx0x5ComputedData.active" :c-style="tRectx0x5ComputedData.cStyle"></t-rect><t-high-light-text id="t-high-light-text-b1c9.d9b6fabf" class="videoWarningReal-t-high-light-text-0-6"  :fragment-list="replaceCssVariables(filterData(state.warningTextArr, componentPropBindingMap?.['t-high-light-text-b1c9.d9b6fabf']['fragmentList'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :styles="tHighLightTextx0x6ComputedData.styles" :c-style="tHighLightTextx0x6ComputedData.cStyle"></t-high-light-text><t-text-common id="t-text-common-54c0.2ab16d38f" class="videoWarningReal-t-text-common-0-7"  :label="tTextCommonx0x7ComputedData.label" :editable="tTextCommonx0x7ComputedData.editable" :c-style="tTextCommonx0x7ComputedData.cStyle"></t-text-common><t-table id="t-table-f4d9.66b63002d" class="videoWarningReal-t-table-0-8"  :height="tTablex0x8ComputedData.height" :stripe="tTablex0x8ComputedData.stripe" :border="tTablex0x8ComputedData.border" :auto-scroll="tTablex0x8ComputedData.autoScroll" :speed="tTablex0x8ComputedData.speed" :columns="tTablex0x8ComputedData.columns" :data="replaceCssVariables(filterData(state.QYKEResultLYList, componentPropBindingMap?.['t-table-f4d9.66b63002d']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x8ComputedData.defaultSort" :c-style="tTablex0x8ComputedData.cStyle" @cell-click="oncellClick1762410432035_0_0"></t-table></div>
</template>
...
.t-l-c-videoWarningReal .videoWarningReal-t-component-0-0 {
...
.t-l-c-videoWarningReal .videoWarningReal-t-text-0-1 {
position: absolute !important;
top: 6px;
left: 294px;
width: 108px;
...
.t-l-c-videoWarningReal .videoWarningReal-t-text-unit-0-2 {
position: absolute !important;
top: 6px;
left: 35px;
width: 261px;
...
.t-l-c-videoWarningReal .videoWarningReal-t-select-0-3 {
position: absolute !important;
top: 46px;
left: 113px;
width: 295px;
...
.t-l-c-videoWarningReal .videoWarningReal-t-rect-0-4 {
position: absolute !important;
top: 100px;
left: -1px;
width: 410px;
...
.t-l-c-videoWarningReal .videoWarningReal-t-rect-0-5 {
position: absolute !important;
top: 112px;
left: 15px;
width: 18px;
...
.t-l-c-videoWarningReal .videoWarningReal-t-high-light-text-0-6 {
position: absolute !important;
top: 100px;
left: 45px;
width: 364px;
...
.t-l-c-videoWarningReal .videoWarningReal-t-text-common-0-7 {
position: absolute !important;
top: 53px;
left: 6px;
width: 89px;
...
.t-l-c-videoWarningReal .videoWarningReal-t-table-0-8 {
position: absolute !important;
top: 156px;
left: 0px;
width: 409px;

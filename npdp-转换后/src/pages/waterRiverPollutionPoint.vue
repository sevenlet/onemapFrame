<template>
  <div id="t-l-c-waterRiverPollutionPoint" class="t-l-c-waterRiverPollutionPoint" ><t-rect id="t-rect-8252.1a4ade4f4" class="waterRiverPollutionPoint-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle"></t-rect><t-rect id="t-rect-e3a7.d7772ec8d" class="waterRiverPollutionPoint-t-rect-0-1"  :tip="tRectx0x1ComputedData.tip" :label="tRectx0x1ComputedData.label" :active="tRectx0x1ComputedData.active" :c-style="tRectx0x1ComputedData.cStyle"></t-rect><t-text id="t-text-8cba.b16affff7" class="waterRiverPollutionPoint-t-text-0-2"  :label="state.pointNameSource" :editable="tTextx0x2ComputedData.editable" :c-style="tTextx0x2ComputedData.cStyle" :show-title="tTextx0x2ComputedData.showTitle"></t-text><t-rect id="t-rect-da62.857f90ab" class="waterRiverPollutionPoint-t-rect-0-3"  :tip="tRectx0x3ComputedData.tip" :label="tRectx0x3ComputedData.label" :active="tRectx0x3ComputedData.active" :c-style="tRectx0x3ComputedData.cStyle" @click="onclick1733817210174"></t-rect><t-text id="t-text-738d.67fdf6baf" class="waterRiverPollutionPoint-t-text-0-4"  :label="tTextx0x4ComputedData.label" :editable="tTextx0x4ComputedData.editable" :c-style="tTextx0x4ComputedData.cStyle"></t-text><t-list-card id="t-list-card-1afd.46c2cc26d" class="waterRiverPollutionPoint-t-list-card-0-5"  :data="state.cardList" :spacing-x="tListCardx0x5ComputedData.spacingX" :col="tListCardx0x5ComputedData.col" :direction="tListCardx0x5ComputedData.direction" :exchange-order="tListCardx0x5ComputedData.exchangeOrder" :unit-break="tListCardx0x5ComputedData.unitBreak" :key-field="tListCardx0x5ComputedData.keyField" :active-key-field="tListCardx0x5ComputedData.activeKeyField" :active="tListCardx0x5ComputedData.active" :c-style="tListCardx0x5ComputedData.cStyle"></t-list-card><t-row id="t-row-1aec.588d3a901" class="waterRiverPollutionPoint-t-row-0-6"  :c-style="tRowx0x6ComputedData.cStyle" :gutter="tRowx0x6ComputedData.gutter" :justify="tRowx0x6ComputedData.justify" :align="tRowx0x6ComputedData.align"><t-text id="t-text-0df0.1c50452" class="waterRiverPollutionPoint-t-text-0-6-0"  :label="tTextx0x6x0ComputedData.label" :editable="tTextx0x6x0ComputedData.editable" :c-style="tTextx0x6x0ComputedData.cStyle" @click="onclick1734499551425"></t-text></t-row></div>
</template>
...
<style scoped>
.t-l-c-waterRiverPollutionPoint {
position: relative;
overflow: hidden;
...
.t-l-c-waterRiverPollutionPoint .waterRiverPollutionPoint-t-rect-0-0 {
...
.t-l-c-waterRiverPollutionPoint .waterRiverPollutionPoint-t-rect-0-1 {
position: absolute !important;
top: 0px;
left: 0px;
width: 450px;
...
.t-l-c-waterRiverPollutionPoint .waterRiverPollutionPoint-t-text-0-2 {
position: absolute !important;
...
.t-l-c-waterRiverPollutionPoint .waterRiverPollutionPoint-t-rect-0-3 {
position: absolute !important;
...
.t-l-c-waterRiverPollutionPoint .waterRiverPollutionPoint-t-text-0-4 {
position: absolute !important;
...
.t-l-c-waterRiverPollutionPoint .waterRiverPollutionPoint-t-list-card-0-5 {
position: absolute !important;
top: 64px;
left: 20px;
width: 410px;
...
.t-l-c-waterRiverPollutionPoint .waterRiverPollutionPoint-t-row-0-6 {
position: absolute !important;
top: 328px;
left: 0px;
width: 430px;
...
.t-l-c-waterRiverPollutionPoint .waterRiverPollutionPoint-t-text-0-6-0 {
position: unset;

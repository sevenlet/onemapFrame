<template>
  <div id="t-l-c-travelingVehicleList" class="t-l-c-travelingVehicleList" ><t-table id="t-table-80e0.6d181a57a" class="travelingVehicleList-t-table-0-0"  :height="tTablex0x0ComputedData.height" :stripe="tTablex0x0ComputedData.stripe" :border="tTablex0x0ComputedData.border" :auto-scroll="tTablex0x0ComputedData.autoScroll" :speed="tTablex0x0ComputedData.speed" :columns="tTablex0x0ComputedData.columns" :data="replaceCssVariables(filterData(state.listData, componentPropBindingMap?.['t-table-80e0.6d181a57a']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x0ComputedData.defaultSort" :c-style="tTablex0x0ComputedData.cStyle" @cell-click="oncellClick1765100518646"></t-table></div>
</template>
...
tTablex0x0: {
defaultStyle: {
            default: {"width":"410px","height":"760px","paddingTop":"0px","borderBottom":"0px solid ","animationName":"","--el-text-color-secondary":"var(--business-show-bg60)","marginBottom":"12px"},
...
/* 接收socket.io消息 */
const onSocketChangeebcb15d0960d4b5a9747 = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChangeebcb15d0960d4b5a9747);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChangeebcb15d0960d4b5a9747);
});
// 执行自定义方法
injectData();
onMounted(() => {

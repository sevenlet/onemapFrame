<template>
  <div id="t-l-c-dissolvedOxygenPrediction" class="t-l-c-dissolvedOxygenPrediction" ><t-row id="t-row-12f5.ae7dd69ad" class="dissolvedOxygenPrediction-t-row-0-0"  :c-style="tRowx0x0ComputedData.cStyle" :gutter="tRowx0x0ComputedData.gutter" :justify="tRowx0x0ComputedData.justify" :align="tRowx0x0ComputedData.align"><t-col id="t-col-4292.5f9aba444" class="dissolvedOxygenPrediction-t-col-0-0-0"  :span="tColx0x0x0ComputedData.span" :offset="tColx0x0x0ComputedData.offset" :push="tColx0x0x0ComputedData.push" :pull="tColx0x0x0ComputedData.pull" :c-style="tColx0x0x0ComputedData.cStyle"></t-col><t-col id="t-col-1135.218b5344e" class="dissolvedOxygenPrediction-t-col-0-0-1"  :span="tColx0x0x1ComputedData.span" :offset="tColx0x0x1ComputedData.offset" :push="tColx0x0x1ComputedData.push" :pull="tColx0x0x1ComputedData.pull" :c-style="tColx0x0x1ComputedData.cStyle"></t-col><t-col id="t-col-7c0c.5412e7222" class="dissolvedOxygenPrediction-t-col-0-0-2"  :span="tColx0x0x2ComputedData.span" :offset="tColx0x0x2ComputedData.offset" :push="tColx0x0x2ComputedData.push" :pull="tColx0x0x2ComputedData.pull" :c-style="tColx0x0x2ComputedData.cStyle"><t-chart-design id="t-chart-design-c5c8.a4774dfbe" class="dissolvedOxygenPrediction-t-chart-design-0-0-2-0"  :empty-img="tChartDesignx0x0x2x0ComputedData.emptyImg" :c-style="tChartDesignx0x0x2x0ComputedData.cStyle" :options="replaceCssVariables(filterData(state.variationTrendData.chartOptions, componentPropBindingMap?.['t-chart-design-c5c8.a4774dfbe']['options'].filters || []), global?.theme || global?.activeTheme || '默认主题')"></t-chart-design></t-col><t-col id="t-col-07cf.05a8e8c47" class="dissolvedOxygenPrediction-t-col-0-0-3"  :span="tColx0x0x3ComputedData.span" :offset="tColx0x0x3ComputedData.offset" :push="tColx0x0x3ComputedData.push" :pull="tColx0x0x3ComputedData.pull" :c-style="tColx0x0x3ComputedData.cStyle"><t-table id="t-table-08de.61e675df4" class="dissolvedOxygenPrediction-t-table-0-0-3-0"  :height="tTablex0x0x3x0ComputedData.height" :stripe="tTablex0x0x3x0ComputedData.stripe" :border="tTablex0x0x3x0ComputedData.border" :auto-scroll="tTablex0x0x3x0ComputedData.autoScroll" :speed="tTablex0x0x3x0ComputedData.speed" :columns="tTablex0x0x3x0ComputedData.columns" :data="replaceCssVariables(filterData(state.tableData, componentPropBindingMap?.['t-table-08de.61e675df4']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x0x3x0ComputedData.defaultSort" :c-style="tTablex0x0x3x0ComputedData.cStyle"></t-table></t-col></t-row><t-row id="t-row-6154.4ed2135d1" class="dissolvedOxygenPrediction-t-row-0-1"  :c-style="tRowx0x1ComputedData.cStyle" :gutter="tRowx0x1ComputedData.gutter" :justify="tRowx0x1ComputedData.justify" :align="tRowx0x1ComputedData.align"></t-row><t-component id="t-component-566a.7daef950a" class="dissolvedOxygenPrediction-t-component-0-2"  :name="tComponentx0x2ComputedData.name" :loading="tComponentx0x2ComputedData.loading" :c-style="tComponentx0x2ComputedData.cStyle" :src="tComponentx0x2ComputedData.src" :component-name="tComponentx0x2ComputedData.componentName" :page-id="tComponentx0x2ComputedData.pageId" :page-code="tComponentx0x2ComputedData.pageCode"></t-component><t-text id="t-text-9a20.6469293a3" class="dissolvedOxygenPrediction-t-text-0-3"  :label="tTextx0x3ComputedData.label" :editable="tTextx0x3ComputedData.editable" :c-style="tTextx0x3ComputedData.cStyle"></t-text><t-row id="t-row-0f73.cf7be687e" class="dissolvedOxygenPrediction-t-row-0-4"  :c-style="tRowx0x4ComputedData.cStyle" :gutter="tRowx0x4ComputedData.gutter" :justify="tRowx0x4ComputedData.justify" :align="tRowx0x4ComputedData.align"><t-col id="t-col-a032.e90d917a2" class="dissolvedOxygenPrediction-t-col-0-4-0"  :span="tColx0x4x0ComputedData.span" :offset="tColx0x4x0ComputedData.offset" :push="tColx0x4x0ComputedData.push" :pull="tColx0x4x0ComputedData.pull" :c-style="tColx0x4x0ComputedData.cStyle"><t-text id="t-text-b6da.ea5c0e651" class="dissolvedOxygenPrediction-t-text-0-4-0-0"  :label="tTextx0x4x0x0ComputedData.label" :editable="tTextx0x4x0x0ComputedData.editable" :c-style="tTextx0x4x0x0ComputedData.cStyle"></t-text><t-switch id="t-switch-914d.6251c8372" class="dissolvedOxygenPrediction-t-switch-0-4-0-1"  :value="replaceCssVariables(filterData(state.isBz, componentPropBindingMap?.['t-switch-914d.6251c8372']['value'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :c-style="tSwitchx0x4x0x1ComputedData.cStyle" @change="onchange1769408639859"></t-switch></t-col><t-col id="t-col-cc2b.451f2d1f" class="dissolvedOxygenPrediction-t-col-0-4-1"  :span="tColx0x4x1ComputedData.span" :offset="tColx0x4x1ComputedData.offset" :push="tColx0x4x1ComputedData.push" :pull="tColx0x4x1ComputedData.pull" :c-style="tColx0x4x1ComputedData.cStyle"></t-col><t-col id="t-col-d86d.1bd2b0f7f" class="dissolvedOxygenPrediction-t-col-0-4-2"  :span="tColx0x4x2ComputedData.span" :offset="tColx0x4x2ComputedData.offset" :push="tColx0x4x2ComputedData.push" :pull="tColx0x4x2ComputedData.pull" :c-style="tColx0x4x2ComputedData.cStyle"><t-select id="t-select-74eb.bb6a35c83" class="dissolvedOxygenPrediction-t-select-0-4-2-0"  :active-value="replaceCssVariables(filterData(state.selectedValue, componentPropBindingMap?.['t-select-74eb.bb6a35c83']['activeValue'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :options="replaceCssVariables(filterData(state.options, componentPropBindingMap?.['t-select-74eb.bb6a35c83']['options'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :alias="tSelectx0x4x2x0ComputedData.alias" :multiple="tSelectx0x4x2x0ComputedData.multiple" :placeholder="tSelectx0x4x2x0ComputedData.placeholder" :clearable="tSelectx0x4x2x0ComputedData.clearable" :disabled="tSelectx0x4x2x0ComputedData.disabled" :name="tSelectx0x4x2x0ComputedData.name" :autocomplete="tSelectx0x4x2x0ComputedData.autocomplete" :filterable="tSelectx0x4x2x0ComputedData.filterable" :no-match-text="tSelectx0x4x2x0ComputedData.no-match-text" :no-data-text="tSelectx0x4x2x0ComputedData.no-data-text" :c-style="tSelectx0x4x2x0ComputedData.cStyle" @change="onchange1770010190906"></t-select></t-col></t-row></div>
</template>
...
import { TChartDesign, TCol, TComponent, TRow, TSelect, TSwitch, TTable, TText } from '@ths/design';
    ...
    return {
      ...
      tooltip: {
        ...
        formatter: (formatterParams) => {
          ...
          const first = list[0];
          let name = first?.data?.tooltipXAxisLabel || first?.name || '--';
          let str = '';
          list.forEach((item) => {
...
const applyForecastChartData = (list) => {
    ...
    const step = 0.1;
        ...
        let series = Object.keys(groupMap).map((code) => {
          const group = groupMap[code] || [];
          let name = group?.[0]?.POINT_NAME ? String(group[0].POINT_NAME) : code;
...
<style scoped>
.t-l-c-dissolvedOxygenPrediction {
position: relative;
overflow: hidden;
...
.t-l-c-dissolvedOxygenPrediction .dissolvedOxygenPrediction-t-row-0-0 {
...
.t-l-c-dissolvedOxygenPrediction .dissolvedOxygenPrediction-t-col-0-0-0 {
position: relative;
top: null;
left: null;
width: 100px;
...
justify-content: center;
align-items: center;
background: rgba(150, 30, 30, 0);
fill-type: color;
}

.t-l-c-dissolvedOxygenPrediction .dissolvedOxygenPrediction-t-col-0-0-1 {
position: relative;
top: null;
left: null;
width: 100px;
...
.t-l-c-dissolvedOxygenPrediction .dissolvedOxygenPrediction-t-col-0-0-2 {
position: relative;
top: null;
left: null;
width: 100px;
...
.t-l-c-dissolvedOxygenPrediction .dissolvedOxygenPrediction-t-chart-design-0-0-2-0 {
position: unset;
top: 79px;
left: 0px;
width: 100%;
...
.t-l-c-dissolvedOxygenPrediction .dissolvedOxygenPrediction-t-col-0-0-3 {
position: relative;
top: null;
left: null;
width: 100px;
...
.t-l-c-dissolvedOxygenPrediction .dissolvedOxygenPrediction-t-table-0-0-3-0 {
position: unset;
top: 298px;
left: 0px;
width: 100%;
...
.t-l-c-dissolvedOxygenPrediction .dissolvedOxygenPrediction-t-row-0-1 {
position: absolute !important;
top: 0px;
left: 0px;
width: 100%;
...
.t-l-c-dissolvedOxygenPrediction .dissolvedOxygenPrediction-t-component-0-2 {
position: absolute !important;
top: 0px;
left: 0px;
width: 100%;
...
.t-l-c-dissolvedOxygenPrediction .dissolvedOxygenPrediction-t-text-0-3 {
position: absolute !important;
top: 0px;
left: 41px;
width: 150px;
...
.t-l-c-dissolvedOxygenPrediction .dissolvedOxygenPrediction-t-row-0-4 {
position: absolute !important;
top: 46px;
left: 1px;
width: 100%;
...
.t-l-c-dissolvedOxygenPrediction .dissolvedOxygenPrediction-t-col-0-4-0 {
position: relative;
top: null;
left: null;
width: 100px;
...
.t-l-c-dissolvedOxygenPrediction .dissolvedOxygenPrediction-t-text-0-4-0-0 {
position: unset;
top: 337px;
left: 736px;
width: auto;
...
.t-l-c-dissolvedOxygenPrediction .dissolvedOxygenPrediction-t-switch-0-4-0-1 {
position: unset;
top: 338px;
left: 801px;
width: 32px;
...
.t-l-c-dissolvedOxygenPrediction .dissolvedOxygenPrediction-t-col-0-4-1 {
position: relative;
top: null;
left: null;
width: 100px;
...
.t-l-c-dissolvedOxygenPrediction .dissolvedOxygenPrediction-t-col-0-4-2 {
position: relative;
top: null;
left: null;
width: 100px;
...
.t-l-c-dissolvedOxygenPrediction .dissolvedOxygenPrediction-t-select-0-4-2-0 {
position: unset;
top: 79px;
left: 42px;
width: 205px;

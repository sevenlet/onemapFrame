...
return new Promise((resolve, reject) => {
  http({"url":global.serviceBasePath,"method":"get","baseURL":global.foshanServiceBaseUrl,"params":{"WATER_CODE":state.WATER_CODE,"BRANCH_NAME":"支涌","WSYSTEM_CODE":state.WSYSTEM_CODE,"KEYWORD":state.name,"REGION_CODE":"","interfaceId":"faa5fa1f0985f82b86f045bff2bc1be4"},}).then((res) => {
     // 成功的操作
...
deep: true, // 深度监听
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-shjysZl', global.appScaleMode, 'normal');
...
.t-l-c-shjysZl .shjysZl-t-search-0-0 {
...
.t-l-c-shjysZl .shjysZl-t-button-0-1 {
position: absolute !important;
top: 0px;
left: 353px;
width: 49px;
...
.t-l-c-shjysZl .shjysZl-t-table-0-2 {
position: absolute !important;
top: 40px;
left: 8px;
width: 394px;

<template>
  <div id="t-l-c-shjysZghc" class="t-l-c-shjysZghc" ><t-search id="t-search-f587.478ec4a0f" class="shjysZghc-t-search-0-0"  :type="tSearchx0x0ComputedData.type" :input-value="replaceCssVariables(state.name, global?.theme || global?.activeTheme || '默认主题')" :maxlength="tSearchx0x0ComputedData.maxlength" :minlength="tSearchx0x0ComputedData.minlength" :show-word-limit="tSearchx0x0ComputedData.showWordLimit" :placeholder="tSearchx0x0ComputedData.placeholder" :clearable="tSearchx0x0ComputedData.clearable" :show-password="tSearchx0x0ComputedData.showPassword" :disabled="tSearchx0x0ComputedData.disabled" :prefix-icon="tSearchx0x0ComputedData.prefix-icon" :suffix-icon="tSearchx0x0ComputedData.suffix-icon" :rows="tSearchx0x0ComputedData.rows" :autosize="tSearchx0x0ComputedData.autosize" :name="tSearchx0x0ComputedData.name" :readonly="tSearchx0x0ComputedData.readonly" :step="tSearchx0x0ComputedData.step" :autofocus="tSearchx0x0ComputedData.autofocus" :form="tSearchx0x0ComputedData.form" :label="tSearchx0x0ComputedData.label" :tabindex="tSearchx0x0ComputedData.tabindex" :validate-event="tSearchx0x0ComputedData.validateEvent" :c-style="tSearchx0x0ComputedData.cStyle" :has-search-btn="tSearchx0x0ComputedData.hasSearchBtn" @input="oninput1738745314318"></t-search><t-button id="t-button-888b.3eae03772" class="shjysZghc-t-button-0-1"  :label="tButtonx0x1ComputedData.label" :round="tButtonx0x1ComputedData.round" :plain="tButtonx0x1ComputedData.plain" :disabled="tButtonx0x1ComputedData.disabled" :type="tButtonx0x1ComputedData.type" :size="tButtonx0x1ComputedData.size" :native-type="tButtonx0x1ComputedData.native-type" :c-style="tButtonx0x1ComputedData.cStyle" @click="onclick1739351815507"></t-button><t-table id="t-table-3144.232785c32" class="shjysZghc-t-table-0-2"  :height="tTablex0x2ComputedData.height" :stripe="tTablex0x2ComputedData.stripe" :border="tTablex0x2ComputedData.border" :auto-scroll="tTablex0x2ComputedData.autoScroll" :speed="tTablex0x2ComputedData.speed" :columns="tTablex0x2ComputedData.columns" :data="replaceCssVariables(state.data, global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x2ComputedData.defaultSort" :c-style="tTablex0x2ComputedData.cStyle" @cell-click="oncellClick1739352040691"></t-table></div>
</template>
...
const oncellClick1739352040691 = (row,column,cell,event) => {
// 执行自定义方法
...
return new Promise((resolve, reject) => {
  http({"url":global.serviceBasePath,"method":"get","baseURL":global.foshanServiceBaseUrl,"params":{"WATER_CODE":state.WATER_CODE,"BRANCH_NAME":"主干河涌","WSYSTEM_CODE":state.WSYSTEM_CODE,"KEYWORD":state.name,"REGION_CODE":"","interfaceId":"faa5fa1f0985f82b86f045bff2bc1be4"},}).then((res) => {
     // 成功的操作
     console.log('关联支涌列表', res.data)
...
deep: true, // 深度监听
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-shjysZghc', global.appScaleMode, 'normal');
...
onclick1739351815507,
oncellClick1739352040691,
};
},
}
</script>
...
.t-l-c-shjysZghc .shjysZghc-t-search-0-0 {
...
.t-l-c-shjysZghc .shjysZghc-t-button-0-1 {
position: absolute !important;
top: 0px;
left: 353px;
width: 49px;
...
.t-l-c-shjysZghc .shjysZghc-t-table-0-2 {
position: absolute !important;
top: 40px;
left: 8px;
width: 394px;

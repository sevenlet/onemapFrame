<template>
  <div id="t-l-c-lawEnforcerEntry" class="t-l-c-lawEnforcerEntry" ><t-component id="t-component-5c87.a35bbde46" class="lawEnforcerEntry-t-component-0-1"  :name="tComponentx0x1ComputedData.name" :loading="tComponentx0x1ComputedData.loading" :c-style="tComponentx0x1ComputedData.cStyle" :src="tComponentx0x1ComputedData.src" :component-name="tComponentx0x1ComputedData.componentName" :page-id="tComponentx0x1ComputedData.pageId" :page-code="tComponentx0x1ComputedData.pageCode"></t-component><t-text-unit id="t-text-unit-9dee.e75bc54ed" class="lawEnforcerEntry-t-text-unit-0-2"  :c-style="tTextUnitx0x2ComputedData.cStyle" :content="tTextUnitx0x2ComputedData.content" :unit="tTextUnitx0x2ComputedData.unit" :show-overflow-tooltip="tTextUnitx0x2ComputedData.showOverflowTooltip"></t-text-unit><t-component id="t-component-13ad.4ef5b3948" class="lawEnforcerEntry-t-component-0-3"  :name="tComponentx0x3ComputedData.name" :loading="tComponentx0x3ComputedData.loading" :c-style="tComponentx0x3ComputedData.cStyle" :src="tComponentx0x3ComputedData.src" :component-name="tComponentx0x3ComputedData.componentName" :page-id="tComponentx0x3ComputedData.pageId" :page-code="tComponentx0x3ComputedData.pageCode"></t-component></div>
</template>
...
tComponentx0x3: {
defaultStyle: {
            default: {"width":"403px","height":"696px","margin":"0 auto","position":"unset","left":"26px","top":"72px"},
            
            },
 default: { 
 
name:"lawEnforcerEntryListComponent",
loading:true,
cStyle:{"wrapper":{"default":{"width":"403px","height":"696px","margin":"0 auto","position":"unset","left":"26px","top":"72px"}}},
src:"/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/index.html#/lawEnforcerEntryList",
componentName:"lawEnforcerEntryListComponent",
pageId:"ba0d117b90c04b27a81de5d66f3a9361",
pageCode:"lawEnforcerEntryList", 
 },
},
});
...
if (head.statusCode === '200' && data.length) {
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-lawEnforcerEntry', global.appScaleMode, 'normal');
...
.t-l-c-lawEnforcerEntry .lawEnforcerEntry-t-component-0-1 {
...
.t-l-c-lawEnforcerEntry .lawEnforcerEntry-t-text-unit-0-2 {
position: absolute !important;
top: 28px;
left: 59px;
width: 282px;
...
.t-l-c-lawEnforcerEntry .lawEnforcerEntry-t-component-0-3 {
position: absolute !important;
top: 72px;
left: 26px;
width: 403px;

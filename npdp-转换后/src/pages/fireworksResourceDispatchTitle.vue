<template>
  <div id="t-l-c-fireworksResourceDispatchTitle" class="t-l-c-fireworksResourceDispatchTitle" ><t-component id="t-component-ded9.0f5a924fa" class="fireworksResourceDispatchTitle-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName"></t-component><t-text id="t-text-4f99.3a44d10f5" class="fireworksResourceDispatchTitle-t-text-0-1"  :label="tTextx0x1ComputedData.label" :editable="tTextx0x1ComputedData.editable" :c-style="tTextx0x1ComputedData.cStyle"></t-text></div>
</template>
...
export default {
  ...
  setup() {
const componentPropBindingMap = {"body":{"attributeName":"tBodyx0x0"},"t-component-ded9.0f5a924fa":{"attributeName":"tComponentx0x0","name":{"filters":[]},"cStyle":{"filters":[]},"src":{"filters":[]},"componentName":{"filters":[]}},"t-text-4f99.3a44d10f5":{"attributeName":"tTextx0x1","label":{"filters":[]},"editable":{"filters":[]},"cStyle":{"filters":[]}}};
// 页面内注入全局变量和事件
...
tTextx0x1: {
defaultStyle: {
            default: {"width":"177px","height":"31px","color":"rgba(255, 255, 255, 0.9)","position":"unset","left":"40px","top":"1px","fontFamily":"方正综艺","fontSize":"var(--business-text-size-20)","animationName":"","letterSpacing":"2px","lineHeight":"31px"},
...
label:"点位清单",
editable:false,
cStyle:{"wrapper":{"default":{"width":"177px","height":"31px","color":"rgba(255, 255, 255, 0.9)","position":"unset","left":"40px","top":"1px","fontFamily":"方正综艺","fontSize":"var(--business-text-size-20)","animationName":"","letterSpacing":"2px","lineHeight":"31px"}}}, 
 },
},
});let apiRegistry = {}; 

 function handleWindowResize() {
                            setPageScale('t-l-c-fireworksResourceDispatchTitle', global.appScaleMode, 'normal');
...
<style scoped>
.t-l-c-fireworksResourceDispatchTitle {
position: relative;
overflow: hidden;
...
.t-l-c-fireworksResourceDispatchTitle .fireworksResourceDispatchTitle-t-component-0-0 {
...
.t-l-c-fireworksResourceDispatchTitle .fireworksResourceDispatchTitle-t-text-0-1 {
position: absolute !important;
top: 1px;
left: 40px;
width: 177px;

<template>
  <div id="t-l-c-wrfxOld" class="t-l-c-wrfxOld" ><t-rect v-if="state.listLoading === true" id="t-rect-04fa.ba844241f" class="pollutionAnalysis-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle"></t-rect><t-rect v-if="state.cardLoading === true" id="t-rect-82e1.1a78bdcce" class="pollutionAnalysis-t-rect-0-1"  :tip="tRectx0x1ComputedData.tip" :label="tRectx0x1ComputedData.label" :active="tRectx0x1ComputedData.active" :c-style="tRectx0x1ComputedData.cStyle"></t-rect><t-button id="t-button-2397.b3b568691" class="pollutionAnalysis-t-button-0-3"  :label="tButtonx0x3ComputedData.label" :round="tButtonx0x3ComputedData.round" :plain="tButtonx0x3ComputedData.plain" :disabled="tButtonx0x3ComputedData.disabled" :type="tButtonx0x3ComputedData.type" :size="tButtonx0x3ComputedData.size" :native-type="tButtonx0x3ComputedData.native-type" :c-style="tButtonx0x3ComputedData.cStyle" @click="onclick1761120647351"></t-button><t-image-base id="t-image-base-cc01.3413a106e" class="pollutionAnalysis-t-image-base-0-4"  :src="tImageBasex0x4ComputedData.src" :fit="tImageBasex0x4ComputedData.fit" :c-style="tImageBasex0x4ComputedData.cStyle"></t-image-base><t-list-card v-if="state.cardLoading === false" id="t-list-card-2d95.1c787b696" class="pollutionAnalysis-t-list-card-0-5"  :data="replaceCssVariables(filterData(state.sceneList, componentPropBindingMap?.['t-list-card-2d95.1c787b696']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :spacing-x="tListCardx0x5ComputedData.spacingX" :col="tListCardx0x5ComputedData.col" :direction="tListCardx0x5ComputedData.direction" :exchange-order="tListCardx0x5ComputedData.exchangeOrder" :unit-break="tListCardx0x5ComputedData.unitBreak" :key-field="tListCardx0x5ComputedData.keyField" :active-key-field="tListCardx0x5ComputedData.activeKeyField" :active="replaceCssVariables(filterData(state.activeTab.name, componentPropBindingMap?.['t-list-card-2d95.1c787b696']['active'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :c-style="tListCardx0x5ComputedData.cStyle" @card-click="oncardClick1735029005919"></t-list-card><t-rect id="t-rect-364c.0469d38c2" class="pollutionAnalysis-t-rect-0-6"  :tip="tRectx0x6ComputedData.tip" :label="tRectx0x6ComputedData.label" :active="tRectx0x6ComputedData.active" :c-style="tRectx0x6ComputedData.cStyle"></t-rect><t-table v-if="state.listLoading === false" id="t-table-a0d0.258b53cfd" class="pollutionAnalysis-t-table-0-7"  :height="tTablex0x7ComputedData.height" :stripe="tTablex0x7ComputedData.stripe" :border="tTablex0x7ComputedData.border" :auto-scroll="tTablex0x7ComputedData.autoScroll" :speed="tTablex0x7ComputedData.speed" :columns="tTablex0x7ComputedData.columns" :data="replaceCssVariables(filterData(state.enterList, componentPropBindingMap?.['t-table-a0d0.258b53cfd']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x7ComputedData.defaultSort" :c-style="tTablex0x7ComputedData.cStyle" @cell-click="oncellClick1735184769666_0_0"></t-table><t-component id="t-component-3c7c.d9e5b9971" class="pollutionAnalysis-t-component-0-8"  :name="tComponentx0x8ComputedData.name" :c-style="tComponentx0x8ComputedData.cStyle" :src="tComponentx0x8ComputedData.src" :component-name="tComponentx0x8ComputedData.componentName"></t-component><t-text id="t-text-0645.e3c5af32d" class="pollutionAnalysis-t-text-0-9"  :label="tTextx0x9ComputedData.label" :editable="tTextx0x9ComputedData.editable" :c-style="tTextx0x9ComputedData.cStyle"></t-text><t-rect v-if="state.checkedIds !== ''" id="t-rect-f258.31abd13a7" class="pollutionAnalysis-t-rect-0-10"  :tip="tRectx0x10ComputedData.tip" :label="tRectx0x10ComputedData.label" :active="tRectx0x10ComputedData.active" :c-style="tRectx0x10ComputedData.cStyle" @click="onclick1735205190641"></t-rect><t-rect v-if="state.checkedIds === ''" id="t-rect-caab.15629254d" class="pollutionAnalysis-t-rect-0-11"  :tip="tRectx0x11ComputedData.tip" :label="tRectx0x11ComputedData.label" :active="tRectx0x11ComputedData.active" :c-style="tRectx0x11ComputedData.cStyle"></t-rect><t-text id="t-text-5454.74c04491" class="pollutionAnalysis-t-text-0-13"  :label="tTextx0x13ComputedData.label" :editable="tTextx0x13ComputedData.editable" :c-style="tTextx0x13ComputedData.cStyle"></t-text><t-text id="t-text-a89a.7e30697e2" class="pollutionAnalysis-t-text-0-14"  :label="tTextx0x14ComputedData.label" :editable="tTextx0x14ComputedData.editable" :c-style="tTextx0x14ComputedData.cStyle"></t-text><t-text id="t-text-49e3.b2374108a" class="pollutionAnalysis-t-text-0-15"  :label="tTextx0x15ComputedData.label" :editable="tTextx0x15ComputedData.editable" :c-style="tTextx0x15ComputedData.cStyle"></t-text><t-text id="t-text-3797.0a506c66b" class="pollutionAnalysis-t-text-0-16"  :label="tTextx0x16ComputedData.label" :editable="tTextx0x16ComputedData.editable" :c-style="tTextx0x16ComputedData.cStyle"></t-text><t-radio id="t-radio-7049.20f57b6cf" class="pollutionAnalysis-t-radio-0-17"  :options="tRadiox0x17ComputedData.options" :active="replaceCssVariables(filterData(state.selectedParams.direction, componentPropBindingMap?.['t-radio-7049.20f57b6cf']['active'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :alias="tRadiox0x17ComputedData.alias" :disabled="tRadiox0x17ComputedData.disabled" :border="tRadiox0x17ComputedData.border" :size="tRadiox0x17ComputedData.size" :is-use-button="tRadiox0x17ComputedData.isUseButton" :c-style="tRadiox0x17ComputedData.cStyle" @change="onchange1740720896505"></t-radio><t-radio id="t-radio-f568.197f4f8a6" class="pollutionAnalysis-t-radio-0-18"  :options="tRadiox0x18ComputedData.options" :active="replaceCssVariables(filterData(state.selectedParams.buffer, componentPropBindingMap?.['t-radio-f568.197f4f8a6']['active'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :alias="tRadiox0x18ComputedData.alias" :disabled="tRadiox0x18ComputedData.disabled" :border="tRadiox0x18ComputedData.border" :size="tRadiox0x18ComputedData.size" :is-use-button="tRadiox0x18ComputedData.isUseButton" :c-style="tRadiox0x18ComputedData.cStyle" @change="onchange1740720921561"></t-radio><t-checkbox id="t-checkbox-3380.5456a8ecb" class="pollutionAnalysis-t-checkbox-0-19"  :data="tCheckboxx0x19ComputedData.data" :active="replaceCssVariables(filterData(state.selectedParams.altitude, componentPropBindingMap?.['t-checkbox-3380.5456a8ecb']['active'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :data-alias="tCheckboxx0x19ComputedData.dataAlias" :border="tCheckboxx0x19ComputedData.border" :use-button="tCheckboxx0x19ComputedData.useButton" :c-style="tCheckboxx0x19ComputedData.cStyle" @change="onchange1740720873822"></t-checkbox><t-rect id="t-rect-0b21.228388b5a" class="pollutionAnalysis-t-rect-0-20"  :tip="tRectx0x20ComputedData.tip" :label="tRectx0x20ComputedData.label" :active="tRectx0x20ComputedData.active" :c-style="tRectx0x20ComputedData.cStyle" @click="onclick1740712988309_0_0"></t-rect><t-search id="t-search-fadf.e7800d58b" class="pollutionAnalysis-t-search-0-21"  :type="tSearchx0x21ComputedData.type" :input-value="replaceCssVariables(filterData(state.selectedParams.radius, componentPropBindingMap?.['t-search-fadf.e7800d58b']['inputValue'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :maxlength="tSearchx0x21ComputedData.maxlength" :minlength="tSearchx0x21ComputedData.minlength" :show-word-limit="tSearchx0x21ComputedData.showWordLimit" :placeholder="tSearchx0x21ComputedData.placeholder" :clearable="tSearchx0x21ComputedData.clearable" :show-password="tSearchx0x21ComputedData.showPassword" :disabled="tSearchx0x21ComputedData.disabled" :prefix-icon="tSearchx0x21ComputedData.prefix-icon" :suffix-icon="tSearchx0x21ComputedData.suffix-icon" :rows="tSearchx0x21ComputedData.rows" :autosize="tSearchx0x21ComputedData.autosize" :name="tSearchx0x21ComputedData.name" :readonly="tSearchx0x21ComputedData.readonly" :step="tSearchx0x21ComputedData.step" :autofocus="tSearchx0x21ComputedData.autofocus" :form="tSearchx0x21ComputedData.form" :label="tSearchx0x21ComputedData.label" :tabindex="tSearchx0x21ComputedData.tabindex" :validate-event="tSearchx0x21ComputedData.validateEvent" :c-style="tSearchx0x21ComputedData.cStyle" :has-search-btn="tSearchx0x21ComputedData.hasSearchBtn" @input="oninput1740741929704"></t-search><t-text id="t-text-52c7.b32680ad6" class="pollutionAnalysis-t-text-0-22"  :label="tTextx0x22ComputedData.label" :editable="tTextx0x22ComputedData.editable" :c-style="tTextx0x22ComputedData.cStyle"></t-text></div>
</template>
...
import { TButton, TCheckbox, TComponent, TImageBase, TListCard, TRadio, TRect, TSearch, TTable, TText } from '@ths/design';
...
export default {
  ...
  setup() {
const componentPropBindingMap = {"body":{"attributeName":"tBodyx0x0"},"t-rect-04fa.ba844241f":{"attributeName":"tRectx0x0","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-82e1.1a78bdcce":{"attributeName":"tRectx0x1","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-table-dc13.1454a104c":{"attributeName":"tTablex0x2"},"t-button-2397.b3b568691":{"attributeName":"tButtonx0x3","label":{"filters":[]},"round":{"filters":[]},"plain":{"filters":[]},"disabled":{"filters":[]},"type":{"filters":[]},"size":{"filters":[]},"native-type":{"filters":[]},"cStyle":{"filters":[]}},"t-image-base-cc01.3413a106e":{"attributeName":"tImageBasex0x4","src":{"filters":[]},"fit":{"filters":[]},"cStyle":{"filters":[]}},"t-list-card-2d95.1c787b696":{"attributeName":"tListCardx0x5","data":{"filters":[]},"spacingX":{"filters":[]},"col":{"filters":[]},"direction":{"filters":[]},"exchangeOrder":{"filters":[]},"unitBreak":{"filters":[]},"keyField":{"filters":[]},"activeKeyField":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-364c.0469d38c2":{"attributeName":"tRectx0x6","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-table-a0d0.258b53cfd":{"attributeName":"tTablex0x7","height":{"filters":[]},"stripe":{"filters":[]},"border":{"filters":[]},"autoScroll":{"filters":[]},"speed":{"filters":[]},"columns":{"filters":[]},"data":{"filters":[]},"defaultSort":{"filters":[]},"cStyle":{"filters":[]}},"t-component-3c7c.d9e5b9971":{"attributeName":"tComponentx0x8","name":{"filters":[]},"cStyle":{"filters":[]},"src":{"filters":[]},"componentName":{"filters":[]}},"t-text-0645.e3c5af32d":{"attributeName":"tTextx0x9","label":{"filters":[]},"editable":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-f258.31abd13a7":{"attributeName":"tRectx0x10","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-caab.15629254d":{"attributeName":"tRectx0x11","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-image-base-7def.74ba3dc2":{"attributeName":"tImageBasex0x12"},"t-text-5454.74c04491":{"attributeName":"tTextx0x13","label":{"filters":[]},"editable":{"filters":[]},"cStyle":{"filters":[]}},"t-text-a89a.7e30697e2":{"attributeName":"tTextx0x14","label":{"filters":[]},"editable":{"filters":[]},"cStyle":{"filters":[]}},"t-text-49e3.b2374108a":{"attributeName":"tTextx0x15","label":{"filters":[]},"editable":{"filters":[]},"cStyle":{"filters":[]}},"t-text-3797.0a506c66b":{"attributeName":"tTextx0x16","label":{"filters":[]},"editable":{"filters":[]},"cStyle":{"filters":[]}},"t-radio-7049.20f57b6cf":{"attributeName":"tRadiox0x17","options":{"filters":[]},"active":{"filters":[]},"alias":{"filters":[]},"disabled":{"filters":[]},"border":{"filters":[]},"size":{"filters":[]},"isUseButton":{"filters":[]},"cStyle":{"filters":[]}},"t-radio-f568.197f4f8a6":{"attributeName":"tRadiox0x18","options":{"filters":[]},"active":{"filters":[]},"alias":{"filters":[]},"disabled":{"filters":[]},"border":{"filters":[]},"size":{"filters":[]},"isUseButton":{"filters":[]},"cStyle":{"filters":[]}},"t-checkbox-3380.5456a8ecb":{"attributeName":"tCheckboxx0x19","data":{"filters":[]},"active":{"filters":[]},"dataAlias":{"filters":[]},"border":{"filters":[]},"useButton":{"filters":[]},"cStyle":{"filters":[]}},"t-rect-0b21.228388b5a":{"attributeName":"tRectx0x20","tip":{"filters":[]},"label":{"filters":[]},"active":{"filters":[]},"cStyle":{"filters":[]}},"t-search-fadf.e7800d58b":{"attributeName":"tSearchx0x21","type":{"filters":[]},"inputValue":{"filters":[]},"maxlength":{"filters":[]},"minlength":{"filters":[]},"showWordLimit":{"filters":[]},"placeholder":{"filters":[]},"clearable":{"filters":[]},"showPassword":{"filters":[]},"disabled":{"filters":[]},"prefix-icon":{"filters":[]},"suffix-icon":{"filters":[]},"rows":{"filters":[]},"autosize":{"filters":[]},"name":{"filters":[]},"readonly":{"filters":[]},"step":{"filters":[]},"autofocus":{"filters":[]},"form":{"filters":[]},"label":{"filters":[]},"tabindex":{"filters":[]},"validateEvent":{"filters":[]},"cStyle":{"filters":[]},"hasSearchBtn":{"filters":[]}},"t-text-52c7.b32680ad6":{"attributeName":"tTextx0x22","label":{"filters":[]},"editable":{"filters":[]},"cStyle":{"filters":[]}}};
// 页面内注入全局变量和事件
...
src:"assets/images/2025-02-28/5b83ceeba3ed47ff9c3db1435d3f1e8e.svg",
fit:"fill",
...
tListCardx0x5: {
defaultStyle: {
            default: {"width":"410px","height":"151px","position":"unset","left":"0px","top":"254px","lineHeight":"18px","animationName":"","paddingRight":"8px","paddingLeft":"8px","backgroundColor":"var(--business-show-bg30)","paddingTop":"8px","paddingBottom":"8px","min-height":"82px"},
...
if (column.label === '定位') {
  ...
  let item = state.enterList.find((val) => val.DATA_PKID === row.DATA_PKID);
  if (item) {
    // 复选
    // dispatchTask(row.DATA_PKID);
    if (item.isCheck === '0') {
...
localStorage.setItem('airTraceSourceActiceTab', JSON.stringify(state.activeTab));

try {
  let listQueryParams = JSON.parse(state.queryJson);
...
rootData.rootOn('rootSocket:change', (data) =>{
    if (data.type === 'filterTag') {
      console.log(data.data, 'filterTag66');
      // 处理逻辑
      localStorage.setItem('airFilterTag', JSON.stringify(data.data))
      // 关闭弹窗
      global.isShowWarningTagFilter = false;
      global.waterGlobalVariables.sourceApportionment.activeTabName = 'wrfxOldComponent';
...
// 接口函数
 getTraceLine: {
              ...
              config: {"url":"airservice/serviceinterface/search/run.action","method":"get","baseURL":"http://222.212.88.209:8089","params":{"height":"state.parentParams.height","forward":"state.parentParams.forward","prediction":"state.parentParams.prediction","cHour":"state.parentParams.cHour","cTime":"state.parentParams.cTime","pTime":"state.parentParams.pTime","lat":"state.parentParams.lat","lon":"state.parentParams.lon","token":"thscityee_sanming","interfaceId":"836e6f38817b7fee388c09ecc372550e"}},
...
return new Promise((resolve, reject) => {
                ...
                http({"url":"airservice/serviceinterface/search/run.action","method":"get","baseURL":"http://222.212.88.209:8089","params":{"height":state.parentParams.height,"forward":state.parentParams.forward,"prediction":state.parentParams.prediction,"cHour":state.parentParams.cHour,"cTime":state.parentParams.cTime,"pTime":state.parentParams.pTime,"lat":state.parentParams.lat,"lon":state.parentParams.lon,"token":"thscityee_sanming","interfaceId":"836e6f38817b7fee388c09ecc372550e"},}).then((res) => {
                   ...
                   // 成功的操作
                   const cacheKey = generateCacheKey('http://222.212.88.209:8089-airservice/serviceinterface/search/run.action',  {"height":state.parentParams.height,"forward":state.parentParams.forward,"prediction":state.parentParams.prediction,"cHour":state.parentParams.cHour,"cTime":state.parentParams.cTime,"pTime":state.parentParams.pTime,"lat":state.parentParams.lat,"lon":state.parentParams.lon,"token":"thscityee_sanming","interfaceId":"836e6f38817b7fee388c09ecc372550e"});
                   
                   apiDataMap[cacheKey] = res.data;
                   apiDataMap['getTraceLine'] = res.data;
...
// 接口函数
 getEnterList: {
              ...
              autoLoad: false, // 自动请求
              bindComponents: [], // 依赖的组件ID列表，可能多个组件绑定一个接口的数据
              config: {"url":"global.serviceBasePath","method":"post","baseURL":"global.serviceBaseUrl","data":"qs.stringify({\"interfaceId\":\"54c0456d112a15810ddedb11a29c986d\",\"queryJson\":\"state.listQueryParams\",\"entityCode\":\"tag_gather_yztdqsy_1735090881279\"})qsstringifyend"},
              request: function ( componentId) {
return new Promise((resolve, reject) => {
                ...
                http({"url":global.serviceBasePath,"method":"post","baseURL":global.serviceBaseUrl,"data":qs.stringify({"interfaceId":"54c0456d112a15810ddedb11a29c986d","queryJson":state.listQueryParams,"entityCode":"tag_gather_yztdqsy_1735090881279"}),}).then((res) => {
                   ...
                   // 成功的操作
                   const cacheKey = generateCacheKey('global.serviceBaseUrl-global.serviceBasePath',  "qs.stringify({\"interfaceId\":\"54c0456d112a15810ddedb11a29c986d\",\"queryJson\":\state.listQueryParams\,\"entityCode\":\"tag_gather_yztdqsy_1735090881279\"})qsstringifyend");
...
// 接口函数
 getListDataCopy: {
              ...
              autoLoad: false, // 自动请求
              bindComponents: [], // 依赖的组件ID列表，可能多个组件绑定一个接口的数据
              config: {"url":"global.serviceBasePath","method":"get","baseURL":"global.foshanServiceBaseUrl","params":{"useGisShape":"false","locationField":"location","tagJson":"{}","HasAllTag":"false","topicCode":"19d6d286-fd40-4f56-8f94-4eeefadb59e8","hasGather":"true","pageSize":10,"pageNum":1,"keyword":"","interfaceId":"8b5ca6a3009f750b5b1f19a415589682","ENTITY_CODE":"tag_gather_yztdqsy_1735090881279"}},
              request: function ( componentId) {
return new Promise((resolve, reject) => {
  
                http({"url":global.serviceBasePath,"method":"get","baseURL":global.foshanServiceBaseUrl,"params":{"useGisShape":"false","locationField":"location","tagJson":"{}","HasAllTag":"false","topicCode":"19d6d286-fd40-4f56-8f94-4eeefadb59e8","hasGather":"true","pageSize":10,"pageNum":1,"keyword":"","interfaceId":"8b5ca6a3009f750b5b1f19a415589682","ENTITY_CODE":"tag_gather_yztdqsy_1735090881279"},}).then((res) => {
 
                   // 成功的操作
                   const cacheKey = generateCacheKey('global.foshanServiceBaseUrl-global.serviceBasePath',  {"useGisShape":"false","locationField":"location","tagJson":"{}","HasAllTag":"false","topicCode":"19d6d286-fd40-4f56-8f94-4eeefadb59e8","hasGather":"true","pageSize":10,"pageNum":1,"keyword":"","interfaceId":"8b5ca6a3009f750b5b1f19a415589682","ENTITY_CODE":"tag_gather_yztdqsy_1735090881279"});
                   
                   apiDataMap[cacheKey] = res.data;
                   apiDataMap['getListDataCopy'] = res.data;
...
// 监听变量，调取接口
watch(() => [1], async () => {
                await requestApi(apiRegistry, apiDataCache, componentState, componentPropBindingMap, 'getListDataCopy', function(cacheKey, data, apiName) {
                    // 更新缓存
...
deep: true, // 深度监听
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-wrfxOld', global.appScaleMode, 'normal');
...
/* 接收socket.io消息 */
const onSocketChangee9f20d9f4234496bb84a = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChangee9f20d9f4234496bb84a);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChangee9f20d9f4234496bb84a);
});
/* 接收socket.io消息 */
const onSocketChangec927b44c3d504bff9676 = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChangec927b44c3d504bff9676);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChangec927b44c3d504bff9676);
});
// 执行自定义方法
getProvider("","");
// 执行自定义方法
...
.t-l-c-wrfxOld .pollutionAnalysis-t-rect-0-0 {
...
.t-l-c-wrfxOld .pollutionAnalysis-t-rect-0-1 {
position: absolute !important;
top: 254px;
left: 0px;
width: 410px;
...
.t-l-c-wrfxOld .pollutionAnalysis-t-button-0-3 {
position: absolute !important;
top: 411px;
left: 250px;
width: 70px;
...
.t-l-c-wrfxOld .pollutionAnalysis-t-image-base-0-4 {
position: absolute !important;
top: 55px;
left: 1px;
width: 410px;
...
.t-l-c-wrfxOld .pollutionAnalysis-t-list-card-0-5 {
position: absolute !important;
top: 254px;
left: 0px;
width: 410px;
...
.t-l-c-wrfxOld .pollutionAnalysis-t-rect-0-6 {
position: absolute !important;
top: 243px;
left: 1px;
width: 410px;
...
.t-l-c-wrfxOld .pollutionAnalysis-t-table-0-7 {
position: absolute !important;
top: 452px;
left: 0px;
width: 410px;
...
.t-l-c-wrfxOld .pollutionAnalysis-t-component-0-8 {
position: absolute !important;
top: 0px;
left: 0px;
width: 410px;
...
.t-l-c-wrfxOld .pollutionAnalysis-t-text-0-9 {
position: absolute !important;
top: 5px;
left: 33px;
width: 234px;
...
.t-l-c-wrfxOld .pollutionAnalysis-t-rect-0-10 {
position: absolute !important;
top: 411px;
left: 330px;
width: 72px;
...
.t-l-c-wrfxOld .pollutionAnalysis-t-rect-0-11 {
position: absolute !important;
top: 410px;
left: 330px;
width: 72px;
...
.t-l-c-wrfxOld .pollutionAnalysis-t-text-0-13 {
position: absolute !important;
top: 118px;
left: 17px;
width: 70px;
...
.t-l-c-wrfxOld .pollutionAnalysis-t-text-0-14 {
position: absolute !important;
top: 172px;
left: 17px;
width: 70px;
...
.t-l-c-wrfxOld .pollutionAnalysis-t-text-0-15 {
position: absolute !important;
top: 145px;
left: 17px;
width: 70px;
...
.t-l-c-wrfxOld .pollutionAnalysis-t-text-0-16 {
position: absolute !important;
top: 80px;
left: 17px;
width: 70px;
...
.t-l-c-wrfxOld .pollutionAnalysis-t-radio-0-17 {
position: absolute !important;
top: 115px;
left: 90px;
width: 256px;
...
.t-l-c-wrfxOld .pollutionAnalysis-t-radio-0-18 {
position: absolute !important;
top: 169px;
left: 90px;
width: 256px;
...
.t-l-c-wrfxOld .pollutionAnalysis-t-checkbox-0-19 {
position: absolute !important;
top: 142px;
left: 88px;
width: 232px;
...
.t-l-c-wrfxOld .pollutionAnalysis-t-rect-0-20 {
position: absolute !important;
top: 199px;
left: 310px;
width: 85px;
...
.t-l-c-wrfxOld .pollutionAnalysis-t-search-0-21 {
position: absolute !important;
top: 72px;
left: 89px;
width: 260px;
...
.t-l-c-wrfxOld .pollutionAnalysis-t-text-0-22 {
position: absolute !important;
top: 82px;
left: 362px;
width: 28px;

<template>
  <div id="t-l-c-airRadar" class="t-l-c-airRadar" ><t-rect v-if="state.showContent === true" id="t-rect-a122.67a8288a4" class="airRadar-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle" @click="onclick1734686591589"></t-rect><t-text v-if="state.showContent === false" id="t-text-50f5.0d6af7e03" class="airRadar-t-text-0-1"  :label="tTextx0x1ComputedData.label" :editable="tTextx0x1ComputedData.editable" :c-style="tTextx0x1ComputedData.cStyle" :show-title="tTextx0x1ComputedData.showTitle" @click="onclick1734686575114"></t-text></div>
</template>
...
.t-l-c-airRadar .airRadar-t-rect-0-0 {
...
.t-l-c-airRadar .airRadar-t-text-0-1 {
position: absolute !important;
top: 2px;
left: 0px;
width: 38px;

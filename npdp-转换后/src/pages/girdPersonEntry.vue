...
const state = reactive({
   screenSize: "",
   componentName: "girdPersonContentComponent",
});
// 选中的图表主题
...
name:"girdPersonContentComponent",
loading:true,
...
if (tabValue !== state.tabSelect) {
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-girdPersonEntry', global.appScaleMode, 'normal');
...
.t-l-c-girdPersonEntry .girdPersonEntry-t-component-0-0 {

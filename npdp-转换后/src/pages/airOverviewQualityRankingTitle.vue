<template>
  <div id="t-l-c-airOverviewQualityRankingTitle" class="t-l-c-airOverviewQualityRankingTitle" ><t-component id="t-component-6f3b.f3ecc4cb7" class="airOverviewQualityRankingTitle-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName"></t-component><t-text id="t-text-1e1f.11878bc02" class="airOverviewQualityRankingTitle-t-text-0-1"  :label="tTextx0x1ComputedData.label" :editable="tTextx0x1ComputedData.editable" :c-style="tTextx0x1ComputedData.cStyle" :show-title="tTextx0x1ComputedData.showTitle" @click="onclick1736840230272"></t-text><t-text-unit id="t-text-unit-a439.52ab7ae63" class="airOverviewQualityRankingTitle-t-text-unit-0-2"  :c-style="tTextUnitx0x2ComputedData.cStyle" :justify="tTextUnitx0x2ComputedData.justify" :align="tTextUnitx0x2ComputedData.align" :content="replaceCssVariables(filterData(global.regionaQuery.businessRegionName, componentPropBindingMap?.['t-text-unit-a439.52ab7ae63']['content'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :unit="tTextUnitx0x2ComputedData.unit" :show-overflow-tooltip="tTextUnitx0x2ComputedData.showOverflowTooltip"></t-text-unit></div>
</template>
...
<style scoped>
.t-l-c-airOverviewQualityRankingTitle {
position: relative;
overflow: hidden;
...
.t-l-c-airOverviewQualityRankingTitle .airOverviewQualityRankingTitle-t-component-0-0 {
...
.t-l-c-airOverviewQualityRankingTitle .airOverviewQualityRankingTitle-t-text-0-1 {
position: absolute !important;
top: 6px;
left: 280px;
width: 120px;
...
.t-l-c-airOverviewQualityRankingTitle .airOverviewQualityRankingTitle-t-text-unit-0-2 {
position: absolute !important;
top: 1px;
left: 34px;
width: 249px;

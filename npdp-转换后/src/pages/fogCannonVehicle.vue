<template>
  <div id="t-l-c-fogCannonVehicle" class="t-l-c-fogCannonVehicle" ><t-component id="t-component-aa14.3ba955fbb" class="fogCannonVehicle-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName"></t-component><t-text-unit id="t-text-unit-a3c4.48c326f87" class="fogCannonVehicle-t-text-unit-0-1"  :c-style="tTextUnitx0x1ComputedData.cStyle" :justify="tTextUnitx0x1ComputedData.justify" :align="tTextUnitx0x1ComputedData.align" :content="tTextUnitx0x1ComputedData.content" :unit="tTextUnitx0x1ComputedData.unit" :show-overflow-tooltip="tTextUnitx0x1ComputedData.showOverflowTooltip"></t-text-unit><t-component id="t-component-9ecd.617296bbe" class="fogCannonVehicle-t-component-0-3"  :name="tComponentx0x3ComputedData.name" :loading="tComponentx0x3ComputedData.loading" :c-style="tComponentx0x3ComputedData.cStyle" :src="tComponentx0x3ComputedData.src" :component-name="tComponentx0x3ComputedData.componentName" :page-id="tComponentx0x3ComputedData.pageId" :page-code="tComponentx0x3ComputedData.pageCode"></t-component></div>
</template>
...
import { TComponent, TTextUnit } from '@ths/design';
...
tComponentx0x3: {
defaultStyle: {
            default: {"width":"410px","height":"800px","margin":"0 auto","left":"0px"},
            
            },
 default: { 
 
name:"fogCannonVehicleListComponent",
loading:true,
cStyle:{"wrapper":{"default":{"width":"410px","height":"800px","margin":"0 auto","left":"0px"}}},
src:"/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/index.html#/fogCannonVehicleList",
componentName:"fogCannonVehicleListComponent",
pageId:"a9d3837c2b5d45bbbf88e4a850c3e6ab",
pageCode:"fogCannonVehicleList", 
 },
},
});
...
// 接口函数
 getListData: {
              ...
              config: {"url":"global.serviceBasePath","method":"get","baseURL":"global.foshanServiceBaseUrl","params":{"ZYC_TYPE":"雾炮车","REGION_PATH":"global.regionaQuery.regionCode","interfaceId":"cba412a8965299fd2fb2d88d19163b3e"}},
              request: function ( componentId) {
return new Promise((resolve, reject) => {
  
                http({"url":global.serviceBasePath,"method":"get","baseURL":global.foshanServiceBaseUrl,"params":{"ZYC_TYPE":"雾炮车","REGION_PATH":global.regionaQuery.regionCode,"interfaceId":"cba412a8965299fd2fb2d88d19163b3e"},}).then((res) => {
 
                   // 成功的操作
                   const cacheKey = generateCacheKey('global.foshanServiceBaseUrl-global.serviceBasePath',  {"ZYC_TYPE":"雾炮车","REGION_PATH":global.regionaQuery.regionCode,"interfaceId":"cba412a8965299fd2fb2d88d19163b3e"});
...
deep: true, // 深度监听
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-fogCannonVehicle', global.appScaleMode, 'normal');
...
.t-l-c-fogCannonVehicle .fogCannonVehicle-t-component-0-0 {
...
.t-l-c-fogCannonVehicle .fogCannonVehicle-t-text-unit-0-1 {
position: absolute !important;
top: 6px;
left: 35px;
width: 261px;
...
.t-l-c-fogCannonVehicle .fogCannonVehicle-t-component-0-3 {
position: absolute !important;
top: 45px;
left: 0px;
width: 410px;

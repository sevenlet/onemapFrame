...
const oncellClick1739352784938 = (row,column,cell,event) => {
// 执行自定义方法
...
return new Promise((resolve, reject) => {
  http({"url":global.serviceBasePath,"method":"get","baseURL":global.foshanServiceBaseUrl,"params":{"WATER_CODE":state.WATER_CODE,"WSYSTEM_CODE":state.WSYSTEM_CODE,"KEYWORD":state.name,"REGION_CODE":"","interfaceId":"ae8e72cf1b62ea661c6748dfc361ae76"},}).then((res) => {
     // 成功的操作
     console.log('涉水企业列表', res.data)
...
deep: true, // 深度监听
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-shjysSsqy', global.appScaleMode, 'normal');
...
.t-l-c-shjysSsqy .shjysSsqy-t-search-0-0 {
...
.t-l-c-shjysSsqy .shjysSsqy-t-button-0-1 {
position: absolute !important;
top: 0px;
left: 353px;
width: 49px;
...
.t-l-c-shjysSsqy .shjysSsqy-t-table-0-2 {
position: absolute !important;
top: 40px;
left: 8px;
width: 394px;

<template>
  <div id="t-l-c-waterPollutionSourceDialog" class="t-l-c-waterPollutionSourceDialog" ><t-rect id="t-rect-8252.1a4ade4f4" class="waterPollutionSourceDialog-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle"></t-rect><t-rect id="t-rect-e3a7.d7772ec8d" class="waterPollutionSourceDialog-t-rect-0-1"  :tip="tRectx0x1ComputedData.tip" :label="tRectx0x1ComputedData.label" :active="tRectx0x1ComputedData.active" :c-style="tRectx0x1ComputedData.cStyle"></t-rect><t-text id="t-text-8cba.b16affff7" class="waterPollutionSourceDialog-t-text-0-2"  :label="state.pointNameSource" :editable="tTextx0x2ComputedData.editable" :c-style="tTextx0x2ComputedData.cStyle"></t-text><t-rect id="t-rect-da62.857f90ab" class="waterPollutionSourceDialog-t-rect-0-3"  :tip="tRectx0x3ComputedData.tip" :label="tRectx0x3ComputedData.label" :active="tRectx0x3ComputedData.active" :c-style="tRectx0x3ComputedData.cStyle" @click="onclick1733817210174"></t-rect><t-text id="t-text-738d.67fdf6baf" class="waterPollutionSourceDialog-t-text-0-4"  :label="tTextx0x4ComputedData.label" :editable="tTextx0x4ComputedData.editable" :c-style="tTextx0x4ComputedData.cStyle"></t-text><t-list-card id="t-list-card-1afd.46c2cc26d" class="waterPollutionSourceDialog-t-list-card-0-5"  :data="state.cardList" :spacing-x="tListCardx0x5ComputedData.spacingX" :col="tListCardx0x5ComputedData.col" :direction="tListCardx0x5ComputedData.direction" :exchange-order="tListCardx0x5ComputedData.exchangeOrder" :unit-break="tListCardx0x5ComputedData.unitBreak" :key-field="tListCardx0x5ComputedData.keyField" :active-key-field="tListCardx0x5ComputedData.activeKeyField" :active="tListCardx0x5ComputedData.active" :c-style="tListCardx0x5ComputedData.cStyle"></t-list-card><t-row id="t-row-1aec.588d3a901" class="waterPollutionSourceDialog-t-row-0-6"  :c-style="tRowx0x6ComputedData.cStyle" :gutter="tRowx0x6ComputedData.gutter" :justify="tRowx0x6ComputedData.justify" :align="tRowx0x6ComputedData.align"><t-text id="t-text-0df0.1c50452" class="waterPollutionSourceDialog-t-text-0-6-0"  :label="tTextx0x6x0ComputedData.label" :editable="tTextx0x6x0ComputedData.editable" :c-style="tTextx0x6x0ComputedData.cStyle" @click="onclick1734499551425"></t-text><t-text id="t-text-b3c3.a188c38d9" class="waterPollutionSourceDialog-t-text-0-6-1"  :label="tTextx0x6x1ComputedData.label" :editable="tTextx0x6x1ComputedData.editable" :c-style="tTextx0x6x1ComputedData.cStyle" @click="onclick1734499815574"></t-text></t-row></div>
</template>
...
import { TListCard, TRect, TRow, TText } from '@ths/design';
...
const state = reactive({
   screenSize: "",
   point: {"lon":"","lat":""},
   cardList: [{"title":"固定源名称","num":"-"},{"title":"固定源地址","num":" "},{"title":"法定人名称","num":"-"},{"title":"社会统一信用代码","num":"-"},{"title":"行政区","num":"-"},{"title":"行业类别","num":"-"}],
   pointNameSource: "-",
   pointIdSource: "",
});
// 选中的图表主题
...
tTextx0x2: {
defaultStyle: {
            default: {"width":"314px","height":"20.674157303370787px","color":"rgba(255, 255, 255, 1)","fontSize":"18px","position":"unset","left":"24px","top":"13.438202247191011px","backgroundImage":"","-webkit-mask-image":"","backgroundRepeat":"","-webkit-mask-repeat":"","backgroundSize":"","-webkit-mask-size":"","backgroundPosition":"","-webkit-mask-position":"","paddingLeft":"0px","fontWeight":"700","animationName":""},
...
label:"-",
editable:false,
cStyle:{"wrapper":{"default":{"width":"314px","height":"20.674157303370787px","color":"rgba(255, 255, 255, 1)","fontSize":"18px","position":"unset","left":"24px","top":"13.438202247191011px","backgroundImage":"","-webkit-mask-image":"","backgroundRepeat":"","-webkit-mask-repeat":"","backgroundSize":"","-webkit-mask-size":"","backgroundPosition":"","-webkit-mask-position":"","paddingLeft":"0px","fontWeight":"700","animationName":""}}}, 
 },
},
tRectx0x3: {
defaultStyle: {
...
data:[{"title":"固定源名称","num":"-"},{"title":"固定源地址","num":" "},{"title":"法定人名称","num":"-"},{"title":"社会统一信用代码","num":"-"},{"title":"行政区","num":"-"},{"title":"行业类别","num":"-"}],
spacingX:0,
col:1,
direction:"vertical",
exchangeOrder:false,
...
tTextx0x6x1: {
defaultStyle: {
            default: {"width":"90px","height":"28px","color":"#00FFFF","fontSize":"14px","borderTopLeftRadius":"28px","borderTopRightRadius":"28px","borderBottomLeftRadius":"28px","borderBottomRightRadius":"28px","backgroundColor":"var(--business-show-bg30)","textAlign":"left","lineHeight":"28px","position":"unset","left":"647px","top":"471.3999938964844px","cursor":"pointer","animationName":"","backgroundImage":"url(http://192.168.0.202:7777/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78/assets/images/2024-12-16/8b5a25d0ae5647d4ac7e737d98fb0b04.png)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"22px 50%","-webkit-mask-position":"","paddingLeft":"38px","marginLeft":"20px"},
...
state.pointNameSource = global.businessDialog?.dialogParmas?.ENTER_NAME || '-';
state.pointIdSource = global.businessDialog?.dialogParmas?.STANDENTERID || '';
...
rootData.rootSocket.emit('message', {
  ...
  data: [ // 消息内容
    ...
    { shareCode: "close_window_code", runtimeValue: "source_details" }
  ]
});
...
// 详情
window.open(`${global.enterUrl}/psa/summary/summary-menu!showInfo.vm?standenterid=${state.pointIdSource}`)
};
...
return new Promise((resolve, reject) => {
  http({"url":global.serviceBasePath,"method":"get","baseURL":global.foshanServiceBaseUrl,"params":{"STANDENTERID":state.pointIdSource,"interfaceId":"7ef65f2daf9cb751dd06a3b6c3f37c9b"},}).then((res) => {
     // 成功的操作
     
if (res?.status === 200 && res?.data?.data?.length) {
  // console.log(res, 'ceshi')
  // 固定源名称
  state.cardList[0].num = res?.data?.data[0]?.ENTER_NAME || '-';
  // 固定源地址
  state.cardList[1].num = res?.data?.data[0]?.ENTER_ADDR || '-';
  // 法定人名称
  state.cardList[2].num = res?.data?.data[0]?.CORP_NAME || '-';
  // 社会统一信用代码
  state.cardList[3].num = res?.data?.data[0]?.TYSHXYDM || '-';
  // 行政区
  state.cardList[4].num = res?.data?.data[0]?.REGION_ALLNAME || '-';
  // 行业类别
  state.cardList[5].num = res?.data?.data[0]?.TRADE_NAME || '-';

  // 经纬度--周边查询使用
  state.point.lat = res?.data?.data[0]?.LATITUDE || '';
  state.point.lon = res?.data?.data[0]?.LONGITUDE || '';
} else {
  // 固定源名称
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-waterPollutionSourceDialog', global.appScaleMode, 'normal');
...
<style scoped>
.t-l-c-waterPollutionSourceDialog {
position: relative;
overflow: hidden;
...
.t-l-c-waterPollutionSourceDialog .waterPollutionSourceDialog-t-rect-0-0 {
...
.t-l-c-waterPollutionSourceDialog .waterPollutionSourceDialog-t-rect-0-1 {
position: absolute !important;
top: 0px;
left: 0px;
width: 450px;
height: 46.51685393258427px;
pointer-events: auto;
}

.t-l-c-waterPollutionSourceDialog .waterPollutionSourceDialog-t-text-0-2 {
position: absolute !important;
top: 13.438202247191011px;
left: 24px;
width: 314px;
height: 20.674157303370787px;
pointer-events: auto;
}

.t-l-c-waterPollutionSourceDialog .waterPollutionSourceDialog-t-rect-0-3 {
position: absolute !important;
top: 10.337078651685394px;
left: 402px;
width: 24px;
height: 23.775280898876407px;
pointer-events: auto;
}

.t-l-c-waterPollutionSourceDialog .waterPollutionSourceDialog-t-text-0-4 {
position: absolute !important;
top: 316.314606741573px;
left: 0px;
width: 450px;
height: 51.68539325842697px;
pointer-events: auto;
}

.t-l-c-waterPollutionSourceDialog .waterPollutionSourceDialog-t-list-card-0-5 {
position: absolute !important;
top: 64px;
left: 20px;
width: 410px;
...
.t-l-c-waterPollutionSourceDialog .waterPollutionSourceDialog-t-row-0-6 {
position: absolute !important;
top: 328px;
left: 0px;
width: 430px;
...
.t-l-c-waterPollutionSourceDialog .waterPollutionSourceDialog-t-text-0-6-0 {
position: unset;
top: 471.3999938964844px;
left: 446px;
width: 90px;
height: 28px;
pointer-events: auto;
...
.t-l-c-waterPollutionSourceDialog .waterPollutionSourceDialog-t-text-0-6-1 {
position: unset;
top: 471.3999938964844px;
left: 647px;
width: 90px;

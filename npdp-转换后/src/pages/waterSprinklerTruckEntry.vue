...
const state = reactive({
   screenSize: "",
   componentName: "waterSprinklerTruckContentComponent",
});
// 选中的图表主题
...
name:"waterSprinklerTruckContentComponent",
loading:true,
...
if (tabValue !== state.tabSelect) {
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-waterSprinklerTruckEntry', global.appScaleMode, 'normal');
...
handleWindowResize();
/* 接收socket.io消息 */
const onSocketChange4f56d43ab85645fdb90b = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChange4f56d43ab85645fdb90b);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChange4f56d43ab85645fdb90b);
});
/* 接收socket.io消息 */
const onSocketChanged924801317c24161ad1c = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChanged924801317c24161ad1c);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChanged924801317c24161ad1c);
});
/* 接收socket.io消息 */
const onSocketChange5f38f41daf2344e6944e = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChange5f38f41daf2344e6944e);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChange5f38f41daf2344e6944e);
});
/* 接收socket.io消息 */
const onSocketChangef45ef3ff83744eb1bace = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChangef45ef3ff83744eb1bace);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChangef45ef3ff83744eb1bace);
});
});
// 页面离开时的操作
onUnmounted(() => {
...
<style scoped>
.t-l-c-waterSprinklerTruckEntry {
position: relative;
overflow: hidden;
...
.t-l-c-waterSprinklerTruckEntry .waterSprinklerTruckEntry-t-component-0-0 {

<template>
  <div id="t-l-c-xfCarContent" class="t-l-c-xfCarContent" ><t-component id="t-component-f869.e7ce2b41a" class="xfCarContent-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName" :page-id="tComponentx0x0ComputedData.pageId" :page-code="tComponentx0x0ComputedData.pageCode"></t-component></div>
</template>
...
.t-l-c-xfCarContent .xfCarContent-t-component-0-0 {

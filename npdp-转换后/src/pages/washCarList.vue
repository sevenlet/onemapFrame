...
// 接口函数
 getListData: {
              ...
              config: {"url":"global.serviceBasePath","method":"get","baseURL":"global.foshanServiceBaseUrl","params":{"VMN_TYPE":"cxc","interfaceId":"cec8a9f0eb62383b2ed0703f87a7b455"}},
              request: function ( componentId) {
return new Promise((resolve, reject) => {
  
                http({"url":global.serviceBasePath,"method":"get","baseURL":global.foshanServiceBaseUrl,"params":{"VMN_TYPE":"cxc","interfaceId":"cec8a9f0eb62383b2ed0703f87a7b455"},}).then((res) => {
 
                   // 成功的操作
                   const cacheKey = generateCacheKey('global.foshanServiceBaseUrl-global.serviceBasePath',  {"VMN_TYPE":"cxc","interfaceId":"cec8a9f0eb62383b2ed0703f87a7b455"});
...
if (head.statusCode === '200' && data.length) {
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-washCarList', global.appScaleMode, 'normal');
...
.t-l-c-washCarList .washCarList-t-table-0-0 {

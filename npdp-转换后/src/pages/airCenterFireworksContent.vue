<template>
  <div id="t-l-c-airCenterFireworksContent" class="t-l-c-airCenterFireworksContent" ><t-button id="t-button-2a6e.64b188df4" class="airCenterFireworksContent-t-button-0-0"  :label="tButtonx0x0ComputedData.label" :round="tButtonx0x0ComputedData.round" :plain="tButtonx0x0ComputedData.plain" :disabled="tButtonx0x0ComputedData.disabled" :type="tButtonx0x0ComputedData.type" :size="tButtonx0x0ComputedData.size" :native-type="tButtonx0x0ComputedData.native-type" :c-style="tButtonx0x0ComputedData.cStyle" @click="onclick1766886257462"></t-button><t-button id="t-button-cb37.8d1da106b" class="airCenterFireworksContent-t-button-0-1"  :label="tButtonx0x1ComputedData.label" :round="tButtonx0x1ComputedData.round" :plain="tButtonx0x1ComputedData.plain" :disabled="tButtonx0x1ComputedData.disabled" :type="tButtonx0x1ComputedData.type" :size="tButtonx0x1ComputedData.size" :native-type="tButtonx0x1ComputedData.native-type" :c-style="tButtonx0x1ComputedData.cStyle" @click="onclick1766369515905"></t-button><t-button id="t-button-d590.3071cb69c" class="airCenterFireworksContent-t-button-0-2"  :label="tButtonx0x2ComputedData.label" :round="tButtonx0x2ComputedData.round" :plain="tButtonx0x2ComputedData.plain" :disabled="tButtonx0x2ComputedData.disabled" :type="tButtonx0x2ComputedData.type" :size="tButtonx0x2ComputedData.size" :native-type="tButtonx0x2ComputedData.native-type" :c-style="tButtonx0x2ComputedData.cStyle" @click="onclick1766370462065"></t-button><t-button id="t-button-437e.e5e947e7f" class="airCenterFireworksContent-t-button-0-3"  :label="tButtonx0x3ComputedData.label" :round="tButtonx0x3ComputedData.round" :plain="tButtonx0x3ComputedData.plain" :disabled="tButtonx0x3ComputedData.disabled" :type="tButtonx0x3ComputedData.type" :size="tButtonx0x3ComputedData.size" :native-type="tButtonx0x3ComputedData.native-type" :c-style="tButtonx0x3ComputedData.cStyle" @click="onclick1766727068323_0_0"></t-button><t-image-base id="t-image-base-d5ca.b4fb1571" class="airCenterFireworksContent-t-image-base-0-4"  :src="tImageBasex0x4ComputedData.src" :fit="tImageBasex0x4ComputedData.fit" :c-style="tImageBasex0x4ComputedData.cStyle" @click="onclick1770257061732"></t-image-base><t-circle v-if="state.isShowXcTodoNum === true" id="t-circle-27f5.8ddbac949" class="airCenterFireworksContent-t-circle-0-5"  :tip="tCirclex0x5ComputedData.tip" :label="replaceCssVariables(filterData(state.xcTodoNum, componentPropBindingMap?.['t-circle-27f5.8ddbac949']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tCirclex0x5ComputedData.active" :c-style="tCirclex0x5ComputedData.cStyle"></t-circle></div>
</template>
...
import { TButton, TCircle, TImageBase } from '@ths/design';
...
src:"assets/images/2022-11-01/325115b23ccc4714ae4cc3711d4269f4.svg",
fit:"fill",
...
<style scoped>
.t-l-c-airCenterFireworksContent {
position: relative;
overflow: hidden;
...
.t-l-c-airCenterFireworksContent .airCenterFireworksContent-t-button-0-0 {
...
.t-l-c-airCenterFireworksContent .airCenterFireworksContent-t-button-0-1 {
position: absolute !important;
top: 46px;
left: 331px;
width: 68px;
...
.t-l-c-airCenterFireworksContent .airCenterFireworksContent-t-button-0-2 {
position: absolute !important;
top: 89px;
left: 331px;
width: 68px;
...
.t-l-c-airCenterFireworksContent .airCenterFireworksContent-t-button-0-3 {
position: absolute !important;
top: 132px;
left: 331px;
width: 68px;
...
.t-l-c-airCenterFireworksContent .airCenterFireworksContent-t-image-base-0-4 {
position: absolute !important;
top: 174px;
left: 354px;
width: 25px;
...
.t-l-c-airCenterFireworksContent .airCenterFireworksContent-t-circle-0-5 {
position: absolute !important;
top: 78px;
left: 317px;
width: 24px;

<template>
  <div id="t-l-c-qxBaseInfoFoShan" class="t-l-c-qxBaseInfoFoShan" ><t-component id="t-component-c019.99b6d840a" class="qxBaseInfoFoShan-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName" :page-id="tComponentx0x0ComputedData.pageId" :page-code="tComponentx0x0ComputedData.pageCode"></t-component><t-text id="t-text-62b3.48b14905c" class="qxBaseInfoFoShan-t-text-0-1"  :label="tTextx0x1ComputedData.label" :editable="tTextx0x1ComputedData.editable" :c-style="tTextx0x1ComputedData.cStyle"></t-text><t-table v-if="state.showTable === true" id="t-table-a03c.38ecd6b87" class="qxBaseInfoFoShan-t-table-0-2"  :height="tTablex0x2ComputedData.height" :stripe="tTablex0x2ComputedData.stripe" :border="tTablex0x2ComputedData.border" :auto-scroll="tTablex0x2ComputedData.autoScroll" :speed="tTablex0x2ComputedData.speed" :columns="tTablex0x2ComputedData.columns" :data="replaceCssVariables(filterData(state.tableData, componentPropBindingMap?.['t-table-a03c.38ecd6b87']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x2ComputedData.defaultSort" :c-style="tTablex0x2ComputedData.cStyle"></t-table><t-row id="t-row-9111.1b5dc7cd5" class="qxBaseInfoFoShan-t-row-0-3"  :c-style="tRowx0x3ComputedData.cStyle" :gutter="tRowx0x3ComputedData.gutter" :justify="tRowx0x3ComputedData.justify" :align="tRowx0x3ComputedData.align"><t-col id="t-col-46bf.19e16152f" class="qxBaseInfoFoShan-t-col-0-3-0"  :span="tColx0x3x0ComputedData.span" :offset="tColx0x3x0ComputedData.offset" :push="tColx0x3x0ComputedData.push" :pull="tColx0x3x0ComputedData.pull" :c-style="tColx0x3x0ComputedData.cStyle"><t-text id="t-text-6063.4db73323" class="qxBaseInfoFoShan-t-text-0-3-0-0"  :label="tTextx0x3x0x0ComputedData.label" :editable="tTextx0x3x0x0ComputedData.editable" :c-style="tTextx0x3x0x0ComputedData.cStyle"></t-text><t-date-picker id="t-date-picker-fa39.f1f4b1652" class="qxBaseInfoFoShan-t-date-picker-0-3-0-1"  :placeholder="tDatePickerx0x3x0x1ComputedData.placeholder" :start-placeholder="tDatePickerx0x3x0x1ComputedData.startPlaceholder" :end-placeholder="tDatePickerx0x3x0x1ComputedData.endPlaceholder" :type="tDatePickerx0x3x0x1ComputedData.type" :clearable="tDatePickerx0x3x0x1ComputedData.clearable" :range-separator="tDatePickerx0x3x0x1ComputedData.rangeSeparator" :default-date="replaceCssVariables(filterData(state.timeRange, componentPropBindingMap?.['t-date-picker-fa39.f1f4b1652']['default-date'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :separator="tDatePickerx0x3x0x1ComputedData.separator" :readonly="tDatePickerx0x3x0x1ComputedData.readonly" :editable="tDatePickerx0x3x0x1ComputedData.editable" :c-style="tDatePickerx0x3x0x1ComputedData.cStyle" @date-change="ondateChange1767948867605_0_0"></t-date-picker></t-col><t-col id="t-col-9e29.dc84c516" class="qxBaseInfoFoShan-t-col-0-3-1"  :span="tColx0x3x1ComputedData.span" :offset="tColx0x3x1ComputedData.offset" :push="tColx0x3x1ComputedData.push" :pull="tColx0x3x1ComputedData.pull" :c-style="tColx0x3x1ComputedData.cStyle"><t-select v-if="state.showType !== 'table'" id="t-select-3fcb.c00f74209" class="qxBaseInfoFoShan-t-select-0-3-1-0"  :active-value="replaceCssVariables(filterData(state.currentPolluteCode, componentPropBindingMap?.['t-select-3fcb.c00f74209']['activeValue'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :options="replaceCssVariables(filterData(state.polluteList, componentPropBindingMap?.['t-select-3fcb.c00f74209']['options'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :alias="tSelectx0x3x1x0ComputedData.alias" :multiple="tSelectx0x3x1x0ComputedData.multiple" :placeholder="tSelectx0x3x1x0ComputedData.placeholder" :clearable="tSelectx0x3x1x0ComputedData.clearable" :disabled="tSelectx0x3x1x0ComputedData.disabled" :name="tSelectx0x3x1x0ComputedData.name" :autocomplete="tSelectx0x3x1x0ComputedData.autocomplete" :filterable="tSelectx0x3x1x0ComputedData.filterable" :no-match-text="tSelectx0x3x1x0ComputedData.no-match-text" :no-data-text="tSelectx0x3x1x0ComputedData.no-data-text" :c-style="tSelectx0x3x1x0ComputedData.cStyle" @change="onchange1733973555614"></t-select><t-select id="t-select-6362.7b6ac7966" class="qxBaseInfoFoShan-t-select-0-3-1-1"  :active-value="replaceCssVariables(filterData(state.showType, componentPropBindingMap?.['t-select-6362.7b6ac7966']['activeValue'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :options="tSelectx0x3x1x1ComputedData.options" :alias="tSelectx0x3x1x1ComputedData.alias" :multiple="tSelectx0x3x1x1ComputedData.multiple" :placeholder="tSelectx0x3x1x1ComputedData.placeholder" :clearable="tSelectx0x3x1x1ComputedData.clearable" :disabled="tSelectx0x3x1x1ComputedData.disabled" :name="tSelectx0x3x1x1ComputedData.name" :autocomplete="tSelectx0x3x1x1ComputedData.autocomplete" :filterable="tSelectx0x3x1x1ComputedData.filterable" :no-match-text="tSelectx0x3x1x1ComputedData.no-match-text" :no-data-text="tSelectx0x3x1x1ComputedData.no-data-text" :c-style="tSelectx0x3x1x1ComputedData.cStyle" @change="onchange1767772766838_0_0"></t-select></t-col></t-row><t-text v-if="state.isShowchartUnit === true" id="t-text-f8f0.bc97393c" class="qxBaseInfoFoShan-t-text-0-4"  :label="replaceCssVariables(filterData(state.chartUint, componentPropBindingMap?.['t-text-f8f0.bc97393c']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x4ComputedData.editable" :c-style="tTextx0x4ComputedData.cStyle"></t-text><t-list-card id="t-list-card-2930.4cdad1987" class="qxBaseInfoFoShan-t-list-card-0-5"  :data="replaceCssVariables(filterData(state.monitorData, componentPropBindingMap?.['t-list-card-2930.4cdad1987']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :spacing-x="tListCardx0x5ComputedData.spacingX" :col="tListCardx0x5ComputedData.col" :direction="tListCardx0x5ComputedData.direction" :exchange-order="tListCardx0x5ComputedData.exchangeOrder" :unit-break="tListCardx0x5ComputedData.unitBreak" :key-field="tListCardx0x5ComputedData.keyField" :active-key-field="tListCardx0x5ComputedData.activeKeyField" :active="tListCardx0x5ComputedData.active" :c-style="tListCardx0x5ComputedData.cStyle"></t-list-card><t-chart-wind-direction v-if="state.windDirectionSpeedLine === true" id="t-chart-wind-direction-418c.32b624bb3" class="qxBaseInfoFoShan-t-chart-wind-direction-0-6"  :empty-img="replaceCssVariables(filterData(state.noDataImg, componentPropBindingMap?.['t-chart-wind-direction-418c.32b624bb3']['emptyImg'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :c-style="tChartWindDirectionx0x6ComputedData.cStyle" :show-item-bg="tChartWindDirectionx0x6ComputedData.showItemBg" :options="tChartWindDirectionx0x6ComputedData.options" :data="replaceCssVariables(filterData(state.chartList, componentPropBindingMap?.['t-chart-wind-direction-418c.32b624bb3']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :series-setting="tChartWindDirectionx0x6ComputedData.seriesSetting" :main-axis="tChartWindDirectionx0x6ComputedData.mainAxis" :line="componentState.tChartWindDirectionx0x6.line"></t-chart-wind-direction><t-row id="t-row-7d05.00a92afd3" class="qxBaseInfoFoShan-t-row-0-7"  :c-style="tRowx0x7ComputedData.cStyle" :gutter="tRowx0x7ComputedData.gutter" :justify="tRowx0x7ComputedData.justify" :align="tRowx0x7ComputedData.align"><t-row id="t-row-b0c8.018f2197c" class="qxBaseInfoFoShan-t-row-0-7-0"  :c-style="tRowx0x7x0ComputedData.cStyle" :gutter="tRowx0x7x0ComputedData.gutter" :justify="tRowx0x7x0ComputedData.justify" :align="tRowx0x7x0ComputedData.align"><t-col id="t-col-58c5.e3e55e5f4" class="qxBaseInfoFoShan-t-col-0-7-0-0"  :span="tColx0x7x0x0ComputedData.span" :offset="tColx0x7x0x0ComputedData.offset" :push="tColx0x7x0x0ComputedData.push" :pull="tColx0x7x0x0ComputedData.pull" :c-style="tColx0x7x0x0ComputedData.cStyle"><t-text id="t-text-98a4.90e1520d3" class="qxBaseInfoFoShan-t-text-0-7-0-0-0"  :label="tTextx0x7x0x0x0ComputedData.label" :editable="tTextx0x7x0x0x0ComputedData.editable" :c-style="tTextx0x7x0x0x0ComputedData.cStyle"></t-text></t-col><t-col id="t-col-8eeb.2c9d147f1" class="qxBaseInfoFoShan-t-col-0-7-0-1"  :span="tColx0x7x0x1ComputedData.span" :offset="tColx0x7x0x1ComputedData.offset" :push="tColx0x7x0x1ComputedData.push" :pull="tColx0x7x0x1ComputedData.pull" :c-style="tColx0x7x0x1ComputedData.cStyle"><t-text id="t-text-ed5a.75f62b851" class="qxBaseInfoFoShan-t-text-0-7-0-1-0"  :label="replaceCssVariables(filterData(state.baseInfo.DDATETIME, componentPropBindingMap?.['t-text-ed5a.75f62b851']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x7x0x1x0ComputedData.editable" :c-style="tTextx0x7x0x1x0ComputedData.cStyle"></t-text></t-col></t-row><t-row id="t-row-e0e7.192bf2224" class="qxBaseInfoFoShan-t-row-0-7-1"  :c-style="tRowx0x7x1ComputedData.cStyle" :gutter="tRowx0x7x1ComputedData.gutter" :justify="tRowx0x7x1ComputedData.justify" :align="tRowx0x7x1ComputedData.align"><t-col id="t-col-84ea.13fd9a69c" class="qxBaseInfoFoShan-t-col-0-7-1-0"  :span="tColx0x7x1x0ComputedData.span" :offset="tColx0x7x1x0ComputedData.offset" :push="tColx0x7x1x0ComputedData.push" :pull="tColx0x7x1x0ComputedData.pull" :c-style="tColx0x7x1x0ComputedData.cStyle"><t-text id="t-text-f997.a33b35379" class="qxBaseInfoFoShan-t-text-0-7-1-0-0"  :label="tTextx0x7x1x0x0ComputedData.label" :editable="tTextx0x7x1x0x0ComputedData.editable" :c-style="tTextx0x7x1x0x0ComputedData.cStyle"></t-text></t-col><t-col id="t-col-3926.8488b6159" class="qxBaseInfoFoShan-t-col-0-7-1-1"  :span="tColx0x7x1x1ComputedData.span" :offset="tColx0x7x1x1ComputedData.offset" :push="tColx0x7x1x1ComputedData.push" :pull="tColx0x7x1x1ComputedData.pull" :c-style="tColx0x7x1x1ComputedData.cStyle"><t-text id="t-text-5580.bf2a63f19" class="qxBaseInfoFoShan-t-text-0-7-1-1-0"  :label="replaceCssVariables(filterData(state.baseInfo.longitude, componentPropBindingMap?.['t-text-5580.bf2a63f19']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x7x1x1x0ComputedData.editable" :c-style="tTextx0x7x1x1x0ComputedData.cStyle"></t-text></t-col><t-col id="t-col-fae6.112c80399" class="qxBaseInfoFoShan-t-col-0-7-1-2"  :span="tColx0x7x1x2ComputedData.span" :offset="tColx0x7x1x2ComputedData.offset" :push="tColx0x7x1x2ComputedData.push" :pull="tColx0x7x1x2ComputedData.pull" :c-style="tColx0x7x1x2ComputedData.cStyle"><t-text id="t-text-1f70.7d602d09d" class="qxBaseInfoFoShan-t-text-0-7-1-2-0"  :label="tTextx0x7x1x2x0ComputedData.label" :editable="tTextx0x7x1x2x0ComputedData.editable" :c-style="tTextx0x7x1x2x0ComputedData.cStyle"></t-text></t-col><t-col id="t-col-6dfa.6910d8ef2" class="qxBaseInfoFoShan-t-col-0-7-1-3"  :span="tColx0x7x1x3ComputedData.span" :offset="tColx0x7x1x3ComputedData.offset" :push="tColx0x7x1x3ComputedData.push" :pull="tColx0x7x1x3ComputedData.pull" :c-style="tColx0x7x1x3ComputedData.cStyle"><t-text id="t-text-1aa2.98d0516bf" class="qxBaseInfoFoShan-t-text-0-7-1-3-0"  :label="replaceCssVariables(filterData(state.baseInfo.latitude, componentPropBindingMap?.['t-text-1aa2.98d0516bf']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x7x1x3x0ComputedData.editable" :c-style="tTextx0x7x1x3x0ComputedData.cStyle"></t-text></t-col></t-row></t-row><t-chart-design v-if="state.showChart === true" id="t-chart-design-8d2a.4d46123cd" class="qxBaseInfoFoShan-t-chart-design-0-8"  :register-map-name="tChartDesignx0x8ComputedData.registerMapName" :geo-json="tChartDesignx0x8ComputedData.geoJson" :empty-img="tChartDesignx0x8ComputedData.emptyImg" :c-style="tChartDesignx0x8ComputedData.cStyle" :options="replaceCssVariables(filterData(state.options, componentPropBindingMap?.['t-chart-design-8d2a.4d46123cd']['options'].filters || []), global?.theme || global?.activeTheme || '默认主题')"></t-chart-design></div>
</template>
...
import { TChartDesign, TChartWindDirection, TCol, TComponent, TDatePicker, TListCard, TRow, TSelect, TTable, TText } from '@ths/design';
...
const state = reactive({
   screenSize: "",
   serviceBasePath1: "/service/serviceinterface/search/run.action?token=dcp",
   foshanServiceBaseUrl1: "http://27.36.118.5:8888/",
   dataZoom: {},
   chartName: "",
   chartType: "line",
   tableData: [],
   baseInfo: {"DDATETIME":"","longitude":"","latitude":""},
   showTable: false,
   showChart: false,
   windDirectionSpeedLine: false,
   chartUint: "m/s",
   currentPolluteCode: "WD10DF",
   isShowchartUnit: true,
   chartList: [],
   showType: "line",
   polluteList: [{"label":"风向风速","value":"WD10DF","disabled":false,"unit":"m/s"},{"label":"温度","value":"WD","disabled":false,"unit":"℃"},{"label":"降雨量","value":"JYL","disabled":false,"unit":"mm"},{"label":"气压","value":"YQ","disabled":false,"unit":"hPa"},{"label":"湿度","value":"SD","disabled":false,"unit":"%"}],
   options: "",
   myChart: "",
   seriesData: [],
   noDataImg: "assets/images/2024-12-26/f1200f84c82a4a1698a450dfa89ceedb.svg",
   dataSourcetype: "",
   monitorData: [{"title":"风速","num":"-","unit":"m/s","icon":"assets/images/2026-03-27/4490a3d22b044319990474b357d03335.png","selectIcon":"assets/images/2026-03-27/4490a3d22b044319990474b357d03335.png"},{"title":"风向","num":"-","icon":"assets/images/2026-03-27/fe0e585e00994783a20f6f95bbd3eb31.png","selectIcon":"assets/images/2026-03-27/fe0e585e00994783a20f6f95bbd3eb31.png"},{"title":"温度","num":"-","unit":"℃","icon":"assets/images/2026-03-27/2826dc3b7f9a411da2227d899a809a9a.png","selectIcon":"assets/images/2026-03-27/2826dc3b7f9a411da2227d899a809a9a.png"},{"title":"湿度","num":"-","unit":"%","icon":"assets/images/2026-03-27/07bc0a16b588486f9d892e258f7d2b55.png","selectIcon":"assets/images/2026-03-27/07bc0a16b588486f9d892e258f7d2b55.png"},{"title":"降雨量","num":"-","unit":"mm","icon":"assets/images/2026-03-27/6f43e22929d64082a78c27eb2eea728e.png","selectIcon":"assets/images/2026-03-27/6f43e22929d64082a78c27eb2eea728e.png"},{"title":"气压","num":"-","unit":"hPa","icon":"assets/images/2026-03-27/330100078adc4cffad00ad33ceaba64b.png","selectIcon":"assets/images/2026-03-27/330100078adc4cffad00ad33ceaba64b.png"}],
   pointCode: "",
   timeRange: [],
   endTime: "",
   startTime: "",
...
tTextx0x1: {
defaultStyle: {
            default: {"width":"130px","height":"20px","color":"rgba(255, 255, 255, 0.9)","position":"unset","left":"29px","top":"98px","fontFamily":"方正综艺","fontSize":"var(--text-size-14)","animationName":"","lineHeight":"20px"},
...
label:"监测信息",
editable:false,
cStyle:{"wrapper":{"default":{"width":"130px","height":"20px","color":"rgba(255, 255, 255, 0.9)","position":"unset","left":"29px","top":"98px","fontFamily":"方正综艺","fontSize":"var(--text-size-14)","animationName":"","lineHeight":"20px"}}}, 
 },
},
tTablex0x2: {
defaultStyle: {
...
tTextx0x3x0x0: {
defaultStyle: {
            default: {"width":"auto","height":"32px","color":"rgba(255, 255, 255, 1)","lineHeight":"32px","fontSize":"var(--text-size-14)","fontFamily":"方正综艺","top":"208px","left":"0px","position":"unset","textAlign":"left","marginLeft":"0px"},
...
label:"指标变化趋势",
editable:false,
cStyle:{"wrapper":{"default":{"width":"auto","height":"32px","color":"rgba(255, 255, 255, 1)","lineHeight":"32px","fontSize":"var(--text-size-14)","fontFamily":"方正综艺","top":"208px","left":"0px","position":"unset","textAlign":"left","marginLeft":"0px"}},"cardValue":{"default":{"fontSize":"var(--text-size-14)"}}}, 
 },
},
tDatePickerx0x3x0x1: {
defaultStyle: {
...
activeValue:"WD10DF",
options:[{"label":"风向风速","value":"WD10DF","disabled":false,"unit":"m/s"},{"label":"温度","value":"WD","disabled":false,"unit":"℃"},{"label":"降雨量","value":"JYL","disabled":false,"unit":"mm"},{"label":"气压","value":"YQ","disabled":false,"unit":"hPa"},{"label":"湿度","value":"SD","disabled":false,"unit":"%"}],
...
tSelectx0x3x1x1: {
defaultStyle: {
            default: {"width":"120px","height":"32px","position":"unset","left":"714px","top":"218px","animationName":"","paddingLeft":"12px","paddingRight":"12px","fontSize":"var(--text-size-14)","backgroundColor":"var(--business-show-bg30)","borderLeft":"1px solid var(--business-show-bg50)","borderTop":"1px solid var(--business-show-bg50)","borderRight":"1px solid var(--business-show-bg50)","borderBottom":"1px solid var(--business-show-bg50)","color":"rgba(255, 255, 255, 1)","--el-select-border-color-hover":"var(--business-theme)","marginRight":"15px"},
...
'no-match-text':"无匹配数据",
'no-data-text':"无数据",
cStyle:{"wrapper":{"default":{"width":"120px","height":"32px","position":"unset","left":"714px","top":"218px","animationName":"","paddingLeft":"12px","paddingRight":"12px","fontSize":"var(--text-size-14)","backgroundColor":"var(--business-show-bg30)","borderLeft":"1px solid var(--business-show-bg50)","borderTop":"1px solid var(--business-show-bg50)","borderRight":"1px solid var(--business-show-bg50)","borderBottom":"1px solid var(--business-show-bg50)","color":"rgba(255, 255, 255, 1)","--el-select-border-color-hover":"var(--business-theme)","marginRight":"15px"},"focus":{"borderLeft":"1px solid var(--business-theme)","borderTop":"1px solid var(--business-theme)","borderRight":"1px solid var(--business-theme)","borderBottom":"1px solid var(--business-theme)","fontSize":"var(--text-size-14)"},"hover":{"borderLeft":"1px solid var(--business-theme)","borderTop":"1px solid var(--business-theme)","borderRight":"1px solid var(--business-theme)","borderBottom":"1px solid var(--business-theme)"}},"dropdownArrow":{"default":{"display":"none"}},"arrow":{"default":{"color":"var(--business-unit-icon)"}},"placeholder":{"default":{"color":"var(--business-text-avianize)"}},"dropdownWrapper":{"default":{"backgroundColor":"var(--business-dialog-bg)","borderLeft":"1px solid var(--business-show-bg50)","borderTop":"1px solid var(--business-show-bg50)","borderRight":"1px solid var(--business-show-bg50)","borderBottom":"1px solid var(--business-show-bg50)"}},"dropdownItem":{"active":{"backgroundColor":"var(--business-show-bg15)","color":"var(--business-theme)"},"hover":{"color":"var(--business-theme)","backgroundColor":"var(--business-show-bg15)"}},"dropdownItemText":{"default":{"fontSize":"var(--text-size-14)"},"active":{"fontSize":"var(--text-size-14)"}}}, 
 },
},
tTextx0x4: {
defaultStyle: {
            default: {"width":"99px","height":"32px","color":"var(--business-text-avianize)","lineHeight":"32px","fontSize":"var(--text-size-14)","fontFamily":"方正综艺","top":"265px","left":"24px","position":"unset","textAlign":"left","marginLeft":"20px","animationName":""},
...
label:"m/s",
editable:false,
cStyle:{"wrapper":{"default":{"width":"99px","height":"32px","color":"var(--business-text-avianize)","lineHeight":"32px","fontSize":"var(--text-size-14)","fontFamily":"方正综艺","top":"265px","left":"24px","position":"unset","textAlign":"left","marginLeft":"20px","animationName":""}},"cardValue":{"default":{"fontSize":"var(--text-size-14)"}}}, 
 },
},
tListCardx0x5: {
defaultStyle: {
            default: {"width":"824px","height":"92px","position":"unset","left":"0px","top":"130px","background":"rgba(0, 0, 0, 0)","fillType":"color"},
            
            },
 default: { 
 
data:[{"title":"风速","num":"-","unit":"m/s","icon":"assets/images/2026-03-27/4490a3d22b044319990474b357d03335.png","selectIcon":"assets/images/2026-03-27/4490a3d22b044319990474b357d03335.png"},{"title":"风向","num":"-","icon":"assets/images/2026-03-27/fe0e585e00994783a20f6f95bbd3eb31.png","selectIcon":"assets/images/2026-03-27/fe0e585e00994783a20f6f95bbd3eb31.png"},{"title":"温度","num":"-","unit":"℃","icon":"assets/images/2026-03-27/2826dc3b7f9a411da2227d899a809a9a.png","selectIcon":"assets/images/2026-03-27/2826dc3b7f9a411da2227d899a809a9a.png"},{"title":"湿度","num":"-","unit":"%","icon":"assets/images/2026-03-27/07bc0a16b588486f9d892e258f7d2b55.png","selectIcon":"assets/images/2026-03-27/07bc0a16b588486f9d892e258f7d2b55.png"},{"title":"降雨量","num":"-","unit":"mm","icon":"assets/images/2026-03-27/6f43e22929d64082a78c27eb2eea728e.png","selectIcon":"assets/images/2026-03-27/6f43e22929d64082a78c27eb2eea728e.png"},{"title":"气压","num":"-","unit":"hPa","icon":"assets/images/2026-03-27/330100078adc4cffad00ad33ceaba64b.png","selectIcon":"assets/images/2026-03-27/330100078adc4cffad00ad33ceaba64b.png"}],
spacingX:8,
col:4,
direction:"vertical",
exchangeOrder:false,
...
active:"",
cStyle:{"wrapper":{"default":{"width":"824px","height":"92px","position":"unset","left":"0px","top":"130px","background":"rgba(0, 0, 0, 0)","fillType":"color"}},"innerWrapper":{"default":{"display":"flex","flexWrap":"wrap","boxSizing":"border-box","width":"100%","height":"100%","justifyContent":"space-between","alignItems":"center","gap":"auto","flexDirection":"row"}},"outerWrapper":{"default":{"width":"16%","height":"auto","padding":"0px"}},"itemWrapper":{"default":{"background":"#023481","display":"flex","justifyContent":"space-between","gap":"auto","alignItems":"center","flexDirection":"row","height":"","fillType":"color","borderDirection":"all","borderLeft":"1px Solid rgba(138, 210, 255, 0.5)","borderTop":"1px Solid rgba(138, 210, 255, 0.5)","borderRight":"1px Solid rgba(138, 210, 255, 0.5)","borderBottom":"1px Solid rgba(138, 210, 255, 0.5)","border":"auto !important","position":"relative"}},"rightContent":{"default":{"height":"auto","justifyContent":"center","alignItems":"center","flexDirection":"column","display":"flex","gap":"auto","backgroundColor":""}},"specialItemWrapper":{"default":{"backgroundColor":""}},"icon":{"default":{"width":"18px","height":"18px","background":"","backgroundSize":"100% 100%","backgroundRepeat":"no-repeat","fillType":"image","position":"absolute","top":"10px","left":"var(--icon-air-meteorology-left)","float":"right","clear":"none"},"active":{}},"cardIcon":{"default":{"position":"static","top":"10px","left":"20px"}},"specialCardIcon":{"default":{"position":"static"}},"num":{"default":{"verticalAlign":"-1px","overflow":"hidden","color":"rgba(242, 244, 247, 1)","fontWeight":"500","fontSize":"var(--text-size-14)","fontFamily":"微软雅黑","textOverflow":"ellipsis","whiteSpace":"nowrap","background":"unset","backgroundClip":"unset"}},"numBox":{"default":{"justifyContent":"space-between","alignItems":"center","flexDirection":"row","display":"flex"}},"title":{"default":{"color":"rgba(255, 255, 255, 1)","fontSize":"var(--text-size-14)","background":"unset","backgroundClip":"unset","backgroundColor":"#014FB8","width":"100%","borderTopLeftRadius":"2px","borderTopRightRadius":"2px","marginRight":"0px !important"}},"unit":{"default":{"color":"#8AD2FF","fontSize":"var(--text-size-14)","background":"unset","backgroundClip":"unset","marginLeft":"5px"}}}, 
 },
},
...
cStyle:{"wrapper":{"default":{"width":"100%","height":"calc(100% - 290px)","position":"unset","left":"0px","top":"290px"}},"emptyText":{"default":{"color":"rgba(252, 252, 252, 1)","fontSize":"14px"}}},
showItemBg:false,
options: computed(() => _.merge({}, activeChartThemeOptions.value, {"grid":{"containLabel":true,"left":"4%","bottom":"4%","right":"2%","top":"8%"},"legend":{"show":false},"yAxis":{"name":"m/s","nameTextStyle":{"color":"var(--business-text-avianize)"}},"dataZoom":[{"type":"slider","backgroundColor":"var(--business-show-bg30)","borderColor":"var(--business-show-bg30)","borderRadius":0,"showDetail":false,"showDataShadow":false,"zoomLock":false,"height":15,"start":0,"end":50,"brushSelect":false,"bottom":"0%","brushStyle":{"color":"#000"},"fillerColor":"var(--business-btn-default)","handleStyle":{"color":"#2D955A","borderColor":"#D1D5D9","borderCap":"round"}}]})),
data:[],
seriesSetting:{"xAxisLabel":"DDATETIME","data":[{"name":"风速","dataKey":"WD10DF","windKey":"direction","style":{"label":{"show":false},"symbol":"assets/images/chart-wind-direction/arrow.png","symbolSize":[20,20],"lineStyle":{"color":"#266FE8"}},"isOpenLineColor":true}],"windData":{"north":"1","northeast":"2","east":"3","sortheast":"4","sorth":"5","sorthwest":"6","west":"7","northwest":"8"}},
mainAxis:"x", 
 },
},
tRowx0x7: {
...
registerMapName:"",
geoJson:{},
emptyImg:"assets/images/emptyImg.png",
...
state.options = {
  ...
  "xAxis": {
    type: 'category',
    data: state.chartList.map(item => item.DDATETIME),
    axisLabel: {
...
let pointCode = getUrlParamValue('POINT_CODE');
state.pointCode = pointCode || '';
async function getData() {
  debugger;
  // await apiRegistry.getLatestTime.request();
  await apiRegistry.getBaseInfo.request();
  state.endTime = state.baseInfo.DDATETIME;
  state.startTime = getPrevTime(state.endTime + ':00', 'hour').slice(0, 16)
...
// 接口函数
 getListData: {
              ...
              config: {"url":"state.serviceBasePath1","method":"get","baseURL":"state.foshanServiceBaseUrl1","params":{"DDATETIME_END":"state.endTime","DDATETIME_START":"state.startTime","OBTID":"state.pointCode","interfaceId":"4811e7f1024af3bc91f99447f3216912"}},
              request: function ( componentId) {
return new Promise((resolve, reject) => {
  
                http({"url":state.serviceBasePath1,"method":"get","baseURL":state.foshanServiceBaseUrl1,"params":{"DDATETIME_END":state.endTime,"DDATETIME_START":state.startTime,"OBTID":state.pointCode,"interfaceId":"4811e7f1024af3bc91f99447f3216912"},}).then((res) => {
 
                   // 成功的操作
                   const cacheKey = generateCacheKey('state.foshanServiceBaseUrl1-state.serviceBasePath1',  {"DDATETIME_END":state.endTime,"DDATETIME_START":state.startTime,"OBTID":state.pointCode,"interfaceId":"4811e7f1024af3bc91f99447f3216912"});
...
if (head.statusCode === "200" && data.length) {
  state.chartList = data
    .map((item) => {
      return {
        ...item,
        direction: handleWindDirection(item.WD10DD), // 参数注意修改
      };
    })
    .sort(
      (a, b) =>
        new Date(a.DDATETIME).getTime() -
        new Date(b.DDATETIME).getTime(),
    );
...
// 接口函数
 getBaseInfo: {
              ...
              autoLoad: false, // 自动请求
              bindComponents: [], // 依赖的组件ID列表，可能多个组件绑定一个接口的数据
              config: {"url":"state.serviceBasePath1","method":"get","baseURL":"state.foshanServiceBaseUrl1","params":{"OBTID":"state.pointCode","interfaceId":"754cc9aea873bfc26810df06ea92d34b"}},
              request: function ( componentId) {
return new Promise((resolve, reject) => {
  
                http({"url":state.serviceBasePath1,"method":"get","baseURL":state.foshanServiceBaseUrl1,"params":{"OBTID":state.pointCode,"interfaceId":"754cc9aea873bfc26810df06ea92d34b"},}).then((res) => {
 
                   // 成功的操作
                   const cacheKey = generateCacheKey('state.foshanServiceBaseUrl1-state.serviceBasePath1',  {"OBTID":state.pointCode,"interfaceId":"754cc9aea873bfc26810df06ea92d34b"});
...
const { data, head } = res.data;
if (head.statusCode === '200' && data.length) {
    state.baseInfo.DDATETIME = data[0].DDATETIME || '-'
    state.baseInfo.latitude = data[0].LAT || '-'
    state.baseInfo.longitude = data[0].LON || '-'
    state.monitorData = [
        {
            "title": "风速",
            "num": data[0].WD10DF || '-',
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-qxBaseInfoFoShan', global.appScaleMode, 'normal');
...
.t-l-c-qxBaseInfoFoShan .qxBaseInfoFoShan-t-component-0-0 {
...
.t-l-c-qxBaseInfoFoShan .qxBaseInfoFoShan-t-text-0-1 {
position: absolute !important;
top: 98px;
left: 29px;
width: 130px;
...
.t-l-c-qxBaseInfoFoShan .qxBaseInfoFoShan-t-table-0-2 {
position: absolute !important;
top: 300px;
left: 0px;
width: 100%;
...
.t-l-c-qxBaseInfoFoShan .qxBaseInfoFoShan-t-row-0-3 {
position: absolute !important;
top: 227px;
left: 0px;
width: 100%;
...
.t-l-c-qxBaseInfoFoShan .qxBaseInfoFoShan-t-col-0-3-0 {
position: relative;
top: null;
left: null;
width: 100px;
...
.t-l-c-qxBaseInfoFoShan .qxBaseInfoFoShan-t-text-0-3-0-0 {
position: unset;
top: 208px;
left: 0px;
width: auto;
...
.t-l-c-qxBaseInfoFoShan .qxBaseInfoFoShan-t-date-picker-0-3-0-1 {
position: unset;
top: 304px;
left: 414px;
width: 380px;
...
.t-l-c-qxBaseInfoFoShan .qxBaseInfoFoShan-t-col-0-3-1 {
position: relative;
top: null;
left: null;
width: 100px;
...
.t-l-c-qxBaseInfoFoShan .qxBaseInfoFoShan-t-select-0-3-1-0 {
position: unset;
top: 208px;
left: 704px;
width: 180px;
...
.t-l-c-qxBaseInfoFoShan .qxBaseInfoFoShan-t-select-0-3-1-1 {
position: unset;
top: 218px;
left: 714px;
width: 120px;
...
.t-l-c-qxBaseInfoFoShan .qxBaseInfoFoShan-t-text-0-4 {
position: absolute !important;
top: 265px;
left: 24px;
width: 99px;
...
.t-l-c-qxBaseInfoFoShan .qxBaseInfoFoShan-t-list-card-0-5 {
position: absolute !important;
top: 130px;
left: 0px;
width: 824px;
...
.t-l-c-qxBaseInfoFoShan .qxBaseInfoFoShan-t-chart-wind-direction-0-6 {
position: absolute !important;
top: 290px;
left: 0px;
width: 100%;
...
.t-l-c-qxBaseInfoFoShan .qxBaseInfoFoShan-t-row-0-7 {
position: absolute !important;
top: 0px;
left: 0px;
width: 100%;
...
.t-l-c-qxBaseInfoFoShan .qxBaseInfoFoShan-t-row-0-7-0 {
position: unset;
top: 108px;
left: 85px;
width: 100%;
...
.t-l-c-qxBaseInfoFoShan .qxBaseInfoFoShan-t-col-0-7-0-0 {
position: relative;
top: null;
left: null;
width: 100px;
...
.t-l-c-qxBaseInfoFoShan .qxBaseInfoFoShan-t-text-0-7-0-0-0 {
position: unset;
top: 107px;
left: 80px;
width: 100%;
...
.t-l-c-qxBaseInfoFoShan .qxBaseInfoFoShan-t-col-0-7-0-1 {
position: relative;
top: null;
left: null;
width: 100px;
...
.t-l-c-qxBaseInfoFoShan .qxBaseInfoFoShan-t-text-0-7-0-1-0 {
position: unset;
top: 107px;
left: 202px;
width: 100%;
...
.t-l-c-qxBaseInfoFoShan .qxBaseInfoFoShan-t-row-0-7-1 {
position: unset;
top: 98px;
left: 75px;
width: 100%;
...
.t-l-c-qxBaseInfoFoShan .qxBaseInfoFoShan-t-col-0-7-1-0 {
position: relative;
top: null;
left: null;
width: 100px;
...
.t-l-c-qxBaseInfoFoShan .qxBaseInfoFoShan-t-text-0-7-1-0-0 {
position: unset;
top: 97px;
left: 70px;
width: 100%;
...
.t-l-c-qxBaseInfoFoShan .qxBaseInfoFoShan-t-col-0-7-1-1 {
position: relative;
top: null;
left: null;
width: 100px;
...
.t-l-c-qxBaseInfoFoShan .qxBaseInfoFoShan-t-text-0-7-1-1-0 {
position: unset;
top: 97px;
left: 192px;
width: 100%;
...
.t-l-c-qxBaseInfoFoShan .qxBaseInfoFoShan-t-col-0-7-1-2 {
position: relative;
top: null;
left: null;
width: 100px;
...
.t-l-c-qxBaseInfoFoShan .qxBaseInfoFoShan-t-text-0-7-1-2-0 {
position: unset;
top: 97px;
left: 549px;
width: 100%;
...
.t-l-c-qxBaseInfoFoShan .qxBaseInfoFoShan-t-col-0-7-1-3 {
position: relative;
top: null;
left: null;
width: 100px;
...
.t-l-c-qxBaseInfoFoShan .qxBaseInfoFoShan-t-text-0-7-1-3-0 {
position: unset;
top: 97px;
left: 671px;
width: 100%;
...
.t-l-c-qxBaseInfoFoShan .qxBaseInfoFoShan-t-chart-design-0-8 {
position: absolute !important;
top: 290px;
left: 0px;
width: 100%;

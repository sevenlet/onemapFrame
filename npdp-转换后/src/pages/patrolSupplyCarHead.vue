<template>
  <div id="t-l-c-patrolSupplyCarHead" class="t-l-c-patrolSupplyCarHead" ><t-row id="t-row-a9c1.ffb0f3adb" class="patrolSupplyCarHead-t-row-0-0"  :c-style="tRowx0x0ComputedData.cStyle" :gutter="tRowx0x0ComputedData.gutter" :justify="tRowx0x0ComputedData.justify" :align="tRowx0x0ComputedData.align"><t-text-common id="t-text-common-ebb5.079f4d7f8" class="patrolSupplyCarHead-t-text-common-0-0-0"  :label="tTextCommonx0x0x0ComputedData.label" :editable="tTextCommonx0x0x0ComputedData.editable" :c-style="tTextCommonx0x0x0ComputedData.cStyle"></t-text-common><t-rect id="t-rect-5ddd.c09e8a3a4" class="patrolSupplyCarHead-t-rect-0-0-1"  :tip="tRectx0x0x1ComputedData.tip" :label="tRectx0x0x1ComputedData.label" :active="tRectx0x0x1ComputedData.active" :c-style="tRectx0x0x1ComputedData.cStyle"></t-rect></t-row></div>
</template>
...
import { TRect, TRow, TTextCommon } from '@ths/design';
...
// 接口函数
 getBaseInfo: {
              ...
              config: {"url":"global.serviceBasePath","method":"get","baseURL":"global.foshanServiceBaseUrl","params":{"id":"","device_id":"global.airGlobalVariables.waterSprinklerTruck.VMN","VMN_TYPE":"wzc","interfaceId":"cec8a9f0eb62383b2ed0703f87a7b455"}},
              request: function ( componentId) {
return new Promise((resolve, reject) => {
  
                http({"url":global.serviceBasePath,"method":"get","baseURL":global.foshanServiceBaseUrl,"params":{"id":"","device_id":global.airGlobalVariables.waterSprinklerTruck.VMN,"VMN_TYPE":"wzc","interfaceId":"cec8a9f0eb62383b2ed0703f87a7b455"},}).then((res) => {
 
                   // 成功的操作
                   const cacheKey = generateCacheKey('global.foshanServiceBaseUrl-global.serviceBasePath',  {"id":"","device_id":global.airGlobalVariables.waterSprinklerTruck.VMN,"VMN_TYPE":"wzc","interfaceId":"cec8a9f0eb62383b2ed0703f87a7b455"});
...
deep: true, // 深度监听
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-patrolSupplyCarHead', global.appScaleMode, 'normal');
...
.t-l-c-patrolSupplyCarHead .patrolSupplyCarHead-t-row-0-0 {
...
.t-l-c-patrolSupplyCarHead .patrolSupplyCarHead-t-text-common-0-0-0 {
position: unset;
top: 207px;
left: 375px;
width: auto;
...
.t-l-c-patrolSupplyCarHead .patrolSupplyCarHead-t-rect-0-0-1 {
position: unset;
top: 205px;
left: 505px;
width: 80px;

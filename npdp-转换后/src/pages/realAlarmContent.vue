<template>
  <div id="t-l-c-realAlarmContent" class="t-l-c-realAlarmContent" ><t-component id="t-component-3f9e.6d1636f5c" class="realAlarmContent-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName" :page-id="tComponentx0x0ComputedData.pageId" :page-code="tComponentx0x0ComputedData.pageCode"></t-component><t-component id="t-component-9c0b.c1f74dcf8" class="realAlarmContent-t-component-0-1"  :name="tComponentx0x1ComputedData.name" :c-style="tComponentx0x1ComputedData.cStyle" :src="tComponentx0x1ComputedData.src" :component-name="tComponentx0x1ComputedData.componentName" :page-id="tComponentx0x1ComputedData.pageId" :page-code="tComponentx0x1ComputedData.pageCode"></t-component><t-date-picker id="t-date-picker-f414.3a989b7ec" class="realAlarmContent-t-date-picker-0-3"  :placeholder="tDatePickerx0x3ComputedData.placeholder" :start-placeholder="tDatePickerx0x3ComputedData.startPlaceholder" :end-placeholder="tDatePickerx0x3ComputedData.endPlaceholder" :type="tDatePickerx0x3ComputedData.type" :clearable="tDatePickerx0x3ComputedData.clearable" :range-separator="tDatePickerx0x3ComputedData.rangeSeparator" :default-date="replaceCssVariables(filterData(global.airGlobalVariables.realTimeAlarm.dateValue, componentPropBindingMap?.['t-date-picker-f414.3a989b7ec']['default-date'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :separator="tDatePickerx0x3ComputedData.separator" :readonly="tDatePickerx0x3ComputedData.readonly" :editable="tDatePickerx0x3ComputedData.editable" :c-style="tDatePickerx0x3ComputedData.cStyle" @date-change="ondateChange1764294836112"></t-date-picker><t-component id="t-component-49c4.498b04c77" class="realAlarmContent-t-component-0-6"  :name="tComponentx0x6ComputedData.name" :c-style="tComponentx0x6ComputedData.cStyle" :src="tComponentx0x6ComputedData.src" :component-name="tComponentx0x6ComputedData.componentName" :page-id="tComponentx0x6ComputedData.pageId" :page-code="tComponentx0x6ComputedData.pageCode"></t-component><t-tabs-base id="t-tabs-base-13c4.ae5d168bb" class="realAlarmContent-t-tabs-base-0-7"  :data="tTabsBasex0x7ComputedData.data" :space="tTabsBasex0x7ComputedData.space" :selected-tab-val="replaceCssVariables(filterData(state.currentType, componentPropBindingMap?.['t-tabs-base-13c4.ae5d168bb']['selectedTabVal'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :inner-shadow-color="tTabsBasex0x7ComputedData.innerShadowColor" :active-inner-shadow-color="tTabsBasex0x7ComputedData.activeInnerShadowColor" :alias="tTabsBasex0x7ComputedData.alias" :c-style="tTabsBasex0x7ComputedData.cStyle" @tab-click="ontabClick1766373279462_0_0"></t-tabs-base><t-text-unit v-if="state.currentType === 'auto'" id="t-text-unit-f35b.c556743c2" class="realAlarmContent-t-text-unit-0-8"  :c-style="tTextUnitx0x8ComputedData.cStyle" :content="replaceCssVariables(filterData(state.refreshTime, componentPropBindingMap?.['t-text-unit-f35b.c556743c2']['content'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :unit="tTextUnitx0x8ComputedData.unit" :show-overflow-tooltip="tTextUnitx0x8ComputedData.showOverflowTooltip"></t-text-unit><t-image-base id="t-image-base-b991.dde902a68" class="realAlarmContent-t-image-base-0-9"  :src="tImageBasex0x9ComputedData.src" :fit="tImageBasex0x9ComputedData.fit" :c-style="tImageBasex0x9ComputedData.cStyle" @click="onclick1766392254927"></t-image-base></div>
</template>
...
import { TComponent, TDatePicker, TImageBase, TTabsBase, TTextUnit } from '@ths/design';
...
tImageBasex0x9: {
defaultStyle: {
            default: {"width":"20px","height":"20px","cursor":"pointer","animationName":"","-webkit-mask-image":"url(assets/images/2026-05-06/e2068acfee6646b4b524f5411f6d49cf.svg)","-webkit-mask-position":"50% 50%","-webkit-mask-repeat":"no-repeat","-webkit-mask-size":"100% 100%","backgroundImage":"","backgroundPosition":"","backgroundRepeat":"","backgroundSize":"","color":"","backgroundColor":"var(--business-white)"},
...
src:"",
fit:"fill",
cStyle:{"wrapper":{"default":{"width":"20px","height":"20px","cursor":"pointer","animationName":"","-webkit-mask-image":"url(assets/images/2026-05-06/e2068acfee6646b4b524f5411f6d49cf.svg)","-webkit-mask-position":"50% 50%","-webkit-mask-repeat":"no-repeat","-webkit-mask-size":"100% 100%","backgroundImage":"","backgroundPosition":"","backgroundRepeat":"","backgroundSize":"","color":"","backgroundColor":"var(--business-white)"}}}, 
 },
},
});
...
.t-l-c-realAlarmContent .realAlarmContent-t-component-0-0 {
...
.t-l-c-realAlarmContent .realAlarmContent-t-component-0-1 {
position: absolute !important;
top: 751px;
left: 20px;
width: 410px;
...
.t-l-c-realAlarmContent .realAlarmContent-t-date-picker-0-3 {
position: absolute !important;
top: 13px;
left: 20px;
width: 178px;
...
.t-l-c-realAlarmContent .realAlarmContent-t-component-0-6 {
position: absolute !important;
top: 363px;
left: 20px;
width: 410px;
...
.t-l-c-realAlarmContent .realAlarmContent-t-tabs-base-0-7 {
position: absolute !important;
top: 13px;
left: 209px;
width: 140px;
...
.t-l-c-realAlarmContent .realAlarmContent-t-text-unit-0-8 {
position: absolute !important;
top: 19px;
left: 388px;
width: 50px;
...
.t-l-c-realAlarmContent .realAlarmContent-t-image-base-0-9 {
position: absolute !important;
top: 19px;
left: 360px;
width: 20px;

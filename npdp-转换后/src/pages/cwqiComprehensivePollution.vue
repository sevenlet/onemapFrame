<template>
  <div id="t-l-c-cwqiComprehensivePollution" class="t-l-c-cwqiComprehensivePollution" ><t-component id="t-component-a4b4.7625ba7a4" class="cwqiComprehensivePollution-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName" :page-id="tComponentx0x0ComputedData.pageId" :page-code="tComponentx0x0ComputedData.pageCode"></t-component><t-text-common id="t-text-common-a60e.1f345df9a" class="cwqiComprehensivePollution-t-text-common-0-1"  :label="tTextCommonx0x1ComputedData.label" :editable="tTextCommonx0x1ComputedData.editable" :c-style="tTextCommonx0x1ComputedData.cStyle"></t-text-common><t-row id="t-row-484c.8e4518314" class="cwqiComprehensivePollution-t-row-0-2"  :c-style="tRowx0x2ComputedData.cStyle" :gutter="tRowx0x2ComputedData.gutter" :justify="tRowx0x2ComputedData.justify" :align="tRowx0x2ComputedData.align"><t-col id="t-col-3f65.aabde4483" class="cwqiComprehensivePollution-t-col-0-2-0"  :span="tColx0x2x0ComputedData.span" :offset="tColx0x2x0ComputedData.offset" :push="tColx0x2x0ComputedData.push" :pull="tColx0x2x0ComputedData.pull" :c-style="tColx0x2x0ComputedData.cStyle"><t-chart-bar-simple id="t-chart-bar-simple-171e.9bc629894" class="cwqiComprehensivePollution-t-chart-bar-simple-0-2-0-0"  :empty-img="tChartBarSimplex0x2x0x0ComputedData.emptyImg" :c-style="tChartBarSimplex0x2x0x0ComputedData.cStyle" :options="tChartBarSimplex0x2x0x0ComputedData.options" :data="replaceCssVariables(filterData(state.list, componentPropBindingMap?.['t-chart-bar-simple-171e.9bc629894']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :series-setting="tChartBarSimplex0x2x0x0ComputedData.seriesSetting" :main-axis="tChartBarSimplex0x2x0x0ComputedData.mainAxis" :bar="componentState.tChartBarSimplex0x2x0x0.bar"></t-chart-bar-simple></t-col><t-col id="t-col-f391.524caa70a" class="cwqiComprehensivePollution-t-col-0-2-1"  :span="tColx0x2x1ComputedData.span" :offset="tColx0x2x1ComputedData.offset" :push="tColx0x2x1ComputedData.push" :pull="tColx0x2x1ComputedData.pull" :c-style="tColx0x2x1ComputedData.cStyle"><t-table v-if="state.isShowList === true" id="t-table-896d.f0d26022e" class="cwqiComprehensivePollution-t-table-0-2-1-0"  :height="tTablex0x2x1x0ComputedData.height" :stripe="tTablex0x2x1x0ComputedData.stripe" :border="tTablex0x2x1x0ComputedData.border" :auto-scroll="tTablex0x2x1x0ComputedData.autoScroll" :speed="tTablex0x2x1x0ComputedData.speed" :columns="tTablex0x2x1x0ComputedData.columns" :data="replaceCssVariables(filterData(state.list, componentPropBindingMap?.['t-table-896d.f0d26022e']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x2x1x0ComputedData.defaultSort" :c-style="tTablex0x2x1x0ComputedData.cStyle"></t-table><t-pagination-base id="t-pagination-base-96eb.3c54cf0e6" class="cwqiComprehensivePollution-t-pagination-base-0-2-1-1"  :total="replaceCssVariables(filterData(state.pageInfo.total, componentPropBindingMap?.['t-pagination-base-96eb.3c54cf0e6']['total'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :small="tPaginationBasex0x2x1x1ComputedData.small" :page-size="replaceCssVariables(filterData(state.pageInfo.pageSize, componentPropBindingMap?.['t-pagination-base-96eb.3c54cf0e6']['pageSize'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :pager-count="tPaginationBasex0x2x1x1ComputedData.pagerCount" :current-page="replaceCssVariables(filterData(state.pageInfo.pageNum, componentPropBindingMap?.['t-pagination-base-96eb.3c54cf0e6']['currentPage'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :layout="tPaginationBasex0x2x1x1ComputedData.layout" :page-sizes="tPaginationBasex0x2x1x1ComputedData.pageSizes" :disabled="tPaginationBasex0x2x1x1ComputedData.disabled" :c-style="tPaginationBasex0x2x1x1ComputedData.cStyle" @size-change="onsizeChange1765955291451_0_0" @current-change="oncurrentChange1765955291451_0_1"></t-pagination-base></t-col></t-row><t-text id="t-text-6583.da38b228" class="cwqiComprehensivePollution-t-text-0-3"  :label="tTextx0x3ComputedData.label" :editable="tTextx0x3ComputedData.editable" :c-style="tTextx0x3ComputedData.cStyle"></t-text><t-text id="t-text-4e12.f91e4a6b" class="cwqiComprehensivePollution-t-text-0-4"  :label="replaceCssVariables(filterData(state.monitorTime, componentPropBindingMap?.['t-text-4e12.f91e4a6b']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x4ComputedData.editable" :c-style="tTextx0x4ComputedData.cStyle"></t-text></div>
</template>
...
import { TChartBarSimple, TCol, TComponent, TPaginationBase, TRow, TTable, TText, TTextCommon } from '@ths/design';
...
<style scoped>
.t-l-c-cwqiComprehensivePollution {
position: relative;
overflow: hidden;
...
.t-l-c-cwqiComprehensivePollution .cwqiComprehensivePollution-t-component-0-0 {
...
.t-l-c-cwqiComprehensivePollution .cwqiComprehensivePollution-t-text-common-0-1 {
position: absolute !important;
top: 39px;
left: 15px;
width: 52px;
...
.t-l-c-cwqiComprehensivePollution .cwqiComprehensivePollution-t-row-0-2 {
position: absolute !important;
top: 17px;
left: 1px;
width: 100%;
...
.t-l-c-cwqiComprehensivePollution .cwqiComprehensivePollution-t-col-0-2-0 {
position: relative;
top: null;
left: null;
width: 100px;
...
.t-l-c-cwqiComprehensivePollution .cwqiComprehensivePollution-t-chart-bar-simple-0-2-0-0 {
position: unset;
top: 114px;
left: -318px;
width: 100%;
...
.t-l-c-cwqiComprehensivePollution .cwqiComprehensivePollution-t-col-0-2-1 {
position: relative;
top: null;
left: null;
width: 100px;
...
.t-l-c-cwqiComprehensivePollution .cwqiComprehensivePollution-t-table-0-2-1-0 {
position: unset;
top: 264px;
left: 12px;
width: 100%;
...
.t-l-c-cwqiComprehensivePollution .cwqiComprehensivePollution-t-pagination-base-0-2-1-1 {
position: unset;
top: 347px;
left: 594px;
width: 100%;
...
.t-l-c-cwqiComprehensivePollution .cwqiComprehensivePollution-t-text-0-3 {
position: absolute !important;
top: 1px;
left: 40px;
width: auto;
...
.t-l-c-cwqiComprehensivePollution .cwqiComprehensivePollution-t-text-0-4 {
position: absolute !important;
top: 1px;
left: 646px;
width: 164px;

<template>
  <div id="t-l-c-measuresLibraryPopPdfCopy" class="t-l-c-measuresLibraryPopPdfCopy" ><t-iframe id="t-iframe-a2b7.a9ef3178d" class="measuresLibraryPop-t-iframe-0-0"  :src="tIframex0x0ComputedData.src" :srcdoc="tIframex0x0ComputedData.srcdoc" :scrolling="tIframex0x0ComputedData.scrolling" :c-style="tIframex0x0ComputedData.cStyle"></t-iframe></div>
</template>
...
export default {
  ...
  setup() {
const componentPropBindingMap = {"body":{"attributeName":"tBodyx0x0"},"t-iframe-a2b7.a9ef3178d":{"attributeName":"tIframex0x0","src":{"filters":[]},"srcdoc":{"filters":[]},"scrolling":{"filters":[]},"cStyle":{"filters":[]}}};
// 页面内注入全局变量和事件
...
src:"http://192.168.24.106:10157/tqyj.pdf",
srcdoc:"",
scrolling:"no",
...
window.open('http://192.168.24.106:10157/tqyj.pdf', '_blank');
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-measuresLibraryPopPdfCopy', global.appScaleMode, 'normal');
...
<style scoped>
.t-l-c-measuresLibraryPopPdfCopy {
position: relative;
overflow: hidden;
...
.t-l-c-measuresLibraryPopPdfCopy .measuresLibraryPop-t-iframe-0-0 {

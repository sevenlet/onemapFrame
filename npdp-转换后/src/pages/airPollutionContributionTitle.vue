<template>
  <div id="t-l-c-airPollutionContributionTitle" class="t-l-c-airPollutionContributionTitle" ><t-component id="t-component-6f3b.f3ecc4cb7" class="airPollutionContributionTitle-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName"></t-component><t-text id="t-text-4f12.f427f5fe7" class="airPollutionContributionTitle-t-text-0-1"  :label="state.titleText" :editable="tTextx0x1ComputedData.editable" :c-style="tTextx0x1ComputedData.cStyle"></t-text><t-text id="t-text-fd83.ca236cbcf" class="airPollutionContributionTitle-t-text-0-2"  :label="tTextx0x2ComputedData.label" :editable="tTextx0x2ComputedData.editable" :c-style="tTextx0x2ComputedData.cStyle" @click="onclick1734435804241"></t-text></div>
</template>
...
<style scoped>
.t-l-c-airPollutionContributionTitle {
position: relative;
overflow: hidden;
...
.t-l-c-airPollutionContributionTitle .airPollutionContributionTitle-t-component-0-0 {
...
.t-l-c-airPollutionContributionTitle .airPollutionContributionTitle-t-text-0-1 {
position: absolute !important;
top: 6px;
left: 34px;
width: 285px;
...
.t-l-c-airPollutionContributionTitle .airPollutionContributionTitle-t-text-0-2 {
position: absolute !important;
top: 7px;
left: 320px;
width: 80px;

<template>
  <div id="t-l-c-airCenterIndexContainer" class="t-l-c-airCenterIndexContainer" ><t-rect id="t-rect-54ba.408ebfad2" class="airCenterIndexContainer-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle"></t-rect><t-component v-if="state.showPollutionIndex === true" id="t-component-3a14.f07066497" class="airCenterIndexContainer-t-component-0-1"  :name="tComponentx0x1ComputedData.name" :c-style="tComponentx0x1ComputedData.cStyle" :src="tComponentx0x1ComputedData.src" :component-name="tComponentx0x1ComputedData.componentName"></t-component><t-component id="t-component-3689.537b2a738" class="airCenterIndexContainer-t-component-0-2"  :name="tComponentx0x2ComputedData.name" :c-style="tComponentx0x2ComputedData.cStyle" :src="tComponentx0x2ComputedData.src" :component-name="tComponentx0x2ComputedData.componentName"></t-component><t-component v-if="state.showWeatherIndex === true" id="t-component-7a64.e226fd22f" class="airCenterIndexContainer-t-component-0-3"  :name="tComponentx0x3ComputedData.name" :c-style="tComponentx0x3ComputedData.cStyle" :src="tComponentx0x3ComputedData.src" :component-name="tComponentx0x3ComputedData.componentName"></t-component><t-rect v-if="state.showContent === true" id="t-rect-a122.67a8288a4" class="airCenterIndexContainer-t-rect-0-4"  :tip="tRectx0x4ComputedData.tip" :label="tRectx0x4ComputedData.label" :active="tRectx0x4ComputedData.active" :c-style="tRectx0x4ComputedData.cStyle" @click="onclick1734686591589"></t-rect><t-text v-if="state.showContent === false" id="t-text-50f5.0d6af7e03" class="airCenterIndexContainer-t-text-0-5"  :label="tTextx0x5ComputedData.label" :editable="tTextx0x5ComputedData.editable" :c-style="tTextx0x5ComputedData.cStyle" :show-title="tTextx0x5ComputedData.showTitle" @click="onclick1734686575114"></t-text></div>
</template>
...
import { TComponent, TRect, TText } from '@ths/design';
...
.t-l-c-airCenterIndexContainer .airCenterIndexContainer-t-rect-0-0 {
...
.t-l-c-airCenterIndexContainer .airCenterIndexContainer-t-component-0-1 {
position: absolute !important;
top: 8px;
left: 8px;
width: 498px;
...
.t-l-c-airCenterIndexContainer .airCenterIndexContainer-t-component-0-2 {
position: absolute !important;
top: 48px;
left: 388px;
width: 154px;
...
.t-l-c-airCenterIndexContainer .airCenterIndexContainer-t-component-0-3 {
position: absolute !important;
top: 52px;
left: 8px;
width: 286px;
...
.t-l-c-airCenterIndexContainer .airCenterIndexContainer-t-rect-0-4 {
position: absolute !important;
top: 7px;
left: 507px;
width: 39px;
...
.t-l-c-airCenterIndexContainer .airCenterIndexContainer-t-text-0-5 {
position: absolute !important;
top: 0px;
left: 507px;
width: 39px;

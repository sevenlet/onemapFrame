<template>
  <div id="t-l-c-livestockBreedingCopy" class="t-l-c-livestockBreedingCopy" ><t-rect id="t-rect-8252.1a4ade4f4" class="livestockBreedingCopy-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle"></t-rect><t-component id="t-component-75a5.51539ef39" class="livestockBreedingCopy-t-component-0-1"  :name="replaceCssVariables(filterData(state.activeTab, componentPropBindingMap?.['t-component-75a5.51539ef39']['name'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :c-style="tComponentx0x1ComputedData.cStyle" :src="tComponentx0x1ComputedData.src" :component-name="replaceCssVariables(filterData(state.activeTab, componentPropBindingMap?.['t-component-75a5.51539ef39']['componentName'].filters || []), global?.theme || global?.activeTheme || '默认主题')"></t-component><t-rect id="t-rect-71af.6d10fdece" class="livestockBreedingCopy-t-rect-0-2"  :tip="tRectx0x2ComputedData.tip" :label="tRectx0x2ComputedData.label" :active="tRectx0x2ComputedData.active" :c-style="tRectx0x2ComputedData.cStyle"></t-rect><t-rect id="t-rect-e3a7.d7772ec8d" class="livestockBreedingCopy-t-rect-0-3"  :tip="tRectx0x3ComputedData.tip" :label="tRectx0x3ComputedData.label" :active="tRectx0x3ComputedData.active" :c-style="tRectx0x3ComputedData.cStyle"></t-rect><t-rect id="t-rect-5577.0975bb8d2" class="livestockBreedingCopy-t-rect-0-4"  :tip="tRectx0x4ComputedData.tip" :label="tRectx0x4ComputedData.label" :active="tRectx0x4ComputedData.active" :c-style="tRectx0x4ComputedData.cStyle"></t-rect><t-tabs id="t-tabs-36ee.81d7b3b28" class="livestockBreedingCopy-t-tabs-0-5"  :data="replaceCssVariables(filterData(state.tabList, componentPropBindingMap?.['t-tabs-36ee.81d7b3b28']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active-tab="tTabsx0x5ComputedData.activeTab" :tab-position-extend="tTabsx0x5ComputedData.tabPositionExtend" :stretch="tTabsx0x5ComputedData.stretch" :c-style="tTabsx0x5ComputedData.cStyle"></t-tabs><t-row id="t-row-a98e.97de7da75" class="livestockBreedingCopy-t-row-0-7"  :c-style="tRowx0x7ComputedData.cStyle" :gutter="tRowx0x7ComputedData.gutter" :justify="tRowx0x7ComputedData.justify" :align="tRowx0x7ComputedData.align"><t-text id="t-text-8cba.b16affff7" class="livestockBreedingCopy-t-text-0-7-0"  :label="replaceCssVariables(filterData(state.baseInfo.title, componentPropBindingMap?.['t-text-8cba.b16affff7']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x7x0ComputedData.editable" :c-style="tTextx0x7x0ComputedData.cStyle" :show-title="tTextx0x7x0ComputedData.showTitle"></t-text><t-rect v-if="state.baseInfo.alarmText !== ''" id="t-rect-4bb6.47291368" class="livestockBreedingCopy-t-rect-0-7-1"  :tip="tRectx0x7x1ComputedData.tip" :label="tRectx0x7x1ComputedData.label" :active="tRectx0x7x1ComputedData.active" :c-style="tRectx0x7x1ComputedData.cStyle" @mouseover="onmouseover1733993886943" @mouseout="onmouseout1733993903757"></t-rect></t-row><t-rect v-if="state.baseInfo.alarmShow === true" id="t-rect-16fd.29080fd9c" class="livestockBreedingCopy-t-rect-0-8"  :tip="tRectx0x8ComputedData.tip" :label="replaceCssVariables(filterData(state.baseInfo.alarmText, componentPropBindingMap?.['t-rect-16fd.29080fd9c']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x8ComputedData.active" :c-style="tRectx0x8ComputedData.cStyle"></t-rect><t-rect id="t-rect-da62.857f90ab" class="livestockBreedingCopy-t-rect-0-9"  :tip="tRectx0x9ComputedData.tip" :label="tRectx0x9ComputedData.label" :active="tRectx0x9ComputedData.active" :c-style="tRectx0x9ComputedData.cStyle" @click="onclick1733817210174"></t-rect><t-row id="t-row-6365.97c68ed82" class="livestockBreedingCopy-t-row-0-10"  :c-style="tRowx0x10ComputedData.cStyle" :gutter="tRowx0x10ComputedData.gutter" :justify="tRowx0x10ComputedData.justify" :align="tRowx0x10ComputedData.align"><t-text id="t-text-630e.1af9131a3" class="livestockBreedingCopy-t-text-0-10-0"  :label="tTextx0x10x0ComputedData.label" :editable="tTextx0x10x0ComputedData.editable" :c-style="tTextx0x10x0ComputedData.cStyle" @click="onclick1734068220296"></t-text><t-text id="t-text-19bd.a994fa29f" class="livestockBreedingCopy-t-text-0-10-2"  :label="tTextx0x10x2ComputedData.label" :editable="tTextx0x10x2ComputedData.editable" :c-style="tTextx0x10x2ComputedData.cStyle" @click="onclick1734067550409"></t-text></t-row></div>
</template>
...
.t-l-c-livestockBreedingCopy .livestockBreedingCopy-t-rect-0-0 {
...
.t-l-c-livestockBreedingCopy .livestockBreedingCopy-t-component-0-1 {
position: absolute !important;
top: 63px;
left: 176px;
width: 824px;
...
.t-l-c-livestockBreedingCopy .livestockBreedingCopy-t-rect-0-2 {
position: absolute !important;
top: 660px;
left: 0px;
width: 1020px;
...
.t-l-c-livestockBreedingCopy .livestockBreedingCopy-t-rect-0-3 {
position: absolute !important;
top: 0px;
left: 0px;
width: 1020px;
...
.t-l-c-livestockBreedingCopy .livestockBreedingCopy-t-rect-0-4 {
position: absolute !important;
top: 63px;
left: 20px;
width: 140px;
...
.t-l-c-livestockBreedingCopy .livestockBreedingCopy-t-tabs-0-5 {
position: absolute !important;
top: 66px;
left: 26px;
width: 130px;
...
.t-l-c-livestockBreedingCopy .livestockBreedingCopy-t-row-0-7 {
position: absolute !important;
top: 0px;
left: 18px;
width: 500px;
...
.t-l-c-livestockBreedingCopy .livestockBreedingCopy-t-text-0-7-0 {
position: unset;
top: 13px;
left: 16px;
width: auto;
...
.t-l-c-livestockBreedingCopy .livestockBreedingCopy-t-rect-0-7-1 {
position: unset;
top: 14px;
left: 399px;
width: 20px;
...
.t-l-c-livestockBreedingCopy .livestockBreedingCopy-t-rect-0-8 {
position: absolute !important;
top: 39px;
left: 254px;
width: 297px;
...
.t-l-c-livestockBreedingCopy .livestockBreedingCopy-t-rect-0-9 {
position: absolute !important;
top: 11px;
left: 971px;
width: 24px;
...
.t-l-c-livestockBreedingCopy .livestockBreedingCopy-t-row-0-10 {
position: absolute !important;
top: 672px;
left: 570px;
width: 430px;
...
.t-l-c-livestockBreedingCopy .livestockBreedingCopy-t-text-0-10-0 {
position: unset;
top: 670px;
left: 669px;
width: 90px;
...
.t-l-c-livestockBreedingCopy .livestockBreedingCopy-t-text-0-10-2 {
position: unset;
top: 670px;
left: 870px;
width: 90px;

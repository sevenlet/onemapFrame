<template>
  <div id="t-l-c-recentlyVideoWarningReal" class="t-l-c-recentlyVideoWarningReal" ><t-component id="t-component-aa14.3ba955fbb" class="recentlyVideoWarningReal-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName"></t-component><t-text-unit id="t-text-unit-a3c4.48c326f87" class="recentlyVideoWarningReal-t-text-unit-0-1"  :c-style="tTextUnitx0x1ComputedData.cStyle" :justify="tTextUnitx0x1ComputedData.justify" :align="tTextUnitx0x1ComputedData.align" :content="replaceCssVariables(filterData(state.title, componentPropBindingMap?.['t-text-unit-a3c4.48c326f87']['content'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :unit="tTextUnitx0x1ComputedData.unit" :show-overflow-tooltip="tTextUnitx0x1ComputedData.showOverflowTooltip"></t-text-unit><t-select id="t-select-aa06.70e5fbb7f" class="recentlyVideoWarningReal-t-select-0-2"  :active-value="replaceCssVariables(filterData(state.alarmType, componentPropBindingMap?.['t-select-aa06.70e5fbb7f']['activeValue'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :options="tSelectx0x2ComputedData.options" :alias="tSelectx0x2ComputedData.alias" :multiple="tSelectx0x2ComputedData.multiple" :placeholder="tSelectx0x2ComputedData.placeholder" :clearable="tSelectx0x2ComputedData.clearable" :disabled="tSelectx0x2ComputedData.disabled" :name="tSelectx0x2ComputedData.name" :autocomplete="tSelectx0x2ComputedData.autocomplete" :filterable="tSelectx0x2ComputedData.filterable" :no-match-text="tSelectx0x2ComputedData.no-match-text" :no-data-text="tSelectx0x2ComputedData.no-data-text" :c-style="tSelectx0x2ComputedData.cStyle" @change="onchange1766737799429"></t-select><t-text-common id="t-text-common-54c0.2ab16d38f" class="recentlyVideoWarningReal-t-text-common-0-3"  :label="tTextCommonx0x3ComputedData.label" :editable="tTextCommonx0x3ComputedData.editable" :c-style="tTextCommonx0x3ComputedData.cStyle"></t-text-common><t-table id="t-table-f4d9.66b63002d" class="recentlyVideoWarningReal-t-table-0-4"  :height="tTablex0x4ComputedData.height" :stripe="tTablex0x4ComputedData.stripe" :border="tTablex0x4ComputedData.border" :auto-scroll="tTablex0x4ComputedData.autoScroll" :speed="tTablex0x4ComputedData.speed" :columns="tTablex0x4ComputedData.columns" :data="replaceCssVariables(filterData(state.listData, componentPropBindingMap?.['t-table-f4d9.66b63002d']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x4ComputedData.defaultSort" :c-style="tTablex0x4ComputedData.cStyle" @cell-click="oncellClick1762410432035_0_0"></t-table><t-component v-if="state.isShowImg === true" id="t-component-b1d3.508f21263" class="recentlyVideoWarningReal-t-component-0-5"  :name="tComponentx0x5ComputedData.name" :loading="tComponentx0x5ComputedData.loading" :c-style="tComponentx0x5ComputedData.cStyle" :src="tComponentx0x5ComputedData.src" :component-name="tComponentx0x5ComputedData.componentName" :page-id="tComponentx0x5ComputedData.pageId" :page-code="tComponentx0x5ComputedData.pageCode"></t-component><t-text-common id="t-text-common-69b7.54ad86cf2" class="recentlyVideoWarningReal-t-text-common-0-6"  :label="tTextCommonx0x6ComputedData.label" :editable="tTextCommonx0x6ComputedData.editable" :c-style="tTextCommonx0x6ComputedData.cStyle" @click="onclick1770097504743"></t-text-common></div>
</template>
...
import { TComponent, TSelect, TTable, TTextCommon, TTextUnit } from '@ths/design';
...
<style scoped>
.t-l-c-recentlyVideoWarningReal {
position: relative;
overflow: hidden;
...
.t-l-c-recentlyVideoWarningReal .recentlyVideoWarningReal-t-component-0-0 {
...
.t-l-c-recentlyVideoWarningReal .recentlyVideoWarningReal-t-text-unit-0-1 {
position: absolute !important;
top: 0px;
left: 36px;
width: 230px;
...
.t-l-c-recentlyVideoWarningReal .recentlyVideoWarningReal-t-select-0-2 {
position: absolute !important;
top: 46px;
left: 113px;
width: 295px;
...
.t-l-c-recentlyVideoWarningReal .recentlyVideoWarningReal-t-text-common-0-3 {
position: absolute !important;
top: 46px;
left: 6px;
width: 89px;
...
.t-l-c-recentlyVideoWarningReal .recentlyVideoWarningReal-t-table-0-4 {
position: absolute !important;
top: 97px;
left: 0px;
width: 409px;
...
.t-l-c-recentlyVideoWarningReal .recentlyVideoWarningReal-t-component-0-5 {
position: absolute !important;
top: -1px;
left: 510px;
width: 400px;
...
.t-l-c-recentlyVideoWarningReal .recentlyVideoWarningReal-t-text-common-0-6 {
position: absolute !important;
top: 0px;
left: 308px;
width: 88px;

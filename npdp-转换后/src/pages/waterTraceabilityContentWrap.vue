<template>
  <div id="t-l-c-waterTraceabilityContentWrap" class="t-l-c-waterTraceabilityContentWrap" ><t-component id="t-component-18ba.8b4f27f22" class="waterTraceabilityContentWrap-t-component-0-0"  :name="replaceCssVariables(filterData(state.componentName, componentPropBindingMap?.['t-component-18ba.8b4f27f22']['name'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :loading="tComponentx0x0ComputedData.loading" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="replaceCssVariables(filterData(state.componentName, componentPropBindingMap?.['t-component-18ba.8b4f27f22']['componentName'].filters || []), global?.theme || global?.activeTheme || '默认主题')"></t-component><t-tabs-base id="t-tabs-base-69f4.253cca2ad" class="waterTraceabilityContentWrap-t-tabs-base-0-1"  :data="tTabsBasex0x1ComputedData.data" :space="tTabsBasex0x1ComputedData.space" :selected-tab-val="replaceCssVariables(filterData(state.componentName, componentPropBindingMap?.['t-tabs-base-69f4.253cca2ad']['selectedTabVal'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :inner-shadow-color="tTabsBasex0x1ComputedData.innerShadowColor" :active-inner-shadow-color="tTabsBasex0x1ComputedData.activeInnerShadowColor" :alias="tTabsBasex0x1ComputedData.alias" :c-style="tTabsBasex0x1ComputedData.cStyle" @tab-click="ontabClick1764666014993"></t-tabs-base></div>
</template>
...
import { TComponent, TTabsBase } from '@ths/design';
...
export default {
  ...
  setup() {
const componentPropBindingMap = {"body":{"attributeName":"tBodyx0x0"},"t-component-18ba.8b4f27f22":{"attributeName":"tComponentx0x0","name":{"filters":[]},"loading":{"filters":[]},"cStyle":{"filters":[]},"src":{"filters":[]},"componentName":{"filters":[]}},"t-tabs-base-69f4.253cca2ad":{"attributeName":"tTabsBasex0x1","data":{"filters":[]},"space":{"filters":[]},"selectedTabVal":{"filters":[]},"innerShadowColor":{"filters":[]},"activeInnerShadowColor":{"filters":[]},"alias":{"filters":[]},"cStyle":{"filters":[]}}};
// 页面内注入全局变量和事件
...
const state = reactive({
   screenSize: "",
   componentName: "relationAnalysisComponent",
   isNewDate: true,
   maxQuarterYear: "",
   maxTimeValue: "",
...
tComponentx0x0: {
defaultStyle: {
            default: {"width":"411px","height":"741px","margin":"0 auto","backgroundColor":"rgba(255, 255, 255, 0)","position":"unset","left":"21px","top":"52px","overflow":"auto","overflow-x":"hidden"},
            
            },
 default: { 
 
name:"relationAnalysisComponent",
loading:true,
cStyle:{"wrapper":{"default":{"width":"411px","height":"741px","margin":"0 auto","backgroundColor":"rgba(255, 255, 255, 0)","position":"unset","left":"21px","top":"52px","overflow":"auto","overflow-x":"hidden"}}},
src:"/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/index.html#/monitoringAnalysis",
componentName:"relationAnalysisComponent", 
 },
},
tTabsBasex0x1: {
defaultStyle: {
            default: {"width":"423px","height":"32px","backgroundImage":"","backgroundRepeat":"","backgroundSize":"","backgroundPosition":"","animationName":"","backgroundColor":"var(--business-show-bg30)","borderTopLeftRadius":"4px","borderTopRightRadius":"4px","borderBottomLeftRadius":"4px","borderBottomRightRadius":"4px","borderLeft":"1px none var(--business--tab-border)","borderTop":"1px none var(--business--tab-border)","borderRight":"1px none var(--business--tab-border)","borderBottom":"1px none var(--business--tab-border)","box-shadow":"var(--business-show-bg50) 0px 0px 0px 1px inset","position":"unset","left":"14px","top":"1px"},
            
            },
 default: { 
 
data:[{"label":"关联要素","value":"relationAnalysisComponent"},{"label":"智慧推荐","value":"waterSourceWisetRecommeComponent"}],
space:5,
selectedTabVal:"relationAnalysisComponent",
innerShadowColor:"rgba(0,0,0,0)",
activeInnerShadowColor:"rgba(0,0,0,0)",
alias:{"label":"label","value":"value","disabled":"disabled"},
cStyle:{"wrapper":{"default":{"width":"423px","height":"32px","backgroundImage":"","backgroundRepeat":"","backgroundSize":"","backgroundPosition":"","animationName":"","backgroundColor":"var(--business-show-bg30)","borderTopLeftRadius":"4px","borderTopRightRadius":"4px","borderBottomLeftRadius":"4px","borderBottomRightRadius":"4px","borderLeft":"1px none var(--business--tab-border)","borderTop":"1px none var(--business--tab-border)","borderRight":"1px none var(--business--tab-border)","borderBottom":"1px none var(--business--tab-border)","box-shadow":"var(--business-show-bg50) 0px 0px 0px 1px inset","position":"unset","left":"14px","top":"1px"}},"itemWrapper":{"default":{"backgroundImage":"","backgroundRepeat":"","backgroundSize":"","backgroundPosition":"","backgroundColor":"rgba(0, 61, 155, 0)","-webkit-background-clip":"border-box","-webkit-text-fill-color":"inherit","borderTopLeftRadius":"0px","borderTopRightRadius":"0px","borderBottomLeftRadius":"0px","borderBottomRightRadius":"0px","width":"120px","height":"32px","fontSize":"14px","lineHeight":"32px","-webkit-mask-image":"","-webkit-mask-repeat":"","-webkit-mask-size":"","-webkit-mask-position":"","borderLeft":"1px solid rgba(0,61,155,0)","borderTop":"1px solid rgba(0,61,155,0)","borderRight":"1px solid rgba(0,61,155,0)","borderBottom":"1px solid rgba(0,61,155,0)","color":"var(--business--tab-default-font)","background":"var(--business-tab-first-bg)","fillType":"color"},"active":{"background":"var(--business-tab-third-active-fill)","backgroundRepeat":"repeat","backgroundSize":"auto","backgroundPosition":"0% 0%","lineHeight":"32px","fontWeight":"400","-webkit-mask-image":"","-webkit-mask-repeat":"","-webkit-mask-size":"","-webkit-mask-position":"","backgroundColor":"rgba(3, 12, 52, 0)","borderLeft":"1px solid var(--business-tab-third-active-border)","borderTop":"1px solid var(--business-tab-third-active-border)","borderRight":"1px solid var(--business-tab-third-active-border)","borderBottom":"1px solid var(--business-tab-third-active-border)","box-shadow":"var(--business-tab-third-active-shadow) 0px 0px 18px 0px inset","color":"var(--business-tab-third-active-border)","borderTopLeftRadius":"4px","borderTopRightRadius":"4px","borderBottomLeftRadius":"4px","borderBottomRightRadius":"4px","height":"32px"},"hover":{"backgroundColor":"rgba(0, 61, 155, 0)","backgroundImage":"","backgroundRepeat":"","backgroundSize":"","backgroundPosition":"","borderLeft":"1px solid rgba(255,255,255,0)","borderTop":"1px solid rgba(255,255,255,0)","borderRight":"1px solid rgba(255,255,255,0)","borderBottom":"1px solid rgba(255,255,255,0)","borderTopLeftRadius":"10px","borderTopRightRadius":"10px","borderBottomLeftRadius":"10px","borderBottomRightRadius":"10px","color":"var(--business-tab-third-active-border)"}},"tabsContainer":{"default":{"background":"rgba(0, 0, 0, 0)","fillType":"color"}},"label":{"active":{"color":"var(--business-tab-third-active-text)","background":"unset","backgroundClip":"unset","fontSize":"var(--business-text-size-14)"},"default":{"fontSize":"var(--business-text-size-14)"}}}, 
 },
},
});
...
// 监测分析
if(value === 'jcfx'){
  state.componentName = 'monitoringAnalysisComponent'
}else if (value === 'wrfx'){
// 污染分析
state.componentName = 'pollutionAnalysisComponent'
}else if (value === 'zhtj'){
// 智慧推荐
}

};
const ontabClick1764666014993 = (data) => {
// 设置变量值
state.componentName = data.value;
/* 发送socket消息 */
rootData.rootSocket.emit('message', {
room: global.socketRoom, // 房间号
type: "clearFilterPanelSelectItems", // 消息名称
data: {}, // 发送的数据
});
};let apiRegistry = {}; 
...
deep: true, // 深度监听
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-waterTraceabilityContentWrap', global.appScaleMode, 'normal');
...
<style scoped>
.t-l-c-waterTraceabilityContentWrap {
position: relative;
overflow: hidden;
...
.t-l-c-waterTraceabilityContentWrap .waterTraceabilityContentWrap-t-component-0-0 {
...
.t-l-c-waterTraceabilityContentWrap .waterTraceabilityContentWrap-t-tabs-base-0-1 {
position: absolute !important;
top: 1px;
left: 14px;
width: 423px;

<template>
  <div id="t-l-c-pollutionAnalysis" class="t-l-c-pollutionAnalysis" ><t-rect v-if="state.cardNoData === true" id="t-rect-a701.ebf144921" class="pollutionAnalysis-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle"></t-rect><t-button v-if="state.activeTab.value !== ''" id="t-button-2397.b3b568691" class="pollutionAnalysis-t-button-0-2"  :label="tButtonx0x2ComputedData.label" :round="tButtonx0x2ComputedData.round" :plain="tButtonx0x2ComputedData.plain" :disabled="tButtonx0x2ComputedData.disabled" :type="tButtonx0x2ComputedData.type" :size="tButtonx0x2ComputedData.size" :native-type="tButtonx0x2ComputedData.native-type" :c-style="tButtonx0x2ComputedData.cStyle" @click="onclick1761120647351"></t-button><t-image-base id="t-image-base-cc01.3413a106e" class="pollutionAnalysis-t-image-base-0-3"  :src="tImageBasex0x3ComputedData.src" :fit="tImageBasex0x3ComputedData.fit" :c-style="tImageBasex0x3ComputedData.cStyle"></t-image-base><t-list-card v-if="state.cardLoading === false" id="t-list-card-2d95.1c787b696" class="pollutionAnalysis-t-list-card-0-4"  :data="replaceCssVariables(filterData(state.sceneList, componentPropBindingMap?.['t-list-card-2d95.1c787b696']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :spacing-x="tListCardx0x4ComputedData.spacingX" :col="tListCardx0x4ComputedData.col" :direction="tListCardx0x4ComputedData.direction" :exchange-order="tListCardx0x4ComputedData.exchangeOrder" :unit-break="tListCardx0x4ComputedData.unitBreak" :key-field="tListCardx0x4ComputedData.keyField" :active-key-field="tListCardx0x4ComputedData.activeKeyField" :active="replaceCssVariables(filterData(state.activeTab.name, componentPropBindingMap?.['t-list-card-2d95.1c787b696']['active'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :c-style="tListCardx0x4ComputedData.cStyle" @card-click="oncardClick1735029005919"></t-list-card><t-rect id="t-rect-364c.0469d38c2" class="pollutionAnalysis-t-rect-0-5"  :tip="tRectx0x5ComputedData.tip" :label="tRectx0x5ComputedData.label" :active="tRectx0x5ComputedData.active" :c-style="tRectx0x5ComputedData.cStyle"></t-rect><t-table v-if="state.listLoading === false" id="t-table-a0d0.258b53cfd" class="pollutionAnalysis-t-table-0-6"  :height="tTablex0x6ComputedData.height" :stripe="tTablex0x6ComputedData.stripe" :border="tTablex0x6ComputedData.border" :auto-scroll="tTablex0x6ComputedData.autoScroll" :speed="tTablex0x6ComputedData.speed" :columns="tTablex0x6ComputedData.columns" :data="replaceCssVariables(filterData(state.enterList, componentPropBindingMap?.['t-table-a0d0.258b53cfd']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x6ComputedData.defaultSort" :c-style="tTablex0x6ComputedData.cStyle" @cell-click="oncellClick1735184769666_0_0"></t-table><t-component id="t-component-3c7c.d9e5b9971" class="pollutionAnalysis-t-component-0-7"  :name="tComponentx0x7ComputedData.name" :c-style="tComponentx0x7ComputedData.cStyle" :src="tComponentx0x7ComputedData.src" :component-name="tComponentx0x7ComputedData.componentName"></t-component><t-text id="t-text-0645.e3c5af32d" class="pollutionAnalysis-t-text-0-8"  :label="tTextx0x8ComputedData.label" :editable="tTextx0x8ComputedData.editable" :c-style="tTextx0x8ComputedData.cStyle"></t-text><t-rect v-if="state.checkedIds !== ''" id="t-rect-f258.31abd13a7" class="pollutionAnalysis-t-rect-0-9"  :tip="tRectx0x9ComputedData.tip" :label="tRectx0x9ComputedData.label" :active="tRectx0x9ComputedData.active" :c-style="tRectx0x9ComputedData.cStyle" @click="onclick1735205190641"></t-rect><t-rect v-if="state.checkedIds === ''" id="t-rect-caab.15629254d" class="pollutionAnalysis-t-rect-0-10"  :tip="tRectx0x10ComputedData.tip" :label="tRectx0x10ComputedData.label" :active="tRectx0x10ComputedData.active" :c-style="tRectx0x10ComputedData.cStyle"></t-rect><t-text id="t-text-5454.74c04491" class="pollutionAnalysis-t-text-0-12"  :label="tTextx0x12ComputedData.label" :editable="tTextx0x12ComputedData.editable" :c-style="tTextx0x12ComputedData.cStyle"></t-text><t-text id="t-text-a89a.7e30697e2" class="pollutionAnalysis-t-text-0-13"  :label="tTextx0x13ComputedData.label" :editable="tTextx0x13ComputedData.editable" :c-style="tTextx0x13ComputedData.cStyle"></t-text><t-text id="t-text-49e3.b2374108a" class="pollutionAnalysis-t-text-0-14"  :label="tTextx0x14ComputedData.label" :editable="tTextx0x14ComputedData.editable" :c-style="tTextx0x14ComputedData.cStyle"></t-text><t-text id="t-text-3797.0a506c66b" class="pollutionAnalysis-t-text-0-15"  :label="tTextx0x15ComputedData.label" :editable="tTextx0x15ComputedData.editable" :c-style="tTextx0x15ComputedData.cStyle"></t-text><t-radio id="t-radio-7049.20f57b6cf" class="pollutionAnalysis-t-radio-0-16"  :options="tRadiox0x16ComputedData.options" :active="replaceCssVariables(filterData(state.selectedParams.direction, componentPropBindingMap?.['t-radio-7049.20f57b6cf']['active'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :alias="tRadiox0x16ComputedData.alias" :disabled="tRadiox0x16ComputedData.disabled" :border="tRadiox0x16ComputedData.border" :size="tRadiox0x16ComputedData.size" :is-use-button="tRadiox0x16ComputedData.isUseButton" :c-style="tRadiox0x16ComputedData.cStyle" @change="onchange1740720896505"></t-radio><t-radio id="t-radio-f568.197f4f8a6" class="pollutionAnalysis-t-radio-0-17"  :options="tRadiox0x17ComputedData.options" :active="replaceCssVariables(filterData(state.selectedParams.buffer, componentPropBindingMap?.['t-radio-f568.197f4f8a6']['active'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :alias="tRadiox0x17ComputedData.alias" :disabled="tRadiox0x17ComputedData.disabled" :border="tRadiox0x17ComputedData.border" :size="tRadiox0x17ComputedData.size" :is-use-button="tRadiox0x17ComputedData.isUseButton" :c-style="tRadiox0x17ComputedData.cStyle" @change="onchange1740720921561"></t-radio><t-checkbox id="t-checkbox-3380.5456a8ecb" class="pollutionAnalysis-t-checkbox-0-18"  :data="tCheckboxx0x18ComputedData.data" :active="replaceCssVariables(filterData(state.selectedParams.altitude, componentPropBindingMap?.['t-checkbox-3380.5456a8ecb']['active'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :data-alias="tCheckboxx0x18ComputedData.dataAlias" :border="tCheckboxx0x18ComputedData.border" :use-button="tCheckboxx0x18ComputedData.useButton" :c-style="tCheckboxx0x18ComputedData.cStyle" @change="onchange1740720873822"></t-checkbox><t-checkbox id="t-checkbox-e6ce.789248433" class="pollutionAnalysis-t-checkbox-0-19"  :data="tCheckboxx0x19ComputedData.data" :active="replaceCssVariables(filterData(state.ymsSelect, componentPropBindingMap?.['t-checkbox-e6ce.789248433']['active'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :data-alias="tCheckboxx0x19ComputedData.dataAlias" :border="tCheckboxx0x19ComputedData.border" :use-button="tCheckboxx0x19ComputedData.useButton" :c-style="tCheckboxx0x19ComputedData.cStyle" @change="onchange1768900934761_0_0"></t-checkbox><t-rect id="t-rect-0b21.228388b5a" class="pollutionAnalysis-t-rect-0-20"  :tip="tRectx0x20ComputedData.tip" :label="tRectx0x20ComputedData.label" :active="tRectx0x20ComputedData.active" :c-style="tRectx0x20ComputedData.cStyle" @click="onclick1740712988309_0_0"></t-rect><t-search id="t-search-fadf.e7800d58b" class="pollutionAnalysis-t-search-0-21"  :type="tSearchx0x21ComputedData.type" :input-value="replaceCssVariables(filterData(state.selectedParams.radius, componentPropBindingMap?.['t-search-fadf.e7800d58b']['inputValue'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :maxlength="tSearchx0x21ComputedData.maxlength" :minlength="tSearchx0x21ComputedData.minlength" :show-word-limit="tSearchx0x21ComputedData.showWordLimit" :placeholder="tSearchx0x21ComputedData.placeholder" :clearable="tSearchx0x21ComputedData.clearable" :show-password="tSearchx0x21ComputedData.showPassword" :disabled="tSearchx0x21ComputedData.disabled" :prefix-icon="tSearchx0x21ComputedData.prefix-icon" :suffix-icon="tSearchx0x21ComputedData.suffix-icon" :rows="tSearchx0x21ComputedData.rows" :autosize="tSearchx0x21ComputedData.autosize" :name="tSearchx0x21ComputedData.name" :readonly="tSearchx0x21ComputedData.readonly" :step="tSearchx0x21ComputedData.step" :autofocus="tSearchx0x21ComputedData.autofocus" :form="tSearchx0x21ComputedData.form" :label="tSearchx0x21ComputedData.label" :tabindex="tSearchx0x21ComputedData.tabindex" :validate-event="tSearchx0x21ComputedData.validateEvent" :c-style="tSearchx0x21ComputedData.cStyle" :has-search-btn="tSearchx0x21ComputedData.hasSearchBtn" @input="oninput1740741929704"></t-search><t-text id="t-text-52c7.b32680ad6" class="pollutionAnalysis-t-text-0-22"  :label="tTextx0x22ComputedData.label" :editable="tTextx0x22ComputedData.editable" :c-style="tTextx0x22ComputedData.cStyle"></t-text><t-rect v-if="state.cardLoading === true" id="t-rect-82e1.1a78bdcce" class="pollutionAnalysis-t-rect-0-23"  :tip="tRectx0x23ComputedData.tip" :label="tRectx0x23ComputedData.label" :active="tRectx0x23ComputedData.active" :c-style="tRectx0x23ComputedData.cStyle"></t-rect><t-rect v-if="state.listLoading === true" id="t-rect-04fa.ba844241f" class="pollutionAnalysis-t-rect-0-24"  :tip="tRectx0x24ComputedData.tip" :label="tRectx0x24ComputedData.label" :active="tRectx0x24ComputedData.active" :c-style="tRectx0x24ComputedData.cStyle"></t-rect></div>
</template>
...
if (column.label === '定位') {
  ...
  let item = state.enterList.find((val) => val.STANDENTERID === row.STANDENTERID);
  if (item) {
    // 复选
    // dispatchTask(row.STANDENTERID);
    if (item.isCheck === '0') {
...
.t-l-c-pollutionAnalysis .pollutionAnalysis-t-rect-0-0 {
...
.t-l-c-pollutionAnalysis .pollutionAnalysis-t-button-0-2 {
position: absolute !important;
top: 411px;
left: 250px;
width: 70px;
...
.t-l-c-pollutionAnalysis .pollutionAnalysis-t-image-base-0-3 {
position: absolute !important;
top: 55px;
left: 1px;
width: 410px;
...
.t-l-c-pollutionAnalysis .pollutionAnalysis-t-list-card-0-4 {
position: absolute !important;
top: 253px;
left: 0px;
width: 410px;
...
.t-l-c-pollutionAnalysis .pollutionAnalysis-t-rect-0-5 {
position: absolute !important;
top: 243px;
left: 1px;
width: 410px;
...
.t-l-c-pollutionAnalysis .pollutionAnalysis-t-table-0-6 {
position: absolute !important;
top: 452px;
left: 0px;
width: 410px;
...
.t-l-c-pollutionAnalysis .pollutionAnalysis-t-component-0-7 {
position: absolute !important;
top: 0px;
left: 0px;
width: 410px;
...
.t-l-c-pollutionAnalysis .pollutionAnalysis-t-text-0-8 {
position: absolute !important;
top: 5px;
left: 33px;
width: 234px;
...
.t-l-c-pollutionAnalysis .pollutionAnalysis-t-rect-0-9 {
position: absolute !important;
top: 411px;
left: 330px;
width: 72px;
...
.t-l-c-pollutionAnalysis .pollutionAnalysis-t-rect-0-10 {
position: absolute !important;
top: 410px;
left: 330px;
width: 72px;
...
.t-l-c-pollutionAnalysis .pollutionAnalysis-t-text-0-12 {
position: absolute !important;
top: 118px;
left: 17px;
width: 70px;
...
.t-l-c-pollutionAnalysis .pollutionAnalysis-t-text-0-13 {
position: absolute !important;
top: 172px;
left: 17px;
width: 70px;
...
.t-l-c-pollutionAnalysis .pollutionAnalysis-t-text-0-14 {
position: absolute !important;
top: 145px;
left: 17px;
width: 70px;
...
.t-l-c-pollutionAnalysis .pollutionAnalysis-t-text-0-15 {
position: absolute !important;
top: 80px;
left: 17px;
width: 70px;
...
.t-l-c-pollutionAnalysis .pollutionAnalysis-t-radio-0-16 {
position: absolute !important;
top: 115px;
left: 90px;
width: 256px;
...
.t-l-c-pollutionAnalysis .pollutionAnalysis-t-radio-0-17 {
position: absolute !important;
top: 169px;
left: 90px;
width: 256px;
...
.t-l-c-pollutionAnalysis .pollutionAnalysis-t-checkbox-0-18 {
position: absolute !important;
top: 142px;
left: 88px;
width: 232px;
...
.t-l-c-pollutionAnalysis .pollutionAnalysis-t-checkbox-0-19 {
position: absolute !important;
top: 204px;
left: 31px;
width: 89px;
...
.t-l-c-pollutionAnalysis .pollutionAnalysis-t-rect-0-20 {
position: absolute !important;
top: 199px;
left: 310px;
width: 85px;
...
.t-l-c-pollutionAnalysis .pollutionAnalysis-t-search-0-21 {
position: absolute !important;
top: 72px;
left: 89px;
width: 260px;
...
.t-l-c-pollutionAnalysis .pollutionAnalysis-t-text-0-22 {
position: absolute !important;
top: 82px;
left: 362px;
width: 28px;
...
.t-l-c-pollutionAnalysis .pollutionAnalysis-t-rect-0-23 {
position: absolute !important;
top: 254px;
left: 0px;
width: 410px;
...
.t-l-c-pollutionAnalysis .pollutionAnalysis-t-rect-0-24 {
position: absolute !important;
top: 449px;
left: 0px;
width: 410px;

<template>
  <div id="t-l-c-airPollutionPointWarningTitle" class="t-l-c-airPollutionPointWarningTitle" ><t-component id="t-component-6f3b.f3ecc4cb7" class="airPollutionPointWarningTitle-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName"></t-component><t-text-unit id="t-text-unit-d9ea.c81589479" class="airPollutionPointWarningTitle-t-text-unit-0-1"  :c-style="tTextUnitx0x1ComputedData.cStyle" :justify="tTextUnitx0x1ComputedData.justify" :align="tTextUnitx0x1ComputedData.align" :content="replaceCssVariables(global.regionaQuery.businessRegionName, global?.theme || global?.activeTheme || '默认主题')" :unit="tTextUnitx0x1ComputedData.unit" :show-overflow-tooltip="tTextUnitx0x1ComputedData.showOverflowTooltip"></t-text-unit></div>
</template>
...
tTextUnitx0x1: {
defaultStyle: {
            default: {"width":"261px","height":"20px","fontSize":"17px","fontFamily":"方正综艺","color":"var(--t-white)","lineHeight":"20px","left":"34px","top":"6px"},
            
            },
 default: { 
 
cStyle:{"wrapper":{"default":{"width":"261px","height":"20px","fontSize":"17px","fontFamily":"方正综艺","color":"var(--t-white)","lineHeight":"20px","left":"34px","top":"6px"}},"unit":{"default":{"fontSize":"17px","fontFamily":"方正综艺","lineHeight":"20px"}},"text":{"default":{"lineHeight":"20px","fontSize":"17px"}}},
justify:"flex-start",
align:"flex-end",
content:"佛山市",
unit:"站点报警",
showOverflowTooltip:true, 
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-airPollutionPointWarningTitle', global.appScaleMode, 'normal');
...
<style scoped>
.t-l-c-airPollutionPointWarningTitle {
position: relative;
overflow: hidden;
...
.t-l-c-airPollutionPointWarningTitle .airPollutionPointWarningTitle-t-component-0-0 {
...
.t-l-c-airPollutionPointWarningTitle .airPollutionPointWarningTitle-t-text-unit-0-1 {
position: absolute !important;
top: 6px;
left: 34px;
width: 261px;

<template>
  <div id="t-l-c-airOverviewPressureForecastAna" class="t-l-c-airOverviewPressureForecastAna" ><t-text v-if="state.hasChartData === false" id="t-text-10ae.895f3ed0c" class="airOverviewPressureForecastAna-t-text-0-0"  :label="state.noDataText" :editable="tTextx0x0ComputedData.editable" :c-style="tTextx0x0ComputedData.cStyle"></t-text><t-table id="t-table-b7b7.800201ecf" class="airOverviewPressureForecastAna-t-table-0-1"  :height="tTablex0x1ComputedData.height" :stripe="tTablex0x1ComputedData.stripe" :border="tTablex0x1ComputedData.border" :auto-scroll="tTablex0x1ComputedData.autoScroll" :speed="tTablex0x1ComputedData.speed" :show-animation="tTablex0x1ComputedData.showAnimation" :animation-delay="tTablex0x1ComputedData.animationDelay" :animation-type="tTablex0x1ComputedData.animationType" :columns="state.tableColumns" :data="state.tableData" :default-sort="tTablex0x1ComputedData.defaultSort" :c-style="tTablex0x1ComputedData.cStyle"></t-table><t-radio id="t-radio-dcf3.4362336b1" class="airOverviewPressureForecastAna-t-radio-0-2"  :options="tRadiox0x2ComputedData.options" :active="state.radioSelect" :alias="tRadiox0x2ComputedData.alias" :disabled="tRadiox0x2ComputedData.disabled" :border="tRadiox0x2ComputedData.border" :size="tRadiox0x2ComputedData.size" :is-use-button="tRadiox0x2ComputedData.isUseButton" :c-style="tRadiox0x2ComputedData.cStyle" :options-raw="tRadiox0x2ComputedData.optionsRaw" @change="onchange1733920748958"></t-radio><t-chart-design v-if="state.hasChartData === true" id="t-chart-design-3ef9.d3eb8a719" class="airOverviewPressureForecastAna-t-chart-design-0-3"  :empty-img="tChartDesignx0x3ComputedData.emptyImg" :c-style="tChartDesignx0x3ComputedData.cStyle" :options="state.chartOption"></t-chart-design><t-component id="t-component-10c2.7cdde9e89" class="airOverviewPressureForecastAna-t-component-0-4"  :name="tComponentx0x4ComputedData.name" :c-style="tComponentx0x4ComputedData.cStyle" :src="tComponentx0x4ComputedData.src" :component-name="tComponentx0x4ComputedData.componentName"></t-component><t-text id="t-text-63f5.24c77f15b" class="airOverviewPressureForecastAna-t-text-0-5"  :label="state.titleText" :editable="tTextx0x5ComputedData.editable" :c-style="tTextx0x5ComputedData.cStyle"></t-text><t-text id="t-text-e36e.d8067ffa8" class="airOverviewPressureForecastAna-t-text-0-6"  :label="state.timeValue" :editable="tTextx0x6ComputedData.editable" :c-style="tTextx0x6ComputedData.cStyle"></t-text></div>
</template>
...
import { TChartDesign, TComponent, TRadio, TTable, TText } from '@ths/design';
...
state.chartOption = {
  "tooltip": {
    ...
    formatter: (formatterParams) => {
       ...
       */
      let str = '';
      let name = formatterParams[0].axisValue;
...
<style scoped>
.t-l-c-airOverviewPressureForecastAna {
position: relative;
overflow: hidden;
...
.t-l-c-airOverviewPressureForecastAna .airOverviewPressureForecastAna-t-text-0-0 {
...
.t-l-c-airOverviewPressureForecastAna .airOverviewPressureForecastAna-t-table-0-1 {
position: absolute !important;
top: 44px;
left: 0px;
width: 960px;
...
.t-l-c-airOverviewPressureForecastAna .airOverviewPressureForecastAna-t-radio-0-2 {
position: absolute !important;
top: 334px;
left: 0px;
width: 454px;
...
.t-l-c-airOverviewPressureForecastAna .airOverviewPressureForecastAna-t-chart-design-0-3 {
position: absolute !important;
top: 370px;
left: 0px;
width: 960px;
...
.t-l-c-airOverviewPressureForecastAna .airOverviewPressureForecastAna-t-component-0-4 {
position: absolute !important;
top: 0px;
left: 0px;
width: 910px;
...
.t-l-c-airOverviewPressureForecastAna .airOverviewPressureForecastAna-t-text-0-5 {
position: absolute !important;
top: 5px;
left: 34px;
width: 130px;
...
.t-l-c-airOverviewPressureForecastAna .airOverviewPressureForecastAna-t-text-0-6 {
position: absolute !important;
top: 7px;
left: 775px;
width: 175px;

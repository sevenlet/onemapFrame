<template>
  <div id="t-l-c-airCenterOtherIndex" class="t-l-c-airCenterOtherIndex" ><t-rect id="t-rect-98e7.8b1a86cd" class="airCenterOtherIndex-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle"></t-rect><t-tabs id="t-tabs-5c63.3caa932c2" class="airCenterOtherIndex-t-tabs-0-2"  :alias="tTabsx0x2ComputedData.alias" :data="replaceCssVariables(filterData(state.listData, componentPropBindingMap?.['t-tabs-5c63.3caa932c2']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :model-value="tTabsx0x2ComputedData.model-value" :tab-position-extend="tTabsx0x2ComputedData.tabPositionExtend" :stretch="tTabsx0x2ComputedData.stretch" :c-style="tTabsx0x2ComputedData.cStyle" :active-tab="replaceCssVariables(filterData(state.activeIndex, componentPropBindingMap?.['t-tabs-5c63.3caa932c2']['activeTab'].filters || []), global?.theme || global?.activeTheme || '默认主题')" @tab-click="ontabClick1766808256575"></t-tabs><t-rect v-if="state.showContent === true" id="t-rect-a122.67a8288a4" class="airCenterOtherIndex-t-rect-0-3"  :tip="tRectx0x3ComputedData.tip" :label="tRectx0x3ComputedData.label" :active="tRectx0x3ComputedData.active" :c-style="tRectx0x3ComputedData.cStyle" @click="onclick1734686591589"></t-rect><t-text v-if="state.showContent === false" id="t-text-50f5.0d6af7e03" class="airCenterOtherIndex-t-text-0-4"  :label="tTextx0x4ComputedData.label" :editable="tTextx0x4ComputedData.editable" :c-style="tTextx0x4ComputedData.cStyle" :show-title="tTextx0x4ComputedData.showTitle" @click="onclick1734686575114"></t-text><t-switch v-if="state.showContent === true" id="t-switch-dbeb.4fadfc867" class="airCenterOtherIndex-t-switch-0-5"  :value="replaceCssVariables(filterData(state.switch, componentPropBindingMap?.['t-switch-dbeb.4fadfc867']['value'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :c-style="tSwitchx0x5ComputedData.cStyle" @change="onchange1766824134346"></t-switch><t-text v-if="state.showContent === true" id="t-text-f59e.6d76d06e9" class="airCenterOtherIndex-t-text-0-6"  :label="tTextx0x6ComputedData.label" :editable="tTextx0x6ComputedData.editable" :c-style="tTextx0x6ComputedData.cStyle"></t-text></div>
</template>
...
import { TRect, TSwitch, TTabs, TText } from '@ths/design';
...
.t-l-c-airCenterOtherIndex .airCenterOtherIndex-t-rect-0-0 {
...
.t-l-c-airCenterOtherIndex .airCenterOtherIndex-t-tabs-0-2 {
position: absolute !important;
top: 10px;
left: 3px;
width: 357px;
...
.t-l-c-airCenterOtherIndex .airCenterOtherIndex-t-rect-0-3 {
position: absolute !important;
top: 10px;
left: 477px;
width: 39px;
...
.t-l-c-airCenterOtherIndex .airCenterOtherIndex-t-text-0-4 {
position: absolute !important;
top: 10px;
left: 477px;
width: 39px;
...
.t-l-c-airCenterOtherIndex .airCenterOtherIndex-t-switch-0-5 {
position: absolute !important;
top: 17px;
left: 440px;
width: 28px;
...
.t-l-c-airCenterOtherIndex .airCenterOtherIndex-t-text-0-6 {
position: absolute !important;
top: 18px;
left: 372px;
width: 58px;

<template>
  <div id="t-l-c-xhjsBaseInfo" class="t-l-c-xhjsBaseInfo" ><t-circle id="t-circle-7dbd.196078e2c" class="xhjsBaseInfo-t-circle-0-0"  :tip="tCirclex0x0ComputedData.tip" :label="tCirclex0x0ComputedData.label" :active="tCirclex0x0ComputedData.active" :c-style="tCirclex0x0ComputedData.cStyle"></t-circle><t-text id="t-text-e92f.6243867ce" class="xhjsBaseInfo-t-text-0-1"  :label="tTextx0x1ComputedData.label" :editable="tTextx0x1ComputedData.editable" :c-style="tTextx0x1ComputedData.cStyle"></t-text><t-chart-design v-if="state.isBz === true" id="t-chart-design-b252.5effe541d" class="xhjsBaseInfo-t-chart-design-0-3"  :empty-img="replaceCssVariables(filterData(state.noDataImg, componentPropBindingMap?.['t-chart-design-b252.5effe541d']['emptyImg'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :c-style="tChartDesignx0x3ComputedData.cStyle" :options="replaceCssVariables(filterData(state.options, componentPropBindingMap?.['t-chart-design-b252.5effe541d']['options'].filters || []), global?.theme || global?.activeTheme || '默认主题')" @get-chart-instance="ongetChartInstance1764308327093_0_0"></t-chart-design><t-chart-design v-if="state.isBz === false" id="t-chart-design-3774.63e82ca0e" class="xhjsBaseInfo-t-chart-design-0-4"  :empty-img="replaceCssVariables(filterData(state.noDataImg, componentPropBindingMap?.['t-chart-design-3774.63e82ca0e']['emptyImg'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :c-style="tChartDesignx0x4ComputedData.cStyle" :options="replaceCssVariables(filterData(state.variationTrendData.chartOptions, componentPropBindingMap?.['t-chart-design-3774.63e82ca0e']['options'].filters || []), global?.theme || global?.activeTheme || '默认主题')" @get-chart-instance="ongetChartInstance1764135516141"></t-chart-design><t-list-card id="t-list-card-d9ab.2e21fb3b5" class="xhjsBaseInfo-t-list-card-0-6"  :data="replaceCssVariables(filterData(state.baseInfoData, componentPropBindingMap?.['t-list-card-d9ab.2e21fb3b5']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :spacing-x="tListCardx0x6ComputedData.spacingX" :col="tListCardx0x6ComputedData.col" :direction="tListCardx0x6ComputedData.direction" :exchange-order="tListCardx0x6ComputedData.exchangeOrder" :unit-break="tListCardx0x6ComputedData.unitBreak" :key-field="tListCardx0x6ComputedData.keyField" :active-key-field="tListCardx0x6ComputedData.activeKeyField" :active="tListCardx0x6ComputedData.active" :c-style="tListCardx0x6ComputedData.cStyle"></t-list-card><t-component id="t-component-c019.99b6d840a" class="xhjsBaseInfo-t-component-0-7"  :name="tComponentx0x7ComputedData.name" :c-style="tComponentx0x7ComputedData.cStyle" :src="tComponentx0x7ComputedData.src" :component-name="tComponentx0x7ComputedData.componentName" :page-id="tComponentx0x7ComputedData.pageId" :page-code="tComponentx0x7ComputedData.pageCode"></t-component><t-text id="t-text-62b3.48b14905c" class="xhjsBaseInfo-t-text-0-8"  :label="tTextx0x8ComputedData.label" :editable="tTextx0x8ComputedData.editable" :c-style="tTextx0x8ComputedData.cStyle"></t-text><t-scrollable-cards id="t-scrollable-cards-455f.ff3a2c962" class="xhjsBaseInfo-t-scrollable-cards-0-9"  :c-style="tScrollableCardsx0x9ComputedData.cStyle" :show-icon="tScrollableCardsx0x9ComputedData.showIcon" :auto-scroll="tScrollableCardsx0x9ComputedData.autoScroll" :tab="tScrollableCardsx0x9ComputedData.tab" :key-word="tScrollableCardsx0x9ComputedData.keyWord" :default-checked="tScrollableCardsx0x9ComputedData.defaultChecked" :speed="tScrollableCardsx0x9ComputedData.speed" :interval="tScrollableCardsx0x9ComputedData.interval" :card-space="tScrollableCardsx0x9ComputedData.cardSpace" :direction="tScrollableCardsx0x9ComputedData.direction" :data-alias="tScrollableCardsx0x9ComputedData.dataAlias" :data="replaceCssVariables(filterData(state.monitorData, componentPropBindingMap?.['t-scrollable-cards-455f.ff3a2c962']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" @card-click="oncardClick1770123179284"></t-scrollable-cards><t-row id="t-row-3ae9.949fc1c3b" class="xhjsBaseInfo-t-row-0-11"  :c-style="tRowx0x11ComputedData.cStyle" :gutter="tRowx0x11ComputedData.gutter" :justify="tRowx0x11ComputedData.justify" :align="tRowx0x11ComputedData.align"><t-col id="t-col-5c12.21387b6cc" class="xhjsBaseInfo-t-col-0-11-0"  :span="tColx0x11x0ComputedData.span" :offset="tColx0x11x0ComputedData.offset" :push="tColx0x11x0ComputedData.push" :pull="tColx0x11x0ComputedData.pull" :c-style="tColx0x11x0ComputedData.cStyle"><t-text id="t-text-6063.4db73323" class="xhjsBaseInfo-t-text-0-11-0-0"  :label="replaceCssVariables(filterData(state.variationTrendData.title, componentPropBindingMap?.['t-text-6063.4db73323']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x11x0x0ComputedData.editable" :c-style="tTextx0x11x0x0ComputedData.cStyle"></t-text></t-col><t-col id="t-col-facf.ef4316657" class="xhjsBaseInfo-t-col-0-11-1"  :span="tColx0x11x1ComputedData.span" :offset="tColx0x11x1ComputedData.offset" :push="tColx0x11x1ComputedData.push" :pull="tColx0x11x1ComputedData.pull" :c-style="tColx0x11x1ComputedData.cStyle"><t-date-picker id="t-date-picker-b356.86cbc2728" class="xhjsBaseInfo-t-date-picker-0-11-1-0"  :placeholder="tDatePickerx0x11x1x0ComputedData.placeholder" :start-placeholder="tDatePickerx0x11x1x0ComputedData.startPlaceholder" :end-placeholder="tDatePickerx0x11x1x0ComputedData.endPlaceholder" :type="tDatePickerx0x11x1x0ComputedData.type" :clearable="tDatePickerx0x11x1x0ComputedData.clearable" :range-separator="tDatePickerx0x11x1x0ComputedData.rangeSeparator" :default-date="replaceCssVariables(filterData(state.timeRange, componentPropBindingMap?.['t-date-picker-b356.86cbc2728']['default-date'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :separator="tDatePickerx0x11x1x0ComputedData.separator" :readonly="tDatePickerx0x11x1x0ComputedData.readonly" :editable="tDatePickerx0x11x1x0ComputedData.editable" :c-style="tDatePickerx0x11x1x0ComputedData.cStyle" @date-change="ondateChange1735549171926"></t-date-picker><t-select id="t-select-3fcb.c00f74209" class="xhjsBaseInfo-t-select-0-11-1-1"  :active-value="replaceCssVariables(filterData(state.variationTrendData.activeTarget, componentPropBindingMap?.['t-select-3fcb.c00f74209']['activeValue'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :options="replaceCssVariables(filterData(state.categoryList, componentPropBindingMap?.['t-select-3fcb.c00f74209']['options'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :alias="tSelectx0x11x1x1ComputedData.alias" :multiple="tSelectx0x11x1x1ComputedData.multiple" :placeholder="tSelectx0x11x1x1ComputedData.placeholder" :clearable="tSelectx0x11x1x1ComputedData.clearable" :disabled="tSelectx0x11x1x1ComputedData.disabled" :name="tSelectx0x11x1x1ComputedData.name" :autocomplete="tSelectx0x11x1x1ComputedData.autocomplete" :filterable="tSelectx0x11x1x1ComputedData.filterable" :no-match-text="tSelectx0x11x1x1ComputedData.no-match-text" :no-data-text="tSelectx0x11x1x1ComputedData.no-data-text" :c-style="tSelectx0x11x1x1ComputedData.cStyle" @change="onchange1733973555614"></t-select></t-col></t-row><t-row id="t-row-9111.1b5dc7cd5" class="xhjsBaseInfo-t-row-0-12"  :c-style="tRowx0x12ComputedData.cStyle" :gutter="tRowx0x12ComputedData.gutter" :justify="tRowx0x12ComputedData.justify" :align="tRowx0x12ComputedData.align"><t-col id="t-col-e76b.cb7d21096" class="xhjsBaseInfo-t-col-0-12-0"  :span="tColx0x12x0ComputedData.span" :offset="tColx0x12x0ComputedData.offset" :push="tColx0x12x0ComputedData.push" :pull="tColx0x12x0ComputedData.pull" :c-style="tColx0x12x0ComputedData.cStyle"><t-text id="t-text-c954.b258bcb6b" class="xhjsBaseInfo-t-text-0-12-0-0"  :label="tTextx0x12x0x0ComputedData.label" :editable="tTextx0x12x0x0ComputedData.editable" :c-style="tTextx0x12x0x0ComputedData.cStyle"></t-text><t-switch id="t-switch-fdd4.057ab13d6" class="xhjsBaseInfo-t-switch-0-12-0-1"  :value="tSwitchx0x12x0x1ComputedData.value" :c-style="tSwitchx0x12x0x1ComputedData.cStyle" @change="onchange1735789295216"></t-switch></t-col></t-row><t-row id="t-row-bed0.5ca83a488" class="xhjsBaseInfo-t-row-0-13"  :c-style="tRowx0x13ComputedData.cStyle" :gutter="tRowx0x13ComputedData.gutter" :justify="tRowx0x13ComputedData.justify" :align="tRowx0x13ComputedData.align"><t-text v-if="state.monitorTime !== ''" id="t-text-b39c.b6c03321c" class="xhjsBaseInfo-t-text-0-13-0"  :label="replaceCssVariables(filterData(state.monitorTime, componentPropBindingMap?.['t-text-b39c.b6c03321c']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x13x0ComputedData.editable" :c-style="tTextx0x13x0ComputedData.cStyle"></t-text></t-row></div>
</template>
...
import { TChartDesign, TCircle, TCol, TComponent, TDatePicker, TListCard, TRow, TScrollableCards, TSelect, TSwitch, TText } from '@ths/design';
...
const state = reactive({
   ...
   baseInfoData: [{"title":"站点名称","num":"-"},{"title":"所属行政区","num":"-"},{"title":"所属镇街","num":"-"},{"title":"所属水体","num":"-"}],
   assessType: "",
   pointCode: "",
   monitorTime: "",
   timeRange: [],
...
tCirclex0x0: {
defaultStyle: {
            default: {"width":"9px","height":"9px","position":"unset","left":"-1px","top":"133px","backgroundColor":"#FF2B2B","borderLeft":"1px none rgb(23,62,228)","borderTop":"1px none rgb(23,62,228)","borderRight":"1px none rgb(23,62,228)","borderBottom":"1px none rgb(23,62,228)"},
...
label:"",
active:false,
cStyle:{"wrapper":{"default":{"width":"9px","height":"9px","position":"unset","left":"-1px","top":"133px","backgroundColor":"#FF2B2B","borderLeft":"1px none rgb(23,62,228)","borderTop":"1px none rgb(23,62,228)","borderRight":"1px none rgb(23,62,228)","borderBottom":"1px none rgb(23,62,228)"}}}, 
 },
},
tTextx0x1: {
defaultStyle: {
            default: {"width":"334px","height":"24px","color":"var(--business-text-avianize)","fontSize":"var(--text-size-14)","top":"125px","left":"12px","position":"unset","lineHeight":"24px"},
...
editable:false,
cStyle:{"wrapper":{"default":{"width":"334px","height":"24px","color":"var(--business-text-avianize)","fontSize":"var(--text-size-14)","top":"125px","left":"12px","position":"unset","lineHeight":"24px"}}}, 
 },
},
tChartDesignx0x3: {
defaultStyle: {
            default: {"height":"calc(100% - 296px)","width":"100%","position":"unset","left":"-1px","top":"291px","animationName":""},
            
            },
 default: { 
 
emptyImg:"assets/images/2024-12-26/f1200f84c82a4a1698a450dfa89ceedb.svg",
cStyle:{"wrapper":{"default":{"height":"calc(100% - 296px)","width":"100%","position":"unset","left":"-1px","top":"291px","animationName":""}},"emptyText":{"default":{"fontSize":"14px","color":"var(--business-show-bg60)"}}},
options:"", 
 },
},
tChartDesignx0x4: {
defaultStyle: {
            default: {"height":"calc(100% - 296px)","width":"100%","position":"unset","left":"-1px","top":"291px"},
            
            },
 default: { 
 
emptyImg:"assets/images/2024-12-26/f1200f84c82a4a1698a450dfa89ceedb.svg",
cStyle:{"wrapper":{"default":{"height":"calc(100% - 296px)","width":"100%","position":"unset","left":"-1px","top":"291px"}},"emptyText":{"default":{"fontSize":"14px","color":"var(--business-show-bg60)"}}},
options: computed(() => _.merge({}, activeChartThemeOptions.value, {"series":[]})), 
 },
},
tListCardx0x6: {
defaultStyle: {
            default: {"width":"100%","height":"69px","position":"unset","left":"0px","top":"0px","overflow":"visible","animationName":""},
            
            },
 default: { 
 
data:[{"title":"站点名称","num":"-"},{"title":"所属行政区","num":"-"},{"title":"所属镇街","num":"-"},{"title":"所属水体","num":"-"}],
spacingX:2,
col:2,
direction:"vertical",
exchangeOrder:false,
...
tTextx0x8: {
defaultStyle: {
            default: {"width":"130px","height":"20px","color":"rgba(255, 255, 255, 0.9)","position":"unset","left":"39px","top":"89px","fontFamily":"方正综艺","fontSize":"var(--text-size-14)","animationName":"","lineHeight":"20px"},
...
tRowx0x11: {
defaultStyle: {
            default: {"width":"100%","height":"32px","display":"flex","justifyContent":"center","alignItems":"center","position":"unset","left":"-1px","top":"240px"},
            
            },
 default: { 
 
cStyle:{"wrapper":{"default":{"width":"100%","height":"32px","display":"flex","justifyContent":"center","alignItems":"center","position":"unset","left":"-1px","top":"240px"}}},
gutter:0,
...
tTextx0x11x0x0: {
defaultStyle: {
            default: {"width":"240px","height":"32px","color":"rgba(255, 255, 255, 1)","lineHeight":"32px","fontSize":"var(--text-size-14)","fontFamily":"方正综艺","top":"289px","left":"0px","position":"unset"},
...
label:"近12个月水质变化趋势",
editable:false,
cStyle:{"wrapper":{"default":{"width":"240px","height":"32px","color":"rgba(255, 255, 255, 1)","lineHeight":"32px","fontSize":"var(--text-size-14)","fontFamily":"方正综艺","top":"289px","left":"0px","position":"unset"}},"cardValue":{"default":{"fontSize":"var(--text-size-14)"}}}, 
 },
},
tColx0x11x1: {
defaultStyle: {
...
defaultStyle: {
            default: {"width":"330px","height":"32px","position":"unset","left":"394px","top":"284px","--t-date-picker-input-placeholder-color":"var(--business-text-avianize) !important","--t-date-picker-splitline-color":"var(--business-show-bg50) !important","borderLeft":"1px solid var(--business-show-bg50)","borderTop":"1px solid var(--business-show-bg50)","borderRight":"1px solid var(--business-show-bg50)","borderBottom":"1px solid var(--business-show-bg50)","borderTopLeftRadius":"4px","borderTopRightRadius":"4px","borderBottomLeftRadius":"4px","borderBottomRightRadius":"4px","overflow":"hidden","animationName":"","marginRight":"15px"},
...
'no-match-text':"无匹配数据",
'no-data-text':"无数据",
cStyle:{"wrapper":{"default":{"width":"190px","height":"32px","position":"unset","left":"704px","top":"284px","animationName":"","paddingLeft":"12px","paddingRight":"12px","fontSize":"var(--text-size-14)","backgroundColor":"var(--business-show-bg30)","borderLeft":"1px solid var(--business-show-bg50)","borderTop":"1px solid var(--business-show-bg50)","borderRight":"1px solid var(--business-show-bg50)","borderBottom":"1px solid var(--business-show-bg50)","color":"rgba(255, 255, 255, 1)","--el-select-border-color-hover":"var(--business-theme)"},"focus":{"borderLeft":"1px solid var(--business-theme)","borderTop":"1px solid var(--business-theme)","borderRight":"1px solid var(--business-theme)","borderBottom":"1px solid var(--business-theme)","fontSize":"var(--text-size-14)"},"hover":{"borderLeft":"1px solid var(--business-theme)","borderTop":"1px solid var(--business-theme)","borderRight":"1px solid var(--business-theme)","borderBottom":"1px solid var(--business-theme)"}},"dropdownArrow":{"default":{"display":"none"}},"arrow":{"default":{"color":"var(--business-unit-icon)"}},"placeholder":{"default":{"color":"var(--business-text-avianize)"}},"dropdownWrapper":{"default":{"backgroundColor":"var(--business-dialog-bg)","borderLeft":"1px solid var(--business-show-bg50)","borderTop":"1px solid var(--business-show-bg50)","borderRight":"1px solid var(--business-show-bg50)","borderBottom":"1px solid var(--business-show-bg50)"}},"dropdownItem":{"active":{"backgroundColor":"var(--business-show-bg15)","color":"var(--business-theme)"},"hover":{"color":"var(--business-theme)","backgroundColor":"var(--business-show-bg15)"}},"dropdownItemText":{"default":{"fontSize":"var(--text-size-14)"},"active":{"fontSize":"var(--text-size-14)"}}}, 
 },
},
tRowx0x12: {
defaultStyle: {
            default: {"width":"100%","height":"30px","display":"flex","justifyContent":"right","alignItems":"center","position":"unset","left":"-1px","top":"293px","pointerEvents":"none"},
            
            },
 default: { 
 
cStyle:{"wrapper":{"default":{"width":"100%","height":"30px","display":"flex","justifyContent":"right","alignItems":"center","position":"unset","left":"-1px","top":"293px","pointerEvents":"none"}}},
gutter:0,
justify:"space-between",
align:"middle", 
 },
...
tColx0x12x0: {
defaultStyle: {
            default: {"width":"100%","height":"30px","display":"flex","justifyContent":"right","alignItems":"center","pointerEvents":"none"},
...
push:0,
pull:0,
cStyle:{"wrapper":{"default":{"width":"100%","height":"30px","display":"flex","justifyContent":"right","alignItems":"center","pointerEvents":"none"}}}, 
 },
},
tTextx0x12x0x0: {
defaultStyle: {
            default: {"width":"65px","height":"22px","color":"var(--business-text-avianize)","position":"unset","left":"726px","top":"327px","fontSize":"var(--text-size-14)","lineHeight":"22px","animationName":"","textAlign":"right","marginRight":"15px"},
...
label:"标准值",
editable:false,
cStyle:{"wrapper":{"default":{"width":"65px","height":"22px","color":"var(--business-text-avianize)","position":"unset","left":"726px","top":"327px","fontSize":"var(--text-size-14)","lineHeight":"22px","animationName":"","textAlign":"right","marginRight":"15px"}},"cardValue":{"default":{"fontSize":"var(--text-size-14)"}}}, 
 },
},
tSwitchx0x12x0x1: {
defaultStyle: {
...
tRowx0x13: {
defaultStyle: {
            default: {"width":"100%","height":"28px","display":"flex","justifyContent":"right","alignItems":"center","left":"-1px","top":"85px","position":"unset"},
            
            },
 default: { 
 
cStyle:{"wrapper":{"default":{"width":"100%","height":"28px","display":"flex","justifyContent":"right","alignItems":"center","left":"-1px","top":"85px","position":"unset"}}},
gutter:0,
justify:"space-between",
align:"middle", 
 },
...
// 结束时间
let endTime = dateFormat(new Date(state.monitorTime), 'yyyy-MM');
// 开始时间
let startTime = dateFormat(getPrevTime(new Date(state.monitorTime), 'month'), 'yyyy-MM');
...
// 接口函数
 getMonitorData: {
              ...
              autoLoad: false, // 自动请求
              bindComponents: [], // 依赖的组件ID列表，可能多个组件绑定一个接口的数据
              config: {"url":"global.serviceBasePath","method":"get","baseURL":"global.foshanServiceBaseUrl","params":{"POINT_CODE":"state.pointCode","MONITORTIME":"state.monitorTime","interfaceId":"ed2f93137c4a03786949ae1c766e5c13"}},
              request: function ( componentId) {
return new Promise((resolve, reject) => {
  
                http({"url":global.serviceBasePath,"method":"get","baseURL":global.foshanServiceBaseUrl,"params":{"POINT_CODE":state.pointCode,"MONITORTIME":state.monitorTime,"interfaceId":"ed2f93137c4a03786949ae1c766e5c13"},}).then((res) => {
 
                   // 成功的操作
                   const cacheKey = generateCacheKey('global.foshanServiceBaseUrl-global.serviceBasePath',  {"POINT_CODE":state.pointCode,"MONITORTIME":state.monitorTime,"interfaceId":"ed2f93137c4a03786949ae1c766e5c13"});
...
if (data?.head?.statusCode === '200') {
  ...
  const typeData = [
    { label: 'pH值', value: 'W01001', EXT1: '' },
    { label: '溶解氧', value: 'W01009', EXT1: 'mg/L' },
    { label: '高锰酸盐指数', value: 'W01019', EXT1: 'mg/L' },
    { label: '氨氮', value: 'W21003', EXT1: 'mg/L' },
    { label: '总磷', value: 'W21011', EXT1: 'mg/L' },
    { label: '水质', value: 'W99999', EXT1: '' } // 用于测试过滤逻辑
  ];
  
  console.log(state.categoryList,'state.categoryList');

  // 将返回的数组数据转换为对象映射（方便快速查找）
  const dataMap = {};
  data.data.forEach(item => {
    dataMap[item.POLLUTE_CODE] = {
      value: item.POLLUTEVALUE,
      waterLevelCode: item.CODE_WATERLEVEL,
      isStandards: item.ISSTANDARDS,
      unit: item.EN_CUNIT
    };
  });

  // 遍历配置，批量更新 state.monitorData
  state.monitorData = typeData.map((typeItem) => {
    const { label, value: code, EXT1: defaultUnit } = typeItem;
    // 从映射中获取当前指标的数据，无数据则用默认值
    const itemData = dataMap[code] || {
      value: '-',
      waterLevelCode: '6678a04114a34021a947caa73ebcf17f',
      isStandards: '1',
      unit: defaultUnit
    };

    const { value, waterLevelCode, isStandards, unit } = itemData;

    // 基础样式：labelIconStyle
    let style = {
      labelIconStyle: {
        'background-image': getWaterLevelSrc(waterLevelCode) // 假设该函数已定义
      }
    };
    ...
    return {
      ...
      value: value,
      style: style,
      unit: unit || defaultUnit, // 优先用接口返回的单位，无则用默认
      code: code
    };
  });
  ...
  function sortWaterQualityDataByCode(data) {
    const coreCodeToOrder = { W21011: 0, W21003: 1, W01019: 2, W01009: 3, W01001: 4 };

    const hasValueItems = [];
    const noValueItems = [];

    for (let item of data) {
      if (item.value !== '-' && item.value !== '') { // 修正空值判断逻辑
  ...
  // 隐藏水质
  state.monitorData = state.monitorData.filter((item) => item.label !== '水质');
  state.monitorData = sortWaterQualityDataByCode(state.monitorData);

  console.log('state.monitorData - 手工弹窗监测信息', state.categoryList, state.monitorData);
}
      resolve(_.get(res, "data"));
    }).catch((error) => {
      // 失败的操作
...
// 接口函数
 getWaterVariationTrend: {
              ...
              autoLoad: false, // 自动请求
              bindComponents: [], // 依赖的组件ID列表，可能多个组件绑定一个接口的数据
              config: {"url":"global.serviceBasePath","method":"get","baseURL":"global.foshanServiceBaseUrl","params":{"END_MONITORTIME":"state.endTime","START_MONITORTIME":"state.startTime","POINT_CODE":"state.pointCode","interfaceId":"82f9ea74a99dc1e82914dc04c386956e"}},
              request: function ( componentId) {
return new Promise((resolve, reject) => {
  
                http({"url":global.serviceBasePath,"method":"get","baseURL":global.foshanServiceBaseUrl,"params":{"END_MONITORTIME":state.endTime,"START_MONITORTIME":state.startTime,"POINT_CODE":state.pointCode,"interfaceId":"82f9ea74a99dc1e82914dc04c386956e"},}).then((res) => {
 
                   // 成功的操作
                   const cacheKey = generateCacheKey('global.foshanServiceBaseUrl-global.serviceBasePath',  {"END_MONITORTIME":state.endTime,"START_MONITORTIME":state.startTime,"POINT_CODE":state.pointCode,"interfaceId":"82f9ea74a99dc1e82914dc04c386956e"});
...
// 接口函数
 getBaseInfo: {
              ...
              autoLoad: false, // 自动请求
              bindComponents: [], // 依赖的组件ID列表，可能多个组件绑定一个接口的数据
              config: {"url":"global.serviceBasePath","method":"get","baseURL":"global.foshanServiceBaseUrl","params":{"POINT_CODE":"state.pointCode","a":"","interfaceId":"05a4339b55fe545693f8bbd6ce5f5fb8"}},
              request: function ( componentId) {
return new Promise((resolve, reject) => {
  
                http({"url":global.serviceBasePath,"method":"get","baseURL":global.foshanServiceBaseUrl,"params":{"POINT_CODE":state.pointCode,"a":"","interfaceId":"05a4339b55fe545693f8bbd6ce5f5fb8"},}).then((res) => {
 
                   // 成功的操作
                   const cacheKey = generateCacheKey('global.foshanServiceBaseUrl-global.serviceBasePath',  {"POINT_CODE":state.pointCode,"a":"","interfaceId":"05a4339b55fe545693f8bbd6ce5f5fb8"});
...
if (data.head.statusCode === '200' && data.data) {
  ...
  state.baseInfoData[2].num = data.data?.POINTADDRESS || '-';
  // 所在水体
  state.baseInfoData[3].num = `${data.data?.WSYSTEM_NAME}/${data.data?.WATER_NAME}` || '-';
...
deep: true, // 深度监听
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-xhjsBaseInfo', global.appScaleMode, 'normal');
...
.t-l-c-xhjsBaseInfo .xhjsBaseInfo-t-circle-0-0 {
...
.t-l-c-xhjsBaseInfo .xhjsBaseInfo-t-text-0-1 {
position: absolute !important;
top: 125px;
left: 12px;
width: 334px;
...
.t-l-c-xhjsBaseInfo .xhjsBaseInfo-t-chart-design-0-3 {
position: absolute !important;
top: 291px;
left: -1px;
width: 100%;
...
.t-l-c-xhjsBaseInfo .xhjsBaseInfo-t-chart-design-0-4 {
position: absolute !important;
top: 291px;
left: -1px;
width: 100%;
...
.t-l-c-xhjsBaseInfo .xhjsBaseInfo-t-list-card-0-6 {
position: absolute !important;
top: 0px;
left: 0px;
width: 100%;
...
.t-l-c-xhjsBaseInfo .xhjsBaseInfo-t-component-0-7 {
position: absolute !important;
top: 85px;
left: -1px;
width: 100%;
...
.t-l-c-xhjsBaseInfo .xhjsBaseInfo-t-text-0-8 {
position: absolute !important;
top: 89px;
left: 39px;
width: 130px;
...
.t-l-c-xhjsBaseInfo .xhjsBaseInfo-t-scrollable-cards-0-9 {
position: absolute !important;
top: 161px;
left: -1px;
width: 100%;
...
.t-l-c-xhjsBaseInfo .xhjsBaseInfo-t-row-0-11 {
position: absolute !important;
top: 240px;
left: -1px;
width: 100%;
...
.t-l-c-xhjsBaseInfo .xhjsBaseInfo-t-col-0-11-0 {
position: relative;
top: null;
left: null;
width: 100px;
...
.t-l-c-xhjsBaseInfo .xhjsBaseInfo-t-text-0-11-0-0 {
position: unset;
top: 289px;
left: 0px;
width: 240px;
...
.t-l-c-xhjsBaseInfo .xhjsBaseInfo-t-col-0-11-1 {
position: relative;
top: null;
left: null;
width: 100px;
...
.t-l-c-xhjsBaseInfo .xhjsBaseInfo-t-date-picker-0-11-1-0 {
position: unset;
top: 284px;
left: 394px;
width: 330px;
...
.t-l-c-xhjsBaseInfo .xhjsBaseInfo-t-select-0-11-1-1 {
position: unset;
top: 284px;
left: 704px;
width: 190px;
...
.t-l-c-xhjsBaseInfo .xhjsBaseInfo-t-row-0-12 {
position: absolute !important;
top: 293px;
left: -1px;
width: 100%;
...
.t-l-c-xhjsBaseInfo .xhjsBaseInfo-t-col-0-12-0 {
position: relative;
top: null;
left: null;
width: 100%;
...
.t-l-c-xhjsBaseInfo .xhjsBaseInfo-t-text-0-12-0-0 {
position: unset;
top: 327px;
left: 726px;
width: 65px;
...
.t-l-c-xhjsBaseInfo .xhjsBaseInfo-t-switch-0-12-0-1 {
position: unset;
top: 328px;
left: 791px;
width: 32px;
...
.t-l-c-xhjsBaseInfo .xhjsBaseInfo-t-row-0-13 {
position: absolute !important;
top: 85px;
left: -1px;
width: 100%;
...
.t-l-c-xhjsBaseInfo .xhjsBaseInfo-t-text-0-13-0 {
position: unset;
top: 124.5px;
left: 645px;
width: 164px;

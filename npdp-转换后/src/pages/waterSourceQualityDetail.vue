<template>
  <div id="t-l-c-waterSourceQualityDetail" class="t-l-c-waterSourceQualityDetail" ><t-row id="t-row-7bf8.3ee75802" class="waterSourceQualityDetail-t-row-0-0"  :c-style="tRowx0x0ComputedData.cStyle" :gutter="tRowx0x0ComputedData.gutter" :justify="tRowx0x0ComputedData.justify" :align="tRowx0x0ComputedData.align"><t-text id="t-text-17af.da59848b8" class="waterSourceQualityDetail-t-text-0-0-0"  :label="tTextx0x0x0ComputedData.label" :editable="tTextx0x0x0ComputedData.editable" :c-style="tTextx0x0x0ComputedData.cStyle" @click="onclick1734571942724_0_0"></t-text><t-text id="t-text-fa2d.892cf4b77" class="waterSourceQualityDetail-t-text-0-0-1"  :label="replaceCssVariables(filterData(state.title, componentPropBindingMap?.['t-text-fa2d.892cf4b77']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x0x1ComputedData.editable" :c-style="tTextx0x0x1ComputedData.cStyle" :show-title="tTextx0x0x1ComputedData.showTitle"></t-text><t-list-card-common id="t-list-card-common-0d81.de421556a" class="waterSourceQualityDetail-t-list-card-common-0-0-2"  :c-style="tListCardCommonx0x0x2ComputedData.cStyle" :key-word="tListCardCommonx0x0x2ComputedData.keyWord" :default-checked="tListCardCommonx0x0x2ComputedData.defaultChecked" :tab="tListCardCommonx0x0x2ComputedData.tab" :collapse="tListCardCommonx0x0x2ComputedData.collapse" :collapse-text="tListCardCommonx0x0x2ComputedData.collapseText" :display-count="tListCardCommonx0x0x2ComputedData.displayCount" :data-alias="tListCardCommonx0x0x2ComputedData.dataAlias" :data="replaceCssVariables(filterData(state.standard, componentPropBindingMap?.['t-list-card-common-0d81.de421556a']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')"></t-list-card-common></t-row><t-rect id="t-rect-b8a7.3fc5f52df" class="waterSourceQualityDetail-t-rect-0-1"  :tip="tRectx0x1ComputedData.tip" :label="tRectx0x1ComputedData.label" :active="tRectx0x1ComputedData.active" :c-style="tRectx0x1ComputedData.cStyle"></t-rect><t-component id="t-component-2081.271fecb9c" class="waterSourceQualityDetail-t-component-0-2"  :name="tComponentx0x2ComputedData.name" :c-style="tComponentx0x2ComputedData.cStyle" :src="tComponentx0x2ComputedData.src" :component-name="tComponentx0x2ComputedData.componentName"></t-component></div>
</template>
...
<style scoped>
.t-l-c-waterSourceQualityDetail {
position: relative;
overflow: hidden;
...
.t-l-c-waterSourceQualityDetail .waterSourceQualityDetail-t-row-0-0 {
...
.t-l-c-waterSourceQualityDetail .waterSourceQualityDetail-t-text-0-0-0 {
position: unset;
top: -195px;
left: 125px;
width: 43px;
...
.t-l-c-waterSourceQualityDetail .waterSourceQualityDetail-t-text-0-0-1 {
position: unset;
top: -7.873399522569571px;
left: 582.8092289677372px;
width: auto;
height: auto;
pointer-events: auto;
}

.t-l-c-waterSourceQualityDetail .waterSourceQualityDetail-t-list-card-common-0-0-2 {
position: unset;
top: -22px;
left: 369px;
width: auto;
...
.t-l-c-waterSourceQualityDetail .waterSourceQualityDetail-t-rect-0-1 {
position: absolute !important;
top: 55px;
left: 0px;
width: 450px;
...
.t-l-c-waterSourceQualityDetail .waterSourceQualityDetail-t-component-0-2 {
position: absolute !important;
top: 68px;
left: 0px;
width: 450px;

...
import { TButton, TPaginationBase, TSearch, TTable } from '@ths/design';
...
tabindex:"",
validateEvent:true,
cStyle:{"wrapper":{"default":{"width":"350px","height":"33px","backgroundColor":"var(--business-show-bg30)","borderLeft":"1px solid var(--business-show-bg50)","borderTop":"1px solid var(--business-show-bg50)","borderRight":"1px solid var(--business-show-bg50)","borderBottom":"1px solid var(--business-show-bg50)","color":"var(--t-white)","animationName":"","position":"unset","left":"0px","top":"0px"},"hover":{"borderLeft":"1px solid var(--business-theme)","borderTop":"1px solid var(--business-theme)","borderRight":"1px solid var(--business-theme)","borderBottom":"1px solid var(--business-theme)","color":"var(--t-white)"}},"placeholder":{"default":{"color":"var(--business-text-avianize)"}},"prefix":{"default":{"color":"var(--t-gray5)"}}},
hasSearchBtn:false, 
 },
},
tPaginationBasex0x1: {
...
tTablex0x3: {
defaultStyle: {
            default: {"width":"410px","height":"712px","position":"unset","left":"-1px","top":"49px","borderBottom":"0px solid rgba(23,62,228,0)","fontWeight":"400","animationName":"","--el-text-color-secondary":"var(--business-show-bg60)"},
...
// 接口函数
 getListData: {
              ...
              config: {"url":"global.serviceBasePath","method":"get","baseURL":"global.foshanServiceBaseUrl","params":{"PKID":"","pageNum":"state.pageInfo.pageNum","pageSize":"state.pageInfo.pageSize","NAME":"state.keyWord","REGION_PATH":"global.regionaQuery.regionCode","interfaceId":"835e846a442548c4df3c437af7d7c4d5"}},
              request: function ( componentId) {
return new Promise((resolve, reject) => {
  
                http({"url":global.serviceBasePath,"method":"get","baseURL":global.foshanServiceBaseUrl,"params":{"PKID":"","pageNum":state.pageInfo.pageNum,"pageSize":state.pageInfo.pageSize,"NAME":state.keyWord,"REGION_PATH":global.regionaQuery.regionCode,"interfaceId":"835e846a442548c4df3c437af7d7c4d5"},}).then((res) => {
 
                   // 成功的操作
                   const cacheKey = generateCacheKey('global.foshanServiceBaseUrl-global.serviceBasePath',  {"PKID":"","pageNum":state.pageInfo.pageNum,"pageSize":state.pageInfo.pageSize,"NAME":state.keyWord,"REGION_PATH":global.regionaQuery.regionCode,"interfaceId":"835e846a442548c4df3c437af7d7c4d5"});
...
if (head.statusCode === '200' && data.length) {
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-jzrfdList', global.appScaleMode, 'normal');
...
.t-l-c-jzrfdList .jzrfdList-t-search-0-0 {
...
.t-l-c-jzrfdList .jzrfdList-t-pagination-base-0-1 {
position: absolute !important;
top: 787px;
left: 0px;
width: 410px;
...
.t-l-c-jzrfdList .jzrfdList-t-button-0-2 {
position: absolute !important;
top: 0px;
left: 360px;
width: 50px;
...
.t-l-c-jzrfdList .jzrfdList-t-table-0-3 {
position: absolute !important;
top: 49px;
left: -1px;
width: 410px;

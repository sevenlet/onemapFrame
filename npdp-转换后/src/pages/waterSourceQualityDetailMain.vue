<template>
  <div id="t-l-c-waterSourceQualityDetailMain" class="t-l-c-waterSourceQualityDetailMain" ><t-component id="t-component-dab7.4985a8477" class="waterSourceQualityDetailMain-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName"></t-component><t-text id="t-text-3d08.2ece82a4d" class="waterSourceQualityDetailMain-t-text-0-1"  :label="tTextx0x1ComputedData.label" :editable="tTextx0x1ComputedData.editable" :c-style="tTextx0x1ComputedData.cStyle"></t-text><t-rect id="t-rect-3ee9.a01809fa3" class="waterSourceQualityDetailMain-t-rect-0-2"  :tip="tRectx0x2ComputedData.tip" :label="tRectx0x2ComputedData.label" :active="tRectx0x2ComputedData.active" :c-style="tRectx0x2ComputedData.cStyle"></t-rect><t-date-picker id="t-date-picker-c859.d0d5ef923" class="waterSourceQualityDetailMain-t-date-picker-0-3"  :placeholder="tDatePickerx0x3ComputedData.placeholder" :start-placeholder="tDatePickerx0x3ComputedData.startPlaceholder" :end-placeholder="tDatePickerx0x3ComputedData.endPlaceholder" :type="tDatePickerx0x3ComputedData.type" :clearable="tDatePickerx0x3ComputedData.clearable" :range-separator="tDatePickerx0x3ComputedData.rangeSeparator" :default-date="replaceCssVariables(filterData(state.monitorTime, componentPropBindingMap?.['t-date-picker-c859.d0d5ef923']['default-date'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :separator="tDatePickerx0x3ComputedData.separator" :readonly="tDatePickerx0x3ComputedData.readonly" :editable="tDatePickerx0x3ComputedData.editable" :c-style="tDatePickerx0x3ComputedData.cStyle" @date-change="ondateChange1733896202369"></t-date-picker><t-table id="t-table-ded9.b0289ff3" class="waterSourceQualityDetailMain-t-table-0-4"  :height="tTablex0x4ComputedData.height" :stripe="tTablex0x4ComputedData.stripe" :border="tTablex0x4ComputedData.border" :auto-scroll="tTablex0x4ComputedData.autoScroll" :speed="tTablex0x4ComputedData.speed" :columns="tTablex0x4ComputedData.columns" :data="replaceCssVariables(filterData(state.dmList, componentPropBindingMap?.['t-table-ded9.b0289ff3']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x4ComputedData.defaultSort" :c-style="tTablex0x4ComputedData.cStyle" @cell-click="oncellClick1733906983339"></t-table><t-table id="t-table-42c3.a5138b9a5" class="waterSourceQualityDetailMain-t-table-0-5"  :height="tTablex0x5ComputedData.height" :stripe="tTablex0x5ComputedData.stripe" :border="tTablex0x5ComputedData.border" :auto-scroll="tTablex0x5ComputedData.autoScroll" :speed="tTablex0x5ComputedData.speed" :columns="tTablex0x5ComputedData.columns" :data="replaceCssVariables(filterData(state.fxyList, componentPropBindingMap?.['t-table-42c3.a5138b9a5']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x5ComputedData.defaultSort" :c-style="tTablex0x5ComputedData.cStyle" @cell-click="oncellClick1734486253590"></t-table><t-list-card id="t-list-card-fb20.2af923ac2" class="waterSourceQualityDetailMain-t-list-card-0-6"  :data="replaceCssVariables(filterData(state.bhqfwData, componentPropBindingMap?.['t-list-card-fb20.2af923ac2']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :spacing-x="tListCardx0x6ComputedData.spacingX" :col="tListCardx0x6ComputedData.col" :direction="tListCardx0x6ComputedData.direction" :exchange-order="tListCardx0x6ComputedData.exchangeOrder" :unit-break="tListCardx0x6ComputedData.unitBreak" :key-field="tListCardx0x6ComputedData.keyField" :active-key-field="tListCardx0x6ComputedData.activeKeyField" :active="tListCardx0x6ComputedData.active" :c-style="tListCardx0x6ComputedData.cStyle"></t-list-card><t-component id="t-component-d7a5.0f0c30eaf" class="waterSourceQualityDetailMain-t-component-0-7"  :name="tComponentx0x7ComputedData.name" :c-style="tComponentx0x7ComputedData.cStyle" :src="tComponentx0x7ComputedData.src" :component-name="tComponentx0x7ComputedData.componentName"></t-component><t-component id="t-component-9a43.f9f1a46a" class="waterSourceQualityDetailMain-t-component-0-8"  :name="tComponentx0x8ComputedData.name" :c-style="tComponentx0x8ComputedData.cStyle" :src="tComponentx0x8ComputedData.src" :component-name="tComponentx0x8ComputedData.componentName"></t-component><t-text id="t-text-dde9.205bbc868" class="waterSourceQualityDetailMain-t-text-0-9"  :label="tTextx0x9ComputedData.label" :editable="tTextx0x9ComputedData.editable" :c-style="tTextx0x9ComputedData.cStyle"></t-text><t-component id="t-component-0847.c1f68f2d3" class="waterSourceQualityDetailMain-t-component-0-10"  :name="tComponentx0x10ComputedData.name" :c-style="tComponentx0x10ComputedData.cStyle" :src="tComponentx0x10ComputedData.src" :component-name="tComponentx0x10ComputedData.componentName"></t-component><t-text id="t-text-886c.6813dc79" class="waterSourceQualityDetailMain-t-text-0-11"  :label="tTextx0x11ComputedData.label" :editable="tTextx0x11ComputedData.editable" :c-style="tTextx0x11ComputedData.cStyle"></t-text><t-component id="t-component-31d3.24b651f58" class="waterSourceQualityDetailMain-t-component-0-12"  :name="tComponentx0x12ComputedData.name" :c-style="tComponentx0x12ComputedData.cStyle" :src="tComponentx0x12ComputedData.src" :component-name="tComponentx0x12ComputedData.componentName"></t-component><t-text id="t-text-1389.f99ff2c66" class="waterSourceQualityDetailMain-t-text-0-13"  :label="tTextx0x13ComputedData.label" :editable="tTextx0x13ComputedData.editable" :c-style="tTextx0x13ComputedData.cStyle"></t-text><t-text id="t-text-4c0d.f85861fe9" class="waterSourceQualityDetailMain-t-text-0-14"  :label="tTextx0x14ComputedData.label" :editable="tTextx0x14ComputedData.editable" :c-style="tTextx0x14ComputedData.cStyle"></t-text><t-list-card id="t-list-card-9491.e64bae56e" class="waterSourceQualityDetailMain-t-list-card-0-15"  :data="replaceCssVariables(filterData(state.baseInfoData, componentPropBindingMap?.['t-list-card-9491.e64bae56e']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :spacing-x="tListCardx0x15ComputedData.spacingX" :col="tListCardx0x15ComputedData.col" :direction="tListCardx0x15ComputedData.direction" :exchange-order="tListCardx0x15ComputedData.exchangeOrder" :unit-break="tListCardx0x15ComputedData.unitBreak" :key-field="tListCardx0x15ComputedData.keyField" :active-key-field="tListCardx0x15ComputedData.activeKeyField" :active="tListCardx0x15ComputedData.active" :c-style="tListCardx0x15ComputedData.cStyle"></t-list-card><t-list-card id="t-list-card-196c.c4221638e" class="waterSourceQualityDetailMain-t-list-card-0-16"  :data="replaceCssVariables(filterData(state.bhqglData, componentPropBindingMap?.['t-list-card-196c.c4221638e']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :spacing-x="tListCardx0x16ComputedData.spacingX" :col="tListCardx0x16ComputedData.col" :direction="tListCardx0x16ComputedData.direction" :exchange-order="tListCardx0x16ComputedData.exchangeOrder" :unit-break="tListCardx0x16ComputedData.unitBreak" :key-field="tListCardx0x16ComputedData.keyField" :active-key-field="tListCardx0x16ComputedData.activeKeyField" :active="tListCardx0x16ComputedData.active" :c-style="tListCardx0x16ComputedData.cStyle"></t-list-card></div>
</template>
...
import { TComponent, TDatePicker, TListCard, TRect, TTable, TText } from '@ths/design';
...
<style scoped>
.t-l-c-waterSourceQualityDetailMain {
position: relative;
overflow: hidden;
...
.t-l-c-waterSourceQualityDetailMain .waterSourceQualityDetailMain-t-component-0-0 {
...
.t-l-c-waterSourceQualityDetailMain .waterSourceQualityDetailMain-t-text-0-1 {
position: absolute !important;
top: 746px;
left: 60px;
width: 130px;
...
.t-l-c-waterSourceQualityDetailMain .waterSourceQualityDetailMain-t-rect-0-2 {
position: absolute !important;
top: 0px;
left: 0px;
width: 450px;
...
.t-l-c-waterSourceQualityDetailMain .waterSourceQualityDetailMain-t-date-picker-0-3 {
position: absolute !important;
top: 16px;
left: 16px;
width: 418px;
...
.t-l-c-waterSourceQualityDetailMain .waterSourceQualityDetailMain-t-table-0-4 {
position: absolute !important;
top: 789px;
left: 20px;
width: 410px;
...
.t-l-c-waterSourceQualityDetailMain .waterSourceQualityDetailMain-t-table-0-5 {
position: absolute !important;
top: 1092px;
left: 20px;
width: 410px;
...
.t-l-c-waterSourceQualityDetailMain .waterSourceQualityDetailMain-t-list-card-0-6 {
position: absolute !important;
top: 506px;
left: 16px;
width: 418px;
...
.t-l-c-waterSourceQualityDetailMain .waterSourceQualityDetailMain-t-component-0-7 {
position: absolute !important;
top: 84px;
left: 20px;
width: 410px;
...
.t-l-c-waterSourceQualityDetailMain .waterSourceQualityDetailMain-t-component-0-8 {
position: absolute !important;
top: 464px;
left: 20px;
width: 410px;
...
.t-l-c-waterSourceQualityDetailMain .waterSourceQualityDetailMain-t-text-0-9 {
position: absolute !important;
top: 84px;
left: 60px;
width: 130px;
...
.t-l-c-waterSourceQualityDetailMain .waterSourceQualityDetailMain-t-component-0-10 {
position: absolute !important;
top: 606px;
left: 20px;
width: 410px;
...
.t-l-c-waterSourceQualityDetailMain .waterSourceQualityDetailMain-t-text-0-11 {
position: absolute !important;
top: 606px;
left: 60px;
width: 182px;
...
.t-l-c-waterSourceQualityDetailMain .waterSourceQualityDetailMain-t-component-0-12 {
position: absolute !important;
top: 1049px;
left: 20px;
width: 410px;
...
.t-l-c-waterSourceQualityDetailMain .waterSourceQualityDetailMain-t-text-0-13 {
position: absolute !important;
top: 1049px;
left: 60px;
width: 130px;
...
.t-l-c-waterSourceQualityDetailMain .waterSourceQualityDetailMain-t-text-0-14 {
position: absolute !important;
top: 469px;
left: 60px;
width: 130px;
...
.t-l-c-waterSourceQualityDetailMain .waterSourceQualityDetailMain-t-list-card-0-15 {
position: absolute !important;
top: 127px;
left: 20px;
width: 410px;
...
.t-l-c-waterSourceQualityDetailMain .waterSourceQualityDetailMain-t-list-card-0-16 {
position: absolute !important;
top: 649px;
left: 20px;
width: 410px;

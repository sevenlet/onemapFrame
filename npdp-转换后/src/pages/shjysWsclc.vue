...
import { TButton, TSearch, TTable } from '@ths/design';
...
const oncellClick1739353314281 = (row,column,cell,event) => {
// 执行自定义方法
...
// 接口函数
 getListData: {
              ...
              config: {"url":"global.serviceBasePath","method":"post","baseURL":"global.foshanServiceBaseUrl","data":"qs.stringify({\"ENTITY_CODE\":\"tag_wsclc_1764143150953\",\"HasAllTag\":\"true\",\"keyword\":\"state.name\",\"pageNum\":\"1\",\"pageSize\":\"2000\",\"orderBy\":\"\",\"tagJson\":\"state.tagJson\",\"distance\":\"\",\"locationField\":\"\",\"pointValue\":\"\",\"gisType\":\"\",\"queryField\":\"ENTER_NAME\",\"AREA_CODE\":\"\",\"useTermKeyword\":\"\",\"useGisShape\":\"\",\"hasGather\":\"\",\"topicCode\":\"\",\"REGION_CODE\":\"global.regionaQuery.regionCode\",\"interfaceId\":\"8b5ca6a3009f750b5b1f19a415589682\"})qsstringifyend"},
...
return new Promise((resolve, reject) => {
                ...
                http({"url":global.serviceBasePath,"method":"post","baseURL":global.foshanServiceBaseUrl,"data":qs.stringify({"ENTITY_CODE":"tag_wsclc_1764143150953","HasAllTag":"true","keyword":state.name,"pageNum":"1","pageSize":"2000","orderBy":"","tagJson":state.tagJson,"distance":"","locationField":"","pointValue":"","gisType":"","queryField":"ENTER_NAME","AREA_CODE":"","useTermKeyword":"","useGisShape":"","hasGather":"","topicCode":"","REGION_CODE":global.regionaQuery.regionCode,"interfaceId":"8b5ca6a3009f750b5b1f19a415589682"}),}).then((res) => {
                   ...
                   // 成功的操作
                   const cacheKey = generateCacheKey('global.foshanServiceBaseUrl-global.serviceBasePath',  "qs.stringify({\"ENTITY_CODE\":\"tag_wsclc_1764143150953\",\"HasAllTag\":\"true\",\"keyword\":\state.name\,\"pageNum\":\"1\",\"pageSize\":\"2000\",\"orderBy\":\"\",\"tagJson\":\state.tagJson\,\"distance\":\"\",\"locationField\":\"\",\"pointValue\":\"\",\"gisType\":\"\",\"queryField\":\"ENTER_NAME\",\"AREA_CODE\":\"\",\"useTermKeyword\":\"\",\"useGisShape\":\"\",\"hasGather\":\"\",\"topicCode\":\"\",\"REGION_CODE\":\global.regionaQuery.regionCode\,\"interfaceId\":\"8b5ca6a3009f750b5b1f19a415589682\"})qsstringifyend");
...
deep: true, // 深度监听
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-shjysWsclc', global.appScaleMode, 'normal');
...
onclick1739353266882,
oncellClick1739353314281,
};
},
}
</script>
...
.t-l-c-shjysWsclc .shjysWsclc-t-search-0-0 {
...
.t-l-c-shjysWsclc .shjysWsclc-t-button-0-1 {
position: absolute !important;
top: 0px;
left: 353px;
width: 49px;
...
.t-l-c-shjysWsclc .shjysWsclc-t-table-0-2 {
position: absolute !important;
top: 40px;
left: 8px;
width: 394px;

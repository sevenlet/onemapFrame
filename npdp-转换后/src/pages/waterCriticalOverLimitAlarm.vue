<template>
  <div id="t-l-c-waterCriticalOverLimitAlarm" class="t-l-c-waterCriticalOverLimitAlarm" ><t-rect id="t-rect-8252.1a4ade4f4" class="waterCriticalOverLimitAlarm-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle"></t-rect><t-table id="t-table-1f2f.98c8ca619" class="waterCriticalOverLimitAlarm-t-table-0-1"  :height="tTablex0x1ComputedData.height" :stripe="tTablex0x1ComputedData.stripe" :border="tTablex0x1ComputedData.border" :auto-scroll="tTablex0x1ComputedData.autoScroll" :speed="tTablex0x1ComputedData.speed" :columns="tTablex0x1ComputedData.columns" :data="replaceCssVariables(filterData(state.waringList, componentPropBindingMap?.['t-table-1f2f.98c8ca619']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x1ComputedData.defaultSort" :c-style="tTablex0x1ComputedData.cStyle" @cell-click="oncellClick1734078861325"></t-table><t-rect id="t-rect-e3a7.d7772ec8d" class="waterCriticalOverLimitAlarm-t-rect-0-2"  :tip="tRectx0x2ComputedData.tip" :label="tRectx0x2ComputedData.label" :active="tRectx0x2ComputedData.active" :c-style="tRectx0x2ComputedData.cStyle"></t-rect><t-text id="t-text-8cba.b16affff7" class="waterCriticalOverLimitAlarm-t-text-0-3"  :label="tTextx0x3ComputedData.label" :editable="tTextx0x3ComputedData.editable" :c-style="tTextx0x3ComputedData.cStyle"></t-text><t-rect id="t-rect-da62.857f90ab" class="waterCriticalOverLimitAlarm-t-rect-0-4"  :tip="tRectx0x4ComputedData.tip" :label="tRectx0x4ComputedData.label" :active="tRectx0x4ComputedData.active" :c-style="tRectx0x4ComputedData.cStyle" @click="onclick1733817210174"></t-rect></div>
</template>
...
// 点击定位给地图发消息
if (["定位", '断面名称', '水体名称', '水质目标', '报警污染物(标准限制;监测浓度)'].includes(column.label)) {
  /* 发送消息 */
...
const oncellClick1734078861325 = (row,column,cell,event) => {
// 执行自定义方法
...
// 接口函数
 getWaringList: {
              ...
              config: {"url":"global.serviceBasePath","method":"get","baseURL":"global.foshanServiceBaseUrl","params":{"AREA CODE":"global.regionaQuery.areaCode","DATA_FREQUENCY":"state.DATA_FREQUENCY","CODE_WQDATASOURCETYPE":"state.CODE_WQDATASOURCETYPE","WSYSTEM_CODE":"global.regionaQuery.areaCode","MONITORTYPE":"state.MONITORTYPE","CODE_CONTROLLEVEL":"state.CODE_CONTROLLEVEL","IS_CONNECT_SECTION":"state.IS_CONNECT_SECTION","REGION_CODE":"global.regionaQuery.regionCode","MONITORTIME":"state.MONITORTIME","interfaceId":"6128ee3da755aa07e8958ff06619e542"}},
              request: function ( componentId) {
return new Promise((resolve, reject) => {
  
                http({"url":global.serviceBasePath,"method":"get","baseURL":global.foshanServiceBaseUrl,"params":{"AREA CODE":global.regionaQuery.areaCode,"DATA_FREQUENCY":state.DATA_FREQUENCY,"CODE_WQDATASOURCETYPE":state.CODE_WQDATASOURCETYPE,"WSYSTEM_CODE":global.regionaQuery.areaCode,"MONITORTYPE":state.MONITORTYPE,"CODE_CONTROLLEVEL":state.CODE_CONTROLLEVEL,"IS_CONNECT_SECTION":state.IS_CONNECT_SECTION,"REGION_CODE":global.regionaQuery.regionCode,"MONITORTIME":state.MONITORTIME,"interfaceId":"6128ee3da755aa07e8958ff06619e542"},}).then((res) => {
 
                   // 成功的操作
                   const cacheKey = generateCacheKey('global.foshanServiceBaseUrl-global.serviceBasePath',  {"AREA CODE":global.regionaQuery.areaCode,"DATA_FREQUENCY":state.DATA_FREQUENCY,"CODE_WQDATASOURCETYPE":state.CODE_WQDATASOURCETYPE,"WSYSTEM_CODE":global.regionaQuery.areaCode,"MONITORTYPE":state.MONITORTYPE,"CODE_CONTROLLEVEL":state.CODE_CONTROLLEVEL,"IS_CONNECT_SECTION":state.IS_CONNECT_SECTION,"REGION_CODE":global.regionaQuery.regionCode,"MONITORTIME":state.MONITORTIME,"interfaceId":"6128ee3da755aa07e8958ff06619e542"});
                   
                   apiDataMap[cacheKey] = res.data;
                   apiDataMap['getWaringList'] = res.data;
                
     if (res?.data?.head?.statusCode === '200' && res?.data?.data) {
  // console.log(res, '临界超标报警-列表数据')
  ...
  if (state.waringList?.length) {
    state.waringList = state.waringList.map((item) => ({
      ...
      CODE_TARGETWATERLEVEL: item?.CODE_TARGETWATERLEVEL || '-',
      // 报警污染物
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-waterCriticalOverLimitAlarm', global.appScaleMode, 'normal');
...
<style scoped>
.t-l-c-waterCriticalOverLimitAlarm {
position: relative;
overflow: hidden;
...
.t-l-c-waterCriticalOverLimitAlarm .waterCriticalOverLimitAlarm-t-rect-0-0 {
...
.t-l-c-waterCriticalOverLimitAlarm .waterCriticalOverLimitAlarm-t-table-0-1 {
position: absolute !important;
top: 63px;
left: 20px;
width: 580px;
...
.t-l-c-waterCriticalOverLimitAlarm .waterCriticalOverLimitAlarm-t-rect-0-2 {
position: absolute !important;
top: 0px;
left: 0px;
width: 620px;
...
.t-l-c-waterCriticalOverLimitAlarm .waterCriticalOverLimitAlarm-t-text-0-3 {
position: absolute !important;
top: 13px;
left: 24px;
width: 314px;
...
.t-l-c-waterCriticalOverLimitAlarm .waterCriticalOverLimitAlarm-t-rect-0-4 {
position: absolute !important;
top: 10px;
left: 580px;
width: 24px;

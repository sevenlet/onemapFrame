<template>
  <div id="t-l-c-waterMonitoringEntry" class="t-l-c-waterMonitoringEntry" ><t-component id="t-component-8cc1.8e726916" class="waterMonitoringEntry-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName"></t-component></div>
</template>
...
export default {
  ...
  setup() {
const componentPropBindingMap = {"body":{"attributeName":"tBodyx0x0"},"t-component-8cc1.8e726916":{"attributeName":"tComponentx0x0","name":{"filters":[]},"cStyle":{"filters":[]},"src":{"filters":[]},"componentName":{"filters":[]}}};
// 页面内注入全局变量和事件
...
name:"waterMonitoringContentComponent",
...
src:"/lego-generated-apps/lego_file/app/src/27d54c897f0f4ba18421a7b587fe4ce4_12/index.html#/waterMonitoringContent",
componentName:"waterMonitoringContentComponent", 
 },
},
});
const setProvider = () => {
provide('waterMonitoringState', state);
};let apiRegistry = {}; 

 function handleWindowResize() {
                            setPageScale('t-l-c-waterMonitoringEntry', global.appScaleMode, 'normal');
...
.t-l-c-waterMonitoringEntry .waterMonitoringEntry-t-component-0-0 {

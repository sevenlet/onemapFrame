<template>
  <div id="t-l-c-waterBalckWaterDetailDialog" class="t-l-c-waterBalckWaterDetailDialog" ><t-rect id="t-rect-8252.1a4ade4f4" class="waterBalckWaterDetailDialog-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle"></t-rect><t-rect id="t-rect-e3a7.d7772ec8d" class="waterBalckWaterDetailDialog-t-rect-0-1"  :tip="tRectx0x1ComputedData.tip" :label="tRectx0x1ComputedData.label" :active="tRectx0x1ComputedData.active" :c-style="tRectx0x1ComputedData.cStyle"></t-rect><t-text id="t-text-8cba.b16affff7" class="waterBalckWaterDetailDialog-t-text-0-2"  :label="state.blackWaterPointName" :editable="tTextx0x2ComputedData.editable" :c-style="tTextx0x2ComputedData.cStyle"></t-text><t-rect id="t-rect-da62.857f90ab" class="waterBalckWaterDetailDialog-t-rect-0-3"  :tip="tRectx0x3ComputedData.tip" :label="tRectx0x3ComputedData.label" :active="tRectx0x3ComputedData.active" :c-style="tRectx0x3ComputedData.cStyle" @click="onclick1733817210174"></t-rect><t-text id="t-text-738d.67fdf6baf" class="waterBalckWaterDetailDialog-t-text-0-4"  :label="tTextx0x4ComputedData.label" :editable="tTextx0x4ComputedData.editable" :c-style="tTextx0x4ComputedData.cStyle"></t-text><t-text id="t-text-a501.53f326817" class="waterBalckWaterDetailDialog-t-text-0-5"  :label="state.pjTime" :editable="tTextx0x5ComputedData.editable" :c-style="tTextx0x5ComputedData.cStyle"></t-text><t-list-card id="t-list-card-1afd.46c2cc26d" class="waterBalckWaterDetailDialog-t-list-card-0-6"  :data="state.cardList" :spacing-x="tListCardx0x6ComputedData.spacingX" :col="tListCardx0x6ComputedData.col" :direction="tListCardx0x6ComputedData.direction" :exchange-order="tListCardx0x6ComputedData.exchangeOrder" :unit-break="tListCardx0x6ComputedData.unitBreak" :key-field="tListCardx0x6ComputedData.keyField" :active-key-field="tListCardx0x6ComputedData.activeKeyField" :active="tListCardx0x6ComputedData.active" :c-style="tListCardx0x6ComputedData.cStyle"></t-list-card><t-select id="t-select-ab9b.87d98bf9d" class="waterBalckWaterDetailDialog-t-select-0-7"  :active-value="state.MONITOR_DATE_STR" :options="state.cySelectList" :alias="tSelectx0x7ComputedData.alias" :multiple="tSelectx0x7ComputedData.multiple" :placeholder="tSelectx0x7ComputedData.placeholder" :clearable="tSelectx0x7ComputedData.clearable" :disabled="tSelectx0x7ComputedData.disabled" :name="tSelectx0x7ComputedData.name" :autocomplete="tSelectx0x7ComputedData.autocomplete" :filterable="tSelectx0x7ComputedData.filterable" :no-match-text="tSelectx0x7ComputedData.no-match-text" :no-data-text="tSelectx0x7ComputedData.no-data-text" :c-style="tSelectx0x7ComputedData.cStyle" @change="onchange1733987100050"></t-select><t-row id="t-row-fe1a.537c1d02b" class="waterBalckWaterDetailDialog-t-row-0-8"  :c-style="tRowx0x8ComputedData.cStyle" :gutter="tRowx0x8ComputedData.gutter" :justify="tRowx0x8ComputedData.justify" :align="tRowx0x8ComputedData.align"><t-text id="t-text-c920.565800cd9" class="waterBalckWaterDetailDialog-t-text-0-8-0"  :label="tTextx0x8x0ComputedData.label" :editable="tTextx0x8x0ComputedData.editable" :c-style="tTextx0x8x0ComputedData.cStyle" @click="onclick1734498867709"></t-text></t-row></div>
</template>
...
import { TListCard, TRect, TRow, TSelect, TText } from '@ths/design';
...
<style scoped>
.t-l-c-waterBalckWaterDetailDialog {
position: relative;
overflow: hidden;
...
.t-l-c-waterBalckWaterDetailDialog .waterBalckWaterDetailDialog-t-rect-0-0 {
...
.t-l-c-waterBalckWaterDetailDialog .waterBalckWaterDetailDialog-t-rect-0-1 {
position: absolute !important;
top: 0px;
left: 0px;
width: 450px;
...
.t-l-c-waterBalckWaterDetailDialog .waterBalckWaterDetailDialog-t-text-0-2 {
position: absolute !important;
top: 13px;
left: 24px;
width: 314px;
...
.t-l-c-waterBalckWaterDetailDialog .waterBalckWaterDetailDialog-t-rect-0-3 {
position: absolute !important;
top: 10px;
left: 402px;
width: 24px;
...
.t-l-c-waterBalckWaterDetailDialog .waterBalckWaterDetailDialog-t-text-0-4 {
position: absolute !important;
top: 318px;
left: 0px;
width: 450px;
...
.t-l-c-waterBalckWaterDetailDialog .waterBalckWaterDetailDialog-t-text-0-5 {
position: absolute !important;
top: 63px;
left: 20px;
width: 250px;
...
.t-l-c-waterBalckWaterDetailDialog .waterBalckWaterDetailDialog-t-list-card-0-6 {
position: absolute !important;
top: 99px;
left: 20px;
width: 410px;
...
.t-l-c-waterBalckWaterDetailDialog .waterBalckWaterDetailDialog-t-select-0-7 {
position: absolute !important;
top: 135px;
left: 190px;
width: 232px;
...
.t-l-c-waterBalckWaterDetailDialog .waterBalckWaterDetailDialog-t-row-0-8 {
position: absolute !important;
top: 331px;
left: 0px;
width: 430px;
...
.t-l-c-waterBalckWaterDetailDialog .waterBalckWaterDetailDialog-t-text-0-8-0 {
position: unset;
top: 449.3999938964844px;
left: 601px;
width: 90px;
height: 28px;
pointer-events: auto;

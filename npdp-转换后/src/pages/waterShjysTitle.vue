<template>
  <div id="t-l-c-waterShjysTitle" class="t-l-c-waterShjysTitle" ><t-component id="t-component-ded9.0f5a924fa" class="waterShjysTitle-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName"></t-component><t-text id="t-text-4f99.3a44d10f5" class="waterShjysTitle-t-text-0-1"  :label="tTextx0x1ComputedData.label" :editable="tTextx0x1ComputedData.editable" :c-style="tTextx0x1ComputedData.cStyle"></t-text></div>
</template>
...
tTextx0x1: {
defaultStyle: {
            default: {"width":"177px","height":"31px","color":"rgba(255, 255, 255, 0.9)","position":"unset","left":"40px","top":"0px","fontFamily":"方正综艺","fontSize":"var(--business-text-size-20)","animationName":"","letterSpacing":"2px","lineHeight":"31px"},
...
label:"水环境要素",
editable:false,
cStyle:{"wrapper":{"default":{"width":"177px","height":"31px","color":"rgba(255, 255, 255, 0.9)","position":"unset","left":"40px","top":"0px","fontFamily":"方正综艺","fontSize":"var(--business-text-size-20)","animationName":"","letterSpacing":"2px","lineHeight":"31px"}}}, 
 },
},
});let apiRegistry = {}; 

 function handleWindowResize() {
                            setPageScale('t-l-c-waterShjysTitle', global.appScaleMode, 'normal');
...
.t-l-c-waterShjysTitle .waterShjysTitle-t-component-0-0 {
...
.t-l-c-waterShjysTitle .waterShjysTitle-t-text-0-1 {
position: absolute !important;
top: 0px;
left: 40px;
width: 177px;

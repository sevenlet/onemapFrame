<template>
  <div id="t-l-c-businessMessage" class="t-l-c-businessMessage" ><t-rect id="t-rect-09e8.3b71afa9a" class="businessMessage-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle"></t-rect><t-rect id="t-rect-afae.576bf09ee" class="businessMessage-t-rect-0-1"  :tip="tRectx0x1ComputedData.tip" :label="tRectx0x1ComputedData.label" :active="tRectx0x1ComputedData.active" :c-style="tRectx0x1ComputedData.cStyle"></t-rect><t-rect id="t-rect-26fc.42aa488dd" class="businessMessage-t-rect-0-2"  :tip="tRectx0x2ComputedData.tip" :label="tRectx0x2ComputedData.label" :active="tRectx0x2ComputedData.active" :c-style="tRectx0x2ComputedData.cStyle" @click="onclick1734493226123"></t-rect><t-text id="t-text-1101.946bfcb11" class="businessMessage-t-text-0-4"  :label="replaceCssVariables(state.IS_FINISH, global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x4ComputedData.editable" :c-style="tTextx0x4ComputedData.cStyle" :show-title="tTextx0x4ComputedData.showTitle"></t-text><t-text id="t-text-85e6.8e2ae94e5" class="businessMessage-t-text-0-5"  :label="tTextx0x5ComputedData.label" :editable="tTextx0x5ComputedData.editable" :c-style="tTextx0x5ComputedData.cStyle"></t-text><t-text id="t-text-8a54.4f2e413df" class="businessMessage-t-text-0-6"  :label="tTextx0x6ComputedData.label" :editable="tTextx0x6ComputedData.editable" :c-style="tTextx0x6ComputedData.cStyle"></t-text><t-text id="t-text-5c90.1906820e5" class="businessMessage-t-text-0-7"  :label="replaceCssVariables(state.type, global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x7ComputedData.editable" :c-style="tTextx0x7ComputedData.cStyle" :show-title="tTextx0x7ComputedData.showTitle"></t-text><t-text id="t-text-b2de.98769e346" class="businessMessage-t-text-0-8"  :label="tTextx0x8ComputedData.label" :editable="tTextx0x8ComputedData.editable" :c-style="tTextx0x8ComputedData.cStyle"></t-text><t-text id="t-text-be22.060091258" class="businessMessage-t-text-0-9"  :label="tTextx0x9ComputedData.label" :editable="tTextx0x9ComputedData.editable" :c-style="tTextx0x9ComputedData.cStyle"></t-text><t-text id="t-text-610d.01e0076da" class="businessMessage-t-text-0-10"  :label="tTextx0x10ComputedData.label" :editable="tTextx0x10ComputedData.editable" :c-style="tTextx0x10ComputedData.cStyle"></t-text><t-text id="t-text-5b18.b811a1a6b" class="businessMessage-t-text-0-11"  :label="replaceCssVariables(state.questionName, global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x11ComputedData.editable" :c-style="tTextx0x11ComputedData.cStyle" :show-title="tTextx0x11ComputedData.showTitle"></t-text><t-text id="t-text-b136.79a29b68f" class="businessMessage-t-text-0-12"  :label="replaceCssVariables(state.longitude, global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x12ComputedData.editable" :c-style="tTextx0x12ComputedData.cStyle" :show-title="tTextx0x12ComputedData.showTitle"></t-text><t-text id="t-text-bc30.f8a081eb4" class="businessMessage-t-text-0-13"  :label="replaceCssVariables(state.latitude, global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x13ComputedData.editable" :c-style="tTextx0x13ComputedData.cStyle" :show-title="tTextx0x13ComputedData.showTitle"></t-text><t-text id="t-text-a3dd.58079667c" class="businessMessage-t-text-0-14"  :label="replaceCssVariables(state.name, global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x14ComputedData.editable" :c-style="tTextx0x14ComputedData.cStyle" :show-title="tTextx0x14ComputedData.showTitle"></t-text></div>
</template>
...
import { TRect, TText } from '@ths/design';
...
.t-l-c-businessMessage .businessMessage-t-rect-0-0 {
...
.t-l-c-businessMessage .businessMessage-t-rect-0-1 {
position: absolute !important;
top: 337px;
left: 725px;
width: 400px;
...
.t-l-c-businessMessage .businessMessage-t-rect-0-2 {
position: absolute !important;
top: 348px;
left: 1087px;
width: 24px;
...
.t-l-c-businessMessage .businessMessage-t-text-0-4 {
position: absolute !important;
top: 404px;
left: 832px;
width: 278px;
...
.t-l-c-businessMessage .businessMessage-t-text-0-5 {
position: absolute !important;
top: 444px;
left: 741px;
width: 90px;
...
.t-l-c-businessMessage .businessMessage-t-text-0-6 {
position: absolute !important;
top: 404px;
left: 741px;
width: 90px;
...
.t-l-c-businessMessage .businessMessage-t-text-0-7 {
position: absolute !important;
top: 444px;
left: 835px;
width: 269px;
...
.t-l-c-businessMessage .businessMessage-t-text-0-8 {
position: absolute !important;
top: 484px;
left: 741px;
width: 90px;
...
.t-l-c-businessMessage .businessMessage-t-text-0-9 {
position: absolute !important;
top: 524px;
left: 742px;
width: 90px;
...
.t-l-c-businessMessage .businessMessage-t-text-0-10 {
position: absolute !important;
top: 564px;
left: 740px;
width: 90px;
...
.t-l-c-businessMessage .businessMessage-t-text-0-11 {
position: absolute !important;
top: 484px;
left: 835px;
width: 269px;
...
.t-l-c-businessMessage .businessMessage-t-text-0-12 {
position: absolute !important;
top: 524px;
left: 835px;
width: 269px;
...
.t-l-c-businessMessage .businessMessage-t-text-0-13 {
position: absolute !important;
top: 564px;
left: 835px;
width: 269px;
...
.t-l-c-businessMessage .businessMessage-t-text-0-14 {
position: absolute !important;
top: 351px;
left: 735px;
width: 344px;

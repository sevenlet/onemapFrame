<template>
  <div id="t-l-c-kkOverviewSite" class="t-l-c-kkOverviewSite" ><t-rect id="t-rect-4367.90eb8e485" class="kkOverviewSite-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle"></t-rect><t-text id="t-text-76c9.204328df1" class="kkOverviewSite-t-text-0-1"  :label="tTextx0x1ComputedData.label" :editable="tTextx0x1ComputedData.editable" :c-style="tTextx0x1ComputedData.cStyle"></t-text><t-text id="t-text-1a48.32758ea27" class="kkOverviewSite-t-text-0-2"  :label="tTextx0x2ComputedData.label" :editable="tTextx0x2ComputedData.editable" :c-style="tTextx0x2ComputedData.cStyle"></t-text><t-rect id="t-rect-2b91.483820738" class="kkOverviewSite-t-rect-0-3"  :tip="tRectx0x3ComputedData.tip" :label="tRectx0x3ComputedData.label" :active="tRectx0x3ComputedData.active" :c-style="tRectx0x3ComputedData.cStyle"></t-rect><t-text id="t-text-091a.f0c3d838c" class="kkOverviewSite-t-text-0-4"  :label="tTextx0x4ComputedData.label" :editable="tTextx0x4ComputedData.editable" :c-style="tTextx0x4ComputedData.cStyle"></t-text><t-rect id="t-rect-ad7d.bd1fec294" class="kkOverviewSite-t-rect-0-5"  :tip="tRectx0x5ComputedData.tip" :label="tRectx0x5ComputedData.label" :active="tRectx0x5ComputedData.active" :c-style="tRectx0x5ComputedData.cStyle" @click="onclick1747891159980"></t-rect><t-text id="t-text-860b.3d2e575fc" class="kkOverviewSite-t-text-0-6"  :label="replaceCssVariables(state.total, global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x6ComputedData.editable" :c-style="tTextx0x6ComputedData.cStyle"></t-text><t-text id="t-text-3b2e.48261c674" class="kkOverviewSite-t-text-0-7"  :label="replaceCssVariables(state.kcTotal, global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x7ComputedData.editable" :c-style="tTextx0x7ComputedData.cStyle"></t-text><t-text id="t-text-ab5f.a6282b089" class="kkOverviewSite-t-text-0-8"  :label="tTextx0x8ComputedData.label" :editable="tTextx0x8ComputedData.editable" :c-style="tTextx0x8ComputedData.cStyle"></t-text><t-text id="t-text-5486.3aebc0a" class="kkOverviewSite-t-text-0-9"  :label="tTextx0x9ComputedData.label" :editable="tTextx0x9ComputedData.editable" :c-style="tTextx0x9ComputedData.cStyle"></t-text><t-text id="t-text-d45e.d49726fc9" class="kkOverviewSite-t-text-0-10"  :label="replaceCssVariables(state.ROAD_NAME, global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x10ComputedData.editable" :c-style="tTextx0x10ComputedData.cStyle"></t-text><t-text id="t-text-131a.df06390fb" class="kkOverviewSite-t-text-0-11"  :label="replaceCssVariables(state.hcTotal, global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x11ComputedData.editable" :c-style="tTextx0x11ComputedData.cStyle"></t-text><t-checkbox id="t-checkbox-a30f.90bffdf93" class="kkOverviewSite-t-checkbox-0-12"  :data="replaceCssVariables(state.filterTypeList, global?.theme || global?.activeTheme || '默认主题')" :active="replaceCssVariables(state.filterCarType, global?.theme || global?.activeTheme || '默认主题')" :data-alias="tCheckboxx0x12ComputedData.dataAlias" :border="tCheckboxx0x12ComputedData.border" :use-button="tCheckboxx0x12ComputedData.useButton" :c-style="tCheckboxx0x12ComputedData.cStyle" @change="onchange1747877382357"></t-checkbox><t-checkbox id="t-checkbox-ae01.36e75ea5" class="kkOverviewSite-t-checkbox-0-13"  :data="replaceCssVariables(state.emissionStandardList, global?.theme || global?.activeTheme || '默认主题')" :active="replaceCssVariables(state.emissionCarType, global?.theme || global?.activeTheme || '默认主题')" :data-alias="tCheckboxx0x13ComputedData.dataAlias" :border="tCheckboxx0x13ComputedData.border" :use-button="tCheckboxx0x13ComputedData.useButton" :c-style="tCheckboxx0x13ComputedData.cStyle" @change="onchange1747877413692"></t-checkbox><t-checkbox id="t-checkbox-5eae.314975d45" class="kkOverviewSite-t-checkbox-0-14"  :data="replaceCssVariables(state.localList, global?.theme || global?.activeTheme || '默认主题')" :active="replaceCssVariables(state.localCarType, global?.theme || global?.activeTheme || '默认主题')" :data-alias="tCheckboxx0x14ComputedData.dataAlias" :border="tCheckboxx0x14ComputedData.border" :use-button="tCheckboxx0x14ComputedData.useButton" :c-style="tCheckboxx0x14ComputedData.cStyle" @change="onchange1747877440925"></t-checkbox><t-tabs-base id="t-tabs-base-e086.575c0b576" class="kkOverviewSite-t-tabs-base-0-15"  :data="tTabsBasex0x15ComputedData.data" :space="tTabsBasex0x15ComputedData.space" :selected-tab-val="replaceCssVariables(state.timeType, global?.theme || global?.activeTheme || '默认主题')" :inner-shadow-color="tTabsBasex0x15ComputedData.innerShadowColor" :active-inner-shadow-color="tTabsBasex0x15ComputedData.activeInnerShadowColor" :alias="tTabsBasex0x15ComputedData.alias" :c-style="tTabsBasex0x15ComputedData.cStyle" @tab-click="ontabClick1747887738768"></t-tabs-base><t-chart-design v-if="state.isShow === true" id="t-chart-design-dc03.7baf51c1c" class="kkOverviewSite-t-chart-design-0-16"  :empty-img="tChartDesignx0x16ComputedData.emptyImg" :c-style="tChartDesignx0x16ComputedData.cStyle" :options="replaceCssVariables(state.options, global?.theme || global?.activeTheme || '默认主题')"></t-chart-design><t-text id="t-text-1d05.37ad2604b" class="kkOverviewSite-t-text-0-17"  :label="tTextx0x17ComputedData.label" :editable="tTextx0x17ComputedData.editable" :c-style="tTextx0x17ComputedData.cStyle"></t-text><t-text id="t-text-db7d.7e53b2fe9" class="kkOverviewSite-t-text-0-18"  :label="tTextx0x18ComputedData.label" :editable="tTextx0x18ComputedData.editable" :c-style="tTextx0x18ComputedData.cStyle"></t-text><t-text id="t-text-5973.c53e17df9" class="kkOverviewSite-t-text-0-19"  :label="tTextx0x19ComputedData.label" :editable="tTextx0x19ComputedData.editable" :c-style="tTextx0x19ComputedData.cStyle"></t-text></div>
</template>
...
import { TChartDesign, TCheckbox, TRect, TTabsBase, TText } from '@ths/design';
...
.t-l-c-kkOverviewSite .kkOverviewSite-t-rect-0-0 {
...
.t-l-c-kkOverviewSite .kkOverviewSite-t-text-0-1 {
position: absolute !important;
top: 263px;
left: 492px;
width: 120px;
...
.t-l-c-kkOverviewSite .kkOverviewSite-t-text-0-2 {
position: absolute !important;
top: 300px;
left: 492px;
width: 120px;
...
.t-l-c-kkOverviewSite .kkOverviewSite-t-rect-0-3 {
position: absolute !important;
top: 197px;
left: 468px;
width: 1000px;
...
.t-l-c-kkOverviewSite .kkOverviewSite-t-text-0-4 {
position: absolute !important;
top: 211px;
left: 487px;
width: 194px;
...
.t-l-c-kkOverviewSite .kkOverviewSite-t-rect-0-5 {
position: absolute !important;
top: 208px;
left: 1420px;
width: 24px;
...
.t-l-c-kkOverviewSite .kkOverviewSite-t-text-0-6 {
position: absolute !important;
top: 263px;
left: 1093px;
width: 355px;
...
.t-l-c-kkOverviewSite .kkOverviewSite-t-text-0-7 {
position: absolute !important;
top: 300px;
left: 1093px;
width: 355px;
...
.t-l-c-kkOverviewSite .kkOverviewSite-t-text-0-8 {
position: absolute !important;
top: 263px;
left: 971px;
width: 120px;
...
.t-l-c-kkOverviewSite .kkOverviewSite-t-text-0-9 {
position: absolute !important;
top: 300px;
left: 971px;
width: 120px;
...
.t-l-c-kkOverviewSite .kkOverviewSite-t-text-0-10 {
position: absolute !important;
top: 263px;
left: 614px;
width: 355px;
...
.t-l-c-kkOverviewSite .kkOverviewSite-t-text-0-11 {
position: absolute !important;
top: 300px;
left: 614px;
width: 355px;
...
.t-l-c-kkOverviewSite .kkOverviewSite-t-checkbox-0-12 {
position: absolute !important;
top: 350px;
left: 562px;
width: 952px;
...
.t-l-c-kkOverviewSite .kkOverviewSite-t-checkbox-0-13 {
position: absolute !important;
top: 382px;
left: 562px;
width: 955px;
...
.t-l-c-kkOverviewSite .kkOverviewSite-t-checkbox-0-14 {
position: absolute !important;
top: 416px;
left: 562px;
width: 954px;
...
.t-l-c-kkOverviewSite .kkOverviewSite-t-tabs-base-0-15 {
position: absolute !important;
top: 470px;
left: 492px;
width: 183px;
...
.t-l-c-kkOverviewSite .kkOverviewSite-t-chart-design-0-16 {
position: absolute !important;
top: 517px;
left: 494px;
width: 954px;
...
.t-l-c-kkOverviewSite .kkOverviewSite-t-text-0-17 {
position: absolute !important;
top: 350px;
left: 512px;
width: 62px;
...
.t-l-c-kkOverviewSite .kkOverviewSite-t-text-0-18 {
position: absolute !important;
top: 382px;
left: 480px;
width: 96px;
...
.t-l-c-kkOverviewSite .kkOverviewSite-t-text-0-19 {
position: absolute !important;
top: 416px;
left: 496px;
width: 96px;

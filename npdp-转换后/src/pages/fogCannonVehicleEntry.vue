...
const state = reactive({
   screenSize: "",
   componentName: "fogCannonVehicleContentComponent",
});
// 选中的图表主题
...
name:"fogCannonVehicleContentComponent",
loading:true,
...
if (tabValue !== state.tabSelect) {
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-fogCannonVehicleEntry', global.appScaleMode, 'normal');
...
handleWindowResize();
/* 接收socket.io消息 */
const onSocketChange471395e7a975439f88c2 = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChange471395e7a975439f88c2);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChange471395e7a975439f88c2);
});
/* 接收socket.io消息 */
const onSocketChange94427f373a2d46689d99 = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChange94427f373a2d46689d99);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChange94427f373a2d46689d99);
});
/* 接收socket.io消息 */
const onSocketChange42109d937891429c902b = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChange42109d937891429c902b);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChange42109d937891429c902b);
});
/* 接收socket.io消息 */
const onSocketChangec37cfc58b51b46c980ec = function (data) {
if(data.type === "closeTrajectoryWaterSprinkler"){
try{
// 设置变量值
state.componentName = 'fogCannonVehicleContentComponent';
} catch (error) {
console.error('参数格式错误', error);
};
};
};rootData.rootOn('rootSocket:change', onSocketChangec37cfc58b51b46c980ec);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChangec37cfc58b51b46c980ec);
});
});
// 页面离开时的操作
onUnmounted(() => {
...
.t-l-c-fogCannonVehicleEntry .fogCannonVehicleEntry-t-component-0-0 {

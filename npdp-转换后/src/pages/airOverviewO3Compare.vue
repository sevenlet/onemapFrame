<template>
  <div id="t-l-c-airOverviewO3Compare" class="t-l-c-airOverviewO3Compare" ><t-rect id="t-rect-2325.79ce94973" class="airOverviewO3Compare-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle"></t-rect><t-rect id="t-rect-4161.9bd54c05e" class="airOverviewO3Compare-t-rect-0-1"  :tip="tRectx0x1ComputedData.tip" :label="tRectx0x1ComputedData.label" :active="tRectx0x1ComputedData.active" :c-style="tRectx0x1ComputedData.cStyle"></t-rect><t-text id="t-text-ad67.771b51625" class="airOverviewO3Compare-t-text-0-2"  :label="state.pageTitle" :editable="tTextx0x2ComputedData.editable" :c-style="tTextx0x2ComputedData.cStyle"></t-text><t-rect id="t-rect-c2b5.7e5d67c97" class="airOverviewO3Compare-t-rect-0-3"  :tip="tRectx0x3ComputedData.tip" :label="tRectx0x3ComputedData.label" :active="tRectx0x3ComputedData.active" :c-style="tRectx0x3ComputedData.cStyle" @click="onclick1734493046811"></t-rect><t-table id="t-table-10d3.6d8162774" class="airOverviewO3Compare-t-table-0-4"  :height="tTablex0x4ComputedData.height" :stripe="tTablex0x4ComputedData.stripe" :border="tTablex0x4ComputedData.border" :auto-scroll="tTablex0x4ComputedData.autoScroll" :speed="tTablex0x4ComputedData.speed" :show-animation="tTablex0x4ComputedData.showAnimation" :animation-delay="tTablex0x4ComputedData.animationDelay" :animation-type="tTablex0x4ComputedData.animationType" :columns="tTablex0x4ComputedData.columns" :data="state.fusionList" :default-sort="tTablex0x4ComputedData.defaultSort" :c-style="tTablex0x4ComputedData.cStyle" :columns-raw="tTablex0x4ComputedData.columnsRaw"></t-table><t-chart-design id="t-chart-design-f418.ba00e877" class="airOverviewO3Compare-t-chart-design-0-5"  :empty-img="tChartDesignx0x5ComputedData.emptyImg" :c-style="tChartDesignx0x5ComputedData.cStyle" :options="state.options"></t-chart-design></div>
</template>
...
import { TChartDesign, TRect, TTable, TText } from '@ths/design';
...
.t-l-c-airOverviewO3Compare .airOverviewO3Compare-t-rect-0-0 {
...
.t-l-c-airOverviewO3Compare .airOverviewO3Compare-t-rect-0-1 {
position: absolute !important;
top: 184px;
left: 460px;
width: 1000px;
...
.t-l-c-airOverviewO3Compare .airOverviewO3Compare-t-text-0-2 {
position: absolute !important;
top: 198px;
left: 479px;
width: 194px;
...
.t-l-c-airOverviewO3Compare .airOverviewO3Compare-t-rect-0-3 {
position: absolute !important;
top: 195px;
left: 1412px;
width: 24px;
...
.t-l-c-airOverviewO3Compare .airOverviewO3Compare-t-table-0-4 {
position: absolute !important;
top: 636px;
left: 482px;
width: 960px;
...
.t-l-c-airOverviewO3Compare .airOverviewO3Compare-t-chart-design-0-5 {
position: absolute !important;
top: 245px;
left: 484px;
width: 957px;

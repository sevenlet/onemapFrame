<template>
  <div id="t-l-c-airOverviewExceededTitle" class="t-l-c-airOverviewExceededTitle" ><t-component id="t-component-1d7c.95d3bb6e8" class="airOverviewExceededTitle-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName"></t-component><t-text-unit id="t-text-unit-649d.5ded94ee6" class="airOverviewExceededTitle-t-text-unit-0-1"  :c-style="tTextUnitx0x1ComputedData.cStyle" :justify="tTextUnitx0x1ComputedData.justify" :align="tTextUnitx0x1ComputedData.align" :content="replaceCssVariables(filterData(global.regionaQuery.businessRegionName, componentPropBindingMap?.['t-text-unit-649d.5ded94ee6']['content'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :unit="tTextUnitx0x1ComputedData.unit" :show-overflow-tooltip="tTextUnitx0x1ComputedData.showOverflowTooltip"></t-text-unit></div>
</template>
...
export default {
  ...
  setup() {
const componentPropBindingMap = {"body":{"attributeName":"tBodyx0x0"},"t-component-1d7c.95d3bb6e8":{"attributeName":"tComponentx0x0","name":{"filters":[]},"cStyle":{"filters":[]},"src":{"filters":[]},"componentName":{"filters":[]}},"t-text-unit-649d.5ded94ee6":{"attributeName":"tTextUnitx0x1","cStyle":{"filters":[]},"justify":{"filters":[]},"align":{"filters":[]},"content":{"filters":[]},"unit":{"filters":[]},"showOverflowTooltip":{"filters":[]}}};
// 页面内注入全局变量和事件
...
tComponentx0x0: {
defaultStyle: {
            default: {"width":"410px","height":"32px","margin":"0 auto","backgroundColor":"","position":"unset","left":"0px","top":"0px"},
            
            },
 default: { 
 
name:"titleFirstBgComponent",
cStyle:{"wrapper":{"default":{"width":"410px","height":"32px","margin":"0 auto","backgroundColor":"","position":"unset","left":"0px","top":"0px"}}},
...
showOverflowTooltip:true, 
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-airOverviewExceededTitle', global.appScaleMode, 'normal');
...
<style scoped>
.t-l-c-airOverviewExceededTitle {
position: relative;
overflow: hidden;
...
.t-l-c-airOverviewExceededTitle .airOverviewExceededTitle-t-component-0-0 {
...
.t-l-c-airOverviewExceededTitle .airOverviewExceededTitle-t-text-unit-0-1 {
position: absolute !important;
top: 1px;
left: 34px;
width: 249px;

<template>
  <div id="t-l-c-weatherContent" class="t-l-c-weatherContent" ><t-component id="t-component-431e.6d9b9424" class="weatherContent-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName"></t-component><t-text-unit id="t-text-unit-e1da.8307f91c7" class="weatherContent-t-text-unit-0-1"  :c-style="tTextUnitx0x1ComputedData.cStyle" :justify="tTextUnitx0x1ComputedData.justify" :align="tTextUnitx0x1ComputedData.align" :content="tTextUnitx0x1ComputedData.content" :unit="tTextUnitx0x1ComputedData.unit" :show-overflow-tooltip="tTextUnitx0x1ComputedData.showOverflowTooltip"></t-text-unit><t-component id="t-component-f869.e7ce2b41a" class="weatherContent-t-component-0-2"  :name="tComponentx0x2ComputedData.name" :c-style="tComponentx0x2ComputedData.cStyle" :src="tComponentx0x2ComputedData.src" :component-name="tComponentx0x2ComputedData.componentName" :page-id="tComponentx0x2ComputedData.pageId" :page-code="tComponentx0x2ComputedData.pageCode"></t-component></div>
</template>
...
export default {
  ...
  setup() {
const componentPropBindingMap = {"body":{"attributeName":"tBodyx0x0"},"t-component-431e.6d9b9424":{"attributeName":"tComponentx0x0","name":{"filters":[]},"cStyle":{"filters":[]},"src":{"filters":[]},"componentName":{"filters":[]}},"t-text-unit-e1da.8307f91c7":{"attributeName":"tTextUnitx0x1","cStyle":{"filters":[]},"justify":{"filters":[]},"align":{"filters":[]},"content":{"filters":[]},"unit":{"filters":[]},"showOverflowTooltip":{"filters":[]}},"t-component-f869.e7ce2b41a":{"attributeName":"tComponentx0x2","name":{"filters":[]},"cStyle":{"filters":[]},"src":{"filters":[]},"componentName":{"filters":[]},"pageId":{"filters":[]},"pageCode":{"filters":[]}}};
// 页面内注入全局变量和事件
...
tTextUnitx0x1: {
defaultStyle: {
            default: {"width":"261px","height":"20px","fontSize":"17px","fontFamily":"方正综艺","color":"var(--t-white)","position":"unset","left":"55px","top":"26px","lineHeight":"20px","animationName":""},
            
            },
 default: { 
 
cStyle:{"wrapper":{"default":{"width":"261px","height":"20px","fontSize":"17px","fontFamily":"方正综艺","color":"var(--t-white)","position":"unset","left":"55px","top":"26px","lineHeight":"20px","animationName":""}},"unit":{"default":{"fontSize":"17px","fontFamily":"方正综艺","lineHeight":"20px"}},"text":{"default":{"lineHeight":"20px","fontSize":"var(--business-text-size-18)"}}},
justify:"flex-start",
align:"flex-end",
content:"气象站点位",
unit:"",
...
tComponentx0x2: {
defaultStyle: {
            default: {"width":"410px","height":"795px","margin":"0 auto","backgroundColor":"rgba(255, 255, 255, 0)","position":"unset","left":"20px","top":"68px","animationName":""},
            
            },
 default: { 
 
name:"weatherListComponent",
cStyle:{"wrapper":{"default":{"width":"410px","height":"795px","margin":"0 auto","backgroundColor":"rgba(255, 255, 255, 0)","position":"unset","left":"20px","top":"68px","animationName":""}}},
src:"/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/index.html#/weatherList",
componentName:"weatherListComponent",
pageId:"ff8b416537ca4577ae031b276eced26a",
pageCode:"weatherList", 
 },
},
});
...
if (head.statusCode === '200' && data) {
  let endTime = data.max_start_time_str
  let startTime = getTwoDaysBefore(endTime)
...
deep: true, // 深度监听
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-weatherContent', global.appScaleMode, 'normal');
...
.t-l-c-weatherContent .weatherContent-t-component-0-0 {
...
.t-l-c-weatherContent .weatherContent-t-text-unit-0-1 {
position: absolute !important;
top: 26px;
left: 55px;
width: 261px;
...
.t-l-c-weatherContent .weatherContent-t-component-0-2 {
position: absolute !important;
top: 68px;
left: 20px;
width: 410px;

<template>
  <div id="t-l-c-waterMonitorData" class="t-l-c-waterMonitorData" ><t-select id="t-select-a052.47dcf777b" class="waterMonitorData-t-select-0-0"  :active-value="replaceCssVariables(state.pollutor, global?.theme || global?.activeTheme || '默认主题')" :options="replaceCssVariables(state.pollutorList, global?.theme || global?.activeTheme || '默认主题')" :alias="tSelectx0x0ComputedData.alias" :multiple="tSelectx0x0ComputedData.multiple" :placeholder="tSelectx0x0ComputedData.placeholder" :clearable="tSelectx0x0ComputedData.clearable" :disabled="tSelectx0x0ComputedData.disabled" :name="tSelectx0x0ComputedData.name" :autocomplete="tSelectx0x0ComputedData.autocomplete" :filterable="tSelectx0x0ComputedData.filterable" :no-match-text="tSelectx0x0ComputedData.no-match-text" :no-data-text="tSelectx0x0ComputedData.no-data-text" :c-style="tSelectx0x0ComputedData.cStyle" @change="onchange1752199484126"></t-select><t-select id="t-select-f260.869d89e5b" class="waterMonitorData-t-select-0-1"  :active-value="replaceCssVariables(state.station, global?.theme || global?.activeTheme || '默认主题')" :options="replaceCssVariables(state.stationList, global?.theme || global?.activeTheme || '默认主题')" :alias="tSelectx0x1ComputedData.alias" :multiple="tSelectx0x1ComputedData.multiple" :placeholder="tSelectx0x1ComputedData.placeholder" :clearable="tSelectx0x1ComputedData.clearable" :disabled="tSelectx0x1ComputedData.disabled" :name="tSelectx0x1ComputedData.name" :autocomplete="tSelectx0x1ComputedData.autocomplete" :filterable="tSelectx0x1ComputedData.filterable" :no-match-text="tSelectx0x1ComputedData.no-match-text" :no-data-text="tSelectx0x1ComputedData.no-data-text" :c-style="tSelectx0x1ComputedData.cStyle" @change="onchange1752199392191"></t-select><t-date-picker id="t-date-picker-1b48.e892f401e" class="waterMonitorData-t-date-picker-0-2"  :placeholder="tDatePickerx0x2ComputedData.placeholder" :start-placeholder="tDatePickerx0x2ComputedData.startPlaceholder" :end-placeholder="tDatePickerx0x2ComputedData.endPlaceholder" :type="tDatePickerx0x2ComputedData.type" :clearable="tDatePickerx0x2ComputedData.clearable" :range-separator="tDatePickerx0x2ComputedData.rangeSeparator" :default-date="replaceCssVariables(state.monitorTime, global?.theme || global?.activeTheme || '默认主题')" :separator="tDatePickerx0x2ComputedData.separator" :readonly="tDatePickerx0x2ComputedData.readonly" :editable="tDatePickerx0x2ComputedData.editable" :c-style="tDatePickerx0x2ComputedData.cStyle" @date-change="ondateChange1752199526758"></t-date-picker><t-text id="t-text-f339.46f7d45c5" class="waterMonitorData-t-text-0-3"  :label="tTextx0x3ComputedData.label" :editable="tTextx0x3ComputedData.editable" :c-style="tTextx0x3ComputedData.cStyle"></t-text><t-text id="t-text-f5e3.e386f76d9" class="waterMonitorData-t-text-0-4"  :label="tTextx0x4ComputedData.label" :editable="tTextx0x4ComputedData.editable" :c-style="tTextx0x4ComputedData.cStyle"></t-text><t-chart-curve id="t-chart-curve-1f74.64749a6bd" class="waterMonitorData-t-chart-curve-0-5"  :empty-img="tChartCurvex0x5ComputedData.emptyImg" :series-setting="tChartCurvex0x5ComputedData.seriesSetting" :data="replaceCssVariables(state.lineData, global?.theme || global?.activeTheme || '默认主题')" :options="tChartCurvex0x5ComputedData.options" :c-style="tChartCurvex0x5ComputedData.cStyle" :y-axis-left-options="tChartCurvex0x5ComputedData.yAxisLeftOptions" :y-axis-right-options="tChartCurvex0x5ComputedData.yAxisRightOptions" :line="componentState.tChartCurvex0x5.line"></t-chart-curve><t-text id="t-text-ee43.3a6e69413" class="waterMonitorData-t-text-0-6"  :label="replaceCssVariables(state.unit, global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x6ComputedData.editable" :c-style="tTextx0x6ComputedData.cStyle"></t-text></div>
</template>
...
import { TChartCurve, TDatePicker, TSelect, TText } from '@ths/design';
...
if (res?.data?.head?.statusCode === '200' && res?.data?.data) {
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-waterMonitorData', global.appScaleMode, 'normal');
...
.t-l-c-waterMonitorData .waterMonitorData-t-select-0-0 {
...
.t-l-c-waterMonitorData .waterMonitorData-t-select-0-1 {
position: absolute !important;
top: 0px;
left: 67px;
width: 161px;
...
.t-l-c-waterMonitorData .waterMonitorData-t-date-picker-0-2 {
position: absolute !important;
top: 0px;
left: 510px;
width: 278px;
...
.t-l-c-waterMonitorData .waterMonitorData-t-text-0-3 {
position: absolute !important;
top: 10px;
left: -1px;
width: 96px;
...
.t-l-c-waterMonitorData .waterMonitorData-t-text-0-4 {
position: absolute !important;
top: 9px;
left: 244px;
width: 122px;
...
.t-l-c-waterMonitorData .waterMonitorData-t-chart-curve-0-5 {
position: absolute !important;
top: 51px;
left: 1px;
width: 788px;
...
.t-l-c-waterMonitorData .waterMonitorData-t-text-0-6 {
position: absolute !important;
top: 61px;
left: 37px;
width: 85px;

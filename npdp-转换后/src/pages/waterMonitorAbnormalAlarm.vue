<template>
  <div id="t-l-c-waterMonitorAbnormalAlarm" class="t-l-c-waterMonitorAbnormalAlarm" ><t-rect id="t-rect-8252.1a4ade4f4" class="waterMonitorAbnormalAlarm-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle"></t-rect><t-table id="t-table-1f2f.98c8ca619" class="waterMonitorAbnormalAlarm-t-table-0-1"  :height="tTablex0x1ComputedData.height" :stripe="tTablex0x1ComputedData.stripe" :border="tTablex0x1ComputedData.border" :auto-scroll="tTablex0x1ComputedData.autoScroll" :speed="tTablex0x1ComputedData.speed" :columns="tTablex0x1ComputedData.columns" :data="tTablex0x1ComputedData.data" :default-sort="tTablex0x1ComputedData.defaultSort" :c-style="tTablex0x1ComputedData.cStyle" @cell-click="oncellClick1734079023244"></t-table><t-rect id="t-rect-e3a7.d7772ec8d" class="waterMonitorAbnormalAlarm-t-rect-0-2"  :tip="tRectx0x2ComputedData.tip" :label="tRectx0x2ComputedData.label" :active="tRectx0x2ComputedData.active" :c-style="tRectx0x2ComputedData.cStyle"></t-rect><t-text id="t-text-8cba.b16affff7" class="waterMonitorAbnormalAlarm-t-text-0-3"  :label="tTextx0x3ComputedData.label" :editable="tTextx0x3ComputedData.editable" :c-style="tTextx0x3ComputedData.cStyle"></t-text><t-rect id="t-rect-da62.857f90ab" class="waterMonitorAbnormalAlarm-t-rect-0-4"  :tip="tRectx0x4ComputedData.tip" :label="tRectx0x4ComputedData.label" :active="tRectx0x4ComputedData.active" :c-style="tRectx0x4ComputedData.cStyle" @click="onclick1733817210174"></t-rect></div>
</template>
...
label:"",
active:false,
cStyle:{"wrapper":{"default":{"width":"620px","height":"355px","position":"unset","left":"0px","top":"0px","backgroundColor":"var(--business-dialog-bg)","borderTopLeftRadius":"16px","borderTopRightRadius":"16px","borderBottomLeftRadius":"16px","borderBottomRightRadius":"16px","borderLeft":"1px solid var(--business-show-bg60)","borderTop":"1px solid var(--business-show-bg60)","borderRight":"1px solid var(--business-show-bg60)","borderBottom":"1px solid var(--business-show-bg60)","animationName":""}}}, 
 },
},
tTablex0x1: {
defaultStyle: {
            default: {"width":"580px","height":"276px","position":"unset","left":"20px","top":"63px","paddingTop":"0px","borderBottom":"0px solid ","animationName":"","--el-text-color-secondary":"var(--business-show-bg60)"},
...
label:"",
active:false,
cStyle:{"wrapper":{"default":{"width":"620px","height":"47.01035523217572px","backgroundColor":"var(--business-show-bg30)","borderTopLeftRadius":"16px","borderTopRightRadius":"16px","borderLeft":"1px none rgb(23,62,228)","borderTop":"1px none rgb(23,62,228)","borderRight":"1px none rgb(23,62,228)","borderBottom":"1px solid var(--business-show-bg60)","position":"unset","left":"0px","top":"0px","animationName":""}}}, 
 },
},
tTextx0x3: {
defaultStyle: {
...
// 点击定位给地图发消息
if (["定位", '断面名称', '水体名称', '水质目标', '预警污染物'].includes(column.label)) {
  /* 发送消息 */
...
const oncellClick1734079023244 = (row,column,cell,event) => {
// 执行自定义方法
...
// 接口函数
 getWaringList: {
              ...
              config: {"url":"global.serviceBasePath","method":"get","baseURL":"global.foshanServiceBaseUrl","params":{"AREA CODE":"global.regionaQuery.areaCode","CODE_WQDATASOURCETYPE":"state.CODE_WQDATASOURCETYPE","WSYSTEM_CODE":"global.regionaQuery.areaCode","MONITORTYPE":"state.MONITORTYPE","CODE_CONTROLLEVEL":"state.CODE_CONTROLLEVEL","IS_CONNECT_SECTION":"state.IS_CONNECT_SECTION","REGION_CODE":"global.regionaQuery.regionCode","MONITORTIME":"state.MONITORTIME","interfaceId":"87d0b13b181de13aa2ad2f169b764ff4"}},
              request: function ( componentId) {
return new Promise((resolve, reject) => {
  
                http({"url":global.serviceBasePath,"method":"get","baseURL":global.foshanServiceBaseUrl,"params":{"AREA CODE":global.regionaQuery.areaCode,"CODE_WQDATASOURCETYPE":state.CODE_WQDATASOURCETYPE,"WSYSTEM_CODE":global.regionaQuery.areaCode,"MONITORTYPE":state.MONITORTYPE,"CODE_CONTROLLEVEL":state.CODE_CONTROLLEVEL,"IS_CONNECT_SECTION":state.IS_CONNECT_SECTION,"REGION_CODE":global.regionaQuery.regionCode,"MONITORTIME":state.MONITORTIME,"interfaceId":"87d0b13b181de13aa2ad2f169b764ff4"},}).then((res) => {
 
                   // 成功的操作
                   const cacheKey = generateCacheKey('global.foshanServiceBaseUrl-global.serviceBasePath',  {"AREA CODE":global.regionaQuery.areaCode,"CODE_WQDATASOURCETYPE":state.CODE_WQDATASOURCETYPE,"WSYSTEM_CODE":global.regionaQuery.areaCode,"MONITORTYPE":state.MONITORTYPE,"CODE_CONTROLLEVEL":state.CODE_CONTROLLEVEL,"IS_CONNECT_SECTION":state.IS_CONNECT_SECTION,"REGION_CODE":global.regionaQuery.regionCode,"MONITORTIME":state.MONITORTIME,"interfaceId":"87d0b13b181de13aa2ad2f169b764ff4"});
                   
                   apiDataMap[cacheKey] = res.data;
                   apiDataMap['getWaringList'] = res.data;
                
     if (res?.data?.head?.statusCode === '200' && res?.data?.data) {
  console.log(res, '水弹窗-监测异常报警-列表数据')
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-waterMonitorAbnormalAlarm', global.appScaleMode, 'normal');
...
<style scoped>
.t-l-c-waterMonitorAbnormalAlarm {
position: relative;
overflow: hidden;
...
.t-l-c-waterMonitorAbnormalAlarm .waterMonitorAbnormalAlarm-t-rect-0-0 {
...
.t-l-c-waterMonitorAbnormalAlarm .waterMonitorAbnormalAlarm-t-table-0-1 {
position: absolute !important;
top: 63px;
left: 20px;
width: 580px;
...
.t-l-c-waterMonitorAbnormalAlarm .waterMonitorAbnormalAlarm-t-rect-0-2 {
position: absolute !important;
top: 0px;
left: 0px;
width: 620px;
height: 47.01035523217572px;
pointer-events: auto;
}

.t-l-c-waterMonitorAbnormalAlarm .waterMonitorAbnormalAlarm-t-text-0-3 {
position: absolute !important;
top: 13px;
left: 24px;
width: 314px;
...
.t-l-c-waterMonitorAbnormalAlarm .waterMonitorAbnormalAlarm-t-rect-0-4 {
position: absolute !important;
top: 10px;
left: 565px;
width: 24px;

<template>
  <div id="t-l-c-waterSprinklerTruckDialogTitle" class="t-l-c-waterSprinklerTruckDialogTitle" ><t-row id="t-row-a9c1.ffb0f3adb" class="waterSprinklerTruckDialogTitle-t-row-0-0"  :c-style="tRowx0x0ComputedData.cStyle" :gutter="tRowx0x0ComputedData.gutter" :justify="tRowx0x0ComputedData.justify" :align="tRowx0x0ComputedData.align"><t-text-common id="t-text-common-ebb5.079f4d7f8" class="waterSprinklerTruckDialogTitle-t-text-common-0-0-0"  :label="tTextCommonx0x0x0ComputedData.label" :editable="tTextCommonx0x0x0ComputedData.editable" :c-style="tTextCommonx0x0x0ComputedData.cStyle"></t-text-common><t-rect id="t-rect-5ddd.c09e8a3a4" class="waterSprinklerTruckDialogTitle-t-rect-0-0-1"  :tip="tRectx0x0x1ComputedData.tip" :label="tRectx0x0x1ComputedData.label" :active="tRectx0x0x1ComputedData.active" :c-style="tRectx0x0x1ComputedData.cStyle"></t-rect></t-row></div>
</template>
...
<style scoped>
.t-l-c-waterSprinklerTruckDialogTitle {
position: relative;
overflow: hidden;
...
.t-l-c-waterSprinklerTruckDialogTitle .waterSprinklerTruckDialogTitle-t-row-0-0 {
...
.t-l-c-waterSprinklerTruckDialogTitle .waterSprinklerTruckDialogTitle-t-text-common-0-0-0 {
position: unset;
top: 207px;
left: 375px;
width: auto;
...
.t-l-c-waterSprinklerTruckDialogTitle .waterSprinklerTruckDialogTitle-t-rect-0-0-1 {
position: unset;
top: 205px;
left: 505px;
width: 60px;

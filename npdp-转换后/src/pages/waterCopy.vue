<template>
  <div id="t-l-c-waterCopy" class="t-l-c-waterCopy" ><t-component id="t-component-d7a5.0f0c30eaf" class="waterCopy-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName"></t-component><t-text id="t-text-dde9.205bbc868" class="waterCopy-t-text-0-1"  :label="tTextx0x1ComputedData.label" :editable="tTextx0x1ComputedData.editable" :c-style="tTextx0x1ComputedData.cStyle"></t-text><t-row id="t-row-500b.8a4282c55" class="waterCopy-t-row-0-2"  :c-style="tRowx0x2ComputedData.cStyle" :gutter="tRowx0x2ComputedData.gutter" :justify="tRowx0x2ComputedData.justify" :align="tRowx0x2ComputedData.align"><t-text id="t-text-1bbc.292a467e2" class="waterCopy-t-text-0-2-0"  :label="tTextx0x2x0ComputedData.label" :editable="tTextx0x2x0ComputedData.editable" :c-style="tTextx0x2x0ComputedData.cStyle" @click="onclick1733723979280"></t-text><t-text id="t-text-5001.13952ab12" class="waterCopy-t-text-0-2-1"  :label="replaceCssVariables(state.headerInfo.POINT_NAME, global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x2x1ComputedData.editable" :c-style="tTextx0x2x1ComputedData.cStyle" :show-title="tTextx0x2x1ComputedData.showTitle"></t-text><t-text id="t-text-8f83.4cdb67f43" class="waterCopy-t-text-0-2-2"  :label="replaceCssVariables(state.headerInfo.type, global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x2x2ComputedData.editable" :c-style="tTextx0x2x2ComputedData.cStyle"></t-text><t-list-card-common id="t-list-card-common-b400.91fe9d2ff" class="waterCopy-t-list-card-common-0-2-3"  :c-style="tListCardCommonx0x2x3ComputedData.cStyle" :key-word="tListCardCommonx0x2x3ComputedData.keyWord" :default-checked="tListCardCommonx0x2x3ComputedData.defaultChecked" :tab="tListCardCommonx0x2x3ComputedData.tab" :collapse="tListCardCommonx0x2x3ComputedData.collapse" :collapse-text="tListCardCommonx0x2x3ComputedData.collapseText" :display-count="tListCardCommonx0x2x3ComputedData.displayCount" :data-alias="tListCardCommonx0x2x3ComputedData.dataAlias" :data="replaceCssVariables(state.headerInfo.WATERQUALITYLEVELNAME, global?.theme || global?.activeTheme || '默认主题')"></t-list-card-common><t-list-card-common id="t-list-card-common-ca3e.4acae3791" class="waterCopy-t-list-card-common-0-2-4"  :c-style="tListCardCommonx0x2x4ComputedData.cStyle" :key-word="tListCardCommonx0x2x4ComputedData.keyWord" :default-checked="tListCardCommonx0x2x4ComputedData.defaultChecked" :tab="tListCardCommonx0x2x4ComputedData.tab" :collapse="tListCardCommonx0x2x4ComputedData.collapse" :collapse-text="tListCardCommonx0x2x4ComputedData.collapseText" :display-count="tListCardCommonx0x2x4ComputedData.displayCount" :data-alias="tListCardCommonx0x2x4ComputedData.dataAlias" :data="replaceCssVariables(state.headerInfo.ISSTANDARDSSTR, global?.theme || global?.activeTheme || '默认主题')"></t-list-card-common><t-rect v-if="state.headerInfo.isShowAlarm === true" id="t-rect-5459.0054cfc89" class="waterCopy-t-rect-0-2-5"  :tip="tRectx0x2x5ComputedData.tip" :label="tRectx0x2x5ComputedData.label" :active="tRectx0x2x5ComputedData.active" :c-style="tRectx0x2x5ComputedData.cStyle"></t-rect></t-row><t-component id="t-component-31d3.24b651f58" class="waterCopy-t-component-0-3"  :name="tComponentx0x3ComputedData.name" :c-style="tComponentx0x3ComputedData.cStyle" :src="tComponentx0x3ComputedData.src" :component-name="tComponentx0x3ComputedData.componentName"></t-component><t-text id="t-text-1389.f99ff2c66" class="waterCopy-t-text-0-4"  :label="tTextx0x4ComputedData.label" :editable="tTextx0x4ComputedData.editable" :c-style="tTextx0x4ComputedData.cStyle"></t-text><t-table id="t-table-c9d3.68c8cf75" class="waterCopy-t-table-0-5"  :height="tTablex0x5ComputedData.height" :stripe="tTablex0x5ComputedData.stripe" :border="tTablex0x5ComputedData.border" :auto-scroll="tTablex0x5ComputedData.autoScroll" :speed="tTablex0x5ComputedData.speed" :columns="tTablex0x5ComputedData.columns" :data="replaceCssVariables(state.alarmList, global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x5ComputedData.defaultSort" :c-style="tTablex0x5ComputedData.cStyle" @cell-click="oncellClick1734069105111_0_0"></t-table><t-rect id="t-rect-5e3b.5e9377bde" class="waterCopy-t-rect-0-7"  :tip="tRectx0x7ComputedData.tip" :label="tRectx0x7ComputedData.label" :active="tRectx0x7ComputedData.active" :c-style="tRectx0x7ComputedData.cStyle"></t-rect><t-row id="t-row-5cb6.6e0b481ac" class="waterCopy-t-row-0-8"  :c-style="tRowx0x8ComputedData.cStyle" :gutter="tRowx0x8ComputedData.gutter" :justify="tRowx0x8ComputedData.justify" :align="tRowx0x8ComputedData.align"><t-checkbox v-if="state.isShowWrwCheckbox === true" id="t-checkbox-daf6.bd71a4b8e" class="waterCopy-t-checkbox-0-8-0"  :data="replaceCssVariables(state.wrwCheckboxOpts, global?.theme || global?.activeTheme || '默认主题')" :active="replaceCssVariables(state.wrwCheckboxArr, global?.theme || global?.activeTheme || '默认主题')" :data-alias="tCheckboxx0x8x0ComputedData.dataAlias" :border="tCheckboxx0x8x0ComputedData.border" :use-button="tCheckboxx0x8x0ComputedData.useButton" :c-style="tCheckboxx0x8x0ComputedData.cStyle" @change="onchange1734069969885"></t-checkbox><t-col id="t-col-af70.186e3480e" class="waterCopy-t-col-0-8-1"  :span="tColx0x8x1ComputedData.span" :offset="tColx0x8x1ComputedData.offset" :push="tColx0x8x1ComputedData.push" :pull="tColx0x8x1ComputedData.pull" :c-style="tColx0x8x1ComputedData.cStyle"><t-text id="t-text-3ff6.322a2bcd3" class="waterCopy-t-text-0-8-1-0"  :label="tTextx0x8x1x0ComputedData.label" :editable="tTextx0x8x1x0ComputedData.editable" :c-style="tTextx0x8x1x0ComputedData.cStyle"></t-text><t-select id="t-select-19f7.ef514e3cb" class="waterCopy-t-select-0-8-1-1"  :active-value="replaceCssVariables(state.ENTERPRISE_TYPE, global?.theme || global?.activeTheme || '默认主题')" :options="replaceCssVariables(state.wryOpts, global?.theme || global?.activeTheme || '默认主题')" :alias="tSelectx0x8x1x1ComputedData.alias" :multiple="tSelectx0x8x1x1ComputedData.multiple" :placeholder="tSelectx0x8x1x1ComputedData.placeholder" :clearable="tSelectx0x8x1x1ComputedData.clearable" :disabled="tSelectx0x8x1x1ComputedData.disabled" :name="tSelectx0x8x1x1ComputedData.name" :autocomplete="tSelectx0x8x1x1ComputedData.autocomplete" :filterable="tSelectx0x8x1x1ComputedData.filterable" :no-match-text="tSelectx0x8x1x1ComputedData.no-match-text" :no-data-text="tSelectx0x8x1x1ComputedData.no-data-text" :c-style="tSelectx0x8x1x1ComputedData.cStyle" @change="onchange1733895446402_0_0"></t-select><t-text id="t-text-235f.2bb390b1f" class="waterCopy-t-text-0-8-1-2"  :label="tTextx0x8x1x2ComputedData.label" :editable="tTextx0x8x1x2ComputedData.editable" :c-style="tTextx0x8x1x2ComputedData.cStyle"></t-text><t-cascader id="t-cascader-8f0d.31e7e4925" class="waterCopy-t-cascader-0-8-1-3"  :active-value="replaceCssVariables(state.treeActive, global?.theme || global?.activeTheme || '默认主题')" :data="replaceCssVariables(state.treeData, global?.theme || global?.activeTheme || '默认主题')" :alias="tCascaderx0x8x1x3ComputedData.alias" :placeholder="tCascaderx0x8x1x3ComputedData.placeholder" :clearable="tCascaderx0x8x1x3ComputedData.clearable" :disabled="tCascaderx0x8x1x3ComputedData.disabled" :no-match-text="tCascaderx0x8x1x3ComputedData.noMatchText" :no-data-text="tCascaderx0x8x1x3ComputedData.noDataText" :c-style="tCascaderx0x8x1x3ComputedData.cStyle" :show-all-levels="tCascaderx0x8x1x3ComputedData.showAllLevels" :check-strictly="tCascaderx0x8x1x3ComputedData.checkStrictly" @change="onchange1734070589108_0_0" @clear="onclear1734590114522"></t-cascader><t-rect id="t-rect-4c01.2a8aec7e3" class="waterCopy-t-rect-0-8-1-4"  :tip="tRectx0x8x1x4ComputedData.tip" :label="tRectx0x8x1x4ComputedData.label" :active="tRectx0x8x1x4ComputedData.active" :c-style="tRectx0x8x1x4ComputedData.cStyle" @click="onclick1739514291790"></t-rect></t-col><t-radio v-if="state.isShowWrwCheckbox === true" id="t-radio-81f2.2342e33a3" class="waterCopy-t-radio-0-8-2"  :options="tRadiox0x8x2ComputedData.options" :active="replaceCssVariables(state.pageSize, global?.theme || global?.activeTheme || '默认主题')" :alias="tRadiox0x8x2ComputedData.alias" :disabled="tRadiox0x8x2ComputedData.disabled" :border="tRadiox0x8x2ComputedData.border" :size="tRadiox0x8x2ComputedData.size" :is-use-button="tRadiox0x8x2ComputedData.isUseButton" :c-style="tRadiox0x8x2ComputedData.cStyle" @change="onchange1734071747662"></t-radio><t-table id="t-table-0dc3.b83e1e06b" class="waterCopy-t-table-0-8-3"  :height="tTablex0x8x3ComputedData.height" :stripe="tTablex0x8x3ComputedData.stripe" :border="tTablex0x8x3ComputedData.border" :auto-scroll="tTablex0x8x3ComputedData.autoScroll" :speed="tTablex0x8x3ComputedData.speed" :columns="tTablex0x8x3ComputedData.columns" :data="replaceCssVariables(state.syList, global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x8x3ComputedData.defaultSort" :c-style="tTablex0x8x3ComputedData.cStyle" @cell-click="oncellClick1733886529707_0_0"></t-table></t-row></div>
</template>
...
import { TCascader, TCheckbox, TCol, TComponent, TListCardCommon, TRadio, TRect, TRow, TSelect, TTable, TText } from '@ths/design';
...
.t-l-c-waterCopy .waterCopy-t-component-0-0 {
...
.t-l-c-waterCopy .waterCopy-t-text-0-1 {
position: absolute !important;
top: 84px;
left: 60px;
width: 130px;
...
.t-l-c-waterCopy .waterCopy-t-row-0-2 {
position: absolute !important;
top: 9px;
left: 20px;
width: 419px;
...
.t-l-c-waterCopy .waterCopy-t-text-0-2-0 {
position: unset;
top: 18px;
left: 12px;
width: 43px;
...
.t-l-c-waterCopy .waterCopy-t-text-0-2-1 {
position: unset;
top: 205.12660047743043px;
left: 469.8092289677372px;
width: auto;
height: 21px;
pointer-events: auto;
}

.t-l-c-waterCopy .waterCopy-t-text-0-2-2 {
position: unset;
top: -106px;
left: 260px;
width: 40px;
...
.t-l-c-waterCopy .waterCopy-t-list-card-common-0-2-3 {
position: unset;
top: 207.12660047743043px;
left: 672.8092289677372px;
width: 50px;
height: 20px;
pointer-events: auto;
}

.t-l-c-waterCopy .waterCopy-t-list-card-common-0-2-4 {
position: unset;
top: 241px;
left: 634px;
width: 50px;
...
.t-l-c-waterCopy .waterCopy-t-rect-0-2-5 {
position: unset;
top: 206.12660047743043px;
left: 852.8092289677372px;
width: 20px;
height: 20px;
pointer-events: auto;
}

.t-l-c-waterCopy .waterCopy-t-component-0-3 {
position: absolute !important;
top: 239px;
left: 20px;
width: 410px;
...
.t-l-c-waterCopy .waterCopy-t-text-0-4 {
position: absolute !important;
top: 244px;
left: 60px;
width: 130px;
...
.t-l-c-waterCopy .waterCopy-t-table-0-5 {
position: absolute !important;
top: 124px;
left: 22px;
width: 409px;
...
.t-l-c-waterCopy .waterCopy-t-rect-0-7 {
position: absolute !important;
top: 60px;
left: 2px;
width: 450px;
...
.t-l-c-waterCopy .waterCopy-t-row-0-8 {
position: absolute !important;
top: 282px;
left: 20px;
width: 412px;
...
.t-l-c-waterCopy .waterCopy-t-checkbox-0-8-0 {
position: unset;
top: 281px;
left: 20px;
width: 413px;
...
.t-l-c-waterCopy .waterCopy-t-col-0-8-1 {
position: relative;
top: null;
left: null;
width: 100%;
...
.t-l-c-waterCopy .waterCopy-t-text-0-8-1-0 {
position: unset;
top: 319px;
left: 19px;
width: 100px;
...
.t-l-c-waterCopy .waterCopy-t-select-0-8-1-1 {
position: unset;
top: 311px;
left: 101px;
width: 105px;
...
.t-l-c-waterCopy .waterCopy-t-text-0-8-1-2 {
position: unset;
top: 319px;
left: 237px;
width: 100px;
...
.t-l-c-waterCopy .waterCopy-t-cascader-0-8-1-3 {
position: unset;
top: 311px;
left: 276px;
width: 116px;
...
.t-l-c-waterCopy .waterCopy-t-rect-0-8-1-4 {
position: unset;
top: 312px;
left: 609px;
width: 100px;
...
.t-l-c-waterCopy .waterCopy-t-radio-0-8-2 {
position: unset;
top: 356px;
left: 19px;
width: 302px;
...
.t-l-c-waterCopy .waterCopy-t-table-0-8-3 {
position: unset;
top: 390px;
left: 20px;
width: 409px;

...
return new Promise((resolve, reject) => {
  http({"url":global.serviceBasePath,"method":"get","baseURL":global.foshanServiceBaseUrl,"params":{"WATER_CODE":state.WATER_CODE,"BRANCH_NAME":"主要河道","WSYSTEM_CODE":state.WSYSTEM_CODE,"KEYWORD":state.name,"REGION_CODE":"","interfaceId":"faa5fa1f0985f82b86f045bff2bc1be4"},}).then((res) => {
     // 成功的操作
...
deep: true, // 深度监听
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-shjysGl', global.appScaleMode, 'normal');
...
.t-l-c-shjysGl .shjysGl-t-search-0-0 {
...
.t-l-c-shjysGl .shjysGl-t-button-0-1 {
position: absolute !important;
top: 0px;
left: 353px;
width: 49px;
...
.t-l-c-shjysGl .shjysGl-t-table-0-2 {
position: absolute !important;
top: 40px;
left: 8px;
width: 394px;

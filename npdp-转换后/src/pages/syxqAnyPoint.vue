<template>
  <div id="t-l-c-syxqAnyPoint" class="t-l-c-syxqAnyPoint" ><t-button id="t-button-8a7a.9a0bb49b5" class="syxqAnyPoint-t-button-0-0"  :label="tButtonx0x0ComputedData.label" :round="tButtonx0x0ComputedData.round" :plain="tButtonx0x0ComputedData.plain" :disabled="tButtonx0x0ComputedData.disabled" :type="tButtonx0x0ComputedData.type" :size="tButtonx0x0ComputedData.size" :native-type="tButtonx0x0ComputedData.native-type" :c-style="tButtonx0x0ComputedData.cStyle" @click="onclick1761117008297"></t-button><t-image-base id="t-image-base-cc01.3413a106e" class="syxqAnyPoint-t-image-base-0-1"  :src="tImageBasex0x1ComputedData.src" :fit="tImageBasex0x1ComputedData.fit" :c-style="tImageBasex0x1ComputedData.cStyle"></t-image-base><t-list-card v-if="state.activeTab.value !== ''" id="t-list-card-2d95.1c787b696" class="syxqAnyPoint-t-list-card-0-2"  :data="replaceCssVariables(state.sceneList, global?.theme || global?.activeTheme || '默认主题')" :spacing-x="tListCardx0x2ComputedData.spacingX" :col="tListCardx0x2ComputedData.col" :direction="tListCardx0x2ComputedData.direction" :exchange-order="tListCardx0x2ComputedData.exchangeOrder" :unit-break="tListCardx0x2ComputedData.unitBreak" :key-field="tListCardx0x2ComputedData.keyField" :active-key-field="tListCardx0x2ComputedData.activeKeyField" :active="replaceCssVariables(state.activeTab.name, global?.theme || global?.activeTheme || '默认主题')" :c-style="tListCardx0x2ComputedData.cStyle" @card-click="oncardClick1735029005919"></t-list-card><t-rect id="t-rect-364c.0469d38c2" class="syxqAnyPoint-t-rect-0-3"  :tip="tRectx0x3ComputedData.tip" :label="tRectx0x3ComputedData.label" :active="tRectx0x3ComputedData.active" :c-style="tRectx0x3ComputedData.cStyle"></t-rect><t-table v-if="state.isShowOperateColumn === false" id="t-table-dc13.1454a104c" class="syxqAnyPoint-t-table-0-4"  :height="tTablex0x4ComputedData.height" :stripe="tTablex0x4ComputedData.stripe" :border="tTablex0x4ComputedData.border" :auto-scroll="tTablex0x4ComputedData.autoScroll" :speed="tTablex0x4ComputedData.speed" :columns="tTablex0x4ComputedData.columns" :data="replaceCssVariables(state.enterList, global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x4ComputedData.defaultSort" :c-style="tTablex0x4ComputedData.cStyle" @cell-click="oncellClick1734608241064"></t-table><t-table v-if="state.isShowOperateColumn === true" id="t-table-a0d0.258b53cfd" class="syxqAnyPoint-t-table-0-5"  :height="tTablex0x5ComputedData.height" :stripe="tTablex0x5ComputedData.stripe" :border="tTablex0x5ComputedData.border" :auto-scroll="tTablex0x5ComputedData.autoScroll" :speed="tTablex0x5ComputedData.speed" :columns="tTablex0x5ComputedData.columns" :data="replaceCssVariables(state.enterList, global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x5ComputedData.defaultSort" :c-style="tTablex0x5ComputedData.cStyle" @cell-click="oncellClick1735184769666_0_0"></t-table><t-component id="t-component-3c7c.d9e5b9971" class="syxqAnyPoint-t-component-0-6"  :name="tComponentx0x6ComputedData.name" :c-style="tComponentx0x6ComputedData.cStyle" :src="tComponentx0x6ComputedData.src" :component-name="tComponentx0x6ComputedData.componentName"></t-component><t-text id="t-text-0645.e3c5af32d" class="syxqAnyPoint-t-text-0-7"  :label="tTextx0x7ComputedData.label" :editable="tTextx0x7ComputedData.editable" :c-style="tTextx0x7ComputedData.cStyle"></t-text><t-date-picker id="t-date-picker-cb44.603c1d70f" class="syxqAnyPoint-t-date-picker-0-8"  :placeholder="tDatePickerx0x8ComputedData.placeholder" :start-placeholder="tDatePickerx0x8ComputedData.startPlaceholder" :end-placeholder="tDatePickerx0x8ComputedData.endPlaceholder" :type="tDatePickerx0x8ComputedData.type" :clearable="tDatePickerx0x8ComputedData.clearable" :range-separator="tDatePickerx0x8ComputedData.rangeSeparator" :default-date="replaceCssVariables(state.selectedParams.time, global?.theme || global?.activeTheme || '默认主题')" :separator="tDatePickerx0x8ComputedData.separator" :readonly="tDatePickerx0x8ComputedData.readonly" :editable="tDatePickerx0x8ComputedData.editable" :c-style="tDatePickerx0x8ComputedData.cStyle" @date-change="ondateChange1740967140116"></t-date-picker><t-rect v-if="state.checkedIds !== ''" id="t-rect-f258.31abd13a7" class="syxqAnyPoint-t-rect-0-9"  :tip="tRectx0x9ComputedData.tip" :label="tRectx0x9ComputedData.label" :active="tRectx0x9ComputedData.active" :c-style="tRectx0x9ComputedData.cStyle" @click="onclick1735205190641"></t-rect><t-rect v-if="state.checkedIds === ''" id="t-rect-caab.15629254d" class="syxqAnyPoint-t-rect-0-10"  :tip="tRectx0x10ComputedData.tip" :label="tRectx0x10ComputedData.label" :active="tRectx0x10ComputedData.active" :c-style="tRectx0x10ComputedData.cStyle"></t-rect><t-text id="t-text-5454.74c04491" class="syxqAnyPoint-t-text-0-11"  :label="tTextx0x11ComputedData.label" :editable="tTextx0x11ComputedData.editable" :c-style="tTextx0x11ComputedData.cStyle"></t-text><t-text id="t-text-3cbd.a0ae1d041" class="syxqAnyPoint-t-text-0-12"  :label="tTextx0x12ComputedData.label" :editable="tTextx0x12ComputedData.editable" :c-style="tTextx0x12ComputedData.cStyle"></t-text><t-text id="t-text-a89a.7e30697e2" class="syxqAnyPoint-t-text-0-13"  :label="tTextx0x13ComputedData.label" :editable="tTextx0x13ComputedData.editable" :c-style="tTextx0x13ComputedData.cStyle"></t-text><t-text id="t-text-49e3.b2374108a" class="syxqAnyPoint-t-text-0-14"  :label="tTextx0x14ComputedData.label" :editable="tTextx0x14ComputedData.editable" :c-style="tTextx0x14ComputedData.cStyle"></t-text><t-text id="t-text-3797.0a506c66b" class="syxqAnyPoint-t-text-0-15"  :label="tTextx0x15ComputedData.label" :editable="tTextx0x15ComputedData.editable" :c-style="tTextx0x15ComputedData.cStyle"></t-text><t-radio id="t-radio-7049.20f57b6cf" class="syxqAnyPoint-t-radio-0-16"  :options="tRadiox0x16ComputedData.options" :active="replaceCssVariables(state.selectedParams.direction, global?.theme || global?.activeTheme || '默认主题')" :alias="tRadiox0x16ComputedData.alias" :disabled="tRadiox0x16ComputedData.disabled" :border="tRadiox0x16ComputedData.border" :size="tRadiox0x16ComputedData.size" :is-use-button="tRadiox0x16ComputedData.isUseButton" :c-style="tRadiox0x16ComputedData.cStyle" @change="onchange1740720896505"></t-radio><t-radio id="t-radio-f568.197f4f8a6" class="syxqAnyPoint-t-radio-0-17"  :options="tRadiox0x17ComputedData.options" :active="replaceCssVariables(state.selectedParams.buffer, global?.theme || global?.activeTheme || '默认主题')" :alias="tRadiox0x17ComputedData.alias" :disabled="tRadiox0x17ComputedData.disabled" :border="tRadiox0x17ComputedData.border" :size="tRadiox0x17ComputedData.size" :is-use-button="tRadiox0x17ComputedData.isUseButton" :c-style="tRadiox0x17ComputedData.cStyle" @change="onchange1740720921561"></t-radio><t-checkbox id="t-checkbox-3380.5456a8ecb" class="syxqAnyPoint-t-checkbox-0-18"  :data="tCheckboxx0x18ComputedData.data" :active="replaceCssVariables(state.selectedParams.altitude, global?.theme || global?.activeTheme || '默认主题')" :data-alias="tCheckboxx0x18ComputedData.dataAlias" :border="tCheckboxx0x18ComputedData.border" :use-button="tCheckboxx0x18ComputedData.useButton" :c-style="tCheckboxx0x18ComputedData.cStyle" @change="onchange1740720873822"></t-checkbox><t-rect id="t-rect-0b21.228388b5a" class="syxqAnyPoint-t-rect-0-19"  :tip="tRectx0x19ComputedData.tip" :label="tRectx0x19ComputedData.label" :active="tRectx0x19ComputedData.active" :c-style="tRectx0x19ComputedData.cStyle" @click="onclick1740712988309_0_0"></t-rect><t-search id="t-search-fadf.e7800d58b" class="syxqAnyPoint-t-search-0-20"  :type="tSearchx0x20ComputedData.type" :input-value="replaceCssVariables(state.selectedParams.radius, global?.theme || global?.activeTheme || '默认主题')" :maxlength="tSearchx0x20ComputedData.maxlength" :minlength="tSearchx0x20ComputedData.minlength" :show-word-limit="tSearchx0x20ComputedData.showWordLimit" :placeholder="tSearchx0x20ComputedData.placeholder" :clearable="tSearchx0x20ComputedData.clearable" :show-password="tSearchx0x20ComputedData.showPassword" :disabled="tSearchx0x20ComputedData.disabled" :prefix-icon="tSearchx0x20ComputedData.prefix-icon" :suffix-icon="tSearchx0x20ComputedData.suffix-icon" :rows="tSearchx0x20ComputedData.rows" :autosize="tSearchx0x20ComputedData.autosize" :name="tSearchx0x20ComputedData.name" :readonly="tSearchx0x20ComputedData.readonly" :step="tSearchx0x20ComputedData.step" :autofocus="tSearchx0x20ComputedData.autofocus" :form="tSearchx0x20ComputedData.form" :label="tSearchx0x20ComputedData.label" :tabindex="tSearchx0x20ComputedData.tabindex" :validate-event="tSearchx0x20ComputedData.validateEvent" :c-style="tSearchx0x20ComputedData.cStyle" :has-search-btn="tSearchx0x20ComputedData.hasSearchBtn" @input="oninput1740741929704"></t-search><t-text id="t-text-52c7.b32680ad6" class="syxqAnyPoint-t-text-0-21"  :label="tTextx0x21ComputedData.label" :editable="tTextx0x21ComputedData.editable" :c-style="tTextx0x21ComputedData.cStyle"></t-text><t-component v-if="state.isShowTagFilter === true" id="t-component-7856.abcbda815" class="syxqAnyPoint-t-component-0-22"  :name="tComponentx0x22ComputedData.name" :loading="tComponentx0x22ComputedData.loading" :c-style="tComponentx0x22ComputedData.cStyle" :src="tComponentx0x22ComputedData.src" :component-name="tComponentx0x22ComputedData.componentName" :page-id="tComponentx0x22ComputedData.pageId" :page-code="tComponentx0x22ComputedData.pageCode"></t-component></div>
</template>
...
import { TButton, TCheckbox, TComponent, TDatePicker, TImageBase, TListCard, TRadio, TRect, TSearch, TTable, TText } from '@ths/design';
...
.t-l-c-syxqAnyPoint .syxqAnyPoint-t-button-0-0 {
...
.t-l-c-syxqAnyPoint .syxqAnyPoint-t-image-base-0-1 {
position: absolute !important;
top: 48px;
left: 20px;
width: 410px;
...
.t-l-c-syxqAnyPoint .syxqAnyPoint-t-list-card-0-2 {
position: absolute !important;
top: 280px;
left: 18px;
width: 410px;
...
.t-l-c-syxqAnyPoint .syxqAnyPoint-t-rect-0-3 {
position: absolute !important;
top: 268px;
left: 20px;
width: 410px;
...
.t-l-c-syxqAnyPoint .syxqAnyPoint-t-table-0-4 {
position: absolute !important;
top: 416px;
left: 20px;
width: 410px;
...
.t-l-c-syxqAnyPoint .syxqAnyPoint-t-table-0-5 {
position: absolute !important;
top: 416px;
left: 20px;
width: 410px;
...
.t-l-c-syxqAnyPoint .syxqAnyPoint-t-component-0-6 {
position: absolute !important;
top: 0px;
left: 20px;
width: 410px;
...
.t-l-c-syxqAnyPoint .syxqAnyPoint-t-text-0-7 {
position: absolute !important;
top: 5px;
left: 60px;
width: 234px;
...
.t-l-c-syxqAnyPoint .syxqAnyPoint-t-date-picker-0-8 {
position: absolute !important;
top: 108px;
left: 108px;
width: 260px;
...
.t-l-c-syxqAnyPoint .syxqAnyPoint-t-rect-0-9 {
position: absolute !important;
top: 372px;
left: 306px;
width: 72px;
...
.t-l-c-syxqAnyPoint .syxqAnyPoint-t-rect-0-10 {
position: absolute !important;
top: 372px;
left: 306px;
width: 72px;
...
.t-l-c-syxqAnyPoint .syxqAnyPoint-t-text-0-11 {
position: absolute !important;
top: 148px;
left: 36px;
width: 70px;
...
.t-l-c-syxqAnyPoint .syxqAnyPoint-t-text-0-12 {
position: absolute !important;
top: 117px;
left: 35px;
width: 70px;
...
.t-l-c-syxqAnyPoint .syxqAnyPoint-t-text-0-13 {
position: absolute !important;
top: 202px;
left: 36px;
width: 70px;
...
.t-l-c-syxqAnyPoint .syxqAnyPoint-t-text-0-14 {
position: absolute !important;
top: 175px;
left: 36px;
width: 70px;
...
.t-l-c-syxqAnyPoint .syxqAnyPoint-t-text-0-15 {
position: absolute !important;
top: 73px;
left: 36px;
width: 70px;
...
.t-l-c-syxqAnyPoint .syxqAnyPoint-t-radio-0-16 {
position: absolute !important;
top: 145px;
left: 109px;
width: 256px;
...
.t-l-c-syxqAnyPoint .syxqAnyPoint-t-radio-0-17 {
position: absolute !important;
top: 199px;
left: 109px;
width: 256px;
...
.t-l-c-syxqAnyPoint .syxqAnyPoint-t-checkbox-0-18 {
position: absolute !important;
top: 172px;
left: 107px;
width: 232px;
...
.t-l-c-syxqAnyPoint .syxqAnyPoint-t-rect-0-19 {
position: absolute !important;
top: 224px;
left: 329px;
width: 85px;
...
.t-l-c-syxqAnyPoint .syxqAnyPoint-t-search-0-20 {
position: absolute !important;
top: 65px;
left: 108px;
width: 260px;
...
.t-l-c-syxqAnyPoint .syxqAnyPoint-t-text-0-21 {
position: absolute !important;
top: 75px;
left: 381px;
width: 28px;
...
.t-l-c-syxqAnyPoint .syxqAnyPoint-t-component-0-22 {
position: absolute !important;
top: 226px;
left: 20px;
width: 410px;

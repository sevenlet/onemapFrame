<template>
  <div id="t-l-c-relationAnalysis" class="t-l-c-relationAnalysis" ><t-rect v-if="state.listLoading === true" id="t-rect-04fa.ba844241f" class="relationAnalysis-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle"></t-rect><t-rect v-if="state.listLoading === false" id="t-rect-ba66.a2aff468a" class="relationAnalysis-t-rect-0-1"  :tip="tRectx0x1ComputedData.tip" :label="tRectx0x1ComputedData.label" :active="tRectx0x1ComputedData.active" :c-style="tRectx0x1ComputedData.cStyle"></t-rect><t-rect v-if="state.cardNoData === true" id="t-rect-f378.207e0b47d" class="relationAnalysis-t-rect-0-2"  :tip="tRectx0x2ComputedData.tip" :label="tRectx0x2ComputedData.label" :active="tRectx0x2ComputedData.active" :c-style="tRectx0x2ComputedData.cStyle"></t-rect><t-rect id="t-rect-9709.23bde24b7" class="relationAnalysis-t-rect-0-3"  :tip="tRectx0x3ComputedData.tip" :label="tRectx0x3ComputedData.label" :active="tRectx0x3ComputedData.active" :c-style="tRectx0x3ComputedData.cStyle"></t-rect><t-rect id="t-rect-0ab3.a19c0437a" class="relationAnalysis-t-rect-0-4"  :tip="tRectx0x4ComputedData.tip" :label="tRectx0x4ComputedData.label" :active="tRectx0x4ComputedData.active" :c-style="tRectx0x4ComputedData.cStyle"></t-rect><t-list-card-multiple-choice v-if="state.cardLoading === false" id="t-list-card-multiple-choice-2596.f27bf7424" class="relationAnalysis-t-list-card-multiple-choice-0-5"  :c-style="tListCardMultipleChoicex0x5ComputedData.cStyle" :key-word="tListCardMultipleChoicex0x5ComputedData.keyWord" :default-checked="replaceCssVariables(filterData(state.selectedTopics, componentPropBindingMap?.['t-list-card-multiple-choice-2596.f27bf7424']['defaultChecked'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :data-alias="tListCardMultipleChoicex0x5ComputedData.dataAlias" :data="replaceCssVariables(filterData(state.sceneListGroup.other, componentPropBindingMap?.['t-list-card-multiple-choice-2596.f27bf7424']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" @card-click="oncardClick1764322825819"></t-list-card-multiple-choice><t-rect v-if="state.cardLoading === true" id="t-rect-82e1.1a78bdcce" class="relationAnalysis-t-rect-0-6"  :tip="tRectx0x6ComputedData.tip" :label="tRectx0x6ComputedData.label" :active="tRectx0x6ComputedData.active" :c-style="tRectx0x6ComputedData.cStyle"></t-rect><t-rect v-if="state.cardLoading === true" id="t-rect-562c.8214ac23e" class="relationAnalysis-t-rect-0-7"  :tip="tRectx0x7ComputedData.tip" :label="tRectx0x7ComputedData.label" :active="tRectx0x7ComputedData.active" :c-style="tRectx0x7ComputedData.cStyle"></t-rect><t-list-card-multiple-choice v-if="state.cardLoading === false" id="t-list-card-multiple-choice-c1f5.54fd7efef" class="relationAnalysis-t-list-card-multiple-choice-0-8"  :c-style="tListCardMultipleChoicex0x8ComputedData.cStyle" :key-word="tListCardMultipleChoicex0x8ComputedData.keyWord" :default-checked="replaceCssVariables(filterData(state.selectedTopics, componentPropBindingMap?.['t-list-card-multiple-choice-c1f5.54fd7efef']['defaultChecked'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :data-alias="tListCardMultipleChoicex0x8ComputedData.dataAlias" :data="replaceCssVariables(filterData(state.sceneListGroup.zxjc, componentPropBindingMap?.['t-list-card-multiple-choice-c1f5.54fd7efef']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" @card-click="oncardClick1770106093327_0_0"></t-list-card-multiple-choice><t-button v-if="state.activeTab.value !== ''" id="t-button-2397.b3b568691" class="relationAnalysis-t-button-0-9"  :label="tButtonx0x9ComputedData.label" :round="tButtonx0x9ComputedData.round" :plain="tButtonx0x9ComputedData.plain" :disabled="tButtonx0x9ComputedData.disabled" :type="tButtonx0x9ComputedData.type" :size="tButtonx0x9ComputedData.size" :native-type="tButtonx0x9ComputedData.native-type" :c-style="tButtonx0x9ComputedData.cStyle" @click="onclick1761120647351"></t-button><t-scrollable-cards id="t-scrollable-cards-f23d.fa9764949" class="relationAnalysis-t-scrollable-cards-0-10"  :c-style="tScrollableCardsx0x10ComputedData.cStyle" :auto-scroll="tScrollableCardsx0x10ComputedData.autoScroll" :tab="tScrollableCardsx0x10ComputedData.tab" :key-word="tScrollableCardsx0x10ComputedData.keyWord" :default-checked="replaceCssVariables(filterData(state.activeTab.value, componentPropBindingMap?.['t-scrollable-cards-f23d.fa9764949']['defaultChecked'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :speed="tScrollableCardsx0x10ComputedData.speed" :interval="tScrollableCardsx0x10ComputedData.interval" :card-space="tScrollableCardsx0x10ComputedData.cardSpace" :direction="tScrollableCardsx0x10ComputedData.direction" :data-alias="tScrollableCardsx0x10ComputedData.dataAlias" :data="replaceCssVariables(filterData(state.selectedTopicsData, componentPropBindingMap?.['t-scrollable-cards-f23d.fa9764949']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" @card-click="oncardClick1764321793704_0_0"></t-scrollable-cards><t-component id="t-component-3c7c.d9e5b9971" class="relationAnalysis-t-component-0-11"  :name="tComponentx0x11ComputedData.name" :c-style="tComponentx0x11ComputedData.cStyle" :src="tComponentx0x11ComputedData.src" :component-name="tComponentx0x11ComputedData.componentName"></t-component><t-text id="t-text-0645.e3c5af32d" class="relationAnalysis-t-text-0-12"  :label="tTextx0x12ComputedData.label" :editable="tTextx0x12ComputedData.editable" :c-style="tTextx0x12ComputedData.cStyle"></t-text><t-rect v-if="state.checkedIds !== ''" id="t-rect-f258.31abd13a7" class="relationAnalysis-t-rect-0-13"  :tip="tRectx0x13ComputedData.tip" :label="tRectx0x13ComputedData.label" :active="tRectx0x13ComputedData.active" :c-style="tRectx0x13ComputedData.cStyle" @click="onclick1735205190641"></t-rect><t-rect v-if="state.checkedIds === ''" id="t-rect-caab.15629254d" class="relationAnalysis-t-rect-0-14"  :tip="tRectx0x14ComputedData.tip" :label="tRectx0x14ComputedData.label" :active="tRectx0x14ComputedData.active" :c-style="tRectx0x14ComputedData.cStyle"></t-rect><t-row id="t-row-563c.ec22362cc" class="relationAnalysis-t-row-0-15"  :c-style="tRowx0x15ComputedData.cStyle" :gutter="tRowx0x15ComputedData.gutter" :justify="tRowx0x15ComputedData.justify" :align="tRowx0x15ComputedData.align"><t-col v-if="state.isShowExterSelect === true" id="t-col-4058.2b4c56e81" class="relationAnalysis-t-col-0-15-0"  :span="tColx0x15x0ComputedData.span" :offset="tColx0x15x0ComputedData.offset" :push="tColx0x15x0ComputedData.push" :pull="tColx0x15x0ComputedData.pull" :c-style="tColx0x15x0ComputedData.cStyle"><t-iframe id="t-iframe-546c.e0e34bf73" class="relationAnalysis-t-iframe-0-15-0-0"  :src="tIframex0x15x0x0ComputedData.src" :srcdoc="tIframex0x15x0x0ComputedData.srcdoc" :scrolling="tIframex0x15x0x0ComputedData.scrolling" :c-style="tIframex0x15x0x0ComputedData.cStyle"></t-iframe></t-col><t-col id="t-col-51ed.447c3d9cc" class="relationAnalysis-t-col-0-15-1"  :span="tColx0x15x1ComputedData.span" :offset="tColx0x15x1ComputedData.offset" :push="tColx0x15x1ComputedData.push" :pull="tColx0x15x1ComputedData.pull" :c-style="tColx0x15x1ComputedData.cStyle"><t-table v-if="state.listLoading === false" id="t-table-a0d0.258b53cfd" class="relationAnalysis-t-table-0-15-1-0"  :height="tTablex0x15x1x0ComputedData.height" :stripe="tTablex0x15x1x0ComputedData.stripe" :border="tTablex0x15x1x0ComputedData.border" :auto-scroll="tTablex0x15x1x0ComputedData.autoScroll" :speed="tTablex0x15x1x0ComputedData.speed" :columns="tTablex0x15x1x0ComputedData.columns" :data="replaceCssVariables(filterData(state.enterList, componentPropBindingMap?.['t-table-a0d0.258b53cfd']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x15x1x0ComputedData.defaultSort" :c-style="tTablex0x15x1x0ComputedData.cStyle" @cell-click="oncellClick1735184769666_0_0"></t-table></t-col></t-row><t-text-common v-if="state.cardLoading === false" id="t-text-common-ef14.9ffc7e2ca" class="relationAnalysis-t-text-common-0-16"  :label="tTextCommonx0x16ComputedData.label" :editable="tTextCommonx0x16ComputedData.editable" :c-style="tTextCommonx0x16ComputedData.cStyle"></t-text-common><t-text-common v-if="state.cardLoading === false" id="t-text-common-f613.add4e1008" class="relationAnalysis-t-text-common-0-17"  :label="tTextCommonx0x17ComputedData.label" :editable="tTextCommonx0x17ComputedData.editable" :c-style="tTextCommonx0x17ComputedData.cStyle"></t-text-common></div>
</template>
...
import { TButton, TCol, TComponent, TIframe, TListCardMultipleChoice, TRect, TRow, TScrollableCards, TTable, TText, TTextCommon } from '@ths/design';
...
return new Promise((resolve, reject) => {
     ...
     // if (res?.data?.groupResult?.length) {
//   let sceneList = res?.data?.groupResult.map(item => {
//     return {
//       ...item,
//       title: item?.DATA_TYPE || item?.DATA_TYPE,
//       num: item?.doc_count || '0',
...
.t-l-c-relationAnalysis .relationAnalysis-t-rect-0-0 {
...
.t-l-c-relationAnalysis .relationAnalysis-t-rect-0-1 {
position: absolute !important;
top: 400px;
left: 0px;
width: 410px;
...
.t-l-c-relationAnalysis .relationAnalysis-t-rect-0-2 {
position: absolute !important;
top: 45px;
left: 0px;
width: 410px;
...
.t-l-c-relationAnalysis .relationAnalysis-t-rect-0-3 {
position: absolute !important;
top: 42px;
left: 0px;
width: 410px;
...
.t-l-c-relationAnalysis .relationAnalysis-t-rect-0-4 {
position: absolute !important;
top: 221px;
left: 0px;
width: 410px;
...
.t-l-c-relationAnalysis .relationAnalysis-t-list-card-multiple-choice-0-5 {
position: absolute !important;
top: 260px;
left: 9px;
width: 410px;
...
.t-l-c-relationAnalysis .relationAnalysis-t-rect-0-6 {
position: absolute !important;
top: 45px;
left: -1px;
width: 410px;
...
.t-l-c-relationAnalysis .relationAnalysis-t-rect-0-7 {
position: absolute !important;
top: 211px;
left: 1px;
width: 410px;
...
.t-l-c-relationAnalysis .relationAnalysis-t-list-card-multiple-choice-0-8 {
position: absolute !important;
top: 85px;
left: 9px;
width: 410px;
...
.t-l-c-relationAnalysis .relationAnalysis-t-button-0-9 {
position: absolute !important;
top: 470px;
left: 276px;
width: 46px;
...
.t-l-c-relationAnalysis .relationAnalysis-t-scrollable-cards-0-10 {
position: absolute !important;
top: 470px;
left: 1px;
width: 259px;
...
.t-l-c-relationAnalysis .relationAnalysis-t-component-0-11 {
position: absolute !important;
top: 0px;
left: 0px;
width: 410px;
...
.t-l-c-relationAnalysis .relationAnalysis-t-text-0-12 {
position: absolute !important;
top: 5px;
left: 33px;
width: 234px;
...
.t-l-c-relationAnalysis .relationAnalysis-t-rect-0-13 {
position: absolute !important;
top: 470px;
left: 328px;
width: 72px;
...
.t-l-c-relationAnalysis .relationAnalysis-t-rect-0-14 {
position: absolute !important;
top: 470px;
left: 328px;
width: 72px;
...
.t-l-c-relationAnalysis .relationAnalysis-t-row-0-15 {
position: absolute !important;
top: 500px;
left: 2px;
width: 409px;
...
.t-l-c-relationAnalysis .relationAnalysis-t-col-0-15-0 {
position: relative;
top: null;
left: null;
width: 100px;
...
.t-l-c-relationAnalysis .relationAnalysis-t-iframe-0-15-0-0 {
position: unset;
top: 329px;
left: -2px;
width: 412px;
...
.t-l-c-relationAnalysis .relationAnalysis-t-col-0-15-1 {
position: relative;
top: null;
left: null;
width: 100%;
...
.t-l-c-relationAnalysis .relationAnalysis-t-table-0-15-1-0 {
position: unset;
top: 383px;
left: 0px;
width: 100%;
...
.t-l-c-relationAnalysis .relationAnalysis-t-text-common-0-16 {
position: absolute !important;
top: 52px;
left: 7px;
width: auto;
...
.t-l-c-relationAnalysis .relationAnalysis-t-text-common-0-17 {
position: absolute !important;
top: 229px;
left: 7px;
width: 132px;

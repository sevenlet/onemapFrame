<template>
  <div id="t-l-c-washCarContent" class="t-l-c-washCarContent" ><t-component id="t-component-f869.e7ce2b41a" class="washCarContent-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName" :page-id="tComponentx0x0ComputedData.pageId" :page-code="tComponentx0x0ComputedData.pageCode"></t-component></div>
</template>
...
src:"/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/index.html#/washCarPage",
componentName:"washCarPageComponent",
pageId:"895ed92771c243ee98669dbb328dc66c",
pageCode:"washCarPage", 
 },
},
});
...
deep: true, // 深度监听
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-washCarContent', global.appScaleMode, 'normal');
...
.t-l-c-washCarContent .washCarContent-t-component-0-0 {

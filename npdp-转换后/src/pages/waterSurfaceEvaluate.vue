<template>
  <div id="t-l-c-waterSurfaceEvaluate" class="t-l-c-waterSurfaceEvaluate" ><t-component id="t-component-85f9.a47b96486" class="waterSurfaceEvaluate-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName"></t-component><t-text id="t-text-ff94.8b4d2cddb" class="waterSurfaceEvaluate-t-text-0-1"  :label="tTextx0x1ComputedData.label" :editable="tTextx0x1ComputedData.editable" :c-style="tTextx0x1ComputedData.cStyle" @click="onclick1738907413310"></t-text><t-rect id="t-rect-652f.fdf9abada" class="waterSurfaceEvaluate-t-rect-0-2"  :tip="tRectx0x2ComputedData.tip" :label="tRectx0x2ComputedData.label" :active="tRectx0x2ComputedData.active" :c-style="tRectx0x2ComputedData.cStyle"></t-rect><t-select id="t-select-083e.0e3eb9d19" class="waterSurfaceEvaluate-t-select-0-3"  :active-value="replaceCssVariables(filterData(state.selectTwoValue, componentPropBindingMap?.['t-select-083e.0e3eb9d19']['activeValue'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :options="tSelectx0x3ComputedData.options" :alias="tSelectx0x3ComputedData.alias" :multiple="tSelectx0x3ComputedData.multiple" :placeholder="tSelectx0x3ComputedData.placeholder" :clearable="tSelectx0x3ComputedData.clearable" :disabled="tSelectx0x3ComputedData.disabled" :name="tSelectx0x3ComputedData.name" :autocomplete="tSelectx0x3ComputedData.autocomplete" :filterable="tSelectx0x3ComputedData.filterable" :no-match-text="tSelectx0x3ComputedData.no-match-text" :no-data-text="tSelectx0x3ComputedData.no-data-text" :c-style="tSelectx0x3ComputedData.cStyle" @change="onchange1733305548807"></t-select><t-select id="t-select-78f9.e579cc45d" class="waterSurfaceEvaluate-t-select-0-4"  :active-value="replaceCssVariables(filterData(state.selectOne, componentPropBindingMap?.['t-select-78f9.e579cc45d']['activeValue'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :options="tSelectx0x4ComputedData.options" :alias="tSelectx0x4ComputedData.alias" :multiple="tSelectx0x4ComputedData.multiple" :placeholder="tSelectx0x4ComputedData.placeholder" :clearable="tSelectx0x4ComputedData.clearable" :disabled="tSelectx0x4ComputedData.disabled" :collapse-tags="tSelectx0x4ComputedData.collapseTags" :name="tSelectx0x4ComputedData.name" :autocomplete="tSelectx0x4ComputedData.autocomplete" :filterable="tSelectx0x4ComputedData.filterable" :no-match-text="tSelectx0x4ComputedData.no-match-text" :no-data-text="tSelectx0x4ComputedData.no-data-text" :c-style="tSelectx0x4ComputedData.cStyle" @change="onchange1740100712865"></t-select><t-date-picker id="t-date-picker-2c62.2be8bf325" class="waterSurfaceEvaluate-t-date-picker-0-5"  :placeholder="tDatePickerx0x5ComputedData.placeholder" :start-placeholder="tDatePickerx0x5ComputedData.startPlaceholder" :end-placeholder="tDatePickerx0x5ComputedData.endPlaceholder" :type="tDatePickerx0x5ComputedData.type" :clearable="tDatePickerx0x5ComputedData.clearable" :range-separator="tDatePickerx0x5ComputedData.rangeSeparator" :default-date="replaceCssVariables(filterData(state.timeValue, componentPropBindingMap?.['t-date-picker-2c62.2be8bf325']['default-date'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :separator="tDatePickerx0x5ComputedData.separator" :readonly="tDatePickerx0x5ComputedData.readonly" :editable="tDatePickerx0x5ComputedData.editable" :c-style="tDatePickerx0x5ComputedData.cStyle" @date-change="ondateChange1733305582571"></t-date-picker><t-tabs-base id="t-tabs-base-9fec.899607ff" class="waterSurfaceEvaluate-t-tabs-base-0-6"  :data="tTabsBasex0x6ComputedData.data" :space="tTabsBasex0x6ComputedData.space" :selected-tab-val="replaceCssVariables(filterData(state.tabsActiveValue, componentPropBindingMap?.['t-tabs-base-9fec.899607ff']['selectedTabVal'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :inner-shadow-color="tTabsBasex0x6ComputedData.innerShadowColor" :active-inner-shadow-color="tTabsBasex0x6ComputedData.activeInnerShadowColor" :alias="tTabsBasex0x6ComputedData.alias" :c-style="tTabsBasex0x6ComputedData.cStyle" @tab-click="ontabClick1733305602843"></t-tabs-base><t-text id="t-text-0449.7284ee64" class="waterSurfaceEvaluate-t-text-0-9"  :label="tTextx0x9ComputedData.label" :editable="tTextx0x9ComputedData.editable" :c-style="tTextx0x9ComputedData.cStyle"></t-text><t-row id="t-row-271c.152545e7d" class="waterSurfaceEvaluate-t-row-0-11"  :c-style="tRowx0x11ComputedData.cStyle" :gutter="tRowx0x11ComputedData.gutter" :justify="tRowx0x11ComputedData.justify" :align="tRowx0x11ComputedData.align"><t-col id="t-col-9dc8.56d5671a" class="waterSurfaceEvaluate-t-col-0-11-0"  :span="tColx0x11x0ComputedData.span" :offset="tColx0x11x0ComputedData.offset" :push="tColx0x11x0ComputedData.push" :pull="tColx0x11x0ComputedData.pull" :c-style="tColx0x11x0ComputedData.cStyle"><t-list-card id="t-list-card-d957.e53434b18" class="waterSurfaceEvaluate-t-list-card-0-11-0-0"  :data="replaceCssVariables(filterData(state.overallRatingCard, componentPropBindingMap?.['t-list-card-d957.e53434b18']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :spacing-x="tListCardx0x11x0x0ComputedData.spacingX" :col="tListCardx0x11x0x0ComputedData.col" :direction="tListCardx0x11x0x0ComputedData.direction" :exchange-order="tListCardx0x11x0x0ComputedData.exchangeOrder" :unit-break="tListCardx0x11x0x0ComputedData.unitBreak" :key-field="tListCardx0x11x0x0ComputedData.keyField" :active-key-field="tListCardx0x11x0x0ComputedData.activeKeyField" :active="tListCardx0x11x0x0ComputedData.active" :c-style="tListCardx0x11x0x0ComputedData.cStyle"></t-list-card></t-col><t-col id="t-col-f875.1c241088a" class="waterSurfaceEvaluate-t-col-0-11-1"  :span="tColx0x11x1ComputedData.span" :offset="tColx0x11x1ComputedData.offset" :push="tColx0x11x1ComputedData.push" :pull="tColx0x11x1ComputedData.pull" :c-style="tColx0x11x1ComputedData.cStyle"><t-row id="t-row-69a1.76cf8f072" class="waterSurfaceEvaluate-t-row-0-11-1-0"  :c-style="tRowx0x11x1x0ComputedData.cStyle" :gutter="tRowx0x11x1x0ComputedData.gutter" :justify="tRowx0x11x1x0ComputedData.justify" :align="tRowx0x11x1x0ComputedData.align"><t-col id="t-col-62c8.62863f8d" class="waterSurfaceEvaluate-t-col-0-11-1-0-0"  :span="tColx0x11x1x0x0ComputedData.span" :offset="tColx0x11x1x0x0ComputedData.offset" :push="tColx0x11x1x0x0ComputedData.push" :pull="tColx0x11x1x0x0ComputedData.pull" :c-style="tColx0x11x1x0x0ComputedData.cStyle"><t-rect id="t-rect-d95b.18dadcfef" class="waterSurfaceEvaluate-t-rect-0-11-1-0-0-0"  :tip="tRectx0x11x1x0x0x0ComputedData.tip" :label="tRectx0x11x1x0x0x0ComputedData.label" :active="tRectx0x11x1x0x0x0ComputedData.active" :c-style="tRectx0x11x1x0x0x0ComputedData.cStyle"></t-rect><t-text-common id="t-text-common-85e1.faef115ac" class="waterSurfaceEvaluate-t-text-common-0-11-1-0-0-1"  :label="tTextCommonx0x11x1x0x0x1ComputedData.label" :editable="tTextCommonx0x11x1x0x0x1ComputedData.editable" :c-style="tTextCommonx0x11x1x0x0x1ComputedData.cStyle"></t-text-common><t-row id="t-row-a96c.5bfa56f1d" class="waterSurfaceEvaluate-t-row-0-11-1-0-0-2"  :c-style="tRowx0x11x1x0x0x2ComputedData.cStyle" :gutter="tRowx0x11x1x0x0x2ComputedData.gutter" :justify="tRowx0x11x1x0x0x2ComputedData.justify" :align="tRowx0x11x1x0x0x2ComputedData.align"><t-text id="t-text-fcd4.2fed1dcf3" class="waterSurfaceEvaluate-t-text-0-11-1-0-0-2-0"  :label="replaceCssVariables(filterData(state.overallRatingBottom.one, componentPropBindingMap?.['t-text-fcd4.2fed1dcf3']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x11x1x0x0x2x0ComputedData.editable" :c-style="tTextx0x11x1x0x0x2x0ComputedData.cStyle"></t-text><t-text id="t-text-e105.b9697bcf3" class="waterSurfaceEvaluate-t-text-0-11-1-0-0-2-1"  :label="tTextx0x11x1x0x0x2x1ComputedData.label" :editable="tTextx0x11x1x0x0x2x1ComputedData.editable" :c-style="tTextx0x11x1x0x0x2x1ComputedData.cStyle"></t-text><t-text id="t-text-3eb8.3a46d3442" class="waterSurfaceEvaluate-t-text-0-11-1-0-0-2-2"  :label="replaceCssVariables(filterData(state.overallRatingBottom.two, componentPropBindingMap?.['t-text-3eb8.3a46d3442']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x11x1x0x0x2x2ComputedData.editable" :c-style="tTextx0x11x1x0x0x2x2ComputedData.cStyle"></t-text></t-row></t-col><t-col id="t-col-944b.8d4d07d77" class="waterSurfaceEvaluate-t-col-0-11-1-0-1"  :span="tColx0x11x1x0x1ComputedData.span" :offset="tColx0x11x1x0x1ComputedData.offset" :push="tColx0x11x1x0x1ComputedData.push" :pull="tColx0x11x1x0x1ComputedData.pull" :c-style="tColx0x11x1x0x1ComputedData.cStyle"><t-rect id="t-rect-2da8.9478ec65e" class="waterSurfaceEvaluate-t-rect-0-11-1-0-1-0"  :tip="tRectx0x11x1x0x1x0ComputedData.tip" :label="tRectx0x11x1x0x1x0ComputedData.label" :active="tRectx0x11x1x0x1x0ComputedData.active" :c-style="tRectx0x11x1x0x1x0ComputedData.cStyle"></t-rect><t-text-common id="t-text-common-3df9.76c5c9642" class="waterSurfaceEvaluate-t-text-common-0-11-1-0-1-1"  :label="tTextCommonx0x11x1x0x1x1ComputedData.label" :editable="tTextCommonx0x11x1x0x1x1ComputedData.editable" :c-style="tTextCommonx0x11x1x0x1x1ComputedData.cStyle"></t-text-common><t-row id="t-row-100b.33ea4cc7" class="waterSurfaceEvaluate-t-row-0-11-1-0-1-2"  :c-style="tRowx0x11x1x0x1x2ComputedData.cStyle" :gutter="tRowx0x11x1x0x1x2ComputedData.gutter" :justify="tRowx0x11x1x0x1x2ComputedData.justify" :align="tRowx0x11x1x0x1x2ComputedData.align"><t-text id="t-text-f771.9f95a44da" class="waterSurfaceEvaluate-t-text-0-11-1-0-1-2-0"  :label="replaceCssVariables(filterData(state.overallRatingBottom.three, componentPropBindingMap?.['t-text-f771.9f95a44da']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x11x1x0x1x2x0ComputedData.editable" :c-style="tTextx0x11x1x0x1x2x0ComputedData.cStyle"></t-text><t-text id="t-text-a336.96889892e" class="waterSurfaceEvaluate-t-text-0-11-1-0-1-2-1"  :label="tTextx0x11x1x0x1x2x1ComputedData.label" :editable="tTextx0x11x1x0x1x2x1ComputedData.editable" :c-style="tTextx0x11x1x0x1x2x1ComputedData.cStyle"></t-text></t-row></t-col></t-row></t-col><t-col id="t-col-3ff1.f1bdb2ffa" class="waterSurfaceEvaluate-t-col-0-11-2"  :span="tColx0x11x2ComputedData.span" :offset="tColx0x11x2ComputedData.offset" :push="tColx0x11x2ComputedData.push" :pull="tColx0x11x2ComputedData.pull" :c-style="tColx0x11x2ComputedData.cStyle"><t-component id="t-component-35d2.d3f19cd26" class="waterSurfaceEvaluate-t-component-0-11-2-0"  :name="tComponentx0x11x2x0ComputedData.name" :c-style="tComponentx0x11x2x0ComputedData.cStyle" :src="tComponentx0x11x2x0ComputedData.src" :component-name="tComponentx0x11x2x0ComputedData.componentName"></t-component><t-text id="t-text-a345.2c7e234dc" class="waterSurfaceEvaluate-t-text-0-11-2-1"  :label="tTextx0x11x2x1ComputedData.label" :editable="tTextx0x11x2x1ComputedData.editable" :c-style="tTextx0x11x2x1ComputedData.cStyle"></t-text><t-text id="t-text-89e7.f2902e521" class="waterSurfaceEvaluate-t-text-0-11-2-2"  :label="tTextx0x11x2x2ComputedData.label" :editable="tTextx0x11x2x2ComputedData.editable" :c-style="tTextx0x11x2x2ComputedData.cStyle" @mouseover="onmouseover1733298920782" @mouseout="onmouseout1733298930144"></t-text><t-text v-if="state.isShowHelpOne === true" id="t-text-9ad6.3931e464c" class="waterSurfaceEvaluate-t-text-0-11-2-3"  :label="tTextx0x11x2x3ComputedData.label" :editable="tTextx0x11x2x3ComputedData.editable" :c-style="tTextx0x11x2x3ComputedData.cStyle"></t-text></t-col><t-col id="t-col-64e9.1dfe291fe" class="waterSurfaceEvaluate-t-col-0-11-3"  :span="tColx0x11x3ComputedData.span" :offset="tColx0x11x3ComputedData.offset" :push="tColx0x11x3ComputedData.push" :pull="tColx0x11x3ComputedData.pull" :c-style="tColx0x11x3ComputedData.cStyle"><t-list-card id="t-list-card-9105.37fa1f9cf" class="waterSurfaceEvaluate-t-list-card-0-11-3-0"  :data="replaceCssVariables(filterData(state.earlyWarningCard, componentPropBindingMap?.['t-list-card-9105.37fa1f9cf']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :spacing-x="tListCardx0x11x3x0ComputedData.spacingX" :col="tListCardx0x11x3x0ComputedData.col" :direction="tListCardx0x11x3x0ComputedData.direction" :exchange-order="tListCardx0x11x3x0ComputedData.exchangeOrder" :unit-break="tListCardx0x11x3x0ComputedData.unitBreak" :key-field="tListCardx0x11x3x0ComputedData.keyField" :active-key-field="tListCardx0x11x3x0ComputedData.activeKeyField" :active="tListCardx0x11x3x0ComputedData.active" :c-style="tListCardx0x11x3x0ComputedData.cStyle" @card-click="oncardClick1734057935552"></t-list-card></t-col><t-col id="t-col-490d.1f0f8c14e" class="waterSurfaceEvaluate-t-col-0-11-4"  :span="tColx0x11x4ComputedData.span" :offset="tColx0x11x4ComputedData.offset" :push="tColx0x11x4ComputedData.push" :pull="tColx0x11x4ComputedData.pull" :c-style="tColx0x11x4ComputedData.cStyle"><t-tabs-base id="t-tabs-base-7987.214a4cae" class="waterSurfaceEvaluate-t-tabs-base-0-11-4-0"  :data="tTabsBasex0x11x4x0ComputedData.data" :space="tTabsBasex0x11x4x0ComputedData.space" :selected-tab-val="replaceCssVariables(filterData(state.bottomTabsValue, componentPropBindingMap?.['t-tabs-base-7987.214a4cae']['selectedTabVal'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :inner-shadow-color="tTabsBasex0x11x4x0ComputedData.innerShadowColor" :active-inner-shadow-color="tTabsBasex0x11x4x0ComputedData.activeInnerShadowColor" :alias="tTabsBasex0x11x4x0ComputedData.alias" :c-style="tTabsBasex0x11x4x0ComputedData.cStyle" @tab-click="ontabClick1734511453780"></t-tabs-base></t-col><t-col id="t-col-dee5.892c5873" class="waterSurfaceEvaluate-t-col-0-11-5"  :span="tColx0x11x5ComputedData.span" :offset="tColx0x11x5ComputedData.offset" :push="tColx0x11x5ComputedData.push" :pull="tColx0x11x5ComputedData.pull" :c-style="tColx0x11x5ComputedData.cStyle"><t-chart-design v-if="state.bottomTabsValue !== 'region'" id="t-chart-design-9aa2.f6ffb218e" class="waterSurfaceEvaluate-t-chart-design-0-11-5-0"  :empty-img="replaceCssVariables(filterData(state.noDataImg, componentPropBindingMap?.['t-chart-design-9aa2.f6ffb218e']['emptyImg'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :c-style="tChartDesignx0x11x5x0ComputedData.cStyle" :options="tChartDesignx0x11x5x0ComputedData.options"></t-chart-design><t-chart-design v-if="state.bottomTabsValue === 'region'" id="t-chart-design-8084.313a8863c" class="waterSurfaceEvaluate-t-chart-design-0-11-5-1"  :empty-img="replaceCssVariables(filterData(state.noDataImg, componentPropBindingMap?.['t-chart-design-8084.313a8863c']['emptyImg'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :c-style="tChartDesignx0x11x5x1ComputedData.cStyle" :options="tChartDesignx0x11x5x1ComputedData.options"></t-chart-design></t-col><t-col id="t-col-a69e.37c44979" class="waterSurfaceEvaluate-t-col-0-11-6"  :span="tColx0x11x6ComputedData.span" :offset="tColx0x11x6ComputedData.offset" :push="tColx0x11x6ComputedData.push" :pull="tColx0x11x6ComputedData.pull" :c-style="tColx0x11x6ComputedData.cStyle"><t-component id="t-component-bbdb.5e45132e" class="waterSurfaceEvaluate-t-component-0-11-6-0"  :name="tComponentx0x11x6x0ComputedData.name" :c-style="tComponentx0x11x6x0ComputedData.cStyle" :src="tComponentx0x11x6x0ComputedData.src" :component-name="tComponentx0x11x6x0ComputedData.componentName"></t-component><t-text id="t-text-9860.33832204e" class="waterSurfaceEvaluate-t-text-0-11-6-1"  :label="tTextx0x11x6x1ComputedData.label" :editable="tTextx0x11x6x1ComputedData.editable" :c-style="tTextx0x11x6x1ComputedData.cStyle"></t-text><t-text id="t-text-504e.31650363" class="waterSurfaceEvaluate-t-text-0-11-6-2"  :label="tTextx0x11x6x2ComputedData.label" :editable="tTextx0x11x6x2ComputedData.editable" :c-style="tTextx0x11x6x2ComputedData.cStyle" @mouseover="onmouseover1733300566113_0_0" @mouseout="onmouseout1733300566113_0_1"></t-text><t-text v-if="state.isShowHelpTwo === true" id="t-text-444a.b33691bed" class="waterSurfaceEvaluate-t-text-0-11-6-3"  :label="tTextx0x11x6x3ComputedData.label" :editable="tTextx0x11x6x3ComputedData.editable" :c-style="tTextx0x11x6x3ComputedData.cStyle"></t-text><t-text v-if="state.isShowHelpTwo === true" id="t-text-768c.525fa007a" class="waterSurfaceEvaluate-t-text-0-11-6-4"  :label="tTextx0x11x6x4ComputedData.label" :editable="tTextx0x11x6x4ComputedData.editable" :c-style="tTextx0x11x6x4ComputedData.cStyle"></t-text></t-col><t-col id="t-col-a986.bd3f6611a" class="waterSurfaceEvaluate-t-col-0-11-7"  :span="tColx0x11x7ComputedData.span" :offset="tColx0x11x7ComputedData.offset" :push="tColx0x11x7ComputedData.push" :pull="tColx0x11x7ComputedData.pull" :c-style="tColx0x11x7ComputedData.cStyle"><t-checkbox id="t-checkbox-645b.c195be9a7" class="waterSurfaceEvaluate-t-checkbox-0-11-7-0"  :data="tCheckboxx0x11x7x0ComputedData.data" :active="replaceCssVariables(filterData(state.chexkBoxActive, componentPropBindingMap?.['t-checkbox-645b.c195be9a7']['active'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :data-alias="tCheckboxx0x11x7x0ComputedData.dataAlias" :border="tCheckboxx0x11x7x0ComputedData.border" :use-button="tCheckboxx0x11x7x0ComputedData.useButton" :c-style="tCheckboxx0x11x7x0ComputedData.cStyle" @change="onchange1733294293609"></t-checkbox></t-col><t-col id="t-col-8aa9.4d85a760e" class="waterSurfaceEvaluate-t-col-0-11-8"  :span="tColx0x11x8ComputedData.span" :offset="tColx0x11x8ComputedData.offset" :push="tColx0x11x8ComputedData.push" :pull="tColx0x11x8ComputedData.pull" :c-style="tColx0x11x8ComputedData.cStyle"><t-row id="t-row-c2c0.3cc9dedde" class="waterSurfaceEvaluate-t-row-0-11-8-0"  :c-style="tRowx0x11x8x0ComputedData.cStyle" :gutter="tRowx0x11x8x0ComputedData.gutter" :justify="tRowx0x11x8x0ComputedData.justify" :align="tRowx0x11x8x0ComputedData.align"><t-col id="t-col-0be5.c900e745c" class="waterSurfaceEvaluate-t-col-0-11-8-0-0"  :span="tColx0x11x8x0x0ComputedData.span" :offset="tColx0x11x8x0x0ComputedData.offset" :push="tColx0x11x8x0x0ComputedData.push" :pull="tColx0x11x8x0x0ComputedData.pull" :c-style="tColx0x11x8x0x0ComputedData.cStyle"><t-search id="t-search-87b2.6df361301" class="waterSurfaceEvaluate-t-search-0-11-8-0-0-0"  :type="tSearchx0x11x8x0x0x0ComputedData.type" :input-value="replaceCssVariables(filterData(state.pointName, componentPropBindingMap?.['t-search-87b2.6df361301']['inputValue'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :maxlength="tSearchx0x11x8x0x0x0ComputedData.maxlength" :minlength="tSearchx0x11x8x0x0x0ComputedData.minlength" :show-word-limit="tSearchx0x11x8x0x0x0ComputedData.showWordLimit" :placeholder="tSearchx0x11x8x0x0x0ComputedData.placeholder" :clearable="tSearchx0x11x8x0x0x0ComputedData.clearable" :show-password="tSearchx0x11x8x0x0x0ComputedData.showPassword" :disabled="tSearchx0x11x8x0x0x0ComputedData.disabled" :prefix-icon="tSearchx0x11x8x0x0x0ComputedData.prefix-icon" :suffix-icon="tSearchx0x11x8x0x0x0ComputedData.suffix-icon" :rows="tSearchx0x11x8x0x0x0ComputedData.rows" :autosize="tSearchx0x11x8x0x0x0ComputedData.autosize" :name="tSearchx0x11x8x0x0x0ComputedData.name" :readonly="tSearchx0x11x8x0x0x0ComputedData.readonly" :step="tSearchx0x11x8x0x0x0ComputedData.step" :autofocus="tSearchx0x11x8x0x0x0ComputedData.autofocus" :form="tSearchx0x11x8x0x0x0ComputedData.form" :label="tSearchx0x11x8x0x0x0ComputedData.label" :tabindex="tSearchx0x11x8x0x0x0ComputedData.tabindex" :validate-event="tSearchx0x11x8x0x0x0ComputedData.validateEvent" :c-style="tSearchx0x11x8x0x0x0ComputedData.cStyle" :has-search-btn="tSearchx0x11x8x0x0x0ComputedData.hasSearchBtn" @input="oninput1734340142696"></t-search></t-col><t-col id="t-col-6a38.26a6ecc6e" class="waterSurfaceEvaluate-t-col-0-11-8-0-1"  :span="tColx0x11x8x0x1ComputedData.span" :offset="tColx0x11x8x0x1ComputedData.offset" :push="tColx0x11x8x0x1ComputedData.push" :pull="tColx0x11x8x0x1ComputedData.pull" :c-style="tColx0x11x8x0x1ComputedData.cStyle"><t-button id="t-button-7fbe.2650de349" class="waterSurfaceEvaluate-t-button-0-11-8-0-1-0"  :label="tButtonx0x11x8x0x1x0ComputedData.label" :round="tButtonx0x11x8x0x1x0ComputedData.round" :plain="tButtonx0x11x8x0x1x0ComputedData.plain" :disabled="tButtonx0x11x8x0x1x0ComputedData.disabled" :type="tButtonx0x11x8x0x1x0ComputedData.type" :size="tButtonx0x11x8x0x1x0ComputedData.size" :native-type="tButtonx0x11x8x0x1x0ComputedData.native-type" :c-style="tButtonx0x11x8x0x1x0ComputedData.cStyle" @click="onclick1734484155618"></t-button></t-col></t-row></t-col><t-col id="t-col-8327.149181864" class="waterSurfaceEvaluate-t-col-0-11-9"  :span="tColx0x11x9ComputedData.span" :offset="tColx0x11x9ComputedData.offset" :push="tColx0x11x9ComputedData.push" :pull="tColx0x11x9ComputedData.pull" :c-style="tColx0x11x9ComputedData.cStyle"><t-table id="t-table-aad5.42d83a1c3" class="waterSurfaceEvaluate-t-table-0-11-9-0"  :height="tTablex0x11x9x0ComputedData.height" :stripe="tTablex0x11x9x0ComputedData.stripe" :border="tTablex0x11x9x0ComputedData.border" :auto-scroll="tTablex0x11x9x0ComputedData.autoScroll" :speed="tTablex0x11x9x0ComputedData.speed" :columns="tTablex0x11x9x0ComputedData.columns" :data="replaceCssVariables(filterData(state.pjResultList, componentPropBindingMap?.['t-table-aad5.42d83a1c3']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x11x9x0ComputedData.defaultSort" :c-style="tTablex0x11x9x0ComputedData.cStyle" @cell-click="oncellClick1733452949625"></t-table></t-col></t-row></div>
</template>
...
import { TButton, TChartDesign, TCheckbox, TCol, TComponent, TDatePicker, TListCard, TRect, TRow, TSearch, TSelect, TTable, TTabsBase, TText, TTextCommon } from '@ths/design';
...
const state = reactive({
   ...
   earlyWarningCard: [{"title":"水质超标报警","num":0,"unit":"个","icon":"assets/images/2024-12-04/1cb560e59192482985bba7eeba124949.svg","componentName":"waterCommonWarningDialogComponent","alarmTypeCode":"waterLevelOver"},{"title":"同比下降报警","num":0,"unit":"个","icon":"assets/images/2024-12-04/1cb560e59192482985bba7eeba124949.svg","componentName":"waterCommonWarningDialogComponent","alarmTypeCode":"yoyover"},{"title":"达标差距预警","num":0,"unit":"个","icon":"assets/images/2024-12-04/1cb560e59192482985bba7eeba124949.svg","componentName":"waterCommonWarningDialogComponent","alarmTypeCode":"standardGap"}],
   overallRatingBottom: {"one":"0","two":"0","three":"0"},
   overallRatingCard: [{"title":"断面总数","num":0,"unit":"个","color":"var(--business-theme)","icon":"assets/images/2023-01-05/c455d26bb2b44f2cb0b5aecbd0b2eb43.png"},{"title":"优良断面","num":0,"unit":"个","color":"rgba(0, 255, 34, 1)","icon":"assets/images/2023-01-05/80b32d24a02548d4a4766b6f29301a37.png"},{"title":"劣V断面","num":0,"unit":"个","color":"rgba(255, 192, 0, 1)","icon":"assets/images/2023-01-05/3e691744524c468f8cd1990f8bc03b69.png"}],
   pointName: "",
   timeValue: "",
   selectTwo: "",
   selectOne: ["1","2"],
...
data:[{"title":"水质超标报警","num":0,"unit":"个","icon":"assets/images/2024-12-04/1cb560e59192482985bba7eeba124949.svg","componentName":"waterCommonWarningDialogComponent","alarmTypeCode":"waterLevelOver"},{"title":"同比下降报警","num":0,"unit":"个","icon":"assets/images/2024-12-04/1cb560e59192482985bba7eeba124949.svg","componentName":"waterCommonWarningDialogComponent","alarmTypeCode":"yoyover"},{"title":"达标差距预警","num":0,"unit":"个","icon":"assets/images/2024-12-04/1cb560e59192482985bba7eeba124949.svg","componentName":"waterCommonWarningDialogComponent","alarmTypeCode":"standardGap"}],
spacingX:8,
col:3,
direction:"vertical",
exchangeOrder:false,
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-component-0-0 {
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-text-0-1 {
position: absolute !important;
top: 130px;
left: 253px;
width: 177px;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-rect-0-2 {
position: absolute !important;
top: 0px;
left: 0px;
width: 450px;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-select-0-3 {
position: absolute !important;
top: 57px;
left: 159px;
width: 136px;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-select-0-4 {
position: absolute !important;
top: 57px;
left: 15px;
width: 136px;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-date-picker-0-5 {
position: absolute !important;
top: 57px;
left: 302px;
width: 146px;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-tabs-base-0-6 {
position: absolute !important;
top: 16px;
left: 15px;
width: 423px;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-text-0-9 {
position: absolute !important;
top: 135px;
left: 59px;
width: auto;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-row-0-11 {
position: absolute !important;
top: 174px;
left: 0px;
width: 100%;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-col-0-11-0 {
position: relative;
top: null;
left: null;
width: 100%;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-list-card-0-11-0-0 {
position: unset;
top: 174px;
left: 15px;
width: 100%;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-col-0-11-1 {
position: relative;
top: null;
left: null;
width: 100%;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-row-0-11-1-0 {
position: unset;
top: -269px;
left: 862px;
width: 98%;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-col-0-11-1-0-0 {
position: relative;
top: null;
left: null;
width: 100%;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-rect-0-11-1-0-0-0 {
position: unset;
top: 263px;
left: 20px;
width: 2px;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-text-common-0-11-1-0-0-1 {
position: unset;
top: 268px;
left: 43px;
width: 96px;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-row-0-11-1-0-0-2 {
position: unset;
top: 265px;
left: 135px;
width: 85px;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-text-0-11-1-0-0-2-0 {
position: unset;
top: 1104.1927628296885px;
left: 1235.0743376079358px;
width: auto;
height: auto;
pointer-events: auto;
}

.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-text-0-11-1-0-0-2-1 {
position: unset;
top: 1736.6463072622528px;
left: 1553.6376171769348px;
width: 12px;
height: auto;
pointer-events: auto;
}

.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-text-0-11-1-0-0-2-2 {
position: unset;
top: 1096.1927628296885px;
left: 1174.0743376079358px;
width: auto;
height: auto;
pointer-events: auto;
}

.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-col-0-11-1-0-1 {
position: relative;
top: null;
left: null;
width: 100%;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-rect-0-11-1-0-1-0 {
position: unset;
top: 267px;
left: 238px;
width: 1px;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-text-common-0-11-1-0-1-1 {
position: unset;
top: 268px;
left: 258px;
width: 66px;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-row-0-11-1-0-1-2 {
position: unset;
top: 265px;
left: 327px;
width: 83px;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-text-0-11-1-0-1-2-0 {
position: unset;
top: 1270.0131956048494px;
left: 1708.2985817977992px;
width: auto;
height: auto;
pointer-events: auto;
}

.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-text-0-11-1-0-1-2-1 {
position: unset;
top: 1726.6463072622528px;
left: 1543.6376171769348px;
width: 12px;
height: auto;
pointer-events: auto;
}

.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-col-0-11-2 {
position: relative;
top: null;
left: null;
width: 100%;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-component-0-11-2-0 {
position: unset;
top: 326px;
left: 19px;
width: 410px;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-text-0-11-2-1 {
position: unset;
top: 331px;
left: 59px;
width: auto;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-text-0-11-2-2 {
position: unset;
top: 333px;
left: 149px;
width: 16px;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-text-0-11-2-3 {
position: unset;
top: 353px;
left: 78px;
width: 161px;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-col-0-11-3 {
position: relative;
top: null;
left: null;
width: 100%;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-list-card-0-11-3-0 {
position: unset;
top: 370px;
left: 18px;
width: 100%;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-col-0-11-4 {
position: relative;
top: null;
left: null;
width: 100%;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-tabs-base-0-11-4-0 {
position: unset;
top: 426px;
left: 19px;
width: auto;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-col-0-11-5 {
position: relative;
top: null;
left: null;
width: 100%;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-chart-design-0-11-5-0 {
position: unset;
top: 466px;
left: 21px;
width: 410px;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-chart-design-0-11-5-1 {
position: unset;
top: 466px;
left: 20px;
width: 410px;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-col-0-11-6 {
position: relative;
top: null;
left: null;
width: 100%;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-component-0-11-6-0 {
position: unset;
top: 600px;
left: 15px;
width: 410px;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-text-0-11-6-1 {
position: unset;
top: 606px;
left: 53px;
width: auto;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-text-0-11-6-2 {
position: unset;
top: 609px;
left: 183px;
width: 16px;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-text-0-11-6-3 {
position: unset;
top: 628px;
left: 118px;
width: 161px;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-text-0-11-6-4 {
position: unset;
top: 636px;
left: 125px;
width: 17px;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-col-0-11-7 {
position: relative;
top: null;
left: null;
width: 100%;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-checkbox-0-11-7-0 {
position: unset;
top: 650px;
left: 19px;
width: 100%;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-col-0-11-8 {
position: relative;
top: null;
left: null;
width: 100%;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-row-0-11-8-0 {
position: unset;
top: -259px;
left: 872px;
width: 100%;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-col-0-11-8-0-0 {
position: relative;
top: null;
left: null;
width: 100%;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-search-0-11-8-0-0-0 {
position: unset;
top: 692px;
left: 20px;
width: 100%;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-col-0-11-8-0-1 {
position: relative;
top: null;
left: null;
width: 100%;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-button-0-11-8-0-1-0 {
position: unset;
top: 692px;
left: 380px;
width: 50px;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-col-0-11-9 {
position: relative;
top: null;
left: null;
width: 100%;
...
.t-l-c-waterSurfaceEvaluate .waterSurfaceEvaluate-t-table-0-11-9-0 {
position: unset;
top: 731px;
left: 18px;
width: 100%;

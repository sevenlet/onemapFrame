<template>
  <div id="t-l-c-waterDialogAutoDayBaseInfo" class="t-l-c-waterDialogAutoDayBaseInfo" ><t-component id="t-component-c019.99b6d840a" class="waterDialogAutoDayBaseInfo-t-component-0-1"  :name="tComponentx0x1ComputedData.name" :c-style="tComponentx0x1ComputedData.cStyle" :src="tComponentx0x1ComputedData.src" :component-name="tComponentx0x1ComputedData.componentName" :page-id="tComponentx0x1ComputedData.pageId" :page-code="tComponentx0x1ComputedData.pageCode"></t-component><t-chart-design v-if="state.variationTrendData.chartShow === true" id="t-chart-design-3774.63e82ca0e" class="waterDialogAutoDayBaseInfo-t-chart-design-0-2"  :empty-img="replaceCssVariables(filterData(state.noDataImg, componentPropBindingMap?.['t-chart-design-3774.63e82ca0e']['emptyImg'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :c-style="tChartDesignx0x2ComputedData.cStyle" :options="replaceCssVariables(filterData(state.variationTrendData.chartOptions, componentPropBindingMap?.['t-chart-design-3774.63e82ca0e']['options'].filters || []), global?.theme || global?.activeTheme || '默认主题')" @get-chart-instance="ongetChartInstance1769678024584"></t-chart-design><t-list-card id="t-list-card-d9ab.2e21fb3b5" class="waterDialogAutoDayBaseInfo-t-list-card-0-3"  :data="replaceCssVariables(filterData(state.baseInfoData, componentPropBindingMap?.['t-list-card-d9ab.2e21fb3b5']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :spacing-x="tListCardx0x3ComputedData.spacingX" :col="tListCardx0x3ComputedData.col" :direction="tListCardx0x3ComputedData.direction" :exchange-order="tListCardx0x3ComputedData.exchangeOrder" :unit-break="tListCardx0x3ComputedData.unitBreak" :key-field="tListCardx0x3ComputedData.keyField" :active-key-field="tListCardx0x3ComputedData.activeKeyField" :active="tListCardx0x3ComputedData.active" :c-style="tListCardx0x3ComputedData.cStyle"></t-list-card><t-text id="t-text-62b3.48b14905c" class="waterDialogAutoDayBaseInfo-t-text-0-4"  :label="tTextx0x4ComputedData.label" :editable="tTextx0x4ComputedData.editable" :c-style="tTextx0x4ComputedData.cStyle"></t-text><t-circle id="t-circle-7dbd.196078e2c" class="waterDialogAutoDayBaseInfo-t-circle-0-5"  :tip="tCirclex0x5ComputedData.tip" :label="tCirclex0x5ComputedData.label" :active="tCirclex0x5ComputedData.active" :c-style="tCirclex0x5ComputedData.cStyle"></t-circle><t-text id="t-text-e92f.6243867ce" class="waterDialogAutoDayBaseInfo-t-text-0-6"  :label="tTextx0x6ComputedData.label" :editable="tTextx0x6ComputedData.editable" :c-style="tTextx0x6ComputedData.cStyle"></t-text><t-scrollable-cards id="t-scrollable-cards-455f.ff3a2c962" class="waterDialogAutoDayBaseInfo-t-scrollable-cards-0-7"  :c-style="tScrollableCardsx0x7ComputedData.cStyle" :show-icon="tScrollableCardsx0x7ComputedData.showIcon" :auto-scroll="tScrollableCardsx0x7ComputedData.autoScroll" :tab="tScrollableCardsx0x7ComputedData.tab" :key-word="tScrollableCardsx0x7ComputedData.keyWord" :default-checked="tScrollableCardsx0x7ComputedData.defaultChecked" :speed="tScrollableCardsx0x7ComputedData.speed" :interval="tScrollableCardsx0x7ComputedData.interval" :card-space="tScrollableCardsx0x7ComputedData.cardSpace" :direction="tScrollableCardsx0x7ComputedData.direction" :data-alias="tScrollableCardsx0x7ComputedData.dataAlias" :data="replaceCssVariables(filterData(state.monitorData, componentPropBindingMap?.['t-scrollable-cards-455f.ff3a2c962']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')"></t-scrollable-cards><t-row id="t-row-4e59.43d7f042f" class="waterDialogAutoDayBaseInfo-t-row-0-8"  :c-style="tRowx0x8ComputedData.cStyle" :gutter="tRowx0x8ComputedData.gutter" :justify="tRowx0x8ComputedData.justify" :align="tRowx0x8ComputedData.align"><t-text id="t-text-b39c.b6c03321c" class="waterDialogAutoDayBaseInfo-t-text-0-8-0"  :label="replaceCssVariables(filterData(state.monitorTime, componentPropBindingMap?.['t-text-b39c.b6c03321c']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x8x0ComputedData.editable" :c-style="tTextx0x8x0ComputedData.cStyle"></t-text></t-row><t-row id="t-row-11e6.c117bcaae" class="waterDialogAutoDayBaseInfo-t-row-0-9"  :c-style="tRowx0x9ComputedData.cStyle" :gutter="tRowx0x9ComputedData.gutter" :justify="tRowx0x9ComputedData.justify" :align="tRowx0x9ComputedData.align"><t-col id="t-col-c74a.a03398712" class="waterDialogAutoDayBaseInfo-t-col-0-9-0"  :span="tColx0x9x0ComputedData.span" :offset="tColx0x9x0ComputedData.offset" :push="tColx0x9x0ComputedData.push" :pull="tColx0x9x0ComputedData.pull" :c-style="tColx0x9x0ComputedData.cStyle"><t-text id="t-text-6063.4db73323" class="waterDialogAutoDayBaseInfo-t-text-0-9-0-0"  :label="replaceCssVariables(filterData(state.variationTrendData.title, componentPropBindingMap?.['t-text-6063.4db73323']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x9x0x0ComputedData.editable" :c-style="tTextx0x9x0x0ComputedData.cStyle"></t-text></t-col><t-col id="t-col-cfab.11be2e65d" class="waterDialogAutoDayBaseInfo-t-col-0-9-1"  :span="tColx0x9x1ComputedData.span" :offset="tColx0x9x1ComputedData.offset" :push="tColx0x9x1ComputedData.push" :pull="tColx0x9x1ComputedData.pull" :c-style="tColx0x9x1ComputedData.cStyle"><t-date-picker id="t-date-picker-be0a.32fc8d384" class="waterDialogAutoDayBaseInfo-t-date-picker-0-9-1-0"  :placeholder="tDatePickerx0x9x1x0ComputedData.placeholder" :start-placeholder="tDatePickerx0x9x1x0ComputedData.startPlaceholder" :end-placeholder="tDatePickerx0x9x1x0ComputedData.endPlaceholder" :type="tDatePickerx0x9x1x0ComputedData.type" :clearable="tDatePickerx0x9x1x0ComputedData.clearable" :range-separator="tDatePickerx0x9x1x0ComputedData.rangeSeparator" :default-date="replaceCssVariables(filterData(state.timeRange, componentPropBindingMap?.['t-date-picker-be0a.32fc8d384']['default-date'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :separator="tDatePickerx0x9x1x0ComputedData.separator" :readonly="tDatePickerx0x9x1x0ComputedData.readonly" :editable="tDatePickerx0x9x1x0ComputedData.editable" :c-style="tDatePickerx0x9x1x0ComputedData.cStyle" @date-change="ondateChange1735547804401"></t-date-picker></t-col><t-col id="t-col-6baa.99493e0fe" class="waterDialogAutoDayBaseInfo-t-col-0-9-2"  :span="tColx0x9x2ComputedData.span" :offset="tColx0x9x2ComputedData.offset" :push="tColx0x9x2ComputedData.push" :pull="tColx0x9x2ComputedData.pull" :c-style="tColx0x9x2ComputedData.cStyle"><t-select id="t-select-3fcb.c00f74209" class="waterDialogAutoDayBaseInfo-t-select-0-9-2-0"  :active-value="replaceCssVariables(filterData(state.variationTrendData.activeTarget, componentPropBindingMap?.['t-select-3fcb.c00f74209']['activeValue'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :options="tSelectx0x9x2x0ComputedData.options" :alias="tSelectx0x9x2x0ComputedData.alias" :multiple="tSelectx0x9x2x0ComputedData.multiple" :placeholder="tSelectx0x9x2x0ComputedData.placeholder" :clearable="tSelectx0x9x2x0ComputedData.clearable" :disabled="tSelectx0x9x2x0ComputedData.disabled" :name="tSelectx0x9x2x0ComputedData.name" :autocomplete="tSelectx0x9x2x0ComputedData.autocomplete" :filterable="tSelectx0x9x2x0ComputedData.filterable" :no-match-text="tSelectx0x9x2x0ComputedData.no-match-text" :no-data-text="tSelectx0x9x2x0ComputedData.no-data-text" :c-style="tSelectx0x9x2x0ComputedData.cStyle" :options-raw="tSelectx0x9x2x0ComputedData.optionsRaw" @change="onchange1733973555614"></t-select></t-col></t-row><t-row id="t-row-07f3.2f1d1db62" class="waterDialogAutoDayBaseInfo-t-row-0-10"  :c-style="tRowx0x10ComputedData.cStyle" :gutter="tRowx0x10ComputedData.gutter" :justify="tRowx0x10ComputedData.justify" :align="tRowx0x10ComputedData.align"><t-text id="t-text-b36c.8eb71c7a6" class="waterDialogAutoDayBaseInfo-t-text-0-10-0"  :label="tTextx0x10x0ComputedData.label" :editable="tTextx0x10x0ComputedData.editable" :c-style="tTextx0x10x0ComputedData.cStyle"></t-text><t-switch id="t-switch-5cce.2f5f10a5e" class="waterDialogAutoDayBaseInfo-t-switch-0-10-1"  :value="replaceCssVariables(filterData(state.isBz, componentPropBindingMap?.['t-switch-5cce.2f5f10a5e']['value'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :c-style="tSwitchx0x10x1ComputedData.cStyle" @change="onchange1735803291651"></t-switch></t-row></div>
</template>
...
// 结束时间
let endTime = dateFormat(new Date(state.monitorTime), 'yyyy-MM-dd');
// 开始时间
let startTime = dateFormat(getPrevTime(new Date(state.monitorTime), 'day'), 'yyyy-MM-dd');
...
<style scoped>
.t-l-c-waterDialogAutoDayBaseInfo {
position: relative;
overflow: hidden;
...
.t-l-c-waterDialogAutoDayBaseInfo .waterDialogAutoDayBaseInfo-t-component-0-1 {
...
.t-l-c-waterDialogAutoDayBaseInfo .waterDialogAutoDayBaseInfo-t-chart-design-0-2 {
position: absolute !important;
top: 329px;
left: 0px;
width: 100%;
...
.t-l-c-waterDialogAutoDayBaseInfo .waterDialogAutoDayBaseInfo-t-list-card-0-3 {
position: absolute !important;
top: 0px;
left: 0px;
width: 100%;
...
.t-l-c-waterDialogAutoDayBaseInfo .waterDialogAutoDayBaseInfo-t-text-0-4 {
position: absolute !important;
top: 120px;
left: 40px;
width: auto;
...
.t-l-c-waterDialogAutoDayBaseInfo .waterDialogAutoDayBaseInfo-t-circle-0-5 {
position: absolute !important;
top: 168px;
left: 0px;
width: 9px;
...
.t-l-c-waterDialogAutoDayBaseInfo .waterDialogAutoDayBaseInfo-t-text-0-6 {
position: absolute !important;
top: 160px;
left: 13px;
width: auto;
...
.t-l-c-waterDialogAutoDayBaseInfo .waterDialogAutoDayBaseInfo-t-scrollable-cards-0-7 {
position: absolute !important;
top: 196px;
left: 0px;
width: 824px;
...
.t-l-c-waterDialogAutoDayBaseInfo .waterDialogAutoDayBaseInfo-t-row-0-8 {
position: absolute !important;
top: 120px;
left: 0px;
width: 100%;
...
.t-l-c-waterDialogAutoDayBaseInfo .waterDialogAutoDayBaseInfo-t-text-0-8-0 {
position: unset;
top: 124.5px;
left: 645px;
width: 164px;
...
.t-l-c-waterDialogAutoDayBaseInfo .waterDialogAutoDayBaseInfo-t-row-0-9 {
position: absolute !important;
top: 281px;
left: 0px;
width: 100%;
...
.t-l-c-waterDialogAutoDayBaseInfo .waterDialogAutoDayBaseInfo-t-col-0-9-0 {
position: relative;
top: null;
left: null;
width: 100px;
...
.t-l-c-waterDialogAutoDayBaseInfo .waterDialogAutoDayBaseInfo-t-text-0-9-0-0 {
position: unset;
top: 289px;
left: 0px;
width: 240px;
...
.t-l-c-waterDialogAutoDayBaseInfo .waterDialogAutoDayBaseInfo-t-col-0-9-1 {
position: relative;
top: null;
left: null;
width: 100px;
...
.t-l-c-waterDialogAutoDayBaseInfo .waterDialogAutoDayBaseInfo-t-date-picker-0-9-1-0 {
position: unset;
top: 284px;
left: 394px;
width: 330px;
...
.t-l-c-waterDialogAutoDayBaseInfo .waterDialogAutoDayBaseInfo-t-col-0-9-2 {
position: relative;
top: null;
left: null;
width: 100px;
...
.t-l-c-waterDialogAutoDayBaseInfo .waterDialogAutoDayBaseInfo-t-select-0-9-2-0 {
position: unset;
top: 284px;
left: 704px;
width: 132px;
...
.t-l-c-waterDialogAutoDayBaseInfo .waterDialogAutoDayBaseInfo-t-row-0-10 {
position: absolute !important;
top: 326px;
left: 1px;
width: 100%;
...
.t-l-c-waterDialogAutoDayBaseInfo .waterDialogAutoDayBaseInfo-t-text-0-10-0 {
position: unset;
top: 327px;
left: 726px;
width: auto;
...
.t-l-c-waterDialogAutoDayBaseInfo .waterDialogAutoDayBaseInfo-t-switch-0-10-1 {
position: unset;
top: 328px;
left: 791px;
width: 32px;

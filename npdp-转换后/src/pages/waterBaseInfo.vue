<template>
  <div id="t-l-c-waterBaseInfo" class="t-l-c-waterBaseInfo" ><t-text id="t-text-db66.45d5b89dc" class="waterBaseInfo-t-text-0-0"  :label="tTextx0x0ComputedData.label" :editable="tTextx0x0ComputedData.editable" :c-style="tTextx0x0ComputedData.cStyle"></t-text><t-text id="t-text-0ab3.e19e3ade9" class="waterBaseInfo-t-text-0-1"  :label="tTextx0x1ComputedData.label" :editable="tTextx0x1ComputedData.editable" :c-style="tTextx0x1ComputedData.cStyle"></t-text><t-text id="t-text-ae40.9f9f6f1ba" class="waterBaseInfo-t-text-0-2"  :label="replaceCssVariables(state.lat, global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x2ComputedData.editable" :c-style="tTextx0x2ComputedData.cStyle"></t-text><t-text id="t-text-295e.0cb8f1d89" class="waterBaseInfo-t-text-0-3"  :label="tTextx0x3ComputedData.label" :editable="tTextx0x3ComputedData.editable" :c-style="tTextx0x3ComputedData.cStyle"></t-text><t-text id="t-text-8620.98027c914" class="waterBaseInfo-t-text-0-4"  :label="replaceCssVariables(state.pwxkz, global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x4ComputedData.editable" :c-style="tTextx0x4ComputedData.cStyle"></t-text><t-text id="t-text-013a.2494012eb" class="waterBaseInfo-t-text-0-5"  :label="replaceCssVariables(state.industryParkName, global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x5ComputedData.editable" :c-style="tTextx0x5ComputedData.cStyle"></t-text><t-text id="t-text-44f9.3dd70ffde" class="waterBaseInfo-t-text-0-6"  :label="tTextx0x6ComputedData.label" :editable="tTextx0x6ComputedData.editable" :c-style="tTextx0x6ComputedData.cStyle"></t-text><t-text id="t-text-1db8.5192f167c" class="waterBaseInfo-t-text-0-7"  :label="tTextx0x7ComputedData.label" :editable="tTextx0x7ComputedData.editable" :c-style="tTextx0x7ComputedData.cStyle"></t-text><t-text id="t-text-77cb.3f6a25f78" class="waterBaseInfo-t-text-0-8"  :label="replaceCssVariables(state.lon, global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x8ComputedData.editable" :c-style="tTextx0x8ComputedData.cStyle"></t-text><t-text id="t-text-ef27.45e74a7d4" class="waterBaseInfo-t-text-0-9"  :label="replaceCssVariables(state.wasteDestination, global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x9ComputedData.editable" :c-style="tTextx0x9ComputedData.cStyle"></t-text><t-text id="t-text-fb21.379026595" class="waterBaseInfo-t-text-0-10"  :label="tTextx0x10ComputedData.label" :editable="tTextx0x10ComputedData.editable" :c-style="tTextx0x10ComputedData.cStyle"></t-text><t-text id="t-text-b59a.888e0bcb1" class="waterBaseInfo-t-text-0-11"  :label="tTextx0x11ComputedData.label" :editable="tTextx0x11ComputedData.editable" :c-style="tTextx0x11ComputedData.cStyle"></t-text><t-text id="t-text-f3cf.f5a15c02a" class="waterBaseInfo-t-text-0-12"  :label="replaceCssVariables(state.productState, global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x12ComputedData.editable" :c-style="tTextx0x12ComputedData.cStyle"></t-text><t-text id="t-text-57fd.f259a23fb" class="waterBaseInfo-t-text-0-13"  :label="replaceCssVariables(state.isInIndustryPark, global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x13ComputedData.editable" :c-style="tTextx0x13ComputedData.cStyle"></t-text><t-iframe id="t-iframe-75e8.719b780ac" class="waterBaseInfo-t-iframe-0-14"  :src="tIframex0x14ComputedData.src" :srcdoc="tIframex0x14ComputedData.srcdoc" :scrolling="tIframex0x14ComputedData.scrolling" :c-style="tIframex0x14ComputedData.cStyle"></t-iframe></div>
</template>
...
if (res?.data?.head?.statusCode === '200' && res?.data?.data) {
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-waterBaseInfo', global.appScaleMode, 'normal');
...
getBaseInfoData();
/* 接收socket.io消息 */
const onSocketChange57f13e8da4c74d2e9ab3 = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChange57f13e8da4c74d2e9ab3);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChange57f13e8da4c74d2e9ab3);
});
});
// 页面离开时的操作
onUnmounted(() => {
...
.t-l-c-waterBaseInfo .waterBaseInfo-t-text-0-0 {
...
.t-l-c-waterBaseInfo .waterBaseInfo-t-text-0-1 {
position: absolute !important;
top: 348px;
left: 2px;
width: 126px;
...
.t-l-c-waterBaseInfo .waterBaseInfo-t-text-0-2 {
position: absolute !important;
top: 314px;
left: 518px;
width: 269px;
...
.t-l-c-waterBaseInfo .waterBaseInfo-t-text-0-3 {
position: absolute !important;
top: 314px;
left: 398px;
width: 120px;
...
.t-l-c-waterBaseInfo .waterBaseInfo-t-text-0-4 {
position: absolute !important;
top: 280px;
left: 518px;
width: 269px;
...
.t-l-c-waterBaseInfo .waterBaseInfo-t-text-0-5 {
position: absolute !important;
top: 348px;
left: 518px;
width: 269px;
...
.t-l-c-waterBaseInfo .waterBaseInfo-t-text-0-6 {
position: absolute !important;
top: 280px;
left: 398px;
width: 120px;
...
.t-l-c-waterBaseInfo .waterBaseInfo-t-text-0-7 {
position: absolute !important;
top: 348px;
left: 398px;
width: 120px;
...
.t-l-c-waterBaseInfo .waterBaseInfo-t-text-0-8 {
position: absolute !important;
top: 314px;
left: 128px;
width: 269px;
...
.t-l-c-waterBaseInfo .waterBaseInfo-t-text-0-9 {
position: absolute !important;
top: 382px;
left: 128px;
width: 269px;
...
.t-l-c-waterBaseInfo .waterBaseInfo-t-text-0-10 {
position: absolute !important;
top: 314px;
left: 2px;
width: 126px;
...
.t-l-c-waterBaseInfo .waterBaseInfo-t-text-0-11 {
position: absolute !important;
top: 382px;
left: 2px;
width: 126px;
...
.t-l-c-waterBaseInfo .waterBaseInfo-t-text-0-12 {
position: absolute !important;
top: 280px;
left: 128px;
width: 269px;
...
.t-l-c-waterBaseInfo .waterBaseInfo-t-text-0-13 {
position: absolute !important;
top: 348px;
left: 128px;
width: 269px;
...
.t-l-c-waterBaseInfo .waterBaseInfo-t-iframe-0-14 {
position: absolute !important;
top: -17px;
left: 1px;
width: 786px;

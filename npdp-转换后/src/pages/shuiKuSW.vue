<template>
  <div id="t-l-c-shuiKuSW" class="t-l-c-shuiKuSW" ><t-rect id="t-rect-172c.ee323b01d" class="shuiKuSW-t-rect-0-0"  :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle" :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label"></t-rect><t-text id="t-text-5895.4a069281a" class="shuiKuSW-t-text-0-1"  :editable="tTextx0x1ComputedData.editable" :show-title="tTextx0x1ComputedData.showTitle" :c-style="tTextx0x1ComputedData.cStyle" :label="tTextx0x1ComputedData.label"></t-text><t-text id="t-text-790b.0ece4d5af" class="shuiKuSW-t-text-0-2"  :editable="tTextx0x2ComputedData.editable" :show-title="tTextx0x2ComputedData.showTitle" :c-style="tTextx0x2ComputedData.cStyle" :label="replaceCssVariables(filterData(global.waterStationDialogGlobalVariables.baseMessage.SKSW_AVG, componentPropBindingMap?.['t-text-790b.0ece4d5af']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')"></t-text><t-line id="t-line-5604.4054f8de7" class="shuiKuSW-t-line-0-3"  :c-style="tLinex0x3ComputedData.cStyle"></t-line><t-text id="t-text-add5.f9d63834" class="shuiKuSW-t-text-0-4"  :editable="tTextx0x4ComputedData.editable" :show-title="tTextx0x4ComputedData.showTitle" :c-style="tTextx0x4ComputedData.cStyle" :label="tTextx0x4ComputedData.label"></t-text><t-text id="t-text-e52b.4238bafc8" class="shuiKuSW-t-text-0-5"  :editable="tTextx0x5ComputedData.editable" :show-title="tTextx0x5ComputedData.showTitle" :c-style="tTextx0x5ComputedData.cStyle" :label="replaceCssVariables(filterData(global.waterStationDialogGlobalVariables.baseMessage.SKSW_STD, componentPropBindingMap?.['t-text-e52b.4238bafc8']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')"></t-text></div>
</template>
...
import { TLine, TRect, TText } from '@ths/design';
...
tTextx0x1: {
defaultStyle: {
            default: {"animationName":"","backgroundColor":"","color":"var(--business-text-avianize)","textAlign":"center","display":"block","textDecoration":"none","fontStyle":"normal","float":"none","marginLeft":"41px","paddingBottom":"0px","top":"-2px","left":"-36px","pointerEvents":"none","width":"100%","fontSize":"var(--business-text-size-14)","lineHeight":"14px","position":"unset","paddingTop":"0px","marginTop":"8px","overflow":"hidden","textOverflow":"ellipsis","whiteSpace":"nowrap","height":"24px","line-height":"var(--business-text-size-14)"},
...
label:"", 
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-shuiKuSW', global.appScaleMode, 'normal');
...
.t-l-c-shuiKuSW .shuiKuSW-t-rect-0-0 {
...
.t-l-c-shuiKuSW .shuiKuSW-t-text-0-1 {
position: absolute !important;
top: -2px;
left: -36px;
width: 100%;
...
.t-l-c-shuiKuSW .shuiKuSW-t-text-0-2 {
position: absolute !important;
top: 21px;
left: -29px;
width: 75px;
...
.t-l-c-shuiKuSW .shuiKuSW-t-line-0-3 {
position: absolute !important;
top: 55px;
left: 9px;
width: 90%;
...
.t-l-c-shuiKuSW .shuiKuSW-t-text-0-4 {
position: absolute !important;
top: 63px;
left: -23px;
width: 80px;
...
.t-l-c-shuiKuSW .shuiKuSW-t-text-0-5 {
position: absolute !important;
top: 63px;
left: 15px;
width: 60px;

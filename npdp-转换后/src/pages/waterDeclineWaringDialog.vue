<template>
  <div id="t-l-c-waterDeclineWaringDialog" class="t-l-c-waterDeclineWaringDialog" ><t-rect id="t-rect-8252.1a4ade4f4" class="waterDeclineWaringDialog-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle"></t-rect><t-table id="t-table-1f2f.98c8ca619" class="waterDeclineWaringDialog-t-table-0-1"  :height="tTablex0x1ComputedData.height" :stripe="tTablex0x1ComputedData.stripe" :border="tTablex0x1ComputedData.border" :auto-scroll="tTablex0x1ComputedData.autoScroll" :speed="tTablex0x1ComputedData.speed" :columns="tTablex0x1ComputedData.columns" :data="state.waringList" :default-sort="tTablex0x1ComputedData.defaultSort" :c-style="tTablex0x1ComputedData.cStyle" @cell-click="oncellClick1734078813477"></t-table><t-rect id="t-rect-e3a7.d7772ec8d" class="waterDeclineWaringDialog-t-rect-0-2"  :tip="tRectx0x2ComputedData.tip" :label="tRectx0x2ComputedData.label" :active="tRectx0x2ComputedData.active" :c-style="tRectx0x2ComputedData.cStyle"></t-rect><t-text id="t-text-8cba.b16affff7" class="waterDeclineWaringDialog-t-text-0-3"  :label="tTextx0x3ComputedData.label" :editable="tTextx0x3ComputedData.editable" :c-style="tTextx0x3ComputedData.cStyle"></t-text><t-rect id="t-rect-da62.857f90ab" class="waterDeclineWaringDialog-t-rect-0-4"  :tip="tRectx0x4ComputedData.tip" :label="tRectx0x4ComputedData.label" :active="tRectx0x4ComputedData.active" :c-style="tRectx0x4ComputedData.cStyle" @click="onclick1733817210174"></t-rect></div>
</template>
...
label:"",
active:false,
cStyle:{"wrapper":{"default":{"width":"450px","height":"355px","position":"unset","left":"0px","top":"0px","backgroundColor":"var(--business-dialog-bg)","borderTopLeftRadius":"16px","borderTopRightRadius":"16px","borderBottomLeftRadius":"16px","borderBottomRightRadius":"16px","borderLeft":"1px solid var(--business-show-bg60)","borderTop":"1px solid var(--business-show-bg60)","borderRight":"1px solid var(--business-show-bg60)","borderBottom":"1px solid var(--business-show-bg60)","animationName":""}}}, 
 },
},
tTablex0x1: {
defaultStyle: {
            default: {"width":"410px","height":"276px","position":"unset","left":"20px","top":"62px","paddingTop":"0px","borderBottom":"0px solid ","animationName":"","--el-text-color-secondary":"var(--business-show-bg60)"},
...
// 点击定位给地图发消息
if (["定位", '断面名称', '水体名称', '去年同期水质', '当月水质'].includes(column.label)) {
  /* 发送消息 */
...
const oncellClick1734078813477 = (row,column,cell,event) => {
// 执行自定义方法
...
return new Promise((resolve, reject) => {
  ...
  if (state.waringList?.length) {
    state.waringList = state.waringList.map((item) => ({
      ...
      // 去年同期水质
      WATERLEVEL_LAST: item?.WATERLEVEL_LAST || '-',
      // CODE_WATERLEVEL_LAST: item?.CODE_WATERLEVEL_LAST || '-',
      // 当月水质
      WATERLEVEL: item?.WATERLEVEL || '-',
      // CODE_WATERLEVEL: item?.CODE_WATERLEVEL || '-',
    }))
  }
} else {
  state.waringList = [];
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-waterDeclineWaringDialog', global.appScaleMode, 'normal');
...
<style scoped>
.t-l-c-waterDeclineWaringDialog {
position: relative;
overflow: hidden;
...
.t-l-c-waterDeclineWaringDialog .waterDeclineWaringDialog-t-rect-0-0 {
...
.t-l-c-waterDeclineWaringDialog .waterDeclineWaringDialog-t-table-0-1 {
position: absolute !important;
top: 62px;
left: 20px;
width: 410px;
...
.t-l-c-waterDeclineWaringDialog .waterDeclineWaringDialog-t-rect-0-2 {
position: absolute !important;
top: 0px;
left: 0px;
width: 450px;
...
.t-l-c-waterDeclineWaringDialog .waterDeclineWaringDialog-t-text-0-3 {
position: absolute !important;
top: 13px;
left: 24px;
width: 314px;
...
.t-l-c-waterDeclineWaringDialog .waterDeclineWaringDialog-t-rect-0-4 {
position: absolute !important;
top: 10px;
left: 402px;
width: 24px;

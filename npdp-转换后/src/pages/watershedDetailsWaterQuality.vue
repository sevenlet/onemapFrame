<template>
  <div id="t-l-c-watershedDetailsWaterQuality" class="t-l-c-watershedDetailsWaterQuality" ><t-component id="t-component-ded9.0f5a924fa" class="watershedDetailsWaterQuality-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName"></t-component><t-text id="t-text-4f99.3a44d10f5" class="watershedDetailsWaterQuality-t-text-0-1"  :label="tTextx0x1ComputedData.label" :editable="tTextx0x1ComputedData.editable" :c-style="tTextx0x1ComputedData.cStyle"></t-text><t-rect id="t-rect-b9b0.5b3c425c9" class="watershedDetailsWaterQuality-t-rect-0-2"  :tip="tRectx0x2ComputedData.tip" :label="tRectx0x2ComputedData.label" :active="tRectx0x2ComputedData.active" :c-style="tRectx0x2ComputedData.cStyle"></t-rect><t-rect id="t-rect-2270.4c8164d69" class="watershedDetailsWaterQuality-t-rect-0-3"  :tip="tRectx0x3ComputedData.tip" :label="tRectx0x3ComputedData.label" :active="tRectx0x3ComputedData.active" :c-style="tRectx0x3ComputedData.cStyle"></t-rect><t-rect id="t-rect-d10e.36d31aed1" class="watershedDetailsWaterQuality-t-rect-0-4"  :tip="tRectx0x4ComputedData.tip" :label="tRectx0x4ComputedData.label" :active="tRectx0x4ComputedData.active" :c-style="tRectx0x4ComputedData.cStyle"></t-rect><t-list-card id="t-list-card-7bc9.9ca6ae644" class="watershedDetailsWaterQuality-t-list-card-0-5"  :data="replaceCssVariables(filterData(state.card3, componentPropBindingMap?.['t-list-card-7bc9.9ca6ae644']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :spacing-x="tListCardx0x5ComputedData.spacingX" :col="tListCardx0x5ComputedData.col" :direction="tListCardx0x5ComputedData.direction" :exchange-order="tListCardx0x5ComputedData.exchangeOrder" :unit-break="tListCardx0x5ComputedData.unitBreak" :key-field="tListCardx0x5ComputedData.keyField" :active-key-field="tListCardx0x5ComputedData.activeKeyField" :active="tListCardx0x5ComputedData.active" :c-style="tListCardx0x5ComputedData.cStyle"></t-list-card><t-list-card id="t-list-card-79e9.677721839" class="watershedDetailsWaterQuality-t-list-card-0-6"  :data="replaceCssVariables(filterData(state.card2, componentPropBindingMap?.['t-list-card-79e9.677721839']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :spacing-x="tListCardx0x6ComputedData.spacingX" :col="tListCardx0x6ComputedData.col" :direction="tListCardx0x6ComputedData.direction" :exchange-order="tListCardx0x6ComputedData.exchangeOrder" :unit-break="tListCardx0x6ComputedData.unitBreak" :key-field="tListCardx0x6ComputedData.keyField" :active-key-field="tListCardx0x6ComputedData.activeKeyField" :active="tListCardx0x6ComputedData.active" :c-style="tListCardx0x6ComputedData.cStyle"></t-list-card><t-list-card id="t-list-card-1bff.f8cf6da4f" class="watershedDetailsWaterQuality-t-list-card-0-7"  :data="replaceCssVariables(filterData(state.card1, componentPropBindingMap?.['t-list-card-1bff.f8cf6da4f']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :spacing-x="tListCardx0x7ComputedData.spacingX" :col="tListCardx0x7ComputedData.col" :direction="tListCardx0x7ComputedData.direction" :exchange-order="tListCardx0x7ComputedData.exchangeOrder" :unit-break="tListCardx0x7ComputedData.unitBreak" :key-field="tListCardx0x7ComputedData.keyField" :active-key-field="tListCardx0x7ComputedData.activeKeyField" :active="tListCardx0x7ComputedData.active" :c-style="tListCardx0x7ComputedData.cStyle"></t-list-card><t-rect id="t-rect-d0b7.38485f8af" class="watershedDetailsWaterQuality-t-rect-0-8"  :tip="tRectx0x8ComputedData.tip" :label="tRectx0x8ComputedData.label" :active="tRectx0x8ComputedData.active" :c-style="tRectx0x8ComputedData.cStyle"></t-rect><t-row id="t-row-4d54.8ba213f9b" class="watershedDetailsWaterQuality-t-row-0-9"  :c-style="tRowx0x9ComputedData.cStyle" :gutter="tRowx0x9ComputedData.gutter" :justify="tRowx0x9ComputedData.justify" :align="tRowx0x9ComputedData.align"><t-text id="t-text-c76f.62b392aad" class="watershedDetailsWaterQuality-t-text-0-9-0"  :label="tTextx0x9x0ComputedData.label" :editable="tTextx0x9x0ComputedData.editable" :c-style="tTextx0x9x0ComputedData.cStyle"></t-text><t-high-light-text id="t-high-light-text-0482.21c14061a" class="watershedDetailsWaterQuality-t-high-light-text-0-9-1"  :fragment-list="replaceCssVariables(filterData(state.WATERQUALITYLEVELTARGETNAME, componentPropBindingMap?.['t-high-light-text-0482.21c14061a']['fragmentList'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :styles="replaceCssVariables(filterData(state.style1, componentPropBindingMap?.['t-high-light-text-0482.21c14061a']['styles'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :c-style="tHighLightTextx0x9x1ComputedData.cStyle"></t-high-light-text><t-text id="t-text-9622.d00bf60a7" class="watershedDetailsWaterQuality-t-text-0-9-2"  :label="tTextx0x9x2ComputedData.label" :editable="tTextx0x9x2ComputedData.editable" :c-style="tTextx0x9x2ComputedData.cStyle"></t-text><t-high-light-text id="t-high-light-text-33f4.69864ada6" class="watershedDetailsWaterQuality-t-high-light-text-0-9-3"  :fragment-list="replaceCssVariables(filterData(state.WATERQUALITYLEVELNAME_LAST, componentPropBindingMap?.['t-high-light-text-33f4.69864ada6']['fragmentList'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :styles="replaceCssVariables(filterData(state.style2, componentPropBindingMap?.['t-high-light-text-33f4.69864ada6']['styles'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :c-style="tHighLightTextx0x9x3ComputedData.cStyle"></t-high-light-text></t-row><t-text id="t-text-957c.9ed338dcd" class="watershedDetailsWaterQuality-t-text-0-10"  :label="tTextx0x10ComputedData.label" :editable="tTextx0x10ComputedData.editable" :c-style="tTextx0x10ComputedData.cStyle"></t-text><t-text-common id="t-text-common-8ce8.4497fa889" class="watershedDetailsWaterQuality-t-text-common-0-12"  :label="tTextCommonx0x12ComputedData.label" :editable="tTextCommonx0x12ComputedData.editable" :c-style="tTextCommonx0x12ComputedData.cStyle"></t-text-common></div>
</template>
...
import { TComponent, THighLightText, TListCard, TRect, TRow, TText, TTextCommon } from '@ths/design';
...
const state = reactive({
   ...
   card1: [{"title":"断面总数","num":"--","unit":"个","color":"var(--business-theme)","icon":"assets/images/2023-01-05/c455d26bb2b44f2cb0b5aecbd0b2eb43.png"},{"title":"优良断面","num":"--","unit":"个","color":"rgba(0, 153, 20, 1)","icon":"assets/images/2023-01-05/80b32d24a02548d4a4766b6f29301a37.png"},{"title":"超标断面","num":"--","unit":"个","color":"rgba(255, 192, 0, 1)","icon":"assets/images/2023-01-05/3e691744524c468f8cd1990f8bc03b69.png"}],
   ...
   ASSESSTYPE: "",
   TIME: "",
   imgUrl: "assets/images/2025-02-10/cad08c7c8d6a4f04a52ded146db0b10f.svg",
});
// 选中的图表主题
...
// 暂无数据
const noDataSrc = "assets/images/2025-02-10/cad08c7c8d6a4f04a52ded146db0b10f.svg"

// 断面总数小于五个，展示Ⅰ类到劣Ⅴ类
const src1 = [
  "assets/images/2025-02-05/be58a09b336d4540b40f23617b696258.svg",
  "assets/images/2025-02-05/f53143030a6e45a4ac58a183a16be307.svg",
  "assets/images/2025-02-05/08a353896abd40229e4e3c858d624ca7.svg",
  "assets/images/2025-02-05/f3ad45c0f1c74d059c615565ff17b97e.svg",
  "assets/images/2025-02-05/8b520c66d3ff42ba8ce33060d95c66a3.svg",
  "assets/images/2025-02-05/9a2ee4dab881476b97a9bcdb5bd3b808.svg"
]

// 断面总数大于等于五个，展示优到重度污染（Ⅰ类、Ⅱ类-优，Ⅲ类-良好，Ⅳ类-轻度污染，Ⅴ类-中度污染，劣Ⅴ类-重度污染）
const src2 = [
  "assets/images/2025-02-10/5f998a80516f4edfb9382612c2a87227.svg",
  "assets/images/2025-02-10/5f998a80516f4edfb9382612c2a87227.svg",
  "assets/images/2025-02-10/ea86814cfa9e47a3863834094632f77c.svg",
  "assets/images/2025-02-10/64227e0521284c71a1ee07cb214a3aff.svg",
  "assets/images/2025-02-10/9755e8d562ff420f88c845b7cbd7a9f6.svg",
  "assets/images/2025-02-10/b447539827574241a44c6dca5a253591.svg"
]
...
.t-l-c-watershedDetailsWaterQuality .watershedDetailsWaterQuality-t-component-0-0 {
...
.t-l-c-watershedDetailsWaterQuality .watershedDetailsWaterQuality-t-text-0-1 {
position: absolute !important;
top: -1px;
left: 59px;
width: 130px;
...
.t-l-c-watershedDetailsWaterQuality .watershedDetailsWaterQuality-t-rect-0-2 {
position: absolute !important;
top: 223px;
left: 19px;
width: 131px;
...
.t-l-c-watershedDetailsWaterQuality .watershedDetailsWaterQuality-t-rect-0-3 {
position: absolute !important;
top: 224px;
left: 158px;
width: 131px;
...
.t-l-c-watershedDetailsWaterQuality .watershedDetailsWaterQuality-t-rect-0-4 {
position: absolute !important;
top: 224px;
left: 298px;
width: 131px;
...
.t-l-c-watershedDetailsWaterQuality .watershedDetailsWaterQuality-t-list-card-0-5 {
position: absolute !important;
top: 239px;
left: 11px;
width: 420px;
...
.t-l-c-watershedDetailsWaterQuality .watershedDetailsWaterQuality-t-list-card-0-6 {
position: absolute !important;
top: 210px;
left: 11px;
width: 420px;
...
.t-l-c-watershedDetailsWaterQuality .watershedDetailsWaterQuality-t-list-card-0-7 {
position: absolute !important;
top: 144px;
left: 15px;
width: 418px;
...
.t-l-c-watershedDetailsWaterQuality .watershedDetailsWaterQuality-t-rect-0-8 {
position: absolute !important;
top: 44px;
left: 20px;
width: 410px;
...
.t-l-c-watershedDetailsWaterQuality .watershedDetailsWaterQuality-t-row-0-9 {
position: absolute !important;
top: 84px;
left: 125px;
width: 293px;
...
.t-l-c-watershedDetailsWaterQuality .watershedDetailsWaterQuality-t-text-0-9-0 {
position: unset;
top: 86px;
left: 202px;
width: auto;
...
.t-l-c-watershedDetailsWaterQuality .watershedDetailsWaterQuality-t-high-light-text-0-9-1 {
position: unset;
top: 84px;
left: 264px;
width: auto;
...
.t-l-c-watershedDetailsWaterQuality .watershedDetailsWaterQuality-t-text-0-9-2 {
position: unset;
top: 86px;
left: 313px;
width: auto;
...
.t-l-c-watershedDetailsWaterQuality .watershedDetailsWaterQuality-t-high-light-text-0-9-3 {
position: unset;
top: 84px;
left: 385px;
width: auto;
...
.t-l-c-watershedDetailsWaterQuality .watershedDetailsWaterQuality-t-text-0-10 {
position: absolute !important;
top: 52px;
left: 32px;
width: auto;
...
.t-l-c-watershedDetailsWaterQuality .watershedDetailsWaterQuality-t-text-common-0-12 {
position: absolute !important;
top: 82px;
left: 16px;
width: 96px;

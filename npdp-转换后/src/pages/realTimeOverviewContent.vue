<template>
  <div id="t-l-c-realTimeOverviewContent" class="t-l-c-realTimeOverviewContent" ><t-component id="t-component-1948.8b983b9b8" class="realTimeOverviewContent-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName" :page-id="tComponentx0x0ComputedData.pageId" :page-code="tComponentx0x0ComputedData.pageCode"></t-component><t-component id="t-component-4666.cb9a914ee" class="realTimeOverviewContent-t-component-0-1"  :name="tComponentx0x1ComputedData.name" :loading="tComponentx0x1ComputedData.loading" :c-style="tComponentx0x1ComputedData.cStyle" :src="tComponentx0x1ComputedData.src" :component-name="tComponentx0x1ComputedData.componentName" :page-id="tComponentx0x1ComputedData.pageId" :page-code="tComponentx0x1ComputedData.pageCode"></t-component><t-component id="t-component-3fc8.40c9a9fd1" class="realTimeOverviewContent-t-component-0-2"  :name="tComponentx0x2ComputedData.name" :loading="tComponentx0x2ComputedData.loading" :c-style="tComponentx0x2ComputedData.cStyle" :src="tComponentx0x2ComputedData.src" :component-name="tComponentx0x2ComputedData.componentName" :page-id="tComponentx0x2ComputedData.pageId" :page-code="tComponentx0x2ComputedData.pageCode"></t-component><t-text-unit id="t-text-unit-d5c0.d98c4fced" class="realTimeOverviewContent-t-text-unit-0-3"  :c-style="tTextUnitx0x3ComputedData.cStyle" :content="replaceCssVariables(filterData(global.regionaQuery.businessRegionName, componentPropBindingMap?.['t-text-unit-d5c0.d98c4fced']['content'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :unit="tTextUnitx0x3ComputedData.unit" :show-overflow-tooltip="tTextUnitx0x3ComputedData.showOverflowTooltip"></t-text-unit><t-text-unit id="t-text-unit-8b0e.4ade1c818" class="realTimeOverviewContent-t-text-unit-0-4"  :c-style="tTextUnitx0x4ComputedData.cStyle" :content="tTextUnitx0x4ComputedData.content" :unit="tTextUnitx0x4ComputedData.unit" :show-overflow-tooltip="tTextUnitx0x4ComputedData.showOverflowTooltip"></t-text-unit><t-list-card-rate id="t-list-card-rate-22cf.23be340b2" class="realTimeOverviewContent-t-list-card-rate-0-5"  :data="replaceCssVariables(filterData(state.pollutantsList, componentPropBindingMap?.['t-list-card-rate-22cf.23be340b2']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :status-list="tListCardRatex0x5ComputedData.statusList" :data-alias="tListCardRatex0x5ComputedData.dataAlias" :c-style="tListCardRatex0x5ComputedData.cStyle"></t-list-card-rate><t-table id="t-table-d2c1.f17795542" class="realTimeOverviewContent-t-table-0-6"  :height="tTablex0x6ComputedData.height" :stripe="tTablex0x6ComputedData.stripe" :border="tTablex0x6ComputedData.border" :auto-scroll="tTablex0x6ComputedData.autoScroll" :speed="tTablex0x6ComputedData.speed" :columns="tTablex0x6ComputedData.columns" :data="replaceCssVariables(filterData(state.listData, componentPropBindingMap?.['t-table-d2c1.f17795542']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x6ComputedData.defaultSort" :c-style="tTablex0x6ComputedData.cStyle" @cell-click="oncellClick1767681943133"></t-table><t-date-picker id="t-date-picker-4ad2.c3215be7a" class="realTimeOverviewContent-t-date-picker-0-7"  :placeholder="tDatePickerx0x7ComputedData.placeholder" :start-placeholder="tDatePickerx0x7ComputedData.startPlaceholder" :end-placeholder="tDatePickerx0x7ComputedData.endPlaceholder" :type="tDatePickerx0x7ComputedData.type" :clearable="tDatePickerx0x7ComputedData.clearable" :range-separator="tDatePickerx0x7ComputedData.rangeSeparator" :default-date="replaceCssVariables(filterData(global.airGlobalVariables.realTimeAlarm.dateValue, componentPropBindingMap?.['t-date-picker-4ad2.c3215be7a']['default-date'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :separator="tDatePickerx0x7ComputedData.separator" :readonly="tDatePickerx0x7ComputedData.readonly" :editable="tDatePickerx0x7ComputedData.editable" :c-style="tDatePickerx0x7ComputedData.cStyle" @date-change="ondateChange1767685262838"></t-date-picker><t-component id="t-component-42d9.b148097e9" class="realTimeOverviewContent-t-component-0-8"  :name="tComponentx0x8ComputedData.name" :c-style="tComponentx0x8ComputedData.cStyle" :src="tComponentx0x8ComputedData.src" :component-name="tComponentx0x8ComputedData.componentName" :page-id="tComponentx0x8ComputedData.pageId" :page-code="tComponentx0x8ComputedData.pageCode"></t-component><t-tabs-base id="t-tabs-base-ba51.762c76d26" class="realTimeOverviewContent-t-tabs-base-0-9"  :data="tTabsBasex0x9ComputedData.data" :space="tTabsBasex0x9ComputedData.space" :selected-tab-val="tTabsBasex0x9ComputedData.selectedTabVal" :inner-shadow-color="tTabsBasex0x9ComputedData.innerShadowColor" :active-inner-shadow-color="tTabsBasex0x9ComputedData.activeInnerShadowColor" :alias="tTabsBasex0x9ComputedData.alias" :c-style="tTabsBasex0x9ComputedData.cStyle" @tab-click="ontabClick1767685311994"></t-tabs-base><t-text-unit v-if="state.currentType === 'auto'" id="t-text-unit-5d3e.15d8238a2" class="realTimeOverviewContent-t-text-unit-0-10"  :c-style="tTextUnitx0x10ComputedData.cStyle" :content="replaceCssVariables(filterData(state.refreshTime, componentPropBindingMap?.['t-text-unit-5d3e.15d8238a2']['content'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :unit="tTextUnitx0x10ComputedData.unit" :show-overflow-tooltip="tTextUnitx0x10ComputedData.showOverflowTooltip"></t-text-unit><t-image-base id="t-image-base-fc3f.34674dd84" class="realTimeOverviewContent-t-image-base-0-11"  :src="tImageBasex0x11ComputedData.src" :fit="tImageBasex0x11ComputedData.fit" :c-style="tImageBasex0x11ComputedData.cStyle" @click="onclick1767685710756"></t-image-base><t-text-common id="t-text-common-6f3c.412407f04" class="realTimeOverviewContent-t-text-common-0-12"  :label="tTextCommonx0x12ComputedData.label" :editable="tTextCommonx0x12ComputedData.editable" :c-style="tTextCommonx0x12ComputedData.cStyle" :show-title="tTextCommonx0x12ComputedData.showTitle"></t-text-common></div>
</template>
...
import { TComponent, TDatePicker, TImageBase, TListCardRate, TTable, TTabsBase, TTextCommon, TTextUnit } from '@ths/design';
...
tImageBasex0x11: {
defaultStyle: {
            default: {"width":"20px","height":"20px","top":"19px","left":"360px","position":"unset","cursor":"pointer","animationName":"","-webkit-mask-image":"url(assets/images/2026-05-06/e2068acfee6646b4b524f5411f6d49cf.svg)","-webkit-mask-position":"50% 50%","-webkit-mask-repeat":"no-repeat","-webkit-mask-size":"100% 100%","backgroundImage":"","backgroundPosition":"","backgroundRepeat":"","backgroundSize":"","color":"","backgroundColor":"var(--business-white)"},
...
src:"",
fit:"fill",
cStyle:{"wrapper":{"default":{"width":"20px","height":"20px","top":"19px","left":"360px","position":"unset","cursor":"pointer","animationName":"","-webkit-mask-image":"url(assets/images/2026-05-06/e2068acfee6646b4b524f5411f6d49cf.svg)","-webkit-mask-position":"50% 50%","-webkit-mask-repeat":"no-repeat","-webkit-mask-size":"100% 100%","backgroundImage":"","backgroundPosition":"","backgroundRepeat":"","backgroundSize":"","color":"","backgroundColor":"var(--business-white)"}}}, 
 },
},
tTextCommonx0x12: {
defaultStyle: {
...
.t-l-c-realTimeOverviewContent .realTimeOverviewContent-t-component-0-0 {
...
.t-l-c-realTimeOverviewContent .realTimeOverviewContent-t-component-0-1 {
position: absolute !important;
top: 61px;
left: 25px;
width: 400px;
...
.t-l-c-realTimeOverviewContent .realTimeOverviewContent-t-component-0-2 {
position: absolute !important;
top: 353px;
left: 26px;
width: 400px;
...
.t-l-c-realTimeOverviewContent .realTimeOverviewContent-t-text-unit-0-3 {
position: absolute !important;
top: 62px;
left: 56px;
width: 282px;
...
.t-l-c-realTimeOverviewContent .realTimeOverviewContent-t-text-unit-0-4 {
position: absolute !important;
top: 353px;
left: 57px;
width: auto;
...
.t-l-c-realTimeOverviewContent .realTimeOverviewContent-t-list-card-rate-0-5 {
position: absolute !important;
top: 98px;
left: 13px;
width: 429px;
...
.t-l-c-realTimeOverviewContent .realTimeOverviewContent-t-table-0-6 {
position: absolute !important;
top: 400px;
left: 22px;
width: 410px;
...
.t-l-c-realTimeOverviewContent .realTimeOverviewContent-t-date-picker-0-7 {
position: absolute !important;
top: 12px;
left: 19px;
width: 178px;
...
.t-l-c-realTimeOverviewContent .realTimeOverviewContent-t-component-0-8 {
position: absolute !important;
top: 646px;
left: 23px;
width: 410px;
...
.t-l-c-realTimeOverviewContent .realTimeOverviewContent-t-tabs-base-0-9 {
position: absolute !important;
top: 13px;
left: 209px;
width: 140px;
...
.t-l-c-realTimeOverviewContent .realTimeOverviewContent-t-text-unit-0-10 {
position: absolute !important;
top: 19px;
left: 388px;
width: 50px;
...
.t-l-c-realTimeOverviewContent .realTimeOverviewContent-t-image-base-0-11 {
position: absolute !important;
top: 19px;
left: 360px;
width: 20px;
...
.t-l-c-realTimeOverviewContent .realTimeOverviewContent-t-text-common-0-12 {
position: absolute !important;
top: 353px;
left: 281px;
width: 135px;

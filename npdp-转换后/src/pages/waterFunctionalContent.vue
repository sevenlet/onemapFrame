<template>
  <div id="t-l-c-waterFunctionalContent" class="t-l-c-waterFunctionalContent" ><t-component id="t-component-d956.b44778e1e" class="waterFunctionalContent-t-component-0-0"  :name="state.tabsActiveValue" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="state.tabsActiveValue"></t-component><t-tabs id="t-tabs-f609.2971f9e49" class="waterFunctionalContent-t-tabs-0-1"  :alias="tTabsx0x1ComputedData.alias" :data="state.tabs" :active-tab="state.tabsActiveValue" :tab-position-extend="tTabsx0x1ComputedData.tabPositionExtend" :stretch="tTabsx0x1ComputedData.stretch" :c-style="tTabsx0x1ComputedData.cStyle" @tab-click="ontabClick1733388893232"></t-tabs></div>
</template>
...
.t-l-c-waterFunctionalContent .waterFunctionalContent-t-component-0-0 {
...
.t-l-c-waterFunctionalContent .waterFunctionalContent-t-tabs-0-1 {
position: absolute !important;
top: 0px;
left: 0px;
width: 450px;

<template>
  <div id="t-l-c-airOiverviewContributeTitle" class="t-l-c-airOiverviewContributeTitle" ><t-component id="t-component-acaa.e16a1875a" class="airOiverviewContributeTitle-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName"></t-component><t-text-unit id="t-text-unit-1fca.13da20f7" class="airOiverviewContributeTitle-t-text-unit-0-1"  :c-style="tTextUnitx0x1ComputedData.cStyle" :justify="tTextUnitx0x1ComputedData.justify" :align="tTextUnitx0x1ComputedData.align" :content="global.regionaQuery.businessRegionName" :unit="tTextUnitx0x1ComputedData.unit" :show-overflow-tooltip="tTextUnitx0x1ComputedData.showOverflowTooltip"></t-text-unit></div>
</template>
...
showOverflowTooltip:true, 
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-airOiverviewContributeTitle', global.appScaleMode, 'normal');
...
<style scoped>
.t-l-c-airOiverviewContributeTitle {
position: relative;
overflow: hidden;
...
.t-l-c-airOiverviewContributeTitle .airOiverviewContributeTitle-t-component-0-0 {
...
.t-l-c-airOiverviewContributeTitle .airOiverviewContributeTitle-t-text-unit-0-1 {
position: absolute !important;
top: 6px;
left: 34px;
width: 333px;

<template>
  <div id="t-l-c-videoWarning" class="t-l-c-videoWarning" ><t-component id="t-component-aa14.3ba955fbb" class="videoWarning-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName"></t-component><t-text id="t-text-6843.6e62e9a54" class="videoWarning-t-text-0-1"  :label="tTextx0x1ComputedData.label" :editable="tTextx0x1ComputedData.editable" :c-style="tTextx0x1ComputedData.cStyle" @click="onclick1765617233352"></t-text><t-text-unit id="t-text-unit-a3c4.48c326f87" class="videoWarning-t-text-unit-0-2"  :c-style="tTextUnitx0x2ComputedData.cStyle" :justify="tTextUnitx0x2ComputedData.justify" :align="tTextUnitx0x2ComputedData.align" :content="tTextUnitx0x2ComputedData.content" :unit="tTextUnitx0x2ComputedData.unit" :show-overflow-tooltip="tTextUnitx0x2ComputedData.showOverflowTooltip"></t-text-unit><t-select id="t-select-aa06.70e5fbb7f" class="videoWarning-t-select-0-3"  :active-value="replaceCssVariables(filterData(state.taskCode, componentPropBindingMap?.['t-select-aa06.70e5fbb7f']['activeValue'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :options="tSelectx0x3ComputedData.options" :alias="tSelectx0x3ComputedData.alias" :multiple="tSelectx0x3ComputedData.multiple" :placeholder="tSelectx0x3ComputedData.placeholder" :clearable="tSelectx0x3ComputedData.clearable" :disabled="tSelectx0x3ComputedData.disabled" :name="tSelectx0x3ComputedData.name" :autocomplete="tSelectx0x3ComputedData.autocomplete" :filterable="tSelectx0x3ComputedData.filterable" :no-match-text="tSelectx0x3ComputedData.no-match-text" :no-data-text="tSelectx0x3ComputedData.no-data-text" :c-style="tSelectx0x3ComputedData.cStyle"></t-select><t-rect id="t-rect-4ed7.664206f84" class="videoWarning-t-rect-0-4"  :tip="tRectx0x4ComputedData.tip" :label="tRectx0x4ComputedData.label" :active="tRectx0x4ComputedData.active" :c-style="tRectx0x4ComputedData.cStyle"></t-rect><t-rect id="t-rect-a1cf.fdeeb7749" class="videoWarning-t-rect-0-5"  :tip="tRectx0x5ComputedData.tip" :label="tRectx0x5ComputedData.label" :active="tRectx0x5ComputedData.active" :c-style="tRectx0x5ComputedData.cStyle"></t-rect><t-high-light-text id="t-high-light-text-b1c9.d9b6fabf" class="videoWarning-t-high-light-text-0-6"  :fragment-list="replaceCssVariables(filterData(state.warningTextArr, componentPropBindingMap?.['t-high-light-text-b1c9.d9b6fabf']['fragmentList'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :styles="tHighLightTextx0x6ComputedData.styles" :c-style="tHighLightTextx0x6ComputedData.cStyle"></t-high-light-text><t-text-common id="t-text-common-54c0.2ab16d38f" class="videoWarning-t-text-common-0-7"  :label="tTextCommonx0x7ComputedData.label" :editable="tTextCommonx0x7ComputedData.editable" :c-style="tTextCommonx0x7ComputedData.cStyle"></t-text-common><t-table id="t-table-f4d9.66b63002d" class="videoWarning-t-table-0-8"  :height="tTablex0x8ComputedData.height" :stripe="tTablex0x8ComputedData.stripe" :border="tTablex0x8ComputedData.border" :auto-scroll="tTablex0x8ComputedData.autoScroll" :speed="tTablex0x8ComputedData.speed" :columns="tTablex0x8ComputedData.columns" :data="replaceCssVariables(filterData(state.QYKEResultLYList, componentPropBindingMap?.['t-table-f4d9.66b63002d']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x8ComputedData.defaultSort" :c-style="tTablex0x8ComputedData.cStyle" @cell-click="oncellClick1762410432035_0_0"></t-table></div>
</template>
...
import { TComponent, THighLightText, TRect, TSelect, TTable, TText, TTextCommon, TTextUnit } from '@ths/design';
...
tRectx0x5: {
defaultStyle: {
            default: {"width":"18px","height":"19px","position":"unset","left":"15px","top":"112px","borderLeft":"0px none rgb(23,62,228)","borderTop":"0px none rgb(23,62,228)","borderRight":"0px none rgb(23,62,228)","borderBottom":"0px none rgb(23,62,228)","backgroundImage":"url(assets/images/2024-12-09/8037d0060896423fb4250d034230a26a.png)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"100% 100%","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":""},
...
label:"",
active:false,
cStyle:{"wrapper":{"default":{"width":"18px","height":"19px","position":"unset","left":"15px","top":"112px","borderLeft":"0px none rgb(23,62,228)","borderTop":"0px none rgb(23,62,228)","borderRight":"0px none rgb(23,62,228)","borderBottom":"0px none rgb(23,62,228)","backgroundImage":"url(assets/images/2024-12-09/8037d0060896423fb4250d034230a26a.png)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"100% 100%","-webkit-mask-size":"","backgroundPosition":"50% 50%","-webkit-mask-position":""}}}, 
 },
},
tHighLightTextx0x6: {
defaultStyle: {
...
tTablex0x8: {
defaultStyle: {
            default: {"width":"409px","height":"171px","position":"unset","left":"0px","top":"156px","borderBottom":"0px solid rgba(23,62,228,0)","fontWeight":"400","animationName":"","--el-text-color-secondary":"var(--business-show-bg60)"},
...
const onclick1765617233352 = () => {
/* 发送socket消息 */
rootData.rootSocket.emit('message', {
room: global.socketRoom, // 房间号
type: "createDialog", // 消息名称
data: {"title":"告警详情图片查看","isScalse":"","maxHeight":"750px","maxWidth":"1200px","minHeight":"432px","minWidth":"800px","contentName":"videoWarningRealImgViewComponent","headerName":""}, // 发送的数据
});
};let apiRegistry = {}; 
...
deep: true, // 深度监听
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-videoWarning', global.appScaleMode, 'normal');
...
.t-l-c-videoWarning .videoWarning-t-component-0-0 {
...
.t-l-c-videoWarning .videoWarning-t-text-0-1 {
position: absolute !important;
top: 6px;
left: 293px;
width: 108px;
...
.t-l-c-videoWarning .videoWarning-t-text-unit-0-2 {
position: absolute !important;
top: 6px;
left: 35px;
width: 261px;
...
.t-l-c-videoWarning .videoWarning-t-select-0-3 {
position: absolute !important;
top: 46px;
left: 113px;
width: 295px;
...
.t-l-c-videoWarning .videoWarning-t-rect-0-4 {
position: absolute !important;
top: 100px;
left: -1px;
width: 410px;
...
.t-l-c-videoWarning .videoWarning-t-rect-0-5 {
position: absolute !important;
top: 112px;
left: 15px;
width: 18px;
...
.t-l-c-videoWarning .videoWarning-t-high-light-text-0-6 {
position: absolute !important;
top: 100px;
left: 45px;
width: 364px;
...
.t-l-c-videoWarning .videoWarning-t-text-common-0-7 {
position: absolute !important;
top: 53px;
left: 6px;
width: 89px;
...
.t-l-c-videoWarning .videoWarning-t-table-0-8 {
position: absolute !important;
top: 156px;
left: 0px;
width: 409px;

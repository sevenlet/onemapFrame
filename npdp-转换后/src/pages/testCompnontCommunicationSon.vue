<template>
  <div id="t-l-c-testCompnontCommunicationSon" class="t-l-c-testCompnontCommunicationSon" ><t-gradient-text id="t-gradient-text-8a3d.52623c045" class="testCompnontCommunicationSon-t-gradient-text-0-0"  :label="replaceCssVariables(filterData(state.title, componentPropBindingMap?.['t-gradient-text-8a3d.52623c045']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :c-style="tGradientTextx0x0ComputedData.cStyle"></t-gradient-text><t-button id="t-button-14e6.53f34d103" class="testCompnontCommunicationSon-t-button-0-1"  :label="tButtonx0x1ComputedData.label" :round="tButtonx0x1ComputedData.round" :plain="tButtonx0x1ComputedData.plain" :disabled="tButtonx0x1ComputedData.disabled" :type="tButtonx0x1ComputedData.type" :size="tButtonx0x1ComputedData.size" :native-type="tButtonx0x1ComputedData.native-type" :c-style="tButtonx0x1ComputedData.cStyle" @click="onclick1731931077035"></t-button><t-component id="t-component-71dc.8eae4331" class="testCompnontCommunicationSon-t-component-0-2"  :name="tComponentx0x2ComputedData.name" :c-style="tComponentx0x2ComputedData.cStyle" :src="tComponentx0x2ComputedData.src" :component-name="tComponentx0x2ComputedData.componentName"></t-component><t-text-common id="t-text-common-677d.b4f2f7686" class="testCompnontCommunicationSon-t-text-common-0-3"  :label="replaceCssVariables(filterData(state.num, componentPropBindingMap?.['t-text-common-677d.b4f2f7686']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextCommonx0x3ComputedData.editable" :c-style="tTextCommonx0x3ComputedData.cStyle"></t-text-common></div>
</template>
...
import { TButton, TComponent, TGradientText, TTextCommon } from '@ths/design';
...
<style scoped>
.t-l-c-testCompnontCommunicationSon {
position: relative;
overflow: hidden;
...
.t-l-c-testCompnontCommunicationSon .testCompnontCommunicationSon-t-gradient-text-0-0 {
...
.t-l-c-testCompnontCommunicationSon .testCompnontCommunicationSon-t-button-0-1 {
position: absolute !important;
top: 34px;
left: 103px;
width: 70px;
...
.t-l-c-testCompnontCommunicationSon .testCompnontCommunicationSon-t-component-0-2 {
position: absolute !important;
top: 100px;
left: 2px;
width: 200px;
...
.t-l-c-testCompnontCommunicationSon .testCompnontCommunicationSon-t-text-common-0-3 {
position: absolute !important;
top: 77px;
left: 85px;
width: 96px;

<template>
  <div id="t-l-c-waterTraceabilityContent" class="t-l-c-waterTraceabilityContent" ><t-component id="t-component-bc7f.b7d59ffa4" class="waterTraceabilityContent-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName" :page-id="tComponentx0x0ComputedData.pageId" :page-code="tComponentx0x0ComputedData.pageCode"></t-component><t-component id="t-component-51b1.2d4ab3646" class="waterTraceabilityContent-t-component-0-1"  :name="tComponentx0x1ComputedData.name" :c-style="tComponentx0x1ComputedData.cStyle" :src="tComponentx0x1ComputedData.src" :component-name="tComponentx0x1ComputedData.componentName" :page-id="tComponentx0x1ComputedData.pageId" :page-code="tComponentx0x1ComputedData.pageCode"></t-component><t-row v-if="state.panelName === 'mainPanel'" id="t-row-500b.8a4282c55" class="waterTraceabilityContent-t-row-0-2"  :c-style="tRowx0x2ComputedData.cStyle" :gutter="tRowx0x2ComputedData.gutter" :justify="tRowx0x2ComputedData.justify" :align="tRowx0x2ComputedData.align"><t-text id="t-text-1bbc.292a467e2" class="waterTraceabilityContent-t-text-0-2-0"  :label="tTextx0x2x0ComputedData.label" :editable="tTextx0x2x0ComputedData.editable" :c-style="tTextx0x2x0ComputedData.cStyle" @click="onclick1733723979280"></t-text><t-text id="t-text-5001.13952ab12" class="waterTraceabilityContent-t-text-0-2-1"  :label="replaceCssVariables(filterData(state.headerInfo.POINT_NAME, componentPropBindingMap?.['t-text-5001.13952ab12']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x2x1ComputedData.editable" :c-style="tTextx0x2x1ComputedData.cStyle" :show-title="tTextx0x2x1ComputedData.showTitle"></t-text><t-text id="t-text-8f83.4cdb67f43" class="waterTraceabilityContent-t-text-0-2-2"  :label="replaceCssVariables(filterData(state.headerInfo.type, componentPropBindingMap?.['t-text-8f83.4cdb67f43']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x2x2ComputedData.editable" :c-style="tTextx0x2x2ComputedData.cStyle"></t-text><t-list-card-common id="t-list-card-common-b400.91fe9d2ff" class="waterTraceabilityContent-t-list-card-common-0-2-3"  :c-style="tListCardCommonx0x2x3ComputedData.cStyle" :key-word="tListCardCommonx0x2x3ComputedData.keyWord" :default-checked="tListCardCommonx0x2x3ComputedData.defaultChecked" :tab="tListCardCommonx0x2x3ComputedData.tab" :collapse="tListCardCommonx0x2x3ComputedData.collapse" :collapse-text="tListCardCommonx0x2x3ComputedData.collapseText" :display-count="tListCardCommonx0x2x3ComputedData.displayCount" :data-alias="tListCardCommonx0x2x3ComputedData.dataAlias" :data="replaceCssVariables(filterData(state.headerInfo.WATERQUALITYLEVELNAME, componentPropBindingMap?.['t-list-card-common-b400.91fe9d2ff']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')"></t-list-card-common><t-list-card-common id="t-list-card-common-ca3e.4acae3791" class="waterTraceabilityContent-t-list-card-common-0-2-4"  :c-style="tListCardCommonx0x2x4ComputedData.cStyle" :key-word="tListCardCommonx0x2x4ComputedData.keyWord" :default-checked="tListCardCommonx0x2x4ComputedData.defaultChecked" :tab="tListCardCommonx0x2x4ComputedData.tab" :collapse="tListCardCommonx0x2x4ComputedData.collapse" :collapse-text="tListCardCommonx0x2x4ComputedData.collapseText" :display-count="tListCardCommonx0x2x4ComputedData.displayCount" :data-alias="tListCardCommonx0x2x4ComputedData.dataAlias" :data="replaceCssVariables(filterData(state.headerInfo.ISSTANDARDSSTR, componentPropBindingMap?.['t-list-card-common-ca3e.4acae3791']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')"></t-list-card-common><t-rect v-if="state.headerInfo.isShowAlarm === true" id="t-rect-5459.0054cfc89" class="waterTraceabilityContent-t-rect-0-2-5"  :tip="tRectx0x2x5ComputedData.tip" :label="tRectx0x2x5ComputedData.label" :active="tRectx0x2x5ComputedData.active" :c-style="tRectx0x2x5ComputedData.cStyle"></t-rect></t-row><t-rect id="t-rect-5e3b.5e9377bde" class="waterTraceabilityContent-t-rect-0-3"  :tip="tRectx0x3ComputedData.tip" :label="tRectx0x3ComputedData.label" :active="tRectx0x3ComputedData.active" :c-style="tRectx0x3ComputedData.cStyle"></t-rect><t-component id="t-component-8a71.c7baaba58" class="waterTraceabilityContent-t-component-0-4"  :name="tComponentx0x4ComputedData.name" :loading="tComponentx0x4ComputedData.loading" :c-style="tComponentx0x4ComputedData.cStyle" :src="tComponentx0x4ComputedData.src" :component-name="tComponentx0x4ComputedData.componentName" :page-id="tComponentx0x4ComputedData.pageId" :page-code="tComponentx0x4ComputedData.pageCode"></t-component></div>
</template>
...
import { TComponent, TListCardCommon, TRect, TRow, TText } from '@ths/design';
...
label:"",
editable:false,
cStyle:{"wrapper":{"default":{"width":"43px","height":"18px","color":"var(--t-white)","backgroundImage":"","-webkit-mask-image":"url(assets/images/2024-12-09/767bc6dad50d4decb03abdf9f2484e19.svg)","backgroundRepeat":"","-webkit-mask-repeat":"no-repeat","backgroundSize":"","-webkit-mask-size":"auto","backgroundPosition":"","-webkit-mask-position":"0% 50%","top":"18px","left":"16px","backgroundColor":"var(--t-font-color-gy1)","position":"unset","cursor":"pointer","animationName":"","fontSize":"var(--business-text-size-18)"},"hover":{"backgroundColor":"var(--business-theme)"}},"itemWrapper":{"default":{"color":"var(--business-text-avianize)"}}}, 
 },
},
tTextx0x2x1: {
defaultStyle: {
...
<style scoped>
.t-l-c-waterTraceabilityContent {
position: relative;
overflow: hidden;
...
.t-l-c-waterTraceabilityContent .waterTraceabilityContent-t-component-0-0 {
...
.t-l-c-waterTraceabilityContent .waterTraceabilityContent-t-component-0-1 {
position: absolute !important;
top: 0px;
left: 0px;
width: 445px;
...
.t-l-c-waterTraceabilityContent .waterTraceabilityContent-t-row-0-2 {
position: absolute !important;
top: 8px;
left: 20px;
width: 419px;
...
.t-l-c-waterTraceabilityContent .waterTraceabilityContent-t-text-0-2-0 {
position: unset;
top: 18px;
left: 16px;
width: 43px;
...
.t-l-c-waterTraceabilityContent .waterTraceabilityContent-t-text-0-2-1 {
position: unset;
top: 205.12660047743043px;
left: 469.8092289677372px;
width: auto;
height: var(--business-text-size-18);
pointer-events: auto;
}

.t-l-c-waterTraceabilityContent .waterTraceabilityContent-t-text-0-2-2 {
position: unset;
top: -106px;
left: 260px;
width: auto;
...
.t-l-c-waterTraceabilityContent .waterTraceabilityContent-t-list-card-common-0-2-3 {
position: unset;
...
.t-l-c-waterTraceabilityContent .waterTraceabilityContent-t-list-card-common-0-2-4 {
position: unset;
top: 241px;
left: 634px;
width: 50px;
...
.t-l-c-waterTraceabilityContent .waterTraceabilityContent-t-rect-0-2-5 {
position: unset;
...
.t-l-c-waterTraceabilityContent .waterTraceabilityContent-t-rect-0-3 {
position: absolute !important;
top: 60px;
left: 2px;
width: 450px;
...
.t-l-c-waterTraceabilityContent .waterTraceabilityContent-t-component-0-4 {
position: absolute !important;
top: 78px;
left: 0px;
width: 450px;

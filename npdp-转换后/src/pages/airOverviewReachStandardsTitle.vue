<template>
  <div id="t-l-c-airOverviewReachStandardsTitle" class="t-l-c-airOverviewReachStandardsTitle" ><t-component id="t-component-6f3b.f3ecc4cb7" class="airOverviewReachStandardsTitle-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName"></t-component><t-text-unit id="t-text-unit-aa32.d91a0f847" class="airOverviewReachStandardsTitle-t-text-unit-0-2"  :c-style="tTextUnitx0x2ComputedData.cStyle" :justify="tTextUnitx0x2ComputedData.justify" :align="tTextUnitx0x2ComputedData.align" :content="replaceCssVariables(filterData(global.regionaQuery.businessRegionName, componentPropBindingMap?.['t-text-unit-aa32.d91a0f847']['content'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :unit="tTextUnitx0x2ComputedData.unit" :show-overflow-tooltip="tTextUnitx0x2ComputedData.showOverflowTooltip"></t-text-unit></div>
</template>
...
<style scoped>
.t-l-c-airOverviewReachStandardsTitle {
position: relative;
overflow: hidden;
...
.t-l-c-airOverviewReachStandardsTitle .airOverviewReachStandardsTitle-t-component-0-0 {
...
.t-l-c-airOverviewReachStandardsTitle .airOverviewReachStandardsTitle-t-text-unit-0-2 {
position: absolute !important;
top: 1px;
left: 34px;
width: 282px;

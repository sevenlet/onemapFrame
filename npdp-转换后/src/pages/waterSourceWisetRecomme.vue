<template>
  <div id="t-l-c-waterSourceWisetRecomme" class="t-l-c-waterSourceWisetRecomme" ><t-rect v-if="state.listLoading === true" id="t-rect-9c69.d5a9916a8" class="waterSourceWisetRecomme-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle"></t-rect><t-rect id="t-rect-678e.ec1d59e24" class="waterSourceWisetRecomme-t-rect-0-1"  :tip="tRectx0x1ComputedData.tip" :label="tRectx0x1ComputedData.label" :active="tRectx0x1ComputedData.active" :c-style="tRectx0x1ComputedData.cStyle"></t-rect><t-list-card-multiple-choice v-if="state.cardLoading === false" id="t-list-card-multiple-choice-ec2d.7b812dfe6" class="waterSourceWisetRecomme-t-list-card-multiple-choice-0-4"  :c-style="tListCardMultipleChoicex0x4ComputedData.cStyle" :key-word="tListCardMultipleChoicex0x4ComputedData.keyWord" :default-checked="replaceCssVariables(filterData(state.selectedTopics, componentPropBindingMap?.['t-list-card-multiple-choice-ec2d.7b812dfe6']['defaultChecked'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :data-alias="tListCardMultipleChoicex0x4ComputedData.dataAlias" :data="replaceCssVariables(filterData(state.sceneList, componentPropBindingMap?.['t-list-card-multiple-choice-ec2d.7b812dfe6']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" @card-click="oncardClick1764811131694"></t-list-card-multiple-choice><t-button v-if="state.activeTab.value !== ''" id="t-button-de6b.c70529ab6" class="waterSourceWisetRecomme-t-button-0-5"  :label="tButtonx0x5ComputedData.label" :round="tButtonx0x5ComputedData.round" :plain="tButtonx0x5ComputedData.plain" :disabled="tButtonx0x5ComputedData.disabled" :type="tButtonx0x5ComputedData.type" :size="tButtonx0x5ComputedData.size" :native-type="tButtonx0x5ComputedData.native-type" :c-style="tButtonx0x5ComputedData.cStyle" @click="onclick1764840173566"></t-button><t-table v-if="state.listLoading === false" id="t-table-c9cb.1191728b8" class="waterSourceWisetRecomme-t-table-0-6"  :height="tTablex0x6ComputedData.height" :stripe="tTablex0x6ComputedData.stripe" :border="tTablex0x6ComputedData.border" :auto-scroll="tTablex0x6ComputedData.autoScroll" :speed="tTablex0x6ComputedData.speed" :columns="tTablex0x6ComputedData.columns" :data="replaceCssVariables(filterData(state.enterList, componentPropBindingMap?.['t-table-c9cb.1191728b8']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x6ComputedData.defaultSort" :c-style="tTablex0x6ComputedData.cStyle" @cell-click="oncellClick1764845073264"></t-table><t-component id="t-component-5dd0.1c96052b" class="waterSourceWisetRecomme-t-component-0-8"  :name="tComponentx0x8ComputedData.name" :c-style="tComponentx0x8ComputedData.cStyle" :src="tComponentx0x8ComputedData.src" :component-name="tComponentx0x8ComputedData.componentName"></t-component><t-text id="t-text-44d5.53a19c298" class="waterSourceWisetRecomme-t-text-0-9"  :label="tTextx0x9ComputedData.label" :editable="tTextx0x9ComputedData.editable" :c-style="tTextx0x9ComputedData.cStyle"></t-text><t-rect v-if="state.checkedIds !== ''" id="t-rect-edcb.01e99c84a" class="waterSourceWisetRecomme-t-rect-0-10"  :tip="tRectx0x10ComputedData.tip" :label="tRectx0x10ComputedData.label" :active="tRectx0x10ComputedData.active" :c-style="tRectx0x10ComputedData.cStyle"></t-rect><t-rect v-if="state.checkedIds === ''" id="t-rect-3f4b.8f2cab13a" class="waterSourceWisetRecomme-t-rect-0-11"  :tip="tRectx0x11ComputedData.tip" :label="tRectx0x11ComputedData.label" :active="tRectx0x11ComputedData.active" :c-style="tRectx0x11ComputedData.cStyle"></t-rect><t-checkbox id="t-checkbox-6595.86a7b39ff" class="waterSourceWisetRecomme-t-checkbox-0-12"  :data="replaceCssVariables(filterData(state.pollutantList, componentPropBindingMap?.['t-checkbox-6595.86a7b39ff']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="replaceCssVariables(filterData(state.selectedPollutantList, componentPropBindingMap?.['t-checkbox-6595.86a7b39ff']['active'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :data-alias="tCheckboxx0x12ComputedData.dataAlias" :border="tCheckboxx0x12ComputedData.border" :use-button="tCheckboxx0x12ComputedData.useButton" :c-style="tCheckboxx0x12ComputedData.cStyle" @change="onchange1764756872857"></t-checkbox><t-radio id="t-radio-c9c2.38c884bc6" class="waterSourceWisetRecomme-t-radio-0-13"  :options="tRadiox0x13ComputedData.options" :active="tRadiox0x13ComputedData.active" :alias="tRadiox0x13ComputedData.alias" :disabled="tRadiox0x13ComputedData.disabled" :border="tRadiox0x13ComputedData.border" :size="tRadiox0x13ComputedData.size" :is-use-button="tRadiox0x13ComputedData.isUseButton" :c-style="tRadiox0x13ComputedData.cStyle" @change="onchange1764826916088"></t-radio><t-line id="t-line-f366.c42a28f96" class="waterSourceWisetRecomme-t-line-0-14"  :c-style="tLinex0x14ComputedData.cStyle"></t-line><t-line id="t-line-566f.f4d4b4b04" class="waterSourceWisetRecomme-t-line-0-15"  :c-style="tLinex0x15ComputedData.cStyle"></t-line><t-line id="t-line-84fb.fc8a1f9b3" class="waterSourceWisetRecomme-t-line-0-16"  :c-style="tLinex0x16ComputedData.cStyle"></t-line><t-line id="t-line-0c7c.094fcaa5e" class="waterSourceWisetRecomme-t-line-0-17"  :c-style="tLinex0x17ComputedData.cStyle"></t-line><t-text id="t-text-33fb.97b277483" class="waterSourceWisetRecomme-t-text-0-18"  :label="tTextx0x18ComputedData.label" :editable="tTextx0x18ComputedData.editable" :c-style="tTextx0x18ComputedData.cStyle" @mouseover="onmouseover1769146714567" @mouseout="onmouseout1769146732358"></t-text><t-line id="t-line-eff5.f99edaa96" class="waterSourceWisetRecomme-t-line-0-19"  :c-style="tLinex0x19ComputedData.cStyle"></t-line><t-line id="t-line-516e.d94cdda5d" class="waterSourceWisetRecomme-t-line-0-20"  :c-style="tLinex0x20ComputedData.cStyle"></t-line><t-line id="t-line-5651.2a383f2dd" class="waterSourceWisetRecomme-t-line-0-21"  :c-style="tLinex0x21ComputedData.cStyle"></t-line><t-line id="t-line-212c.f5c04620e" class="waterSourceWisetRecomme-t-line-0-22"  :c-style="tLinex0x22ComputedData.cStyle"></t-line><t-text-common id="t-text-common-2a21.ccaf672f7" class="waterSourceWisetRecomme-t-text-common-0-23"  :label="tTextCommonx0x23ComputedData.label" :editable="tTextCommonx0x23ComputedData.editable" :c-style="tTextCommonx0x23ComputedData.cStyle"></t-text-common><t-text-common v-if="state.isShowTip === true" id="t-text-common-a27a.a9f3156dc" class="waterSourceWisetRecomme-t-text-common-0-24"  :label="tTextCommonx0x24ComputedData.label" :editable="tTextCommonx0x24ComputedData.editable" :c-style="tTextCommonx0x24ComputedData.cStyle"></t-text-common></div>
</template>
...
import { TButton, TCheckbox, TComponent, TLine, TListCardMultipleChoice, TRadio, TRect, TTable, TText, TTextCommon } from '@ths/design';
...
.t-l-c-waterSourceWisetRecomme .waterSourceWisetRecomme-t-rect-0-0 {
...
.t-l-c-waterSourceWisetRecomme .waterSourceWisetRecomme-t-rect-0-1 {
position: absolute !important;
top: 52px;
left: 0px;
width: 410px;
...
.t-l-c-waterSourceWisetRecomme .waterSourceWisetRecomme-t-list-card-multiple-choice-0-4 {
position: absolute !important;
top: 259px;
left: 617px;
width: 410px;
...
.t-l-c-waterSourceWisetRecomme .waterSourceWisetRecomme-t-button-0-5 {
position: absolute !important;
top: 567px;
left: 533px;
width: 46px;
...
.t-l-c-waterSourceWisetRecomme .waterSourceWisetRecomme-t-table-0-6 {
position: absolute !important;
top: 210px;
left: 0px;
width: 410px;
...
.t-l-c-waterSourceWisetRecomme .waterSourceWisetRecomme-t-component-0-8 {
position: absolute !important;
top: 10px;
left: 0px;
width: 410px;
...
.t-l-c-waterSourceWisetRecomme .waterSourceWisetRecomme-t-text-0-9 {
position: absolute !important;
top: 15px;
left: 33px;
width: 234px;
...
.t-l-c-waterSourceWisetRecomme .waterSourceWisetRecomme-t-rect-0-10 {
position: absolute !important;
top: 270px;
left: 332px;
width: 72px;
...
.t-l-c-waterSourceWisetRecomme .waterSourceWisetRecomme-t-rect-0-11 {
position: absolute !important;
top: 153px;
left: 334px;
width: 72px;
...
.t-l-c-waterSourceWisetRecomme .waterSourceWisetRecomme-t-checkbox-0-12 {
position: absolute !important;
top: 64px;
left: 98px;
width: 303px;
...
.t-l-c-waterSourceWisetRecomme .waterSourceWisetRecomme-t-radio-0-13 {
position: absolute !important;
top: 90px;
left: 18px;
width: 300px;
...
.t-l-c-waterSourceWisetRecomme .waterSourceWisetRecomme-t-line-0-14 {
position: absolute !important;
top: 177px;
left: 843px;
width: 1px;
...
.t-l-c-waterSourceWisetRecomme .waterSourceWisetRecomme-t-line-0-15 {
position: absolute !important;
top: 52px;
left: 464px;
width: 1px;
...
.t-l-c-waterSourceWisetRecomme .waterSourceWisetRecomme-t-line-0-16 {
position: absolute !important;
top: 51px;
left: 464px;
width: 6px;
...
.t-l-c-waterSourceWisetRecomme .waterSourceWisetRecomme-t-line-0-17 {
position: absolute !important;
top: 183px;
left: 838px;
width: 6px;
...
.t-l-c-waterSourceWisetRecomme .waterSourceWisetRecomme-t-text-0-18 {
position: absolute !important;
top: 17px;
left: 142px;
width: 16px;
...
.t-l-c-waterSourceWisetRecomme .waterSourceWisetRecomme-t-line-0-19 {
position: absolute !important;
top: 51px;
left: 843px;
width: 1px;
...
.t-l-c-waterSourceWisetRecomme .waterSourceWisetRecomme-t-line-0-20 {
position: absolute !important;
top: 51px;
left: 838px;
width: 6px;
...
.t-l-c-waterSourceWisetRecomme .waterSourceWisetRecomme-t-line-0-21 {
position: absolute !important;
top: 183px;
left: 463px;
width: 6px;
...
.t-l-c-waterSourceWisetRecomme .waterSourceWisetRecomme-t-line-0-22 {
position: absolute !important;
top: 178px;
left: 463px;
width: 1px;
...
.t-l-c-waterSourceWisetRecomme .waterSourceWisetRecomme-t-text-common-0-23 {
position: absolute !important;
top: 65px;
left: 20px;
width: auto;
...
.t-l-c-waterSourceWisetRecomme .waterSourceWisetRecomme-t-text-common-0-24 {
position: absolute !important;
top: 35px;
left: 9px;
width: 288px;

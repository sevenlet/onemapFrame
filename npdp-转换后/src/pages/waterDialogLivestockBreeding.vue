<template>
  <div id="t-l-c-waterDialogLivestockBreeding" class="t-l-c-waterDialogLivestockBreeding" ><t-rect id="t-rect-8252.1a4ade4f4" class="waterDialogLivestockBreeding-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle"></t-rect><t-component id="t-component-75a5.51539ef39" class="waterDialogLivestockBreeding-t-component-0-1"  :name="replaceCssVariables(filterData(state.activeTab, componentPropBindingMap?.['t-component-75a5.51539ef39']['name'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :c-style="tComponentx0x1ComputedData.cStyle" :src="tComponentx0x1ComputedData.src" :component-name="replaceCssVariables(filterData(state.activeTab, componentPropBindingMap?.['t-component-75a5.51539ef39']['componentName'].filters || []), global?.theme || global?.activeTheme || '默认主题')"></t-component><t-rect id="t-rect-71af.6d10fdece" class="waterDialogLivestockBreeding-t-rect-0-2"  :tip="tRectx0x2ComputedData.tip" :label="tRectx0x2ComputedData.label" :active="tRectx0x2ComputedData.active" :c-style="tRectx0x2ComputedData.cStyle"></t-rect><t-rect id="t-rect-e3a7.d7772ec8d" class="waterDialogLivestockBreeding-t-rect-0-3"  :tip="tRectx0x3ComputedData.tip" :label="tRectx0x3ComputedData.label" :active="tRectx0x3ComputedData.active" :c-style="tRectx0x3ComputedData.cStyle"></t-rect><t-rect id="t-rect-5577.0975bb8d2" class="waterDialogLivestockBreeding-t-rect-0-4"  :tip="tRectx0x4ComputedData.tip" :label="tRectx0x4ComputedData.label" :active="tRectx0x4ComputedData.active" :c-style="tRectx0x4ComputedData.cStyle"></t-rect><t-tabs v-if="state.isVideo === false" id="t-tabs-7982.ca024cba2" class="waterDialogLivestockBreeding-t-tabs-0-5"  :data="replaceCssVariables(filterData(state.tabList, componentPropBindingMap?.['t-tabs-7982.ca024cba2']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active-tab="replaceCssVariables(filterData(state.activeTab, componentPropBindingMap?.['t-tabs-7982.ca024cba2']['activeTab'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :tab-position-extend="tTabsx0x5ComputedData.tabPositionExtend" :stretch="tTabsx0x5ComputedData.stretch" :c-style="tTabsx0x5ComputedData.cStyle" @tab-click="ontabClick1768296041110_0_0"></t-tabs><t-tabs v-if="state.isVideo === true" id="t-tabs-36ee.81d7b3b28" class="waterDialogLivestockBreeding-t-tabs-0-6"  :data="replaceCssVariables(filterData(state.tabList, componentPropBindingMap?.['t-tabs-36ee.81d7b3b28']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active-tab="replaceCssVariables(filterData(state.activeTab, componentPropBindingMap?.['t-tabs-36ee.81d7b3b28']['activeTab'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :tab-position-extend="tTabsx0x6ComputedData.tabPositionExtend" :stretch="tTabsx0x6ComputedData.stretch" :c-style="tTabsx0x6ComputedData.cStyle" @tab-click="ontabClick1765166140136"></t-tabs><t-row id="t-row-a98e.97de7da75" class="waterDialogLivestockBreeding-t-row-0-8"  :c-style="tRowx0x8ComputedData.cStyle" :gutter="tRowx0x8ComputedData.gutter" :justify="tRowx0x8ComputedData.justify" :align="tRowx0x8ComputedData.align"><t-text id="t-text-8cba.b16affff7" class="waterDialogLivestockBreeding-t-text-0-8-0"  :label="replaceCssVariables(filterData(state.baseInfo.title, componentPropBindingMap?.['t-text-8cba.b16affff7']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x8x0ComputedData.editable" :c-style="tTextx0x8x0ComputedData.cStyle" :show-title="tTextx0x8x0ComputedData.showTitle"></t-text><t-rect v-if="state.baseInfo.alarmText !== ''" id="t-rect-4bb6.47291368" class="waterDialogLivestockBreeding-t-rect-0-8-1"  :tip="tRectx0x8x1ComputedData.tip" :label="tRectx0x8x1ComputedData.label" :active="tRectx0x8x1ComputedData.active" :c-style="tRectx0x8x1ComputedData.cStyle" @mouseover="onmouseover1733993886943" @mouseout="onmouseout1733993903757"></t-rect></t-row><t-rect v-if="state.baseInfo.alarmShow === true" id="t-rect-16fd.29080fd9c" class="waterDialogLivestockBreeding-t-rect-0-9"  :tip="tRectx0x9ComputedData.tip" :label="replaceCssVariables(filterData(state.baseInfo.alarmText, componentPropBindingMap?.['t-rect-16fd.29080fd9c']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x9ComputedData.active" :c-style="tRectx0x9ComputedData.cStyle"></t-rect><t-rect id="t-rect-da62.857f90ab" class="waterDialogLivestockBreeding-t-rect-0-10"  :tip="tRectx0x10ComputedData.tip" :label="tRectx0x10ComputedData.label" :active="tRectx0x10ComputedData.active" :c-style="tRectx0x10ComputedData.cStyle" @click="onclick1733817210174"></t-rect><t-row id="t-row-6365.97c68ed82" class="waterDialogLivestockBreeding-t-row-0-11"  :c-style="tRowx0x11ComputedData.cStyle" :gutter="tRowx0x11ComputedData.gutter" :justify="tRowx0x11ComputedData.justify" :align="tRowx0x11ComputedData.align"><t-text id="t-text-630e.1af9131a3" class="waterDialogLivestockBreeding-t-text-0-11-0"  :label="tTextx0x11x0ComputedData.label" :editable="tTextx0x11x0ComputedData.editable" :c-style="tTextx0x11x0ComputedData.cStyle" @click="onclick1734068220296"></t-text><t-text id="t-text-19bd.a994fa29f" class="waterDialogLivestockBreeding-t-text-0-11-2"  :label="tTextx0x11x2ComputedData.label" :editable="tTextx0x11x2ComputedData.editable" :c-style="tTextx0x11x2ComputedData.cStyle" @click="onclick1734067550409"></t-text></t-row></div>
</template>
...
// 获取当前组件的名称
let componentName = 'waterDialogLivestockBreeding';
// 定义style元素的id
...
.t-l-c-waterDialogLivestockBreeding .waterDialogLivestockBreeding-t-rect-0-0 {
...
.t-l-c-waterDialogLivestockBreeding .waterDialogLivestockBreeding-t-component-0-1 {
position: absolute !important;
top: 63px;
left: 176px;
width: 824px;
...
.t-l-c-waterDialogLivestockBreeding .waterDialogLivestockBreeding-t-rect-0-2 {
position: absolute !important;
top: 660px;
left: 0px;
width: 1020px;
...
.t-l-c-waterDialogLivestockBreeding .waterDialogLivestockBreeding-t-rect-0-3 {
position: absolute !important;
top: 0px;
left: 0px;
width: 1020px;
...
.t-l-c-waterDialogLivestockBreeding .waterDialogLivestockBreeding-t-rect-0-4 {
position: absolute !important;
top: 63px;
left: 20px;
width: 140px;
...
.t-l-c-waterDialogLivestockBreeding .waterDialogLivestockBreeding-t-tabs-0-5 {
position: absolute !important;
top: 76px;
left: 22px;
width: 130px;
...
.t-l-c-waterDialogLivestockBreeding .waterDialogLivestockBreeding-t-tabs-0-6 {
position: absolute !important;
top: 66px;
left: 22px;
width: 130px;
...
.t-l-c-waterDialogLivestockBreeding .waterDialogLivestockBreeding-t-row-0-8 {
position: absolute !important;
top: 0px;
left: 18px;
width: 500px;
...
.t-l-c-waterDialogLivestockBreeding .waterDialogLivestockBreeding-t-text-0-8-0 {
position: unset;
top: 13px;
left: 16px;
width: auto;
...
.t-l-c-waterDialogLivestockBreeding .waterDialogLivestockBreeding-t-rect-0-8-1 {
position: unset;
top: 14px;
left: 399px;
width: 20px;
...
.t-l-c-waterDialogLivestockBreeding .waterDialogLivestockBreeding-t-rect-0-9 {
position: absolute !important;
top: 39px;
left: 254px;
width: 297px;
...
.t-l-c-waterDialogLivestockBreeding .waterDialogLivestockBreeding-t-rect-0-10 {
position: absolute !important;
top: 11px;
left: 971px;
width: 24px;
...
.t-l-c-waterDialogLivestockBreeding .waterDialogLivestockBreeding-t-row-0-11 {
position: absolute !important;
top: 672px;
left: 570px;
width: 430px;
...
.t-l-c-waterDialogLivestockBreeding .waterDialogLivestockBreeding-t-text-0-11-0 {
position: unset;
top: 670px;
left: 669px;
width: auto;
...
.t-l-c-waterDialogLivestockBreeding .waterDialogLivestockBreeding-t-text-0-11-2 {
position: unset;
top: 670px;
left: 870px;
width: auto;

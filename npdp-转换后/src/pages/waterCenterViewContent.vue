<template>
  <div id="t-l-c-waterCenterViewContent" class="t-l-c-waterCenterViewContent" ><t-button id="t-button-cb37.8d1da106b" class="waterCenterViewContent-t-button-0-0"  :label="tButtonx0x0ComputedData.label" :round="tButtonx0x0ComputedData.round" :plain="tButtonx0x0ComputedData.plain" :disabled="tButtonx0x0ComputedData.disabled" :type="tButtonx0x0ComputedData.type" :size="tButtonx0x0ComputedData.size" :native-type="tButtonx0x0ComputedData.native-type" :c-style="tButtonx0x0ComputedData.cStyle" @click="onclick1766369515905"></t-button><t-button id="t-button-d590.3071cb69c" class="waterCenterViewContent-t-button-0-1"  :label="tButtonx0x1ComputedData.label" :round="tButtonx0x1ComputedData.round" :plain="tButtonx0x1ComputedData.plain" :disabled="tButtonx0x1ComputedData.disabled" :type="tButtonx0x1ComputedData.type" :size="tButtonx0x1ComputedData.size" :native-type="tButtonx0x1ComputedData.native-type" :c-style="tButtonx0x1ComputedData.cStyle" @click="onclick1766370462065"></t-button></div>
</template>
...
import { TButton } from '@ths/design';
...
.t-l-c-waterCenterViewContent .waterCenterViewContent-t-button-0-0 {
...
.t-l-c-waterCenterViewContent .waterCenterViewContent-t-button-0-1 {
position: absolute !important;
top: 38px;
left: 320px;
width: 80px;

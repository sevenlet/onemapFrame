<template>
  <div id="t-l-c-airOverviewSiteRealtimeMonitor" class="t-l-c-airOverviewSiteRealtimeMonitor" ><t-row id="t-row-c739.cc6a815eb" class="airOverviewSiteRealtimeMonitor-t-row-0-0"  :c-style="tRowx0x0ComputedData.cStyle" :gutter="tRowx0x0ComputedData.gutter" :justify="tRowx0x0ComputedData.justify" :align="tRowx0x0ComputedData.align"><t-col id="t-col-28e1.e113afff9" class="airOverviewSiteRealtimeMonitor-t-col-0-0-0"  :span="tColx0x0x0ComputedData.span" :offset="tColx0x0x0ComputedData.offset" :push="tColx0x0x0ComputedData.push" :pull="tColx0x0x0ComputedData.pull" :c-style="tColx0x0x0ComputedData.cStyle"><t-tabs-base id="t-tabs-base-3c0e.5a8cc13d1" class="airOverviewSiteRealtimeMonitor-t-tabs-base-0-0-0-0"  :data="replaceCssVariables(filterData(state.dateList, componentPropBindingMap?.['t-tabs-base-3c0e.5a8cc13d1']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :space="tTabsBasex0x0x0x0ComputedData.space" :selected-tab-val="replaceCssVariables(filterData(state.tabSelect, componentPropBindingMap?.['t-tabs-base-3c0e.5a8cc13d1']['selectedTabVal'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :inner-shadow-color="tTabsBasex0x0x0x0ComputedData.innerShadowColor" :active-inner-shadow-color="tTabsBasex0x0x0x0ComputedData.activeInnerShadowColor" :alias="tTabsBasex0x0x0x0ComputedData.alias" :c-style="tTabsBasex0x0x0x0ComputedData.cStyle" @tab-click="ontabClick1733996453368"></t-tabs-base></t-col><t-col id="t-col-e8c6.56e7dba23" class="airOverviewSiteRealtimeMonitor-t-col-0-0-1"  :span="tColx0x0x1ComputedData.span" :offset="tColx0x0x1ComputedData.offset" :push="tColx0x0x1ComputedData.push" :pull="tColx0x0x1ComputedData.pull" :c-style="tColx0x0x1ComputedData.cStyle"><t-date-picker id="t-date-picker-c174.45d4e20dc" class="airOverviewSiteRealtimeMonitor-t-date-picker-0-0-1-0"  :placeholder="tDatePickerx0x0x1x0ComputedData.placeholder" :start-placeholder="tDatePickerx0x0x1x0ComputedData.startPlaceholder" :end-placeholder="tDatePickerx0x0x1x0ComputedData.endPlaceholder" :type="replaceCssVariables(filterData(state.dateType, componentPropBindingMap?.['t-date-picker-c174.45d4e20dc']['type'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :clearable="tDatePickerx0x0x1x0ComputedData.clearable" :range-separator="tDatePickerx0x0x1x0ComputedData.rangeSeparator" :default-date="replaceCssVariables(filterData(state.dateValue, componentPropBindingMap?.['t-date-picker-c174.45d4e20dc']['default-date'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :separator="tDatePickerx0x0x1x0ComputedData.separator" :readonly="tDatePickerx0x0x1x0ComputedData.readonly" :editable="tDatePickerx0x0x1x0ComputedData.editable" :c-style="tDatePickerx0x0x1x0ComputedData.cStyle" :is-disabled-front="tDatePickerx0x0x1x0ComputedData.isDisabledFront" :disabled-date="replaceCssVariables(filterData(state.maxTimeValue, componentPropBindingMap?.['t-date-picker-c174.45d4e20dc']['disabledDate'].filters || []), global?.theme || global?.activeTheme || '默认主题')" @date-change="ondateChange1733996734046"></t-date-picker></t-col></t-row><t-component id="t-component-af20.b174cdac5" class="airOverviewSiteRealtimeMonitor-t-component-0-1"  :name="tComponentx0x1ComputedData.name" :loading="tComponentx0x1ComputedData.loading" :c-style="tComponentx0x1ComputedData.cStyle" :src="tComponentx0x1ComputedData.src" :component-name="tComponentx0x1ComputedData.componentName" :page-id="tComponentx0x1ComputedData.pageId" :page-code="tComponentx0x1ComputedData.pageCode"></t-component></div>
</template>
...
import { TCol, TComponent, TDatePicker, TRow, TTabsBase } from '@ths/design';
...
const state = reactive({
   ...
   firstPollution: "首污：--",
   PM25Data: [{"title":"PM₂.₅","num":"--","unit":"μg/m³","icon":"assets/images/2024-12-13/993839d628174cb8804f4d31d2ba3ba3.png","color":"#AAA"}],
   PM10Data: [{"title":"PM₁₀","num":"--","unit":"μg/m³","icon":"assets/images/2024-12-13/993839d628174cb8804f4d31d2ba3ba3.png","color":"#AAA"}],
   SO2Data: [{"title":"SO₂","num":"--","unit":"μg/m³","icon":"assets/images/2024-12-13/993839d628174cb8804f4d31d2ba3ba3.png","color":"#AAA"}],
   NO2Data: [{"title":"NO₂","num":"--","unit":"μg/m³","icon":"assets/images/2024-12-13/993839d628174cb8804f4d31d2ba3ba3.png","color":"#AAA"}],
   NOData: [{"title":"NO","num":"--","unit":"μg/m³","icon":"assets/images/2024-12-13/993839d628174cb8804f4d31d2ba3ba3.png","color":"#AAA"}],
   COData: [{"title":"CO","num":"--","unit":"mg/m³","icon":"assets/images/2024-12-13/993839d628174cb8804f4d31d2ba3ba3.png","color":"#AAA"}],
   O3Data: [{"title":"O₃","num":"--","unit":"μg/m³","icon":"assets/images/2024-12-13/993839d628174cb8804f4d31d2ba3ba3.png","color":"#AAA"}],
   O38hData: [{"title":"O₃-8h","num":"--","unit":"μg/m³","icon":"assets/images/2024-12-13/993839d628174cb8804f4d31d2ba3ba3.png","color":"#AAA"}],
});
// 选中的图表主题
...
<style scoped>
.t-l-c-airOverviewSiteRealtimeMonitor {
position: relative;
overflow: hidden;
...
.t-l-c-airOverviewSiteRealtimeMonitor .airOverviewSiteRealtimeMonitor-t-row-0-0 {
...
.t-l-c-airOverviewSiteRealtimeMonitor .airOverviewSiteRealtimeMonitor-t-col-0-0-0 {
position: relative;
top: null;
left: null;
width: 100px;
...
.t-l-c-airOverviewSiteRealtimeMonitor .airOverviewSiteRealtimeMonitor-t-tabs-base-0-0-0-0 {
position: unset;
top: 0px;
left: 0px;
width: 300px;
...
.t-l-c-airOverviewSiteRealtimeMonitor .airOverviewSiteRealtimeMonitor-t-col-0-0-1 {
position: relative;
top: null;
left: null;
width: 100px;
...
.t-l-c-airOverviewSiteRealtimeMonitor .airOverviewSiteRealtimeMonitor-t-date-picker-0-0-1-0 {
position: unset;
top: 1px;
left: 492px;
width: 296px;
...
.t-l-c-airOverviewSiteRealtimeMonitor .airOverviewSiteRealtimeMonitor-t-component-0-1 {
position: absolute !important;
top: 81px;
left: 0px;
width: 788px;

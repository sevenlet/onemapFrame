<template>
  <div id="t-l-c-airOverviewPollutantCompareTit" class="t-l-c-airOverviewPollutantCompareTit" ><t-component id="t-component-6f3b.f3ecc4cb7" class="airOverviewPollutantCompareTit-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName"></t-component><t-text id="t-text-dea6.bbc8e049" class="airOverviewPollutantCompareTit-t-text-0-1"  :label="tTextx0x1ComputedData.label" :editable="tTextx0x1ComputedData.editable" :c-style="tTextx0x1ComputedData.cStyle" :label-raw="tTextx0x1ComputedData.labelRaw"></t-text><t-text-unit id="t-text-unit-b958.1a33be609" class="airOverviewPollutantCompareTit-t-text-unit-0-2"  :c-style="tTextUnitx0x2ComputedData.cStyle" :justify="tTextUnitx0x2ComputedData.justify" :align="tTextUnitx0x2ComputedData.align" :content="global.regionaQuery.businessRegionName" :unit="tTextUnitx0x2ComputedData.unit" :show-overflow-tooltip="tTextUnitx0x2ComputedData.showOverflowTooltip"></t-text-unit></div>
</template>
...
import { TComponent, TText, TTextUnit } from '@ths/design';
...
<style scoped>
.t-l-c-airOverviewPollutantCompareTit {
position: relative;
overflow: hidden;
...
.t-l-c-airOverviewPollutantCompareTit .airOverviewPollutantCompareTit-t-component-0-0 {
...
.t-l-c-airOverviewPollutantCompareTit .airOverviewPollutantCompareTit-t-text-0-1 {
position: absolute !important;
top: 34px;
left: 210px;
width: 198px;
...
.t-l-c-airOverviewPollutantCompareTit .airOverviewPollutantCompareTit-t-text-unit-0-2 {
position: absolute !important;
top: 6px;
left: 34px;
width: 333px;

<template>
  <div id="t-l-c-stationWarningReal" class="t-l-c-stationWarningReal" ><t-component id="t-component-e556.d092b42c2" class="stationWarningReal-t-component-0-0"  :name="tComponentx0x0ComputedData.name" :c-style="tComponentx0x0ComputedData.cStyle" :src="tComponentx0x0ComputedData.src" :component-name="tComponentx0x0ComputedData.componentName"></t-component><t-text-unit id="t-text-unit-df7d.0c301e461" class="stationWarningReal-t-text-unit-0-1"  :c-style="tTextUnitx0x1ComputedData.cStyle" :justify="tTextUnitx0x1ComputedData.justify" :align="tTextUnitx0x1ComputedData.align" :content="tTextUnitx0x1ComputedData.content" :unit="tTextUnitx0x1ComputedData.unit" :show-overflow-tooltip="tTextUnitx0x1ComputedData.showOverflowTooltip"></t-text-unit><t-list-card id="t-list-card-3c01.11cf987e8" class="stationWarningReal-t-list-card-0-2"  :data="replaceCssVariables(filterData(state.warningStatistics, componentPropBindingMap?.['t-list-card-3c01.11cf987e8']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :spacing-x="tListCardx0x2ComputedData.spacingX" :col="tListCardx0x2ComputedData.col" :direction="tListCardx0x2ComputedData.direction" :exchange-order="tListCardx0x2ComputedData.exchangeOrder" :unit-break="tListCardx0x2ComputedData.unitBreak" :key-field="tListCardx0x2ComputedData.keyField" :active-key-field="tListCardx0x2ComputedData.activeKeyField" :active="replaceCssVariables(filterData(state.status, componentPropBindingMap?.['t-list-card-3c01.11cf987e8']['active'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :c-style="tListCardx0x2ComputedData.cStyle" @card-click="oncardClick1766389115445_0_0"></t-list-card><t-table id="t-table-f4d9.66b63002d" class="stationWarningReal-t-table-0-6"  :height="tTablex0x6ComputedData.height" :stripe="tTablex0x6ComputedData.stripe" :border="tTablex0x6ComputedData.border" :auto-scroll="tTablex0x6ComputedData.autoScroll" :speed="tTablex0x6ComputedData.speed" :columns="tTablex0x6ComputedData.columns" :data="replaceCssVariables(filterData(state.listData, componentPropBindingMap?.['t-table-f4d9.66b63002d']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :default-sort="tTablex0x6ComputedData.defaultSort" :c-style="tTablex0x6ComputedData.cStyle" :empty-text="tTablex0x6ComputedData.emptyText" @cell-click="oncellClick1762410432035_0_0"></t-table><t-image-base id="t-image-base-1fcf.2ed139805" class="stationWarningReal-t-image-base-0-7"  :src="tImageBasex0x7ComputedData.src" :fit="tImageBasex0x7ComputedData.fit" :c-style="tImageBasex0x7ComputedData.cStyle"></t-image-base><t-image-base id="t-image-base-404c.c4b1b17aa" class="stationWarningReal-t-image-base-0-8"  :src="tImageBasex0x8ComputedData.src" :fit="tImageBasex0x8ComputedData.fit" :c-style="tImageBasex0x8ComputedData.cStyle"></t-image-base><t-image-base id="t-image-base-ed38.ea8bc6932" class="stationWarningReal-t-image-base-0-9"  :src="tImageBasex0x9ComputedData.src" :fit="tImageBasex0x9ComputedData.fit" :c-style="tImageBasex0x9ComputedData.cStyle"></t-image-base></div>
</template>
...
import { TComponent, TImageBase, TListCard, TTable, TTextUnit } from '@ths/design';
...
const state = reactive({
   ...
   startTime: "",
   moniterTime: "",
   warningStatistics: [{"station_status":"0","station_status_name":"全部","total":"0","color":"var(--business-white)","unit":"个","title":"1,2,3"},{"station_status":"0","station_status_name":"红色报警","total":"0","color":"#FF2B2B","unit":"个","title":"1","selectIcon":"assets/images/2025-12-22/d099c8ca00ca449bb70fcb28de1ba1a4.gif"},{"station_status":"0","station_status_name":"橙色报警","total":"0","color":"#FF7E00","unit":"个","title":"2"},{"station_status":"0","station_status_name":"黄色报警","total":"0","color":"#EEBD10","unit":"个","title":"3"}],
   ...
   status: "1,2,3",
   cardList: [{"station_status":"0","station_status_name":"全部","total":"1","color":"var(--business-white)","unit":"个","title":"0"},{"station_status":"0","station_status_name":"红色报警","total":"1","color":"#FF2B2B","unit":"个","title":"1","selectIcon":"assets/images/2025-12-22/d099c8ca00ca449bb70fcb28de1ba1a4.gif"},{"station_status":"0","station_status_name":"橙色报警","total":"1","color":"#FF7E00","unit":"个","title":"2"},{"station_status":"0","station_status_name":"黄色报警","total":"1","color":"#EEBD10","unit":"个","title":"3"}],
});
// 选中的图表主题
...
src:"assets/images/2025-12-22/d099c8ca00ca449bb70fcb28de1ba1a4.gif",
fit:"fill",
...
src:"assets/images/2025-12-23/ca8b1d207b394dc8ba6162112d0a6bb7.gif",
fit:"fill",
...
src:"assets/images/2025-12-23/c9a5791c06e547efac4fcdb9145a0399.gif",
fit:"fill",
...
.t-l-c-stationWarningReal .stationWarningReal-t-component-0-0 {
...
.t-l-c-stationWarningReal .stationWarningReal-t-text-unit-0-1 {
position: absolute !important;
top: 1px;
left: 37px;
width: 230px;
...
.t-l-c-stationWarningReal .stationWarningReal-t-list-card-0-2 {
position: absolute !important;
top: 48px;
left: -1px;
width: 420px;
...
.t-l-c-stationWarningReal .stationWarningReal-t-table-0-6 {
position: absolute !important;
top: 130px;
left: 2px;
width: 410px;
...
.t-l-c-stationWarningReal .stationWarningReal-t-image-base-0-7 {
position: absolute !important;
top: 59px;
left: 116px;
width: 12px;
...
.t-l-c-stationWarningReal .stationWarningReal-t-image-base-0-8 {
position: absolute !important;
top: 59px;
left: 219px;
width: 12px;
...
.t-l-c-stationWarningReal .stationWarningReal-t-image-base-0-9 {
position: absolute !important;
top: 59px;
left: 321px;
width: 12px;

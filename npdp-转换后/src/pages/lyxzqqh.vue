<template>
  <div id="t-l-c-lyxzqqh" class="t-l-c-lyxzqqh" ><t-row id="t-row-3ab0.004e32a37" class="lyxzqqh-t-row-0-1"  :c-style="tRowx0x1ComputedData.cStyle" :gutter="tRowx0x1ComputedData.gutter" :justify="tRowx0x1ComputedData.justify" :align="tRowx0x1ComputedData.align"><t-checkbox id="t-checkbox-9e14.354734339" class="lyxzqqh-t-checkbox-0-1-0"  :data="tCheckboxx0x1x0ComputedData.data" :active="replaceCssVariables(filterData(state.basinSelect, componentPropBindingMap?.['t-checkbox-9e14.354734339']['active'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :data-alias="tCheckboxx0x1x0ComputedData.dataAlias" :border="tCheckboxx0x1x0ComputedData.border" :use-button="tCheckboxx0x1x0ComputedData.useButton" :c-style="tCheckboxx0x1x0ComputedData.cStyle" @change="onchange1735122132777"></t-checkbox><t-checkbox id="t-checkbox-61c7.80ae9d956" class="lyxzqqh-t-checkbox-0-1-1"  :data="tCheckboxx0x1x1ComputedData.data" :active="replaceCssVariables(filterData(state.regionSelect, componentPropBindingMap?.['t-checkbox-61c7.80ae9d956']['active'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :data-alias="tCheckboxx0x1x1ComputedData.dataAlias" :border="tCheckboxx0x1x1ComputedData.border" :use-button="tCheckboxx0x1x1ComputedData.useButton" :c-style="tCheckboxx0x1x1ComputedData.cStyle" @change="onchange1763191978076_0_0"></t-checkbox></t-row></div>
</template>
...
import { TCheckbox, TRow } from '@ths/design';
...
.t-l-c-lyxzqqh .lyxzqqh-t-row-0-1 {
...
align-items: center;
background-color: var(--business-dialog-title-bg);
...
.t-l-c-lyxzqqh .lyxzqqh-t-checkbox-0-1-0 {
position: unset;
top: 4px;
left: 13px;
width: auto;
...
.t-l-c-lyxzqqh .lyxzqqh-t-checkbox-0-1-1 {
position: unset;
top: 7px;
left: 84px;
width: auto;

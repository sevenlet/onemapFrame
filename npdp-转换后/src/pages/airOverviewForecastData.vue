<template>
  <div id="t-l-c-airOverviewForecastData" class="t-l-c-airOverviewForecastData" ><t-list-card-weather-forecast v-if="state.weatherForecast.length !== 0" id="t-list-card-weather-forecast-3a0a.01fa53d42" class="airOverviewForecastData-t-list-card-weather-forecast-0-0"  :data="replaceCssVariables(filterData(state.weatherForecast, componentPropBindingMap?.['t-list-card-weather-forecast-3a0a.01fa53d42']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :c-style="tListCardWeatherForecastx0x0ComputedData.cStyle" :gap="tListCardWeatherForecastx0x0ComputedData.gap" :other-indicator-style="tListCardWeatherForecastx0x0ComputedData.otherIndicatorStyle" :temperature-unit="replaceCssVariables(filterData(state.temperatureUnit, componentPropBindingMap?.['t-list-card-weather-forecast-3a0a.01fa53d42']['temperatureUnit'].filters || []), global?.theme || global?.activeTheme || '默认主题')"></t-list-card-weather-forecast><t-chart-design v-if="state.weatherForecast.length !== 0" id="t-chart-design-870b.fa2315b82" class="airOverviewForecastData-t-chart-design-0-1"  :empty-img="tChartDesignx0x1ComputedData.emptyImg" :c-style="tChartDesignx0x1ComputedData.cStyle" :options="replaceCssVariables(filterData(state.chartOption, componentPropBindingMap?.['t-chart-design-870b.fa2315b82']['options'].filters || []), global?.theme || global?.activeTheme || '默认主题')"></t-chart-design><t-text v-if="state.weatherForecast.length === 0" id="t-text-1818.018b69ab3" class="airOverviewForecastData-t-text-0-2"  :label="tTextx0x2ComputedData.label" :editable="tTextx0x2ComputedData.editable" :c-style="tTextx0x2ComputedData.cStyle"></t-text></div>
</template>
...
import { TChartDesign, TListCardWeatherForecast, TText } from '@ths/design';

export default {
  components: {
    TChartDesign,
    TListCardWeatherForecast,
    TText,
  },
  setup() {
...
.t-l-c-airOverviewForecastData .airOverviewForecastData-t-list-card-weather-forecast-0-0 {
...
.t-l-c-airOverviewForecastData .airOverviewForecastData-t-chart-design-0-1 {
position: absolute !important;
top: 102px;
left: 0px;
width: 410px;
...
.t-l-c-airOverviewForecastData .airOverviewForecastData-t-text-0-2 {
position: absolute !important;
top: 0px;
left: 1px;
width: 410px;

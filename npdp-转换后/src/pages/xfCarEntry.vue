...
const state = reactive({
   screenSize: "",
   componentName: "xfCarContentComponent",
});
// 选中的图表主题
...
tComponentx0x0: {
defaultStyle: {
            default: {"width":"450px","height":"904px","margin":"0 auto","position":"relative","left":"0px","top":"0px"},
            
            },
 default: { 
 
name:"xfCarContentComponent",
loading:true,
cStyle:{"wrapper":{"default":{"width":"450px","height":"904px","margin":"0 auto","position":"relative","left":"0px","top":"0px"}}},
...
if (tabValue !== state.tabSelect) {
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-xfCarEntry', global.appScaleMode, 'normal');
...
handleWindowResize();
/* 接收socket.io消息 */
const onSocketChanged3d4395f892e470e9610 = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChanged3d4395f892e470e9610);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChanged3d4395f892e470e9610);
});
/* 接收socket.io消息 */
const onSocketChange1548c2b1fa0f4dc4b102 = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChange1548c2b1fa0f4dc4b102);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChange1548c2b1fa0f4dc4b102);
});
/* 接收socket.io消息 */
const onSocketChange986c804d16d24f81bb64 = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChange986c804d16d24f81bb64);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChange986c804d16d24f81bb64);
});
/* 接收socket.io消息 */
const onSocketChangeba9422a9e52444009293 = function (data) {
if(data.type === "closeTrajectoryWaterSprinkler"){
try{
// 设置变量值
state.componentName = 'xfCarContentComponent';
} catch (error) {
console.error('参数格式错误', error);
};
};
};rootData.rootOn('rootSocket:change', onSocketChangeba9422a9e52444009293);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChangeba9422a9e52444009293);
});
});
// 页面离开时的操作
onUnmounted(() => {
...
.t-l-c-xfCarEntry .xfCarEntry-t-component-0-0 {

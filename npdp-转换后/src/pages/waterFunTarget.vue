<template>
  <div id="t-l-c-waterFunTarget" class="t-l-c-waterFunTarget" ><t-rect id="t-rect-7c02.8fd5deb0a" class="waterFunTarget-t-rect-0-0"  :tip="componentState.tRectx0x0.tip" label="" :active="componentState.tRectx0x0.active" :c-style="componentState.tRectx0x0.cStyle"></t-rect><t-select id="t-select-edde.7b8816b3a" class="waterFunTarget-t-select-0-1"  :active-value="state.params.level" :options="state.levelOptions" :alias="componentState.tSelectx0x1.alias" :multiple="componentState.tSelectx0x1.multiple" placeholder="请选择" :clearable="componentState.tSelectx0x1.clearable" :disabled="componentState.tSelectx0x1.disabled" name="" autocomplete="off" :filterable="componentState.tSelectx0x1.filterable" no-match-text="无匹配数据" no-data-text="无数据" :c-style="componentState.tSelectx0x1.cStyle" @change="onchange1734068801469"></t-select><t-table v-if="global.regionaQuery.regionType === 'wsystem'" id="t-table-95e9.5ac4fb8ac" class="waterFunTarget-t-table-0-2"  height="238" :stripe="componentState.tTablex0x2.stripe" :border="componentState.tTablex0x2.border" :auto-scroll="componentState.tTablex0x2.autoScroll" :speed="6" :columns="componentState.tTablex0x2.columns" :data="state.list" :default-sort="componentState.tTablex0x2.defaultSort" :c-style="componentState.tTablex0x2.cStyle"></t-table><t-table v-if="global.regionaQuery.regionType === 'region'" id="t-table-7702.e927e9a4d" class="waterFunTarget-t-table-0-3"  height="238" :stripe="componentState.tTablex0x3.stripe" :border="componentState.tTablex0x3.border" :auto-scroll="componentState.tTablex0x3.autoScroll" :speed="6" :columns="componentState.tTablex0x3.columns" :data="state.list" :default-sort="componentState.tTablex0x3.defaultSort" :c-style="componentState.tTablex0x3.cStyle" @cell-click="oncellClick1734072647370"></t-table><t-date-picker id="t-date-picker-b078.d04348d99" class="waterFunTarget-t-date-picker-0-4"  placeholder="请选择" start-placeholder="开始日期" end-placeholder="结束日期" type="month" :clearable="componentState.tDatePickerx0x4.clearable" range-separator="-" :default-date="state.params.time" separator="-" :readonly="componentState.tDatePickerx0x4.readonly" :editable="componentState.tDatePickerx0x4.editable" :c-style="componentState.tDatePickerx0x4.cStyle" @date-change="ondateChange1734068814191"></t-date-picker><t-list-card id="t-list-card-cde2.e72088c42" class="waterFunTarget-t-list-card-0-5"  :data="state.statisticalCard" :spacing-x="8" :col="3" direction="vertical" :exchange-order="componentState.tListCardx0x5.exchangeOrder" :unit-break="componentState.tListCardx0x5.unitBreak" :key-field="componentState.tListCardx0x5.keyField" active-key-field="title" active="" :c-style="componentState.tListCardx0x5.cStyle"></t-list-card><t-component id="t-component-9f0e.1949b66de" class="waterFunTarget-t-component-0-6"  name="titleFirstBgComponent" :c-style="componentState.tComponentx0x6.cStyle" src="/lego-generated-apps/lego_file/app/src/27d54c897f0f4ba18421a7b587fe4ce4_12/index.html#/titleFirstBg" component-name="titleFirstBgComponent"></t-component><t-component id="t-component-7ac8.eb382f029" class="waterFunTarget-t-component-0-7"  name="titleFirstBgComponent" :c-style="componentState.tComponentx0x7.cStyle" src="/lego-generated-apps/lego_file/app/src/27d54c897f0f4ba18421a7b587fe4ce4_12/index.html#/titleFirstBg" component-name="titleFirstBgComponent"></t-component><t-text v-if="global.regionaQuery.regionType === 'wsystem'" id="t-text-f25c.09c5d408" class="waterFunTarget-t-text-0-8"  label="流域考核结果" :editable="componentState.tTextx0x8.editable" :c-style="componentState.tTextx0x8.cStyle"></t-text><t-text id="t-text-81b8.e509832ec" class="waterFunTarget-t-text-0-9"  label="各类水功能区达标情势" :editable="componentState.tTextx0x9.editable" :c-style="componentState.tTextx0x9.cStyle"></t-text><t-chart-bar-simple id="t-chart-bar-simple-d133.3907a3252" class="waterFunTarget-t-chart-bar-simple-0-10"  :empty-img="state.noDataImg" :c-style="componentState.tChartBarSimplex0x10.cStyle" :options="componentState.tChartBarSimplex0x10.options" :data="state.barData" :series-setting="componentState.tChartBarSimplex0x10.seriesSetting" :bar="componentState.tChartBarSimplex0x10.bar"></t-chart-bar-simple><t-text v-if="global.regionaQuery.regionType === 'region'" id="t-text-631e.7334d647c" class="waterFunTarget-t-text-0-11"  label="区域考核结果" :editable="componentState.tTextx0x11.editable" :c-style="componentState.tTextx0x11.cStyle"></t-text><t-component id="t-component-6b34.5ec886b6a" class="waterFunTarget-t-component-0-12"  name="titleFirstBgComponent" :c-style="componentState.tComponentx0x12.cStyle" src="/lego-generated-apps/lego_file/app/src/27d54c897f0f4ba18421a7b587fe4ce4_12/index.html#/titleFirstBg" component-name="titleFirstBgComponent"></t-component><t-text id="t-text-aef2.cf14959ee" class="waterFunTarget-t-text-0-13"  label="水功能区达标情势" :editable="componentState.tTextx0x13.editable" :c-style="componentState.tTextx0x13.cStyle"></t-text></div>
</template>
...
import { TChartBarSimple, TComponent, TDatePicker, TListCard, TRect, TSelect, TTable, TText } from '@ths/design';
...
.t-l-c-waterFunTarget .waterFunTarget-t-rect-0-0 {
...
.t-l-c-waterFunTarget .waterFunTarget-t-select-0-1 {
position: absolute !important;
top: 16px;
left: 16px;
width: 132px;
...
.t-l-c-waterFunTarget .waterFunTarget-t-table-0-2 {
position: absolute !important;
top: 591px;
left: 20px;
width: 410px;
...
.t-l-c-waterFunTarget .waterFunTarget-t-table-0-3 {
position: absolute !important;
top: 591px;
left: 20px;
width: 410px;
...
.t-l-c-waterFunTarget .waterFunTarget-t-date-picker-0-4 {
position: absolute !important;
top: 16px;
left: 160px;
width: 132px;
...
.t-l-c-waterFunTarget .waterFunTarget-t-list-card-0-5 {
position: absolute !important;
top: 129px;
left: 16px;
width: 418px;
...
.t-l-c-waterFunTarget .waterFunTarget-t-component-0-6 {
position: absolute !important;
top: 229px;
left: 20px;
width: 410px;
...
.t-l-c-waterFunTarget .waterFunTarget-t-component-0-7 {
position: absolute !important;
top: 547px;
left: 21px;
width: 410px;
...
.t-l-c-waterFunTarget .waterFunTarget-t-text-0-8 {
position: absolute !important;
top: 552px;
left: 61px;
width: 200px;
...
.t-l-c-waterFunTarget .waterFunTarget-t-text-0-9 {
position: absolute !important;
top: 234px;
left: 60px;
width: 210px;
...
.t-l-c-waterFunTarget .waterFunTarget-t-chart-bar-simple-0-10 {
position: absolute !important;
top: 272px;
left: 19px;
width: 410px;
...
.t-l-c-waterFunTarget .waterFunTarget-t-text-0-11 {
position: absolute !important;
top: 552px;
left: 61px;
width: 200px;
...
.t-l-c-waterFunTarget .waterFunTarget-t-component-0-12 {
position: absolute !important;
top: 88px;
left: 20px;
width: 410px;
...
.t-l-c-waterFunTarget .waterFunTarget-t-text-0-13 {
position: absolute !important;
top: 93px;
left: 60px;
width: 200px;

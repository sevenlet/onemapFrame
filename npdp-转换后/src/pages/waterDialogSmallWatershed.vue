<template>
  <div id="t-l-c-waterDialogSmallWatershed" class="t-l-c-waterDialogSmallWatershed" ><t-rect id="t-rect-8252.1a4ade4f4" class="waterDialogSmallWatershed-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle"></t-rect><t-component id="t-component-75a5.51539ef39" class="waterDialogSmallWatershed-t-component-0-1"  :name="replaceCssVariables(filterData(state.activeTab, componentPropBindingMap?.['t-component-75a5.51539ef39']['name'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :c-style="tComponentx0x1ComputedData.cStyle" :src="tComponentx0x1ComputedData.src" :component-name="replaceCssVariables(filterData(state.activeTab, componentPropBindingMap?.['t-component-75a5.51539ef39']['componentName'].filters || []), global?.theme || global?.activeTheme || '默认主题')"></t-component><t-rect id="t-rect-71af.6d10fdece" class="waterDialogSmallWatershed-t-rect-0-2"  :tip="tRectx0x2ComputedData.tip" :label="tRectx0x2ComputedData.label" :active="tRectx0x2ComputedData.active" :c-style="tRectx0x2ComputedData.cStyle"></t-rect><t-rect id="t-rect-e3a7.d7772ec8d" class="waterDialogSmallWatershed-t-rect-0-3"  :tip="tRectx0x3ComputedData.tip" :label="tRectx0x3ComputedData.label" :active="tRectx0x3ComputedData.active" :c-style="tRectx0x3ComputedData.cStyle"></t-rect><t-rect id="t-rect-5577.0975bb8d2" class="waterDialogSmallWatershed-t-rect-0-4"  :tip="tRectx0x4ComputedData.tip" :label="tRectx0x4ComputedData.label" :active="tRectx0x4ComputedData.active" :c-style="tRectx0x4ComputedData.cStyle"></t-rect><t-tabs id="t-tabs-d35f.71ff8fdc2" class="waterDialogSmallWatershed-t-tabs-0-5"  :data="replaceCssVariables(filterData(state.tabList, componentPropBindingMap?.['t-tabs-d35f.71ff8fdc2']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active-tab="replaceCssVariables(filterData(state.activeTab, componentPropBindingMap?.['t-tabs-d35f.71ff8fdc2']['activeTab'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :tab-position-extend="tTabsx0x5ComputedData.tabPositionExtend" :stretch="tTabsx0x5ComputedData.stretch" :c-style="tTabsx0x5ComputedData.cStyle" @tab-click="ontabClick1767862823417"></t-tabs><t-row id="t-row-a98e.97de7da75" class="waterDialogSmallWatershed-t-row-0-7"  :c-style="tRowx0x7ComputedData.cStyle" :gutter="tRowx0x7ComputedData.gutter" :justify="tRowx0x7ComputedData.justify" :align="tRowx0x7ComputedData.align"><t-text id="t-text-8cba.b16affff7" class="waterDialogSmallWatershed-t-text-0-7-0"  :label="replaceCssVariables(filterData(state.baseInfo.title, componentPropBindingMap?.['t-text-8cba.b16affff7']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :editable="tTextx0x7x0ComputedData.editable" :c-style="tTextx0x7x0ComputedData.cStyle" :show-title="tTextx0x7x0ComputedData.showTitle"></t-text><t-list-card-common id="t-list-card-common-2140.c5a8afe98" class="waterDialogSmallWatershed-t-list-card-common-0-7-3"  :c-style="tListCardCommonx0x7x3ComputedData.cStyle" :key-word="tListCardCommonx0x7x3ComputedData.keyWord" :default-checked="tListCardCommonx0x7x3ComputedData.defaultChecked" :tab="tListCardCommonx0x7x3ComputedData.tab" :collapse="tListCardCommonx0x7x3ComputedData.collapse" :collapse-text="tListCardCommonx0x7x3ComputedData.collapseText" :display-count="tListCardCommonx0x7x3ComputedData.displayCount" :data-alias="tListCardCommonx0x7x3ComputedData.dataAlias" :data="replaceCssVariables(filterData(state.baseInfo.waterQuality, componentPropBindingMap?.['t-list-card-common-2140.c5a8afe98']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')"></t-list-card-common><t-list-card-common id="t-list-card-common-d579.fbaae92d4" class="waterDialogSmallWatershed-t-list-card-common-0-7-4"  :c-style="tListCardCommonx0x7x4ComputedData.cStyle" :key-word="tListCardCommonx0x7x4ComputedData.keyWord" :default-checked="tListCardCommonx0x7x4ComputedData.defaultChecked" :tab="tListCardCommonx0x7x4ComputedData.tab" :collapse="tListCardCommonx0x7x4ComputedData.collapse" :collapse-text="tListCardCommonx0x7x4ComputedData.collapseText" :display-count="tListCardCommonx0x7x4ComputedData.displayCount" :data-alias="tListCardCommonx0x7x4ComputedData.dataAlias" :data="replaceCssVariables(filterData(state.baseInfo.standard, componentPropBindingMap?.['t-list-card-common-d579.fbaae92d4']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')"></t-list-card-common><t-rect v-if="state.baseInfo.alarmText !== ''" id="t-rect-4bb6.47291368" class="waterDialogSmallWatershed-t-rect-0-7-5"  :tip="tRectx0x7x5ComputedData.tip" :label="tRectx0x7x5ComputedData.label" :active="tRectx0x7x5ComputedData.active" :c-style="tRectx0x7x5ComputedData.cStyle" @mouseover="onmouseover1733993886943" @mouseout="onmouseout1733993903757"></t-rect></t-row><t-rect v-if="state.baseInfo.alarmShow === true" id="t-rect-16fd.29080fd9c" class="waterDialogSmallWatershed-t-rect-0-8"  :tip="tRectx0x8ComputedData.tip" :label="replaceCssVariables(filterData(state.baseInfo.alarmText, componentPropBindingMap?.['t-rect-16fd.29080fd9c']['label'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :active="tRectx0x8ComputedData.active" :c-style="tRectx0x8ComputedData.cStyle"></t-rect><t-rect id="t-rect-da62.857f90ab" class="waterDialogSmallWatershed-t-rect-0-9"  :tip="tRectx0x9ComputedData.tip" :label="tRectx0x9ComputedData.label" :active="tRectx0x9ComputedData.active" :c-style="tRectx0x9ComputedData.cStyle" @click="onclick1733817210174"></t-rect><t-row id="t-row-6365.97c68ed82" class="waterDialogSmallWatershed-t-row-0-10"  :c-style="tRowx0x10ComputedData.cStyle" :gutter="tRowx0x10ComputedData.gutter" :justify="tRowx0x10ComputedData.justify" :align="tRowx0x10ComputedData.align"><t-text id="t-text-630e.1af9131a3" class="waterDialogSmallWatershed-t-text-0-10-0"  :label="tTextx0x10x0ComputedData.label" :editable="tTextx0x10x0ComputedData.editable" :c-style="tTextx0x10x0ComputedData.cStyle" @click="onclick1734068220296"></t-text><t-text v-if="state.showSource === true" id="t-text-4e6d.a19cece3e" class="waterDialogSmallWatershed-t-text-0-10-1"  :label="tTextx0x10x1ComputedData.label" :editable="tTextx0x10x1ComputedData.editable" :c-style="tTextx0x10x1ComputedData.cStyle" @click="onclick1734071402189"></t-text><t-text id="t-text-19bd.a994fa29f" class="waterDialogSmallWatershed-t-text-0-10-2"  :label="tTextx0x10x2ComputedData.label" :editable="tTextx0x10x2ComputedData.editable" :c-style="tTextx0x10x2ComputedData.cStyle" @click="onclick1734067550409"></t-text></t-row><t-component v-if="state.activeTab === 'waterDialogSmallWatershedBaseComponent'" id="t-component-7ddc.990165e4a" class="waterDialogSmallWatershed-t-component-0-11"  :name="tComponentx0x11ComputedData.name" :c-style="tComponentx0x11ComputedData.cStyle" :src="tComponentx0x11ComputedData.src" :component-name="tComponentx0x11ComputedData.componentName" :page-id="tComponentx0x11ComputedData.pageId" :page-code="tComponentx0x11ComputedData.pageCode"></t-component></div>
</template>
...
tTextx0x7x0: {
defaultStyle: {
            default: {"width":"auto","height":"auto","color":"rgba(255, 255, 255, 1)","fontSize":"var(--business-text-size-18)","position":"unset","left":"16px","top":"13px","backgroundImage":"url(assets/images/2024-04-17/26907d3cdd3d451c98ec22ec5199d46d.svg)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"26px 26px","-webkit-mask-size":"","backgroundPosition":"0% 50%","-webkit-mask-position":"","paddingLeft":"32px","fontWeight":"700","animationName":"","textAlign":"left","max-width":"240px","marginRight":"6px","whiteSpace":"nowrap","textOverflow":"ellipsis","overflow":"hidden"},
...
label:"-",
editable:false,
cStyle:{"wrapper":{"default":{"width":"auto","height":"auto","color":"rgba(255, 255, 255, 1)","fontSize":"var(--business-text-size-18)","position":"unset","left":"16px","top":"13px","backgroundImage":"url(assets/images/2024-04-17/26907d3cdd3d451c98ec22ec5199d46d.svg)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"26px 26px","-webkit-mask-size":"","backgroundPosition":"0% 50%","-webkit-mask-position":"","paddingLeft":"32px","fontWeight":"700","animationName":"","textAlign":"left","max-width":"240px","marginRight":"6px","whiteSpace":"nowrap","textOverflow":"ellipsis","overflow":"hidden"}}},
showTitle:true, 
 },
},
...
// 获取当前组件的名称
let componentName = 'waterDialogSmallWatershed';
// 定义style元素的id
...
<style scoped>
.t-l-c-waterDialogSmallWatershed {
position: relative;
overflow: hidden;
...
.t-l-c-waterDialogSmallWatershed .waterDialogSmallWatershed-t-rect-0-0 {
...
.t-l-c-waterDialogSmallWatershed .waterDialogSmallWatershed-t-component-0-1 {
position: absolute !important;
top: 63px;
left: 176px;
width: 824px;
...
.t-l-c-waterDialogSmallWatershed .waterDialogSmallWatershed-t-rect-0-2 {
position: absolute !important;
top: 660px;
left: 0px;
width: 1020px;
...
.t-l-c-waterDialogSmallWatershed .waterDialogSmallWatershed-t-rect-0-3 {
position: absolute !important;
top: 0px;
left: 0px;
width: 1020px;
...
.t-l-c-waterDialogSmallWatershed .waterDialogSmallWatershed-t-rect-0-4 {
position: absolute !important;
top: 63px;
left: 20px;
width: 140px;
...
.t-l-c-waterDialogSmallWatershed .waterDialogSmallWatershed-t-tabs-0-5 {
position: absolute !important;
top: 66.00006761746545px;
left: 24.340723651092617px;
width: 130px;
height: 122.97424117378567px;
pointer-events: auto;
}

.t-l-c-waterDialogSmallWatershed .waterDialogSmallWatershed-t-row-0-7 {
position: absolute !important;
top: 0px;
left: 18px;
width: 500px;
...
.t-l-c-waterDialogSmallWatershed .waterDialogSmallWatershed-t-text-0-7-0 {
position: unset;
top: 13px;
left: 16px;
width: auto;
...
.t-l-c-waterDialogSmallWatershed .waterDialogSmallWatershed-t-list-card-common-0-7-3 {
position: unset;
top: 15px;
left: 219px;
width: 50px;
...
.t-l-c-waterDialogSmallWatershed .waterDialogSmallWatershed-t-list-card-common-0-7-4 {
position: unset;
top: 14px;
left: 310px;
width: 50px;
...
.t-l-c-waterDialogSmallWatershed .waterDialogSmallWatershed-t-rect-0-7-5 {
position: unset;
top: 14px;
left: 399px;
width: 20px;
...
.t-l-c-waterDialogSmallWatershed .waterDialogSmallWatershed-t-rect-0-8 {
position: absolute !important;
top: 39px;
left: 254px;
width: 297px;
...
.t-l-c-waterDialogSmallWatershed .waterDialogSmallWatershed-t-rect-0-9 {
position: absolute !important;
top: 11px;
left: 971px;
width: 24px;
...
.t-l-c-waterDialogSmallWatershed .waterDialogSmallWatershed-t-row-0-10 {
position: absolute !important;
top: 672px;
left: 570px;
width: 430px;
...
.t-l-c-waterDialogSmallWatershed .waterDialogSmallWatershed-t-text-0-10-0 {
position: unset;
top: 670px;
left: 669px;
width: auto;
...
.t-l-c-waterDialogSmallWatershed .waterDialogSmallWatershed-t-text-0-10-1 {
position: unset;
top: 670px;
left: 780px;
width: auto;
...
.t-l-c-waterDialogSmallWatershed .waterDialogSmallWatershed-t-text-0-10-2 {
position: unset;
top: 670px;
left: 870px;
width: auto;
...
.t-l-c-waterDialogSmallWatershed .waterDialogSmallWatershed-t-component-0-11 {
position: absolute !important;
top: 257px;
left: 175px;
width: 824px;

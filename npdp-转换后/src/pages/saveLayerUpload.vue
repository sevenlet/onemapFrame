<template>
  <div id="t-l-c-saveLayerUpload" class="t-l-c-saveLayerUpload" ><t-rect id="t-rect-ca0c.fbaed2ca6" class="saveLayerUpload-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle"></t-rect><t-rect id="t-rect-41cf.039182dfb" class="saveLayerUpload-t-rect-0-1"  :tip="tRectx0x1ComputedData.tip" :label="tRectx0x1ComputedData.label" :active="tRectx0x1ComputedData.active" :c-style="tRectx0x1ComputedData.cStyle"></t-rect><t-rect id="t-rect-fe6d.e4eb5cb24" class="saveLayerUpload-t-rect-0-2"  :tip="tRectx0x2ComputedData.tip" :label="tRectx0x2ComputedData.label" :active="tRectx0x2ComputedData.active" :c-style="tRectx0x2ComputedData.cStyle"></t-rect><t-image-base id="t-image-base-44d1.17f6e75ec" class="saveLayerUpload-t-image-base-0-3"  :src="tImageBasex0x3ComputedData.src" :fit="tImageBasex0x3ComputedData.fit" :c-style="tImageBasex0x3ComputedData.cStyle"></t-image-base><t-rect id="t-rect-9401.6e5d7b801" class="saveLayerUpload-t-rect-0-4"  :tip="tRectx0x4ComputedData.tip" :label="tRectx0x4ComputedData.label" :active="tRectx0x4ComputedData.active" :c-style="tRectx0x4ComputedData.cStyle" @click="onclick1738982388664"></t-rect><t-text id="t-text-a26d.eae57bf6" class="saveLayerUpload-t-text-0-5"  :label="tTextx0x5ComputedData.label" :editable="tTextx0x5ComputedData.editable" :c-style="tTextx0x5ComputedData.cStyle"></t-text><t-text id="t-text-17ec.f04300dfc" class="saveLayerUpload-t-text-0-6"  :label="tTextx0x6ComputedData.label" :editable="tTextx0x6ComputedData.editable" :c-style="tTextx0x6ComputedData.cStyle"></t-text><t-text id="t-text-9738.124572a44" class="saveLayerUpload-t-text-0-7"  :label="tTextx0x7ComputedData.label" :editable="tTextx0x7ComputedData.editable" :c-style="tTextx0x7ComputedData.cStyle"></t-text><t-cascader id="t-cascader-cc57.780ee400e" class="saveLayerUpload-t-cascader-0-8"  :active-value="state.selectedMetaData" :data="state.metaDataOptions" :alias="tCascaderx0x8ComputedData.alias" :placeholder="tCascaderx0x8ComputedData.placeholder" :clearable="tCascaderx0x8ComputedData.clearable" :disabled="tCascaderx0x8ComputedData.disabled" :no-match-text="tCascaderx0x8ComputedData.noMatchText" :no-data-text="tCascaderx0x8ComputedData.noDataText" :c-style="tCascaderx0x8ComputedData.cStyle" :show-all-levels="tCascaderx0x8ComputedData.showAllLevels" :check-strictly="tCascaderx0x8ComputedData.checkStrictly" @change="onchange1739006256380"></t-cascader><t-button v-if="state.selectedMetaData !== ''" id="t-button-2c50.15783455b" class="saveLayerUpload-t-button-0-9"  :label="tButtonx0x9ComputedData.label" :round="tButtonx0x9ComputedData.round" :plain="tButtonx0x9ComputedData.plain" :disabled="tButtonx0x9ComputedData.disabled" :type="tButtonx0x9ComputedData.type" :size="tButtonx0x9ComputedData.size" :native-type="tButtonx0x9ComputedData.native-type" :c-style="tButtonx0x9ComputedData.cStyle" @click="onclick1739005313081"></t-button><t-button id="t-button-9687.2aed006f2" class="saveLayerUpload-t-button-0-10"  :label="tButtonx0x10ComputedData.label" :round="tButtonx0x10ComputedData.round" :plain="tButtonx0x10ComputedData.plain" :disabled="tButtonx0x10ComputedData.disabled" :type="tButtonx0x10ComputedData.type" :size="tButtonx0x10ComputedData.size" :native-type="tButtonx0x10ComputedData.native-type" :c-style="tButtonx0x10ComputedData.cStyle" @click="onclick1739244985093"></t-button><t-button v-if="state.selectedMetaData === ''" id="t-button-b807.6c05a01db" class="saveLayerUpload-t-button-0-11"  :label="tButtonx0x11ComputedData.label" :round="tButtonx0x11ComputedData.round" :plain="tButtonx0x11ComputedData.plain" :disabled="tButtonx0x11ComputedData.disabled" :type="tButtonx0x11ComputedData.type" :size="tButtonx0x11ComputedData.size" :native-type="tButtonx0x11ComputedData.native-type" :c-style="tButtonx0x11ComputedData.cStyle"></t-button><t-iframe id="t-iframe-768f.9246fdd33" class="saveLayerUpload-t-iframe-0-12"  :src="tIframex0x12ComputedData.src" :srcdoc="tIframex0x12ComputedData.srcdoc" :scrolling="tIframex0x12ComputedData.scrolling" :c-style="tIframex0x12ComputedData.cStyle" :socket-url="global.socketIp" :room-id="global.socketRoom"></t-iframe><t-text id="t-text-8238.56943ba63" class="saveLayerUpload-t-text-0-13"  :label="state.uploadMessage" :editable="tTextx0x13ComputedData.editable" :c-style="tTextx0x13ComputedData.cStyle"></t-text></div>
</template>
...
import { TButton, TCascader, TIframe, TImageBase, TRect, TText } from '@ths/design';
...
.t-l-c-saveLayerUpload .saveLayerUpload-t-rect-0-0 {
...
.t-l-c-saveLayerUpload .saveLayerUpload-t-rect-0-1 {
position: absolute !important;
top: 435px;
left: 763px;
width: 415px;
...
.t-l-c-saveLayerUpload .saveLayerUpload-t-rect-0-2 {
position: absolute !important;
top: 436px;
left: 763px;
width: 415px;
...
.t-l-c-saveLayerUpload .saveLayerUpload-t-image-base-0-3 {
position: absolute !important;
top: 447px;
left: 777px;
width: 24px;
...
.t-l-c-saveLayerUpload .saveLayerUpload-t-rect-0-4 {
position: absolute !important;
top: 446px;
left: 1133.5px;
width: 24px;
...
.t-l-c-saveLayerUpload .saveLayerUpload-t-text-0-5 {
position: absolute !important;
top: 448px;
left: 809px;
width: 96px;
...
.t-l-c-saveLayerUpload .saveLayerUpload-t-text-0-6 {
position: absolute !important;
top: 518px;
left: 783px;
width: 64px;
...
.t-l-c-saveLayerUpload .saveLayerUpload-t-text-0-7 {
position: absolute !important;
top: 556px;
left: 783px;
width: 64px;
...
.t-l-c-saveLayerUpload .saveLayerUpload-t-cascader-0-8 {
position: absolute !important;
top: 558px;
left: 852px;
width: 306px;
...
.t-l-c-saveLayerUpload .saveLayerUpload-t-button-0-9 {
position: absolute !important;
top: 609px;
left: 1108px;
width: 50px;
...
.t-l-c-saveLayerUpload .saveLayerUpload-t-button-0-10 {
position: absolute !important;
top: 609px;
left: 1044px;
width: 50px;
...
.t-l-c-saveLayerUpload .saveLayerUpload-t-button-0-11 {
position: absolute !important;
top: 609px;
left: 1108px;
width: 50px;
...
.t-l-c-saveLayerUpload .saveLayerUpload-t-iframe-0-12 {
position: absolute !important;
top: 513px;
left: 853px;
width: 306px;
...
.t-l-c-saveLayerUpload .saveLayerUpload-t-text-0-13 {
position: absolute !important;
top: 536px;
left: 853px;
width: 303px;

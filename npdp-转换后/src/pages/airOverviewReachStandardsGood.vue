<template>
  <div id="t-l-c-airOverviewReachStandardsGood" class="t-l-c-airOverviewReachStandardsGood" ><t-rect id="t-rect-0394.099a89c9b" class="airOverviewReachStandardsGood-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle"></t-rect><t-text-unit id="t-text-unit-2650.4bd199b7" class="airOverviewReachStandardsGood-t-text-unit-0-1"  :c-style="tTextUnitx0x1ComputedData.cStyle" :justify="tTextUnitx0x1ComputedData.justify" :align="tTextUnitx0x1ComputedData.align" :content="replaceCssVariables(filterData(state.reachStandardsGoodData.EXCELLENT_RATE_LASTYEAR, componentPropBindingMap?.['t-text-unit-2650.4bd199b7']['content'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :unit="tTextUnitx0x1ComputedData.unit" :show-overflow-tooltip="tTextUnitx0x1ComputedData.showOverflowTooltip"></t-text-unit><t-high-light-text id="t-high-light-text-b596.b9353aeb3" class="airOverviewReachStandardsGood-t-high-light-text-0-3"  :fragment-list="replaceCssVariables(filterData(state.fragmentList, componentPropBindingMap?.['t-high-light-text-b596.b9353aeb3']['fragmentList'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :styles="tHighLightTextx0x3ComputedData.styles" :c-style="tHighLightTextx0x3ComputedData.cStyle"></t-high-light-text><t-text-unit id="t-text-unit-5f24.a78538d8c" class="airOverviewReachStandardsGood-t-text-unit-0-4"  :c-style="tTextUnitx0x4ComputedData.cStyle" :justify="tTextUnitx0x4ComputedData.justify" :align="tTextUnitx0x4ComputedData.align" :content="replaceCssVariables(filterData(state.reachStandardsGoodData.EXCELLENT_RATE_TARGET, componentPropBindingMap?.['t-text-unit-5f24.a78538d8c']['content'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :unit="tTextUnitx0x4ComputedData.unit" :show-overflow-tooltip="tTextUnitx0x4ComputedData.showOverflowTooltip"></t-text-unit><t-rect id="t-rect-c35f.74d33b8c3" class="airOverviewReachStandardsGood-t-rect-0-5"  :tip="tRectx0x5ComputedData.tip" :label="tRectx0x5ComputedData.label" :active="tRectx0x5ComputedData.active" :c-style="tRectx0x5ComputedData.cStyle"></t-rect><t-rank-single v-if="state.isOver === true" id="t-rank-single-900b.d2fe8be58" class="airOverviewReachStandardsGood-t-rank-single-0-6"  :icon-src="tRankSinglex0x6ComputedData.iconSrc" :data="replaceCssVariables(filterData(state.processData, componentPropBindingMap?.['t-rank-single-900b.d2fe8be58']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :c-style="tRankSinglex0x6ComputedData.cStyle" :tab="tRankSinglex0x6ComputedData.tab" :key-word="tRankSinglex0x6ComputedData.keyWord" :default-checked="tRankSinglex0x6ComputedData.defaultChecked" :auto-scroll="tRankSinglex0x6ComputedData.autoScroll" :speed="tRankSinglex0x6ComputedData.speed" :data-style="tRankSinglex0x6ComputedData.dataStyle"></t-rank-single><t-rank-single v-if="state.isOver === false" id="t-rank-single-fb2d.ff5a9ae0d" class="airOverviewReachStandardsGood-t-rank-single-0-7"  :icon-src="tRankSinglex0x7ComputedData.iconSrc" :data="replaceCssVariables(filterData(state.processData, componentPropBindingMap?.['t-rank-single-fb2d.ff5a9ae0d']['data'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :c-style="tRankSinglex0x7ComputedData.cStyle" :tab="tRankSinglex0x7ComputedData.tab" :key-word="tRankSinglex0x7ComputedData.keyWord" :default-checked="tRankSinglex0x7ComputedData.defaultChecked" :auto-scroll="tRankSinglex0x7ComputedData.autoScroll" :speed="tRankSinglex0x7ComputedData.speed" :data-style="tRankSinglex0x7ComputedData.dataStyle"></t-rank-single><t-text-unit id="t-text-unit-a11d.c8aa941b3" class="airOverviewReachStandardsGood-t-text-unit-0-8"  :c-style="tTextUnitx0x8ComputedData.cStyle" :justify="tTextUnitx0x8ComputedData.justify" :align="tTextUnitx0x8ComputedData.align" :content="tTextUnitx0x8ComputedData.content" :unit="tTextUnitx0x8ComputedData.unit" :show-overflow-tooltip="tTextUnitx0x8ComputedData.showOverflowTooltip"></t-text-unit><t-text v-if="state.targetType !== '优良率'" id="t-text-7ff8.a7f3ae1" class="airOverviewReachStandardsGood-t-text-0-9"  :label="tTextx0x9ComputedData.label" :editable="tTextx0x9ComputedData.editable" :c-style="tTextx0x9ComputedData.cStyle" @click="onclick1733798068754"></t-text><t-high-light-text v-if="state.targetType === '优良率'" id="t-high-light-text-fc98.e430c5a5c" class="airOverviewReachStandardsGood-t-high-light-text-0-10"  :fragment-list="replaceCssVariables(filterData(state.targetData, componentPropBindingMap?.['t-high-light-text-fc98.e430c5a5c']['fragmentList'].filters || []), global?.theme || global?.activeTheme || '默认主题')" :styles="tHighLightTextx0x10ComputedData.styles" :c-style="tHighLightTextx0x10ComputedData.cStyle"></t-high-light-text><t-text v-if="state.targetType === '优良率'" id="t-text-3837.171aaa3fa" class="airOverviewReachStandardsGood-t-text-0-11"  :label="tTextx0x11ComputedData.label" :editable="tTextx0x11ComputedData.editable" :c-style="tTextx0x11ComputedData.cStyle" @click="onclick1733799651749_0_0"></t-text></div>
</template>
...
import { THighLightText, TRankSingle, TRect, TText, TTextUnit } from '@ths/design';
...
iconSrc:"assets/images/2024-12-25/ec449e439f3a479ba5c51c4f55f17663.png",
...
iconSrc:"assets/images/2024-12-04/162b6d0793604e93a928e237685698e1.png",
data:[{"currentValue":85}],
...
tTextx0x11: {
defaultStyle: {
            default: {"width":"110px","height":"auto","color":"var(--business-strong)","position":"unset","left":"309px","top":"10px","fontSize":"var(--business-text-size-14)","borderTopLeftRadius":"0px","borderTopRightRadius":"0px","borderBottomLeftRadius":"0px","borderBottomRightRadius":"0px","animationName":"","cursor":"pointer","paddingLeft":"20px","backgroundImage":"url(assets/images/2024-12-10/b88a9534077441e29df4a189a4c94997.svg)","-webkit-mask-image":"","backgroundRepeat":"no-repeat","-webkit-mask-repeat":"","backgroundSize":"auto","-webkit-mask-size":"","backgroundPosition":"0% 50%","-webkit-mask-position":""},
...
<style scoped>
.t-l-c-airOverviewReachStandardsGood {
position: relative;
overflow: hidden;
...
.t-l-c-airOverviewReachStandardsGood .airOverviewReachStandardsGood-t-rect-0-0 {
...
.t-l-c-airOverviewReachStandardsGood .airOverviewReachStandardsGood-t-text-unit-0-1 {
position: absolute !important;
top: 38px;
left: 126px;
width: 128px;
...
.t-l-c-airOverviewReachStandardsGood .airOverviewReachStandardsGood-t-high-light-text-0-3 {
position: absolute !important;
top: 39px;
left: 25px;
width: 47px;
...
.t-l-c-airOverviewReachStandardsGood .airOverviewReachStandardsGood-t-text-unit-0-4 {
position: absolute !important;
top: 38px;
left: 266px;
width: 128px;
...
.t-l-c-airOverviewReachStandardsGood .airOverviewReachStandardsGood-t-rect-0-5 {
position: absolute !important;
top: 42px;
left: 256px;
width: 1px;
...
.t-l-c-airOverviewReachStandardsGood .airOverviewReachStandardsGood-t-rank-single-0-6 {
position: absolute !important;
top: 27px;
left: 19px;
width: 373px;
...
.t-l-c-airOverviewReachStandardsGood .airOverviewReachStandardsGood-t-rank-single-0-7 {
position: absolute !important;
top: 27px;
left: 19px;
width: 373px;
...
.t-l-c-airOverviewReachStandardsGood .airOverviewReachStandardsGood-t-text-unit-0-8 {
position: absolute !important;
top: 11px;
left: 24px;
width: auto;
...
.t-l-c-airOverviewReachStandardsGood .airOverviewReachStandardsGood-t-text-0-9 {
position: absolute !important;
top: 10px;
left: 309px;
width: 110px;
...
.t-l-c-airOverviewReachStandardsGood .airOverviewReachStandardsGood-t-high-light-text-0-10 {
position: absolute !important;
top: 33px;
left: 16px;
width: 390px;
...
.t-l-c-airOverviewReachStandardsGood .airOverviewReachStandardsGood-t-text-0-11 {
position: absolute !important;
top: 10px;
left: 309px;
width: 110px;

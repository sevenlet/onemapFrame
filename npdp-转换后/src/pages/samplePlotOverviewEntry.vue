...
name:"samplePlotOverviewComponent",
loading:true,
cStyle:{"wrapper":{"default":{"width":"450px","height":"904px","margin":"0 auto","position":"unset","left":"0px","top":"0px"}}},
src:"/lego-generated-apps/lego_file/app/src/18547eef59454bff840ff42ee0d03b78_6/index.html#/samplePlotOverview",
componentName:"samplePlotOverviewComponent",
pageId:"75cae849fe154a32b2bc4b882d31e041",
pageCode:"samplePlotOverview", 
 },
},
});
const setStyle = () => {
...
if (tabValue !== state.tabSelect) {
 ...
 function handleWindowResize() {
                            setPageScale('t-l-c-samplePlotOverviewEntry', global.appScaleMode, 'normal');
...
handleWindowResize();
/* 接收socket.io消息 */
const onSocketChange9057efe3f2c1464aa63a = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChange9057efe3f2c1464aa63a);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChange9057efe3f2c1464aa63a);
});
/* 接收socket.io消息 */
const onSocketChange28ffbfcf8d2649639281 = function (data) {
...
};rootData.rootOn('rootSocket:change', onSocketChange28ffbfcf8d2649639281);onUnmounted(() => {
  rootData.rootOff('rootSocket:change', onSocketChange28ffbfcf8d2649639281);
});
});
// 页面离开时的操作
onUnmounted(() => {
...
.t-l-c-samplePlotOverviewEntry .samplePlotOverviewEntry-t-component-0-0 {

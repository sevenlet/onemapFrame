<template>
  <div id="t-l-c-testLeftMenu" class="t-l-c-testLeftMenu" ><t-rect v-if="state.showMenu === true" id="t-rect-1bda.61271563a" class="testLeftMenu-t-rect-0-1"  :tip="tRectx0x1ComputedData.tip" :label="tRectx0x1ComputedData.label" :active="tRectx0x1ComputedData.active" :c-style="tRectx0x1ComputedData.cStyle"></t-rect><t-rect v-if="state.showMenu === true" id="t-rect-19e5.e86ec2bef" class="testLeftMenu-t-rect-0-3"  :tip="tRectx0x3ComputedData.tip" :label="tRectx0x3ComputedData.label" :active="tRectx0x3ComputedData.active" :c-style="tRectx0x3ComputedData.cStyle"></t-rect><t-tabs id="t-tabs-2037.5bf01a865" class="testLeftMenu-t-tabs-0-4"  :alias="tTabsx0x4ComputedData.alias" :data="state.typeList" :active-tab="state.type" :tab-position-extend="tTabsx0x4ComputedData.tabPositionExtend" :stretch="tTabsx0x4ComputedData.stretch" :c-style="tTabsx0x4ComputedData.cStyle" @tab-click="ontabClick1719921924660"></t-tabs><t-rect v-if="state.showMenu === true" id="t-rect-5c2e.c6ce5466f" class="testLeftMenu-t-rect-0-5"  :tip="tRectx0x5ComputedData.tip" :label="tRectx0x5ComputedData.label" :active="tRectx0x5ComputedData.active" :c-style="tRectx0x5ComputedData.cStyle" @click="onclick1719920562468"></t-rect><t-iframe id="t-iframe-32a6.a99f8be3" class="testLeftMenu-t-iframe-0-6"  :src="tIframex0x6ComputedData.src" :srcdoc="tIframex0x6ComputedData.srcdoc" :scrolling="tIframex0x6ComputedData.scrolling" :c-style="tIframex0x6ComputedData.cStyle" :socket-url="global.socketIp" :room-id="global.socketRoom"></t-iframe><t-iframe id="t-iframe-13b6.211504a4b" class="testLeftMenu-t-iframe-0-7"  :src="tIframex0x7ComputedData.src" :srcdoc="tIframex0x7ComputedData.srcdoc" :scrolling="tIframex0x7ComputedData.scrolling" :c-style="tIframex0x7ComputedData.cStyle" :socket-url="global.socketIp" :room-id="global.socketRoom"></t-iframe><t-rect v-if="state.showMenu === false" id="t-rect-29c7.78199920c" class="testLeftMenu-t-rect-0-10"  :tip="tRectx0x10ComputedData.tip" :label="tRectx0x10ComputedData.label" :active="tRectx0x10ComputedData.active" :c-style="tRectx0x10ComputedData.cStyle" @click="onclick1721971936695"></t-rect></div>
</template>
...
.t-l-c-testLeftMenu .testLeftMenu-t-rect-0-1 {
...
.t-l-c-testLeftMenu .testLeftMenu-t-rect-0-3 {
position: absolute !important;
top: 0px;
left: 0px;
width: 223px;
...
.t-l-c-testLeftMenu .testLeftMenu-t-tabs-0-4 {
position: absolute !important;
top: 13px;
left: 76px;
width: 155px;
...
.t-l-c-testLeftMenu .testLeftMenu-t-rect-0-5 {
position: absolute !important;
top: 10px;
left: 16px;
width: 25px;
...
.t-l-c-testLeftMenu .testLeftMenu-t-iframe-0-6 {
position: absolute !important;
top: 52px;
left: 16px;
width: 201px;
...
.t-l-c-testLeftMenu .testLeftMenu-t-iframe-0-7 {
position: absolute !important;
top: 55px;
left: 16px;
width: 205px;
...
.t-l-c-testLeftMenu .testLeftMenu-t-rect-0-10 {
position: absolute !important;
top: 10px;
left: 2px;
width: 25px;

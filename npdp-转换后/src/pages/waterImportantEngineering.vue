<template>
  <div id="t-l-c-waterImportantEngineering" class="t-l-c-waterImportantEngineering" ><t-rect id="t-rect-8252.1a4ade4f4" class="waterImportantEngineering-t-rect-0-0"  :tip="tRectx0x0ComputedData.tip" :label="tRectx0x0ComputedData.label" :active="tRectx0x0ComputedData.active" :c-style="tRectx0x0ComputedData.cStyle"></t-rect><t-rect id="t-rect-e3a7.d7772ec8d" class="waterImportantEngineering-t-rect-0-1"  :tip="tRectx0x1ComputedData.tip" :label="tRectx0x1ComputedData.label" :active="tRectx0x1ComputedData.active" :c-style="tRectx0x1ComputedData.cStyle"></t-rect><t-text id="t-text-8cba.b16affff7" class="waterImportantEngineering-t-text-0-2"  :label="state.pointNameSource" :editable="tTextx0x2ComputedData.editable" :c-style="tTextx0x2ComputedData.cStyle" :show-title="tTextx0x2ComputedData.showTitle"></t-text><t-rect id="t-rect-da62.857f90ab" class="waterImportantEngineering-t-rect-0-3"  :tip="tRectx0x3ComputedData.tip" :label="tRectx0x3ComputedData.label" :active="tRectx0x3ComputedData.active" :c-style="tRectx0x3ComputedData.cStyle" @click="onclick1733817210174"></t-rect><t-text id="t-text-738d.67fdf6baf" class="waterImportantEngineering-t-text-0-4"  :label="tTextx0x4ComputedData.label" :editable="tTextx0x4ComputedData.editable" :c-style="tTextx0x4ComputedData.cStyle"></t-text><t-list-card id="t-list-card-1afd.46c2cc26d" class="waterImportantEngineering-t-list-card-0-5"  :data="state.cardList" :spacing-x="tListCardx0x5ComputedData.spacingX" :col="tListCardx0x5ComputedData.col" :direction="tListCardx0x5ComputedData.direction" :exchange-order="tListCardx0x5ComputedData.exchangeOrder" :unit-break="tListCardx0x5ComputedData.unitBreak" :key-field="tListCardx0x5ComputedData.keyField" :active-key-field="tListCardx0x5ComputedData.activeKeyField" :active="tListCardx0x5ComputedData.active" :c-style="tListCardx0x5ComputedData.cStyle"></t-list-card><t-row id="t-row-1aec.588d3a901" class="waterImportantEngineering-t-row-0-6"  :c-style="tRowx0x6ComputedData.cStyle" :gutter="tRowx0x6ComputedData.gutter" :justify="tRowx0x6ComputedData.justify" :align="tRowx0x6ComputedData.align"><t-text id="t-text-0df0.1c50452" class="waterImportantEngineering-t-text-0-6-0"  :label="tTextx0x6x0ComputedData.label" :editable="tTextx0x6x0ComputedData.editable" :c-style="tTextx0x6x0ComputedData.cStyle" @click="onclick1734499551425"></t-text></t-row></div>
</template>
...
<style scoped>
.t-l-c-waterImportantEngineering {
position: relative;
overflow: hidden;
...
.t-l-c-waterImportantEngineering .waterImportantEngineering-t-rect-0-0 {
position: absolute !important;
top: -0.000005856841994500428px;
left: 0.000022860156605020165px;
width: 450px;
height: 268.00002744533873px;
pointer-events: auto;
}

.t-l-c-waterImportantEngineering .waterImportantEngineering-t-rect-0-1 {
position: absolute !important;
top: -0.000005856841994500428px;
left: 0.000022860156605020165px;
width: 450px;
height: 33.86536264099531px;
pointer-events: auto;
}

.t-l-c-waterImportantEngineering .waterImportantEngineering-t-text-0-2 {
position: absolute !important;
top: 9.780205570003034px;
left: 24.000011430078303px;
width: 360px;
height: 17.986577181208055px;
pointer-events: auto;
}

.t-l-c-waterImportantEngineering .waterImportantEngineering-t-rect-0-3 {
position: absolute !important;
top: 7.5225177005150385px;
left: 401.9999809125002px;
width: 24px;
height: 17.302713099742096px;
pointer-events: auto;
}

.t-l-c-waterImportantEngineering .waterImportantEngineering-t-text-0-4 {
position: absolute !important;
top: 230.34999456040782px;
left: 0.000022860156605020165px;
width: 450px;
height: 37.63129194630872px;
pointer-events: auto;
}

.t-l-c-waterImportantEngineering .waterImportantEngineering-t-list-card-0-5 {
position: absolute !important;
top: 59px;
left: 20px;
width: 410px;
...
.t-l-c-waterImportantEngineering .waterImportantEngineering-t-row-0-6 {
position: absolute !important;
top: 235px;
left: 9px;
width: 430px;
...
.t-l-c-waterImportantEngineering .waterImportantEngineering-t-text-0-6-0 {
position: unset;
